...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb21:  // pred: ^bb20
      ...
      nvvm.mbarrier.try_wait.parity.shared %202, %200, %25 : !llvm.ptr<3>, i32, i32
    ...
    ^bb67:  // pred: ^bb66
      ...
      nvvm.mbarrier.try_wait.parity.shared %259, %258, %25 : !llvm.ptr<3>, i32, i32
    ...
    ^bb83:  // pred: ^bb82
      ...
      nvvm.mbarrier.try_wait.parity.shared %318, %316, %25 : !llvm.ptr<3>, i32, i32
    ...
    ^bb126:  // pred: ^bb125
      ...
      nvvm.mbarrier.try_wait.parity.shared %1190, %1188, %25 : !llvm.ptr<3>, i32, i32
