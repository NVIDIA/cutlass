...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg16: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg17: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg18: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg19: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg20: !cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg21: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg22: !mma_f16_f16_f32_64x128x16_, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: !cute.fast_divmod_divisor<32>, %arg27: !cute.fast_divmod_divisor<32>, %arg28: !cute.fast_divmod_divisor<32>):
      ...
      %826 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %827 = "nvvm.read.ptx.sreg.tid.y"() : () -> i32
      %828 = "nvvm.read.ptx.sreg.tid.z"() : () -> i32
      %829 = "nvvm.read.ptx.sreg.ntid.x"() : () -> i32
      %830 = "nvvm.read.ptx.sreg.ntid.y"() : () -> i32
      ...
      %868 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %869 = "nvvm.read.ptx.sreg.tid.y"() : () -> i32
      %870 = "nvvm.read.ptx.sreg.tid.z"() : () -> i32
      %871 = "nvvm.read.ptx.sreg.ntid.x"() : () -> i32
      %872 = "nvvm.read.ptx.sreg.ntid.y"() : () -> i32
      ...
      %881 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      ...
      "scf.if"(%997) ({
        %4580 = "nvvm.read.ptx.sreg.ctaid.x"() : () -> i32
        %4581 = "nvvm.read.ptx.sreg.ctaid.y"() : () -> i32
        %4582 = "nvvm.read.ptx.sreg.ctaid.z"() : () -> i32
        %4583 = "nvvm.read.ptx.sreg.nctaid.x"() : () -> i32
        %4584 = "nvvm.read.ptx.sreg.nctaid.y"() : () -> i32
        %4585 = "nvvm.read.ptx.sreg.nctaid.z"() : () -> i32
      ...
      %1000:2 = "scf.if"(%999) ({
        ...
        %1001 = "nvvm.read.ptx.sreg.ctaid.x"() : () -> i32
        %1002 = "nvvm.read.ptx.sreg.ctaid.y"() : () -> i32
        %1003 = "nvvm.read.ptx.sreg.ctaid.z"() : () -> i32
        %1004 = "nvvm.read.ptx.sreg.nctaid.x"() : () -> i32
        %1005 = "nvvm.read.ptx.sreg.nctaid.y"() : () -> i32
        %1006 = "nvvm.read.ptx.sreg.nctaid.z"() : () -> i32
