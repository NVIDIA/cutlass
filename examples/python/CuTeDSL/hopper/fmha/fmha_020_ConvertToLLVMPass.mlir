"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32, i32)>, struct<(i64, i64, i64, i64)>)>)>, %arg5: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32, i32)>, struct<(i64, i64, i64, i64, i64)>)>)>, %arg6: !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32, i32, i32)>, struct<()>)>)>, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32):
      ...
      %404 = "builtin.unrealized_conversion_cast"(%403) : (!llvm.ptr<1>) -> !cute.ptr<f16, gmem>
      %405 = "llvm.extractvalue"(%398) <{position = array<i64: 1, 0>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> i64
      %406 = "llvm.extractvalue"(%398) <{position = array<i64: 1, 1>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> i64
      %407 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %408 = "llvm.insertvalue"(%407, %262) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, i64)>, !llvm.struct<()>) -> !llvm.struct<(struct<()>, i64)>
      %409 = "llvm.insertvalue"(%408, %406) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %410 = "llvm.extractvalue"(%398) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> !llvm.struct<()>
      %411 = "llvm.extractvalue"(%398) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> !llvm.struct<(i64, i64)>
      %412 = "llvm.extractvalue"(%411) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>) -> i64
      %413 = "llvm.extractvalue"(%411) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i64)>) -> i64
      %414 = "llvm.sext"(%267) : (i32) -> i64
      %415 = "llvm.mul"(%414, %412) <{overflowFlags = #llvm.overflow<none>}> : (i64, i64) -> i64
      %416 = "llvm.getelementptr"(%354, %415) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i64) -> !llvm.ptr<1>
      %417 = "builtin.unrealized_conversion_cast"(%416) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %418 = "llvm.extractvalue"(%261) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %419 = "llvm.extractvalue"(%261) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %420 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %421 = "llvm.mul"(%267, %420) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %422 = "llvm.extractvalue"(%390) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %423 = "llvm.extractvalue"(%390) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %424 = "llvm.extractvalue"(%390) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %425 = "llvm.extractvalue"(%390) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %426 = "llvm.extractvalue"(%390) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %427 = "llvm.add"(%423, %421) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %428 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %429 = "llvm.insertvalue"(%428, %422) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %430 = "llvm.insertvalue"(%429, %427) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %431 = "llvm.insertvalue"(%430, %424) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %432 = "llvm.insertvalue"(%431, %425) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %433 = "llvm.insertvalue"(%432, %426) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %434 = "llvm.extractvalue"(%433) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %435 = "llvm.extractvalue"(%433) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %436 = "llvm.extractvalue"(%433) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %437 = "llvm.extractvalue"(%433) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %438 = "llvm.extractvalue"(%433) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %439 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %440 = "llvm.insertvalue"(%439, %434) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %441 = "llvm.insertvalue"(%440, %435) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %442 = "llvm.insertvalue"(%441, %436) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %443 = "llvm.insertvalue"(%442, %437) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %444 = "llvm.insertvalue"(%443, %438) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %445 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %446 = "llvm.insertvalue"(%445, %arg7) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %447 = "llvm.insertvalue"(%446, %arg8) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %448 = "llvm.insertvalue"(%447, %arg9) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %449 = "llvm.insertvalue"(%448, %arg10) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %450 = "llvm.insertvalue"(%449, %arg11) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32)>
      %451 = "llvm.extractvalue"(%444) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %452 = "llvm.extractvalue"(%444) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %453 = "llvm.extractvalue"(%444) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %454 = "llvm.extractvalue"(%444) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %455 = "llvm.extractvalue"(%444) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %456 = "llvm.extractvalue"(%450) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %457 = "llvm.extractvalue"(%450) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %458 = "llvm.extractvalue"(%450) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %459 = "llvm.extractvalue"(%450) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %460 = "llvm.extractvalue"(%450) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32)>) -> i32
      %461 = "llvm.icmp"(%451, %456) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %462 = "llvm.icmp"(%452, %457) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %463 = "llvm.and"(%461, %462) : (i1, i1) -> i1
      %464 = "llvm.icmp"(%453, %458) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %465 = "llvm.and"(%463, %464) : (i1, i1) -> i1
      %466 = "llvm.icmp"(%454, %459) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %467 = "llvm.and"(%465, %466) : (i1, i1) -> i1
      %468 = "llvm.icmp"(%455, %460) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %469 = "llvm.and"(%467, %468) : (i1, i1) -> i1
      "llvm.cond_br"(%469)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb1:  // pred: ^bb0
      %470 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %471 = "llvm.insertvalue"(%470, %256) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %472 = "llvm.insertvalue"(%471, %253) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %473 = "llvm.extractvalue"(%472) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %474 = "builtin.unrealized_conversion_cast"(%473) : (!llvm.ptr) -> !cute.ptr<f16, rmem, align<32>>
      %475 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %476 = "llvm.insertvalue"(%475, %252) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %477 = "llvm.insertvalue"(%476, %249) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %478 = "llvm.extractvalue"(%477) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %479 = "builtin.unrealized_conversion_cast"(%478) : (!llvm.ptr) -> !cute.ptr<f32, rmem, align<32>>
      %480 = "builtin.unrealized_conversion_cast"(%404) : (!cute.ptr<f16, gmem>) -> !llvm.ptr<1>
      %481 = "builtin.unrealized_conversion_cast"(%474) : (!cute.ptr<f16, rmem, align<32>>) -> !llvm.ptr
      %482 = "llvm.load"(%480) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf16>
      "llvm.store"(%482, %481) <{alignment = 2 : i64, ordering = 0 : i64}> : (vector<1xf16>, !llvm.ptr) -> ()
      %483 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %484 = "llvm.getelementptr"(%403, %483) <{elem_type = f16, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %485 = "builtin.unrealized_conversion_cast"(%484) : (!llvm.ptr<1>) -> !cute.ptr<f16, gmem>
      %486 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %487 = "llvm.getelementptr"(%473, %486) <{elem_type = f16, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %488 = "builtin.unrealized_conversion_cast"(%487) : (!llvm.ptr) -> !cute.ptr<f16, rmem>
      %489 = "builtin.unrealized_conversion_cast"(%485) : (!cute.ptr<f16, gmem>) -> !llvm.ptr<1>
      %490 = "builtin.unrealized_conversion_cast"(%488) : (!cute.ptr<f16, rmem>) -> !llvm.ptr
      %491 = "llvm.load"(%489) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf16>
      "llvm.store"(%491, %490) <{alignment = 2 : i64, ordering = 0 : i64}> : (vector<1xf16>, !llvm.ptr) -> ()
      %492 = "llvm.mlir.poison"() : () -> !llvm.array<1 x vector<2xf16>>
      %493 = "builtin.unrealized_conversion_cast"(%492) : (!llvm.array<1 x vector<2xf16>>) -> vector<1x2xf16>
      %494 = "llvm.extractvalue"(%472) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %495 = "llvm.getelementptr"(%494) <{elem_type = f16, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      %496 = "llvm.load"(%495) <{alignment = 32 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<2xf16>
      %497 = "vector.insert"(%496, %493) <{static_position = array<i64: 0>}> : (vector<2xf16>, vector<1x2xf16>) -> vector<1x2xf16>
      %498 = "vector.shape_cast"(%497) : (vector<1x2xf16>) -> vector<2xf16>
      %499 = "llvm.fpext"(%498) : (vector<2xf16>) -> vector<2xf32>
      %500 = "vector.shape_cast"(%499) : (vector<2xf32>) -> vector<1x2xf32>
      %501 = "llvm.extractvalue"(%477) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %502 = "vector.extract"(%500) <{static_position = array<i64: 0>}> : (vector<1x2xf32>) -> vector<2xf32>
      %503 = "llvm.getelementptr"(%501) <{elem_type = f32, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%502, %503) <{alignment = 32 : i64, ordering = 0 : i64}> : (vector<2xf32>, !llvm.ptr) -> ()
      %504 = "llvm.extractvalue"(%409) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %505 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %506 = "llvm.insertvalue"(%505, %504) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %507 = "llvm.extractvalue"(%506) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %508 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %509 = "llvm.insertvalue"(%508, %258) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, i64)>, !llvm.struct<()>) -> !llvm.struct<(struct<()>, i64)>
      %510 = "llvm.insertvalue"(%509, %507) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %511 = "llvm.extractvalue"(%510) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %512 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %513 = "llvm.insertvalue"(%512, %511) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %514 = "llvm.extractvalue"(%513) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %515 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %516 = "llvm.insertvalue"(%515, %257) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, i64)>, !llvm.struct<()>) -> !llvm.struct<(struct<()>, i64)>
      %517 = "llvm.insertvalue"(%516, %514) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %518 = "llvm.extractvalue"(%517) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %519 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, i64)>
      %520 = "llvm.insertvalue"(%519, %262) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, i64)>, !llvm.struct<()>) -> !llvm.struct<(struct<()>, i64)>
      %521 = "llvm.insertvalue"(%520, %518) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>, i64) -> !llvm.struct<(struct<()>, i64)>
      %522 = "llvm.extractvalue"(%521) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, i64)>) -> i64
      %523 = "builtin.unrealized_conversion_cast"(%479) : (!cute.ptr<f32, rmem, align<32>>) -> !llvm.ptr
      %524 = "builtin.unrealized_conversion_cast"(%417) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
      ...
      %527 = "llvm.getelementptr"(%478, %526) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %528 = "builtin.unrealized_conversion_cast"(%527) : (!llvm.ptr) -> !cute.ptr<f32, rmem>
      %529 = "llvm.getelementptr"(%416, %522) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i64) -> !llvm.ptr<1>
      %530 = "builtin.unrealized_conversion_cast"(%529) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %531 = "builtin.unrealized_conversion_cast"(%528) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
      %532 = "builtin.unrealized_conversion_cast"(%530) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
