    ...
    func.func public @kernel_cutlass__convert_kernel_tensorptrf16gmemalign16o125611101000256_tensorptrf32gmemalign16o12561110000div2561_tensor00000o1256111011000102561121314______Float16_Float32_0(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f32_, %arg2: !cute.coord_tensor<"(0,0,0,0,0)", "((1,256,1,1,1),(?,?,?,?,?)):((0,1@1,0,0,0),(1@0,256@1,1@2,1@3,1@4))">, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %26 {
        ...
        scf.for %arg8 = %c0_i32 to %27 step %c1_i32  : i32 {
          %32 = builtin.unrealized_conversion_cast %ptr_11 : !cute.ptr<f16, gmem> to !llvm.ptr<1>
          %33 = builtin.unrealized_conversion_cast %iter_20 : !cute.ptr<f16, rmem, align<32>> to !llvm.ptr
          %34 = llvm.load %32 {alignment = 2 : i64} : !llvm.ptr<1> -> vector<1xf16>
          llvm.store %34, %33 {alignment = 2 : i64} : vector<1xf16>, !llvm.ptr
          %ptr_28 = cute.add_offset(%ptr_11, %2) : (!cute.ptr<f16, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f16, gmem>
          %ptr_29 = cute.add_offset(%iter_20, %2) : (!cute.ptr<f16, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f16, rmem>
          %35 = builtin.unrealized_conversion_cast %ptr_28 : !cute.ptr<f16, gmem> to !llvm.ptr<1>
          %36 = builtin.unrealized_conversion_cast %ptr_29 : !cute.ptr<f16, rmem> to !llvm.ptr
          %37 = llvm.load %35 {alignment = 2 : i64} : !llvm.ptr<1> -> vector<1xf16>
          llvm.store %37, %36 {alignment = 2 : i64} : vector<1xf16>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %28 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f16_
        %29 = arith.extf %28 : vector<2xf16> to vector<2xf32>
        cute.memref.store_vec %29, %rmem_21, row_major : !memref_rmem_f32_
        ...
        %lay_24 = cute.make_layout(%1, %stride_23) : !cute.layout<"(2,(1)):(?{i64},(0))">
        %append_25 = cute.append_to_rank<2> (%lay_24, %3) : !cute.layout<"(2,(1)):(?{i64},(0))">, !cute.layout<"1:0">
        %31 = cute.get_scalars(%append_25) <{only_dynamic}> : !cute.layout<"(2,(1)):(?{i64},(0))">
        %stride_26 = cute.make_stride(%31) : (i64) -> !cute.stride<"(?{i64},((0)))">
        %lay_27 = cute.make_layout(%0, %stride_26) : !cute.layout<"(2,((1))):(?{i64},((0)))">
        scf.for %arg8 = %c0_i32 to %27 step %c1_i32  : i32 {
          %32 = cute.get_scalars(%lay_27) <{only_dynamic}> : !cute.layout<"(2,((1))):(?{i64},((0)))">
          %stride_28 = cute.make_stride(%32) : (i64) -> !cute.stride<"(?{i64})">
          %lay_29 = cute.make_layout(%5, %stride_28) : !cute.layout<"(2):(?{i64})">
          %33 = cute.get_scalars(%lay_29) <{only_dynamic}> : !cute.layout<"(2):(?{i64})">
          %34 = builtin.unrealized_conversion_cast %iter_22 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
          %35 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %36 = llvm.load %34 {alignment = 4 : i64} : !llvm.ptr -> vector<1xf32>
          llvm.store %36, %35 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr<1>
          %ptr_30 = cute.add_offset(%iter_22, %2) : (!cute.ptr<f32, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f32, rmem>
          %int_tuple = cute.make_int_tuple(%33) : (i64) -> !cute.int_tuple<"?{i64}">
          %ptr_31 = cute.add_offset(%ptr_15, %int_tuple) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<f32, gmem>
          %37 = builtin.unrealized_conversion_cast %ptr_30 : !cute.ptr<f32, rmem> to !llvm.ptr
          %38 = builtin.unrealized_conversion_cast %ptr_31 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %39 = llvm.load %37 {alignment = 4 : i64} : !llvm.ptr -> vector<1xf32>
          llvm.store %39, %38 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
