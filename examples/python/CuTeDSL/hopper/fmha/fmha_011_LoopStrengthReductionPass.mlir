    ...
    func.func public @kernel_cutlass__convert_kernel_tensorptrf16gmemalign16o125611101000256_tensorptrf32gmemalign16o12561110000div2561_tensor00000o1256111011000102561121314______Float16_Float32_0(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f32_, %arg2: !cute.coord_tensor<"(0,0,0,0,0)", "((1,256,1,1,1),(?,?,?,?,?)):((0,1@1,0,0,0),(1@0,256@1,1@2,1@3,1@4))">, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %26 {
        ...
        scf.for %arg8 = %c0_i32 to %27 step %c1_i32  : i32 {
          %42 = llvm.load %28 {alignment = 2 : i64} : !llvm.ptr<1> -> vector<1xf16>
          llvm.store %42, %29 {alignment = 2 : i64} : vector<1xf16>, !llvm.ptr
          %43 = llvm.load %30 {alignment = 2 : i64} : !llvm.ptr<1> -> vector<1xf16>
          llvm.store %43, %31 {alignment = 2 : i64} : vector<1xf16>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %32 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f16_
        %33 = arith.extf %32 : vector<2xf16> to vector<2xf32>
        cute.memref.store_vec %33, %rmem_21, row_major : !memref_rmem_f32_
        %append = cute.append_to_rank<2> (%lay_13, %3) : !cute.layout<"(2):(?{i64})">, !cute.layout<"1:0">
        %34 = cute.get_scalars(%append) <{only_dynamic}> : !cute.layout<"(2,1):(?{i64},0)">
        %stride_25 = cute.make_stride(%34) : (i64) -> !cute.stride<"(?{i64},(0))">
        ...
        %35 = cute.get_scalars(%append_27) <{only_dynamic}> : !cute.layout<"(2,(1)):(?{i64},(0))">
        %stride_28 = cute.make_stride(%35) : (i64) -> !cute.stride<"(?{i64},((0)))">
        %lay_29 = cute.make_layout(%0, %stride_28) : !cute.layout<"(2,((1))):(?{i64},((0)))">
        %36 = cute.get_scalars(%lay_29) <{only_dynamic}> : !cute.layout<"(2,((1))):(?{i64},((0)))">
        %stride_30 = cute.make_stride(%36) : (i64) -> !cute.stride<"(?{i64})">
        %lay_31 = cute.make_layout(%5, %stride_30) : !cute.layout<"(2):(?{i64})">
        %37 = cute.get_scalars(%lay_31) <{only_dynamic}> : !cute.layout<"(2):(?{i64})">
        %38 = builtin.unrealized_conversion_cast %iter_22 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
        %39 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
        %ptr_32 = cute.add_offset(%iter_22, %2) : (!cute.ptr<f32, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f32, rmem>
        %int_tuple = cute.make_int_tuple(%37) : (i64) -> !cute.int_tuple<"?{i64}">
        %ptr_33 = cute.add_offset(%ptr_15, %int_tuple) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<f32, gmem>
        %40 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<f32, rmem> to !llvm.ptr
        %41 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
        scf.for %arg8 = %c0_i32 to %27 step %c1_i32  : i32 {
          %42 = llvm.load %38 {alignment = 4 : i64} : !llvm.ptr -> vector<1xf32>
          llvm.store %42, %39 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr<1>
          %43 = llvm.load %40 {alignment = 4 : i64} : !llvm.ptr -> vector<1xf32>
          llvm.store %43, %41 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
