...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg5: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg6: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg7: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg8: !cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, tma_format = F16_RN>, %arg9: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg10: !mma_f16_f16_f32_64x128x16_):
      ...
      %630 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %631 = "nvvm.read.ptx.sreg.tid.y"() : () -> i32
      %632 = "nvvm.read.ptx.sreg.tid.z"() : () -> i32
      %633 = "nvvm.read.ptx.sreg.ntid.x"() : () -> i32
      %634 = "nvvm.read.ptx.sreg.ntid.y"() : () -> i32
      ...
      %645 = "nvvm.read.ptx.sreg.ctaid.z"() : () -> i32
      ...
      %691 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %692 = "nvvm.read.ptx.sreg.tid.y"() : () -> i32
      %693 = "nvvm.read.ptx.sreg.tid.z"() : () -> i32
      %694 = "nvvm.read.ptx.sreg.ntid.x"() : () -> i32
      %695 = "nvvm.read.ptx.sreg.ntid.y"() : () -> i32
      ...
      %706 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %707 = "nvvm.read.ptx.sreg.tid.y"() : () -> i32
      %708 = "nvvm.read.ptx.sreg.tid.z"() : () -> i32
      %709 = "nvvm.read.ptx.sreg.ntid.x"() : () -> i32
      %710 = "nvvm.read.ptx.sreg.ntid.y"() : () -> i32
      ...
      %719 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
