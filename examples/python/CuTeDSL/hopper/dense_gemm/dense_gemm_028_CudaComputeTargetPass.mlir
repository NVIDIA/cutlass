gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb20(%220: i32, %221: i32, %222: i32, %223: i32):  // 2 preds: ^bb19, ^bb37
    ...
    llvm.cond_br %224, ^bb21, ^bb38(%221, %222, %223 : i32, i32, i32) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb21:  // pred: ^bb20
  ...
  ^bb24(%234: i32):  // 2 preds: ^bb23, ^bb27
    ...
    llvm.cond_br %235, ^bb25, ^bb28 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb25:  // pred: ^bb24
  ...
  ^bb29(%238: i32):  // 2 preds: ^bb28, ^bb32
    ...
    llvm.cond_br %239, ^bb30, ^bb33 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb30:  // pred: ^bb29
  ...
  ^bb47(%258: i32, %259: !llvm.struct<(i1)>):  // 2 preds: ^bb46, ^bb57
    ...
    llvm.cond_br %260, ^bb48, ^bb58 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb48:  // pred: ^bb47
  ...
  ^bb49(%272: i32):  // 2 preds: ^bb48, ^bb56
    ...
    llvm.cond_br %273, ^bb50, ^bb57 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb50:  // pred: ^bb49
    llvm.br ^bb51(%22 : i32)
  ^bb51(%274: i32):  // 2 preds: ^bb50, ^bb55
    %275 = llvm.icmp "slt" %274, %31 : i32
    llvm.cond_br %275, ^bb52, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb52:  // pred: ^bb51
  ...
  ^bb53(%281: i32):  // 2 preds: ^bb52, ^bb54
    ...
    llvm.cond_br %282, ^bb54, ^bb55 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb54:  // pred: ^bb53
  ...
  ^bb63(%488: i32, %489: i1, %490: i32, %491: i32, %492: i32, %493: i32, %494: i32, %495: i32, %496: i32):  // 2 preds: ^bb62, ^bb110
    ...
    llvm.cond_br %497, ^bb64, ^bb111 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb64:  // pred: ^bb63
  ...
  ^bb67(%501: i32):  // 2 preds: ^bb66, ^bb77
    ...
    llvm.cond_br %502, ^bb68, ^bb78 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb68:  // pred: ^bb67
  ...
  ^bb69(%515: i32):  // 2 preds: ^bb68, ^bb76
    ...
    llvm.cond_br %516, ^bb70, ^bb77 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb70:  // pred: ^bb69
    llvm.br ^bb71(%22 : i32)
  ^bb71(%517: i32):  // 2 preds: ^bb70, ^bb75
    %518 = llvm.icmp "slt" %517, %31 : i32
    llvm.cond_br %518, ^bb72, ^bb76 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
  ...
  ^bb73(%524: i32):  // 2 preds: ^bb72, ^bb74
    ...
    llvm.cond_br %525, ^bb74, ^bb75 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb95(%752: i32):  // 2 preds: ^bb94, ^bb98
    ...
    llvm.cond_br %753, ^bb96, ^bb99 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb96:  // pred: ^bb95
  ...
  ^bb100(%757: i32):  // 2 preds: ^bb99, ^bb103
    ...
    llvm.cond_br %758, ^bb101, ^bb104 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb101:  // pred: ^bb100
  ...
  ^bb112(%897: i32):  // 2 preds: ^bb111, ^bb113
    ...
    llvm.cond_br %898, ^bb113, ^bb114 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb113:  // pred: ^bb112
  ...
  ^bb116(%916: i32):  // 2 preds: ^bb115, ^bb117
    ...
    llvm.cond_br %917, ^bb117, ^bb118 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb117:  // pred: ^bb116
  ...
  ^bb120(%986: i32):  // 2 preds: ^bb119, ^bb121
    ...
    llvm.cond_br %987, ^bb121, ^bb122 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb121:  // pred: ^bb120
  ...
  ^bb124(%1007: i32):  // 2 preds: ^bb123, ^bb125
    ...
    llvm.cond_br %1008, ^bb125, ^bb126 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb125:  // pred: ^bb124
  ...
  ^bb128(%1077: i32):  // 2 preds: ^bb127, ^bb129
    ...
    llvm.cond_br %1078, ^bb129, ^bb130 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb129:  // pred: ^bb128
  ...
  ^bb132(%1098: i32):  // 2 preds: ^bb131, ^bb133
    ...
    llvm.cond_br %1099, ^bb133, ^bb134 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb133:  // pred: ^bb132
  ...
  ^bb136(%1168: i32):  // 2 preds: ^bb135, ^bb137
    ...
    llvm.cond_br %1169, ^bb137, ^bb138 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb137:  // pred: ^bb136
  ...
  ^bb140(%1189: i32):  // 2 preds: ^bb139, ^bb141
    ...
    llvm.cond_br %1190, ^bb141, ^bb142 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb141:  // pred: ^bb140
  ...
  ^bb144(%1258: i32):  // 2 preds: ^bb143, ^bb145
    ...
    llvm.cond_br %1259, ^bb145, ^bb146 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb145:  // pred: ^bb144
  ...
  ^bb148(%1278: i32):  // 2 preds: ^bb147, ^bb149
    ...
    llvm.cond_br %1279, ^bb149, ^bb150 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb149:  // pred: ^bb148
  ...
  ^bb152(%1347: i32):  // 2 preds: ^bb151, ^bb153
    ...
    llvm.cond_br %1348, ^bb153, ^bb154 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb153:  // pred: ^bb152
  ...
  ^bb156(%1369: i32):  // 2 preds: ^bb155, ^bb157
    ...
    llvm.cond_br %1370, ^bb157, ^bb158 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb157:  // pred: ^bb156
  ...
  ^bb160(%1438: i32):  // 2 preds: ^bb159, ^bb161
    ...
    llvm.cond_br %1439, ^bb161, ^bb162 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb161:  // pred: ^bb160
  ...
  ^bb164(%1460: i32):  // 2 preds: ^bb163, ^bb165
    ...
    llvm.cond_br %1461, ^bb165, ^bb166 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb165:  // pred: ^bb164
  ...
  ^bb168(%1529: i32):  // 2 preds: ^bb167, ^bb169
    ...
    llvm.cond_br %1530, ^bb169, ^bb170 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb169:  // pred: ^bb168
  ...
  ^bb172(%1551: i32):  // 2 preds: ^bb171, ^bb173
    ...
    llvm.cond_br %1552, ^bb173, ^bb174 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb173:  // pred: ^bb172
