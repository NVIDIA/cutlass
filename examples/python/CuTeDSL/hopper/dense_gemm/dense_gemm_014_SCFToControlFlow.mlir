...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb15:  // 2 preds: ^bb13, ^bb14
      ...
      %250 = cute_nvgpu.atom.get_value(%248 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
      ...
      %251:3 = cute.get_scalars(%int_tuple_87) : !cute.int_tuple<"(?{div=64},?{div=128},?)">
      cf.br ^bb16(%c0_i32 : i32)
    ^bb16(%252: i32):  // 2 preds: ^bb15, ^bb17
      %253 = arith.cmpi slt, %252, %238 : i32
      cf.cond_br %253, ^bb17, ^bb18 {llvm.loop_annotation = #loop_annotation1}
    ^bb17:  // pred: ^bb16
      cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_79 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, %249 : !cute.ptr<smem, align<8>>, [%251#0, %251#1, %251#2] : i32, i32, i32) cache_policy = %250 mode = <tiled> num_cta = 1 : i32
    ...
    ^bb18:  // pred: ^bb16
      ...
      %255 = cute_nvgpu.atom.set_value(%239, %ptr_86 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>
      %256 = cute_nvgpu.atom.get_value(%255 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
      %257 = cute_nvgpu.atom.get_value(%255 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
      %TMADescAddr_89 = cute_nvgpu.get_tma_desc_addr(%255 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %258:3 = cute.get_scalars(%int_tuple_88) : !cute.int_tuple<"(?{div=64},?{div=128},?)">
      cf.br ^bb19(%c0_i32 : i32)
    ^bb19(%259: i32):  // 2 preds: ^bb18, ^bb20
      %260 = arith.cmpi slt, %259, %238 : i32
      cf.cond_br %260, ^bb20, ^bb21 {llvm.loop_annotation = #loop_annotation1}
    ^bb20:  // pred: ^bb19
      cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_89 : !cute.ptr<generic, align<64>>, %ptr_85 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, %256 : !cute.ptr<smem, align<8>>, [%258#0, %258#1, %258#2] : i32, i32, i32) cache_policy = %257 mode = <tiled> num_cta = 1 : i32
      %261 = arith.addi %259, %c1_i32 : i32
      cf.br ^bb19(%261 : i32)
    ^bb21:  // pred: ^bb19
      %262 = arith.addi %242, %c1_i32 : i32
      %263 = arith.addi %241, %c1_i32 : i32
      %264 = arith.cmpi eq, %262, %c7_i32 : i32
      %265 = arith.select %264, %c0_i32, %262 : i32
      cf.cond_br %264, ^bb22, ^bb23
    ^bb22:  // pred: ^bb21
      %266 = arith.xori %243, %c1_i32 : i32
      cf.br ^bb24(%266 : i32)
    ^bb23:  // pred: ^bb21
      cf.br ^bb24(%243 : i32)
    ^bb24(%267: i32):  // 2 preds: ^bb22, ^bb23
      cf.br ^bb25
    ^bb25:  // pred: ^bb24
      %268 = arith.addi %240, %c1_i32 : i32
      cf.br ^bb12(%268, %263, %265, %267 : i32, i32, i32, i32)
    ^bb26:  // pred: ^bb12
      cf.br ^bb28(%241, %242, %243 : i32, i32, i32)
    ^bb27:  // pred: ^bb10
      cf.br ^bb28(%c0_i32, %c0_i32, %c1_i32 : i32, i32, i32)
    ^bb28(%269: i32, %270: i32, %271: i32):  // 2 preds: ^bb26, ^bb27
      cf.br ^bb29
    ^bb29:  // pred: ^bb28
      %272 = arith.cmpi sgt, %234, %c0_i32 : i32
      cf.cond_br %272, ^bb30, ^bb31
    ^bb30:  // pred: ^bb29
      %dyn_90 = cute.derefine(%iter) : !cute.ptr<i64, smem, align<1024>> to !cute.ptr<i64, smem>
      %273 = builtin.unrealized_conversion_cast %dyn_90 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      %274 = nvvm.mbarrier.wait.parity %273, %c0_i32 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
      cf.br ^bb32(%274 : i1)
    ^bb31:  // pred: ^bb29
      cf.br ^bb32(%true : i1)
    ^bb32(%275: i1):  // 2 preds: ^bb30, ^bb31
      cf.br ^bb33
    ^bb33:  // pred: ^bb32
      %276 = cute_nvgpu.atom.set_value(%arg6, %false : i1) {field = #cute_nvgpu.atom_mma_field_sm90<accum_c>} : !mma_f16_f16_f32_64x128x16_
      %277 = builtin.unrealized_conversion_cast %276 : !mma_f16_f16_f32_64x128x16_ to !llvm.struct<(i1)>
      %278 = arith.extui %275 : i1 to i32
      %279 = arith.cmpi eq, %278, %c0_i32 : i32
      cf.cond_br %279, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
      %dyn_91 = cute.derefine(%iter) : !cute.ptr<i64, smem, align<1024>> to !cute.ptr<i64, smem>
      %280 = builtin.unrealized_conversion_cast %dyn_91 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.try_wait.parity.shared %280, %c0_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      cf.br ^bb35
    ^bb35:  // 2 preds: ^bb33, ^bb34
      nvvm.wgmma.fence.aligned
      %iter_92 = cute.get_iter(%rmem) : !memref_rmem_f32_
      %281 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %282 = cute.get_scalars(%156) : !cute.int_tuple<"2">
      cf.br ^bb36(%c0_i32, %277 : i32, !llvm.struct<(i1)>)
    ^bb36(%283: i32, %284: !llvm.struct<(i1)>):  // 2 preds: ^bb35, ^bb46
      %285 = arith.cmpi slt, %283, %c4_i32 : i32
      cf.cond_br %285, ^bb37, ^bb47 {loop_annotation = #loop_annotation2}
    ^bb37:  // pred: ^bb36
      %286 = builtin.unrealized_conversion_cast %284 : !llvm.struct<(i1)> to !mma_f16_f16_f32_64x128x16_
      %coord_93 = cute.make_coord(%283) : (i32) -> !cute.coord<"(_,_,?,0)">
      ...
      %287 = cute_nvgpu.atom.get_value(%286 : !mma_f16_f16_f32_64x128x16_) {field = #cute_nvgpu.atom_mma_field_sm90<accum_c>} : i1
      cf.br ^bb38(%c0_i32 : i32)
    ^bb38(%288: i32):  // 2 preds: ^bb37, ^bb45
      %289 = arith.cmpi slt, %288, %281 : i32
      cf.cond_br %289, ^bb39, ^bb46 {llvm.loop_annotation = #loop_annotation1}
    ^bb39:  // pred: ^bb38
      cf.br ^bb40(%c0_i32 : i32)
    ^bb40(%290: i32):  // 2 preds: ^bb39, ^bb44
      %291 = arith.cmpi slt, %290, %282 : i32
      cf.cond_br %291, ^bb41, ^bb45 {llvm.loop_annotation = #loop_annotation1}
    ^bb41:  // pred: ^bb40
      %coord_98 = cute.make_coord(%290, %288) : (i32, i32) -> !cute.coord<"(_,?,?)">
    ...
    ^bb42(%292: i32):  // 2 preds: ^bb41, ^bb43
      %293 = arith.cmpi slt, %292, %281 : i32
      cf.cond_br %293, ^bb43, ^bb44 {llvm.loop_annotation = #loop_annotation1}
    ^bb43:  // pred: ^bb42
      %coord_101 = cute.make_coord(%290, %292) : (i32, i32) -> !cute.coord<"(_,?,?)">
      ...
      %294 = builtin.unrealized_conversion_cast %ptr_103 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
      %295 = llvm.load %294 : !llvm.ptr -> f32
      %296 = llvm.getelementptr %294[1] : (!llvm.ptr) -> !llvm.ptr, f32
      %297 = llvm.load %296 : !llvm.ptr -> f32
      %298 = llvm.getelementptr %294[2] : (!llvm.ptr) -> !llvm.ptr, f32
      %299 = llvm.load %298 : !llvm.ptr -> f32
      %300 = llvm.getelementptr %294[3] : (!llvm.ptr) -> !llvm.ptr, f32
      %301 = llvm.load %300 : !llvm.ptr -> f32
      %302 = llvm.getelementptr %294[4] : (!llvm.ptr) -> !llvm.ptr, f32
      %303 = llvm.load %302 : !llvm.ptr -> f32
      %304 = llvm.getelementptr %294[5] : (!llvm.ptr) -> !llvm.ptr, f32
      %305 = llvm.load %304 : !llvm.ptr -> f32
      %306 = llvm.getelementptr %294[6] : (!llvm.ptr) -> !llvm.ptr, f32
      %307 = llvm.load %306 : !llvm.ptr -> f32
      %308 = llvm.getelementptr %294[7] : (!llvm.ptr) -> !llvm.ptr, f32
      %309 = llvm.load %308 : !llvm.ptr -> f32
      %310 = llvm.getelementptr %294[8] : (!llvm.ptr) -> !llvm.ptr, f32
      %311 = llvm.load %310 : !llvm.ptr -> f32
      %312 = llvm.getelementptr %294[9] : (!llvm.ptr) -> !llvm.ptr, f32
      %313 = llvm.load %312 : !llvm.ptr -> f32
      %314 = llvm.getelementptr %294[10] : (!llvm.ptr) -> !llvm.ptr, f32
      %315 = llvm.load %314 : !llvm.ptr -> f32
      %316 = llvm.getelementptr %294[11] : (!llvm.ptr) -> !llvm.ptr, f32
      %317 = llvm.load %316 : !llvm.ptr -> f32
      %318 = llvm.getelementptr %294[12] : (!llvm.ptr) -> !llvm.ptr, f32
      %319 = llvm.load %318 : !llvm.ptr -> f32
      %320 = llvm.getelementptr %294[13] : (!llvm.ptr) -> !llvm.ptr, f32
      %321 = llvm.load %320 : !llvm.ptr -> f32
      %322 = llvm.getelementptr %294[14] : (!llvm.ptr) -> !llvm.ptr, f32
      %323 = llvm.load %322 : !llvm.ptr -> f32
      %324 = llvm.getelementptr %294[15] : (!llvm.ptr) -> !llvm.ptr, f32
      %325 = llvm.load %324 : !llvm.ptr -> f32
      %326 = llvm.getelementptr %294[16] : (!llvm.ptr) -> !llvm.ptr, f32
      %327 = llvm.load %326 : !llvm.ptr -> f32
      %328 = llvm.getelementptr %294[17] : (!llvm.ptr) -> !llvm.ptr, f32
      %329 = llvm.load %328 : !llvm.ptr -> f32
      %330 = llvm.getelementptr %294[18] : (!llvm.ptr) -> !llvm.ptr, f32
      %331 = llvm.load %330 : !llvm.ptr -> f32
      %332 = llvm.getelementptr %294[19] : (!llvm.ptr) -> !llvm.ptr, f32
      %333 = llvm.load %332 : !llvm.ptr -> f32
      %334 = llvm.getelementptr %294[20] : (!llvm.ptr) -> !llvm.ptr, f32
      %335 = llvm.load %334 : !llvm.ptr -> f32
      %336 = llvm.getelementptr %294[21] : (!llvm.ptr) -> !llvm.ptr, f32
      %337 = llvm.load %336 : !llvm.ptr -> f32
      %338 = llvm.getelementptr %294[22] : (!llvm.ptr) -> !llvm.ptr, f32
      %339 = llvm.load %338 : !llvm.ptr -> f32
      %340 = llvm.getelementptr %294[23] : (!llvm.ptr) -> !llvm.ptr, f32
      %341 = llvm.load %340 : !llvm.ptr -> f32
      %342 = llvm.getelementptr %294[24] : (!llvm.ptr) -> !llvm.ptr, f32
      %343 = llvm.load %342 : !llvm.ptr -> f32
      %344 = llvm.getelementptr %294[25] : (!llvm.ptr) -> !llvm.ptr, f32
      %345 = llvm.load %344 : !llvm.ptr -> f32
      %346 = llvm.getelementptr %294[26] : (!llvm.ptr) -> !llvm.ptr, f32
      %347 = llvm.load %346 : !llvm.ptr -> f32
      %348 = llvm.getelementptr %294[27] : (!llvm.ptr) -> !llvm.ptr, f32
      %349 = llvm.load %348 : !llvm.ptr -> f32
      %350 = llvm.getelementptr %294[28] : (!llvm.ptr) -> !llvm.ptr, f32
      %351 = llvm.load %350 : !llvm.ptr -> f32
      %352 = llvm.getelementptr %294[29] : (!llvm.ptr) -> !llvm.ptr, f32
      %353 = llvm.load %352 : !llvm.ptr -> f32
      %354 = llvm.getelementptr %294[30] : (!llvm.ptr) -> !llvm.ptr, f32
      %355 = llvm.load %354 : !llvm.ptr -> f32
      %356 = llvm.getelementptr %294[31] : (!llvm.ptr) -> !llvm.ptr, f32
      %357 = llvm.load %356 : !llvm.ptr -> f32
      %358 = llvm.getelementptr %294[32] : (!llvm.ptr) -> !llvm.ptr, f32
      %359 = llvm.load %358 : !llvm.ptr -> f32
      %360 = llvm.getelementptr %294[33] : (!llvm.ptr) -> !llvm.ptr, f32
      %361 = llvm.load %360 : !llvm.ptr -> f32
      %362 = llvm.getelementptr %294[34] : (!llvm.ptr) -> !llvm.ptr, f32
      %363 = llvm.load %362 : !llvm.ptr -> f32
      %364 = llvm.getelementptr %294[35] : (!llvm.ptr) -> !llvm.ptr, f32
      %365 = llvm.load %364 : !llvm.ptr -> f32
      %366 = llvm.getelementptr %294[36] : (!llvm.ptr) -> !llvm.ptr, f32
      %367 = llvm.load %366 : !llvm.ptr -> f32
      %368 = llvm.getelementptr %294[37] : (!llvm.ptr) -> !llvm.ptr, f32
      %369 = llvm.load %368 : !llvm.ptr -> f32
      %370 = llvm.getelementptr %294[38] : (!llvm.ptr) -> !llvm.ptr, f32
      %371 = llvm.load %370 : !llvm.ptr -> f32
      %372 = llvm.getelementptr %294[39] : (!llvm.ptr) -> !llvm.ptr, f32
      %373 = llvm.load %372 : !llvm.ptr -> f32
      %374 = llvm.getelementptr %294[40] : (!llvm.ptr) -> !llvm.ptr, f32
      %375 = llvm.load %374 : !llvm.ptr -> f32
      %376 = llvm.getelementptr %294[41] : (!llvm.ptr) -> !llvm.ptr, f32
      %377 = llvm.load %376 : !llvm.ptr -> f32
      %378 = llvm.getelementptr %294[42] : (!llvm.ptr) -> !llvm.ptr, f32
      %379 = llvm.load %378 : !llvm.ptr -> f32
      %380 = llvm.getelementptr %294[43] : (!llvm.ptr) -> !llvm.ptr, f32
      %381 = llvm.load %380 : !llvm.ptr -> f32
      %382 = llvm.getelementptr %294[44] : (!llvm.ptr) -> !llvm.ptr, f32
      %383 = llvm.load %382 : !llvm.ptr -> f32
      %384 = llvm.getelementptr %294[45] : (!llvm.ptr) -> !llvm.ptr, f32
      %385 = llvm.load %384 : !llvm.ptr -> f32
      %386 = llvm.getelementptr %294[46] : (!llvm.ptr) -> !llvm.ptr, f32
      %387 = llvm.load %386 : !llvm.ptr -> f32
      %388 = llvm.getelementptr %294[47] : (!llvm.ptr) -> !llvm.ptr, f32
      %389 = llvm.load %388 : !llvm.ptr -> f32
      %390 = llvm.getelementptr %294[48] : (!llvm.ptr) -> !llvm.ptr, f32
      %391 = llvm.load %390 : !llvm.ptr -> f32
      %392 = llvm.getelementptr %294[49] : (!llvm.ptr) -> !llvm.ptr, f32
      %393 = llvm.load %392 : !llvm.ptr -> f32
      %394 = llvm.getelementptr %294[50] : (!llvm.ptr) -> !llvm.ptr, f32
      %395 = llvm.load %394 : !llvm.ptr -> f32
      %396 = llvm.getelementptr %294[51] : (!llvm.ptr) -> !llvm.ptr, f32
      %397 = llvm.load %396 : !llvm.ptr -> f32
      %398 = llvm.getelementptr %294[52] : (!llvm.ptr) -> !llvm.ptr, f32
      %399 = llvm.load %398 : !llvm.ptr -> f32
      %400 = llvm.getelementptr %294[53] : (!llvm.ptr) -> !llvm.ptr, f32
      %401 = llvm.load %400 : !llvm.ptr -> f32
      %402 = llvm.getelementptr %294[54] : (!llvm.ptr) -> !llvm.ptr, f32
      %403 = llvm.load %402 : !llvm.ptr -> f32
      %404 = llvm.getelementptr %294[55] : (!llvm.ptr) -> !llvm.ptr, f32
      %405 = llvm.load %404 : !llvm.ptr -> f32
      %406 = llvm.getelementptr %294[56] : (!llvm.ptr) -> !llvm.ptr, f32
      %407 = llvm.load %406 : !llvm.ptr -> f32
      %408 = llvm.getelementptr %294[57] : (!llvm.ptr) -> !llvm.ptr, f32
      %409 = llvm.load %408 : !llvm.ptr -> f32
      %410 = llvm.getelementptr %294[58] : (!llvm.ptr) -> !llvm.ptr, f32
      %411 = llvm.load %410 : !llvm.ptr -> f32
      %412 = llvm.getelementptr %294[59] : (!llvm.ptr) -> !llvm.ptr, f32
      %413 = llvm.load %412 : !llvm.ptr -> f32
      %414 = llvm.getelementptr %294[60] : (!llvm.ptr) -> !llvm.ptr, f32
      %415 = llvm.load %414 : !llvm.ptr -> f32
      %416 = llvm.getelementptr %294[61] : (!llvm.ptr) -> !llvm.ptr, f32
      %417 = llvm.load %416 : !llvm.ptr -> f32
      %418 = llvm.getelementptr %294[62] : (!llvm.ptr) -> !llvm.ptr, f32
      %419 = llvm.load %418 : !llvm.ptr -> f32
      %420 = llvm.getelementptr %294[63] : (!llvm.ptr) -> !llvm.ptr, f32
      %421 = llvm.load %420 : !llvm.ptr -> f32
      %422:64 = cute_nvgpu.arch.mma.SM90(shapeMNK = "(64,128,16)", A = %tup_100 : [!cute_nvgpu.smem_desc, f16, #cute_nvgpu.major<k>], B = %tup_97 : [!cute_nvgpu.smem_desc, f16, #cute_nvgpu.major<k>], C[%295, %297, %299, %301, %303, %305, %307, %309, %311, %313, %315, %317, %319, %321, %323, %325, %327, %329, %331, %333, %335, %337, %339, %341, %343, %345, %347, %349, %351, %353, %355, %357, %359, %361, %363, %365, %367, %369, %371, %373, %375, %377, %379, %381, %383, %385, %387, %389, %391, %393, %395, %397, %399, %401, %403, %405, %407, %409, %411, %413, %415, %417, %419, %421], accum = %287 : i1)
< {cd_type = f32, operandSegmentSizes = array<i32: 1, 1, 64, 1>}> :(!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, f32, i1) -> (f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32)
      llvm.store %422#0, %294 : f32, !llvm.ptr
      llvm.store %422#1, %296 : f32, !llvm.ptr
      llvm.store %422#2, %298 : f32, !llvm.ptr
      llvm.store %422#3, %300 : f32, !llvm.ptr
      llvm.store %422#4, %302 : f32, !llvm.ptr
      llvm.store %422#5, %304 : f32, !llvm.ptr
      llvm.store %422#6, %306 : f32, !llvm.ptr
      llvm.store %422#7, %308 : f32, !llvm.ptr
      llvm.store %422#8, %310 : f32, !llvm.ptr
      llvm.store %422#9, %312 : f32, !llvm.ptr
      llvm.store %422#10, %314 : f32, !llvm.ptr
      llvm.store %422#11, %316 : f32, !llvm.ptr
      llvm.store %422#12, %318 : f32, !llvm.ptr
      llvm.store %422#13, %320 : f32, !llvm.ptr
      llvm.store %422#14, %322 : f32, !llvm.ptr
      llvm.store %422#15, %324 : f32, !llvm.ptr
      llvm.store %422#16, %326 : f32, !llvm.ptr
      llvm.store %422#17, %328 : f32, !llvm.ptr
      llvm.store %422#18, %330 : f32, !llvm.ptr
      llvm.store %422#19, %332 : f32, !llvm.ptr
      llvm.store %422#20, %334 : f32, !llvm.ptr
      llvm.store %422#21, %336 : f32, !llvm.ptr
      llvm.store %422#22, %338 : f32, !llvm.ptr
      llvm.store %422#23, %340 : f32, !llvm.ptr
      llvm.store %422#24, %342 : f32, !llvm.ptr
      llvm.store %422#25, %344 : f32, !llvm.ptr
      llvm.store %422#26, %346 : f32, !llvm.ptr
      llvm.store %422#27, %348 : f32, !llvm.ptr
      llvm.store %422#28, %350 : f32, !llvm.ptr
      llvm.store %422#29, %352 : f32, !llvm.ptr
      llvm.store %422#30, %354 : f32, !llvm.ptr
      llvm.store %422#31, %356 : f32, !llvm.ptr
      llvm.store %422#32, %358 : f32, !llvm.ptr
      llvm.store %422#33, %360 : f32, !llvm.ptr
      llvm.store %422#34, %362 : f32, !llvm.ptr
      llvm.store %422#35, %364 : f32, !llvm.ptr
      llvm.store %422#36, %366 : f32, !llvm.ptr
      llvm.store %422#37, %368 : f32, !llvm.ptr
      llvm.store %422#38, %370 : f32, !llvm.ptr
      llvm.store %422#39, %372 : f32, !llvm.ptr
      llvm.store %422#40, %374 : f32, !llvm.ptr
      llvm.store %422#41, %376 : f32, !llvm.ptr
      llvm.store %422#42, %378 : f32, !llvm.ptr
      llvm.store %422#43, %380 : f32, !llvm.ptr
      llvm.store %422#44, %382 : f32, !llvm.ptr
      llvm.store %422#45, %384 : f32, !llvm.ptr
      llvm.store %422#46, %386 : f32, !llvm.ptr
      llvm.store %422#47, %388 : f32, !llvm.ptr
      llvm.store %422#48, %390 : f32, !llvm.ptr
      llvm.store %422#49, %392 : f32, !llvm.ptr
      llvm.store %422#50, %394 : f32, !llvm.ptr
      llvm.store %422#51, %396 : f32, !llvm.ptr
      llvm.store %422#52, %398 : f32, !llvm.ptr
      llvm.store %422#53, %400 : f32, !llvm.ptr
      llvm.store %422#54, %402 : f32, !llvm.ptr
      llvm.store %422#55, %404 : f32, !llvm.ptr
      llvm.store %422#56, %406 : f32, !llvm.ptr
      llvm.store %422#57, %408 : f32, !llvm.ptr
      llvm.store %422#58, %410 : f32, !llvm.ptr
      llvm.store %422#59, %412 : f32, !llvm.ptr
      llvm.store %422#60, %414 : f32, !llvm.ptr
      llvm.store %422#61, %416 : f32, !llvm.ptr
      llvm.store %422#62, %418 : f32, !llvm.ptr
      llvm.store %422#63, %420 : f32, !llvm.ptr
      %423 = arith.addi %292, %c1_i32 : i32
      cf.br ^bb42(%423 : i32)
    ^bb44:  // pred: ^bb42
      %424 = arith.addi %290, %c1_i32 : i32
      cf.br ^bb40(%424 : i32)
    ^bb45:  // pred: ^bb40
      %425 = arith.addi %288, %c1_i32 : i32
      cf.br ^bb38(%425 : i32)
    ^bb46:  // pred: ^bb38
      %426 = cute_nvgpu.atom.set_value(%286, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm90<accum_c>} : !mma_f16_f16_f32_64x128x16_
      %427 = builtin.unrealized_conversion_cast %426 : !mma_f16_f16_f32_64x128x16_ to !llvm.struct<(i1)>
      %428 = arith.addi %283, %c1_i32 : i32
      cf.br ^bb36(%428, %427 : i32, !llvm.struct<(i1)>)
    ^bb47:  // pred: ^bb36
      %429 = builtin.unrealized_conversion_cast %284 : !llvm.struct<(i1)> to !mma_f16_f16_f32_64x128x16_
      nvvm.wgmma.commit.group.sync.aligned
      %430 = arith.cmpi sgt, %234, %c1_i32 : i32
      cf.cond_br %430, ^bb48, ^bb49
    ^bb48:  // pred: ^bb47
      ...
      %431 = builtin.unrealized_conversion_cast %ptr_105 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      %432 = nvvm.mbarrier.wait.parity %431, %c0_i32 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
      cf.br ^bb50(%432 : i1)
    ^bb49:  // pred: ^bb47
      cf.br ^bb50(%true : i1)
    ^bb50(%433: i1):  // 2 preds: ^bb48, ^bb49
      cf.br ^bb51
    ^bb51:  // pred: ^bb50
      %iter_106 = cute.get_iter(%rmem) : !memref_rmem_f32_
      %434 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %435 = cute.get_scalars(%156) : !cute.int_tuple<"2">
      %436 = cute_nvgpu.atom.get_value(%429 : !mma_f16_f16_f32_64x128x16_) {field = #cute_nvgpu.atom_mma_field_sm90<accum_c>} : i1
      %437 = arith.extui %172 : i1 to i32
      cf.br ^bb52(%c1_i32, %433, %c1_i32, %c1_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %269, %270, %271 : i32, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32)
    ^bb52(%438: i32, %439: i1, %440: i32, %441: i32, %442: i32, %443: i32, %444: i32, %445: i32, %446: i32, %447: i32, %448: i32):  // 2 preds: ^bb51, ^bb97
      %449 = arith.cmpi slt, %438, %234 : i32
      cf.cond_br %449, ^bb53, ^bb98 {loop_annotation = #loop_annotation}
    ^bb53:  // pred: ^bb52
      %450 = arith.extui %439 : i1 to i32
      %451 = arith.cmpi eq, %450, %c0_i32 : i32
      cf.cond_br %451, ^bb54, ^bb55
    ^bb54:  // pred: ^bb53
      %int_tuple_107 = cute.make_int_tuple(%441) : (i32) -> !cute.int_tuple<"?">
      %ptr_108 = cute.add_offset(%iter, %int_tuple_107) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
      %452 = builtin.unrealized_conversion_cast %ptr_108 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.try_wait.parity.shared %452, %442, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      cf.br ^bb55
    ^bb55:  // 2 preds: ^bb53, ^bb54
      nvvm.wgmma.fence.aligned
      cf.br ^bb56(%c0_i32 : i32)
    ^bb56(%453: i32):  // 2 preds: ^bb55, ^bb66
      %454 = arith.cmpi slt, %453, %c4_i32 : i32
      cf.cond_br %454, ^bb57, ^bb67 {loop_annotation = #loop_annotation2}
    ^bb57:  // pred: ^bb56
      %coord_109 = cute.make_coord(%453, %441) : (i32, i32) -> !cute.coord<"(_,_,?,?)">
    ...
    ^bb58(%455: i32):  // 2 preds: ^bb57, ^bb65
      %456 = arith.cmpi slt, %455, %434 : i32
      cf.cond_br %456, ^bb59, ^bb66 {llvm.loop_annotation = #loop_annotation1}
    ^bb59:  // pred: ^bb58
      cf.br ^bb60(%c0_i32 : i32)
    ^bb60(%457: i32):  // 2 preds: ^bb59, ^bb64
      %458 = arith.cmpi slt, %457, %435 : i32
      cf.cond_br %458, ^bb61, ^bb65 {llvm.loop_annotation = #loop_annotation1}
    ^bb61:  // pred: ^bb60
      %coord_114 = cute.make_coord(%457, %455) : (i32, i32) -> !cute.coord<"(_,?,?)">
    ...
    ^bb62(%459: i32):  // 2 preds: ^bb61, ^bb63
      %460 = arith.cmpi slt, %459, %434 : i32
      cf.cond_br %460, ^bb63, ^bb64 {llvm.loop_annotation = #loop_annotation1}
    ^bb63:  // pred: ^bb62
      %coord_117 = cute.make_coord(%457, %459) : (i32, i32) -> !cute.coord<"(_,?,?)">
      ...
      %461 = builtin.unrealized_conversion_cast %ptr_119 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
      ...
      %589:64 = cute_nvgpu.arch.mma.SM90(shapeMNK = "(64,128,16)", A = %tup_116 : [!cute_nvgpu.smem_desc, f16, #cute_nvgpu.major<k>], B = %tup_113 : [!cute_nvgpu.smem_desc, f16, #cute_nvgpu.major<k>], C[%462, %464, %466, %468, %470, %472, %474, %476, %478, %480, %482, %484, %486, %488, %490, %492, %494, %496, %498, %500, %502, %504, %506, %508, %510, %512, %514, %516, %518, %520, %522, %524, %526, %528, %530, %532, %534, %536, %538, %540, %542, %544, %546, %548, %550, %552, %554, %556, %558, %560, %562, %564, %566, %568, %570, %572, %574, %576, %578, %580, %582, %584, %586, %588], accum = %436 : i1)
< {cd_type = f32, operandSegmentSizes = array<i32: 1, 1, 64, 1>}> :(!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, f32, i1) -> (f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32, f32)
      llvm.store %589#0, %461 : f32, !llvm.ptr
      llvm.store %589#1, %463 : f32, !llvm.ptr
      llvm.store %589#2, %465 : f32, !llvm.ptr
      llvm.store %589#3, %467 : f32, !llvm.ptr
      llvm.store %589#4, %469 : f32, !llvm.ptr
      llvm.store %589#5, %471 : f32, !llvm.ptr
      llvm.store %589#6, %473 : f32, !llvm.ptr
      llvm.store %589#7, %475 : f32, !llvm.ptr
      llvm.store %589#8, %477 : f32, !llvm.ptr
      llvm.store %589#9, %479 : f32, !llvm.ptr
      llvm.store %589#10, %481 : f32, !llvm.ptr
      llvm.store %589#11, %483 : f32, !llvm.ptr
      llvm.store %589#12, %485 : f32, !llvm.ptr
      llvm.store %589#13, %487 : f32, !llvm.ptr
      llvm.store %589#14, %489 : f32, !llvm.ptr
      llvm.store %589#15, %491 : f32, !llvm.ptr
      llvm.store %589#16, %493 : f32, !llvm.ptr
      llvm.store %589#17, %495 : f32, !llvm.ptr
      llvm.store %589#18, %497 : f32, !llvm.ptr
      llvm.store %589#19, %499 : f32, !llvm.ptr
      llvm.store %589#20, %501 : f32, !llvm.ptr
      llvm.store %589#21, %503 : f32, !llvm.ptr
      llvm.store %589#22, %505 : f32, !llvm.ptr
      llvm.store %589#23, %507 : f32, !llvm.ptr
      llvm.store %589#24, %509 : f32, !llvm.ptr
      llvm.store %589#25, %511 : f32, !llvm.ptr
      llvm.store %589#26, %513 : f32, !llvm.ptr
      llvm.store %589#27, %515 : f32, !llvm.ptr
      llvm.store %589#28, %517 : f32, !llvm.ptr
      llvm.store %589#29, %519 : f32, !llvm.ptr
      llvm.store %589#30, %521 : f32, !llvm.ptr
      llvm.store %589#31, %523 : f32, !llvm.ptr
      llvm.store %589#32, %525 : f32, !llvm.ptr
      llvm.store %589#33, %527 : f32, !llvm.ptr
      llvm.store %589#34, %529 : f32, !llvm.ptr
      llvm.store %589#35, %531 : f32, !llvm.ptr
      llvm.store %589#36, %533 : f32, !llvm.ptr
      llvm.store %589#37, %535 : f32, !llvm.ptr
      llvm.store %589#38, %537 : f32, !llvm.ptr
      llvm.store %589#39, %539 : f32, !llvm.ptr
      llvm.store %589#40, %541 : f32, !llvm.ptr
      llvm.store %589#41, %543 : f32, !llvm.ptr
      llvm.store %589#42, %545 : f32, !llvm.ptr
      llvm.store %589#43, %547 : f32, !llvm.ptr
      llvm.store %589#44, %549 : f32, !llvm.ptr
      llvm.store %589#45, %551 : f32, !llvm.ptr
      llvm.store %589#46, %553 : f32, !llvm.ptr
      llvm.store %589#47, %555 : f32, !llvm.ptr
      llvm.store %589#48, %557 : f32, !llvm.ptr
      llvm.store %589#49, %559 : f32, !llvm.ptr
      llvm.store %589#50, %561 : f32, !llvm.ptr
      llvm.store %589#51, %563 : f32, !llvm.ptr
      llvm.store %589#52, %565 : f32, !llvm.ptr
      llvm.store %589#53, %567 : f32, !llvm.ptr
      llvm.store %589#54, %569 : f32, !llvm.ptr
      llvm.store %589#55, %571 : f32, !llvm.ptr
      llvm.store %589#56, %573 : f32, !llvm.ptr
      llvm.store %589#57, %575 : f32, !llvm.ptr
      llvm.store %589#58, %577 : f32, !llvm.ptr
      llvm.store %589#59, %579 : f32, !llvm.ptr
      llvm.store %589#60, %581 : f32, !llvm.ptr
      llvm.store %589#61, %583 : f32, !llvm.ptr
      llvm.store %589#62, %585 : f32, !llvm.ptr
      llvm.store %589#63, %587 : f32, !llvm.ptr
      %590 = arith.addi %459, %c1_i32 : i32
      cf.br ^bb62(%590 : i32)
    ^bb64:  // pred: ^bb62
      %591 = arith.addi %457, %c1_i32 : i32
      cf.br ^bb60(%591 : i32)
    ^bb65:  // pred: ^bb60
      %592 = arith.addi %455, %c1_i32 : i32
      cf.br ^bb58(%592 : i32)
    ^bb66:  // pred: ^bb58
      %593 = arith.addi %453, %c1_i32 : i32
      cf.br ^bb56(%593 : i32)
    ^bb67:  // pred: ^bb56
      nvvm.wgmma.commit.group.sync.aligned
    ...
    ^bb68:  // pred: ^bb67
      %int_tuple_120 = cute.make_int_tuple(%444) : (i32) -> !cute.int_tuple<"?">
      %ptr_121 = cute.add_offset(%ptr_19, %int_tuple_120) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
      %594 = builtin.unrealized_conversion_cast %ptr_121 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.txn %594, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
      cf.br ^bb69
    ^bb69:  // 2 preds: ^bb67, ^bb68
      %595 = arith.addi %441, %c1_i32 : i32
      %596 = arith.addi %440, %c1_i32 : i32
      %597 = arith.cmpi eq, %595, %c7_i32 : i32
      %598 = arith.select %597, %c0_i32, %595 : i32
      cf.cond_br %597, ^bb70, ^bb71
    ^bb70:  // pred: ^bb69
      %599 = arith.xori %442, %c1_i32 : i32
      cf.br ^bb72(%599 : i32)
    ^bb71:  // pred: ^bb69
      cf.br ^bb72(%442 : i32)
    ^bb72(%600: i32):  // 2 preds: ^bb70, ^bb71
      cf.br ^bb73
    ^bb73:  // pred: ^bb72
      %601 = arith.addi %444, %c1_i32 : i32
      %602 = arith.addi %443, %c1_i32 : i32
      %603 = arith.cmpi eq, %601, %c7_i32 : i32
      %604 = arith.select %603, %c0_i32, %601 : i32
      cf.cond_br %603, ^bb74, ^bb75
    ^bb74:  // pred: ^bb73
      %605 = arith.xori %445, %c1_i32 : i32
      cf.br ^bb76(%605 : i32)
    ^bb75:  // pred: ^bb73
      cf.br ^bb76(%445 : i32)
    ^bb76(%606: i32):  // 2 preds: ^bb74, ^bb75
      cf.br ^bb77
    ^bb77:  // pred: ^bb76
      %607 = arith.cmpi sgt, %234, %596 : i32
      cf.cond_br %607, ^bb78, ^bb79
    ^bb78:  // pred: ^bb77
      %int_tuple_122 = cute.make_int_tuple(%598) : (i32) -> !cute.int_tuple<"?">
      %ptr_123 = cute.add_offset(%iter, %int_tuple_122) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
      %608 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      %609 = nvvm.mbarrier.wait.parity %608, %600 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
      cf.br ^bb80(%609 : i1)
    ^bb79:  // pred: ^bb77
      cf.br ^bb80(%true : i1)
    ^bb80(%610: i1):  // 2 preds: ^bb78, ^bb79
      cf.br ^bb81
    ^bb81:  // pred: ^bb80
      %611 = arith.cmpi sgt, %234, %446 : i32
      %612 = arith.extui %611 : i1 to i32
      %613 = arith.select %172, %612, %437 : i32
      %614 = arith.cmpi ne, %613, %c0_i32 : i32
      cf.cond_br %614, ^bb82, ^bb95
    ^bb82:  // pred: ^bb81
      %int_tuple_124 = cute.make_int_tuple(%447) : (i32) -> !cute.int_tuple<"?">
      %ptr_125 = cute.add_offset(%ptr_19, %int_tuple_124) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
      %615 = builtin.unrealized_conversion_cast %ptr_125 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.try_wait.parity.shared %615, %448, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      %616 = nvvm.elect.sync -> i1
      cf.cond_br %616, ^bb83, ^bb84
    ^bb83:  // pred: ^bb82
      %ptr_126 = cute.add_offset(%iter, %int_tuple_124) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
      %617 = builtin.unrealized_conversion_cast %ptr_126 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.txn %617, %c32768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
      cf.br ^bb84
    ^bb84:  // 2 preds: ^bb82, ^bb83
      %coord_127 = cute.make_coord(%446) : (i32) -> !cute.coord<"(_,?)">
      ...
      %coord_133 = cute.make_coord(%447) : (i32) -> !cute.coord<"(_,?)">
      ...
      %618 = cute_nvgpu.atom.make_exec_tma(%arg0) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>
      %619 = cute_nvgpu.atom.set_value(%618, %ptr_142 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>
      %620 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %621 = cute_nvgpu.atom.get_value(%619 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
      %622 = cute_nvgpu.atom.get_value(%619 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
      %TMADescAddr_144 = cute_nvgpu.get_tma_desc_addr(%619 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %623:3 = cute.get_scalars(%int_tuple_143) : !cute.int_tuple<"(?{div=64},?{div=128},?)">
      cf.br ^bb85(%c0_i32 : i32)
    ^bb85(%624: i32):  // 2 preds: ^bb84, ^bb86
      %625 = arith.cmpi slt, %624, %620 : i32
      cf.cond_br %625, ^bb86, ^bb87 {llvm.loop_annotation = #loop_annotation1}
    ^bb86:  // pred: ^bb85
      cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_144 : !cute.ptr<generic, align<64>>, %ptr_135 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, %621 : !cute.ptr<smem, align<8>>, [%623#0, %623#1, %623#2] : i32, i32, i32) cache_policy = %622 mode = <tiled> num_cta = 1 : i32
    ...
    ^bb87:  // pred: ^bb85
      ...
      %627 = cute_nvgpu.atom.make_exec_tma(%arg2) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>
      %628 = cute_nvgpu.atom.set_value(%627, %ptr_142 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>
      %629 = cute_nvgpu.atom.get_value(%628 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
      %630 = cute_nvgpu.atom.get_value(%628 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
      %TMADescAddr_146 = cute_nvgpu.get_tma_desc_addr(%628 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %631:3 = cute.get_scalars(%int_tuple_145) : !cute.int_tuple<"(?{div=64},?{div=128},?)">
      cf.br ^bb88(%c0_i32 : i32)
    ^bb88(%632: i32):  // 2 preds: ^bb87, ^bb89
      %633 = arith.cmpi slt, %632, %620 : i32
      cf.cond_br %633, ^bb89, ^bb90 {llvm.loop_annotation = #loop_annotation1}
    ^bb89:  // pred: ^bb88
      cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_146 : !cute.ptr<generic, align<64>>, %ptr_141 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, %629 : !cute.ptr<smem, align<8>>, [%631#0, %631#1, %631#2] : i32, i32, i32) cache_policy = %630 mode = <tiled> num_cta = 1 : i32
      %634 = arith.addi %632, %c1_i32 : i32
      cf.br ^bb88(%634 : i32)
    ^bb90:  // pred: ^bb88
      %635 = arith.addi %447, %c1_i32 : i32
      %636 = arith.addi %446, %c1_i32 : i32
      %637 = arith.cmpi eq, %635, %c7_i32 : i32
      %638 = arith.select %637, %c0_i32, %635 : i32
      cf.cond_br %637, ^bb91, ^bb92
    ^bb91:  // pred: ^bb90
      %639 = arith.xori %448, %c1_i32 : i32
      cf.br ^bb93(%639 : i32)
    ^bb92:  // pred: ^bb90
      cf.br ^bb93(%448 : i32)
    ^bb93(%640: i32):  // 2 preds: ^bb91, ^bb92
      cf.br ^bb94
    ^bb94:  // pred: ^bb93
      cf.br ^bb96(%636, %638, %640 : i32, i32, i32)
    ^bb95:  // pred: ^bb81
      cf.br ^bb96(%446, %447, %448 : i32, i32, i32)
    ^bb96(%641: i32, %642: i32, %643: i32):  // 2 preds: ^bb94, ^bb95
      cf.br ^bb97
    ^bb97:  // pred: ^bb96
      %644 = arith.addi %438, %c1_i32 : i32
      cf.br ^bb52(%644, %610, %596, %598, %600, %602, %604, %606, %641, %642, %643 : i32, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32)
    ^bb98:  // pred: ^bb52
      nvvm.wgmma.wait.group.sync.aligned 0
      nvvm.barrier
      %atom = cute.make_atom() : () -> !cute_nvgpu.atom.stsm<f16, mode = <"(8,8)">, num_matrices = 4, n>
      %645 = cute.make_tiled_copy(%atom) : !copy_stsm_4_
      %646 = cute.make_tiled_copy(%atom) : !copy_stsm_4_1
      %coord_147 = cute.make_coord(%160) : (i32) -> !cute.coord<"?">
      %647 = cute.get_scalars(%coord_147) <{only_dynamic}> : !cute.coord<"?">
      %648 = arith.divsi %647, %c8_i32 : i32
      %649 = arith.remsi %647, %c8_i32 : i32
      %650 = arith.muli %649, %c32_i32 : i32
      %651 = arith.divsi %648, %c2_i32 : i32
      %652 = arith.remsi %648, %c2_i32 : i32
      %653 = arith.muli %652, %c256_i32 : i32
      %654 = arith.addi %650, %653 : i32
      %655 = arith.divsi %651, %c2_i32 : i32
      %656 = arith.remsi %651, %c2_i32 : i32
      %657 = arith.muli %656, %c8_i32 : i32
      %658 = arith.addi %654, %657 : i32
      %659 = arith.muli %655, %c512_i32 : i32
      %660 = arith.addi %658, %659 : i32
      %iv = cute.assume(%660) : (i32) -> !cute.i32<divby 8>
      ...
      %661 = cute.memref.load(%view, %139) : (!memref_rmem_f32_1, !cute.coord<"0">) -> f32
      cute.memref.store(%rmem_151, %139, %661) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %662 = cute.memref.load(%view, %138) : (!memref_rmem_f32_1, !cute.coord<"1">) -> f32
      cute.memref.store(%rmem_151, %138, %662) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %663 = cute.memref.load(%view, %137) : (!memref_rmem_f32_1, !cute.coord<"2">) -> f32
      cute.memref.store(%rmem_151, %137, %663) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %664 = cute.memref.load(%view, %136) : (!memref_rmem_f32_1, !cute.coord<"3">) -> f32
      cute.memref.store(%rmem_151, %136, %664) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %665 = cute.memref.load(%view, %135) : (!memref_rmem_f32_1, !cute.coord<"4">) -> f32
      cute.memref.store(%rmem_151, %135, %665) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %666 = cute.memref.load(%view, %134) : (!memref_rmem_f32_1, !cute.coord<"5">) -> f32
      cute.memref.store(%rmem_151, %134, %666) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %667 = cute.memref.load(%view, %133) : (!memref_rmem_f32_1, !cute.coord<"6">) -> f32
      cute.memref.store(%rmem_151, %133, %667) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %668 = cute.memref.load(%view, %132) : (!memref_rmem_f32_1, !cute.coord<"7">) -> f32
      cute.memref.store(%rmem_151, %132, %668) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %669 = cute.memref.load(%view, %131) : (!memref_rmem_f32_1, !cute.coord<"8">) -> f32
      cute.memref.store(%rmem_151, %131, %669) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %670 = cute.memref.load(%view, %130) : (!memref_rmem_f32_1, !cute.coord<"9">) -> f32
      cute.memref.store(%rmem_151, %130, %670) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %671 = cute.memref.load(%view, %129) : (!memref_rmem_f32_1, !cute.coord<"10">) -> f32
      cute.memref.store(%rmem_151, %129, %671) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %672 = cute.memref.load(%view, %128) : (!memref_rmem_f32_1, !cute.coord<"11">) -> f32
      cute.memref.store(%rmem_151, %128, %672) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %673 = cute.memref.load(%view, %127) : (!memref_rmem_f32_1, !cute.coord<"12">) -> f32
      cute.memref.store(%rmem_151, %127, %673) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %674 = cute.memref.load(%view, %126) : (!memref_rmem_f32_1, !cute.coord<"13">) -> f32
      cute.memref.store(%rmem_151, %126, %674) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %675 = cute.memref.load(%view, %125) : (!memref_rmem_f32_1, !cute.coord<"14">) -> f32
      cute.memref.store(%rmem_151, %125, %675) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %676 = cute.memref.load(%view, %124) : (!memref_rmem_f32_1, !cute.coord<"15">) -> f32
      cute.memref.store(%rmem_151, %124, %676) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_152 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_153 = cute.get_iter(%rmem_152) : !memref_rmem_f16_
      %677 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %678 = arith.truncf %677 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %678, %rmem_152 : !memref_rmem_f16_
      %679 = cute.get_scalars(%156) : !cute.int_tuple<"2">
      cf.br ^bb99(%c0_i32 : i32)
    ^bb99(%680: i32):  // 2 preds: ^bb98, ^bb100
      %681 = arith.cmpi slt, %680, %679 : i32
      cf.cond_br %681, ^bb100, ^bb101 {llvm.loop_annotation = #loop_annotation1}
    ^bb100:  // pred: ^bb99
      %coord_154 = cute.make_coord(%680) : (i32) -> !cute.coord<"(_,?)">
      ...
      %682 = builtin.unrealized_conversion_cast %ptr_156 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %683 = llvm.load %682 : !llvm.ptr -> vector<4xi32>
      %swizzled = cute.apply_swizzle(%ptr_158) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled, %683) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %684 = arith.addi %680, %c1_i32 : i32
      cf.br ^bb99(%684 : i32)
    ^bb101:  // pred: ^bb99
    ...
    ^bb102:  // pred: ^bb101
      ...
      %685 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %686 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_163 = cute_nvgpu.get_tma_desc_addr(%685 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %687 = cute_nvgpu.atom.get_value(%685 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %688:3 = cute.get_scalars(%int_tuple_162) : !cute.int_tuple<"(?{div=128},?{div=128},?)">
      cf.br ^bb103(%c0_i32 : i32)
    ^bb103(%689: i32):  // 2 preds: ^bb102, ^bb104
      %690 = arith.cmpi slt, %689, %686 : i32
      cf.cond_br %690, ^bb104, ^bb105 {llvm.loop_annotation = #loop_annotation1}
    ^bb104:  // pred: ^bb103
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_163 : !cute.ptr<generic, align<64>>, %iter_36 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%688#0, %688#1, %688#2] : i32, i32, i32) cache_policy = %687 mode = <tiled>
    ...
    ^bb106:  // 2 preds: ^bb101, ^bb105
      nvvm.barrier id = %c1_i32
      %692 = cute.memref.load(%view, %121) : (!memref_rmem_f32_1, !cute.coord<"16">) -> f32
      cute.memref.store(%rmem_151, %139, %692) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %693 = cute.memref.load(%view, %120) : (!memref_rmem_f32_1, !cute.coord<"17">) -> f32
      cute.memref.store(%rmem_151, %138, %693) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %694 = cute.memref.load(%view, %119) : (!memref_rmem_f32_1, !cute.coord<"18">) -> f32
      cute.memref.store(%rmem_151, %137, %694) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %695 = cute.memref.load(%view, %118) : (!memref_rmem_f32_1, !cute.coord<"19">) -> f32
      cute.memref.store(%rmem_151, %136, %695) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %696 = cute.memref.load(%view, %117) : (!memref_rmem_f32_1, !cute.coord<"20">) -> f32
      cute.memref.store(%rmem_151, %135, %696) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %697 = cute.memref.load(%view, %116) : (!memref_rmem_f32_1, !cute.coord<"21">) -> f32
      cute.memref.store(%rmem_151, %134, %697) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %698 = cute.memref.load(%view, %115) : (!memref_rmem_f32_1, !cute.coord<"22">) -> f32
      cute.memref.store(%rmem_151, %133, %698) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %699 = cute.memref.load(%view, %114) : (!memref_rmem_f32_1, !cute.coord<"23">) -> f32
      cute.memref.store(%rmem_151, %132, %699) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %700 = cute.memref.load(%view, %113) : (!memref_rmem_f32_1, !cute.coord<"24">) -> f32
      cute.memref.store(%rmem_151, %131, %700) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %701 = cute.memref.load(%view, %112) : (!memref_rmem_f32_1, !cute.coord<"25">) -> f32
      cute.memref.store(%rmem_151, %130, %701) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %702 = cute.memref.load(%view, %111) : (!memref_rmem_f32_1, !cute.coord<"26">) -> f32
      cute.memref.store(%rmem_151, %129, %702) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %703 = cute.memref.load(%view, %110) : (!memref_rmem_f32_1, !cute.coord<"27">) -> f32
      cute.memref.store(%rmem_151, %128, %703) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %704 = cute.memref.load(%view, %109) : (!memref_rmem_f32_1, !cute.coord<"28">) -> f32
      cute.memref.store(%rmem_151, %127, %704) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %705 = cute.memref.load(%view, %108) : (!memref_rmem_f32_1, !cute.coord<"29">) -> f32
      cute.memref.store(%rmem_151, %126, %705) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %706 = cute.memref.load(%view, %107) : (!memref_rmem_f32_1, !cute.coord<"30">) -> f32
      cute.memref.store(%rmem_151, %125, %706) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %707 = cute.memref.load(%view, %106) : (!memref_rmem_f32_1, !cute.coord<"31">) -> f32
      cute.memref.store(%rmem_151, %124, %707) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_164 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_165 = cute.get_iter(%rmem_164) : !memref_rmem_f16_
      %708 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %709 = arith.truncf %708 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %709, %rmem_164 : !memref_rmem_f16_
    ...
    ^bb107(%710: i32):  // 2 preds: ^bb106, ^bb108
      %711 = arith.cmpi slt, %710, %679 : i32
      cf.cond_br %711, ^bb108, ^bb109 {llvm.loop_annotation = #loop_annotation1}
    ^bb108:  // pred: ^bb107
      %coord_167 = cute.make_coord(%710) : (i32) -> !cute.coord<"(_,?)">
      ...
      %712 = builtin.unrealized_conversion_cast %ptr_169 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %713 = llvm.load %712 : !llvm.ptr -> vector<4xi32>
      %swizzled_172 = cute.apply_swizzle(%ptr_171) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_172, %713) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
    ...
    ^bb110:  // pred: ^bb109
      ...
      %715 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %716 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_179 = cute_nvgpu.get_tma_desc_addr(%715 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %717 = cute_nvgpu.atom.get_value(%715 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %718:3 = cute.get_scalars(%int_tuple_178) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
      cf.br ^bb111(%c0_i32 : i32)
    ^bb111(%719: i32):  // 2 preds: ^bb110, ^bb112
      %720 = arith.cmpi slt, %719, %716 : i32
      cf.cond_br %720, ^bb112, ^bb113 {llvm.loop_annotation = #loop_annotation1}
    ^bb112:  // pred: ^bb111
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_179 : !cute.ptr<generic, align<64>>, %ptr_173 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%718#0, %718#1, %718#2] : i32, i32, i32) cache_policy = %717 mode = <tiled>
    ...
    ^bb114:  // 2 preds: ^bb109, ^bb113
      nvvm.barrier id = %c1_i32
      %722 = cute.memref.load(%view, %103) : (!memref_rmem_f32_1, !cute.coord<"32">) -> f32
      cute.memref.store(%rmem_151, %139, %722) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %723 = cute.memref.load(%view, %102) : (!memref_rmem_f32_1, !cute.coord<"33">) -> f32
      cute.memref.store(%rmem_151, %138, %723) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %724 = cute.memref.load(%view, %101) : (!memref_rmem_f32_1, !cute.coord<"34">) -> f32
      cute.memref.store(%rmem_151, %137, %724) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %725 = cute.memref.load(%view, %100) : (!memref_rmem_f32_1, !cute.coord<"35">) -> f32
      cute.memref.store(%rmem_151, %136, %725) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %726 = cute.memref.load(%view, %99) : (!memref_rmem_f32_1, !cute.coord<"36">) -> f32
      cute.memref.store(%rmem_151, %135, %726) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %727 = cute.memref.load(%view, %98) : (!memref_rmem_f32_1, !cute.coord<"37">) -> f32
      cute.memref.store(%rmem_151, %134, %727) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %728 = cute.memref.load(%view, %97) : (!memref_rmem_f32_1, !cute.coord<"38">) -> f32
      cute.memref.store(%rmem_151, %133, %728) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %729 = cute.memref.load(%view, %96) : (!memref_rmem_f32_1, !cute.coord<"39">) -> f32
      cute.memref.store(%rmem_151, %132, %729) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %730 = cute.memref.load(%view, %95) : (!memref_rmem_f32_1, !cute.coord<"40">) -> f32
      cute.memref.store(%rmem_151, %131, %730) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %731 = cute.memref.load(%view, %94) : (!memref_rmem_f32_1, !cute.coord<"41">) -> f32
      cute.memref.store(%rmem_151, %130, %731) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %732 = cute.memref.load(%view, %93) : (!memref_rmem_f32_1, !cute.coord<"42">) -> f32
      cute.memref.store(%rmem_151, %129, %732) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %733 = cute.memref.load(%view, %92) : (!memref_rmem_f32_1, !cute.coord<"43">) -> f32
      cute.memref.store(%rmem_151, %128, %733) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %734 = cute.memref.load(%view, %91) : (!memref_rmem_f32_1, !cute.coord<"44">) -> f32
      cute.memref.store(%rmem_151, %127, %734) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %735 = cute.memref.load(%view, %90) : (!memref_rmem_f32_1, !cute.coord<"45">) -> f32
      cute.memref.store(%rmem_151, %126, %735) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %736 = cute.memref.load(%view, %89) : (!memref_rmem_f32_1, !cute.coord<"46">) -> f32
      cute.memref.store(%rmem_151, %125, %736) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %737 = cute.memref.load(%view, %88) : (!memref_rmem_f32_1, !cute.coord<"47">) -> f32
      cute.memref.store(%rmem_151, %124, %737) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_180 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_181 = cute.get_iter(%rmem_180) : !memref_rmem_f16_
      %738 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %739 = arith.truncf %738 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %739, %rmem_180 : !memref_rmem_f16_
    ...
    ^bb115(%740: i32):  // 2 preds: ^bb114, ^bb116
      %741 = arith.cmpi slt, %740, %679 : i32
      cf.cond_br %741, ^bb116, ^bb117 {llvm.loop_annotation = #loop_annotation1}
    ^bb116:  // pred: ^bb115
      %coord_183 = cute.make_coord(%740) : (i32) -> !cute.coord<"(_,?)">
      ...
      %742 = builtin.unrealized_conversion_cast %ptr_185 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %743 = llvm.load %742 : !llvm.ptr -> vector<4xi32>
      %swizzled_188 = cute.apply_swizzle(%ptr_187) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_188, %743) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
    ...
    ^bb118:  // pred: ^bb117
      ...
      %745 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %746 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_195 = cute_nvgpu.get_tma_desc_addr(%745 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %747 = cute_nvgpu.atom.get_value(%745 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %748:3 = cute.get_scalars(%int_tuple_194) : !cute.int_tuple<"(?{div=64},?{div=128},?)">
      cf.br ^bb119(%c0_i32 : i32)
    ^bb119(%749: i32):  // 2 preds: ^bb118, ^bb120
      %750 = arith.cmpi slt, %749, %746 : i32
      cf.cond_br %750, ^bb120, ^bb121 {llvm.loop_annotation = #loop_annotation1}
    ^bb120:  // pred: ^bb119
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_195 : !cute.ptr<generic, align<64>>, %ptr_189 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%748#0, %748#1, %748#2] : i32, i32, i32) cache_policy = %747 mode = <tiled>
      %751 = arith.addi %749, %c1_i32 : i32
      cf.br ^bb119(%751 : i32)
    ^bb121:  // pred: ^bb119
      nvvm.cp.async.bulk.commit.group
      nvvm.cp.async.bulk.wait_group 3 {read}
    ...
    ^bb122:  // 2 preds: ^bb117, ^bb121
      nvvm.barrier id = %c1_i32
      %752 = cute.memref.load(%view, %85) : (!memref_rmem_f32_1, !cute.coord<"48">) -> f32
      cute.memref.store(%rmem_151, %139, %752) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %753 = cute.memref.load(%view, %84) : (!memref_rmem_f32_1, !cute.coord<"49">) -> f32
      cute.memref.store(%rmem_151, %138, %753) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %754 = cute.memref.load(%view, %83) : (!memref_rmem_f32_1, !cute.coord<"50">) -> f32
      cute.memref.store(%rmem_151, %137, %754) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %755 = cute.memref.load(%view, %82) : (!memref_rmem_f32_1, !cute.coord<"51">) -> f32
      cute.memref.store(%rmem_151, %136, %755) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %756 = cute.memref.load(%view, %81) : (!memref_rmem_f32_1, !cute.coord<"52">) -> f32
      cute.memref.store(%rmem_151, %135, %756) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %757 = cute.memref.load(%view, %80) : (!memref_rmem_f32_1, !cute.coord<"53">) -> f32
      cute.memref.store(%rmem_151, %134, %757) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %758 = cute.memref.load(%view, %79) : (!memref_rmem_f32_1, !cute.coord<"54">) -> f32
      cute.memref.store(%rmem_151, %133, %758) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %759 = cute.memref.load(%view, %78) : (!memref_rmem_f32_1, !cute.coord<"55">) -> f32
      cute.memref.store(%rmem_151, %132, %759) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %760 = cute.memref.load(%view, %77) : (!memref_rmem_f32_1, !cute.coord<"56">) -> f32
      cute.memref.store(%rmem_151, %131, %760) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %761 = cute.memref.load(%view, %76) : (!memref_rmem_f32_1, !cute.coord<"57">) -> f32
      cute.memref.store(%rmem_151, %130, %761) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %762 = cute.memref.load(%view, %75) : (!memref_rmem_f32_1, !cute.coord<"58">) -> f32
      cute.memref.store(%rmem_151, %129, %762) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %763 = cute.memref.load(%view, %74) : (!memref_rmem_f32_1, !cute.coord<"59">) -> f32
      cute.memref.store(%rmem_151, %128, %763) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %764 = cute.memref.load(%view, %73) : (!memref_rmem_f32_1, !cute.coord<"60">) -> f32
      cute.memref.store(%rmem_151, %127, %764) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %765 = cute.memref.load(%view, %72) : (!memref_rmem_f32_1, !cute.coord<"61">) -> f32
      cute.memref.store(%rmem_151, %126, %765) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %766 = cute.memref.load(%view, %71) : (!memref_rmem_f32_1, !cute.coord<"62">) -> f32
      cute.memref.store(%rmem_151, %125, %766) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %767 = cute.memref.load(%view, %70) : (!memref_rmem_f32_1, !cute.coord<"63">) -> f32
      cute.memref.store(%rmem_151, %124, %767) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_196 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_197 = cute.get_iter(%rmem_196) : !memref_rmem_f16_
      %768 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %769 = arith.truncf %768 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %769, %rmem_196 : !memref_rmem_f16_
    ...
    ^bb123(%770: i32):  // 2 preds: ^bb122, ^bb124
      %771 = arith.cmpi slt, %770, %679 : i32
      cf.cond_br %771, ^bb124, ^bb125 {llvm.loop_annotation = #loop_annotation1}
    ^bb124:  // pred: ^bb123
      %coord_199 = cute.make_coord(%770) : (i32) -> !cute.coord<"(_,?)">
      ...
      %772 = builtin.unrealized_conversion_cast %ptr_201 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %773 = llvm.load %772 : !llvm.ptr -> vector<4xi32>
      %swizzled_204 = cute.apply_swizzle(%ptr_203) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_204, %773) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %774 = arith.addi %770, %c1_i32 : i32
      cf.br ^bb123(%774 : i32)
    ^bb125:  // pred: ^bb123
      nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
      nvvm.barrier id = %c1_i32
    ...
    ^bb126:  // pred: ^bb125
      ...
      %775 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %776 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_211 = cute_nvgpu.get_tma_desc_addr(%775 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %777 = cute_nvgpu.atom.get_value(%775 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %778:3 = cute.get_scalars(%int_tuple_210) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
      cf.br ^bb127(%c0_i32 : i32)
    ^bb127(%779: i32):  // 2 preds: ^bb126, ^bb128
      %780 = arith.cmpi slt, %779, %776 : i32
      cf.cond_br %780, ^bb128, ^bb129 {llvm.loop_annotation = #loop_annotation1}
    ^bb128:  // pred: ^bb127
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_211 : !cute.ptr<generic, align<64>>, %ptr_205 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%778#0, %778#1, %778#2] : i32, i32, i32) cache_policy = %777 mode = <tiled>
      %781 = arith.addi %779, %c1_i32 : i32
      cf.br ^bb127(%781 : i32)
    ^bb129:  // pred: ^bb127
      nvvm.cp.async.bulk.commit.group
      nvvm.cp.async.bulk.wait_group 3 {read}
    ...
    ^bb130:  // 2 preds: ^bb125, ^bb129
      nvvm.barrier id = %c1_i32
      %782 = cute.memref.load(%view, %67) : (!memref_rmem_f32_1, !cute.coord<"64">) -> f32
      cute.memref.store(%rmem_151, %139, %782) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %783 = cute.memref.load(%view, %66) : (!memref_rmem_f32_1, !cute.coord<"65">) -> f32
      cute.memref.store(%rmem_151, %138, %783) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %784 = cute.memref.load(%view, %65) : (!memref_rmem_f32_1, !cute.coord<"66">) -> f32
      cute.memref.store(%rmem_151, %137, %784) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %785 = cute.memref.load(%view, %64) : (!memref_rmem_f32_1, !cute.coord<"67">) -> f32
      cute.memref.store(%rmem_151, %136, %785) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %786 = cute.memref.load(%view, %63) : (!memref_rmem_f32_1, !cute.coord<"68">) -> f32
      cute.memref.store(%rmem_151, %135, %786) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %787 = cute.memref.load(%view, %62) : (!memref_rmem_f32_1, !cute.coord<"69">) -> f32
      cute.memref.store(%rmem_151, %134, %787) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %788 = cute.memref.load(%view, %61) : (!memref_rmem_f32_1, !cute.coord<"70">) -> f32
      cute.memref.store(%rmem_151, %133, %788) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %789 = cute.memref.load(%view, %60) : (!memref_rmem_f32_1, !cute.coord<"71">) -> f32
      cute.memref.store(%rmem_151, %132, %789) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %790 = cute.memref.load(%view, %59) : (!memref_rmem_f32_1, !cute.coord<"72">) -> f32
      cute.memref.store(%rmem_151, %131, %790) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %791 = cute.memref.load(%view, %58) : (!memref_rmem_f32_1, !cute.coord<"73">) -> f32
      cute.memref.store(%rmem_151, %130, %791) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %792 = cute.memref.load(%view, %57) : (!memref_rmem_f32_1, !cute.coord<"74">) -> f32
      cute.memref.store(%rmem_151, %129, %792) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %793 = cute.memref.load(%view, %56) : (!memref_rmem_f32_1, !cute.coord<"75">) -> f32
      cute.memref.store(%rmem_151, %128, %793) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %794 = cute.memref.load(%view, %55) : (!memref_rmem_f32_1, !cute.coord<"76">) -> f32
      cute.memref.store(%rmem_151, %127, %794) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %795 = cute.memref.load(%view, %54) : (!memref_rmem_f32_1, !cute.coord<"77">) -> f32
      cute.memref.store(%rmem_151, %126, %795) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %796 = cute.memref.load(%view, %53) : (!memref_rmem_f32_1, !cute.coord<"78">) -> f32
      cute.memref.store(%rmem_151, %125, %796) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %797 = cute.memref.load(%view, %52) : (!memref_rmem_f32_1, !cute.coord<"79">) -> f32
      cute.memref.store(%rmem_151, %124, %797) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_212 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_213 = cute.get_iter(%rmem_212) : !memref_rmem_f16_
      %798 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %799 = arith.truncf %798 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %799, %rmem_212 : !memref_rmem_f16_
      cf.br ^bb131(%c0_i32 : i32)
    ^bb131(%800: i32):  // 2 preds: ^bb130, ^bb132
      %801 = arith.cmpi slt, %800, %679 : i32
      cf.cond_br %801, ^bb132, ^bb133 {llvm.loop_annotation = #loop_annotation1}
    ^bb132:  // pred: ^bb131
      %coord_214 = cute.make_coord(%800) : (i32) -> !cute.coord<"(_,?)">
      ...
      %802 = builtin.unrealized_conversion_cast %ptr_216 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %803 = llvm.load %802 : !llvm.ptr -> vector<4xi32>
      %swizzled_219 = cute.apply_swizzle(%ptr_218) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_219, %803) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %804 = arith.addi %800, %c1_i32 : i32
      cf.br ^bb131(%804 : i32)
    ^bb133:  // pred: ^bb131
      nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
      nvvm.barrier id = %c1_i32
    ...
    ^bb134:  // pred: ^bb133
      ...
      %805 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %806 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_225 = cute_nvgpu.get_tma_desc_addr(%805 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %807 = cute_nvgpu.atom.get_value(%805 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %808:3 = cute.get_scalars(%int_tuple_224) : !cute.int_tuple<"(?{div=128},?{div=64},?)">
      cf.br ^bb135(%c0_i32 : i32)
    ^bb135(%809: i32):  // 2 preds: ^bb134, ^bb136
      %810 = arith.cmpi slt, %809, %806 : i32
      cf.cond_br %810, ^bb136, ^bb137 {llvm.loop_annotation = #loop_annotation1}
    ^bb136:  // pred: ^bb135
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_225 : !cute.ptr<generic, align<64>>, %iter_36 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%808#0, %808#1, %808#2] : i32, i32, i32) cache_policy = %807 mode = <tiled>
      %811 = arith.addi %809, %c1_i32 : i32
      cf.br ^bb135(%811 : i32)
    ^bb137:  // pred: ^bb135
      nvvm.cp.async.bulk.commit.group
      nvvm.cp.async.bulk.wait_group 3 {read}
    ...
    ^bb138:  // 2 preds: ^bb133, ^bb137
      nvvm.barrier id = %c1_i32
      %812 = cute.memref.load(%view, %50) : (!memref_rmem_f32_1, !cute.coord<"80">) -> f32
      cute.memref.store(%rmem_151, %139, %812) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %813 = cute.memref.load(%view, %49) : (!memref_rmem_f32_1, !cute.coord<"81">) -> f32
      cute.memref.store(%rmem_151, %138, %813) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %814 = cute.memref.load(%view, %48) : (!memref_rmem_f32_1, !cute.coord<"82">) -> f32
      cute.memref.store(%rmem_151, %137, %814) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %815 = cute.memref.load(%view, %47) : (!memref_rmem_f32_1, !cute.coord<"83">) -> f32
      cute.memref.store(%rmem_151, %136, %815) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %816 = cute.memref.load(%view, %46) : (!memref_rmem_f32_1, !cute.coord<"84">) -> f32
      cute.memref.store(%rmem_151, %135, %816) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %817 = cute.memref.load(%view, %45) : (!memref_rmem_f32_1, !cute.coord<"85">) -> f32
      cute.memref.store(%rmem_151, %134, %817) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %818 = cute.memref.load(%view, %44) : (!memref_rmem_f32_1, !cute.coord<"86">) -> f32
      cute.memref.store(%rmem_151, %133, %818) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %819 = cute.memref.load(%view, %43) : (!memref_rmem_f32_1, !cute.coord<"87">) -> f32
      cute.memref.store(%rmem_151, %132, %819) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %820 = cute.memref.load(%view, %42) : (!memref_rmem_f32_1, !cute.coord<"88">) -> f32
      cute.memref.store(%rmem_151, %131, %820) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %821 = cute.memref.load(%view, %41) : (!memref_rmem_f32_1, !cute.coord<"89">) -> f32
      cute.memref.store(%rmem_151, %130, %821) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %822 = cute.memref.load(%view, %40) : (!memref_rmem_f32_1, !cute.coord<"90">) -> f32
      cute.memref.store(%rmem_151, %129, %822) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %823 = cute.memref.load(%view, %39) : (!memref_rmem_f32_1, !cute.coord<"91">) -> f32
      cute.memref.store(%rmem_151, %128, %823) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %824 = cute.memref.load(%view, %38) : (!memref_rmem_f32_1, !cute.coord<"92">) -> f32
      cute.memref.store(%rmem_151, %127, %824) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %825 = cute.memref.load(%view, %37) : (!memref_rmem_f32_1, !cute.coord<"93">) -> f32
      cute.memref.store(%rmem_151, %126, %825) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %826 = cute.memref.load(%view, %36) : (!memref_rmem_f32_1, !cute.coord<"94">) -> f32
      cute.memref.store(%rmem_151, %125, %826) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %827 = cute.memref.load(%view, %35) : (!memref_rmem_f32_1, !cute.coord<"95">) -> f32
      cute.memref.store(%rmem_151, %124, %827) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_226 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_227 = cute.get_iter(%rmem_226) : !memref_rmem_f16_
      %828 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %829 = arith.truncf %828 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %829, %rmem_226 : !memref_rmem_f16_
      cf.br ^bb139(%c0_i32 : i32)
    ^bb139(%830: i32):  // 2 preds: ^bb138, ^bb140
      %831 = arith.cmpi slt, %830, %679 : i32
      cf.cond_br %831, ^bb140, ^bb141 {llvm.loop_annotation = #loop_annotation1}
    ^bb140:  // pred: ^bb139
      %coord_228 = cute.make_coord(%830) : (i32) -> !cute.coord<"(_,?)">
      ...
      %832 = builtin.unrealized_conversion_cast %ptr_230 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %833 = llvm.load %832 : !llvm.ptr -> vector<4xi32>
      %swizzled_233 = cute.apply_swizzle(%ptr_232) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_233, %833) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %834 = arith.addi %830, %c1_i32 : i32
      cf.br ^bb139(%834 : i32)
    ^bb141:  // pred: ^bb139
      nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
      nvvm.barrier id = %c1_i32
    ...
    ^bb142:  // pred: ^bb141
      ...
      %835 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %836 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_240 = cute_nvgpu.get_tma_desc_addr(%835 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %837 = cute_nvgpu.atom.get_value(%835 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %838:3 = cute.get_scalars(%int_tuple_239) : !cute.int_tuple<"(?{div=32},?{div=64},?)">
      cf.br ^bb143(%c0_i32 : i32)
    ^bb143(%839: i32):  // 2 preds: ^bb142, ^bb144
      %840 = arith.cmpi slt, %839, %836 : i32
      cf.cond_br %840, ^bb144, ^bb145 {llvm.loop_annotation = #loop_annotation1}
    ^bb144:  // pred: ^bb143
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_240 : !cute.ptr<generic, align<64>>, %ptr_234 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%838#0, %838#1, %838#2] : i32, i32, i32) cache_policy = %837 mode = <tiled>
    ...
    ^bb146:  // 2 preds: ^bb141, ^bb145
      nvvm.barrier id = %c1_i32
      %842 = cute.memref.load(%view, %33) : (!memref_rmem_f32_1, !cute.coord<"96">) -> f32
      cute.memref.store(%rmem_151, %139, %842) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %843 = cute.memref.load(%view, %32) : (!memref_rmem_f32_1, !cute.coord<"97">) -> f32
      cute.memref.store(%rmem_151, %138, %843) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %844 = cute.memref.load(%view, %31) : (!memref_rmem_f32_1, !cute.coord<"98">) -> f32
      cute.memref.store(%rmem_151, %137, %844) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %845 = cute.memref.load(%view, %30) : (!memref_rmem_f32_1, !cute.coord<"99">) -> f32
      cute.memref.store(%rmem_151, %136, %845) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %846 = cute.memref.load(%view, %29) : (!memref_rmem_f32_1, !cute.coord<"100">) -> f32
      cute.memref.store(%rmem_151, %135, %846) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %847 = cute.memref.load(%view, %28) : (!memref_rmem_f32_1, !cute.coord<"101">) -> f32
      cute.memref.store(%rmem_151, %134, %847) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %848 = cute.memref.load(%view, %27) : (!memref_rmem_f32_1, !cute.coord<"102">) -> f32
      cute.memref.store(%rmem_151, %133, %848) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %849 = cute.memref.load(%view, %26) : (!memref_rmem_f32_1, !cute.coord<"103">) -> f32
      cute.memref.store(%rmem_151, %132, %849) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %850 = cute.memref.load(%view, %25) : (!memref_rmem_f32_1, !cute.coord<"104">) -> f32
      cute.memref.store(%rmem_151, %131, %850) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %851 = cute.memref.load(%view, %24) : (!memref_rmem_f32_1, !cute.coord<"105">) -> f32
      cute.memref.store(%rmem_151, %130, %851) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %852 = cute.memref.load(%view, %23) : (!memref_rmem_f32_1, !cute.coord<"106">) -> f32
      cute.memref.store(%rmem_151, %129, %852) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %853 = cute.memref.load(%view, %22) : (!memref_rmem_f32_1, !cute.coord<"107">) -> f32
      cute.memref.store(%rmem_151, %128, %853) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %854 = cute.memref.load(%view, %21) : (!memref_rmem_f32_1, !cute.coord<"108">) -> f32
      cute.memref.store(%rmem_151, %127, %854) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %855 = cute.memref.load(%view, %20) : (!memref_rmem_f32_1, !cute.coord<"109">) -> f32
      cute.memref.store(%rmem_151, %126, %855) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %856 = cute.memref.load(%view, %19) : (!memref_rmem_f32_1, !cute.coord<"110">) -> f32
      cute.memref.store(%rmem_151, %125, %856) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %857 = cute.memref.load(%view, %18) : (!memref_rmem_f32_1, !cute.coord<"111">) -> f32
      cute.memref.store(%rmem_151, %124, %857) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_241 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_242 = cute.get_iter(%rmem_241) : !memref_rmem_f16_
      %858 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %859 = arith.truncf %858 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %859, %rmem_241 : !memref_rmem_f16_
      cf.br ^bb147(%c0_i32 : i32)
    ^bb147(%860: i32):  // 2 preds: ^bb146, ^bb148
      %861 = arith.cmpi slt, %860, %679 : i32
      cf.cond_br %861, ^bb148, ^bb149 {llvm.loop_annotation = #loop_annotation1}
    ^bb148:  // pred: ^bb147
      %coord_243 = cute.make_coord(%860) : (i32) -> !cute.coord<"(_,?)">
      ...
      %862 = builtin.unrealized_conversion_cast %ptr_245 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %863 = llvm.load %862 : !llvm.ptr -> vector<4xi32>
      %swizzled_248 = cute.apply_swizzle(%ptr_247) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_248, %863) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %864 = arith.addi %860, %c1_i32 : i32
      cf.br ^bb147(%864 : i32)
    ^bb149:  // pred: ^bb147
      nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
      nvvm.barrier id = %c1_i32
    ...
    ^bb150:  // pred: ^bb149
      ...
      %865 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %866 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_255 = cute_nvgpu.get_tma_desc_addr(%865 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %867 = cute_nvgpu.atom.get_value(%865 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %868:3 = cute.get_scalars(%int_tuple_254) : !cute.int_tuple<"(?{div=64},?{div=64},?)">
      cf.br ^bb151(%c0_i32 : i32)
    ^bb151(%869: i32):  // 2 preds: ^bb150, ^bb152
      %870 = arith.cmpi slt, %869, %866 : i32
      cf.cond_br %870, ^bb152, ^bb153 {llvm.loop_annotation = #loop_annotation1}
    ^bb152:  // pred: ^bb151
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_255 : !cute.ptr<generic, align<64>>, %ptr_249 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%868#0, %868#1, %868#2] : i32, i32, i32) cache_policy = %867 mode = <tiled>
      %871 = arith.addi %869, %c1_i32 : i32
      cf.br ^bb151(%871 : i32)
    ^bb153:  // pred: ^bb151
      nvvm.cp.async.bulk.commit.group
      nvvm.cp.async.bulk.wait_group 3 {read}
    ...
    ^bb154:  // 2 preds: ^bb149, ^bb153
      nvvm.barrier id = %c1_i32
      %872 = cute.memref.load(%view, %16) : (!memref_rmem_f32_1, !cute.coord<"112">) -> f32
      cute.memref.store(%rmem_151, %139, %872) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
      %873 = cute.memref.load(%view, %15) : (!memref_rmem_f32_1, !cute.coord<"113">) -> f32
      cute.memref.store(%rmem_151, %138, %873) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
      %874 = cute.memref.load(%view, %14) : (!memref_rmem_f32_1, !cute.coord<"114">) -> f32
      cute.memref.store(%rmem_151, %137, %874) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
      %875 = cute.memref.load(%view, %13) : (!memref_rmem_f32_1, !cute.coord<"115">) -> f32
      cute.memref.store(%rmem_151, %136, %875) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
      %876 = cute.memref.load(%view, %12) : (!memref_rmem_f32_1, !cute.coord<"116">) -> f32
      cute.memref.store(%rmem_151, %135, %876) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
      %877 = cute.memref.load(%view, %11) : (!memref_rmem_f32_1, !cute.coord<"117">) -> f32
      cute.memref.store(%rmem_151, %134, %877) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
      %878 = cute.memref.load(%view, %10) : (!memref_rmem_f32_1, !cute.coord<"118">) -> f32
      cute.memref.store(%rmem_151, %133, %878) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
      %879 = cute.memref.load(%view, %9) : (!memref_rmem_f32_1, !cute.coord<"119">) -> f32
      cute.memref.store(%rmem_151, %132, %879) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
      %880 = cute.memref.load(%view, %8) : (!memref_rmem_f32_1, !cute.coord<"120">) -> f32
      cute.memref.store(%rmem_151, %131, %880) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
      %881 = cute.memref.load(%view, %7) : (!memref_rmem_f32_1, !cute.coord<"121">) -> f32
      cute.memref.store(%rmem_151, %130, %881) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
      %882 = cute.memref.load(%view, %6) : (!memref_rmem_f32_1, !cute.coord<"122">) -> f32
      cute.memref.store(%rmem_151, %129, %882) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
      %883 = cute.memref.load(%view, %5) : (!memref_rmem_f32_1, !cute.coord<"123">) -> f32
      cute.memref.store(%rmem_151, %128, %883) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
      %884 = cute.memref.load(%view, %4) : (!memref_rmem_f32_1, !cute.coord<"124">) -> f32
      cute.memref.store(%rmem_151, %127, %884) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
      %885 = cute.memref.load(%view, %3) : (!memref_rmem_f32_1, !cute.coord<"125">) -> f32
      cute.memref.store(%rmem_151, %126, %885) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
      %886 = cute.memref.load(%view, %2) : (!memref_rmem_f32_1, !cute.coord<"126">) -> f32
      cute.memref.store(%rmem_151, %125, %886) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
      %887 = cute.memref.load(%view, %1) : (!memref_rmem_f32_1, !cute.coord<"127">) -> f32
      cute.memref.store(%rmem_151, %124, %887) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
      %rmem_256 = cute.memref.alloca() : !memref_rmem_f16_
      %iter_257 = cute.get_iter(%rmem_256) : !memref_rmem_f16_
      %888 = cute.memref.load_vec %rmem_151 : !memref_rmem_f32_2
      %889 = arith.truncf %888 : vector<16xf32> to vector<16xf16>
      cute.memref.store_vec %889, %rmem_256 : !memref_rmem_f16_
      cf.br ^bb155(%c0_i32 : i32)
    ^bb155(%890: i32):  // 2 preds: ^bb154, ^bb156
      %891 = arith.cmpi slt, %890, %679 : i32
      cf.cond_br %891, ^bb156, ^bb157 {llvm.loop_annotation = #loop_annotation1}
    ^bb156:  // pred: ^bb155
      %coord_258 = cute.make_coord(%890) : (i32) -> !cute.coord<"(_,?)">
      ...
      %892 = builtin.unrealized_conversion_cast %ptr_260 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
      %893 = llvm.load %892 : !llvm.ptr -> vector<4xi32>
      %swizzled_263 = cute.apply_swizzle(%ptr_262) : !cute.ptr<f16, smem, align<16>, S<2,4,3>>
      cute_nvgpu.arch.copy.stsm(%swizzled_263, %893) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32} : <f16, smem, align<16>, S<2,4,3>>, vector<4xi32>
      %894 = arith.addi %890, %c1_i32 : i32
      cf.br ^bb155(%894 : i32)
    ^bb157:  // pred: ^bb155
      nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
      nvvm.barrier id = %c1_i32
    ...
    ^bb158:  // pred: ^bb157
      ...
      %895 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>
      %896 = cute.get_scalars(%157) : !cute.int_tuple<"1">
      %TMADescAddr_270 = cute_nvgpu.get_tma_desc_addr(%895 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
      %897 = cute_nvgpu.atom.get_value(%895 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,64,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
      %898:3 = cute.get_scalars(%int_tuple_269) : !cute.int_tuple<"(?{div=32},?{div=64},?)">
      cf.br ^bb159(%c0_i32 : i32)
    ^bb159(%899: i32):  // 2 preds: ^bb158, ^bb160
      %900 = arith.cmpi slt, %899, %896 : i32
      cf.cond_br %900, ^bb160, ^bb161 {llvm.loop_annotation = #loop_annotation1}
    ^bb160:  // pred: ^bb159
      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr_270 : !cute.ptr<generic, align<64>>, %ptr_264 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%898#0, %898#1, %898#2] : i32, i32, i32) cache_policy = %897 mode = <tiled>
