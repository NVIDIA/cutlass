...
module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass___call_____main__HopperWgmmaGemmKernel_object_at__Tensorgmemoi641i64_Tensorgmemoi641i64_Tensorgmemoi641i64_CUstream0x99dc670(%arg0: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg1: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg2: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg3: !llvm.ptr) attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func <%arg3 : !llvm.ptr> @kernels::@kernel_cutlass_kernel___main__HopperWgmmaGemmKernel_object_at__CopyAtom_ThrID10_TVLayoutSrc1819201_TVLayoutDst1819201_Valuetypef16_tensor000o111012_CopyAtom_ThrID10_TVLayoutSrc1819201_TVL_0 clusters in (%33, %33, %33) blocks in (%332, %333, %334) threads in (%32, %33, %33) : i64 dynamic_shared_memory_size %34 args(%135 : !llvm.struct<(struct<(array<16 x i64>)>)>, %140 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %215 : !llvm.struct<(struct<(array<16 x i64>)>)>, %219 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %295 : !llvm.struct<(struct<(array<16 x i64>)>)>, %299 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %44 : !llvm.struct<(i1)>) {use_pdl = false}
    llvm.return
  }
