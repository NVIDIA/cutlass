...
module attributes {gpu.container_module} {
  ...
  func.func @cutlass_elementwise_apply_builtinfunctionadd_Tensorgmem_o_4096409640961_Tensorgmem_o_4096409640961_Tensorgmemoi641_CUstream0x9fd15d0(%arg0: !memref_gmem_f32_4, %arg1: !memref_gmem_f32_4, %arg2: !memref_gmem_f32_5, %arg3: !gpu.async.token) attributes {llvm.emit_c_interface} {
    ...
    %34 = cute.get_shape(%lay) : (!cute.layout<"(?,?):(?{i64},1)">) -> !cute.shape<"(?,?)">
    ...
    %36 = cute.get_scalars(%itup_12) : !cute.int_tuple<"?">
    ...
    %37:2 = cute.get_scalars(%lay_14) <{only_dynamic}> : !cute.layout<"(?,?):(1@0,1@1)">
    %38 = arith.ceildivsi %37#0, %c64_i32 : i32
    %39 = arith.ceildivsi %37#1, %c256_i32 : i32
    %shape_15 = cute.make_shape(%38, %39) : (i32, i32) -> !cute.shape<"((64,256),(?,?))">
    ...
    %e0_18, %e1_19, %e2, %e3, %e4, %e5 = cute.get_leaves(%40) : !cute.shape<"((64,256),((?,?),(?,?)))">
    ...
    %int_tuple_24 = cute.make_int_tuple(%42, %43) : (i32, i32) -> !cute.int_tuple<"(?,?)">
    %e0_25, %e1_26 = cute.get_leaves(%int_tuple_24) : !cute.int_tuple<"(?,?)">
    %44 = cute.get_scalars(%e0_25) : !cute.int_tuple<"?">
    %45 = cute.get_scalars(%e1_26) : !cute.int_tuple<"?">
    %46 = arith.index_cast %44 : i32 to index
    %47 = arith.index_cast %45 : i32 to index
    %48 = gpu.launch_func async [%arg3] @kernels::@kernel_cutlass_elementwise_apply_kernel_builtinfunctionadd_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32gmemalign16o_0 blocks in (%46, %47, %c1) threads in (%c256, %c1, %c1)  dynamic_shared_memory_size %c0_i32 args(%view : !memref_gmem_f32_, %view_3 : !memref_gmem_f32_, %view_11 : !memref_gmem_f32_1, %view_17 : !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">, %35 : i32, %36 : i32) {use_pdl = false}
    return
  }
}
