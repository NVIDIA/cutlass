...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_elementwise_apply_kernel_builtinfunctionadd_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32gmemalign16o_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f32_, %arg2: !memref_gmem_f32_1, %arg3: !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 256, 1, 1>} {
      ...
      %462 = cute.memref.load_vec %view, row_major : !memref_gmem_f32_2
      %463 = cute.memref.load_vec %view_14, row_major : !memref_gmem_f32_2
      %464 = arith.addf %462, %463 : vector<64xf32>
      cute.memref.store_vec %464, %view_19, row_major : !memref_gmem_f32_3
      return
    }
  }
  func.func @cutlass_elementwise_apply_builtinfunctionadd_Tensorgmem_o_4096409640961_Tensorgmem_o_4096409640961_Tensorgmemoi641_CUstream0x9fd15d0(%arg0: !memref_gmem_f32_4, %arg1: !memref_gmem_f32_4, %arg2: !memref_gmem_f32_5, %arg3: !gpu.async.token) attributes {llvm.emit_c_interface} {
    ...
    %6 = arith.cmpi sgt, %c64_i32, %c0_i32_3 : i32
    %7 = arith.select %6, %c-1_i32_4, %c1_i32_2 : i32
    %8 = arith.addi %7, %5#0 : i32
    %9 = arith.divsi %8, %c64_i32 : i32
    %10 = arith.addi %c1_i32_2, %9 : i32
    %11 = arith.subi %c0_i32_3, %5#0 : i32
    %12 = arith.divsi %11, %c64_i32 : i32
    %13 = arith.subi %c0_i32_3, %12 : i32
    %14 = arith.cmpi slt, %5#0, %c0_i32_3 : i32
    %15 = arith.cmpi sgt, %5#0, %c0_i32_3 : i32
    %16 = arith.cmpi slt, %c64_i32, %c0_i32_3 : i32
    %17 = arith.cmpi sgt, %c64_i32, %c0_i32_3 : i32
    %18 = arith.andi %14, %16 : i1
    %19 = arith.andi %15, %17 : i1
    %20 = arith.ori %18, %19 : i1
    %21 = arith.select %20, %10, %13 : i32
    %22 = arith.muli %5#2, %c64_i64 : i64
    %c1_i32_5 = arith.constant 1 : i32
    %c0_i32_6 = arith.constant 0 : i32
    %c-1_i32_7 = arith.constant -1 : i32
    %23 = arith.cmpi sgt, %c256_i32, %c0_i32_6 : i32
    %24 = arith.select %23, %c-1_i32_7, %c1_i32_5 : i32
    %25 = arith.addi %24, %5#1 : i32
    %26 = arith.divsi %25, %c256_i32 : i32
    %27 = arith.addi %c1_i32_5, %26 : i32
    %28 = arith.subi %c0_i32_6, %5#1 : i32
    %29 = arith.divsi %28, %c256_i32 : i32
    %30 = arith.subi %c0_i32_6, %29 : i32
    %31 = arith.cmpi slt, %5#1, %c0_i32_6 : i32
    %32 = arith.cmpi sgt, %5#1, %c0_i32_6 : i32
    %33 = arith.cmpi slt, %c256_i32, %c0_i32_6 : i32
    %34 = arith.cmpi sgt, %c256_i32, %c0_i32_6 : i32
    %35 = arith.andi %31, %33 : i1
    %36 = arith.andi %32, %34 : i1
    %37 = arith.ori %35, %36 : i1
    %38 = arith.select %37, %27, %30 : i32
    %shape = cute.make_shape(%21, %38) : (i32, i32) -> !cute.shape<"((64,256),(?,?))">
    %iv = cute.assume(%22) : (i64) -> !cute.i64<divby 64>
    %stride = cute.make_stride(%5#2, %iv) : (i64, !cute.i64<divby 64>) -> !cute.stride<"((?{i64},1),(?{i64 div=64},256))">
    %lay_8 = cute.make_layout(%shape, %stride) : !cute.layout<"((64,256),(?,?)):((?{i64},1),(?{i64 div=64},256))">
    %view = cute.make_view(%iter) : !memref_gmem_f32_
    %view_9 = cute.make_view(%iter_0) : !memref_gmem_f32_
    %39:4 = cute.get_scalars(%lay_8) <{only_dynamic}> : !cute.layout<"((64,256),(?,?)):((?{i64},1),(?{i64 div=64},256))">
    %40 = arith.divsi %39#0, %c64_i32 : i32
    %41 = arith.cmpi ne, %40, %c0_i32 : i32
    cf.cond_br %41, ^bb1, ^bb2
  ^bb1:  // pred: ^bb0
    cf.br ^bb7(%40 : i32)
  ^bb2:  // pred: ^bb0
    %42 = arith.cmpi sgt, %39#0, %c0_i32 : i32
    cf.cond_br %42, ^bb3, ^bb4
  ^bb3:  // pred: ^bb2
    cf.br ^bb5(%c1_i32 : i32)
  ^bb4:  // pred: ^bb2
    %43 = arith.cmpi eq, %39#0, %c0_i32 : i32
    %44 = arith.select %43, %c0_i32, %c-1_i32 : i32
    cf.br ^bb5(%44 : i32)
  ...
  ^bb7(%46: i32):  // 2 preds: ^bb1, ^bb6
    cf.br ^bb8
  ^bb8:  // pred: ^bb7
    %47 = arith.cmpi slt, %46, %c16_i32 : i32
    %48 = arith.select %47, %46, %c16_i32 : i32
    %49 = arith.muli %39#3, %c64_i64 : i64
    %50 = math.absi %46 : i32
    %51 = arith.divsi %c16_i32, %50 : i32
  ...
  ^bb12:  // pred: ^bb10
    %54 = arith.cmpi eq, %50, %c0_i32 : i32
    %55 = arith.select %54, %c0_i32, %c-1_i32 : i32
    cf.br ^bb13(%55 : i32)
  ^bb13(%56: i32):  // 2 preds: ^bb11, ^bb12
    cf.br ^bb14
  ^bb14:  // pred: ^bb13
    cf.br ^bb15(%56 : i32)
  ^bb15(%57: i32):  // 2 preds: ^bb9, ^bb14
    cf.br ^bb16
  ^bb16:  // pred: ^bb15
    %58 = arith.divsi %c64_i32, %39#0 : i32
    %59 = arith.cmpi ne, %58, %c0_i32 : i32
    cf.cond_br %59, ^bb17, ^bb18
  ^bb17:  // pred: ^bb16
    cf.br ^bb23(%58 : i32)
  ^bb18:  // pred: ^bb16
    %60 = arith.cmpi sgt, %39#0, %c0_i32 : i32
    cf.cond_br %60, ^bb19, ^bb20
  ^bb19:  // pred: ^bb18
    cf.br ^bb21(%c1_i32 : i32)
  ^bb20:  // pred: ^bb18
    %61 = arith.cmpi eq, %39#0, %c0_i32 : i32
    %62 = arith.select %61, %c0_i32, %c-1_i32 : i32
    cf.br ^bb21(%62 : i32)
  ^bb21(%63: i32):  // 2 preds: ^bb19, ^bb20
    cf.br ^bb22
  ^bb22:  // pred: ^bb21
    cf.br ^bb23(%63 : i32)
  ^bb23(%64: i32):  // 2 preds: ^bb17, ^bb22
    cf.br ^bb24
  ^bb24:  // pred: ^bb23
    %65 = arith.muli %64, %c256_i32 : i32
    %66 = arith.cmpi ne, %39#0, %c0_i32 : i32
    cf.cond_br %66, ^bb25, ^bb26
  ^bb25:  // pred: ^bb24
    cf.br ^bb31(%39#0 : i32)
  ^bb26:  // pred: ^bb24
    %67 = arith.cmpi sgt, %39#0, %c0_i32 : i32
    cf.cond_br %67, ^bb27, ^bb28
  ^bb27:  // pred: ^bb26
    cf.br ^bb29(%c1_i32 : i32)
  ^bb28:  // pred: ^bb26
    %68 = arith.cmpi eq, %39#0, %c0_i32 : i32
    %69 = arith.select %68, %c0_i32, %c-1_i32 : i32
    cf.br ^bb29(%69 : i32)
  ^bb29(%70: i32):  // 2 preds: ^bb27, ^bb28
    cf.br ^bb30
  ^bb30:  // pred: ^bb29
    cf.br ^bb31(%70 : i32)
  ^bb31(%71: i32):  // 2 preds: ^bb25, ^bb30
    cf.br ^bb32
  ^bb32:  // pred: ^bb31
    %72 = arith.cmpi slt, %71, %c64_i32 : i32
    %73 = arith.select %72, %71, %c64_i32 : i32
    %74 = math.absi %71 : i32
    %75 = arith.divsi %c64_i32, %74 : i32
    %76 = arith.cmpi ne, %75, %c0_i32 : i32
    cf.cond_br %76, ^bb33, ^bb34
  ^bb33:  // pred: ^bb32
    cf.br ^bb39(%75 : i32)
  ^bb34:  // pred: ^bb32
    %77 = arith.cmpi sgt, %74, %c0_i32 : i32
    cf.cond_br %77, ^bb35, ^bb36
  ^bb35:  // pred: ^bb34
    cf.br ^bb37(%c1_i32 : i32)
  ^bb36:  // pred: ^bb34
    %78 = arith.cmpi eq, %74, %c0_i32 : i32
    %79 = arith.select %78, %c0_i32, %c-1_i32 : i32
    cf.br ^bb37(%79 : i32)
  ^bb37(%80: i32):  // 2 preds: ^bb35, ^bb36
    cf.br ^bb38
  ^bb38:  // pred: ^bb37
    cf.br ^bb39(%80 : i32)
  ^bb39(%81: i32):  // 2 preds: ^bb33, ^bb38
    cf.br ^bb40
  ^bb40:  // pred: ^bb39
    %82 = arith.divsi %c1_i32, %39#0 : i32
    %83 = arith.cmpi ne, %82, %c0_i32 : i32
    cf.cond_br %83, ^bb41, ^bb42
  ^bb41:  // pred: ^bb40
    cf.br ^bb47(%82 : i32)
  ^bb42:  // pred: ^bb40
    %84 = arith.cmpi sgt, %39#0, %c0_i32 : i32
    cf.cond_br %84, ^bb43, ^bb44
  ^bb43:  // pred: ^bb42
    cf.br ^bb45(%c1_i32 : i32)
  ^bb44:  // pred: ^bb42
    %85 = arith.cmpi eq, %39#0, %c0_i32 : i32
    %86 = arith.select %85, %c0_i32, %c-1_i32 : i32
    cf.br ^bb45(%86 : i32)
  ^bb45(%87: i32):  // 2 preds: ^bb43, ^bb44
    cf.br ^bb46
  ^bb46:  // pred: ^bb45
    cf.br ^bb47(%87 : i32)
  ^bb47(%88: i32):  // 2 preds: ^bb41, ^bb46
    cf.br ^bb48
  ^bb48:  // pred: ^bb47
    %89 = arith.muli %88, %c256_i32 : i32
    %shape_10 = cute.make_shape(%48, %57, %73, %81) : (i32, i32, i32, i32) -> !cute.shape<"((64,256),((?,?),(?,?)))">
    %iv_11 = cute.assume(%49) : (i64) -> !cute.i64<divby 4096>
    %iv_12 = cute.assume(%65) : (i32) -> !cute.i32<divby 256>
    %iv_13 = cute.assume(%39#3) : (i64) -> !cute.i64<divby 64>
    %iv_14 = cute.assume(%89) : (i32) -> !cute.i32<divby 256>
    %stride_15 = cute.make_stride(%39#2, %iv_11, %iv_12, %iv_13, %iv_14) : (i64, !cute.i64<divby 4096>, !cute.i32<divby 256>, !cute.i64<divby 64>, !cute.i32<divby 256>) -> !cute.stride<"((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">
    %lay_16 = cute.make_layout(%shape_10, %stride_15) : !cute.layout<"((64,256),((?,?),(?,?))):((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">
    %view_17 = cute.make_view(%iter_1, %lay_16) : !memref_gmem_f32_1
    %90 = cute.get_shape(%lay) : (!cute.layout<"(?,?):(?{i64},1)">) -> !cute.shape<"(?,?)">
    %e0, %e1 = cute.get_leaves(%90) : !cute.shape<"(?,?)">
    %itup = cute.to_int_tuple(%e0) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %91 = cute.get_scalars(%itup) : !cute.int_tuple<"?">
    %itup_18 = cute.to_int_tuple(%e1) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %92 = cute.get_scalars(%itup_18) : !cute.int_tuple<"?">
    %shape_19 = cute.make_shape(%itup, %itup_18) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.shape<"(?,?)">
    %lay_20 = cute.make_layout(%shape_19, %1) : !cute.layout<"(?,?):(1@0,1@1)">
    %93:2 = cute.get_scalars(%lay_20) <{only_dynamic}> : !cute.layout<"(?,?):(1@0,1@1)">
    %c1_i32_21 = arith.constant 1 : i32
    %c0_i32_22 = arith.constant 0 : i32
    %c-1_i32_23 = arith.constant -1 : i32
    %94 = arith.cmpi sgt, %c64_i32, %c0_i32_22 : i32
    %95 = arith.select %94, %c-1_i32_23, %c1_i32_21 : i32
    %96 = arith.addi %95, %93#0 : i32
    %97 = arith.divsi %96, %c64_i32 : i32
    %98 = arith.addi %c1_i32_21, %97 : i32
    %99 = arith.subi %c0_i32_22, %93#0 : i32
    %100 = arith.divsi %99, %c64_i32 : i32
    %101 = arith.subi %c0_i32_22, %100 : i32
    %102 = arith.cmpi slt, %93#0, %c0_i32_22 : i32
    %103 = arith.cmpi sgt, %93#0, %c0_i32_22 : i32
    %104 = arith.cmpi slt, %c64_i32, %c0_i32_22 : i32
    %105 = arith.cmpi sgt, %c64_i32, %c0_i32_22 : i32
    %106 = arith.andi %102, %104 : i1
    %107 = arith.andi %103, %105 : i1
    %108 = arith.ori %106, %107 : i1
    %109 = arith.select %108, %98, %101 : i32
    %c1_i32_24 = arith.constant 1 : i32
    %c0_i32_25 = arith.constant 0 : i32
    %c-1_i32_26 = arith.constant -1 : i32
    %110 = arith.cmpi sgt, %c256_i32, %c0_i32_25 : i32
    %111 = arith.select %110, %c-1_i32_26, %c1_i32_24 : i32
    %112 = arith.addi %111, %93#1 : i32
    %113 = arith.divsi %112, %c256_i32 : i32
    %114 = arith.addi %c1_i32_24, %113 : i32
    %115 = arith.subi %c0_i32_25, %93#1 : i32
    %116 = arith.divsi %115, %c256_i32 : i32
    %117 = arith.subi %c0_i32_25, %116 : i32
    %118 = arith.cmpi slt, %93#1, %c0_i32_25 : i32
    %119 = arith.cmpi sgt, %93#1, %c0_i32_25 : i32
    %120 = arith.cmpi slt, %c256_i32, %c0_i32_25 : i32
    %121 = arith.cmpi sgt, %c256_i32, %c0_i32_25 : i32
    %122 = arith.andi %118, %120 : i1
    %123 = arith.andi %119, %121 : i1
    %124 = arith.ori %122, %123 : i1
    %125 = arith.select %124, %114, %117 : i32
    %shape_27 = cute.make_shape(%109, %125) : (i32, i32) -> !cute.shape<"((64,256),(?,?))">
    %lay_28 = cute.make_layout(%shape_27, %0) : !cute.layout<"((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">
    %view_29 = cute.make_view(%2, %lay_28) : !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">
    %126 = cute.get_shape(%lay_16) : (!cute.layout<"((64,256),((?,?),(?,?))):((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">) -> !cute.shape<"((64,256),((?,?),(?,?)))">
    %e0_30, %e1_31, %e2, %e3, %e4, %e5 = cute.get_leaves(%126) : !cute.shape<"((64,256),((?,?),(?,?)))">
    %itup_32 = cute.to_int_tuple(%e2) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %itup_33 = cute.to_int_tuple(%e3) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %itup_34 = cute.to_int_tuple(%e4) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %itup_35 = cute.to_int_tuple(%e5) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %int_tuple = cute.make_int_tuple(%itup_32, %itup_33, %itup_34, %itup_35) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.int_tuple<"((?,?),(?,?))">
    %127:4 = cute.get_scalars(%int_tuple) <{only_dynamic}> : !cute.int_tuple<"((?,?),(?,?))">
    %128 = arith.muli %127#0, %127#1 : i32
    %129 = arith.muli %127#2, %127#3 : i32
    %int_tuple_36 = cute.make_int_tuple(%128, %129) : (i32, i32) -> !cute.int_tuple<"(?,?)">
    %e0_37, %e1_38 = cute.get_leaves(%int_tuple_36) : !cute.int_tuple<"(?,?)">
    %130 = cute.get_scalars(%e0_37) : !cute.int_tuple<"?">
    %131 = cute.get_scalars(%e1_38) : !cute.int_tuple<"?">
    %132 = arith.index_cast %130 : i32 to index
    %133 = arith.index_cast %131 : i32 to index
    %134 = gpu.launch_func async [%arg3] @kernels::@kernel_cutlass_elementwise_apply_kernel_builtinfunctionadd_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32gmemalign16o_0 blocks in (%132, %133, %c1) threads in (%c256, %c1, %c1)  dynamic_shared_memory_size %c0_i32 args(%view : !memref_gmem_f32_, %view_9 : !memref_gmem_f32_, %view_17 : !memref_gmem_f32_1, %view_29 : !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">, %91 : i32, %92 : i32) {use_pdl = false}
    return
  }
}
