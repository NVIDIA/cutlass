...
"builtin.module"() ({
  ...
  ^bb0(%arg0: !memref_gmem_f32_4, %arg1: !memref_gmem_f32_4, %arg2: !memref_gmem_f32_5, %arg3: !cuda.stream):
    ...
    "cf.cond_br"(%28)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    "cf.br"(%27)[^bb7] : (i32) -> ()
  ^bb2:  // pred: ^bb0
    %29 = "arith.cmpi"(%26#0, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%29)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    "cf.br"(%5)[^bb5] : (i32) -> ()
  ^bb4:  // pred: ^bb2
    %30 = "arith.cmpi"(%26#0, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %31 = "arith.select"(%30, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%31)[^bb5] : (i32) -> ()
  ^bb5(%32: i32):  // 2 preds: ^bb3, ^bb4
    "cf.br"()[^bb6] : () -> ()
  ^bb6:  // pred: ^bb5
    "cf.br"(%32)[^bb7] : (i32) -> ()
  ^bb7(%33: i32):  // 2 preds: ^bb1, ^bb6
    "cf.br"()[^bb8] : () -> ()
  ^bb8:  // pred: ^bb7
    %34 = "arith.minsi"(%33, %3) : (i32, i32) -> i32
    %35 = "arith.muli"(%26#3, %8) <{overflowFlags = #arith.overflow<none>}> : (i64, i64) -> i64
    %36 = "math.absi"(%33) : (i32) -> i32
    %37 = "arith.divsi"(%3, %36) : (i32, i32) -> i32
    %38 = "arith.cmpi"(%37, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%38)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    "cf.br"(%37)[^bb15] : (i32) -> ()
  ^bb10:  // pred: ^bb8
    %39 = "arith.cmpi"(%36, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%39)[^bb11, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    "cf.br"(%5)[^bb13] : (i32) -> ()
  ^bb12:  // pred: ^bb10
    %40 = "arith.cmpi"(%36, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %41 = "arith.select"(%40, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%41)[^bb13] : (i32) -> ()
  ^bb13(%42: i32):  // 2 preds: ^bb11, ^bb12
    "cf.br"()[^bb14] : () -> ()
  ^bb14:  // pred: ^bb13
    "cf.br"(%42)[^bb15] : (i32) -> ()
  ^bb15(%43: i32):  // 2 preds: ^bb9, ^bb14
    "cf.br"()[^bb16] : () -> ()
  ^bb16:  // pred: ^bb15
    %44 = "arith.divsi"(%9, %26#0) : (i32, i32) -> i32
    %45 = "arith.cmpi"(%44, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%45)[^bb17, ^bb18] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb17:  // pred: ^bb16
    "cf.br"(%44)[^bb23] : (i32) -> ()
  ^bb18:  // pred: ^bb16
    %46 = "arith.cmpi"(%26#0, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%46)[^bb19, ^bb20] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb19:  // pred: ^bb18
    "cf.br"(%5)[^bb21] : (i32) -> ()
  ^bb20:  // pred: ^bb18
    %47 = "arith.cmpi"(%26#0, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %48 = "arith.select"(%47, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%48)[^bb21] : (i32) -> ()
  ^bb21(%49: i32):  // 2 preds: ^bb19, ^bb20
    "cf.br"()[^bb22] : () -> ()
  ^bb22:  // pred: ^bb21
    "cf.br"(%49)[^bb23] : (i32) -> ()
  ^bb23(%50: i32):  // 2 preds: ^bb17, ^bb22
    "cf.br"()[^bb24] : () -> ()
  ^bb24:  // pred: ^bb23
    %51 = "arith.muli"(%50, %7) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %52 = "arith.cmpi"(%26#0, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%52)[^bb25, ^bb26] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb25:  // pred: ^bb24
    "cf.br"(%26#0)[^bb31] : (i32) -> ()
  ^bb26:  // pred: ^bb24
    %53 = "arith.cmpi"(%26#0, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%53)[^bb27, ^bb28] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb27:  // pred: ^bb26
    "cf.br"(%5)[^bb29] : (i32) -> ()
  ^bb28:  // pred: ^bb26
    %54 = "arith.cmpi"(%26#0, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %55 = "arith.select"(%54, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%55)[^bb29] : (i32) -> ()
  ^bb29(%56: i32):  // 2 preds: ^bb27, ^bb28
    "cf.br"()[^bb30] : () -> ()
  ^bb30:  // pred: ^bb29
    "cf.br"(%56)[^bb31] : (i32) -> ()
  ^bb31(%57: i32):  // 2 preds: ^bb25, ^bb30
    "cf.br"()[^bb32] : () -> ()
  ^bb32:  // pred: ^bb31
    %58 = "arith.minsi"(%57, %9) : (i32, i32) -> i32
    %59 = "math.absi"(%57) : (i32) -> i32
    %60 = "arith.divsi"(%9, %59) : (i32, i32) -> i32
    %61 = "arith.cmpi"(%60, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%61)[^bb33, ^bb34] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb33:  // pred: ^bb32
    "cf.br"(%60)[^bb39] : (i32) -> ()
  ^bb34:  // pred: ^bb32
    %62 = "arith.cmpi"(%59, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%62)[^bb35, ^bb36] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb35:  // pred: ^bb34
    "cf.br"(%5)[^bb37] : (i32) -> ()
  ^bb36:  // pred: ^bb34
    %63 = "arith.cmpi"(%59, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %64 = "arith.select"(%63, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%64)[^bb37] : (i32) -> ()
  ^bb37(%65: i32):  // 2 preds: ^bb35, ^bb36
    "cf.br"()[^bb38] : () -> ()
  ^bb38:  // pred: ^bb37
    "cf.br"(%65)[^bb39] : (i32) -> ()
  ^bb39(%66: i32):  // 2 preds: ^bb33, ^bb38
    "cf.br"()[^bb40] : () -> ()
  ^bb40:  // pred: ^bb39
    %67 = "arith.divsi"(%5, %26#0) : (i32, i32) -> i32
    %68 = "arith.cmpi"(%67, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%68)[^bb41, ^bb42] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb41:  // pred: ^bb40
    "cf.br"(%67)[^bb47] : (i32) -> ()
  ^bb42:  // pred: ^bb40
    %69 = "arith.cmpi"(%26#0, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "cf.cond_br"(%69)[^bb43, ^bb44] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb43:  // pred: ^bb42
    "cf.br"(%5)[^bb45] : (i32) -> ()
  ^bb44:  // pred: ^bb42
    %70 = "arith.cmpi"(%26#0, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %71 = "arith.select"(%70, %6, %4) : (i1, i32, i32) -> i32
    "cf.br"(%71)[^bb45] : (i32) -> ()
  ^bb45(%72: i32):  // 2 preds: ^bb43, ^bb44
    "cf.br"()[^bb46] : () -> ()
  ^bb46:  // pred: ^bb45
    "cf.br"(%72)[^bb47] : (i32) -> ()
  ^bb47(%73: i32):  // 2 preds: ^bb41, ^bb46
    "cf.br"()[^bb48] : () -> ()
  ^bb48:  // pred: ^bb47
    %74 = "arith.muli"(%73, %7) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %75 = "cute.make_shape"(%34, %43, %58, %66) : (i32, i32, i32, i32) -> !cute.shape<"((64,256),((?,?),(?,?)))">
    %76 = "cute.assume"(%35) : (i64) -> !cute.i64<divby 4096>
    %77 = "cute.assume"(%51) : (i32) -> !cute.i32<divby 256>
    %78 = "cute.assume"(%26#3) : (i64) -> !cute.i64<divby 64>
    %79 = "cute.assume"(%74) : (i32) -> !cute.i32<divby 256>
    %80 = "cute.make_stride"(%26#2, %76, %77, %78, %79) : (i64, !cute.i64<divby 4096>, !cute.i32<divby 256>, !cute.i64<divby 64>, !cute.i32<divby 256>) -> !cute.stride<"((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">
    %81 = "cute.make_layout"(%75, %80) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((64,256),((?,?),(?,?)))">, !cute.stride<"((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">) -> !cute.layout<"((64,256),((?,?),(?,?))):((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">
    %82 = "cute.make_view"(%14, %81) : (!cute.ptr<f32, gmem, align<16>>, !cute.layout<"((64,256),((?,?),(?,?))):((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">) -> !memref_gmem_f32_1
    %83 = "cute.get_shape"(%15) : (!cute.layout<"(?,?):(?{i64},1)">) -> !cute.shape<"(?,?)">
    %84:2 = "cute.get_leaves"(%83) : (!cute.shape<"(?,?)">) -> (!cute.shape<"?">, !cute.shape<"?">)
    %85 = "cute.to_int_tuple"(%84#0) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %86 = "cute.to_int_tuple"(%84#1) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %87 = "cute.make_shape"(%85, %86) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.shape<"(?,?)">
    %88 = "cute.make_arith_tuple_iter"() : () -> !cute.arith_tuple_iter<"(0,0)">
    %89 = "cute.make_layout"(%87, %2) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"(?,?)">, !cute.stride<"(1@0,1@1)">) -> !cute.layout<"(?,?):(1@0,1@1)">
    %90:2 = "cute.get_scalars"(%89) <{only_dynamic}> : (!cute.layout<"(?,?):(1@0,1@1)">) -> (i32, i32)
    %91 = "arith.ceildivsi"(%90#0, %9) : (i32, i32) -> i32
    %92 = "arith.ceildivsi"(%90#1, %7) : (i32, i32) -> i32
    %93 = "cute.make_shape"(%91, %92) : (i32, i32) -> !cute.shape<"((64,256),(?,?))">
    %94 = "cute.make_layout"(%93, %1) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((64,256),(?,?))">, !cute.stride<"((1@0,1@1),(64@0,256@1))">) -> !cute.layout<"((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">
    %95 = "cute.make_view"(%88, %94) : (!cute.arith_tuple_iter<"(0,0)">, !cute.layout<"((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">) -> !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">
    %96 = "cute.get_scalars"(%85) : (!cute.int_tuple<"?">) -> i32
    %97 = "cute.get_scalars"(%86) : (!cute.int_tuple<"?">) -> i32
    %98 = "cute.get_shape"(%81) : (!cute.layout<"((64,256),((?,?),(?,?))):((?{i64},1),((?{i64 div=4096},?{div=256}),(?{i64 div=64},?{div=256})))">) -> !cute.shape<"((64,256),((?,?),(?,?)))">
    %99:6 = "cute.get_leaves"(%98) : (!cute.shape<"((64,256),((?,?),(?,?)))">) -> (!cute.shape<"64">, !cute.shape<"256">, !cute.shape<"?">, !cute.shape<"?">, !cute.shape<"?">, !cute.shape<"?">)
    %100 = "cute.to_int_tuple"(%99#2) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %101 = "cute.to_int_tuple"(%99#3) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %102 = "cute.to_int_tuple"(%99#4) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %103 = "cute.to_int_tuple"(%99#5) : (!cute.shape<"?">) -> !cute.int_tuple<"?">
    %104 = "cute.make_int_tuple"(%100, %101, %102, %103) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.int_tuple<"((?,?),(?,?))">
    %105:4 = "cute.get_scalars"(%104) <{only_dynamic}> : (!cute.int_tuple<"((?,?),(?,?))">) -> (i32, i32, i32, i32)
    %106 = "arith.muli"(%105#0, %105#1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %107 = "arith.muli"(%105#2, %105#3) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %108 = "cute.make_int_tuple"(%106, %107) : (i32, i32) -> !cute.int_tuple<"(?,?)">
    %109:2 = "cute.get_leaves"(%108) : (!cute.int_tuple<"(?,?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?">)
    %110 = "cute.get_scalars"(%109#0) : (!cute.int_tuple<"?">) -> i32
    %111 = "cute.get_scalars"(%109#1) : (!cute.int_tuple<"?">) -> i32
    %112 = "cuda.launch_cfg.create"(%7, %5, %5, %0, %110, %111, %5, %arg3) <{maxNumAttrs = 3 : i32}> : (i32, i32, i32, i64, i32, i32, i32, !cuda.stream) -> !cuda.launch_cfg<max_attrs = 3>
    "cuda.launch_cfg.programmatic_stream_serialization_allowed"(%112, %6) : (!cuda.launch_cfg<max_attrs = 3>, i32) -> ()
    "cuda.launch_cfg.cooperative"(%112, %6) : (!cuda.launch_cfg<max_attrs = 3>, i32) -> ()
    %113 = "cuda.launch_ex"(%112, %24, %25, %82, %95, %96, %97) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass_elementwise_apply_kernel_builtinfunctionadd_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32_gmem_align16_o_64256166440961256262144_tensorptrf32gmemalign16o_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_f32_, !memref_gmem_f32_1, !cute.coord_tensor<"(0,0)", "((64,256),(?,?)):((1@0,1@1),(64@0,256@1))">, i32, i32) -> !cuda.result
    %114 = "cuda.cast"(%113) : (!cuda.result) -> i32
    "cuda.return_if_error"(%114) : (i32) -> ()
    "func.return"(%6) : (i32) -> ()
