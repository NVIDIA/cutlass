...
module attributes {gpu.container_module} {
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
    ...
    ^bb73(%763: i32):  // 2 preds: ^bb72, ^bb74
      ...
      llvm.cond_br %764, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb76(%788: i32):  // 2 preds: ^bb75, ^bb77
      ...
      llvm.cond_br %789, ^bb77, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb77:  // pred: ^bb76
    ...
    ^bb83(%809: i32):  // 2 preds: ^bb82, ^bb86
      ...
      llvm.cond_br %810, ^bb84, ^bb87 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
