gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_90a">] {
  ...
  ^bb73(%765: i32):  // 2 preds: ^bb72, ^bb74
    ...
    llvm.cond_br %766, ^bb74, ^bb75 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb76(%790: i32):  // 2 preds: ^bb75, ^bb77
    ...
    llvm.cond_br %791, ^bb77, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb77:  // pred: ^bb76
  ...
  ^bb83(%811: i32):  // 2 preds: ^bb82, ^bb86
    ...
    llvm.cond_br %812, ^bb84, ^bb87 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb84:  // pred: ^bb83
