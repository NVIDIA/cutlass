...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb26:  // pred: ^bb24
      ...
      cute.memref.store_vec %cst, %rmem_292, row_major : !memref_rmem_f32_
    ...
    ^bb73:  // pred: ^bb33
      ...
      %411 = cute.memref.load_vec %rmem_292, row_major : !memref_rmem_f32_
      ...
      cute.memref.store_vec %412, %view_454, row_major : !memref_rmem_f16_2
