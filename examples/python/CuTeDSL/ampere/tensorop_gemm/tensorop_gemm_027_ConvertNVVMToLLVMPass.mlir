...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb14(%385: i32):  // 2 preds: ^bb13, ^bb15
      ...
      llvm.cond_br %386, ^bb15, ^bb16 {llvm.loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
    ...
    ^bb21(%397: i32):  // 2 preds: ^bb20, ^bb22
      ...
      llvm.cond_br %398, ^bb22, ^bb23 {llvm.loop_annotation = #loop_annotation}
    ^bb22:  // pred: ^bb21
    ...
    ^bb24(%411: i32):  // 2 preds: ^bb23, ^bb25
      ...
      llvm.cond_br %412, ^bb25, ^bb26 {llvm.loop_annotation = #loop_annotation}
    ^bb25:  // pred: ^bb24
    ...
    ^bb30(%527: i32):  // 2 preds: ^bb29, ^bb31
      ...
      llvm.cond_br %528, ^bb31, ^bb32 {llvm.loop_annotation = #loop_annotation}
    ^bb31:  // pred: ^bb30
    ...
    ^bb35:  // pred: ^bb34
      ...
      llvm.cond_br %574, ^bb36, ^bb71 {loop_annotation = #loop_annotation1}
    ^bb36:  // pred: ^bb35
    ...
    ^bb44(%632: i32):  // 2 preds: ^bb43, ^bb45
      ...
      llvm.cond_br %633, ^bb45, ^bb46 {llvm.loop_annotation = #loop_annotation}
    ^bb45:  // pred: ^bb44
    ...
    ^bb49(%674: i32):  // 2 preds: ^bb48, ^bb50
      ...
      llvm.cond_br %675, ^bb50, ^bb51 {llvm.loop_annotation = #loop_annotation}
    ^bb50:  // pred: ^bb49
    ...
    ^bb73(%782: i32):  // 2 preds: ^bb72, ^bb74
      ...
      llvm.cond_br %783, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb76(%807: i32):  // 2 preds: ^bb75, ^bb77
      ...
      llvm.cond_br %808, ^bb77, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb77:  // pred: ^bb76
    ...
    ^bb83(%828: i32):  // 2 preds: ^bb82, ^bb86
      ...
      llvm.cond_br %829, ^bb84, ^bb87 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
