  ...
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel___main__TensorOpGemm_object_at__tensorptrf16gmemalign16odiv81div8div8_tensorptrf16gmemalign16odiv81div8div8_tensorptrf16gmemalign16odiv8div81div8_S333o0o642841315126_0(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f16_, %arg2: !memref_gmem_f16_1, %arg3: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %77 {
        ...
        cute.memref.store_vec %cst_1, %view_166, row_major : !memref_smem_f16_
        nvvm.barrier
        ...
        scf.for %arg4 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
          ...
          %260 = cute.get_scalars(%coord_341) : !cute.coord<"?">
          %261 = arith.cmpi slt, %160, %260 : i32
          scf.if %261 {
            ...
            %262 = cute.get_scalars(%44) : !cute.int_tuple<"1">
            ...
            scf.for %arg5 = %c0_i32 to %262 step %c1_i32  : i32 {
              ...
              %263 = builtin.unrealized_conversion_cast %ptr_352 : !cute.ptr<i8, rmem> to !llvm.ptr
              %264 = llvm.load %263 : !llvm.ptr -> i8
              %265 = llvm.trunc %264 : i8 to i1
              cute_nvgpu.arch.copy.SM80.cp_async(%iter_349 : !cute.ptr<i128, smem>, %iter_348 : !cute.ptr<i128, gmem>, %265 : i1) {cache_mode = <global>}
        ...
        scf.for %arg4 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
          ...
          %coord_341 = cute.make_coord(%e1_339) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
          %260 = cute.get_scalars(%coord_341) : !cute.coord<"?">
          %261 = arith.cmpi slt, %161, %260 : i32
          scf.if %261 {
            %coord_342 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(_,_,?,0)">
        ...
        scf.if %162 {
          ...
          cute.memref.store_vec %cst_0, %rmem_184, row_major : !memref_rmem_i8_
        }
        ...
        scf.for %arg4 = %c0_i32 to %166 step %c1_i32  : i32 {
          ...
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_341 : !cute.ptr<i128, smem>, %iter_340 : !cute.ptr<i128, gmem>, %261 : i1) {cache_mode = <global>}
        } {llvm.loop_annotation = #loop_annotation}
        ...
        cute.memref.store_vec %cst, %rmem_242, row_major : !memref_rmem_f32_
        ...
        %233 = builtin.unrealized_conversion_cast %view_260 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
        %234 = cute.get_scalars(%lay_255) <{only_dynamic}> : !cute.layout<"((8,1),(2,2),2,(1,3)):((1,0),(?{div=32},512),2048,(0,4096))">
        %iv_261 = cute.assume(%234) : (i32) -> !cute.i32<divby 32>
        ...
        %235 = builtin.unrealized_conversion_cast %view_264 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
        nvvm.cp.async.wait.group 1
        nvvm.barrier
        %236 = cute.get_scalars(%lay_259) <{only_dynamic}> : !cute.layout<"((8,1),(2,2),2):((1,0),(?{div=32},512),2048)">
        %iv_265 = cute.assume(%236) : (i32) -> !cute.i32<divby 32>
        ...
        %237 = cute.get_scalars(%append_268) <{only_dynamic}> : !cute.layout<"((8,1),(2,2)):((1,0),(?{div=32},512))">
        %iv_269 = cute.assume(%237) : (i32) -> !cute.i32<divby 32>
        ...
        %238 = cute.get_scalars(%append_272) <{only_dynamic}> : !cute.layout<"((8,1),((2,2))):((1,0),((?{div=32},512)))">
        %iv_273 = cute.assume(%238) : (i32) -> !cute.i32<divby 32>
        ...
        scf.for %arg4 = %c0_i32 to %166 step %c1_i32  : i32 {
          ...
          %260 = cute_nvgpu.arch.copy.ldsm %ptr_337{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>> -> vector<4xi32>
          %261 = vector.extractelement %260[%31 : i32] : vector<4xi32>
          %262 = builtin.unrealized_conversion_cast %ptr_339 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          llvm.store %261, %262 : i32, !llvm.ptr
          %263 = vector.extractelement %260[%30 : i32] : vector<4xi32>
          %ptr_340 = cute.add_offset(%ptr_339, %29) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
          %264 = builtin.unrealized_conversion_cast %ptr_340 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          llvm.store %263, %264 : i32, !llvm.ptr
          %265 = vector.extractelement %260[%28 : i32] : vector<4xi32>
          %ptr_341 = cute.add_offset(%ptr_339, %39) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
          %266 = builtin.unrealized_conversion_cast %ptr_341 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
          llvm.store %265, %266 : i32, !llvm.ptr
          %267 = vector.extractelement %260[%27 : i32] : vector<4xi32>
          %ptr_342 = cute.add_offset(%ptr_339, %26) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
          %268 = builtin.unrealized_conversion_cast %ptr_342 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          llvm.store %267, %268 : i32, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %239 = cute.get_scalars(%lay_263) <{only_dynamic}> : !cute.layout<"((8,1),(2,2),2):((1,0),(?{div=32},512),2048)">
        %iv_276 = cute.assume(%239) : (i32) -> !cute.i32<divby 32>
        ...
        %240 = cute.get_scalars(%append_279) <{only_dynamic}> : !cute.layout<"((8,1),(2,2)):((1,0),(?{div=32},512))">
        %iv_280 = cute.assume(%240) : (i32) -> !cute.i32<divby 32>
        ...
        %241 = cute.get_scalars(%append_283) <{only_dynamic}> : !cute.layout<"((8,1),((2,2))):((1,0),((?{div=32},512)))">
        %iv_284 = cute.assume(%241) : (i32) -> !cute.i32<divby 32>
        ...
        scf.for %arg4 = %c0_i32 to %166 step %c1_i32  : i32 {
          ...
          %260 = cute_nvgpu.arch.copy.ldsm %ptr_337{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>> -> vector<4xi32>
          %261 = vector.extractelement %260[%31 : i32] : vector<4xi32>
          %262 = builtin.unrealized_conversion_cast %ptr_339 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
          llvm.store %261, %262 : i32, !llvm.ptr
          %263 = vector.extractelement %260[%30 : i32] : vector<4xi32>
        ...
        %242 = cute.get_scalars(%44) : !cute.int_tuple<"1">
        %243 = cute.get_scalars(%15) : !cute.int_tuple<"8">
        %244:5 = scf.for %arg4 = %c0_i32 to %159 step %c1_i32 iter_args(%arg5 = %233, %arg6 = %235, %arg7 = %c2_i32, %arg8 = %c2_i32, %arg9 = %c0_i32) -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32)  : i32 {
          %260:5 = scf.for %arg10 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg11 = %arg5, %arg12 = %arg6, %arg13 = %arg7, %arg14 = %arg8, %arg15 = %arg9) -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32)  : i32 {
            %261 = arith.cmpi eq, %arg10, %c1_i32 : i32
            %262:2 = scf.if %261 -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>) {
              ...
              %276 = builtin.unrealized_conversion_cast %view_378 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
              ...
              %277 = builtin.unrealized_conversion_cast %view_381 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
              nvvm.cp.async.wait.group 1
              nvvm.barrier
              scf.yield %276, %277 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
            } else {
              scf.yield %arg11, %arg12 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
            }
            %263 = builtin.unrealized_conversion_cast %262#1 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)> to !memref_smem_f16_1
            %264 = builtin.unrealized_conversion_cast %262#0 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)> to !memref_smem_f16_1
            %265 = arith.addi %arg10, %c1_i32 : i32
            %266 = arith.remsi %265, %c2_i32 : i32
            %coord_335 = cute.make_coord(%266) : (i32) -> !cute.coord<"(_,_,?)">
            %lay_336 = cute.get_layout(%264) : !memref_smem_f16_1
            %267 = cute.get_scalars(%lay_336) <{only_dynamic}> : !cute.layout<"((8,1),(2,2),2):((1,0),(?{div=32},512),2048)">
            %iv_337 = cute.assume(%267) : (i32) -> !cute.i32<divby 32>
            ...
            %iter_341 = cute.get_iter(%264) : !memref_smem_f16_1
            ...
            %268 = cute.get_scalars(%append_345) <{only_dynamic}> : !cute.layout<"((8,1),(2,2)):((1,0),(?{div=32},512))">
            %iv_346 = cute.assume(%268) : (i32) -> !cute.i32<divby 32>
            ...
            %269 = cute.get_scalars(%append_349) <{only_dynamic}> : !cute.layout<"((8,1),((2,2))):((1,0),((?{div=32},512)))">
            %iv_350 = cute.assume(%269) : (i32) -> !cute.i32<divby 32>
            ...
            scf.for %arg16 = %c0_i32 to %166 step %c1_i32  : i32 {
              ...
              %276 = cute_nvgpu.arch.copy.ldsm %ptr_377{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>> -> vector<4xi32>
              %277 = vector.extractelement %276[%31 : i32] : vector<4xi32>
              %278 = builtin.unrealized_conversion_cast %ptr_379 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              llvm.store %277, %278 : i32, !llvm.ptr
              %279 = vector.extractelement %276[%30 : i32] : vector<4xi32>
              %ptr_380 = cute.add_offset(%ptr_379, %29) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
              %280 = builtin.unrealized_conversion_cast %ptr_380 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %279, %280 : i32, !llvm.ptr
              %281 = vector.extractelement %276[%28 : i32] : vector<4xi32>
              %ptr_381 = cute.add_offset(%ptr_379, %39) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
              %282 = builtin.unrealized_conversion_cast %ptr_381 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %281, %282 : i32, !llvm.ptr
              %283 = vector.extractelement %276[%27 : i32] : vector<4xi32>
              %ptr_382 = cute.add_offset(%ptr_379, %26) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
              %284 = builtin.unrealized_conversion_cast %ptr_382 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %283, %284 : i32, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %lay_353 = cute.get_layout(%263) : !memref_smem_f16_1
            %270 = cute.get_scalars(%lay_353) <{only_dynamic}> : !cute.layout<"((8,1),(2,2),2):((1,0),(?{div=32},512),2048)">
            %iv_354 = cute.assume(%270) : (i32) -> !cute.i32<divby 32>
            ...
            %iter_358 = cute.get_iter(%263) : !memref_smem_f16_1
            ...
            %271 = cute.get_scalars(%append_362) <{only_dynamic}> : !cute.layout<"((8,1),(2,2)):((1,0),(?{div=32},512))">
            %iv_363 = cute.assume(%271) : (i32) -> !cute.i32<divby 32>
            ...
            %272 = cute.get_scalars(%append_366) <{only_dynamic}> : !cute.layout<"((8,1),((2,2))):((1,0),((?{div=32},512)))">
            %iv_367 = cute.assume(%272) : (i32) -> !cute.i32<divby 32>
            ...
            scf.for %arg16 = %c0_i32 to %166 step %c1_i32  : i32 {
              ...
              %276 = cute_nvgpu.arch.copy.ldsm %ptr_377{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>> -> vector<4xi32>
              %277 = vector.extractelement %276[%31 : i32] : vector<4xi32>
              %278 = builtin.unrealized_conversion_cast %ptr_379 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %277, %278 : i32, !llvm.ptr
              %279 = vector.extractelement %276[%30 : i32] : vector<4xi32>
            ...
            %273 = arith.cmpi eq, %arg10, %c0_i32 : i32
            scf.if %273 {
              %276 = arith.addi %arg4, %c2_i32 : i32
              %277 = arith.cmpi sgt, %159, %276 : i32
              scf.if %277 {
                ...
                %278 = builtin.unrealized_conversion_cast %iter_202 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
                scf.for %arg16 = %c0_i32 to %166 step %c1_i32  : i32 {
            ...
            scf.for %arg16 = %c0_i32 to %242 step %c1_i32  : i32 {
              scf.for %arg17 = %c0_i32 to %166 step %c1_i32  : i32 {
                ...
                %276 = builtin.unrealized_conversion_cast %ptr_377 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
                %277 = llvm.getelementptr %276[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %278 = llvm.getelementptr %276[2] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %279 = llvm.getelementptr %276[3] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                scf.for %arg18 = %c0_i32 to %243 step %c1_i32  : i32 {
                  ...
                  %283 = llvm.load %279 : !llvm.ptr -> vector<2xf16>
                  %284 = builtin.unrealized_conversion_cast %ptr_381 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
                  %285 = llvm.load %284 : !llvm.ptr -> vector<2xf16>
                  %286 = llvm.getelementptr %284[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                  %287 = llvm.load %286 : !llvm.ptr -> vector<2xf16>
                  %288 = builtin.unrealized_conversion_cast %ptr_383 : !cute.ptr<f32, rmem, align<16>> to !llvm.ptr
                  %289 = llvm.load %288 : !llvm.ptr -> f32
                  %290 = llvm.getelementptr %288[1] : (!llvm.ptr) -> !llvm.ptr, f32
                  %291 = llvm.load %290 : !llvm.ptr -> f32
                  %292 = llvm.getelementptr %288[2] : (!llvm.ptr) -> !llvm.ptr, f32
                  %293 = llvm.load %292 : !llvm.ptr -> f32
                  %294 = llvm.getelementptr %288[3] : (!llvm.ptr) -> !llvm.ptr, f32
                  %295 = llvm.load %294 : !llvm.ptr -> f32
                  %296:4 = cute_nvgpu.arch.mma.SM80 A[%280, %281, %282, %283]  B[%285, %287]  C[%289, %291, %293, %295] < {a_type = f16, b_type = f16, shape_MNK = #cute.shape<"(16,8,16)">}> : (vector<2xf16>, vector<2xf16>, f32) -> (f32, f32, f32, f32)
                  llvm.store %296#0, %288 : f32, !llvm.ptr
                  llvm.store %296#1, %290 : f32, !llvm.ptr
                  llvm.store %296#2, %292 : f32, !llvm.ptr
                  llvm.store %296#3, %294 : f32, !llvm.ptr
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %274 = arith.select %273, %arg15, %arg14 : i32
            %275:2 = scf.if %273 -> (i32, i32) {
              %276 = arith.addi %arg4, %c2_i32 : i32
              %277 = arith.cmpi sgt, %159, %276 : i32
              scf.if %277 {
                %coord_375 = cute.make_coord(%arg13) : (i32) -> !cute.coord<"(_,_,_,?)">
                ...
                %282 = builtin.unrealized_conversion_cast %iter_203 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
                scf.for %arg16 = %c0_i32 to %166 step %c1_i32  : i32 {
                  %coord_381 = cute.make_coord(%arg16) : (i32) -> !cute.coord<"(_,?)">
                  ...
                  %iter_386 = cute.recast_iter(%ptr_383) : !cute.ptr<f16, gmem, align<16>> to !cute.ptr<i128, gmem>
                  %iter_387 = cute.recast_iter(%ptr_385) : !cute.ptr<f16, smem, align<16>> to !cute.ptr<i128, smem>
                  cute_nvgpu.arch.copy.SM80.cp_async(%iter_387 : !cute.ptr<i128, smem>, %iter_386 : !cute.ptr<i128, gmem>, %284 : i1) {cache_mode = <global>}
                } {llvm.loop_annotation = #loop_annotation}
              }
              %278 = arith.addi %arg13, %c1_i32 : i32
              nvvm.cp.async.commit.group
              %279 = arith.addi %arg15, %c1_i32 : i32
              %280 = arith.cmpi eq, %279, %c3_i32 : i32
              %281 = arith.select %280, %c0_i32, %279 : i32
              scf.yield %278, %281 : i32, i32
            } else {
              scf.yield %arg13, %arg15 : i32, i32
            }
            scf.yield %262#0, %262#1, %275#0, %274, %275#1 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          scf.yield %260#0, %260#1, %260#2, %260#3, %260#4 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32
        }
        nvvm.cp.async.wait.group 0
        nvvm.barrier
        %rmem_288 = cute.memref.alloca() : !memref_rmem_f16_2
        %245 = cute.memref.load_vec %rmem_242, row_major : !memref_rmem_f32_
        %246 = arith.truncf %245 : vector<128xf32> to vector<128xf16>
        %iter_289 = cute.get_iter(%rmem_288) : !memref_rmem_f16_2
        %view_290 = cute.make_view(%iter_289) : !memref_rmem_f16_2
        cute.memref.store_vec %246, %view_290, row_major : !memref_rmem_f16_2
        %247:2 = cute.get_scalars(%lay_239) <{only_dynamic}> : !cute.layout<"((2,2),4,(2,2,2)):((1,1024),4096,(?{div=16},?{div=32},64))">
        %iv_291 = cute.assume(%247#0) : (i32) -> !cute.i32<divby 16>
        %iv_292 = cute.assume(%247#1) : (i32) -> !cute.i32<divby 32>
        ...
        %248:2 = cute.get_scalars(%lay_294) <{only_dynamic}> : !cute.layout<"(2,(2,4,2,2,2)):(1,(1024,4096,?{div=16},?{div=32},64))">
        %iv_295 = cute.assume(%248#0) : (i32) -> !cute.i32<divby 16>
        %iv_296 = cute.assume(%248#1) : (i32) -> !cute.i32<divby 32>
        ...
        %249:2 = cute.get_scalars(%append_299) <{only_dynamic}> : !cute.layout<"(2,(2,4,2,2,2)):(1,(1024,4096,?{div=16},?{div=32},64))">
        %iv_300 = cute.assume(%249#0) : (i32) -> !cute.i32<divby 16>
        %iv_301 = cute.assume(%249#1) : (i32) -> !cute.i32<divby 32>
        ...
        %250 = cute.get_scalars(%11) : !cute.int_tuple<"64">
        scf.for %arg4 = %c0_i32 to %250 step %c1_i32  : i32 {
          %coord_335 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(_,?)">
          ...
          %260 = builtin.unrealized_conversion_cast %ptr_337 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          %261 = builtin.unrealized_conversion_cast %ptr_339 : !cute.ptr<f16, smem, align<4>> to !llvm.ptr<3>
          %262 = llvm.load %260 {alignment = 4 : i64} : !llvm.ptr -> vector<2xf16>
          llvm.store %262, %261 {alignment = 4 : i64} : vector<2xf16>, !llvm.ptr<3>
        } {llvm.loop_annotation = #loop_annotation}
        ...
        %251:2 = cute.get_scalars(%lay_313) <{only_dynamic}> : !cute.layout<"(?{div=128},?{div=128},1):(1@0,1@1,1@2)">
        %iv_314 = cute.assume(%251#0) : (i32) -> !cute.i32<divby 128>
        %iv_315 = cute.assume(%251#1) : (i32) -> !cute.i32<divby 128>
        ...
        %252:2 = cute.get_scalars(%lay_317) <{only_dynamic}> : !cute.layout<"(?{div=128},?{div=128}):(1@0,1@1)">
        %253 = arith.ceildivsi %252#0, %c128_i32 : i32
        %254 = arith.ceildivsi %252#1, %c128_i32 : i32
        %shape_320 = cute.make_shape(%253, %254) : (i32, i32) -> !cute.shape<"((128,128),(?,?))">
        ...
        %255 = cute.get_scalars(%24) : !cute.int_tuple<"16">
        scf.for %arg4 = %c0_i32 to %255 step %c1_i32  : i32 {
          %coord_335 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(_,?)">
          ...
          %260 = builtin.unrealized_conversion_cast %ptr_337 : !cute.ptr<f16, smem, align<16>> to !llvm.ptr<3>
          %261 = builtin.unrealized_conversion_cast %ptr_339 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          %262 = llvm.load %260 {alignment = 16 : i64} : !llvm.ptr<3> -> vector<8xf16>
          llvm.store %262, %261 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %rmem_328 = cute.memref.alloca() : !memref_rmem_i8_1
        %coord_329 = cute.make_coord(%itup) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
        %256 = cute.get_scalars(%coord_329) : !cute.coord<"?">
        scf.for %arg4 = %c0_i32 to %c16_i32 step %c1_i32  : i32 {
          ...
          %260 = cute.get_scalars(%coord_341) : !cute.coord<"?">
          %261 = arith.cmpi slt, %260, %256 : i32
          ...
          cute.memref.store(%rmem_328, %dyn_343, %262) : (!memref_rmem_i8_1, !cute.coord<"(?,?,0)">, i8) -> ()
        }
        ...
        %257 = cute.get_scalars(%coord_333) : !cute.coord<"?{div=8}">
        %258 = cute.get_scalars(%coord_334) : !cute.coord<"?{div=8}">
        %259 = arith.cmpi slt, %257, %258 : i32
        scf.if %259 {
          %260 = cute.get_scalars(%lay_175) <{only_dynamic}> : !cute.layout<"((8,1),16,1):((1,0),?{i64 div=64},0)">
          %iv_335 = cute.assume(%260) : (i64) -> !cute.i64<divby 64>
          ...
          %261 = cute.get_scalars(%append_339) <{only_dynamic}> : !cute.layout<"((8,1),16):((1,0),?{i64 div=64})">
          %iv_340 = cute.assume(%261) : (i64) -> !cute.i64<divby 64>
          ...
          %262 = cute.get_scalars(%append_343) <{only_dynamic}> : !cute.layout<"((8,1),(16)):((1,0),(?{i64 div=64}))">
          %iv_344 = cute.assume(%262) : (i64) -> !cute.i64<divby 64>
          ...
          scf.for %arg4 = %c0_i32 to %255 step %c1_i32  : i32 {
            ...
            %263 = builtin.unrealized_conversion_cast %ptr_353 : !cute.ptr<i8, rmem> to !llvm.ptr
            %264 = llvm.load %263 : !llvm.ptr -> i8
            %265 = llvm.icmp "ne" %264, %0 : i8
            scf.if %265 {
              %266 = builtin.unrealized_conversion_cast %ptr_349 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              %267 = builtin.unrealized_conversion_cast %ptr_351 : !cute.ptr<f16, gmem, align<16>> to !llvm.ptr<1>
              %268 = llvm.load %266 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %268, %267 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<1>
            }
          } {llvm.loop_annotation = #loop_annotation}
        }
      }
