...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb73:  // pred: ^bb39
      ...
      %318 = vector.shuffle %317, %317 [0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15] : vector<16xf32>, vector<16xf32>
      %319 = llvm.load %13 {alignment = 32 : i64} : !llvm.ptr -> vector<16xf32>
      %320 = vector.shuffle %319, %319 [0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15] : vector<16xf32>, vector<16xf32>
      %321 = llvm.fadd %318, %320 : vector<16xf32>
      %322 = vector.shuffle %321, %321 [0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15] : vector<16xf32>, vector<16xf32>
