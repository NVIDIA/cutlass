...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_elementwise_add_kernel_tensorptrf32gmemo161281div16128_tensorptrf32gmemo161281div16128_tensorptrf32gmemo161281div16128_tensor00o1612810111601281___0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f32_, %arg2: !memref_gmem_f32_, %arg3: !cute.coord_tensor<"(0,0)", "((16,128),(?,?)):((1@0,1@1),(16@0,128@1))">, %arg4: i32, %arg5: i32, %arg6: !cute.layout<"(4,32):(32,1)">, %arg7: !cute.layout<"(4,4):(4,1)">) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %0 = cute.get_shape(%lay) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.shape<"((16,128),(?,?))">
      %e0_9, %e1_10, %e2, %e3 = cute.get_leaves(%0) : !cute.shape<"((16,128),(?,?))">
      ...
      %3 = cute.get_stride(%lay) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %e0_12, %e1_13, %e2_14, %e3_15 = cute.get_leaves(%3) : !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %itup_16 = cute.to_int_tuple(%e0_12) : !cute.stride<"?{i64}"> to !cute.int_tuple<"?{i64}">
      %4 = cute.get_scalars(%itup_16) : !cute.int_tuple<"?{i64}">
      %itup_17 = cute.to_int_tuple(%e2_14) : !cute.stride<"?{i64 div=16}"> to !cute.int_tuple<"?{i64 div=16}">
      %5 = cute.get_scalars(%itup_17) : !cute.int_tuple<"?{i64 div=16}">
      %lay_18 = cute.get_layout(%arg1) : !memref_gmem_f32_
      %6 = cute.get_shape(%lay_18) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.shape<"((16,128),(?,?))">
      %e0_19, %e1_20, %e2_21, %e3_22 = cute.get_leaves(%6) : !cute.shape<"((16,128),(?,?))">
      ...
      %9 = cute.get_stride(%lay_18) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %e0_25, %e1_26, %e2_27, %e3_28 = cute.get_leaves(%9) : !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %itup_29 = cute.to_int_tuple(%e0_25) : !cute.stride<"?{i64}"> to !cute.int_tuple<"?{i64}">
      %10 = cute.get_scalars(%itup_29) : !cute.int_tuple<"?{i64}">
      %itup_30 = cute.to_int_tuple(%e2_27) : !cute.stride<"?{i64 div=16}"> to !cute.int_tuple<"?{i64 div=16}">
      %11 = cute.get_scalars(%itup_30) : !cute.int_tuple<"?{i64 div=16}">
      %lay_31 = cute.get_layout(%arg2) : !memref_gmem_f32_
      %12 = cute.get_shape(%lay_31) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.shape<"((16,128),(?,?))">
      %e0_32, %e1_33, %e2_34, %e3_35 = cute.get_leaves(%12) : !cute.shape<"((16,128),(?,?))">
      ...
      %15 = cute.get_stride(%lay_31) : (!cute.layout<"((16,128),(?,?)):((?{i64},1),(?{i64 div=16},128))">) -> !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %e0_38, %e1_39, %e2_40, %e3_41 = cute.get_leaves(%15) : !cute.stride<"((?{i64},1),(?{i64 div=16},128))">
      %itup_42 = cute.to_int_tuple(%e0_38) : !cute.stride<"?{i64}"> to !cute.int_tuple<"?{i64}">
      %16 = cute.get_scalars(%itup_42) : !cute.int_tuple<"?{i64}">
      %itup_43 = cute.to_int_tuple(%e2_40) : !cute.stride<"?{i64 div=16}"> to !cute.int_tuple<"?{i64 div=16}">
      %17 = cute.get_scalars(%itup_43) : !cute.int_tuple<"?{i64 div=16}">
      %lay_44 = cute.get_layout(%arg3) : !cute.coord_tensor<"(0,0)", "((16,128),(?,?)):((1@0,1@1),(16@0,128@1))">
      %18 = cute.get_shape(%lay_44) : (!cute.layout<"((16,128),(?,?)):((1@0,1@1),(16@0,128@1))">) -> !cute.shape<"((16,128),(?,?))">
      %e0_45, %e1_46, %e2_47, %e3_48 = cute.get_leaves(%18) : !cute.shape<"((16,128),(?,?))">
      %itup_49 = cute.to_int_tuple(%e2_47) : !cute.shape<"?"> to !cute.int_tuple<"?">
      %19 = cute.get_scalars(%itup_49) : !cute.int_tuple<"?">
      %itup_50 = cute.to_int_tuple(%e3_48) : !cute.shape<"?"> to !cute.int_tuple<"?">
      %20 = cute.get_scalars(%itup_50) : !cute.int_tuple<"?">
      %21 = cute.get_stride(%lay_44) : (!cute.layout<"((16,128),(?,?)):((1@0,1@1),(16@0,128@1))">) -> !cute.stride<"((1@0,1@1),(16@0,128@1))">
      %e0_51, %e1_52, %e2_53, %e3_54 = cute.get_leaves(%21) : !cute.stride<"((1@0,1@1),(16@0,128@1))">
      %22 = cute.get_shape(%arg6) : (!cute.layout<"(4,32):(32,1)">) -> !cute.shape<"(4,32)">
      %e0_55, %e1_56 = cute.get_leaves(%22) : !cute.shape<"(4,32)">
      %23 = cute.get_stride(%arg6) : (!cute.layout<"(4,32):(32,1)">) -> !cute.stride<"(32,1)">
      %e0_57, %e1_58 = cute.get_leaves(%23) : !cute.stride<"(32,1)">
      %24 = cute.get_shape(%arg7) : (!cute.layout<"(4,4):(4,1)">) -> !cute.shape<"(4,4)">
      %e0_59, %e1_60 = cute.get_leaves(%24) : !cute.shape<"(4,4)">
      %25 = cute.get_stride(%arg7) : (!cute.layout<"(4,4):(4,1)">) -> !cute.stride<"(4,1)">
      %e0_61, %e1_62 = cute.get_leaves(%25) : !cute.stride<"(4,1)">
      %26 = nvvm.read.ptx.sreg.tid.x : i32
      %27 = nvvm.read.ptx.sreg.tid.y : i32
      %28 = nvvm.read.ptx.sreg.tid.z : i32
      %29 = nvvm.read.ptx.sreg.ctaid.x : i32
      %30 = nvvm.read.ptx.sreg.ctaid.y : i32
      %31 = nvvm.read.ptx.sreg.ctaid.z : i32
      %coord = cute.make_coord(%29) : (i32) -> !cute.coord<"((_,_),?)">
      %slice = cute.slice(%arg0, %coord) : !memref_gmem_f32_, !cute.coord<"((_,_),?)">
      %iter_63 = cute.get_iter(%slice) : !memref_gmem_f32_1
      %coord_64 = cute.make_coord(%29) : (i32) -> !cute.coord<"((_,_),?)">
      %slice_65 = cute.slice(%arg1, %coord_64) : !memref_gmem_f32_, !cute.coord<"((_,_),?)">
      %iter_66 = cute.get_iter(%slice_65) : !memref_gmem_f32_1
      %coord_67 = cute.make_coord(%29) : (i32) -> !cute.coord<"((_,_),?)">
      %slice_68 = cute.slice(%arg2, %coord_67) : !memref_gmem_f32_, !cute.coord<"((_,_),?)">
      %iter_69 = cute.get_iter(%slice_68) : !memref_gmem_f32_1
      %coord_70 = cute.make_coord(%29) : (i32) -> !cute.coord<"((_,_),?)">
      ...
      %32 = cute.get_scalars(%e0_73) : !cute.int_tuple<"?{div=16}">
      %33 = cute.get_scalars(%e1_74) : !cute.int_tuple<"?{div=128}">
      ...
      %sz_77 = cute.size(%arg7) : (!cute.layout<"(4,4):(4,1)">) -> !cute.int_tuple<"16">
      ...
      %34 = cute.composition(%rinv, %lay_79) : (!cute.layout<"(32,16,4):(64,4,1)">, !cute.layout<"(128,16):(1,128)">) -> !cute.layout<"((32,4),(4,4)):((64,4),(16,1))">
      %35 = cute.get_shape(%prod) : (!cute.layout<"((4,4),(4,32)):((512,32),(128,1))">) -> !cute.shape<"((4,4),(4,32))">
      %e0_80, %e1_81, %e2_82, %e3_83 = cute.get_leaves(%35) : !cute.shape<"((4,4),(4,32))">
      ...
      %36 = cute.make_tiled_copy(%atom) : !copy_simt
      %prod_90 = cute.raked_product(%arg6, %arg7) : (!cute.layout<"(4,32):(32,1)">, !cute.layout<"(4,4):(4,1)">) -> !cute.layout<"((4,4),(4,32)):((512,32),(128,1))">
      %sz_91 = cute.size(%arg6) : (!cute.layout<"(4,32):(32,1)">) -> !cute.int_tuple<"128">
      %e0_92 = cute.get_leaves(%sz_91) : !cute.int_tuple<"128">
      %sz_93 = cute.size(%arg7) : (!cute.layout<"(4,4):(4,1)">) -> !cute.int_tuple<"16">
      ...
      %37 = cute.composition(%rinv_97, %lay_96) : (!cute.layout<"(32,16,4):(64,4,1)">, !cute.layout<"(128,16):(1,128)">) -> !cute.layout<"((32,4),(4,4)):((64,4),(16,1))">
      %38 = cute.get_shape(%prod_90) : (!cute.layout<"((4,4),(4,32)):((512,32),(128,1))">) -> !cute.shape<"((4,4),(4,32))">
      %e0_98, %e1_99, %e2_100, %e3_101 = cute.get_leaves(%38) : !cute.shape<"((4,4),(4,32))">
      ...
      %prod_111 = cute.raked_product(%arg6, %arg7) : (!cute.layout<"(4,32):(32,1)">, !cute.layout<"(4,4):(4,1)">) -> !cute.layout<"((4,4),(4,32)):((512,32),(128,1))">
      %sz_112 = cute.size(%arg6) : (!cute.layout<"(4,32):(32,1)">) -> !cute.int_tuple<"128">
      %e0_113 = cute.get_leaves(%sz_112) : !cute.int_tuple<"128">
      %sz_114 = cute.size(%arg7) : (!cute.layout<"(4,4):(4,1)">) -> !cute.int_tuple<"16">
      ...
      %40 = cute.composition(%rinv_118, %lay_117) : (!cute.layout<"(32,16,4):(64,4,1)">, !cute.layout<"(128,16):(1,128)">) -> !cute.layout<"((32,4),(4,4)):((64,4),(16,1))">
      %41 = cute.get_shape(%prod_111) : (!cute.layout<"((4,4),(4,32)):((512,32),(128,1))">) -> !cute.shape<"((4,4),(4,32))">
      %e0_119, %e1_120, %e2_121, %e3_122 = cute.get_leaves(%41) : !cute.shape<"((4,4),(4,32))">
      ...
      %42 = cute.make_tiled_copy(%atom_75) : !copy_simt
      %coord_132 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %src_partitioned = cute.tiled.copy.partition_S(%36, %slice, %coord_132) : (!copy_simt, !memref_gmem_f32_1, !cute.coord<"?">) -> !memref_gmem_f32_2
      %iter_133 = cute.get_iter(%src_partitioned) : !memref_gmem_f32_2
      %coord_134 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %src_partitioned_135 = cute.tiled.copy.partition_S(%39, %slice_65, %coord_134) : (!copy_simt, !memref_gmem_f32_1, !cute.coord<"?">) -> !memref_gmem_f32_2
      %iter_136 = cute.get_iter(%src_partitioned_135) : !memref_gmem_f32_2
      %coord_137 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %src_partitioned_138 = cute.tiled.copy.partition_S(%42, %slice_68, %coord_137) : (!copy_simt, !memref_gmem_f32_1, !cute.coord<"?">) -> !memref_gmem_f32_2
      %iter_139 = cute.get_iter(%src_partitioned_138) : !memref_gmem_f32_2
      %lay_140 = cute.get_layout(%src_partitioned) : !memref_gmem_f32_2
      %43 = cute.make_layout_like(%lay_140) : !cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)"> to !cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">
      %rmem = cute.memref.alloca(%43) : !memref_rmem_f32_
      ...
      %44 = cute.make_layout_like(%lay_143) : !cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)"> to !cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">
      %rmem_144 = cute.memref.alloca(%44) : !memref_rmem_f32_
      ...
      %45 = cute.make_layout_like(%lay_147) : !cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)"> to !cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">
      %rmem_148 = cute.memref.alloca(%45) : !memref_rmem_f32_
      %iter_149 = cute.get_iter(%rmem_148) : !memref_rmem_f32_
      %iter_150 = cute.get_iter(%rmem_148) : !memref_rmem_f32_
      %coord_151 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %src_partitioned_152 = cute.tiled.copy.partition_S(%42, %slice_71, %coord_151) : (!copy_simt, !cute.coord_tensor<"(?{div=16},?{div=128})", "(16,128):(1@0,1@1)">, !cute.coord<"?">) -> !cute.coord_tensor<"(?{div=4},?{div=4})", "((1,(4,4)),1,1):((0,(1@1,1@0)),0,0)">
      ...
      %46 = cute.get_scalars(%e0_154) : !cute.int_tuple<"?{div=4}">
      %47 = cute.get_scalars(%e1_155) : !cute.int_tuple<"?{div=4}">
      %lay_156 = cute.get_layout(%src_partitioned_152) : !cute.coord_tensor<"(?{div=4},?{div=4})", "((1,(4,4)),1,1):((0,(1@1,1@0)),0,0)">
      %48 = cute.get_shape(%lay_156) : (!cute.layout<"((1,(4,4)),1,1):((0,(1@1,1@0)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_157, %e1_158, %e2_159, %e3_160, %e4 = cute.get_leaves(%48) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %49 = cute.get_shape(%lay_168) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_169, %e1_170, %e2_171, %e3_172, %e4_173 = cute.get_leaves(%49) : !cute.shape<"((1,(4,4)),1,1)">
      %50 = cute.get_stride(%lay_168) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.stride<"((0,(1,4)),0,0)">
      %e0_174, %e1_175, %e2_176, %e3_177, %e4_178 = cute.get_leaves(%50) : !cute.stride<"((0,(1,4)),0,0)">
      %c0_i32 = arith.constant 0 : i32
      %c16_i32 = arith.constant 16 : i32
      %c1_i32 = arith.constant 1 : i32
      %51 = scf.for %arg8 = %c0_i32 to %c16_i32 step %c1_i32 iter_args(%arg9 = %rmem_163) -> (!memref_rmem_i8_)  : i32 {
        %iter_415 = cute.get_iter(%arg9) : !memref_rmem_i8_
        %lay_416 = cute.get_layout(%arg9) : !memref_rmem_i8_
        %78 = cute.get_shape(%lay_416) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
        %e0_417, %e1_418, %e2_419, %e3_420, %e4_421 = cute.get_leaves(%78) : !cute.shape<"((1,(4,4)),1,1)">
        %79 = cute.get_stride(%lay_416) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.stride<"((0,(1,4)),0,0)">
        %e0_422, %e1_423, %e2_424, %e3_425, %e4_426 = cute.get_leaves(%79) : !cute.stride<"((0,(1,4)),0,0)">
        %iter_427 = cute.get_iter(%arg9) : !memref_rmem_i8_
        %coord_428 = cute.make_coord(%arg8) : (i32) -> !cute.coord<"?">
        ...
        %80 = cute.get_scalars(%e0_431) : !cute.int_tuple<"?">
        %81 = cute.get_scalars(%e1_432) : !cute.int_tuple<"?">
        %iter_433 = cute.get_iter(%slice_429) : !cute.coord_tensor<"(?,?)", "():()">
        %e0_434, %e1_435 = cute.get_leaves(%iter_433) : !cute.int_tuple<"(?,?)">
        %82 = cute.get_scalars(%e0_434) : !cute.int_tuple<"?">
        %83 = cute.get_scalars(%e1_435) : !cute.int_tuple<"?">
        ...
        %86 = cute.elem_less(%coord_439, %coord_440) : !cute.coord<"(?,?)">, !cute.coord<"(?,?)">
        %87 = arith.extui %86 : i1 to i8
        %coord_441 = cute.make_coord(%arg8) : (i32) -> !cute.coord<"?">
        cute.memref.store(%arg9, %coord_441, %87) : (!memref_rmem_i8_, !cute.coord<"?">, i8) -> ()
        %lay_442 = cute.get_layout(%arg9) : !memref_rmem_i8_
        %88 = cute.get_shape(%lay_442) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
        %e0_443, %e1_444, %e2_445, %e3_446, %e4_447 = cute.get_leaves(%88) : !cute.shape<"((1,(4,4)),1,1)">
        %89 = cute.get_stride(%lay_442) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.stride<"((0,(1,4)),0,0)">
        %e0_448, %e1_449, %e2_450, %e3_451, %e4_452 = cute.get_leaves(%89) : !cute.stride<"((0,(1,4)),0,0)">
        scf.yield %arg9 : !memref_rmem_i8_
      }
      %iter_179 = cute.get_iter(%51) : !memref_rmem_i8_
      %lay_180 = cute.get_layout(%51) : !memref_rmem_i8_
      %52 = cute.get_shape(%lay_180) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_181, %e1_182, %e2_183, %e3_184, %e4_185 = cute.get_leaves(%52) : !cute.shape<"((1,(4,4)),1,1)">
      %53 = cute.get_stride(%lay_180) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.stride<"((0,(1,4)),0,0)">
      %e0_186, %e1_187, %e2_188, %e3_189, %e4_190 = cute.get_leaves(%53) : !cute.stride<"((0,(1,4)),0,0)">
      %iter_191 = cute.get_iter(%51) : !memref_rmem_i8_
      %iter_192 = cute.get_iter(%51) : !memref_rmem_i8_
      %lay_193 = cute.get_layout(%src_partitioned) : !memref_gmem_f32_2
      %54 = cute.get_shape(%lay_193) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_194, %e1_195, %e2_196, %e3_197, %e4_198 = cute.get_leaves(%54) : !cute.shape<"((1,(4,4)),1,1)">
      %lay_199 = cute.get_layout(%rmem) : !memref_rmem_f32_
      %55 = cute.get_shape(%lay_199) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_200, %e1_201, %e2_202, %e3_203, %e4_204 = cute.get_leaves(%55) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %56 = cute.get_shape(%lay_209) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_210, %e1_211, %e2_212, %e3_213, %e4_214 = cute.get_leaves(%56) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %57 = cute.get_shape(%lay_223) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_224, %e1_225, %e2_226, %e3_227, %e4_228 = cute.get_leaves(%57) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %lay_232 = cute.get_layout(%51) : !memref_rmem_i8_
      ...
      %58 = cute.get_shape(%lay_238) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_239, %e1_240, %e2_241, %e3_242, %e4_243 = cute.get_leaves(%58) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %59 = cute.get_shape(%lay_247) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,?{i64})),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_248, %e1_249, %e2_250, %e3_251, %e4_252 = cute.get_leaves(%59) : !cute.shape<"((1,(4,4)),(1,1))">
      %lay_253 = cute.get_layout(%grouped_229) : !memref_rmem_f32_1
      %60 = cute.get_shape(%lay_253) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,4)),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_254, %e1_255, %e2_256, %e3_257, %e4_258 = cute.get_leaves(%60) : !cute.shape<"((1,(4,4)),(1,1))">
      ...
      %61 = cute.get_shape(%lay_263) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_264, %e1_265, %e2_266, %e3_267, %e4_268 = cute.get_leaves(%61) : !cute.shape<"((1,(4,4)),1,1)">
      %lay_269 = cute.get_layout(%rmem_144) : !memref_rmem_f32_
      %62 = cute.get_shape(%lay_269) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_270, %e1_271, %e2_272, %e3_273, %e4_274 = cute.get_leaves(%62) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %63 = cute.get_shape(%lay_281) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_282, %e1_283, %e2_284, %e3_285, %e4_286 = cute.get_leaves(%63) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %64 = cute.get_shape(%lay_296) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_297, %e1_298, %e2_299, %e3_300, %e4_301 = cute.get_leaves(%64) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %lay_305 = cute.get_layout(%51) : !memref_rmem_i8_
      ...
      %65 = cute.get_shape(%lay_311) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_312, %e1_313, %e2_314, %e3_315, %e4_316 = cute.get_leaves(%65) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %66 = cute.get_shape(%lay_320) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,?{i64})),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_321, %e1_322, %e2_323, %e3_324, %e4_325 = cute.get_leaves(%66) : !cute.shape<"((1,(4,4)),(1,1))">
      %lay_326 = cute.get_layout(%grouped_302) : !memref_rmem_f32_1
      %67 = cute.get_shape(%lay_326) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,4)),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_327, %e1_328, %e2_329, %e3_330, %e4_331 = cute.get_leaves(%67) : !cute.shape<"((1,(4,4)),(1,1))">
      ...
      %68 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
      %69 = cute.memref.load_vec %rmem_144, row_major : !memref_rmem_f32_
      %70 = arith.addf %68, %69 : vector<16xf32>
      %lay_336 = cute.get_layout(%rmem_148) : !memref_rmem_f32_
      %71 = cute.get_shape(%lay_336) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_337, %e1_338, %e2_339, %e3_340, %e4_341 = cute.get_leaves(%71) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      cute.memref.store_vec %70, %rmem_148, row_major : !memref_rmem_f32_
      %lay_348 = cute.get_layout(%src_partitioned_138) : !memref_gmem_f32_2
      %72 = cute.get_shape(%lay_348) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_349, %e1_350, %e2_351, %e3_352, %e4_353 = cute.get_leaves(%72) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %73 = cute.get_shape(%lay_360) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_361, %e1_362, %e2_363, %e3_364, %e4_365 = cute.get_leaves(%73) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %74 = cute.get_shape(%lay_375) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,?{i64})),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_376, %e1_377, %e2_378, %e3_379, %e4_380 = cute.get_leaves(%74) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %lay_384 = cute.get_layout(%51) : !memref_rmem_i8_
      ...
      %75 = cute.get_shape(%lay_390) : (!cute.layout<"((1,(4,4)),1,1):((0,(1,4)),0,0)">) -> !cute.shape<"((1,(4,4)),1,1)">
      %e0_391, %e1_392, %e2_393, %e3_394, %e4_395 = cute.get_leaves(%75) : !cute.shape<"((1,(4,4)),1,1)">
      ...
      %76 = cute.get_shape(%lay_399) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,4)),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_400, %e1_401, %e2_402, %e3_403, %e4_404 = cute.get_leaves(%76) : !cute.shape<"((1,(4,4)),(1,1))">
      %lay_405 = cute.get_layout(%grouped_381) : !memref_gmem_f32_3
      %77 = cute.get_shape(%lay_405) : (!cute.layout<"((1,(4,4)),(1,1)):((0,(1,?{i64})),(0,0))">) -> !cute.shape<"((1,(4,4)),(1,1))">
      %e0_406, %e1_407, %e2_408, %e3_409, %e4_410 = cute.get_leaves(%77) : !cute.shape<"((1,(4,4)),(1,1))">
  ...
  func.func @cutlass_elementwise_add_tensor_00795_21652_04639_03193_15897_02304_02971_12990_02319_03973_00495_05866_09467_06015_06234_07404_19793_05333_01425_01997_05745_11222_16922_13492_04451(%arg0: !memref_gmem_f32_4, %arg1: !memref_gmem_f32_4, %arg2: !memref_gmem_f32_4) attributes {llvm.emit_c_interface} {
