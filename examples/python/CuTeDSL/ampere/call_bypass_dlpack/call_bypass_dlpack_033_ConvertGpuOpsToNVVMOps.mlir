gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb73(%745: i32):  // 2 preds: ^bb72, ^bb74
    ...
    llvm.cond_br %746, ^bb74, ^bb75 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb76(%770: i32):  // 2 preds: ^bb75, ^bb77
    ...
    llvm.cond_br %771, ^bb77, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb77:  // pred: ^bb76
  ...
  ^bb83(%791: i32):  // 2 preds: ^bb82, ^bb86
    ...
    llvm.cond_br %792, ^bb84, ^bb87 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb84:  // pred: ^bb83
