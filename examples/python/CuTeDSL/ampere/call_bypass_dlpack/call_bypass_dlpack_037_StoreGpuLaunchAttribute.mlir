...
module attributes {gpu.container_module} {
  gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_90a">] {
    ...
    ^bb73(%747: i32):  // 2 preds: ^bb72, ^bb74
      ...
      llvm.cond_br %748, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb76(%772: i32):  // 2 preds: ^bb75, ^bb77
      ...
      llvm.cond_br %773, ^bb77, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb77:  // pred: ^bb76
    ...
    ^bb83(%793: i32):  // 2 preds: ^bb82, ^bb86
      ...
      llvm.cond_br %794, ^bb84, ^bb87 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
  ...
  llvm.func @cutlass_tensor_op_gemm_wrapper_Ptrgmem_Ptrgmem_Ptrgmem_512_256_128_16(%arg0: !llvm.ptr<1> {llvm.align = 32 : i64}, %arg1: !llvm.ptr<1> {llvm.align = 32 : i64}, %arg2: !llvm.ptr<1> {llvm.align = 32 : i64}, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32) attributes {llvm.emit_c_interface} {
    ...
    %17 = llvm.mul %arg3, %arg5 : i32
    %18 = llvm.insertvalue %arg3, %7[0] : !llvm.struct<(i32, i32, i32)> 
    %19 = llvm.insertvalue %arg5, %18[1] : !llvm.struct<(i32, i32, i32)> 
    %20 = llvm.insertvalue %arg6, %19[2] : !llvm.struct<(i32, i32, i32)> 
    %21 = llvm.insertvalue %arg3, %6[0] : !llvm.struct<(i32, i32)> 
    %22 = llvm.insertvalue %17, %21[1] : !llvm.struct<(i32, i32)> 
    %23 = llvm.insertvalue %20, %5[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %24 = llvm.insertvalue %22, %23[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %25 = llvm.mul %arg4, %arg5 : i32
    %26 = llvm.insertvalue %arg4, %7[0] : !llvm.struct<(i32, i32, i32)> 
    %27 = llvm.insertvalue %arg5, %26[1] : !llvm.struct<(i32, i32, i32)> 
    %28 = llvm.insertvalue %arg6, %27[2] : !llvm.struct<(i32, i32, i32)> 
    %29 = llvm.insertvalue %arg4, %6[0] : !llvm.struct<(i32, i32)> 
    %30 = llvm.insertvalue %25, %29[1] : !llvm.struct<(i32, i32)> 
    %31 = llvm.insertvalue %28, %5[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %32 = llvm.insertvalue %30, %31[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %33 = llvm.mul %arg3, %arg4 : i32
    %34 = llvm.insertvalue %arg4, %18[1] : !llvm.struct<(i32, i32, i32)> 
    %35 = llvm.insertvalue %arg6, %34[2] : !llvm.struct<(i32, i32, i32)> 
    %36 = llvm.insertvalue %33, %29[1] : !llvm.struct<(i32, i32)> 
    %37 = llvm.insertvalue %35, %5[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %38 = llvm.insertvalue %36, %37[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)> 
    %39 = llvm.insertvalue %arg0, %4[0] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %40 = llvm.insertvalue %24, %39[1] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %41 = llvm.insertvalue %arg1, %4[0] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %42 = llvm.insertvalue %32, %41[1] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %43 = llvm.insertvalue %arg2, %4[0] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %44 = llvm.insertvalue %38, %43[1] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)> 
    %45 = llvm.select %1, %2, %10 : i1, i32
    %46 = llvm.add %45, %arg3 : i32
    %47 = llvm.sdiv %46, %8 : i32
    %48 = llvm.add %47, %10 : i32
    %49 = llvm.sub %3, %arg3 : i32
    %50 = llvm.sdiv %49, %8 : i32
    %51 = llvm.sub %3, %50 : i32
    %52 = llvm.icmp "slt" %arg3, %3 : i32
    %53 = llvm.icmp "sgt" %arg3, %3 : i32
    %54 = llvm.and %52, %0 : i1
    %55 = llvm.and %53, %1 : i1
    %56 = llvm.or %54, %55 : i1
    %57 = llvm.select %56, %48, %51 : i1, i32
    %58 = llvm.add %45, %arg4 : i32
    %59 = llvm.sdiv %58, %8 : i32
    %60 = llvm.add %59, %10 : i32
    %61 = llvm.sub %3, %arg4 : i32
    %62 = llvm.sdiv %61, %8 : i32
    %63 = llvm.sub %3, %62 : i32
    %64 = llvm.icmp "slt" %arg4, %3 : i32
    %65 = llvm.icmp "sgt" %arg4, %3 : i32
    %66 = llvm.and %64, %0 : i1
    %67 = llvm.and %65, %1 : i1
    %68 = llvm.or %66, %67 : i1
    %69 = llvm.select %68, %60, %63 : i1, i32
    %70 = llvm.icmp "sgt" %69, %9 : i32
    llvm.cond_br %70, ^bb1(%11 : i32), ^bb2
  ^bb1(%71: i32):  // 2 preds: ^bb0, ^bb5
    llvm.br ^bb6
  ^bb2:  // pred: ^bb0
    %72 = llvm.icmp "sgt" %69, %12 : i32
    llvm.cond_br %72, ^bb3, ^bb4
  ^bb3:  // pred: ^bb2
    llvm.br ^bb5(%13 : i32)
  ^bb4:  // pred: ^bb2
    %73 = llvm.icmp "sgt" %69, %10 : i32
    %74 = llvm.select %73, %12, %10 : i1, i32
    llvm.br ^bb5(%74 : i32)
  ...
  ^bb6:  // pred: ^bb1
    llvm.br ^bb7
  ^bb7:  // pred: ^bb6
    %76 = llvm.mul %57, %71 : i32
    %77 = llvm.add %69, %71 : i32
    %78 = llvm.sub %77, %10 : i32
    %79 = llvm.sdiv %78, %71 : i32
    %80 = llvm.sext %76 : i32 to i64
    %81 = llvm.sext %79 : i32 to i64
    %82 = llvm.sext %arg6 : i32 to i64
    gpu.launch_func  @kernels::@kernel_cutlass_kernel_tensorop_gemmTensorOpGemm_object_at__tensorptrf16gmemalign32odiv81div8div8_tensorptrf16gmemalign32odiv81div8div8_tensorptrf16gmemalign32odiv8div8div81div64_S333o0o64_0 blocks in (%80, %81, %82) threads in (%14, %16, %16) : i64 dynamic_shared_memory_size %15 args(%40 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)>, %42 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)>, %44 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)>, %71 : i32) {use_pdl = false}
    llvm.return
  }
