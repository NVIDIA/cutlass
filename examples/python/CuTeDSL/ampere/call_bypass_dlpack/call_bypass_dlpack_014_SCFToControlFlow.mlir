...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb26:  // pred: ^bb24
      ...
      cute.memref.store_vec %cst, %rmem_293 : !memref_rmem_f32_
    ...
    ^bb73:  // pred: ^bb33
      ...
      %409 = cute.memref.load_vec %rmem_293 : !memref_rmem_f32_
      ...
      cute.memref.store_vec %410, %view_455 : !memref_rmem_f16_2
  ...
  ^bb8:  // pred: ^bb7
    ...
    %25 = cuda.launch_cfg.create<max_attrs = 2 : i32> (blockDim = (%c128_i32, %c1_i32, %c1_i32), dynamicSmemBytes = %c49152_i64, gridDim = (%21, %22, %23), stream = %24) : i32, i32, i32, i64, i32, i32, i32, !cuda.stream -> !cuda.launch_cfg<max_attrs = 2>
    %26 = cuda.launch_ex @kernels::@kernel_cutlass_kernel_tensorop_gemmTensorOpGemm_object_at__tensorptrf16gmemalign32odiv81div8div8_tensorptrf16gmemalign32odiv81div8div8_tensorptrf16gmemalign32odiv8div8div81div64_S333o0o64_0<%25> (%view, %view_18, %view_19, %20) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f16_, !memref_gmem_f16_, !memref_gmem_f16_1, i32) -> !cuda.result
    %27 = cuda.cast %26 : !cuda.result -> i32
