gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb6(%355: i32):  // 2 preds: ^bb5, ^bb7
    ...
    llvm.cond_br %356, ^bb7, ^bb8 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb7:  // pred: ^bb6
  ...
  ^bb14(%373: i32):  // 2 preds: ^bb13, ^bb15
    ...
    llvm.cond_br %374, ^bb15, ^bb16 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb15:  // pred: ^bb14
  ...
  ^bb21(%385: i32):  // 2 preds: ^bb20, ^bb22
    ...
    llvm.cond_br %386, ^bb22, ^bb23 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb22:  // pred: ^bb21
  ...
  ^bb24(%398: i32):  // 2 preds: ^bb23, ^bb25
    ...
    llvm.cond_br %399, ^bb25, ^bb26 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb25:  // pred: ^bb24
  ...
  ^bb27(%481: i32):  // 2 preds: ^bb26, ^bb28
    ...
    llvm.cond_br %482, ^bb28, ^bb29 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb28:  // pred: ^bb27
  ...
  ^bb30(%513: i32):  // 2 preds: ^bb29, ^bb31
    ...
    llvm.cond_br %514, ^bb31, ^bb32 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb31:  // pred: ^bb30
  ...
  ^bb35:  // pred: ^bb34
    ...
    llvm.cond_br %560, ^bb36, ^bb71 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb36:  // pred: ^bb35
  ...
  ^bb41(%580: i32):  // 2 preds: ^bb40, ^bb42
    ...
    llvm.cond_br %581, ^bb42, ^bb43 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb42:  // pred: ^bb41
  ...
  ^bb44(%618: i32):  // 2 preds: ^bb43, ^bb45
    ...
    llvm.cond_br %619, ^bb45, ^bb46 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb45:  // pred: ^bb44
  ...
  ^bb49(%659: i32):  // 2 preds: ^bb48, ^bb50
    ...
    llvm.cond_br %660, ^bb50, ^bb51 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb50:  // pred: ^bb49
  ...
  ^bb54(%674: i32):  // 2 preds: ^bb53, ^bb61
    ...
    llvm.cond_br %675, ^bb55, ^bb62 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb55:  // pred: ^bb54
    llvm.br ^bb56(%23 : i32)
  ^bb56(%676: i32):  // 2 preds: ^bb55, ^bb60
    %677 = llvm.icmp "slt" %676, %17 : i32
    llvm.cond_br %677, ^bb57, ^bb61 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb57:  // pred: ^bb56
  ...
  ^bb58(%687: i32):  // 2 preds: ^bb57, ^bb59
    ...
    llvm.cond_br %688, ^bb59, ^bb60 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb59:  // pred: ^bb58
  ...
  ^bb65(%732: i32):  // 2 preds: ^bb64, ^bb66
    ...
    llvm.cond_br %733, ^bb66, ^bb67 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb66:  // pred: ^bb65
  ...
  ^bb73(%764: i32):  // 2 preds: ^bb72, ^bb74
    ...
    llvm.cond_br %765, ^bb74, ^bb75 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb76(%789: i32):  // 2 preds: ^bb75, ^bb77
    ...
    llvm.cond_br %790, ^bb77, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb77:  // pred: ^bb76
  ...
  ^bb83(%810: i32):  // 2 preds: ^bb82, ^bb86
    ...
    llvm.cond_br %811, ^bb84, ^bb87 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb84:  // pred: ^bb83
