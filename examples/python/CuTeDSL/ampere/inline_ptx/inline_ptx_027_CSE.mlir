"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg8: !llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>, %arg9: !llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>, %arg10: !llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>, %arg11: !llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>):
      ...
      %71 = "llvm.mlir.constant"() <{value = 10 : i32}> : () -> i32
      %72 = "nvvm.read.ptx.sreg.tid.x"() <{range = #llvm.constant_range<i32, 0, 1024>}> : () -> i32
      %73 = "llvm.icmp"(%72, %71) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %74 = "nvvm.vote.ballot.sync"(%70, %73) : (i32, i1) -> i32
      %75 = "llvm.inline_asm"(%73, %70) <{asm_dialect = 0 : i64, asm_string = "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.any.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", constraints = "=r,r,i", has_side_effects}> : (i1, i32) -> i1
      %76 = "llvm.inline_asm"(%73, %70) <{asm_dialect = 0 : i64, asm_string = "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.all.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", constraints = "=r,r,i", has_side_effects}> : (i1, i32) -> i1
      %77 = "llvm.inline_asm"(%73, %70) <{asm_dialect = 0 : i64, asm_string = "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.uni.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", constraints = "=r,r,i", has_side_effects}> : (i1, i32) -> i1
      %78 = "llvm.extractvalue"(%arg8) <{position = array<i64: 0>}> : (!llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>) -> !llvm.ptr<1>
      %79 = "llvm.getelementptr"(%78, %72) <{elem_type = i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %80 = "llvm.ptrtoint"(%79) : (!llvm.ptr<1>) -> i64
      %81 = "llvm.inttoptr"(%80) : (i64) -> !llvm.ptr<1>
      "llvm.store"(%74, %81) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr<1>) -> ()
      %82 = "llvm.zext"(%75) : (i1) -> i8
      %83 = "llvm.extractvalue"(%arg9) <{position = array<i64: 0>}> : (!llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>) -> !llvm.ptr<1>
      %84 = "llvm.getelementptr"(%83, %72) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %85 = "llvm.ptrtoint"(%84) : (!llvm.ptr<1>) -> i64
      %86 = "llvm.inttoptr"(%85) : (i64) -> !llvm.ptr<1>
      "llvm.store"(%82, %86) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr<1>) -> ()
      %87 = "llvm.zext"(%76) : (i1) -> i8
      %88 = "llvm.extractvalue"(%arg10) <{position = array<i64: 0>}> : (!llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>) -> !llvm.ptr<1>
      %89 = "llvm.getelementptr"(%88, %72) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %90 = "llvm.ptrtoint"(%89) : (!llvm.ptr<1>) -> i64
      %91 = "llvm.inttoptr"(%90) : (i64) -> !llvm.ptr<1>
      "llvm.store"(%87, %91) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr<1>) -> ()
      %92 = "llvm.zext"(%77) : (i1) -> i8
      %93 = "llvm.extractvalue"(%arg11) <{position = array<i64: 0>}> : (!llvm.struct<(ptr<1>, struct<(i32, struct<()>)>)>) -> !llvm.ptr<1>
      %94 = "llvm.getelementptr"(%93, %72) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %95 = "llvm.ptrtoint"(%94) : (!llvm.ptr<1>) -> i64
      %96 = "llvm.inttoptr"(%95) : (i64) -> !llvm.ptr<1>
      "llvm.store"(%92, %96) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr<1>) -> ()
      "llvm.return"() : () -> ()
  ...
  ^bb10:  // pred: ^bb12
    ...
    "llvm.unreachable"() : () -> ()
  ^bb11:  // pred: ^bb12
    %58 = "llvm.add"(%48, %6) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
  ...
  ^bb14:  // pred: ^bb15
    ...
    %64 = "llvm.add"(%65, %6) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
