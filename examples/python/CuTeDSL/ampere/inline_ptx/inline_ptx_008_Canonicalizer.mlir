...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_vote_kernel_tensorptri32gmemo1_tensorptri8gmemo1_tensorptri8gmemo1_tensorptri8gmemo1_False_0(%arg0: !memref_gmem_i32_, %arg1: !memref_gmem_i8_, %arg2: !memref_gmem_i8_, %arg3: !memref_gmem_i8_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 32, 1, 1>} {
      ...
      %4 = llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.any.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", "=r,r,i" %3, %c-1_i32 : (i1, i32) -> i1
      %5 = arith.cmpi slt, %0, %c10_i32 : i32
      %6 = llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.all.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", "=r,r,i" %5, %c-1_i32 : (i1, i32) -> i1
      %7 = arith.cmpi slt, %0, %c10_i32 : i32
      %8 = llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09\0A            .reg .pred ps;\0A\09\0A            .reg .pred pd;\0A\09\0A            setp.ne.b32 ps, $1, 0;\0A\09\0A            vote.sync.uni.pred pd, ps, $2;\0A\09\0A            selp.b32 $0, 1, 0, pd;\0A\09\0A            }", "=r,r,i" %7, %c-1_i32 : (i1, i32) -> i1
      ...
      %coord_0 = cute.make_coord(%0) : (i32) -> !cute.coord<"?">
      cute.memref.store(%arg1, %coord_0, %9) : (!memref_gmem_i8_, !cute.coord<"?">, i8) -> ()
      %10 = arith.extui %6 : i1 to i8
      %coord_1 = cute.make_coord(%0) : (i32) -> !cute.coord<"?">
      cute.memref.store(%arg2, %coord_1, %10) : (!memref_gmem_i8_, !cute.coord<"?">, i8) -> ()
      %11 = arith.extui %8 : i1 to i8
      %coord_2 = cute.make_coord(%0) : (i32) -> !cute.coord<"?">
      cute.memref.store(%arg3, %coord_2, %11) : (!memref_gmem_i8_, !cute.coord<"?">, i8) -> ()
      return
    }
  }
