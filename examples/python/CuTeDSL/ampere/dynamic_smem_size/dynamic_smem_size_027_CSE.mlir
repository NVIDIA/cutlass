"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    "llvm.func"() <{CConv = #llvm.cconv<ccc>, function_type = !llvm.func<void ()>, linkage = #llvm.linkage<external>, sym_name = "kernel_cutlass_kernel_no_smem_0", visibility_ = 0 : i64}> ({
      ...
      %71 = "llvm.icmp"(%70, %69) <{predicate = 0 : i64}> : (i32, i32) -> i1
  ...
  ^bb16:  // pred: ^bb9
    %67 = "cuda.launch_ex"(%23) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass_kernel_no_smem_0}> : (!cuda.launch_cfg<max_attrs = 3>) -> !cuda.result
    %68 = "builtin.unrealized_conversion_cast"(%67) : (!cuda.result) -> i32
