module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass_launch_kernel2() -> i32 attributes {llvm.emit_c_interface} {
    ...
    %5 = llvm.alloca %4 x !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)> : (i32) -> !llvm.ptr
    %6 = llvm.alloca %4 x !llvm.array<2 x struct<(i32, array<4 x i8>, array<64 x i8>)>> : (i32) -> !llvm.ptr
    ...
    llvm.store %16, %15 : i32, !llvm.ptr
    %17 = llvm.getelementptr %5[0, 3] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %3, %17 : !llvm.ptr, !llvm.ptr
    %18 = llvm.alloca %4 x !llvm.array<1 x ptr> : (i32) -> !llvm.ptr
    %19 = builtin.unrealized_conversion_cast %18 : !llvm.ptr to !cuda.launch_cfg<max_attrs = 2>
    %20 = llvm.getelementptr %18[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1 x ptr>
    llvm.store %5, %20 : !llvm.ptr, !llvm.ptr
    %21 = cuda.launch_ex @kernels::@kernel_cutlass_kernel_no_smem_0<%19> () : !cuda.launch_cfg<max_attrs = 2>, () -> !cuda.result
    %22 = builtin.unrealized_conversion_cast %21 : !cuda.result to i32
