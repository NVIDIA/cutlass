"builtin.module"() ({
  ...
  ^bb0(%arg3: !llvm.ptr):
    ...
    %149 = "llvm.mlir.addressof"() <{global_name = @kernels_binary}> : () -> !llvm.ptr
    %150 = "llvm.mlir.zero"() : () -> i32
    %151 = "llvm.getelementptr"(%arg3) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
    %152 = "llvm.call"(%151, %149, %148, %148, %150, %148, %148, %150) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaLibraryLoadData, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 8, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, i32) -> i32
    %153 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %154 = "llvm.icmp"(%152, %153) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%154, %152)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    %155 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    "llvm.br"(%155)[^bb2] : (i32) -> ()
  ^bb2(%156: i32):  // 2 preds: ^bb0, ^bb1
    "llvm.return"(%156) : (i32) -> ()
  }) : () -> ()
  ...
  ^bb0(%arg2: !llvm.ptr):
    %107 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %108 = "llvm.alloca"(%107) <{elem_type = i32}> : (i32) -> !llvm.ptr
    %109 = "llvm.call"(%108) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaGetDevice, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
    %110 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %111 = "llvm.icmp"(%109, %110) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%111, %109)[^bb1, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    %112 = "llvm.load"(%108) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %113 = "llvm.alloca"(%107) <{elem_type = i32}> : (i32) -> !llvm.ptr
    %114 = "llvm.mlir.constant"() <{value = 97 : i32}> : () -> i32
    %115 = "llvm.call"(%113, %114, %112) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaDeviceGetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i32) -> i32
    %116 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %117 = "llvm.icmp"(%115, %116) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%117, %115)[^bb2, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    %118 = "llvm.load"(%113) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %119 = "llvm.mlir.addressof"() <{global_name = @kernels_kernel_cutlass_kernel_no_smem_0}> : () -> !llvm.ptr
    %120 = "llvm.mlir.constant"() <{value = "kernel_cutlass_kernel_no_smem_0\00"}> : () -> !llvm.array<32 x i8>
    %121 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %122 = "llvm.alloca"(%121) <{elem_type = !llvm.array<32 x i8>}> : (i32) -> !llvm.ptr
    "llvm.store"(%120, %122) <{ordering = 0 : i64}> : (!llvm.array<32 x i8>, !llvm.ptr) -> ()
    %123 = "llvm.getelementptr"(%arg2) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
    %124 = "llvm.load"(%123) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %125 = "llvm.call"(%119, %124, %122) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaLibraryGetKernel, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %126 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %127 = "llvm.icmp"(%125, %126) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%127, %125)[^bb3, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %128 = "llvm.load"(%119) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %129 = "llvm.mlir.constant"() <{value = 8 : i32}> : () -> i32
    %130 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %131 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %132 = "llvm.alloca"(%130) <{elem_type = i32}> : (i32) -> !llvm.ptr
    %133 = "llvm.call"(%132, %131, %128, %112) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cuKernelGetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, !llvm.ptr, i32) -> i32
    %134 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %135 = "llvm.icmp"(%133, %134) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%135, %133)[^bb4, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %136 = "llvm.load"(%132) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %137 = "llvm.sub"(%118, %136) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
    %138 = "llvm.call"(%128, %129, %137) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaFuncSetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i32) -> i32
    %139 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %140 = "llvm.icmp"(%138, %139) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%140, %138)[^bb5, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb5:  // pred: ^bb4
    %141 = "llvm.mlir.constant"() <{value = 14 : i32}> : () -> i32
    %142 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %143 = "llvm.call"(%128, %141, %142) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaFuncSetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i32) -> i32
    %144 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %145 = "llvm.icmp"(%143, %144) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%145, %143)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %146 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    "llvm.br"(%146)[^bb7] : (i32) -> ()
  ^bb7(%147: i32):  // 7 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb4, ^bb5, ^bb6
    "llvm.return"(%147) : (i32) -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %72 = "llvm.alloca"(%71) <{elem_type = i32}> : (i32) -> !llvm.ptr
    %73 = "llvm.mlir.constant"() <{value = 97 : i32}> : () -> i32
    %74 = "llvm.call"(%72, %73, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaDeviceGetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i32) -> i32
    %75 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %76 = "llvm.icmp"(%74, %75) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%76, %74)[^bb1, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    %77 = "llvm.load"(%72) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %78 = "llvm.mlir.addressof"() <{global_name = @kernels_kernel_cutlass_kernel_no_smem_0}> : () -> !llvm.ptr
    %79 = "llvm.mlir.constant"() <{value = "kernel_cutlass_kernel_no_smem_0\00"}> : () -> !llvm.array<32 x i8>
    %80 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %81 = "llvm.alloca"(%80) <{elem_type = !llvm.array<32 x i8>}> : (i32) -> !llvm.ptr
    "llvm.store"(%79, %81) <{ordering = 0 : i64}> : (!llvm.array<32 x i8>, !llvm.ptr) -> ()
    %82 = "llvm.getelementptr"(%arg0) <{elem_type = !llvm.ptr, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
    %83 = "llvm.load"(%82) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %84 = "llvm.call"(%78, %83, %81) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaLibraryGetKernel, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %85 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %86 = "llvm.icmp"(%84, %85) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%86, %84)[^bb2, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    %87 = "llvm.load"(%78) <{ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %88 = "llvm.mlir.constant"() <{value = 8 : i32}> : () -> i32
    %89 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %90 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %91 = "llvm.alloca"(%89) <{elem_type = i32}> : (i32) -> !llvm.ptr
    %92 = "llvm.call"(%91, %90, %87, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cuKernelGetAttribute, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, !llvm.ptr, i32) -> i32
    %93 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %94 = "llvm.icmp"(%92, %93) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%94, %92)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %95 = "llvm.load"(%91) <{ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %96 = "llvm.sub"(%77, %95) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
    %97 = "llvm.call"(%87, %88, %96, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaKernelSetAttributeForDevice, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, i32, i32) -> i32
    %98 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %99 = "llvm.icmp"(%97, %98) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%99, %97)[^bb4, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %100 = "llvm.mlir.constant"() <{value = 14 : i32}> : () -> i32
    %101 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
    %102 = "llvm.call"(%87, %100, %101, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, callee = @_cudaKernelSetAttributeForDevice, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, i32, i32, i32) -> i32
    %103 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %104 = "llvm.icmp"(%102, %103) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%104, %102)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb5:  // pred: ^bb4
    %105 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    "llvm.br"(%105)[^bb6] : (i32) -> ()
  ^bb6(%106: i32):  // 6 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb4, ^bb5
    "llvm.return"(%106) : (i32) -> ()
  }) : () -> ()
