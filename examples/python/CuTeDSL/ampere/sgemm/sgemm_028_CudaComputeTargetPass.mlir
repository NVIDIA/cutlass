gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb10(%203: i32):  // 2 preds: ^bb9, ^bb11
    ...
    llvm.cond_br %204, ^bb11, ^bb12 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb11:  // pred: ^bb10
  ...
  ^bb13(%221: i32):  // 2 preds: ^bb12, ^bb14
    ...
    llvm.cond_br %222, ^bb14, ^bb15 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb14:  // pred: ^bb13
  ...
  ^bb16(%230: i32):  // 2 preds: ^bb15, ^bb17
    ...
    llvm.cond_br %231, ^bb17, ^bb18 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb17:  // pred: ^bb16
  ...
  ^bb19(%268: i32):  // 2 preds: ^bb18, ^bb20
    ...
    llvm.cond_br %269, ^bb20, ^bb21 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb20:  // pred: ^bb19
  ...
  ^bb22(%276: i32):  // 2 preds: ^bb21, ^bb23
    ...
    llvm.cond_br %277, ^bb23, ^bb24 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb23:  // pred: ^bb22
  ...
  ^bb27(%291: i32, %292: !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, %293: !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, %294: i32, %295: i32, %296: i32, %297: i32):  // 2 preds: ^bb26, ^bb59
    ...
    llvm.cond_br %298, ^bb28, ^bb60 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb28:  // pred: ^bb27
  ...
  ^bb33(%315: i32):  // 2 preds: ^bb32, ^bb34
    ...
    llvm.cond_br %316, ^bb34, ^bb35 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb34:  // pred: ^bb33
  ...
  ^bb36(%327: i32):  // 2 preds: ^bb35, ^bb37
    ...
    llvm.cond_br %328, ^bb37, ^bb38 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb37:  // pred: ^bb36
  ...
  ^bb40(%340: i32):  // 2 preds: ^bb39, ^bb41
    ...
    llvm.cond_br %341, ^bb41, ^bb42 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb41:  // pred: ^bb40
  ...
  ^bb44(%350: i32):  // 2 preds: ^bb43, ^bb51
    ...
    llvm.cond_br %351, ^bb45, ^bb52 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb45:  // pred: ^bb44
    llvm.br ^bb46(%19 : i32)
  ^bb46(%352: i32):  // 2 preds: ^bb45, ^bb50
    %353 = llvm.icmp "slt" %352, %14 : i32
    llvm.cond_br %353, ^bb47, ^bb51 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb47:  // pred: ^bb46
  ...
  ^bb48(%359: i32):  // 2 preds: ^bb47, ^bb49
    ...
    llvm.cond_br %360, ^bb49, ^bb50 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb49:  // pred: ^bb48
  ...
  ^bb54(%383: i32):  // 2 preds: ^bb53, ^bb55
    ...
    llvm.cond_br %384, ^bb55, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb55:  // pred: ^bb54
