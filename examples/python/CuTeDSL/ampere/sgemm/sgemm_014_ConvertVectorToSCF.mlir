...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !memref_gmem_f32_, %arg5: !memref_gmem_f32_1, %arg6: !memref_gmem_f32_2):
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg32: i32):
        %501 = "cute.make_coord"(%arg32) : (i32) -> !cute.coord<"((0,0),?,0,0)">
        %502 = "cute.crd2idx"(%501, %196) : (!cute.coord<"((0,0),?,0,0)">, !cute.layout<"((1,1),4,1,?):((0,0),32@0,0,8@1)">) -> !cute.int_tuple<"(?{div=32},0)">
        %503 = "cute.add_offset"(%194, %502) : (!cute.arith_tuple_iter<"(?,?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?,?)">
        %504 = "cute.deref_arith_tuple_iter"(%503) : (!cute.arith_tuple_iter<"(?,?)">) -> !cute.int_tuple<"(?,?)">
        %505:2 = "cute.get_leaves"(%504) : (!cute.int_tuple<"(?,?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?">)
        %506 = "cute.make_coord"(%505#0) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
        %507 = "cute.get_scalars"(%506) : (!cute.coord<"?">) -> i32
        %508 = "arith.cmpi"(%507, %211) <{predicate = 2 : i64}> : (i32, i32) -> i1
        %509 = "arith.extui"(%508) : (i1) -> i8
        %510 = "cute.make_coord"(%arg32) : (i32) -> !cute.coord<"(0,?,0)">
        %511 = "cute.derefine"(%510) : (!cute.coord<"(0,?,0)">) -> !cute.coord<"(?,?,0)">
        "cute.memref.store"(%198, %511, %509) : (!memref_rmem_i8_1, !cute.coord<"(?,?,0)">, i8) -> ()
        "scf.yield"() : () -> ()
      }) : (i32, i32, i32) -> ()
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg31: i32):
        %485 = "cute.make_coord"(%arg31) : (i32) -> !cute.coord<"((0,0),?,0,0)">
        %486 = "cute.crd2idx"(%485, %196) : (!cute.coord<"((0,0),?,0,0)">, !cute.layout<"((1,1),4,1,?):((0,0),32@0,0,8@1)">) -> !cute.int_tuple<"(?{div=32},0)">
        %487 = "cute.add_offset"(%194, %486) : (!cute.arith_tuple_iter<"(?,?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?,?)">
        %488 = "cute.deref_arith_tuple_iter"(%487) : (!cute.arith_tuple_iter<"(?,?)">) -> !cute.int_tuple<"(?,?)">
        %489:2 = "cute.get_leaves"(%488) : (!cute.int_tuple<"(?,?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?">)
        %490 = "cute.make_coord"(%489#0) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,-1)">
        %491 = "cute.derefine"(%490) : (!cute.coord<"(?,-1)">) -> !cute.coord<"(?,?)">
        %492 = "cute.make_coord"(%159, %489#1) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?)">
        %493:2 = "cute.get_scalars"(%491) : (!cute.coord<"(?,?)">) -> (i32, i32)
        %494:2 = "cute.get_scalars"(%492) : (!cute.coord<"(?,?)">) -> (i32, i32)
        %495 = "arith.cmpi"(%493#0, %494#0) <{predicate = 2 : i64}> : (i32, i32) -> i1
        %496 = "arith.cmpi"(%493#1, %494#1) <{predicate = 2 : i64}> : (i32, i32) -> i1
        %497 = "arith.andi"(%495, %496) : (i1, i1) -> i1
        %498 = "arith.extui"(%497) : (i1) -> i8
        %499 = "cute.make_coord"(%arg31) : (i32) -> !cute.coord<"(0,?,0)">
        %500 = "cute.derefine"(%499) : (!cute.coord<"(0,?,0)">) -> !cute.coord<"(?,?,?)">
        "cute.memref.store"(%200, %500, %498) : (!memref_rmem_i8_3, !cute.coord<"(?,?,?)">, i8) -> ()
        "scf.yield"() : () -> ()
      }) : (i32, i32, i32) -> ()
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg30: i32):
        %473 = "cute.make_coord"(%arg30) : (i32) -> !cute.coord<"(_,?)">
        %474 = "cute.crd2idx"(%473, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
        %475 = "cute.add_offset"(%147, %474) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
        %476 = "cute.crd2idx"(%473, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
        %477 = "cute.add_offset"(%155, %476) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
        %478 = "cute.crd2idx"(%473, %51) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,1)))">) -> !cute.int_tuple<"?">
        %479 = "cute.add_offset"(%224, %478) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
        %480 = "builtin.unrealized_conversion_cast"(%479) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
        %481 = "llvm.load"(%480) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
        %482 = "llvm.trunc"(%481) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
        %483 = "cute.recast_iter"(%475) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
        %484 = "cute.recast_iter"(%477) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
        "cute_nvgpu.arch.copy.SM80.cp_async"(%484, %483, %482) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
        "scf.yield"() : () -> ()
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg29: i32):
        %461 = "cute.make_coord"(%arg29) : (i32) -> !cute.coord<"(_,?)">
        %462 = "cute.crd2idx"(%461, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
        %463 = "cute.add_offset"(%258, %462) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
        %464 = "cute.crd2idx"(%461, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
        %465 = "cute.add_offset"(%260, %464) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
        %466 = "cute.crd2idx"(%461, %47) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,0)))">) -> !cute.int_tuple<"?">
        %467 = "cute.add_offset"(%212, %466) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
        ...
        %471 = "cute.recast_iter"(%463) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
        %472 = "cute.recast_iter"(%465) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
        "cute_nvgpu.arch.copy.SM80.cp_async"(%472, %471, %470) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      "nvvm.cp.async.commit.group"() : () -> ()
      ...
      "scf.for"(%59, %50, %58) ({
      ^bb0(%arg28: i32):
        %453 = "cute.make_coord"(%arg28) : (i32) -> !cute.coord<"(_,?)">
        %454 = "cute.crd2idx"(%453, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
        %455 = "cute.add_offset"(%267, %454) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
        %456 = "cute.crd2idx"(%453, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
        %457 = "cute.add_offset"(%294, %456) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
        %458 = "builtin.unrealized_conversion_cast"(%455) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
        %459 = "builtin.unrealized_conversion_cast"(%457) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
        %460 = "llvm.load"(%458) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
        "llvm.store"(%460, %459) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      %295 = "cute.get_iter"(%289) : (!memref_rmem_f32_) -> !cute.ptr<f32, rmem>
      "scf.for"(%59, %50, %58) ({
      ^bb0(%arg27: i32):
        %445 = "cute.make_coord"(%arg27) : (i32) -> !cute.coord<"(_,?)">
        %446 = "cute.crd2idx"(%445, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
        %447 = "cute.add_offset"(%273, %446) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
        %448 = "cute.crd2idx"(%445, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
        %449 = "cute.add_offset"(%295, %448) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
        %450 = "builtin.unrealized_conversion_cast"(%447) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
        %451 = "builtin.unrealized_conversion_cast"(%449) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
        %452 = "llvm.load"(%450) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
        "llvm.store"(%452, %451) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      ...
      ^bb0(%arg9: i32, %arg10: !memref_smem_f32_, %arg11: !memref_smem_f32_1, %arg12: i32, %arg13: i32, %arg14: i32):
        %349:6 = "scf.for"(%59, %73, %58, %arg10, %arg11, %arg12, %arg13, %arg14, %58) ({
        ^bb0(%arg15: i32, %arg16: !memref_smem_f32_, %arg17: !memref_smem_f32_1, %arg18: i32, %arg19: i32, %arg20: i32, %arg21: i32):
          %350 = "arith.cmpi"(%arg15, %38) <{predicate = 0 : i64}> : (i32, i32) -> i1
          %351:2 = "scf.if"(%350) ({
            %438 = "cute.make_coord"(%arg19) : (i32) -> !cute.coord<"(_,_,_,?)">
            %439 = "cute.crd2idx"(%438, %42) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"(1,(4,2),8,3):(0,(1,64),128,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %440 = "cute.add_offset"(%267, %439) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1024}">) -> !cute.ptr<f32, smem, align<16>>
            %441 = "cute.make_view"(%440) : (!cute.ptr<f32, smem, align<16>>) -> !memref_smem_f32_
            %442 = "cute.crd2idx"(%438, %41) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"(1,(4,2),8,3):(0,(1,64),132,1056)">) -> !cute.int_tuple<"?{div=1056}">
            %443 = "cute.add_offset"(%273, %442) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1056}">) -> !cute.ptr<f32, smem, align<16>>
            %444 = "cute.make_view"(%443) : (!cute.ptr<f32, smem, align<16>>) -> !memref_smem_f32_1
            "nvvm.cp.async.wait.group"() <{n = 1 : i32}> : () -> ()
            "llvm.inline_asm"(%58, %68) <{asm_dialect = 0 : i64, asm_string = "bar.sync $0, $1;", constraints = "r,r", has_side_effects}> : (i32, i32) -> ()
            "scf.yield"(%441, %444) : (!memref_smem_f32_, !memref_smem_f32_1) -> ()
          }, {
            "scf.yield"(%arg16, %arg17) : (!memref_smem_f32_, !memref_smem_f32_1) -> ()
          }) : (i1) -> (!memref_smem_f32_, !memref_smem_f32_1)
          %352 = "cute.make_coord"(%arg21) : (i32) -> !cute.coord<"(_,_,?)">
          %353 = "cute.crd2idx"(%352, %37) : (!cute.coord<"(_,_,?)">, !cute.layout<"(1,(4,2),8):(0,(1,64),128)">) -> !cute.int_tuple<"?{div=128}">
          %354 = "cute.get_iter"(%351#0) : (!memref_smem_f32_) -> !cute.ptr<f32, smem, align<16>>
          ...
          %357 = "cute.add_offset"(%294, %356) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, rmem>
          "scf.for"(%59, %50, %58) ({
          ^bb0(%arg26: i32):
            %430 = "cute.make_coord"(%arg26) : (i32) -> !cute.coord<"(_,?)">
            %431 = "cute.crd2idx"(%430, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
            %432 = "cute.add_offset"(%355, %431) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
            %433 = "cute.crd2idx"(%430, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
            %434 = "cute.add_offset"(%357, %433) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
            %435 = "builtin.unrealized_conversion_cast"(%432) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
            %436 = "builtin.unrealized_conversion_cast"(%434) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
            %437 = "llvm.load"(%435) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
            "llvm.store"(%437, %436) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          %358 = "cute.crd2idx"(%352, %35) : (!cute.coord<"(_,_,?)">, !cute.layout<"(1,(4,2),8):(0,(1,64),132)">) -> !cute.int_tuple<"?{div=132}">
          %359 = "cute.get_iter"(%351#1) : (!memref_smem_f32_1) -> !cute.ptr<f32, smem, align<16>>
          %360 = "cute.add_offset"(%359, %358) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=132}">) -> !cute.ptr<f32, smem, align<16>>
          %361 = "cute.add_offset"(%295, %356) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, rmem>
          "scf.for"(%59, %50, %58) ({
          ^bb0(%arg25: i32):
            %422 = "cute.make_coord"(%arg25) : (i32) -> !cute.coord<"(_,?)">
            %423 = "cute.crd2idx"(%422, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
            %424 = "cute.add_offset"(%360, %423) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
            %425 = "cute.crd2idx"(%422, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
            %426 = "cute.add_offset"(%361, %425) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
            %427 = "builtin.unrealized_conversion_cast"(%424) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
            %428 = "builtin.unrealized_conversion_cast"(%426) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
            %429 = "llvm.load"(%427) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
            "llvm.store"(%429, %428) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          %362 = "arith.cmpi"(%arg15, %59) <{predicate = 0 : i64}> : (i32, i32) -> i1
          "scf.if"(%362) ({
            %412 = "cute.make_coord"(%arg20) : (i32) -> !cute.coord<"(_,_,_,?)">
            %413 = "cute.crd2idx"(%412, %57) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((4,1),1,1,8):((1,0),0,0,2048)">) -> !cute.int_tuple<"?{div=2048}">
            %414 = "cute.add_offset"(%133, %413) : (!cute.ptr<f32, gmem, align<16>>, !cute.int_tuple<"?{div=2048}">) -> !cute.ptr<f32, gmem, align<16>>
            %415 = "cute.make_coord"(%arg18) : (i32) -> !cute.coord<"(_,_,_,?)">
            %416 = "cute.crd2idx"(%415, %49) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((4,1),1,1,3):((1,0),0,0,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %417 = "cute.add_offset"(%137, %416) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1024}">) -> !cute.ptr<f32, smem, align<16>>
            %418 = "llvm.load"(%252) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
            %419 = "llvm.trunc"(%418) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
            %420 = "cute.recast_iter"(%414) : (!cute.ptr<f32, gmem, align<16>>) -> !cute.ptr<i128, gmem>
            %421 = "cute.recast_iter"(%417) : (!cute.ptr<f32, smem, align<16>>) -> !cute.ptr<i128, smem>
            "cute_nvgpu.arch.copy.SM80.cp_async"(%421, %420, %419) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i128, smem>, !cute.ptr<i128, gmem>, i1) -> ()
            "scf.yield"() : () -> ()
          }, {
          }) : (i1) -> ()
          ...
          %365 = "cute.add_offset"(%294, %364) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, rmem>
          %366 = "cute.add_offset"(%295, %364) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, rmem>
          "scf.for"(%59, %73, %58) ({
          ^bb0(%arg23: i32):
            %396 = "cute.make_coord"(%arg23) : (i32) -> !cute.coord<"(_,?,0)">
            %397 = "cute.crd2idx"(%396, %33) : (!cute.coord<"(_,?,0)">, !cute.layout<"(1,(4,2),1):(0,(1,4),0)">) -> !cute.int_tuple<"?">
            %398 = "cute.add_offset"(%365, %397) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
            %399 = "cute.make_view"(%398) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
            "scf.for"(%59, %73, %58) ({
            ^bb0(%arg24: i32):
              %400 = "cute.make_coord"(%arg24) : (i32) -> !cute.coord<"(_,?,0)">
              %401 = "cute.make_coord"(%arg23, %arg24) : (i32, i32) -> !cute.coord<"(_,?,?)">
              %402 = "cute.crd2idx"(%400, %33) : (!cute.coord<"(_,?,0)">, !cute.layout<"(1,(4,2),1):(0,(1,4),0)">) -> !cute.int_tuple<"?">
              %403 = "cute.add_offset"(%366, %402) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
              %404 = "cute.crd2idx"(%401, %34) : (!cute.coord<"(_,?,?)">, !cute.layout<"(1,(4,2),(4,2)):(0,(1,4),(8,32))">) -> !cute.int_tuple<"?">
              %405 = "cute.add_offset"(%291, %404) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
              %406 = "cute.make_view"(%403) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
              %407 = "cute.make_view"(%405) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
              %408 = "cute.memref.load_vec"(%399) : (!memref_rmem_f32_2) -> vector<1xf32>
              %409 = "cute.memref.load_vec"(%406) : (!memref_rmem_f32_2) -> vector<1xf32>
              %410 = "cute.memref.load_vec"(%407) : (!memref_rmem_f32_2) -> vector<1xf32>
              %411 = "math.fma"(%408, %409, %410) <{fastmath = #arith.fastmath<none>}> : (vector<1xf32>, vector<1xf32>, vector<1xf32>) -> vector<1xf32>
              "cute.memref.store_vec"(%411, %407) : (vector<1xf32>, !memref_rmem_f32_2) -> ()
              "scf.yield"() : () -> ()
            }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          ...
          %368:2 = "scf.if"(%362) ({
            %372 = "cute.make_coord"(%arg20) : (i32) -> !cute.coord<"(_,_,_,?)">
            %373 = "cute.crd2idx"(%372, %151) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((1,1),4,1,?):((0,0),?{i64 div=2048},0,8)">) -> !cute.int_tuple<"?{div=8}">
            %374 = "cute.add_offset"(%147, %373) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, gmem>
            %375 = "cute.make_coord"(%arg18) : (i32) -> !cute.coord<"(_,_,_,?)">
            %376 = "cute.crd2idx"(%375, %48) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((1,1),4,1,3):((0,0),32,0,1056)">) -> !cute.int_tuple<"?{div=1056}">
            %377 = "cute.add_offset"(%155, %376) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=1056}">) -> !cute.ptr<f32, smem>
            "scf.for"(%59, %69, %58) ({
            ^bb0(%arg22: i32):
              %384 = "cute.make_coord"(%arg22) : (i32) -> !cute.coord<"(_,?)">
              %385 = "cute.crd2idx"(%384, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
              %386 = "cute.add_offset"(%374, %385) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
              %387 = "cute.crd2idx"(%384, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
              %388 = "cute.add_offset"(%377, %387) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
              %389 = "cute.crd2idx"(%384, %47) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,0)))">) -> !cute.int_tuple<"?">
              %390 = "cute.add_offset"(%212, %389) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
              %391 = "builtin.unrealized_conversion_cast"(%390) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
              %392 = "llvm.load"(%391) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
              %393 = "llvm.trunc"(%392) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
              %394 = "cute.recast_iter"(%386) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
              %395 = "cute.recast_iter"(%388) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
              "cute_nvgpu.arch.copy.SM80.cp_async"(%395, %394, %393) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
              "scf.yield"() : () -> ()
            }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
            "nvvm.cp.async.commit.group"() : () -> ()
            %378 = "arith.addi"(%arg19, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %379 = "arith.cmpi"(%378, %32) <{predicate = 0 : i64}> : (i32, i32) -> i1
            %380 = "arith.select"(%379, %59, %378) : (i1, i32, i32) -> i32
            %381 = "arith.addi"(%arg20, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %382 = "arith.cmpi"(%381, %73) <{predicate = 2 : i64}> : (i32, i32) -> i1
            %383 = "scf.if"(%382) ({
              "scf.yield"(%381) : (i32) -> ()
            }, {
              "scf.yield"(%58) : (i32) -> ()
            }) : (i1) -> i32
            "scf.yield"(%380, %383) : (i32, i32) -> ()
          }, {
            "scf.yield"(%arg19, %arg20) : (i32, i32) -> ()
          }) : (i1) -> (i32, i32)
          %369 = "arith.addi"(%arg21, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %370 = "arith.cmpi"(%369, %73) <{predicate = 0 : i64}> : (i32, i32) -> i1
          %371 = "arith.select"(%370, %59, %369) : (i1, i32, i32) -> i32
          "scf.yield"(%351#0, %351#1, %367, %368#0, %368#1, %371) : (!memref_smem_f32_, !memref_smem_f32_1, i32, i32, i32, i32) -> ()
        ...
        "scf.yield"(%349#0, %349#1, %349#2, %349#3, %349#4) : (!memref_smem_f32_, !memref_smem_f32_1, i32, i32, i32) -> ()
