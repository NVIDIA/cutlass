...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !memref_gmem_f32_, %arg5: !memref_gmem_f32_1, %arg6: !memref_gmem_f32_2):
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg31: i32):
        %500 = "cute.make_coord"(%arg31) : (i32) -> !cute.coord<"((0,0),?,0,0)">
        %501 = "cute.crd2idx"(%500, %196) : (!cute.coord<"((0,0),?,0,0)">, !cute.layout<"((1,1),4,1,?):((0,0),32@0,0,8@1)">) -> !cute.int_tuple<"(?{div=32},0)">
        %502 = "cute.add_offset"(%194, %501) : (!cute.arith_tuple_iter<"(?,?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?,?)">
        ...
        %505 = "cute.make_coord"(%504#0) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
        %506 = "cute.get_scalars"(%505) : (!cute.coord<"?">) -> i32
        %507 = "arith.cmpi"(%506, %211) <{predicate = 2 : i64}> : (i32, i32) -> i1
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg30: i32):
        %484 = "cute.make_coord"(%arg30) : (i32) -> !cute.coord<"((0,0),?,0,0)">
        %485 = "cute.crd2idx"(%484, %196) : (!cute.coord<"((0,0),?,0,0)">, !cute.layout<"((1,1),4,1,?):((0,0),32@0,0,8@1)">) -> !cute.int_tuple<"(?{div=32},0)">
        %486 = "cute.add_offset"(%194, %485) : (!cute.arith_tuple_iter<"(?,?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?,?)">
        %487 = "cute.deref_arith_tuple_iter"(%486) : (!cute.arith_tuple_iter<"(?,?)">) -> !cute.int_tuple<"(?,?)">
        %488:2 = "cute.get_leaves"(%487) : (!cute.int_tuple<"(?,?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?">)
        %489 = "cute.make_coord"(%488#0) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,-1)">
        %490 = "cute.derefine"(%489) : (!cute.coord<"(?,-1)">) -> !cute.coord<"(?,?)">
        %491 = "cute.make_coord"(%159, %488#1) : (!cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?)">
        %492:2 = "cute.get_scalars"(%490) : (!cute.coord<"(?,?)">) -> (i32, i32)
        %493:2 = "cute.get_scalars"(%491) : (!cute.coord<"(?,?)">) -> (i32, i32)
        %494 = "arith.cmpi"(%492#0, %493#0) <{predicate = 2 : i64}> : (i32, i32) -> i1
        %495 = "arith.cmpi"(%492#1, %493#1) <{predicate = 2 : i64}> : (i32, i32) -> i1
        %496 = "arith.andi"(%494, %495) : (i1, i1) -> i1
        %497 = "arith.extui"(%496) : (i1) -> i8
        %498 = "cute.make_coord"(%arg30) : (i32) -> !cute.coord<"(0,?,0)">
        %499 = "cute.derefine"(%498) : (!cute.coord<"(0,?,0)">) -> !cute.coord<"(?,?,?)">
        "cute.memref.store"(%200, %499, %497) : (!memref_rmem_i8_3, !cute.coord<"(?,?,?)">, i8) -> ()
        "scf.yield"() : () -> ()
      }) : (i32, i32, i32) -> ()
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg29: i32):
        %472 = "cute.make_coord"(%arg29) : (i32) -> !cute.coord<"(_,?)">
        %473 = "cute.crd2idx"(%472, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
        %474 = "cute.add_offset"(%147, %473) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
        %475 = "cute.crd2idx"(%472, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
        %476 = "cute.add_offset"(%155, %475) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
        %477 = "cute.crd2idx"(%472, %51) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,1)))">) -> !cute.int_tuple<"?">
        %478 = "cute.add_offset"(%224, %477) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
        %479 = "builtin.unrealized_conversion_cast"(%478) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
        %480 = "llvm.load"(%479) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
        %481 = "llvm.trunc"(%480) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
        %482 = "cute.recast_iter"(%474) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
        %483 = "cute.recast_iter"(%476) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
        "cute_nvgpu.arch.copy.SM80.cp_async"(%483, %482, %481) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
        "scf.yield"() : () -> ()
      ...
      "scf.for"(%59, %69, %58) ({
      ^bb0(%arg28: i32):
        %460 = "cute.make_coord"(%arg28) : (i32) -> !cute.coord<"(_,?)">
        %461 = "cute.crd2idx"(%460, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
        %462 = "cute.add_offset"(%258, %461) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
        %463 = "cute.crd2idx"(%460, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
        %464 = "cute.add_offset"(%260, %463) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
        %465 = "cute.crd2idx"(%460, %47) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,0)))">) -> !cute.int_tuple<"?">
        %466 = "cute.add_offset"(%212, %465) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
        %467 = "builtin.unrealized_conversion_cast"(%466) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
        %468 = "llvm.load"(%467) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
        %469 = "llvm.trunc"(%468) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
        %470 = "cute.recast_iter"(%462) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
        %471 = "cute.recast_iter"(%464) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
        "cute_nvgpu.arch.copy.SM80.cp_async"(%471, %470, %469) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      "nvvm.cp.async.commit.group"() : () -> ()
      ...
      "scf.for"(%59, %50, %58) ({
      ^bb0(%arg27: i32):
        %452 = "cute.make_coord"(%arg27) : (i32) -> !cute.coord<"(_,?)">
        %453 = "cute.crd2idx"(%452, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
        %454 = "cute.add_offset"(%267, %453) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
        %455 = "cute.crd2idx"(%452, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
        %456 = "cute.add_offset"(%294, %455) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
        %457 = "builtin.unrealized_conversion_cast"(%454) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
        %458 = "builtin.unrealized_conversion_cast"(%456) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
        %459 = "llvm.load"(%457) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
        "llvm.store"(%459, %458) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      %295 = "cute.get_iter"(%289) : (!memref_rmem_f32_) -> !cute.ptr<f32, rmem>
      "scf.for"(%59, %50, %58) ({
      ^bb0(%arg26: i32):
        %444 = "cute.make_coord"(%arg26) : (i32) -> !cute.coord<"(_,?)">
        %445 = "cute.crd2idx"(%444, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
        %446 = "cute.add_offset"(%273, %445) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
        %447 = "cute.crd2idx"(%444, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
        %448 = "cute.add_offset"(%295, %447) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
        %449 = "builtin.unrealized_conversion_cast"(%446) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
        %450 = "builtin.unrealized_conversion_cast"(%448) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
        %451 = "llvm.load"(%449) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
        "llvm.store"(%451, %450) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
        "scf.yield"() : () -> ()
      }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
      ...
      ^bb0(%arg9: i32, %arg10: !memref_smem_f32_, %arg11: !memref_smem_f32_1, %arg12: i32, %arg13: i32, %arg14: i32):
        %349:5 = "scf.for"(%59, %73, %58, %arg10, %arg11, %arg12, %arg13, %arg14) ({
        ^bb0(%arg15: i32, %arg16: !memref_smem_f32_, %arg17: !memref_smem_f32_1, %arg18: i32, %arg19: i32, %arg20: i32):
          ...
          %351:2 = "scf.if"(%350) ({
            %437 = "cute.make_coord"(%arg19) : (i32) -> !cute.coord<"(_,_,_,?)">
            %438 = "cute.crd2idx"(%437, %42) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"(1,(4,2),8,3):(0,(1,64),128,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %439 = "cute.add_offset"(%267, %438) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1024}">) -> !cute.ptr<f32, smem, align<16>>
            %440 = "cute.make_view"(%439) : (!cute.ptr<f32, smem, align<16>>) -> !memref_smem_f32_
            %441 = "cute.crd2idx"(%437, %41) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"(1,(4,2),8,3):(0,(1,64),132,1056)">) -> !cute.int_tuple<"?{div=1056}">
            %442 = "cute.add_offset"(%273, %441) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1056}">) -> !cute.ptr<f32, smem, align<16>>
            %443 = "cute.make_view"(%442) : (!cute.ptr<f32, smem, align<16>>) -> !memref_smem_f32_1
            "nvvm.cp.async.wait.group"() <{n = 1 : i32}> : () -> ()
            "llvm.inline_asm"(%58, %68) <{asm_dialect = 0 : i64, asm_string = "bar.sync $0, $1;", constraints = "r,r", has_side_effects}> : (i32, i32) -> ()
            "scf.yield"(%440, %443) : (!memref_smem_f32_, !memref_smem_f32_1) -> ()
          }, {
            "scf.yield"(%arg16, %arg17) : (!memref_smem_f32_, !memref_smem_f32_1) -> ()
          }) : (i1) -> (!memref_smem_f32_, !memref_smem_f32_1)
          %352 = "arith.addi"(%arg15, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %353 = "arith.remsi"(%352, %73) : (i32, i32) -> i32
          %354 = "cute.make_coord"(%353) : (i32) -> !cute.coord<"(_,_,?)">
          %355 = "cute.crd2idx"(%354, %37) : (!cute.coord<"(_,_,?)">, !cute.layout<"(1,(4,2),8):(0,(1,64),128)">) -> !cute.int_tuple<"?{div=128}">
          %356 = "cute.get_iter"(%351#0) : (!memref_smem_f32_) -> !cute.ptr<f32, smem, align<16>>
          ...
          "scf.for"(%59, %50, %58) ({
          ^bb0(%arg25: i32):
            %429 = "cute.make_coord"(%arg25) : (i32) -> !cute.coord<"(_,?)">
            %430 = "cute.crd2idx"(%429, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
            %431 = "cute.add_offset"(%357, %430) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
            %432 = "cute.crd2idx"(%429, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
            %433 = "cute.add_offset"(%359, %432) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
            %434 = "builtin.unrealized_conversion_cast"(%431) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
            %435 = "builtin.unrealized_conversion_cast"(%433) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
            %436 = "llvm.load"(%434) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
            "llvm.store"(%436, %435) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          %360 = "cute.crd2idx"(%354, %35) : (!cute.coord<"(_,_,?)">, !cute.layout<"(1,(4,2),8):(0,(1,64),132)">) -> !cute.int_tuple<"?{div=132}">
          %361 = "cute.get_iter"(%351#1) : (!memref_smem_f32_1) -> !cute.ptr<f32, smem, align<16>>
          ...
          "scf.for"(%59, %50, %58) ({
          ^bb0(%arg24: i32):
            %421 = "cute.make_coord"(%arg24) : (i32) -> !cute.coord<"(_,?)">
            %422 = "cute.crd2idx"(%421, %40) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(64))">) -> !cute.int_tuple<"?{div=64}">
            %423 = "cute.add_offset"(%362, %422) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, smem, align<16>>
            %424 = "cute.crd2idx"(%421, %39) : (!cute.coord<"(_,?)">, !cute.layout<"(4,(2)):(1,(4))">) -> !cute.int_tuple<"?{div=4}">
            %425 = "cute.add_offset"(%363, %424) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f32, rmem>
            %426 = "builtin.unrealized_conversion_cast"(%423) : (!cute.ptr<f32, smem, align<16>>) -> !llvm.ptr<3>
            %427 = "builtin.unrealized_conversion_cast"(%425) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
            %428 = "llvm.load"(%426) <{alignment = 16 : i64, ordering = 0 : i64}> : (!llvm.ptr<3>) -> vector<4xf32>
            "llvm.store"(%428, %427) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<4xf32>, !llvm.ptr) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          %364 = "arith.cmpi"(%arg15, %59) <{predicate = 0 : i64}> : (i32, i32) -> i1
          "scf.if"(%364) ({
            %411 = "cute.make_coord"(%arg20) : (i32) -> !cute.coord<"(_,_,_,?)">
            %412 = "cute.crd2idx"(%411, %57) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((4,1),1,1,8):((1,0),0,0,2048)">) -> !cute.int_tuple<"?{div=2048}">
            %413 = "cute.add_offset"(%133, %412) : (!cute.ptr<f32, gmem, align<16>>, !cute.int_tuple<"?{div=2048}">) -> !cute.ptr<f32, gmem, align<16>>
            %414 = "cute.make_coord"(%arg18) : (i32) -> !cute.coord<"(_,_,_,?)">
            %415 = "cute.crd2idx"(%414, %49) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((4,1),1,1,3):((1,0),0,0,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %416 = "cute.add_offset"(%137, %415) : (!cute.ptr<f32, smem, align<16>>, !cute.int_tuple<"?{div=1024}">) -> !cute.ptr<f32, smem, align<16>>
            %417 = "llvm.load"(%252) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
            %418 = "llvm.trunc"(%417) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
            %419 = "cute.recast_iter"(%413) : (!cute.ptr<f32, gmem, align<16>>) -> !cute.ptr<i128, gmem>
            %420 = "cute.recast_iter"(%416) : (!cute.ptr<f32, smem, align<16>>) -> !cute.ptr<i128, smem>
            "cute_nvgpu.arch.copy.SM80.cp_async"(%420, %419, %418) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i128, smem>, !cute.ptr<i128, gmem>, i1) -> ()
            "scf.yield"() : () -> ()
          }, {
          }) : (i1) -> ()
          ...
          "scf.for"(%59, %73, %58) ({
          ^bb0(%arg22: i32):
            %395 = "cute.make_coord"(%arg22) : (i32) -> !cute.coord<"(_,?,0)">
            %396 = "cute.crd2idx"(%395, %33) : (!cute.coord<"(_,?,0)">, !cute.layout<"(1,(4,2),1):(0,(1,4),0)">) -> !cute.int_tuple<"?">
            %397 = "cute.add_offset"(%367, %396) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
            %398 = "cute.make_view"(%397) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
            "scf.for"(%59, %73, %58) ({
            ^bb0(%arg23: i32):
              %399 = "cute.make_coord"(%arg23) : (i32) -> !cute.coord<"(_,?,0)">
              %400 = "cute.make_coord"(%arg22, %arg23) : (i32, i32) -> !cute.coord<"(_,?,?)">
              %401 = "cute.crd2idx"(%399, %33) : (!cute.coord<"(_,?,0)">, !cute.layout<"(1,(4,2),1):(0,(1,4),0)">) -> !cute.int_tuple<"?">
              %402 = "cute.add_offset"(%368, %401) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
              %403 = "cute.crd2idx"(%400, %34) : (!cute.coord<"(_,?,?)">, !cute.layout<"(1,(4,2),(4,2)):(0,(1,4),(8,32))">) -> !cute.int_tuple<"?">
              %404 = "cute.add_offset"(%291, %403) : (!cute.ptr<f32, rmem>, !cute.int_tuple<"?">) -> !cute.ptr<f32, rmem>
              %405 = "cute.make_view"(%402) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
              %406 = "cute.make_view"(%404) : (!cute.ptr<f32, rmem>) -> !memref_rmem_f32_2
              %407 = "cute.memref.load_vec"(%398) : (!memref_rmem_f32_2) -> vector<1xf32>
              %408 = "cute.memref.load_vec"(%405) : (!memref_rmem_f32_2) -> vector<1xf32>
              %409 = "cute.memref.load_vec"(%406) : (!memref_rmem_f32_2) -> vector<1xf32>
              %410 = "math.fma"(%407, %408, %409) <{fastmath = #arith.fastmath<none>}> : (vector<1xf32>, vector<1xf32>, vector<1xf32>) -> vector<1xf32>
              "cute.memref.store_vec"(%410, %406) : (vector<1xf32>, !memref_rmem_f32_2) -> ()
              "scf.yield"() : () -> ()
            }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
            "scf.yield"() : () -> ()
          }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
          ...
          %370:2 = "scf.if"(%364) ({
            %371 = "cute.make_coord"(%arg20) : (i32) -> !cute.coord<"(_,_,_,?)">
            %372 = "cute.crd2idx"(%371, %151) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((1,1),4,1,?):((0,0),?{i64 div=2048},0,8)">) -> !cute.int_tuple<"?{div=8}">
            %373 = "cute.add_offset"(%147, %372) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f32, gmem>
            %374 = "cute.make_coord"(%arg18) : (i32) -> !cute.coord<"(_,_,_,?)">
            %375 = "cute.crd2idx"(%374, %48) : (!cute.coord<"(_,_,_,?)">, !cute.layout<"((1,1),4,1,3):((0,0),32,0,1056)">) -> !cute.int_tuple<"?{div=1056}">
            %376 = "cute.add_offset"(%155, %375) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=1056}">) -> !cute.ptr<f32, smem>
            "scf.for"(%59, %69, %58) ({
            ^bb0(%arg21: i32):
              %383 = "cute.make_coord"(%arg21) : (i32) -> !cute.coord<"(_,?)">
              %384 = "cute.crd2idx"(%383, %246) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((?{i64 div=2048},0)))">) -> !cute.int_tuple<"?{i64 div=2048}">
              %385 = "cute.add_offset"(%373, %384) : (!cute.ptr<f32, gmem>, !cute.int_tuple<"?{i64 div=2048}">) -> !cute.ptr<f32, gmem>
              %386 = "cute.crd2idx"(%383, %52) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1),((4,1))):((0,0),((32,0)))">) -> !cute.int_tuple<"?{div=32}">
              %387 = "cute.add_offset"(%376, %386) : (!cute.ptr<f32, smem>, !cute.int_tuple<"?{div=32}">) -> !cute.ptr<f32, smem>
              %388 = "cute.crd2idx"(%383, %47) : (!cute.coord<"(_,?)">, !cute.layout<"(1,((4,1))):(4,((1,0)))">) -> !cute.int_tuple<"?">
              %389 = "cute.add_offset"(%212, %388) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
              %390 = "builtin.unrealized_conversion_cast"(%389) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
              %391 = "llvm.load"(%390) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
              %392 = "llvm.trunc"(%391) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
              %393 = "cute.recast_iter"(%385) : (!cute.ptr<f32, gmem>) -> !cute.ptr<i32, gmem>
              %394 = "cute.recast_iter"(%387) : (!cute.ptr<f32, smem>) -> !cute.ptr<i32, smem>
              "cute_nvgpu.arch.copy.SM80.cp_async"(%394, %393, %392) <{cache_mode = #cute_nvgpu.load_cache_mode<always>}> : (!cute.ptr<i32, smem>, !cute.ptr<i32, gmem>, i1) -> ()
              "scf.yield"() : () -> ()
            }) {llvm.loop_annotation = #loop_annotation} : (i32, i32, i32) -> ()
            "nvvm.cp.async.commit.group"() : () -> ()
            %377 = "arith.addi"(%arg19, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %378 = "arith.cmpi"(%377, %32) <{predicate = 0 : i64}> : (i32, i32) -> i1
            %379 = "arith.select"(%378, %59, %377) : (i1, i32, i32) -> i32
            %380 = "arith.addi"(%arg20, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %381 = "arith.cmpi"(%380, %73) <{predicate = 2 : i64}> : (i32, i32) -> i1
            %382 = "scf.if"(%381) ({
              "scf.yield"(%380) : (i32) -> ()
            }, {
              "scf.yield"(%58) : (i32) -> ()
            }) : (i1) -> i32
            "scf.yield"(%379, %382) : (i32, i32) -> ()
          }, {
            "scf.yield"(%arg19, %arg20) : (i32, i32) -> ()
          }) : (i1) -> (i32, i32)
          "scf.yield"(%351#0, %351#1, %369, %370#0, %370#1) : (!memref_smem_f32_, !memref_smem_f32_1, i32, i32, i32) -> ()
