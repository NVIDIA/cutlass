...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb8:  // pred: ^bb7
      ...
      nvvm.cp.async.shared.global %138, %136, 16, cache =  ca, %199 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb11:  // pred: ^bb10
      ...
      nvvm.cp.async.shared.global %208, %206, 4, cache =  ca, %214 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb14:  // pred: ^bb13
      ...
      nvvm.cp.async.shared.global %217, %216, 16, cache =  ca, %222 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb17:  // pred: ^bb16
      ...
      nvvm.cp.async.shared.global %233, %231, 4, cache =  ca, %237 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb41:  // pred: ^bb40
      ...
      nvvm.cp.async.shared.global %334, %332, 16, cache =  ca, %339 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb55:  // pred: ^bb54
      ...
      nvvm.cp.async.shared.global %384, %382, 4, cache =  ca, %388 : !llvm.ptr<3>, !llvm.ptr<1>, i32
    ...
    ^bb61:  // pred: ^bb25
      ...
      %404 = vector.shuffle %403, %403 [0, 32, 8, 40, 16, 48, 24, 56, 4, 36, 12, 44, 20, 52, 28, 60, 1, 33, 9, 41, 17, 49, 25, 57, 5, 37, 13, 45, 21, 53, 29, 61, 2, 34, 10, 42, 18, 50, 26, 58, 6, 38, 14, 46, 22, 54, 30, 62, 3, 35, 11, 43, 19, 51, 27, 59, 7, 39, 15, 47, 23, 55, 31, 63] : vector<64xf32>, vector<64xf32>
      %405 = vector.shuffle %404, %404 [0, 16, 32, 48, 8, 24, 40, 56, 2, 18, 34, 50, 10, 26, 42, 58, 4, 20, 36, 52, 12, 28, 44, 60, 6, 22, 38, 54, 14, 30, 46, 62, 1, 17, 33, 49, 9, 25, 41, 57, 3, 19, 35, 51, 11, 27, 43, 59, 5, 21, 37, 53, 13, 29, 45, 61, 7, 23, 39, 55, 15, 31, 47, 63] : vector<64xf32>, vector<64xf32>
