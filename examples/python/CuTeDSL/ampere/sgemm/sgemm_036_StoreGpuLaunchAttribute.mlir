!memref_gmem_f32_ = !cute.memref<f32, gmem, align<16>, "(?,?{div=256}):(?{i64 div=256},1)">
...
module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass___call_____main__SGemm_object_at__Tensorgmemo256641256_Tensorgmemodiv64i64div641_Tensorgmemodiv256i64div2561_functionlambdaat_CUstream0x0(%arg0: !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg1: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg2: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg3: !llvm.ptr) attributes {llvm.emit_c_interface} {
    ...
    %9 = llvm.mlir.constant(24944 : i32) : i32
    %10 = builtin.unrealized_conversion_cast %0 : !memref_gmem_f32_ to !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>
    %11 = llvm.extractvalue %10[1] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)> 
    %12 = llvm.extractvalue %11[0] : !llvm.struct<(struct<(i32, i32)>, i64)> 
    %13 = llvm.extractvalue %12[0] : !llvm.struct<(i32, i32)> 
    %14 = llvm.extractvalue %12[1] : !llvm.struct<(i32, i32)> 
    %15 = llvm.select %2, %3, %5 : i1, i32
    %16 = llvm.add %15, %13 : i32
    %17 = llvm.sdiv %16, %6 : i32
    %18 = llvm.add %17, %5 : i32
    %19 = llvm.sub %4, %13 : i32
    %20 = llvm.sdiv %19, %6 : i32
    %21 = llvm.sub %4, %20 : i32
    %22 = llvm.icmp "slt" %13, %4 : i32
    %23 = llvm.icmp "sgt" %13, %4 : i32
    %24 = llvm.and %22, %1 : i1
    %25 = llvm.and %23, %2 : i1
    %26 = llvm.or %24, %25 : i1
    %27 = llvm.select %26, %18, %21 : i1, i32
    %28 = llvm.add %15, %14 : i32
    %29 = llvm.sdiv %28, %6 : i32
    %30 = llvm.add %29, %5 : i32
    %31 = llvm.sub %4, %14 : i32
    %32 = llvm.sdiv %31, %6 : i32
    %33 = llvm.sub %4, %32 : i32
    %34 = llvm.icmp "slt" %14, %4 : i32
    %35 = llvm.icmp "sgt" %14, %4 : i32
    %36 = llvm.and %34, %1 : i1
    %37 = llvm.and %35, %2 : i1
    %38 = llvm.or %36, %37 : i1
    %39 = llvm.select %38, %30, %33 : i1, i32
    %40 = llvm.sext %27 : i32 to i64
    %41 = llvm.sext %39 : i32 to i64
    gpu.launch_func <%arg3 : !llvm.ptr> @kernels::@kernel_cutlass_kernel___main__SGemm_object_at__tensorptrf32gmemalign16o256641256_tensorptrf32gmemalign16odiv64div641_tensorptrf32gmemalign16odiv256div2561_TiledCopy_TilerMN128181_TVLayout_0 blocks in (%40, %41, %7) threads in (%8, %7, %7) : i64 dynamic_shared_memory_size %9 args(%arg0 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg1 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg2 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>) {use_pdl = false}
    llvm.return
  }
