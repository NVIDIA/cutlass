...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb38:  // pred: ^bb37
      ...
      %456 = "llvm.mlir.undef"() : () -> vector<1xf32>
      %457 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %458 = "llvm.extractelement"(%453, %457) : (vector<1xf32>, i64) -> f32
      %459 = "llvm.extractelement"(%454, %457) : (vector<1xf32>, i64) -> f32
      %460 = "llvm.extractelement"(%455, %457) : (vector<1xf32>, i64) -> f32
      ...
      %462 = "llvm.insertelement"(%456, %461, %457) : (vector<1xf32>, f32, i64) -> vector<1xf32>
      "llvm.store"(%462, %452) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<1xf32>, !llvm.ptr) -> ()
      %463 = "llvm.add"(%441, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      "llvm.br"(%463)[^bb37] : (i32) -> ()
    ^bb39:  // pred: ^bb37
      %464 = "llvm.add"(%434, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      "llvm.br"(%464)[^bb35] : (i32) -> ()
    ^bb40:  // pred: ^bb35
      %465 = "llvm.select"(%423, %383, %382) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
      "llvm.cond_br"(%423, %383, %384)[^bb41, ^bb47] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i32, i32) -> ()
    ^bb41:  // pred: ^bb40
      %466 = "llvm.mul"(%384, %113) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %467 = "llvm.getelementptr"(%246, %466) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %468 = "llvm.mul"(%382, %101) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %469 = "llvm.getelementptr"(%249, %468) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>
      "llvm.br"(%118)[^bb42] : (i32) -> ()
    ^bb42(%470: i32):  // 2 preds: ^bb41, ^bb43
      %471 = "llvm.icmp"(%470, %128) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%471)[^bb43, ^bb44] <{operandSegmentSizes = array<i32: 1, 0, 0>}> {llvm.loop_annotation = #loop_annotation} : (i1) -> ()
    ^bb43:  // pred: ^bb42
      %472 = "llvm.srem"(%470, %128) : (i32, i32) -> i32
      %473 = "llvm.sext"(%472) : (i32) -> i64
      %474 = "llvm.mul"(%473, %239) <{overflowFlags = #llvm.overflow<none>}> : (i64, i64) -> i64
      ...
      %478 = "llvm.getelementptr"(%138, %472) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %479 = "llvm.load"(%478) <{ordering = 0 : i64}> : (!llvm.ptr) -> i8
      %480 = "llvm.trunc"(%479) <{overflowFlags = #llvm.overflow<none>}> : (i8) -> i1
      %481 = "llvm.select"(%480, %128, %118) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
      "llvm.inline_asm"(%477, %475, %128, %481) <{asm_dialect = 0 : i64, asm_string = "cp.async.ca.shared.global [$0], [$1], $2, $3;\0A", constraints = "r,l,n,r", has_side_effects}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32, i32) -> ()
      %482 = "llvm.add"(%470, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      "llvm.br"(%482)[^bb42] : (i32) -> ()
    ^bb44:  // pred: ^bb42
      "nvvm.cp.async.commit.group"() : () -> ()
      %483 = "llvm.add"(%383, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      ...
      %486 = "llvm.add"(%384, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
    ...
    ^bb48:  // pred: ^bb47
      "llvm.br"()[^bb49] : () -> ()
    ^bb49:  // pred: ^bb48
      %491 = "llvm.add"(%385, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      ...
      %494 = "llvm.add"(%379, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      "llvm.br"(%494, %396, %397, %465, %489, %490, %493)[^bb21] : (i32, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, i32, i32, i32, i32) -> ()
    ^bb50:  // pred: ^bb21
      %495 = "llvm.add"(%372, %131) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      "llvm.br"(%495, %380, %381, %382, %383, %384)[^bb19] : (i32, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, i32, i32, i32) -> ()
    ^bb51:  // pred: ^bb19
    ...
    ^bb53:  // pred: ^bb52
      ...
      %514 = "llvm.add"(%335, %509) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %515 = "llvm.add"(%339, %513) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
    ...
    ^bb54:  // pred: ^bb52
      %530 = "llvm.extractvalue"(%351) <{position = array<i64: 1, 0>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> i64
      %531 = "llvm.extractvalue"(%351) <{position = array<i64: 1, 1>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>) -> i64
      ...
      %534 = "llvm.insertvalue"(%350, %533) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, struct<(i64, i64)>)>, !llvm.struct<(i64, i64)>) -> !llvm.struct<(struct<()>, struct<(i64, i64)>)>
    ...
    ^bb56:  // pred: ^bb55
      ...
      %561 = "llvm.getelementptr"(%347, %560) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i64) -> !llvm.ptr<1>
