gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb54(%378: i32):  // 2 preds: ^bb53, ^bb55
    ...
    llvm.cond_br %379, ^bb55, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb55:  // pred: ^bb54
  ...
  ^bb65(%445: i32):  // 2 preds: ^bb64, ^bb68
    ...
    llvm.cond_br %446, ^bb66, ^bb69 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb66:  // pred: ^bb65
