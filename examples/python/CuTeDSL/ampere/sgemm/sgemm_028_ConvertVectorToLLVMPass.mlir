...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb6:  // pred: ^bb4
      ...
      "nvvm.cp.async.shared.global"(%238, %236, %296) <{modifier = #nvvm<load_cache_modifier ca>, size = 16 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
      "llvm.br"(%118)[^bb7] : (i32) -> ()
    ...
    ^bb8:  // pred: ^bb7
      ...
      "nvvm.cp.async.shared.global"(%304, %302, %310) <{modifier = #nvvm<load_cache_modifier ca>, size = 4 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
    ...
    ^bb9:  // pred: ^bb7
      ...
      "nvvm.cp.async.shared.global"(%313, %312, %316) <{modifier = #nvvm<load_cache_modifier ca>, size = 16 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
    ...
    ^bb11:  // pred: ^bb10
      ...
      "nvvm.cp.async.shared.global"(%326, %324, %330) <{modifier = #nvvm<load_cache_modifier ca>, size = 4 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
    ...
    ^bb33:  // pred: ^bb32
      ...
      "nvvm.cp.async.shared.global"(%427, %425, %430) <{modifier = #nvvm<load_cache_modifier ca>, size = 16 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
      "llvm.br"()[^bb34] : () -> ()
    ...
    ^bb43:  // pred: ^bb42
      ...
      "nvvm.cp.async.shared.global"(%471, %469, %475) <{modifier = #nvvm<load_cache_modifier ca>, size = 4 : i32}> : (!llvm.ptr<3>, !llvm.ptr<1>, i32) -> ()
