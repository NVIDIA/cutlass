...
module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass___call_____main__HSTUAttentionForwardAmpere_object_at__Tensorgmemodiv8i64div8i64div8i64div81_Tensorgmemodiv8i64div8i64div8i64div81_Tensorgmemodiv8i64div8i64div8i64div81_Ten(%arg0: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg1: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg2: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg3: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg4: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg5: !llvm.ptr) attributes {llvm.emit_c_interface} {
    %0 = llvm.mlir.constant(57344 : i32) : i32
    ...
    %12 = llvm.extractvalue %11[1] : !llvm.struct<(i32, i32, i32, i32)> 
    %13 = llvm.select %8, %7, %5 : i1, i32
    %14 = llvm.add %13, %12 : i32
    %15 = llvm.sdiv %14, %4 : i32
    %16 = llvm.add %15, %5 : i32
    %17 = llvm.sub %6, %12 : i32
    %18 = llvm.sdiv %17, %4 : i32
    %19 = llvm.sub %6, %18 : i32
    %20 = llvm.icmp "slt" %12, %6 : i32
    %21 = llvm.icmp "sgt" %12, %6 : i32
    %22 = llvm.and %20, %9 : i1
    %23 = llvm.and %21, %8 : i1
    %24 = llvm.or %22, %23 : i1
    %25 = llvm.select %24, %16, %19 : i1, i32
    %26 = llvm.sext %25 : i32 to i64
    gpu.launch_func <%arg5 : !llvm.ptr> @kernels::@kernel_cutlass_kernel___main__HSTUAttentionForwardAmpere_object_at__tensorptrbf16gmemalign16odiv8div8div8div81_tensorptrbf16gmemalign16odiv8div8div8div81_tensorptrbf16gmemalign16odiv8div8_0 blocks in (%3, %3, %26) threads in (%2, %1, %1) : i64 dynamic_shared_memory_size %0 args(%arg0 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg1 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg2 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg3 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>, %arg4 : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32, i32)>, struct<(i64, i64, i64)>)>)>) {use_pdl = false}
    llvm.return
  }
