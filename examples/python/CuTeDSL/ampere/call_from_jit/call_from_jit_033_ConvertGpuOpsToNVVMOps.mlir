gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_90]>]} {
  ...
  ^bb71(%551: i32):  // 2 preds: ^bb70, ^bb72
    ...
    llvm.cond_br %552, ^bb72, ^bb73 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
  ...
  ^bb74(%577: i32):  // 2 preds: ^bb73, ^bb75
    ...
    llvm.cond_br %578, ^bb75, ^bb76 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb75:  // pred: ^bb74
  ...
  ^bb81(%598: i32):  // 2 preds: ^bb80, ^bb84
    ...
    llvm.cond_br %599, ^bb82, ^bb85 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb82:  // pred: ^bb81
