    ...
    func.func public @kernel_cutlass_kernel_tensorop_gemmTensorOpGemm_object_at__tensorptrf16gmemalign32o51212816128165536_tensorptrf16gmemalign32o25612816128132768_tensorptrf16gmemalign32o512256162561131072_S_0(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f16_1, %arg2: !memref_gmem_f16_2, %arg3: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %71 {
        ...
        scf.for %arg4 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
          ...
          %coord_160 = cute.make_coord(%e0_157) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
          %215 = cute.get_scalars(%coord_160) : !cute.coord<"?">
          %216 = arith.cmpi slt, %215, %116 : i32
          %217 = arith.extui %216 : i1 to i8
          %coord_161 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(0,?,0)">
          %dyn_162 = cute.derefine(%coord_161) : !cute.coord<"(0,?,0)"> to !cute.coord<"(?,?,0)">
          cute.memref.store(%rmem_70, %dyn_162, %217) : (!memref_rmem_i8_, !cute.coord<"(?,?,0)">, i8) -> ()
        }
        ...
        scf.if %119 {
          ...
          %215 = cute.get_scalars(%36) : !cute.int_tuple<"4">
          scf.for %arg4 = %c0_i32 to %215 step %c1_i32  : i32 {
            ...
            %216 = builtin.unrealized_conversion_cast %ptr_161 : !cute.ptr<i8, rmem> to !llvm.ptr
            ...
            cute_nvgpu.arch.copy.SM80.cp_async(%iter_163 : !cute.ptr<i128, smem>, %iter_162 : !cute.ptr<i128, gmem>, %218 : i1) {cache_mode = <global>}
        ...
        scf.for %arg4 = %c0_i32 to %122 step %c1_i32  : i32 {
          ...
          %215 = builtin.unrealized_conversion_cast %ptr_160 : !cute.ptr<i8, rmem> to !llvm.ptr
          ...
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_162 : !cute.ptr<i128, smem>, %iter_161 : !cute.ptr<i128, gmem>, %217 : i1) {cache_mode = <global>}
        } {llvm.loop_annotation = #loop_annotation}
        ...
        cute.memref.store_vec %cst, %rmem_101, row_major : !memref_rmem_f32_
        ...
        %198 = builtin.unrealized_conversion_cast %view_119 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
        %199 = cute.get_scalars(%lay_114) <{only_dynamic}> : !cute.layout<"((8,1),4,2,(1,3)):((1,0),1024,?{div=16},(0,4096))">
        %iv_120 = cute.assume(%199) : (i32) -> !cute.i32<divby 16>
        ...
        %200 = builtin.unrealized_conversion_cast %view_123 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
        ...
        scf.for %arg4 = %c0_i32 to %122 step %c1_i32  : i32 {
          ...
          %215 = cute_nvgpu.arch.copy.ldsm %ptr_156{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32} : <f16, smem, align<16>> -> vector<4xi32>
          %216 = vector.extractelement %215[%27 : i32] : vector<4xi32>
          %217 = builtin.unrealized_conversion_cast %ptr_158 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          llvm.store %216, %217 : i32, !llvm.ptr
          %218 = vector.extractelement %215[%26 : i32] : vector<4xi32>
          %ptr_159 = cute.add_offset(%ptr_158, %25) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
          %219 = builtin.unrealized_conversion_cast %ptr_159 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          llvm.store %218, %219 : i32, !llvm.ptr
          %220 = vector.extractelement %215[%24 : i32] : vector<4xi32>
          %ptr_160 = cute.add_offset(%ptr_158, %36) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
          %221 = builtin.unrealized_conversion_cast %ptr_160 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
          llvm.store %220, %221 : i32, !llvm.ptr
          %222 = vector.extractelement %215[%23 : i32] : vector<4xi32>
          %ptr_161 = cute.add_offset(%ptr_158, %22) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
          %223 = builtin.unrealized_conversion_cast %ptr_161 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
        ...
        scf.for %arg4 = %c0_i32 to %122 step %c1_i32  : i32 {
          ...
          %215 = cute_nvgpu.arch.copy.ldsm %ptr_156{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32} : <f16, smem, align<16>> -> vector<4xi32>
          %216 = vector.extractelement %215[%27 : i32] : vector<4xi32>
          %217 = builtin.unrealized_conversion_cast %ptr_158 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
          llvm.store %216, %217 : i32, !llvm.ptr
          %218 = vector.extractelement %215[%26 : i32] : vector<4xi32>
        ...
        %201 = cute.get_scalars(%15) : !cute.int_tuple<"1">
        %202 = cute.get_scalars(%14) : !cute.int_tuple<"8">
        %203:5 = scf.for %arg4 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg5 = %198, %arg6 = %200, %arg7 = %c2_i32, %arg8 = %c2_i32, %arg9 = %c0_i32) -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32)  : i32 {
          %215:5 = scf.for %arg10 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg11 = %arg5, %arg12 = %arg6, %arg13 = %arg7, %arg14 = %arg8, %arg15 = %arg9) -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32)  : i32 {
            %216 = arith.cmpi eq, %arg10, %c1_i32 : i32
            %217:2 = scf.if %216 -> (!llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>) {
              ...
              %225 = builtin.unrealized_conversion_cast %view_174 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
              ...
              %226 = builtin.unrealized_conversion_cast %view_177 : !memref_smem_f16_1 to !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
              nvvm.cp.async.wait.group 1
              nvvm.barrier
              scf.yield %225, %226 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
            } else {
              scf.yield %arg11, %arg12 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>
            }
            %218 = builtin.unrealized_conversion_cast %217#1 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)> to !memref_smem_f16_1
            %219 = builtin.unrealized_conversion_cast %217#0 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)> to !memref_smem_f16_1
            %220 = arith.addi %arg10, %c1_i32 : i32
            %221 = arith.remsi %220, %c2_i32 : i32
            %coord_154 = cute.make_coord(%221) : (i32) -> !cute.coord<"(_,_,?)">
            %lay_155 = cute.get_layout(%219) : !memref_smem_f16_1
            %idx_156 = cute.crd2idx(%coord_154, %lay_155) : (!cute.coord<"(_,_,?)">, !cute.layout<"((8,1),4,2):((1,0),1024,?{div=16})">) -> !cute.int_tuple<"?{div=16}">
            %iter_157 = cute.get_iter(%219) : !memref_smem_f16_1
            ...
            scf.for %arg16 = %c0_i32 to %122 step %c1_i32  : i32 {
              ...
              %225 = cute_nvgpu.arch.copy.ldsm %ptr_173{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32} : <f16, smem, align<16>> -> vector<4xi32>
              %226 = vector.extractelement %225[%27 : i32] : vector<4xi32>
              %227 = builtin.unrealized_conversion_cast %ptr_175 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              llvm.store %226, %227 : i32, !llvm.ptr
              %228 = vector.extractelement %225[%26 : i32] : vector<4xi32>
              %ptr_176 = cute.add_offset(%ptr_175, %25) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
              %229 = builtin.unrealized_conversion_cast %ptr_176 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %228, %229 : i32, !llvm.ptr
              %230 = vector.extractelement %225[%24 : i32] : vector<4xi32>
              %ptr_177 = cute.add_offset(%ptr_175, %36) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
              %231 = builtin.unrealized_conversion_cast %ptr_177 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %230, %231 : i32, !llvm.ptr
              %232 = vector.extractelement %225[%23 : i32] : vector<4xi32>
              %ptr_178 = cute.add_offset(%ptr_175, %22) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
              %233 = builtin.unrealized_conversion_cast %ptr_178 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %232, %233 : i32, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %lay_161 = cute.get_layout(%218) : !memref_smem_f16_1
            %idx_162 = cute.crd2idx(%coord_154, %lay_161) : (!cute.coord<"(_,_,?)">, !cute.layout<"((8,1),4,2):((1,0),1024,?{div=16})">) -> !cute.int_tuple<"?{div=16}">
            %iter_163 = cute.get_iter(%218) : !memref_smem_f16_1
            ...
            scf.for %arg16 = %c0_i32 to %122 step %c1_i32  : i32 {
              ...
              %225 = cute_nvgpu.arch.copy.ldsm %ptr_173{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32} : <f16, smem, align<16>> -> vector<4xi32>
              %226 = vector.extractelement %225[%27 : i32] : vector<4xi32>
              %227 = builtin.unrealized_conversion_cast %ptr_175 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %226, %227 : i32, !llvm.ptr
              %228 = vector.extractelement %225[%26 : i32] : vector<4xi32>
            ...
            %222 = arith.cmpi eq, %arg10, %c0_i32 : i32
            scf.if %222 {
              %225 = arith.addi %arg4, %c2_i32 : i32
              %226 = arith.cmpi slt, %225, %c4_i32 : i32
              scf.if %226 {
            ...
            scf.for %arg16 = %c0_i32 to %201 step %c1_i32  : i32 {
              scf.for %arg17 = %c0_i32 to %122 step %c1_i32  : i32 {
                ...
                %225 = builtin.unrealized_conversion_cast %ptr_173 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
                %226 = llvm.getelementptr %225[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %227 = llvm.getelementptr %225[2] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %228 = llvm.getelementptr %225[3] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                scf.for %arg18 = %c0_i32 to %202 step %c1_i32  : i32 {
                  ...
                  %233 = builtin.unrealized_conversion_cast %ptr_177 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
                  %234 = llvm.load %233 : !llvm.ptr -> vector<2xf16>
                  %235 = llvm.getelementptr %233[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                  %236 = llvm.load %235 : !llvm.ptr -> vector<2xf16>
                  %237 = builtin.unrealized_conversion_cast %ptr_179 : !cute.ptr<f32, rmem, align<16>> to !llvm.ptr
                  %238 = llvm.load %237 : !llvm.ptr -> f32
                  %239 = llvm.getelementptr %237[1] : (!llvm.ptr) -> !llvm.ptr, f32
                  %240 = llvm.load %239 : !llvm.ptr -> f32
                  %241 = llvm.getelementptr %237[2] : (!llvm.ptr) -> !llvm.ptr, f32
                  %242 = llvm.load %241 : !llvm.ptr -> f32
                  %243 = llvm.getelementptr %237[3] : (!llvm.ptr) -> !llvm.ptr, f32
                  %244 = llvm.load %243 : !llvm.ptr -> f32
                  %245:4 = cute_nvgpu.arch.mma.SM80 A[%229, %230, %231, %232]  B[%234, %236]  C[%238, %240, %242, %244] < {a_type = f16, b_type = f16, shape_MNK = #cute.shape<"(16,8,16)">}> : (vector<2xf16>, vector<2xf16>, f32) -> (f32, f32, f32, f32)
                  llvm.store %245#0, %237 : f32, !llvm.ptr
                  llvm.store %245#1, %239 : f32, !llvm.ptr
                  llvm.store %245#2, %241 : f32, !llvm.ptr
                  llvm.store %245#3, %243 : f32, !llvm.ptr
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %223 = arith.select %222, %arg15, %arg14 : i32
            %224:2 = scf.if %222 -> (i32, i32) {
              %225 = arith.addi %arg4, %c2_i32 : i32
              %226 = arith.cmpi slt, %225, %c4_i32 : i32
              scf.if %226 {
                %coord_171 = cute.make_coord(%arg13) : (i32) -> !cute.coord<"(_,_,_,?)">
                ...
                scf.for %arg16 = %c0_i32 to %122 step %c1_i32  : i32 {
                  ...
                  %231 = builtin.unrealized_conversion_cast %ptr_183 : !cute.ptr<i8, rmem> to !llvm.ptr
                  %232 = llvm.load %231 : !llvm.ptr -> i8
                  %233 = llvm.trunc %232 : i8 to i1
                  %iter_184 = cute.recast_iter(%ptr_179) : !cute.ptr<f16, gmem, align<16>> to !cute.ptr<i128, gmem>
                  %iter_185 = cute.recast_iter(%ptr_181) : !cute.ptr<f16, smem, align<16>> to !cute.ptr<i128, smem>
                  cute_nvgpu.arch.copy.SM80.cp_async(%iter_185 : !cute.ptr<i128, smem>, %iter_184 : !cute.ptr<i128, gmem>, %233 : i1) {cache_mode = <global>}
                } {llvm.loop_annotation = #loop_annotation}
              }
              %227 = arith.addi %arg13, %c1_i32 : i32
              nvvm.cp.async.commit.group
              %228 = arith.addi %arg15, %c1_i32 : i32
              %229 = arith.cmpi eq, %228, %c3_i32 : i32
              %230 = arith.select %229, %c0_i32, %228 : i32
              scf.yield %227, %230 : i32, i32
            } else {
              scf.yield %arg13, %arg15 : i32, i32
            }
            scf.yield %217#0, %217#1, %224#0, %223, %224#1 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          scf.yield %215#0, %215#1, %215#2, %215#3, %215#4 : !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, i32)>)>, i32, i32, i32
        }
        nvvm.cp.async.wait.group 0
        nvvm.barrier
        %rmem_125 = cute.memref.alloca() : !memref_rmem_f16_2
        %204 = cute.memref.load_vec %rmem_101, row_major : !memref_rmem_f32_
        %205 = arith.truncf %204 : vector<128xf32> to vector<128xf16>
        %iter_126 = cute.get_iter(%rmem_125) : !memref_rmem_f16_2
        %view_127 = cute.make_view(%iter_126) : !memref_rmem_f16_2
        cute.memref.store_vec %205, %view_127, row_major : !memref_rmem_f16_2
        %206:2 = cute.get_scalars(%lay) <{only_dynamic}> : !cute.layout<"((2,2),4,(2,2,2)):((1,1024),4096,(?{div=16},?{div=32},64))">
        %iv_128 = cute.assume(%206#0) : (i32) -> !cute.i32<divby 16>
        %iv_129 = cute.assume(%206#1) : (i32) -> !cute.i32<divby 32>
        ...
        %207:2 = cute.get_scalars(%lay_131) <{only_dynamic}> : !cute.layout<"(2,(2,4,2,2,2)):(1,(1024,4096,?{div=16},?{div=32},64))">
        %iv_132 = cute.assume(%207#0) : (i32) -> !cute.i32<divby 16>
        %iv_133 = cute.assume(%207#1) : (i32) -> !cute.i32<divby 32>
        ...
        %208:2 = cute.get_scalars(%append) <{only_dynamic}> : !cute.layout<"(2,(2,4,2,2,2)):(1,(1024,4096,?{div=16},?{div=32},64))">
        %iv_136 = cute.assume(%208#0) : (i32) -> !cute.i32<divby 16>
        %iv_137 = cute.assume(%208#1) : (i32) -> !cute.i32<divby 32>
        ...
        %209 = cute.get_scalars(%10) : !cute.int_tuple<"64">
        scf.for %arg4 = %c0_i32 to %209 step %c1_i32  : i32 {
          %coord_154 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(_,?)">
          ...
          %215 = builtin.unrealized_conversion_cast %ptr_156 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          %216 = builtin.unrealized_conversion_cast %ptr_158 : !cute.ptr<f16, smem, align<4>> to !llvm.ptr<3>
          %217 = llvm.load %215 {alignment = 4 : i64} : !llvm.ptr -> vector<2xf16>
          llvm.store %217, %216 {alignment = 4 : i64} : vector<2xf16>, !llvm.ptr<3>
        } {llvm.loop_annotation = #loop_annotation}
        ...
        %210 = cute.get_scalars(%5) : !cute.int_tuple<"16">
        scf.for %arg4 = %c0_i32 to %210 step %c1_i32  : i32 {
          ...
          %215 = builtin.unrealized_conversion_cast %ptr_156 : !cute.ptr<f16, smem, align<16>> to !llvm.ptr<3>
          %216 = builtin.unrealized_conversion_cast %ptr_158 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          %217 = llvm.load %215 {alignment = 16 : i64} : !llvm.ptr<3> -> vector<8xf16>
          llvm.store %217, %216 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %rmem_149 = cute.memref.alloca() : !memref_rmem_i8_1
        %211 = cute.get_scalars(%42) : !cute.coord<"512">
        scf.for %arg4 = %c0_i32 to %c16_i32 step %c1_i32  : i32 {
          ...
          %coord_160 = cute.make_coord(%e0_157) : (!cute.int_tuple<"?">) -> !cute.coord<"?">
          %215 = cute.get_scalars(%coord_160) : !cute.coord<"?">
          %216 = arith.cmpi slt, %215, %211 : i32
          %217 = arith.extui %216 : i1 to i8
          %coord_161 = cute.make_coord(%arg4) : (i32) -> !cute.coord<"(0,?,0)">
          %dyn_162 = cute.derefine(%coord_161) : !cute.coord<"(0,?,0)"> to !cute.coord<"(?,?,0)">
          cute.memref.store(%rmem_149, %dyn_162, %217) : (!memref_rmem_i8_1, !cute.coord<"(?,?,0)">, i8) -> ()
        }
        ...
        %212 = cute.get_scalars(%coord_153) : !cute.coord<"?{div=8}">
        %213 = cute.get_scalars(%41) : !cute.coord<"256">
        %214 = arith.cmpi slt, %212, %213 : i32
        scf.if %214 {
          ...
          scf.for %arg4 = %c0_i32 to %210 step %c1_i32  : i32 {
            ...
            %ptr_161 = cute.add_offset(%iter_154, %idx_160) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i8, rmem>
            %215 = builtin.unrealized_conversion_cast %ptr_161 : !cute.ptr<i8, rmem> to !llvm.ptr
            %216 = llvm.load %215 : !llvm.ptr -> i8
            %217 = llvm.icmp "ne" %216, %0 : i8
            scf.if %217 {
              %218 = builtin.unrealized_conversion_cast %ptr_157 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              %219 = builtin.unrealized_conversion_cast %ptr_159 : !cute.ptr<f16, gmem, align<16>> to !llvm.ptr<1>
              %220 = llvm.load %218 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %220, %219 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<1>
            }
          } {llvm.loop_annotation = #loop_annotation}
        }
      }
