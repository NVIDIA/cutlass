...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb7:  // pred: ^bb6
      ...
      cf.br ^bb6(%136 : i32)
    ^bb8:  // pred: ^bb6
      cute.memref.store_vec %cst_0, %view_53 : !memref_smem_f16_
      cute.memref.store_vec %cst_0, %view_56 : !memref_smem_f16_
      nvvm.barrier
    ...
    ^bb24:  // pred: ^bb22
      ...
      cute.memref.store_vec %cst, %rmem_158 : !memref_rmem_f32_
    ...
    ^bb71:  // pred: ^bb31
      ...
      %376 = cute.memref.load_vec %rmem_158 : !memref_rmem_f32_
      ...
      cute.memref.store_vec %377, %view_279 : !memref_rmem_f16_2
