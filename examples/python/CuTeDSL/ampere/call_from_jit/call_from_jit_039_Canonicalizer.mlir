...
module attributes {gpu.container_module} {
  gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_90a">] {
    ...
    ^bb71(%553: i32):  // 2 preds: ^bb70, ^bb72
      ...
      llvm.cond_br %554, ^bb72, ^bb73 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
    ...
    ^bb74(%579: i32):  // 2 preds: ^bb73, ^bb75
      ...
      llvm.cond_br %580, ^bb75, ^bb76 {llvm.loop_annotation = #loop_annotation}
    ^bb75:  // pred: ^bb74
    ...
    ^bb81(%600: i32):  // 2 preds: ^bb80, ^bb84
      ...
      llvm.cond_br %601, ^bb82, ^bb85 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
  ...
  llvm.func @cutlass_tensor_op_gemm_wrapper___main__BufferWithLayoutobjectat___main__BufferWithLayoutobjectat___main__BufferWithLayoutobjectat_512_256_128_16_Float32_2_2_1(%arg0: !llvm.ptr<1> {llvm.align = 32 : i64}, %arg1: !llvm.ptr<1> {llvm.align = 32 : i64}, %arg2: !llvm.ptr<1> {llvm.align = 32 : i64}) attributes {llvm.emit_c_interface} {
    ...
    %8 = llvm.insertvalue %arg0, %0[0] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    %9 = llvm.insertvalue %1, %8[1] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    %10 = llvm.insertvalue %arg1, %0[0] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    %11 = llvm.insertvalue %1, %10[1] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    %12 = llvm.insertvalue %arg2, %0[0] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    %13 = llvm.insertvalue %1, %12[1] : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)> 
    gpu.launch_func  @kernels::@kernel_cutlass_kernel_tensorop_gemmTensorOpGemm_object_at__tensorptrf16gmemalign32o51212816128165536_tensorptrf16gmemalign32o25612816128132768_tensorptrf16gmemalign32o512256162561131072_S_0 blocks in (%7, %5, %3) threads in (%4, %5, %5) : i64 dynamic_shared_memory_size %6 args(%9 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %11 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %13 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %2 : i32) {use_pdl = false}
    llvm.return
  }
