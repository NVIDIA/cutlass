...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel_05_tensorptrf32gmemo8441_10_tensorptrf32gmemo8221_20_tensorptrf32gmemo16221_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f32_1, %arg2: !memref_gmem_f32_2) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 1, 1, 1>} {
      ...
      cute.memref.store_vec %19, %view_6, row_major : !memref_smem_f32_1
      ...
      %54 = cute.memref.load_vec %view_6, row_major : !memref_smem_f32_1
      cute.memref.store_vec %54, %arg0, row_major : !memref_gmem_f32_
      ...
      cute.memref.store_vec %56, %view_9, row_major : !memref_smem_f32_2
      ...
      %76 = cute.memref.load_vec %view_9, row_major : !memref_smem_f32_2
      cute.memref.store_vec %76, %arg1, row_major : !memref_gmem_f32_1
      %cst_12 = arith.constant 2.000000e+00 : f32
      %77 = vector.splat %cst_12 : vector<32xf32>
      cute.memref.store_vec %77, %view, row_major : !memref_smem_f32_
      ...
      %112 = cute.memref.load_vec %view, row_major : !memref_smem_f32_
      cute.memref.store_vec %112, %arg2, row_major : !memref_gmem_f32_2
      return
    }
  }
