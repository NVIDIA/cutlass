...
module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass___call_____main__GroupedGemmKernel_object_at__Tensorgmemoi641i64_Tensorgmemoi641i64_Tensorgmemoi641i64_2_Tensorgmemo2441_Tensorgmemo232621_Tensorgmemo2331_2_Tensorgmemo1316(%arg0: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg1: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg2: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg3: !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg4: !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg5: !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg6: !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg7: !llvm.ptr) attributes {llvm.emit_c_interface} {
    ...
    %5 = llvm.mlir.undef : !llvm.struct<(struct<(array<16 x i64>)>)>
    %6 = llvm.mlir.undef : !llvm.struct<(i1, i1, i1)>
    ...
    %28 = llvm.mlir.constant(192 : index) : i64
    %29 = llvm.mlir.constant(230400 : i32) : i32
    %30 = llvm.mlir.constant(287522 : i64) : i64
    %31 = llvm.mlir.constant(4539628424389459968 : i64) : i64
    %32 = llvm.mlir.constant(127 : i64) : i64
    %33 = llvm.mlir.constant(279330 : i64) : i64
    %34 = llvm.mlir.constant(2233785415175766016 : i64) : i64
    %35 = builtin.unrealized_conversion_cast %0 : !memref_gmem_f16_ to !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>
    %36 = builtin.unrealized_conversion_cast %1 : !memref_gmem_f16_ to !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>
    %37 = builtin.unrealized_conversion_cast %2 : !memref_gmem_f16_ to !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>
    %38 = llvm.insertvalue %7, %6[0] : !llvm.struct<(i1, i1, i1)> 
    %39 = llvm.insertvalue %7, %38[1] : !llvm.struct<(i1, i1, i1)> 
    %40 = llvm.insertvalue %7, %39[2] : !llvm.struct<(i1, i1, i1)> 
    %41 = llvm.alloca %8 x i64 {alignment = 64 : i64} : (i32) -> !llvm.ptr
    ...
    %131 = llvm.insertvalue %130, %5[0] : !llvm.struct<(struct<(array<16 x i64>)>)> 
    %132 = llvm.extractvalue %43[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)> 
    %133 = llvm.insertvalue %132, %4[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %134 = llvm.insertvalue %24, %133[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %135 = llvm.insertvalue %24, %3[0] : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)> 
    %136 = llvm.insertvalue %134, %135[1] : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)> 
    %137 = llvm.alloca %8 x i64 {alignment = 64 : i64} : (i32) -> !llvm.ptr
    ...
    %211 = llvm.insertvalue %210, %5[0] : !llvm.struct<(struct<(array<16 x i64>)>)> 
    %212 = llvm.extractvalue %139[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)> 
    %213 = llvm.insertvalue %212, %4[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %214 = llvm.insertvalue %24, %213[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %215 = llvm.insertvalue %214, %135[1] : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)> 
    %216 = llvm.alloca %8 x i64 {alignment = 64 : i64} : (i32) -> !llvm.ptr
    %217 = llvm.extractvalue %35[0] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)> 
    %218 = llvm.extractvalue %35[1] : !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)> 
    ...
    %291 = llvm.insertvalue %290, %5[0] : !llvm.struct<(struct<(array<16 x i64>)>)> 
    %292 = llvm.extractvalue %218[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)> 
    %293 = llvm.insertvalue %292, %4[0] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %294 = llvm.insertvalue %24, %293[1] : !llvm.struct<(struct<(i32, i32, i32)>, struct<()>)> 
    %295 = llvm.insertvalue %294, %135[1] : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)> 
    %296 = llvm.icmp "slt" %25, %26 : i32
    %297 = llvm.select %296, %25, %26 : i1, i32
    %298 = llvm.sext %297 : i32 to i64
    gpu.launch_func <%arg7 : !llvm.ptr> @kernels::@kernel_cutlass_kernel___main__GroupedGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK12812816_TVLayoutA1128161281128_TVLayoutB1128161281128__0 clusters in (%27, %27, %27) blocks in (%27, %27, %298) threads in (%28, %27, %27) : i64 dynamic_shared_memory_size %29 args(%40 : !llvm.struct<(i1, i1, i1)>, %131 : !llvm.struct<(struct<(array<16 x i64>)>)>, %136 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %211 : !llvm.struct<(struct<(array<16 x i64>)>)>, %215 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %291 : !llvm.struct<(struct<(array<16 x i64>)>)>, %295 : !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %25 : i32, %arg3 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg4 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg5 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>, %arg6 : !llvm.struct<(ptr<1>, struct<(struct<()>, struct<()>)>)>) {use_pdl = false}
    llvm.return
  }
