        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: !mma_f16_f16_f32_128x128x16_, %arg17: i32, %arg18: i32):
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32):
            ...
            %138 = scf.if %137 -> (i32) {
              ...
              %161 = builtin.unrealized_conversion_cast %ptr_87 : !cute.ptr<i32, gmem, align<16>> to !llvm.ptr<1>
              %162 = builtin.unrealized_conversion_cast %iter_88 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
              scf.for %arg22 = %c0_i32 to %160 step %c1_i32  : i32 {
                %170 = llvm.load %161 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
                llvm.store %170, %162 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %163 = cute.memref.load(%rmem_83, %18) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %164 = arith.addi %163, %c127_i32 : i32
              %165 = arith.floordivsi %164, %c128_i32 : i32
              %166 = cute.memref.load(%rmem_83, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
              %167 = arith.addi %166, %c127_i32 : i32
              %168 = arith.floordivsi %167, %c128_i32 : i32
              %169 = arith.muli %165, %168 : i32
              scf.yield %169 : i32
            } else {
              scf.yield %c0_i32 : i32
            }
            ...
            %140 = scf.if %98 -> (i32) {
              %160 = arith.addi %138, %139 : i32
              scf.yield %160 : i32
            } else {
              scf.yield %138 : i32
            }
            %141 = nvvm.shfl.sync  up %c-1_i32, %140, %c2_i32, %c0_i32 : i32 -> i32
            %142 = scf.if %99 -> (i32) {
              %160 = arith.addi %140, %141 : i32
              scf.yield %160 : i32
            } else {
              scf.yield %140 : i32
            }
            %143 = nvvm.shfl.sync  up %c-1_i32, %142, %c4_i32, %c0_i32 : i32 -> i32
            %144 = scf.if %100 -> (i32) {
            ...
            %145 = nvvm.shfl.sync  up %c-1_i32, %144, %c8_i32, %c0_i32 : i32 -> i32
            %146 = scf.if %101 -> (i32) {
              %160 = arith.addi %144, %145 : i32
              scf.yield %160 : i32
            } else {
              scf.yield %144 : i32
            }
            %147 = nvvm.shfl.sync  up %c-1_i32, %146, %c16_i32, %c0_i32 : i32 -> i32
            %148 = scf.if %102 -> (i32) {
              %160 = arith.addi %146, %147 : i32
              scf.yield %160 : i32
            } else {
              scf.yield %146 : i32
            }
          ...
          scf.for %arg19 = %c0_i32 to %103 step %c1_i32  : i32 {
            %136 = llvm.load %107 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %136, %108 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          %121 = scf.if %118 -> (i1) {
            %136 = builtin.unrealized_conversion_cast %ptr_75 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %137 = nvvm.mbarrier.wait.parity %136, %120 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %137 : i1
          } else {
            scf.yield %true : i1
          }
          ...
          %127 = arith.addi %arg12, %c1_i32 : i32
          %128 = arith.remsi %127, %c6_i32 : i32
          %129:5 = scf.for %arg19 = %c0_i32 to %111 step %c1_i32 iter_args(%arg20 = %121, %arg21 = %114, %arg22 = %120, %arg23 = %126, %arg24 = %128) -> (i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32)  : i32 {
            %136 = arith.addi %arg19, %c1_i32 : i32
            %137 = arith.cmpi eq, %arg24, %c0_i32 : i32
            ...
            scf.if %141 {
              ...
              %152 = builtin.unrealized_conversion_cast %ptr_86 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %152, %arg22, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            %142 = scf.for %arg25 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg26 = %arg23) -> (!mma_f16_f16_f32_128x128x16_)  : i32 {
              ...
              %152 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
              %153 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
              %154 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
              %155 = arith.extui %152 : i1 to i32
              %156 = arith.extui %153 : i1 to i32
              %157 = arith.shli %155, %c13_i32 : i32
              %158 = arith.shli %156, %c14_i32 : i32
              %159 = arith.ori %157, %c136314896_i32 : i32
              %160 = arith.ori %159, %158 : i32
              scf.for %arg27 = %c0_i32 to %103 step %c1_i32  : i32 {
                scf.for %arg28 = %c0_i32 to %103 step %c1_i32  : i32 {
                  scf.for %arg29 = %c0_i32 to %103 step %c1_i32  : i32 {
                    cute_nvgpu.arch.mma.SM100.umma(%tup, %tup_87, %ptr_73, %160, %154) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                  } {llvm.loop_annotation = #loop_annotation}
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
              %161 = cute_nvgpu.atom.set_value(%arg26, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x128x16_
              scf.yield %161 : !mma_f16_f16_f32_128x128x16_
            ...
            scf.if %143 {
              ...
              %152 = builtin.unrealized_conversion_cast %ptr_86 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %152 : !llvm.ptr<3>
            }
            %144 = arith.cmpi slt, %136, %111 : i32
            ...
            %148 = scf.if %147 -> (i1) {
              %152 = builtin.unrealized_conversion_cast %ptr_84 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %153 = nvvm.mbarrier.wait.parity %152, %139 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %153 : i1
            } else {
              scf.yield %true : i1
            }
            %149 = arith.addi %arg24, %c1_i32 : i32
            %150 = arith.cmpi eq, %149, %c6_i32 : i32
            %151 = arith.select %150, %c0_i32, %149 : i32
            scf.yield %148, %arg24, %139, %142, %151 : i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32
          }
          ...
          scf.if %130 {
            ...
            %136 = builtin.unrealized_conversion_cast %ptr_83 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %136 : !llvm.ptr<3>
          }
          %131 = arith.addi %arg17, %92 : i32
          %132 = arith.addi %arg18, %c1_i32 : i32
          %133 = arith.cmpi sgt, %93, %131 : i32
          %134 = cute.get_hier_coord(%131, %lay) : (i32, !cute.layout<"(1,1,?):(0,0,1)">) -> !cute.coord<"(0,0,?)">
          %e0_78, %e1_79, %e2_80 = cute.get_leaves(%134) : !cute.coord<"(0,0,?)">
          ...
          %135 = cute.get_scalars(%mul_82) : !cute.int_tuple<"?">
          scf.yield %113, %135, %133, %106#0, %106#1, %129#3, %131, %132 : i32, i32, i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32, i32
        }
      }
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32):
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32):
            ...
            %152 = scf.if %151 -> (i32) {
              ...
              %174 = cute.get_scalars(%38) : !cute.int_tuple<"1">
              %175 = builtin.unrealized_conversion_cast %ptr_132 : !cute.ptr<i32, gmem, align<16>> to !llvm.ptr<1>
              %176 = builtin.unrealized_conversion_cast %iter_133 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
              scf.for %arg22 = %c0_i32 to %174 step %c1_i32  : i32 {
                %184 = llvm.load %175 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
                llvm.store %184, %176 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %177 = cute.memref.load(%rmem_128, %18) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %178 = arith.addi %177, %c127_i32 : i32
              %179 = arith.floordivsi %178, %c128_i32 : i32
              %180 = cute.memref.load(%rmem_128, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
              %181 = arith.addi %180, %c127_i32 : i32
              %182 = arith.floordivsi %181, %c128_i32 : i32
              %183 = arith.muli %179, %182 : i32
              scf.yield %183 : i32
            } else {
              scf.yield %c0_i32 : i32
            }
            %153 = nvvm.shfl.sync  up %c-1_i32, %152, %c1_i32, %c0_i32 : i32 -> i32
            %154 = scf.if %110 -> (i32) {
              %174 = arith.addi %152, %153 : i32
              scf.yield %174 : i32
            } else {
              scf.yield %152 : i32
            }
            %155 = nvvm.shfl.sync  up %c-1_i32, %154, %c2_i32, %c0_i32 : i32 -> i32
            %156 = scf.if %111 -> (i32) {
              %174 = arith.addi %154, %155 : i32
              scf.yield %174 : i32
            } else {
              scf.yield %154 : i32
            }
            %157 = nvvm.shfl.sync  up %c-1_i32, %156, %c4_i32, %c0_i32 : i32 -> i32
            %158 = scf.if %112 -> (i32) {
              %174 = arith.addi %156, %157 : i32
              scf.yield %174 : i32
            } else {
              scf.yield %156 : i32
            }
            %159 = nvvm.shfl.sync  up %c-1_i32, %158, %c8_i32, %c0_i32 : i32 -> i32
            %160 = scf.if %113 -> (i32) {
              %174 = arith.addi %158, %159 : i32
              scf.yield %174 : i32
            } else {
              scf.yield %158 : i32
            }
            %161 = nvvm.shfl.sync  up %c-1_i32, %160, %c16_i32, %c0_i32 : i32 -> i32
            %162 = scf.if %114 -> (i32) {
              %174 = arith.addi %160, %161 : i32
              scf.yield %174 : i32
            } else {
              scf.yield %160 : i32
            }
            %163 = arith.addi %162, %arg21 : i32
            %164 = arith.cmpi sge, %arg13, %163 : i32
            %165 = nvvm.vote.ballot.sync %c-1_i32, %164 : i32
            %166 = llvm.intr.ctpop(%165) : (i32) -> i32
            %167 = arith.cmpi eq, %166, %c32_i32 : i32
            %168 = arith.addi %166, %arg19 : i32
            %169 = arith.cmpi eq, %166, %c0_i32 : i32
            %170 = arith.cmpi eq, %169, %false : i1
            %171 = scf.if %170 -> (i32) {
              %174 = arith.subi %166, %c1_i32 : i32
              %175 = nvvm.shfl.sync  idx %c-1_i32, %163, %174, %c31_i32 : i32 -> i32
              scf.yield %175 : i32
            } else {
              scf.yield %arg21 : i32
            }
            %172 = arith.select %167, %c31_i32, %166 : i32
            %173 = nvvm.shfl.sync  idx %c-1_i32, %163, %172, %c31_i32 : i32 -> i32
            scf.yield %167, %168, %171, %173 : i1, i32, i32, i32
          }
          ...
          scf.for %arg19 = %c0_i32 to %115 step %c1_i32  : i32 {
            %150 = llvm.load %124 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %150, %125 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          scf.if %135 {
            ...
            %150 = cute.memref.load(%arg10, %coord_128) : (!memref_gmem_i64_, !cute.coord<"(?,2)">) -> i64
            %iv_129 = cute.assume(%150) : (i64) -> !cute.i64<divby 16>
            %151 = cute.inttoptr(%iv_129) : !cute.i64<divby 16> to !cute.ptr<f16, gmem, align<16>>
            ...
            %152 = builtin.unrealized_conversion_cast %ptr_133 : !cute.ptr<i32, gmem, align<8>> to !llvm.ptr<1>
            %153 = builtin.unrealized_conversion_cast %iter_135 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
            scf.for %arg19 = %c0_i32 to %115 step %c1_i32  : i32 {
              %156 = llvm.load %152 {alignment = 8 : i64} : !llvm.ptr<1> -> vector<2xi32>
              llvm.store %156, %153 {alignment = 8 : i64} : vector<2xi32>, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %154 = cute.memref.load(%rmem_134, %18) : (!memref_rmem_i32_1, !cute.coord<"0">) -> i32
            %155 = cute.memref.load(%rmem_134, %16) : (!memref_rmem_i32_1, !cute.coord<"1">) -> i32
            %shape_136 = cute.make_shape(%127, %128) : (i32, i32) -> !cute.shape<"(?,?,1)">
            %stride = cute.make_stride(%154, %155) : (i32, i32) -> !cute.stride<"(?,?,0)">
            %lay_137 = cute.make_layout(%shape_136, %stride) : !cute.layout<"(?,?,1):(?,?,0)">
            %view_138 = cute.make_view(%151, %lay_137) : !memref_gmem_f16_
            ...
            scf.if %56 {
              ...
              nvvm.bar.warp.sync %c-1_i32 : i32
              %157 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              %158 = cute.ptrtoint(%dyn) : !cute.ptr<i64, smem, align<128>> to i32
              llvm.inline_asm has_side_effects asm_dialect = att "tensormap.cp_fenceproxy.global.shared::cta.tensormap::generic.release.gpu.sync.aligned [$0], [$1], 128;", "l,r" %157, %158 : (i64, i32) -> ()
            }
          }
          ...
          scf.if %135 {
            scf.if %56 {
              %150 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              llvm.inline_asm has_side_effects asm_dialect = att "fence.proxy.tensormap::generic.acquire.gpu [$0], 128;", "l" %150 : (i64) -> ()
            }
          }
          %141 = arith.muli %arg18, %c4_i32 : i32
          %142 = arith.remsi %141, %c4_i32 : i32
          %143 = scf.for %arg19 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg20 = %142) -> (i32)  : i32 {
            ...
            scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
              %159 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_130) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 32 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<32xi32>
              llvm.store %159, %116 : vector<32xi32>, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %150 = cute.memref.load_vec %view_85, row_major : !memref_rmem_f32_1
            %151 = arith.truncf %150 : vector<32xf32> to vector<32xf16>
            cute.memref.store_vec %151, %view, row_major : !memref_rmem_f16_1
            ...
            scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
              %159 = llvm.load %117 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %159, %152 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
            ...
            scf.if %56 {
              ...
              %159 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              %iv_146 = cute.assume(%159) : (i64) -> !cute.i64<divby 128>
              %160 = cute.inttoptr(%iv_146) : !cute.i64<divby 128> to !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>
              ...
              %161 = cute_nvgpu.atom.make_exec_tma(%arg5) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 65536, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %162 = cute_nvgpu.atom.set_value(%161, %160 : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>) {field = #cute_nvgpu.atom_copy_field_tmastore<tma_descriptor_ptr>} : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%162 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %163:3 = cute.get_scalars(%int_tuple_147) : !cute.int_tuple<"(?{div=32},?{div=128},0)">
              scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
                cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_139 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%163#0, %163#1, %163#2] : i32, i32, i32) mode = <tiled>
              } {llvm.loop_annotation = #loop_annotation}
              nvvm.cp.async.bulk.commit.group
              nvvm.cp.async.bulk.wait_group 3 {read}
            }
            nvvm.barrier id = %c2_i32 number_of_threads = %c128_i32
            %156 = arith.addi %arg20, %c1_i32 : i32
            %157 = arith.cmpi eq, %156, %c4_i32 : i32
            %158 = arith.select %157, %c0_i32, %156 : i32
            scf.yield %158 : i32
          }
          ...
          scf.if %144 {
            ...
            %150 = builtin.unrealized_conversion_cast %ptr_128 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %150, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
          }
          %145 = arith.addi %arg17, %104 : i32
          %146 = arith.addi %arg18, %c1_i32 : i32
          %147 = arith.cmpi sgt, %105, %145 : i32
          %148 = cute.get_hier_coord(%145, %lay) : (i32, !cute.layout<"(1,1,?):(0,0,1)">) -> !cute.coord<"(0,0,?)">
          %e0_123, %e1_124, %e2_125 = cute.get_leaves(%148) : !cute.coord<"(0,0,?)">
          ...
          %149 = cute.get_scalars(%mul_127) : !cute.int_tuple<"?">
          scf.yield %136, %149, %147, %123#0, %123#0, %123#1, %145, %146 : i32, i32, i1, i32, i32, i32, i32, i32
        }
        scf.if %56 {
