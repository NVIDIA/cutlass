gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb23(%207: i32):  // 2 preds: ^bb22, ^bb24
    ...
    llvm.cond_br %208, ^bb24, ^bb25 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb24:  // pred: ^bb23
  ...
  ^bb54(%268: i32):  // 2 preds: ^bb53, ^bb55
    ...
    llvm.cond_br %269, ^bb55, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb55:  // pred: ^bb54
  ...
  ^bb62(%344: i32):  // 2 preds: ^bb61, ^bb63
    ...
    llvm.cond_br %345, ^bb63, ^bb64 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb63:  // pred: ^bb62
  ...
  ^bb65(%371: i32):  // 2 preds: ^bb64, ^bb66
    ...
    llvm.cond_br %372, ^bb66, ^bb67 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb66:  // pred: ^bb65
  ...
  ^bb86(%453: i32, %454: i1, %455: i32, %456: i32, %457: i32):  // 2 preds: ^bb85, ^bb105
    ...
    llvm.cond_br %458, ^bb87, ^bb106 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb87:  // pred: ^bb86
  ...
  ^bb92(%474: i32):  // 2 preds: ^bb91, ^bb95
    ...
    llvm.cond_br %475, ^bb93, ^bb96 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb93:  // pred: ^bb92
  ...
  ^bb97(%479: i32):  // 2 preds: ^bb96, ^bb100
    ...
    llvm.cond_br %480, ^bb98, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb98:  // pred: ^bb97
  ...
  ^bb115(%572: i32):  // 2 preds: ^bb114, ^bb116
    ...
    llvm.cond_br %573, ^bb116, ^bb117 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb116:  // pred: ^bb115
  ...
  ^bb146(%633: i32):  // 2 preds: ^bb145, ^bb147
    ...
    llvm.cond_br %634, ^bb147, ^bb148 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb147:  // pred: ^bb146
  ...
  ^bb157(%699: i32, %700: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb156, ^bb169
    ...
    llvm.cond_br %701, ^bb158, ^bb170 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb158:  // pred: ^bb157
  ...
  ^bb159(%724: i32):  // 2 preds: ^bb158, ^bb168
    ...
    llvm.cond_br %725, ^bb160, ^bb169 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb160:  // pred: ^bb159
    llvm.br ^bb161(%19 : i32)
  ^bb161(%726: i32):  // 2 preds: ^bb160, ^bb167
    %727 = llvm.icmp "slt" %726, %45 : i32
    llvm.cond_br %727, ^bb162, ^bb168 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb162:  // pred: ^bb161
    llvm.br ^bb163(%19 : i32)
  ^bb163(%728: i32):  // 2 preds: ^bb162, ^bb166
    %729 = llvm.icmp "slt" %728, %45 : i32
    llvm.cond_br %729, ^bb164, ^bb167 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb164:  // pred: ^bb163
  ...
  ^bb202(%881: i32):  // 2 preds: ^bb201, ^bb203
    ...
    llvm.cond_br %882, ^bb203, ^bb204 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb203:  // pred: ^bb202
  ...
  ^bb233(%942: i32):  // 2 preds: ^bb232, ^bb234
    ...
    llvm.cond_br %943, ^bb234, ^bb235 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb234:  // pred: ^bb233
  ...
  ^bb241(%1020: i32):  // 2 preds: ^bb240, ^bb242
    ...
    llvm.cond_br %1021, ^bb242, ^bb243 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb242:  // pred: ^bb241
  ...
  ^bb257(%1086: i32):  // 2 preds: ^bb256, ^bb258
    ...
    llvm.cond_br %1087, ^bb258, ^bb259 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb258:  // pred: ^bb257
  ...
  ^bb260(%1098: i32):  // 2 preds: ^bb259, ^bb261
    ...
    llvm.cond_br %1099, ^bb261, ^bb262 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb261:  // pred: ^bb260
  ...
  ^bb264(%1110: i32):  // 2 preds: ^bb263, ^bb265
    ...
    llvm.cond_br %1111, ^bb265, ^bb266 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb265:  // pred: ^bb264
