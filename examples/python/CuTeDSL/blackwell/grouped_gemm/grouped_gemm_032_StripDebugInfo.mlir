gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_100a">] {
  ...
  ^bb23(%162: i32):  // 2 preds: ^bb22, ^bb24
    ...
    llvm.cond_br %163, ^bb24, ^bb25 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb24:  // pred: ^bb23
  ...
  ^bb54(%223: i32):  // 2 preds: ^bb53, ^bb55
    ...
    llvm.cond_br %224, ^bb55, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb55:  // pred: ^bb54
  ...
  ^bb62(%297: i32):  // 2 preds: ^bb61, ^bb63
    ...
    llvm.cond_br %298, ^bb63, ^bb64 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb63:  // pred: ^bb62
  ...
  ^bb65(%324: i32):  // 2 preds: ^bb64, ^bb66
    ...
    llvm.cond_br %325, ^bb66, ^bb67 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb66:  // pred: ^bb65
  ...
  ^bb86(%406: i32, %407: i1, %408: i32, %409: i32, %410: i32):  // 2 preds: ^bb85, ^bb105
    ...
    llvm.cond_br %411, ^bb87, ^bb106 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb87:  // pred: ^bb86
  ...
  ^bb92(%426: i32):  // 2 preds: ^bb91, ^bb95
    ...
    llvm.cond_br %427, ^bb93, ^bb96 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb93:  // pred: ^bb92
  ...
  ^bb97(%431: i32):  // 2 preds: ^bb96, ^bb100
    ...
    llvm.cond_br %432, ^bb98, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb98:  // pred: ^bb97
  ...
  ^bb115(%472: i32):  // 2 preds: ^bb114, ^bb116
    ...
    llvm.cond_br %473, ^bb116, ^bb117 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb116:  // pred: ^bb115
  ...
  ^bb146(%533: i32):  // 2 preds: ^bb145, ^bb147
    ...
    llvm.cond_br %534, ^bb147, ^bb148 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb147:  // pred: ^bb146
  ...
  ^bb157(%599: i32, %600: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb156, ^bb169
    ...
    llvm.cond_br %601, ^bb158, ^bb170 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb158:  // pred: ^bb157
  ...
  ^bb159(%624: i32):  // 2 preds: ^bb158, ^bb168
    ...
    llvm.cond_br %625, ^bb160, ^bb169 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb160:  // pred: ^bb159
    llvm.br ^bb161(%16 : i32)
  ^bb161(%626: i32):  // 2 preds: ^bb160, ^bb167
    %627 = llvm.icmp "slt" %626, %42 : i32
    llvm.cond_br %627, ^bb162, ^bb168 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb162:  // pred: ^bb161
    llvm.br ^bb163(%16 : i32)
  ^bb163(%628: i32):  // 2 preds: ^bb162, ^bb166
    %629 = llvm.icmp "slt" %628, %42 : i32
    llvm.cond_br %629, ^bb164, ^bb167 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb164:  // pred: ^bb163
  ...
  ^bb202(%725: i32):  // 2 preds: ^bb201, ^bb203
    ...
    llvm.cond_br %726, ^bb203, ^bb204 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb203:  // pred: ^bb202
  ...
  ^bb233(%786: i32):  // 2 preds: ^bb232, ^bb234
    ...
    llvm.cond_br %787, ^bb234, ^bb235 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb234:  // pred: ^bb233
  ...
  ^bb241(%862: i32):  // 2 preds: ^bb240, ^bb242
    ...
    llvm.cond_br %863, ^bb242, ^bb243 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb242:  // pred: ^bb241
  ...
  ^bb257(%928: i32):  // 2 preds: ^bb256, ^bb258
    ...
    llvm.cond_br %929, ^bb258, ^bb259 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb258:  // pred: ^bb257
  ...
  ^bb260(%940: i32):  // 2 preds: ^bb259, ^bb261
    ...
    llvm.cond_br %941, ^bb261, ^bb262 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb261:  // pred: ^bb260
  ...
  ^bb264(%951: i32):  // 2 preds: ^bb263, ^bb265
    ...
    llvm.cond_br %952, ^bb265, ^bb266 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb265:  // pred: ^bb264
