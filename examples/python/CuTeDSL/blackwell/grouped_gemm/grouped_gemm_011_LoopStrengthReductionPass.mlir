        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: !mma_f16_f16_f32_128x128x16_, %arg17: i32, %arg18: i32):
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32):
            ...
            %139 = scf.if %138 -> (i32) {
              ...
              %161 = cute.get_scalars(%38) : !cute.int_tuple<"1">
              %162 = builtin.unrealized_conversion_cast %ptr_87 : !cute.ptr<i32, gmem, align<16>> to !llvm.ptr<1>
              %163 = builtin.unrealized_conversion_cast %iter_88 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
              scf.for %arg22 = %c0_i32 to %161 step %c1_i32  : i32 {
                %171 = llvm.load %162 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
                llvm.store %171, %163 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %164 = cute.memref.load(%rmem_83, %18) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %165 = arith.addi %164, %c127_i32 : i32
              %166 = arith.floordivsi %165, %c128_i32 : i32
              %167 = cute.memref.load(%rmem_83, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
              %168 = arith.addi %167, %c127_i32 : i32
              %169 = arith.floordivsi %168, %c128_i32 : i32
              %170 = arith.muli %166, %169 : i32
              scf.yield %170 : i32
            } else {
              scf.yield %c0_i32 : i32
            }
            %140 = nvvm.shfl.sync  up %c-1_i32, %139, %c1_i32, %c0_i32 : i32 -> i32
            %141 = scf.if %98 -> (i32) {
              %161 = arith.addi %139, %140 : i32
              scf.yield %161 : i32
            } else {
              scf.yield %139 : i32
            }
            ...
            %143 = scf.if %99 -> (i32) {
              %161 = arith.addi %141, %142 : i32
              scf.yield %161 : i32
            } else {
              scf.yield %141 : i32
            }
            %144 = nvvm.shfl.sync  up %c-1_i32, %143, %c4_i32, %c0_i32 : i32 -> i32
            %145 = scf.if %100 -> (i32) {
              %161 = arith.addi %143, %144 : i32
              scf.yield %161 : i32
            } else {
              scf.yield %143 : i32
            }
            %146 = nvvm.shfl.sync  up %c-1_i32, %145, %c8_i32, %c0_i32 : i32 -> i32
            %147 = scf.if %101 -> (i32) {
              %161 = arith.addi %145, %146 : i32
              scf.yield %161 : i32
            } else {
              scf.yield %145 : i32
            }
            %148 = nvvm.shfl.sync  up %c-1_i32, %147, %c16_i32, %c0_i32 : i32 -> i32
            %149 = scf.if %102 -> (i32) {
              %161 = arith.addi %147, %148 : i32
              scf.yield %161 : i32
            } else {
              scf.yield %147 : i32
            }
            %150 = arith.addi %149, %arg21 : i32
            %151 = arith.cmpi sge, %arg13, %150 : i32
            %152 = nvvm.vote.ballot.sync %c-1_i32, %151 : i32
            %153 = llvm.intr.ctpop(%152) : (i32) -> i32
            %154 = arith.cmpi eq, %153, %c32_i32 : i32
            %155 = arith.addi %153, %arg19 : i32
            %156 = arith.cmpi eq, %153, %c0_i32 : i32
            %157 = arith.cmpi eq, %156, %false : i1
            %158 = scf.if %157 -> (i32) {
              %161 = arith.subi %153, %c1_i32 : i32
              %162 = nvvm.shfl.sync  idx %c-1_i32, %150, %161, %c31_i32 : i32 -> i32
              scf.yield %162 : i32
            } else {
              scf.yield %arg21 : i32
            }
            %159 = arith.select %154, %c31_i32, %153 : i32
            %160 = nvvm.shfl.sync  idx %c-1_i32, %150, %159, %c31_i32 : i32 -> i32
            scf.yield %154, %155, %158, %160 : i1, i32, i32, i32
          }
          %rmem = cute.memref.alloca() : !memref_rmem_i32_
          ...
          scf.for %arg19 = %c0_i32 to %103 step %c1_i32  : i32 {
            %137 = llvm.load %107 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %137, %108 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          %121 = scf.if %118 -> (i1) {
            %137 = builtin.unrealized_conversion_cast %ptr_75 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %138 = nvvm.mbarrier.wait.parity %137, %120 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %138 : i1
          } else {
            scf.yield %true : i1
          }
          ...
          %127 = arith.addi %arg12, %c0_i32 : i32
          %128 = arith.addi %127, %c1_i32 : i32
          %129 = arith.remsi %128, %c6_i32 : i32
          %130:5 = scf.for %arg19 = %c0_i32 to %111 step %c1_i32 iter_args(%arg20 = %121, %arg21 = %114, %arg22 = %120, %arg23 = %126, %arg24 = %129) -> (i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32)  : i32 {
            %137 = arith.addi %arg19, %c1_i32 : i32
            %138 = arith.addi %arg12, %137 : i32
            %139 = arith.cmpi eq, %arg24, %c0_i32 : i32
            %140 = arith.xori %arg22, %c1_i32 : i32
            %141 = arith.select %139, %140, %arg22 : i32
            %142 = arith.extui %arg20 : i1 to i32
            ...
            scf.if %143 {
              ...
              %154 = builtin.unrealized_conversion_cast %ptr_88 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %154, %arg22, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            %144 = scf.for %arg25 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg26 = %arg23) -> (!mma_f16_f16_f32_128x128x16_)  : i32 {
              %coord_87 = cute.make_coord(%arg25, %arg21) : (i32, i32) -> !cute.coord<"(_,_,?,?)">
              ...
              %tup_89 = cute.add_offset(%ummaSmemDesc_48, %idx_88) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
              %154 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
              %155 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
              %156 = cute_nvgpu.atom.get_value(%arg26 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
              %157 = arith.extui %154 : i1 to i32
              %158 = arith.extui %155 : i1 to i32
              %159 = arith.shli %157, %c13_i32 : i32
              %160 = arith.shli %158, %c14_i32 : i32
              %161 = arith.ori %159, %c136314896_i32 : i32
              %162 = arith.ori %161, %160 : i32
              scf.for %arg27 = %c0_i32 to %103 step %c1_i32  : i32 {
                scf.for %arg28 = %c0_i32 to %103 step %c1_i32  : i32 {
                  scf.for %arg29 = %c0_i32 to %103 step %c1_i32  : i32 {
                    cute_nvgpu.arch.mma.SM100.umma(%tup, %tup_89, %ptr_73, %162, %156) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                  } {llvm.loop_annotation = #loop_annotation}
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
              %163 = cute_nvgpu.atom.set_value(%arg26, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x128x16_
              scf.yield %163 : !mma_f16_f16_f32_128x128x16_
            ...
            scf.if %145 {
              ...
              %154 = builtin.unrealized_conversion_cast %ptr_88 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %154 : !llvm.ptr<3>
            }
            %146 = arith.cmpi slt, %137, %111 : i32
            %147 = arith.extui %146 : i1 to i32
            %148 = arith.select %146, %c1_i32, %147 : i32
            ...
            %150 = scf.if %149 -> (i1) {
              %154 = builtin.unrealized_conversion_cast %ptr_84 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %155 = nvvm.mbarrier.wait.parity %154, %141 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %155 : i1
            } else {
              scf.yield %true : i1
            }
            %c1_i32_85 = arith.constant 1 : i32
            %151 = arith.addi %arg24, %c1_i32_85 : i32
            %152 = arith.cmpi eq, %151, %c6_i32 : i32
            %c0_i32_86 = arith.constant 0 : i32
            %153 = arith.select %152, %c0_i32_86, %151 : i32
            scf.yield %150, %arg24, %141, %144, %153 : i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32
          }
          %131 = nvvm.elect.sync -> i1
          scf.if %131 {
            %ptr_83 = cute.add_offset(%iter_14, %int_tuple_76) : (!cute.ptr<i64, smem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %137 = builtin.unrealized_conversion_cast %ptr_83 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %137 : !llvm.ptr<3>
          }
          %132 = arith.addi %arg17, %92 : i32
          %133 = arith.addi %arg18, %c1_i32 : i32
          %134 = arith.cmpi sgt, %93, %132 : i32
          %135 = cute.get_hier_coord(%132, %lay) : (i32, !cute.layout<"(1,1,?):(0,0,1)">) -> !cute.coord<"(0,0,?)">
          %e0_78, %e1_79, %e2_80 = cute.get_leaves(%135) : !cute.coord<"(0,0,?)">
          ...
          %136 = cute.get_scalars(%mul_82) : !cute.int_tuple<"?">
          scf.yield %113, %136, %134, %106#0, %106#1, %130#3, %132, %133 : i32, i32, i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32, i32
        }
      }
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32):
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32):
            ...
            %153 = scf.if %152 -> (i32) {
              ...
              %175 = cute.get_scalars(%38) : !cute.int_tuple<"1">
              ...
              %178 = cute.memref.load(%rmem_128, %18) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %179 = arith.addi %178, %c127_i32 : i32
              %180 = arith.floordivsi %179, %c128_i32 : i32
              %181 = cute.memref.load(%rmem_128, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
          ...
          scf.for %arg19 = %c0_i32 to %115 step %c1_i32  : i32 {
            %151 = llvm.load %124 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %151, %125 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          scf.if %135 {
            ...
            %155 = cute.memref.load(%rmem_134, %18) : (!memref_rmem_i32_1, !cute.coord<"0">) -> i32
            %156 = cute.memref.load(%rmem_134, %16) : (!memref_rmem_i32_1, !cute.coord<"1">) -> i32
            ...
            scf.if %56 {
              ...
              nvvm.bar.warp.sync %c-1_i32 : i32
              %158 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
          ...
          scf.if %135 {
            scf.if %56 {
              %151 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
          ...
          %144 = scf.for %arg19 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg20 = %143) -> (i32)  : i32 {
            ...
            scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
              %161 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_130) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 32 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<32xi32>
              llvm.store %161, %116 : vector<32xi32>, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %154 = builtin.unrealized_conversion_cast %ptr_133 : !cute.ptr<f16, smem, align<64>, S<2,4,3>> to !llvm.ptr<3>
            ...
            %155 = builtin.unrealized_conversion_cast %ptr_134 : !cute.ptr<f16, smem, align<16>, S<2,4,3>> to !llvm.ptr<3>
            ...
            %156 = builtin.unrealized_conversion_cast %ptr_135 : !cute.ptr<f16, smem, align<32>, S<2,4,3>> to !llvm.ptr<3>
            ...
            %157 = builtin.unrealized_conversion_cast %ptr_136 : !cute.ptr<f16, smem, align<16>, S<2,4,3>> to !llvm.ptr<3>
            scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
              %161 = llvm.load %117 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %161, %154 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %162 = llvm.load %118 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %162, %155 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %163 = llvm.load %119 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %163, %156 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %164 = llvm.load %120 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %164, %157 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
            } {llvm.loop_annotation = #loop_annotation}
            nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
            nvvm.barrier id = %c2_i32 number_of_threads = %c128_i32
            scf.if %56 {
              %coord_139 = cute.make_coord(%arg20) : (i32) -> !cute.coord<"(_,?)">
              %idx_140 = cute.crd2idx(%coord_139, %1) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),(1,4)):((1,0),(0,4096))">) -> !cute.int_tuple<"?{div=4096}">
              %ptr_141 = cute.add_offset(%iter_16, %idx_140) : (!cute.ptr<f16, smem, align<1024>, S<2,4,3>>, !cute.int_tuple<"?{div=4096}">) -> !cute.ptr<f16, smem, align<1024>, S<2,4,3>>
              %coord_142 = cute.make_coord(%arg19) : (i32) -> !cute.coord<"(_,?)">
              %idx_143 = cute.crd2idx(%coord_142, %0) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),(1,4)):(((1@0,1@1),0),(0,32@0))">) -> !cute.int_tuple<"(?{div=32},0)">
              %tup_144 = cute.add_offset(%tup_117, %idx_143) : (!cute.int_tuple<"(?{div=128},?{div=128},0)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},0)">
              %e0_145, %e1_146, %e2_147 = cute.get_leaves(%tup_144) : !cute.int_tuple<"(?{div=32},?{div=128},0)">
              %161 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              %iv_148 = cute.assume(%161) : (i64) -> !cute.i64<divby 128>
              %162 = cute.inttoptr(%iv_148) : !cute.i64<divby 128> to !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>
              %int_tuple_149 = cute.make_int_tuple(%e0_145, %e1_146) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=32},?{div=128},0)">
              %163 = cute_nvgpu.atom.make_exec_tma(%arg5) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 65536, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %164 = cute_nvgpu.atom.set_value(%163, %162 : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>) {field = #cute_nvgpu.atom_copy_field_tmastore<tma_descriptor_ptr>} : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%164 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %165:3 = cute.get_scalars(%int_tuple_149) : !cute.int_tuple<"(?{div=32},?{div=128},0)">
              scf.for %arg21 = %c0_i32 to %115 step %c1_i32  : i32 {
                cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_141 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%165#0, %165#1, %165#2] : i32, i32, i32) mode = <tiled>
              } {llvm.loop_annotation = #loop_annotation}
              nvvm.cp.async.bulk.commit.group
            ...
            %158 = arith.addi %arg20, %c1_i32_137 : i32
            %159 = arith.cmpi eq, %158, %c4_i32 : i32
            %c0_i32_138 = arith.constant 0 : i32
            %160 = arith.select %159, %c0_i32_138, %158 : i32
            scf.yield %160 : i32
          }
          %145 = nvvm.elect.sync -> i1
          scf.if %145 {
          ...
          %146 = arith.addi %arg17, %104 : i32
          %147 = arith.addi %arg18, %c1_i32 : i32
          %148 = arith.cmpi sgt, %105, %146 : i32
          ...
          scf.yield %136, %150, %148, %123#0, %123#0, %123#1, %146, %147 : i32, i32, i1, i32, i32, i32, i32, i32
        }
        scf.if %56 {
