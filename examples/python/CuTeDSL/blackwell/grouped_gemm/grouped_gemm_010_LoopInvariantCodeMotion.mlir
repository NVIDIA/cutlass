      ...
      scf.if %57 {
        ...
        ^bb0(%arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32, %arg19: !mma_f16_f16_f32_128x128x16_, %arg20: i32, %arg21: i32):
          ...
          ^bb0(%arg22: i32, %arg23: i32, %arg24: i32):
            %173 = arith.addi %arg22, %120 : i32
            %174 = arith.cmpi slt, %173, %c2_i32 : i32
            %175 = scf.if %174 -> (i32) {
              %rmem_84 = cute.memref.alloca() : !memref_rmem_i32_
              %coord_85 = cute.make_coord(%173) : (i32) -> !cute.coord<"(?,_)">
              ...
              %198 = builtin.unrealized_conversion_cast %ptr_88 : !cute.ptr<i32, gmem, align<16>> to !llvm.ptr<1>
              %199 = builtin.unrealized_conversion_cast %iter_89 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
              scf.for %arg25 = %c0_i32 to %197 step %c1_i32  : i32 {
                %207 = llvm.load %198 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
                llvm.store %207, %199 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %200 = cute.memref.load(%rmem_84, %17) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %201 = arith.addi %200, %c127_i32 : i32
              %202 = arith.floordivsi %201, %c128_i32 : i32
              %203 = cute.memref.load(%rmem_84, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
              %204 = arith.addi %203, %c127_i32 : i32
              %205 = arith.floordivsi %204, %c128_i32 : i32
              %206 = arith.muli %202, %205 : i32
              scf.yield %206 : i32
            } else {
              scf.yield %c0_i32 : i32
            }
            %176 = nvvm.shfl.sync  up %c-1_i32, %175, %c1_i32, %c0_i32 : i32 -> i32
            %177 = scf.if %121 -> (i32) {
              %197 = arith.addi %175, %176 : i32
              scf.yield %197 : i32
            } else {
              scf.yield %175 : i32
            }
            %178 = nvvm.shfl.sync  up %c-1_i32, %177, %c2_i32, %c0_i32 : i32 -> i32
            %179 = scf.if %122 -> (i32) {
              %197 = arith.addi %177, %178 : i32
              scf.yield %197 : i32
            } else {
              scf.yield %177 : i32
            }
            %180 = nvvm.shfl.sync  up %c-1_i32, %179, %c4_i32, %c0_i32 : i32 -> i32
            %181 = scf.if %123 -> (i32) {
              %197 = arith.addi %179, %180 : i32
              scf.yield %197 : i32
            } else {
              scf.yield %179 : i32
            }
            %182 = nvvm.shfl.sync  up %c-1_i32, %181, %c8_i32, %c0_i32 : i32 -> i32
            %183 = scf.if %124 -> (i32) {
              %197 = arith.addi %181, %182 : i32
              scf.yield %197 : i32
            } else {
              scf.yield %181 : i32
            }
            %184 = nvvm.shfl.sync  up %c-1_i32, %183, %c16_i32, %c0_i32 : i32 -> i32
            %185 = scf.if %125 -> (i32) {
              %197 = arith.addi %183, %184 : i32
              scf.yield %197 : i32
            } else {
              scf.yield %183 : i32
            }
            %186 = arith.addi %185, %arg24 : i32
            %187 = arith.cmpi sge, %arg16, %186 : i32
            %188 = nvvm.vote.ballot.sync %c-1_i32, %187 : i32
            %189 = llvm.intr.ctpop(%188) : (i32) -> i32
            %190 = arith.cmpi eq, %189, %c32_i32 : i32
            %191 = arith.addi %189, %arg22 : i32
            %192 = arith.cmpi eq, %189, %c0_i32 : i32
            %193 = arith.cmpi eq, %192, %false : i1
            %194 = scf.if %193 -> (i32) {
              %197 = arith.subi %189, %c1_i32 : i32
              %198 = nvvm.shfl.sync  idx %c-1_i32, %186, %197, %c31_i32 : i32 -> i32
              scf.yield %198 : i32
            } else {
              scf.yield %arg24 : i32
            }
            %195 = arith.select %190, %c31_i32, %189 : i32
            %196 = nvvm.shfl.sync  idx %c-1_i32, %186, %195, %c31_i32 : i32 -> i32
            scf.yield %190, %191, %194, %196 : i1, i32, i32, i32
          }
          %rmem = cute.memref.alloca() : !memref_rmem_i32_
          ...
          scf.for %arg22 = %c0_i32 to %126 step %c1_i32  : i32 {
            %173 = llvm.load %130 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %173, %131 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          %144 = scf.if %141 -> (i1) {
            %173 = builtin.unrealized_conversion_cast %ptr_79 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %174 = nvvm.mbarrier.wait.parity %173, %143 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %174 : i1
          } else {
            scf.yield %true : i1
          }
          ...
          %150:4 = scf.for %arg22 = %c0_i32 to %134 step %c1_i32 iter_args(%arg23 = %144, %arg24 = %137, %arg25 = %143, %arg26 = %149) -> (i1, i32, i32, !mma_f16_f16_f32_128x128x16_)  : i32 {
            %173 = arith.addi %arg22, %c1_i32 : i32
            %174 = arith.addi %arg15, %173 : i32
            %175 = arith.remsi %174, %c6_i32 : i32
            ...
            scf.if %180 {
              ...
              %188 = builtin.unrealized_conversion_cast %ptr_87 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %188, %arg25, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            %181 = scf.for %arg27 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg28 = %arg26) -> (!mma_f16_f16_f32_128x128x16_)  : i32 {
              ...
              %188 = cute_nvgpu.atom.get_value(%arg28 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
              %189 = cute_nvgpu.atom.get_value(%arg28 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
              %190 = cute_nvgpu.atom.get_value(%arg28 : !mma_f16_f16_f32_128x128x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
              %191 = arith.extui %188 : i1 to i32
              %192 = arith.extui %189 : i1 to i32
              %193 = arith.shli %191, %c13_i32 : i32
              %194 = arith.shli %192, %c14_i32 : i32
              %195 = arith.ori %193, %c136314896_i32 : i32
              %196 = arith.ori %195, %194 : i32
              scf.for %arg29 = %c0_i32 to %126 step %c1_i32  : i32 {
                scf.for %arg30 = %c0_i32 to %126 step %c1_i32  : i32 {
                  scf.for %arg31 = %c0_i32 to %126 step %c1_i32  : i32 {
                    cute_nvgpu.arch.mma.SM100.umma(%tup, %tup_88, %ptr_77, %196, %190) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                  } {llvm.loop_annotation = #loop_annotation}
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
              %197 = cute_nvgpu.atom.set_value(%arg28, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x128x16_
              scf.yield %197 : !mma_f16_f16_f32_128x128x16_
            ...
            scf.if %182 {
              ...
              %188 = builtin.unrealized_conversion_cast %ptr_87 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %188 : !llvm.ptr<3>
            }
            %183 = arith.cmpi slt, %173, %134 : i32
            %184 = arith.extui %183 : i1 to i32
            %185 = arith.select %183, %c1_i32, %184 : i32
            %186 = arith.cmpi ne, %185, %c0_i32 : i32
            %int_tuple_84 = cute.make_int_tuple(%175) : (i32) -> !cute.int_tuple<"?">
            %ptr_85 = cute.add_offset(%iter_12, %int_tuple_84) : (!cute.ptr<i64, smem, align<128>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %187 = scf.if %186 -> (i1) {
              %188 = builtin.unrealized_conversion_cast %ptr_85 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %189 = nvvm.mbarrier.wait.parity %188, %178 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %189 : i1
            } else {
              scf.yield %true : i1
            }
            scf.yield %187, %175, %178, %181 : i1, i32, i32, !mma_f16_f16_f32_128x128x16_
          }
          ...
          scf.if %151 {
            ...
            %173 = builtin.unrealized_conversion_cast %ptr_84 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %173 : !llvm.ptr<3>
          }
          %152 = arith.addi %arg20, %92 : i32
          %153 = arith.addi %arg21, %c1_i32 : i32
          %154 = arith.cmpi sgt, %93, %152 : i32
          %155 = nvvm.mul  hi %152, %multiplier : i32 -> i32
          %156 = arith.subi %152, %155 : i32
          %157 = arith.shrui %156, %96 : i32
          %158 = arith.addi %155, %157 : i32
          %159 = arith.shrui %158, %97 : i32
          %160 = arith.muli %159, %95 : i32
          %161 = arith.subi %152, %160 : i32
          %162 = nvvm.mul  hi %161, %multiplier_63 : i32 -> i32
          %163 = arith.subi %161, %162 : i32
          %164 = arith.shrui %163, %105 : i32
          %165 = arith.addi %162, %164 : i32
          %166 = arith.shrui %165, %106 : i32
          %167 = nvvm.mul  hi %166, %multiplier_66 : i32 -> i32
          %168 = arith.subi %166, %167 : i32
          %169 = arith.shrui %168, %112 : i32
          %170 = arith.addi %167, %169 : i32
          %171 = arith.shrui %170, %113 : i32
          %int_tuple_82 = cute.make_int_tuple(%171) : (i32) -> !cute.int_tuple<"?">
          %mul_83 = cute.tuple_mul(%int_tuple_82, %38) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %172 = cute.get_scalars(%mul_83) : !cute.int_tuple<"?">
          scf.yield %136, %172, %154, %129#0, %129#1, %150#3, %152, %153 : i32, i32, i1, i32, i32, !mma_f16_f16_f32_128x128x16_, i32, i32
        }
      }
      ...
      scf.if %91 {
        ...
        ^bb0(%arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32, %arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32):
          ...
          ^bb0(%arg24: i32, %arg25: i32, %arg26: i32):
            %201 = arith.addi %arg24, %140 : i32
            %202 = arith.cmpi slt, %201, %c2_i32 : i32
            %203 = scf.if %202 -> (i32) {
              %rmem_140 = cute.memref.alloca() : !memref_rmem_i32_
              %coord_141 = cute.make_coord(%201) : (i32) -> !cute.coord<"(?,_)">
              ...
              %226 = builtin.unrealized_conversion_cast %ptr_144 : !cute.ptr<i32, gmem, align<16>> to !llvm.ptr<1>
              %227 = builtin.unrealized_conversion_cast %iter_145 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
              scf.for %arg27 = %c0_i32 to %225 step %c1_i32  : i32 {
                %235 = llvm.load %226 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
                llvm.store %235, %227 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %228 = cute.memref.load(%rmem_140, %17) : (!memref_rmem_i32_, !cute.coord<"0">) -> i32
              %229 = arith.addi %228, %c127_i32 : i32
              %230 = arith.floordivsi %229, %c128_i32 : i32
              %231 = cute.memref.load(%rmem_140, %16) : (!memref_rmem_i32_, !cute.coord<"1">) -> i32
              %232 = arith.addi %231, %c127_i32 : i32
              %233 = arith.floordivsi %232, %c128_i32 : i32
              %234 = arith.muli %230, %233 : i32
              scf.yield %234 : i32
            } else {
              scf.yield %c0_i32 : i32
            }
            %204 = nvvm.shfl.sync  up %c-1_i32, %203, %c1_i32, %c0_i32 : i32 -> i32
            %205 = scf.if %141 -> (i32) {
              %225 = arith.addi %203, %204 : i32
              scf.yield %225 : i32
            } else {
              scf.yield %203 : i32
            }
            %206 = nvvm.shfl.sync  up %c-1_i32, %205, %c2_i32, %c0_i32 : i32 -> i32
            %207 = scf.if %142 -> (i32) {
              %225 = arith.addi %205, %206 : i32
              scf.yield %225 : i32
            } else {
              scf.yield %205 : i32
            }
            ...
            %211 = scf.if %144 -> (i32) {
              %225 = arith.addi %209, %210 : i32
              scf.yield %225 : i32
            } else {
              scf.yield %209 : i32
            }
            %212 = nvvm.shfl.sync  up %c-1_i32, %211, %c16_i32, %c0_i32 : i32 -> i32
            %213 = scf.if %145 -> (i32) {
              %225 = arith.addi %211, %212 : i32
              scf.yield %225 : i32
            } else {
              scf.yield %211 : i32
            }
            %214 = arith.addi %213, %arg26 : i32
            %215 = arith.cmpi sge, %arg18, %214 : i32
            %216 = nvvm.vote.ballot.sync %c-1_i32, %215 : i32
            %217 = llvm.intr.ctpop(%216) : (i32) -> i32
            %218 = arith.cmpi eq, %217, %c32_i32 : i32
            %219 = arith.addi %217, %arg24 : i32
            %220 = arith.cmpi eq, %217, %c0_i32 : i32
            %221 = arith.cmpi eq, %220, %false : i1
            %222 = scf.if %221 -> (i32) {
              %225 = arith.subi %217, %c1_i32 : i32
              %226 = nvvm.shfl.sync  idx %c-1_i32, %214, %225, %c31_i32 : i32 -> i32
              scf.yield %226 : i32
            } else {
              scf.yield %arg26 : i32
            }
            %223 = arith.select %218, %c31_i32, %217 : i32
            %224 = nvvm.shfl.sync  idx %c-1_i32, %214, %223, %c31_i32 : i32 -> i32
            scf.yield %218, %219, %222, %224 : i1, i32, i32, i32
          }
          ...
          scf.for %arg24 = %c0_i32 to %146 step %c1_i32  : i32 {
            %201 = llvm.load %155 {alignment = 16 : i64} : !llvm.ptr<1> -> vector<4xi32>
            llvm.store %201, %156 {alignment = 16 : i64} : vector<4xi32>, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          ...
          scf.if %166 {
            ...
            %201 = cute.memref.load(%arg13, %coord_140) : (!memref_gmem_i64_, !cute.coord<"(?,2)">) -> i64
            %iv_141 = cute.assume(%201) : (i64) -> !cute.i64<divby 16>
            %202 = cute.inttoptr(%iv_141) : !cute.i64<divby 16> to !cute.ptr<f16, gmem, align<16>>
            ...
            %203 = builtin.unrealized_conversion_cast %ptr_145 : !cute.ptr<i32, gmem, align<8>> to !llvm.ptr<1>
            %204 = builtin.unrealized_conversion_cast %iter_147 : !cute.ptr<i32, rmem, align<32>> to !llvm.ptr
            scf.for %arg24 = %c0_i32 to %146 step %c1_i32  : i32 {
              %207 = llvm.load %203 {alignment = 8 : i64} : !llvm.ptr<1> -> vector<2xi32>
              llvm.store %207, %204 {alignment = 8 : i64} : vector<2xi32>, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %205 = cute.memref.load(%rmem_146, %17) : (!memref_rmem_i32_1, !cute.coord<"0">) -> i32
            %206 = cute.memref.load(%rmem_146, %16) : (!memref_rmem_i32_1, !cute.coord<"1">) -> i32
            %shape_148 = cute.make_shape(%158, %159) : (i32, i32) -> !cute.shape<"(?,?,1)">
            %stride = cute.make_stride(%205, %206) : (i32, i32) -> !cute.stride<"(?,?,0)">
            %lay_149 = cute.make_layout(%shape_148, %stride) : !cute.layout<"(?,?,1):(?,?,0)">
            %view_150 = cute.make_view(%202, %lay_149) : !memref_gmem_f16_
            ...
            scf.if %56 {
              ...
              nvvm.bar.warp.sync %c-1_i32 : i32
              %208 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              %209 = cute.ptrtoint(%dyn) : !cute.ptr<i64, smem, align<128>> to i32
              llvm.inline_asm has_side_effects asm_dialect = att "tensormap.cp_fenceproxy.global.shared::cta.tensormap::generic.release.gpu.sync.aligned [$0], [$1], 128;", "l,r" %208, %209 : (i64, i32) -> ()
            }
          }
          ...
          scf.if %166 {
            scf.if %56 {
              %201 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              llvm.inline_asm has_side_effects asm_dialect = att "fence.proxy.tensormap::generic.acquire.gpu [$0], 128;", "l" %201 : (i64) -> ()
            }
          }
          ...
          scf.for %arg24 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
            ...
            scf.for %arg25 = %c0_i32 to %146 step %c1_i32  : i32 {
              %209 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_142) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 32 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<32xi32>
              llvm.store %209, %147 : vector<32xi32>, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %201 = cute.memref.load_vec %view_93 : !memref_rmem_f32_1
            %202 = arith.truncf %201 : vector<32xf32> to vector<32xf16>
            cute.memref.store_vec %202, %view : !memref_rmem_f16_1
            %203 = arith.addi %172, %arg24 : i32
            %204 = arith.remsi %203, %c4_i32 : i32
            %coord_143 = cute.make_coord(%204) : (i32) -> !cute.coord<"(_,_,_,?)">
            ...
            scf.for %arg25 = %c0_i32 to %146 step %c1_i32  : i32 {
              %209 = llvm.load %148 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %209, %205 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %210 = llvm.load %149 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %210, %206 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %211 = llvm.load %150 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %211, %207 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
              %212 = llvm.load %151 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
              llvm.store %212, %208 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<3>
            } {llvm.loop_annotation = #loop_annotation}
            nvvm.fence.proxy {kind = #nvvm.proxy_kind<async.shared>, space = #nvvm.shared_space<cta>}
            nvvm.barrier id = %c1_i32 number_of_threads = %c128_i32
            scf.if %56 {
              %coord_149 = cute.make_coord(%204) : (i32) -> !cute.coord<"(_,?)">
              ...
              %209 = cute.ptrtoint(%90) : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, gmem, align<128>> to i64
              %iv_158 = cute.assume(%209) : (i64) -> !cute.i64<divby 128>
              %210 = cute.inttoptr(%iv_158) : !cute.i64<divby 128> to !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>
              ...
              %211 = cute_nvgpu.atom.make_exec_tma(%arg5) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 65536, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %212 = cute_nvgpu.atom.set_value(%211, %210 : !cute.ptr<!cute_nvgpu.tma_descriptor_tiled, generic, align<128>>) {field = #cute_nvgpu.atom_copy_field_tmastore<tma_descriptor_ptr>} : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%212 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %213 = cute_nvgpu.atom.get_value(%212 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
              %214:3 = cute.get_scalars(%int_tuple_159) : !cute.int_tuple<"(?{div=32},?{div=128},0)">
              scf.for %arg25 = %c0_i32 to %146 step %c1_i32  : i32 {
                cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_151 : !cute.ptr<f16, smem, align<1024>, S<2,4,3>>, [%214#0, %214#1, %214#2] : i32, i32, i32) cache_policy = %213 mode = <tiled>
              } {llvm.loop_annotation = #loop_annotation}
              nvvm.cp.async.bulk.commit.group
          ...
          scf.if %173 {
            ...
            %201 = builtin.unrealized_conversion_cast %ptr_140 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %201, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
          }
          %174 = arith.addi %arg22, %104 : i32
          %175 = arith.addi %arg23, %c1_i32 : i32
          %176 = arith.cmpi sgt, %105, %174 : i32
          %177 = nvvm.mul  hi %174, %multiplier : i32 -> i32
          %178 = arith.subi %174, %177 : i32
          %179 = arith.shrui %178, %108 : i32
          %180 = arith.addi %177, %179 : i32
          %181 = arith.shrui %180, %109 : i32
          %182 = arith.muli %181, %107 : i32
          %183 = arith.subi %174, %182 : i32
          %184 = nvvm.mul  hi %183, %multiplier_81 : i32 -> i32
          %185 = arith.subi %183, %184 : i32
          %186 = arith.shrui %185, %118 : i32
          %187 = arith.addi %184, %186 : i32
          %188 = arith.shrui %187, %119 : i32
          %189 = arith.muli %188, %117 : i32
          %190 = arith.subi %183, %189 : i32
          %191 = nvvm.mul  hi %188, %multiplier_84 : i32 -> i32
          %192 = arith.subi %188, %191 : i32
          %193 = arith.shrui %192, %128 : i32
          %194 = arith.addi %191, %193 : i32
          %195 = arith.shrui %194, %129 : i32
          %196 = arith.muli %195, %127 : i32
          %197 = arith.subi %188, %196 : i32
          %int_tuple_134 = cute.make_int_tuple(%190) : (i32) -> !cute.int_tuple<"?">
          %mul_135 = cute.tuple_mul(%int_tuple_134, %38) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %198 = cute.get_scalars(%mul_135) : !cute.int_tuple<"?">
          %int_tuple_136 = cute.make_int_tuple(%197) : (i32) -> !cute.int_tuple<"?">
          %mul_137 = cute.tuple_mul(%int_tuple_136, %38) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %199 = cute.get_scalars(%mul_137) : !cute.int_tuple<"?">
          %int_tuple_138 = cute.make_int_tuple(%195) : (i32) -> !cute.int_tuple<"?">
          %mul_139 = cute.tuple_mul(%int_tuple_138, %38) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %200 = cute.get_scalars(%mul_139) : !cute.int_tuple<"?">
          scf.yield %167, %198, %199, %200, %176, %154#0, %154#0, %154#1, %174, %175 : i32, i32, i32, i32, i1, i32, i32, i32, i32, i32
        }
        scf.if %56 {
