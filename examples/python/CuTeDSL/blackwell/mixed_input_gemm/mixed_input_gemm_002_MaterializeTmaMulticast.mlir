...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024_tensorptri8gmemalign128o51211100512_tensor000o1024111000102401112____Float32_Int4_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %27 = cute.get_scalars(%e0_72) : !cute.int_tuple<"?{div=1024}">
      %28 = cute.get_scalars(%e1_73) : !cute.int_tuple<"?">
      ...
      %30 = cute.get_scalars(%e0_76) : !cute.int_tuple<"?{div=1024}">
      %31 = cute.get_scalars(%e1_77) : !cute.int_tuple<"?">
      ...
      %35 = cute.composition(%slice_70, %0) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">, !cute.layout<"(128,8):(8,1)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %iter_81 = cute.get_iter(%35) : !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %e0_82, %e1_83, %e2_84 = cute.get_leaves(%iter_81) : !cute.int_tuple<"(?{div=1024},?,?)">
      %36 = cute.get_scalars(%e0_82) : !cute.int_tuple<"?{div=1024}">
      %37 = cute.get_scalars(%e1_83) : !cute.int_tuple<"?">
      ...
      %slice_94 = cute.slice(%35, %coord_93) : !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">, !cute.coord<"(?,_)">
      ...
      %39 = cute.get_scalars(%e0_96) : !cute.int_tuple<"?{div=8}">
      %40 = cute.get_scalars(%e1_97) : !cute.int_tuple<"?">
      ...
      %42 = cute.get_scalars(%e0_100) : !cute.int_tuple<"?{div=8}">
      %43 = cute.get_scalars(%e1_101) : !cute.int_tuple<"?">
      ...
      %45 = cute.get_scalars(%e0_106) : !cute.int_tuple<"?{div=8}">
      %46 = cute.get_scalars(%e1_107) : !cute.int_tuple<"?">
      ...
      %48 = cute.get_scalars(%e0_110) : !cute.int_tuple<"?{div=8}">
      %49 = cute.get_scalars(%e1_111) : !cute.int_tuple<"?">
      ...
      %51 = cute.get_scalars(%e0_114) : !cute.int_tuple<"?{div=8}">
      %52 = cute.get_scalars(%e1_115) : !cute.int_tuple<"?">
      ...
      scf.if %54 {
        ...
        %68 = arith.fptosi %67 : vector<8xf32> to vector<8xi4>
        ...
        %71 = builtin.unrealized_conversion_cast %68 : vector<8xi4> to vector<8xi4>
