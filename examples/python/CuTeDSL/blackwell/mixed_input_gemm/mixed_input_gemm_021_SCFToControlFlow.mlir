...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb4:  // pred: ^bb2
      ...
      %192 = llvm.fptosi %191 : vector<8xf32> to vector<8xi4>
      %193 = llvm.mlir.undef : !llvm.struct<(struct<()>, struct<()>)>
      %194 = vector.bitcast %192 : vector<8xi4> to vector<4xi8>
      %195 = vector.shape_cast %194 : vector<4xi8> to vector<1x4xi8>
      %196 = llvm.extractvalue %143[0] : !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)> 
      %197 = vector.extract %195[0] : vector<4xi8> from vector<1x4xi8>
      %198 = llvm.getelementptr %196[0] : (!llvm.ptr) -> !llvm.ptr, i8
      llvm.store %197, %198 {alignment = 32 : i64} : vector<4xi8>, !llvm.ptr
      %199 = llvm.mlir.constant(1 : i32) : i32
      %200 = llvm.getelementptr %144[%199] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      %201 = llvm.mlir.constant(1 : i32) : i32
      %202 = llvm.getelementptr %102[%201] : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>, i8
      %203 = llvm.mlir.constant(2 : i32) : i32
      %204 = llvm.getelementptr %144[%203] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      %205 = llvm.mlir.constant(2 : i32) : i32
      %206 = llvm.getelementptr %102[%205] : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>, i8
      %207 = llvm.mlir.constant(3 : i32) : i32
      %208 = llvm.getelementptr %144[%207] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      %209 = llvm.mlir.constant(3 : i32) : i32
      %210 = llvm.getelementptr %102[%209] : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>, i8
      llvm.br ^bb5(%15 : i32)
    ^bb5(%211: i32):  // 2 preds: ^bb4, ^bb6
      %212 = llvm.icmp "slt" %211, %145 : i32
      llvm.cond_br %212, ^bb6, ^bb7 {llvm.loop_annotation = #loop_annotation}
    ^bb6:  // pred: ^bb5
      %213 = llvm.load %144 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %213, %102 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %214 = llvm.load %200 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %214, %202 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %215 = llvm.load %204 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %215, %206 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %216 = llvm.load %208 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %216, %210 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %217 = llvm.add %211, %14 : i32
      llvm.br ^bb5(%217 : i32)
    ^bb7:  // pred: ^bb5
      llvm.br ^bb8
    ^bb8:  // 2 preds: ^bb0, ^bb7
  ...
  ^bb24:  // pred: ^bb23
    ...
    %69 = llvm.insertvalue %37, %68[0] : !llvm.struct<(i32, i32, i32)> 
    %70 = llvm.insertvalue %14, %69[1] : !llvm.struct<(i32, i32, i32)> 
    %71 = llvm.insertvalue %15, %70[2] : !llvm.struct<(i32, i32, i32)> 
    %72 = llvm.mlir.undef : !llvm.struct<(i64, i64)>
    %73 = llvm.insertvalue %52, %72[0] : !llvm.struct<(i64, i64)> 
    ...
    %101 = llvm.add %100, %91 : i32
    %102 = llvm.sdiv %101, %6 : i32
    %103 = llvm.add %102, %96 : i32
    %104 = llvm.sub %97, %91 : i32
    %105 = llvm.sdiv %104, %6 : i32
    %106 = llvm.sub %97, %105 : i32
    %107 = llvm.icmp "slt" %91, %97 : i32
    %108 = llvm.icmp "sgt" %91, %97 : i32
    ...
    %116 = llvm.insertvalue %114, %115[0] : !llvm.struct<(i32, i32, i32)> 
    %117 = llvm.insertvalue %92, %116[1] : !llvm.struct<(i32, i32, i32)> 
    ...
    %136 = llvm.add %135, %128 : i32
    %137 = llvm.sdiv %136, %6 : i32
    %138 = llvm.add %137, %131 : i32
    %139 = llvm.sub %132, %128 : i32
    %140 = llvm.sdiv %139, %6 : i32
    %141 = llvm.sub %132, %140 : i32
    %142 = llvm.icmp "slt" %128, %132 : i32
    %143 = llvm.icmp "sgt" %128, %132 : i32
    ...
    %151 = llvm.insertvalue %149, %150[0] : !llvm.struct<(i32, i32, i32)> 
    %152 = llvm.insertvalue %129, %151[1] : !llvm.struct<(i32, i32, i32)> 
    ...
    %170 = llvm.add %169, %160 : i32
    %171 = llvm.sdiv %170, %4 : i32
    %172 = llvm.add %171, %165 : i32
    %173 = llvm.sub %166, %160 : i32
    %174 = llvm.sdiv %173, %4 : i32
    %175 = llvm.sub %166, %174 : i32
    %176 = llvm.icmp "slt" %160, %166 : i32
    %177 = llvm.icmp "sgt" %160, %166 : i32
    ...
    %185 = llvm.insertvalue %183, %184[0] : !llvm.struct<(i32, i32, i32)> 
    %186 = llvm.insertvalue %161, %185[1] : !llvm.struct<(i32, i32, i32)> 
    ...
    %221 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024_tensorptri8gmemalign128o51211100512_tensor000o1024111000102401112____Float32_Int4_0<%220> (%127, %196, %159, %80, %81, %82) : !cuda.launch_cfg<max_attrs = 2>, (!llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, i32, i32, i32) -> !cuda.result
