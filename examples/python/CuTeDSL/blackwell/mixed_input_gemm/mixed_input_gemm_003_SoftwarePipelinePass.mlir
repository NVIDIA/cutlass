...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %99 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %100 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %104 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %105 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %108 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %109 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %110 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %111 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %112 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %113 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      ...
      %125 = "cute.slice"(%arg4, %124) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, !cute.coord<"(_,?)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">
      %126 = "cute.get_iter"(%125) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %127 = "cute.deref_arith_tuple_iter"(%126) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %128:3 = "cute.get_leaves"(%127) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %129 = "cute.get_scalars"(%128#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %130 = "cute.get_scalars"(%128#1) : (!cute.int_tuple<"?">) -> i32
      %131 = "cute.get_scalars"(%128#2) : (!cute.int_tuple<"?">) -> i32
      %132 = "cute.get_iter"(%125) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %133 = "cute.deref_arith_tuple_iter"(%132) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %134:3 = "cute.get_leaves"(%133) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %135 = "cute.get_scalars"(%134#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %136 = "cute.get_scalars"(%134#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %142 = "cute.composition"(%125, %96) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">, !cute.layout<"(128,8):(8,1)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %143 = "cute.get_iter"(%142) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %144 = "cute.deref_arith_tuple_iter"(%143) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %145:3 = "cute.get_leaves"(%144) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %146 = "cute.get_scalars"(%145#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      ...
      %158 = "cute.slice"(%142, %157) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">, !cute.coord<"(?,_)">) -> !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">
      %159 = "cute.get_iter"(%158) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %160 = "cute.deref_arith_tuple_iter"(%159) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %161:3 = "cute.get_leaves"(%160) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %162 = "cute.get_scalars"(%161#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %163 = "cute.get_scalars"(%161#1) : (!cute.int_tuple<"?">) -> i32
      %164 = "cute.get_scalars"(%161#2) : (!cute.int_tuple<"?">) -> i32
      %165 = "cute.get_iter"(%158) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %166 = "cute.deref_arith_tuple_iter"(%165) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %167:3 = "cute.get_leaves"(%166) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %168 = "cute.get_scalars"(%167#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %169 = "cute.get_scalars"(%167#1) : (!cute.int_tuple<"?">) -> i32
      %170 = "cute.get_scalars"(%167#2) : (!cute.int_tuple<"?">) -> i32
      %171 = "cute.make_coord"() : () -> !cute.coord<"0">
      %172 = "cute.slice"(%158, %171) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">, !cute.coord<"0">) -> !cute.coord_tensor<"(?{div=8},?,?)", "():()">
      ...
      %175:3 = "cute.get_leaves"(%174) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %176 = "cute.get_scalars"(%175#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      ...
      %181:3 = "cute.get_leaves"(%180) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %182 = "cute.get_scalars"(%181#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %183 = "cute.get_scalars"(%181#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %187:3 = "cute.get_leaves"(%186) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %188 = "cute.get_scalars"(%187#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %189 = "cute.get_scalars"(%187#1) : (!cute.int_tuple<"?">) -> i32
      %190 = "cute.get_scalars"(%187#2) : (!cute.int_tuple<"?">) -> i32
      %191 = "cute.make_coord"(%187#0, %187#1, %187#2) : (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?{div=8},?,?)">
      ...
      "scf.if"(%193) ({
        ...
        %264 = "arith.fptosi"(%260) : (vector<8xf32>) -> vector<8xi4>
        ...
        %270 = "builtin.unrealized_conversion_cast"(%264) : (vector<8xi4>) -> vector<8xi4>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_i4_):
    ...
    %93 = "cuda.launch_ex"(%90, %61, %73, %65, %19, %21, %23) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024i64i64_tensorptri8gmemalign128o51211100512i64i64_tensor000o1024111000102401112____Float32_Int4_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, i32, i32, i32) -> !cuda.result
