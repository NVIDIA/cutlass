...
module attributes {gpu.container_module} {
  ...
  ^bb2:  // pred: ^bb0
    ...
    llvm.cond_br %40, ^bb3(%11 : i32), ^bb4
  ^bb3(%41: i32):  // 2 preds: ^bb2, ^bb6
    llvm.br ^bb7
  ^bb4:  // pred: ^bb2
    %42 = llvm.icmp "eq" %23, %13 : i64
    llvm.cond_br %42, ^bb5(%14 : i32), ^bb5(%9 : i32)
  ^bb5(%43: i32):  // 2 preds: ^bb4, ^bb4
    llvm.br ^bb6
  ^bb6:  // pred: ^bb5
    llvm.br ^bb3(%43 : i32)
  ^bb7:  // pred: ^bb3
