...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024i64i64_tensorptri8gmemalign128o51211100512i64i64_tensor000o1024111000102401112____Float32_Int4_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, %arg3: !cute.layout<"(128,8):(8,1)">, %arg4: !cute.layout<"(128,4):(4,1)">, %arg5: i32, %arg6: i32, %arg7: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %lay_10 = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %lay_11 = cute.get_layout(%arg0) : !memref_gmem_f32_
      %lay_12 = cute.get_layout(%arg1) : !memref_gmem_i8_
      %lay_13 = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      ...
      %slice_21 = cute.slice(%arg2, %coord_20) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, !cute.coord<"(_,?)">
      %iter_22 = cute.get_iter(%slice_21) : !cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">
      ...
      %2 = cute.get_scalars(%e0_24) : !cute.int_tuple<"?{div=1024}">
      %3 = cute.get_scalars(%e1_25) : !cute.int_tuple<"?">
      %4 = cute.get_scalars(%e2_26) : !cute.int_tuple<"?">
      %iter_27 = cute.get_iter(%slice_21) : !cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">
      ...
      %5 = cute.get_scalars(%e0_29) : !cute.int_tuple<"?{div=1024}">
      %6 = cute.get_scalars(%e1_30) : !cute.int_tuple<"?">
      ...
      %10 = cute.composition(%slice_21, %arg3) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">, !cute.layout<"(128,8):(8,1)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %iter_34 = cute.get_iter(%10) : !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      ...
      %11 = cute.get_scalars(%e0_36) : !cute.int_tuple<"?{div=1024}">
      %12 = cute.get_scalars(%e1_37) : !cute.int_tuple<"?">
      ...
      %slice_48 = cute.slice(%10, %coord_47) : !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">, !cute.coord<"(?,_)">
      %iter_49 = cute.get_iter(%slice_48) : !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">
      ...
      %14 = cute.get_scalars(%e0_51) : !cute.int_tuple<"?{div=8}">
      %15 = cute.get_scalars(%e1_52) : !cute.int_tuple<"?">
      %16 = cute.get_scalars(%e2_53) : !cute.int_tuple<"?">
      %iter_54 = cute.get_iter(%slice_48) : !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">
      ...
      %17 = cute.get_scalars(%e0_56) : !cute.int_tuple<"?{div=8}">
      %18 = cute.get_scalars(%e1_57) : !cute.int_tuple<"?">
      %19 = cute.get_scalars(%e2_58) : !cute.int_tuple<"?">
      %coord_59 = cute.make_coord() : () -> !cute.coord<"0">
      %slice_60 = cute.slice(%slice_48, %coord_59) : !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">, !cute.coord<"0">
      ...
      %20 = cute.get_scalars(%e0_63) : !cute.int_tuple<"?{div=8}">
      %21 = cute.get_scalars(%e1_64) : !cute.int_tuple<"?">
      ...
      %23 = cute.get_scalars(%e0_68) : !cute.int_tuple<"?{div=8}">
      %24 = cute.get_scalars(%e1_69) : !cute.int_tuple<"?">
      ...
      %26 = cute.get_scalars(%e0_73) : !cute.int_tuple<"?{div=8}">
      %27 = cute.get_scalars(%e1_74) : !cute.int_tuple<"?">
      %28 = cute.get_scalars(%e2_75) : !cute.int_tuple<"?">
      %coord_76 = cute.make_coord(%e0_73, %e1_74, %e2_75) : (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?{div=8},?,?)">
      ...
      scf.if %29 {
        ...
        %47 = arith.fptosi %45 : vector<8xf32> to vector<8xi4>
        ...
        %50 = builtin.unrealized_conversion_cast %47 : vector<8xi4> to vector<8xi4>
  ...
  func.func @cutlass__convert_Tensorgmemo1i64i64_Tensorgmemo1i64i64_0_8(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_i4_) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %lay_3 = cute.get_layout(%arg1) : !memref_gmem_i4_
    ...
    %iter_5 = cute.recast_iter(%iter_2) : !cute.ptr<i4, gmem, align<128>> to !cute.ptr<i8, gmem, align<128>>
    %lay_6 = cute.get_layout(%arg1) : !memref_gmem_i4_
    %1 = cute.recast_layout<8, 4> (%lay_6) : !cute.layout<"(?,?,?):(1,?{i64},?{i64})"> to !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    ...
    %2 = cute.get_shape(%lay_8) : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %6 = cute.get_shape(%lay_11) : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %11 = cute.get_shape(%lay_23) : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %tile_42 = cute.make_tile() : () -> !cute.tile<"[1024:1;1:0;1:0]">
    %div_43 = cute.zipped_divide(%10, %tile_42) : !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@0,1@1,1@2)">, !cute.tile<"[1024:1;1:0;1:0]">
    %iter_44 = cute.get_iter(%div_43) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    ...
    %iter_49 = cute.get_iter(%div_43) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    ...
    %tile_54 = cute.make_tile() : () -> !cute.tile<"[512:1;1:0;1:0]">
    %div_55 = cute.zipped_divide(%view, %tile_54) : !memref_gmem_i8_6, !cute.tile<"[512:1;1:0;1:0]">
    ...
    %lay_64 = cute.get_layout(%div_43) : !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
