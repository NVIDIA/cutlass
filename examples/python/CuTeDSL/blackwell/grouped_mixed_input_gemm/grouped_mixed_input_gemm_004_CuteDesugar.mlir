...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %124 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %125 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %129 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %130 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %133 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %134 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %135 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      ...
      %142 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %143 = "cute.crd2idx"(%141, %142) : (!cute.coord<"(_,?)">, !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.int_tuple<"?{i64}">
      ...
      %150 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %151 = "cute.crd2idx"(%149, %150) : (!cute.coord<"(_,?)">, !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">) -> !cute.int_tuple<"?{i64}">
      %152 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %153 = "cute.add_offset"(%152, %151) : (!cute.ptr<i8, gmem, align<128>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      ...
      %158 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %159 = "cute.crd2idx"(%157, %158) : (!cute.coord<"(_,?)">, !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %160 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      %161 = "cute.add_offset"(%160, %159) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.int_tuple<"(?{div=1024},?,?)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %162 = "cute.make_view"(%161) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">
      %163 = "cute.get_iter"(%162) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %164 = "cute.deref_arith_tuple_iter"(%163) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %165:3 = "cute.get_leaves"(%164) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %166 = "cute.get_scalars"(%165#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %167 = "cute.get_scalars"(%165#1) : (!cute.int_tuple<"?">) -> i32
      %168 = "cute.get_scalars"(%165#2) : (!cute.int_tuple<"?">) -> i32
      %169 = "cute.get_iter"(%162) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %170 = "cute.deref_arith_tuple_iter"(%169) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %171:3 = "cute.get_leaves"(%170) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %172 = "cute.get_scalars"(%171#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      ...
      %181 = "cute.get_iter"(%162) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %182 = "cute.make_view"(%181) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %183 = "cute.get_iter"(%182) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %184 = "cute.deref_arith_tuple_iter"(%183) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %185:3 = "cute.get_leaves"(%184) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %186 = "cute.get_scalars"(%185#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      ...
      %206 = "cute.get_layout"(%182) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.layout<"(128,8):(8@0,1@0)">
      %207 = "cute.crd2idx"(%205, %206) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@0,1@0)">) -> !cute.int_tuple<"(?{div=8})">
      %208 = "cute.get_iter"(%182) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %209 = "cute.add_offset"(%208, %207) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">, !cute.int_tuple<"(?{div=8})">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %210 = "cute.make_view"(%209) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">
      %211 = "cute.get_iter"(%210) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %212 = "cute.deref_arith_tuple_iter"(%211) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %213:3 = "cute.get_leaves"(%212) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %214 = "cute.get_scalars"(%213#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %215 = "cute.get_scalars"(%213#1) : (!cute.int_tuple<"?">) -> i32
      %216 = "cute.get_scalars"(%213#2) : (!cute.int_tuple<"?">) -> i32
      %217 = "cute.get_iter"(%210) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %218 = "cute.deref_arith_tuple_iter"(%217) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %219:3 = "cute.get_leaves"(%218) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %220 = "cute.get_scalars"(%219#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %221 = "cute.get_scalars"(%219#1) : (!cute.int_tuple<"?">) -> i32
      %222 = "cute.get_scalars"(%219#2) : (!cute.int_tuple<"?">) -> i32
      %223 = "cute.make_coord"() : () -> !cute.coord<"0">
      %224 = "cute.get_layout"(%210) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.layout<"(8):(1@0)">
      %225 = "cute.crd2idx"(%223, %224) : (!cute.coord<"0">, !cute.layout<"(8):(1@0)">) -> !cute.int_tuple<"(0)">
      %226 = "cute.get_iter"(%210) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %227 = "cute.add_offset"(%226, %225) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">, !cute.int_tuple<"(0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      ...
      %231:3 = "cute.get_leaves"(%230) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %232 = "cute.get_scalars"(%231#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %233 = "cute.get_scalars"(%231#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %237:3 = "cute.get_leaves"(%236) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %238 = "cute.get_scalars"(%237#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      ...
      %243:3 = "cute.get_leaves"(%242) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %244 = "cute.get_scalars"(%243#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %245 = "cute.get_scalars"(%243#1) : (!cute.int_tuple<"?">) -> i32
      %246 = "cute.get_scalars"(%243#2) : (!cute.int_tuple<"?">) -> i32
      %247 = "cute.make_coord"(%243#0, %243#1, %243#2) : (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?{div=8},?,?)">
      ...
      "scf.if"(%249) ({
        ...
        %337 = "arith.fptosi"(%333) : (vector<8xf32>) -> vector<8xi4>
        ...
        %343 = "builtin.unrealized_conversion_cast"(%337) : (vector<8xi4>) -> vector<8xi4>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_i4_):
    ...
    %62 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %63:5 = "cute.get_scalars"(%62) <{only_dynamic}> : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> (i32, i32, i32, i64, i64)
    %64 = "arith.constant"() <{value = 1024 : i32}> : () -> i32
    %65 = "arith.ceildivsi"(%63#0, %64) : (i32, i32) -> i32
    %66 = "cute.make_shape"(%65, %63#1, %63#2) : (i32, i32, i32) -> !cute.shape<"((1024,1,1),(?,?,?))">
    %67 = "cute.make_stride"(%63#3, %63#4) : (i64, i64) -> !cute.stride<"((1,0,0),(1024,?{i64},?{i64}))">
    %68 = "cute.make_layout"(%66, %67) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1024,1,1),(?,?,?))">, !cute.stride<"((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %69 = "cute.make_view"(%61, %68) : (!cute.ptr<f32, gmem>, !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !memref_gmem_f32_
    %70 = "cute.get_iter"(%69) : (!memref_gmem_f32_) -> !cute.ptr<f32, gmem>
    %71 = "cute.get_iter"(%69) : (!memref_gmem_f32_) -> !cute.ptr<f32, gmem>
    %72 = "cute.make_tile"() : () -> !cute.tile<"[1024:1;1:0;1:0]">
    ...
    %77 = "arith.ceildivsi"(%75#0, %76) : (i32, i32) -> i32
    %78 = "cute.make_shape"(%77, %75#1, %75#2) : (i32, i32, i32) -> !cute.shape<"((1024,1,1),(?,?,?))">
    %79 = "cute.make_stride"() : () -> !cute.stride<"((1@0,0,0),(1024@0,1@1,1@2))">
    %80 = "cute.make_layout"(%78, %79) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1024,1,1),(?,?,?))">, !cute.stride<"((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    %81 = "cute.make_view"(%73, %80) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    %82 = "cute.get_iter"(%81) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
    ...
    %85 = "cute.get_iter"(%81) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
    ...
    %88 = "cute.make_tile"() : () -> !cute.tile<"[512:1;1:0;1:0]">
    %89 = "cute.get_iter"(%13) : (!memref_gmem_i8_6) -> !cute.ptr<i8, gmem, align<128>>
    %90 = "cute.get_layout"(%13) : (!memref_gmem_i8_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %91:5 = "cute.get_scalars"(%90) <{only_dynamic}> : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> (i32, i32, i32, i64, i64)
    %92 = "arith.constant"() <{value = 512 : i32}> : () -> i32
    %93 = "arith.ceildivsi"(%91#0, %92) : (i32, i32) -> i32
    %94 = "cute.make_shape"(%93, %91#1, %91#2) : (i32, i32, i32) -> !cute.shape<"((512,1,1),(?,?,?))">
    %95 = "cute.make_stride"(%91#3, %91#4) : (i64, i64) -> !cute.stride<"((1,0,0),(512,?{i64},?{i64}))">
    ...
    %97 = "cute.make_view"(%89, %96) : (!cute.ptr<i8, gmem, align<128>>, !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">) -> !memref_gmem_i8_
    %98 = "cute.get_iter"(%97) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
    %99 = "cute.get_iter"(%97) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
    %100 = "cute.get_layout"(%69) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %101 = "cute.size"(%100) <{mode = array<i32: 1>}> : (!cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %106 = "cute.get_layout"(%69) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %107 = "cute.get_layout"(%97) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
    %108 = "cute.get_layout"(%81) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    ...
    %118 = "cuda.launch_ex"(%115, %69, %97, %81, %19, %21, %23) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024i64i64_tensorptri8gmemalign128o51211100512i64i64_tensor000o1024111000102401112____Float32_Int4_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, i32, i32, i32) -> !cuda.result
