...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %127 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %128 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %132 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %133 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %136 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %137 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %138 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %139 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %140 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %141 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %142 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %143 = "nvvm.read.ptx.sreg.ctaid.x"() : () -> i32
      %144 = "cute.make_coord"(%143) : (i32) -> !cute.coord<"(_,?)">
      %145 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
      %146 = "cute.crd2idx"(%144, %145) : (!cute.coord<"(_,?)">, !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.int_tuple<"?{i64}">
      ...
      %153 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
      %154 = "cute.crd2idx"(%152, %153) : (!cute.coord<"(_,?)">, !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">) -> !cute.int_tuple<"?{i64}">
      %155 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
      %156 = "cute.add_offset"(%155, %154) : (!cute.ptr<i8, gmem, align<128>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      ...
      %161 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
      %162 = "cute.crd2idx"(%160, %161) : (!cute.coord<"(_,?)">, !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %163 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      %164 = "cute.add_offset"(%163, %162) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.int_tuple<"(?{div=1024},?,?)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %165 = "cute.make_view"(%164) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">
      %166 = "cute.get_iter"(%165) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %167 = "cute.deref_arith_tuple_iter"(%166) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %168:3 = "cute.get_leaves"(%167) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %169 = "cute.get_scalars"(%168#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %170 = "cute.get_scalars"(%168#1) : (!cute.int_tuple<"?">) -> i32
      %171 = "cute.get_scalars"(%168#2) : (!cute.int_tuple<"?">) -> i32
      %172 = "cute.get_iter"(%165) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %173 = "cute.deref_arith_tuple_iter"(%172) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %174:3 = "cute.get_leaves"(%173) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %175 = "cute.get_scalars"(%174#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %176 = "cute.get_scalars"(%174#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %184 = "cute.get_iter"(%165) : (!cute.coord_tensor<"(?{div=1024},?,?)", "((1024,1,1)):((1@0,0,0))">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %185 = "cute.make_view"(%184) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">
      %186 = "cute.get_iter"(%185) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %187 = "cute.deref_arith_tuple_iter"(%186) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">) -> !cute.int_tuple<"(?{div=1024},?,?)">
      %188:3 = "cute.get_leaves"(%187) : (!cute.int_tuple<"(?{div=1024},?,?)">) -> (!cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %189 = "cute.get_scalars"(%188#0) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %190 = "cute.get_scalars"(%188#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %209 = "cute.get_layout"(%185) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.layout<"(128,8):(8@0,1@0)">
      %210 = "cute.crd2idx"(%208, %209) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@0,1@0)">) -> !cute.int_tuple<"(?{div=8})">
      %211 = "cute.get_iter"(%185) : (!cute.coord_tensor<"(?{div=1024},?,?)", "(128,8):(8@0,1@0)">) -> !cute.arith_tuple_iter<"(?{div=1024},?,?)">
      %212 = "cute.add_offset"(%211, %210) : (!cute.arith_tuple_iter<"(?{div=1024},?,?)">, !cute.int_tuple<"(?{div=8})">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %213 = "cute.make_view"(%212) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">
      %214 = "cute.get_iter"(%213) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %215 = "cute.deref_arith_tuple_iter"(%214) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %216:3 = "cute.get_leaves"(%215) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %217 = "cute.get_scalars"(%216#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %218 = "cute.get_scalars"(%216#1) : (!cute.int_tuple<"?">) -> i32
      %219 = "cute.get_scalars"(%216#2) : (!cute.int_tuple<"?">) -> i32
      %220 = "cute.get_iter"(%213) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %221 = "cute.deref_arith_tuple_iter"(%220) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">) -> !cute.int_tuple<"(?{div=8},?,?)">
      %222:3 = "cute.get_leaves"(%221) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %223 = "cute.get_scalars"(%222#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %224 = "cute.get_scalars"(%222#1) : (!cute.int_tuple<"?">) -> i32
      %225 = "cute.get_scalars"(%222#2) : (!cute.int_tuple<"?">) -> i32
      %226 = "cute.make_coord"() : () -> !cute.coord<"0">
      %227 = "cute.get_layout"(%213) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.layout<"(8):(1@0)">
      %228 = "cute.crd2idx"(%226, %227) : (!cute.coord<"0">, !cute.layout<"(8):(1@0)">) -> !cute.int_tuple<"(0)">
      %229 = "cute.get_iter"(%213) : (!cute.coord_tensor<"(?{div=8},?,?)", "(8):(1@0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      %230 = "cute.add_offset"(%229, %228) : (!cute.arith_tuple_iter<"(?{div=8},?,?)">, !cute.int_tuple<"(0)">) -> !cute.arith_tuple_iter<"(?{div=8},?,?)">
      ...
      %234:3 = "cute.get_leaves"(%233) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %235 = "cute.get_scalars"(%234#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %236 = "cute.get_scalars"(%234#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %240:3 = "cute.get_leaves"(%239) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %241 = "cute.get_scalars"(%240#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %242 = "cute.get_scalars"(%240#1) : (!cute.int_tuple<"?">) -> i32
      ...
      %246:3 = "cute.get_leaves"(%245) : (!cute.int_tuple<"(?{div=8},?,?)">) -> (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">)
      %247 = "cute.get_scalars"(%246#0) : (!cute.int_tuple<"?{div=8}">) -> i32
      %248 = "cute.get_scalars"(%246#1) : (!cute.int_tuple<"?">) -> i32
      %249 = "cute.get_scalars"(%246#2) : (!cute.int_tuple<"?">) -> i32
      %250 = "cute.make_coord"(%246#0, %246#1, %246#2) : (!cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">, !cute.int_tuple<"?">) -> !cute.coord<"(?{div=8},?,?)">
      ...
      "scf.if"(%260) ({
        ...
        %348 = "arith.fptosi"(%344) : (vector<8xf32>) -> vector<8xi4>
        ...
        %354 = "builtin.unrealized_conversion_cast"(%348) : (vector<8xi4>) -> vector<8xi4>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_i4_):
    ...
    %41 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %42 = "cute.get_shape"(%41) : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %52 = "cute.get_layout"(%13) : (!memref_gmem_i8_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %53 = "cute.get_shape"(%52) : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %63 = "cute.make_tile"() : () -> !cute.tile<"[1024:1;1:0;1:0]">
    %64 = "cute.get_iter"(%arg0) : (!memref_gmem_f32_6) -> !cute.ptr<f32, gmem>
    %65 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %66:5 = "cute.get_scalars"(%65) <{only_dynamic}> : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> (i32, i32, i32, i64, i64)
    %67 = "arith.constant"() <{value = 1024 : i32}> : () -> i32
    %68 = "arith.ceildivsi"(%66#0, %67) : (i32, i32) -> i32
    %69 = "cute.make_shape"(%68, %66#1, %66#2) : (i32, i32, i32) -> !cute.shape<"((1024,1,1),(?,?,?))">
    %70 = "cute.make_stride"(%66#3, %66#4) : (i64, i64) -> !cute.stride<"((1,0,0),(1024,?{i64},?{i64}))">
    %71 = "cute.make_layout"(%69, %70) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1024,1,1),(?,?,?))">, !cute.stride<"((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %72 = "cute.make_view"(%64, %71) : (!cute.ptr<f32, gmem>, !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !memref_gmem_f32_
    %73 = "cute.get_iter"(%72) : (!memref_gmem_f32_) -> !cute.ptr<f32, gmem>
    %74 = "cute.get_iter"(%72) : (!memref_gmem_f32_) -> !cute.ptr<f32, gmem>
    %75 = "cute.make_tile"() : () -> !cute.tile<"[1024:1;1:0;1:0]">
    ...
    %80 = "arith.ceildivsi"(%78#0, %79) : (i32, i32) -> i32
    %81 = "cute.make_shape"(%80, %78#1, %78#2) : (i32, i32, i32) -> !cute.shape<"((1024,1,1),(?,?,?))">
    %82 = "cute.make_stride"() : () -> !cute.stride<"((1@0,0,0),(1024@0,1@1,1@2))">
    %83 = "cute.make_layout"(%81, %82) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1024,1,1),(?,?,?))">, !cute.stride<"((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    %84 = "cute.make_view"(%76, %83) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    %85 = "cute.get_iter"(%84) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
    ...
    %88 = "cute.get_iter"(%84) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
    ...
    %91 = "cute.make_tile"() : () -> !cute.tile<"[512:1;1:0;1:0]">
    %92 = "cute.get_iter"(%13) : (!memref_gmem_i8_6) -> !cute.ptr<i8, gmem, align<128>>
    %93 = "cute.get_layout"(%13) : (!memref_gmem_i8_6) -> !cute.layout<"(?,?,?):(1,?{i64},?{i64})">
    %94:5 = "cute.get_scalars"(%93) <{only_dynamic}> : (!cute.layout<"(?,?,?):(1,?{i64},?{i64})">) -> (i32, i32, i32, i64, i64)
    %95 = "arith.constant"() <{value = 512 : i32}> : () -> i32
    %96 = "arith.ceildivsi"(%94#0, %95) : (i32, i32) -> i32
    %97 = "cute.make_shape"(%96, %94#1, %94#2) : (i32, i32, i32) -> !cute.shape<"((512,1,1),(?,?,?))">
    %98 = "cute.make_stride"(%94#3, %94#4) : (i64, i64) -> !cute.stride<"((1,0,0),(512,?{i64},?{i64}))">
    %99 = "cute.make_layout"(%97, %98) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((512,1,1),(?,?,?))">, !cute.stride<"((1,0,0),(512,?{i64},?{i64}))">) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
    %100 = "cute.make_view"(%92, %99) : (!cute.ptr<i8, gmem, align<128>>, !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">) -> !memref_gmem_i8_
    %101 = "cute.get_iter"(%100) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
    %102 = "cute.get_iter"(%100) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<128>>
    %103 = "cute.get_layout"(%72) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %104 = "cute.size"(%103) <{mode = array<i32: 1>}> : (!cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %109 = "cute.get_layout"(%72) : (!memref_gmem_f32_) -> !cute.layout<"((1024,1,1),(?,?,?)):((1,0,0),(1024,?{i64},?{i64}))">
    %110 = "cute.get_layout"(%100) : (!memref_gmem_i8_) -> !cute.layout<"((512,1,1),(?,?,?)):((1,0,0),(512,?{i64},?{i64}))">
    %111 = "cute.get_layout"(%84) : (!cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">) -> !cute.layout<"((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">
    ...
    %121 = "cuda.launch_ex"(%118, %72, %100, %84, %19, %21, %23) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1024111001024i64i64_tensorptri8gmemalign128o51211100512i64i64_tensor000o1024111000102401112____Float32_Int4_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1024,1,1),(?,?,?)):((1@0,0,0),(1024@0,1@1,1@2))">, i32, i32, i32) -> !cuda.result
