...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb14(%596: i32, %597: i32, %598: i32, %599: i32):  // 2 preds: ^bb13, ^bb27
      %600 = llvm.icmp "slt" %596, %588 : i32
      llvm.cond_br %600, ^bb15, ^bb28 {loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
    ...
    ^bb22(%640: i32):  // 2 preds: ^bb21, ^bb23
      %641 = llvm.icmp "slt" %640, %592 : i32
      llvm.cond_br %641, ^bb23, ^bb24 {llvm.loop_annotation = #loop_annotation1}
    ^bb23:  // pred: ^bb22
    ...
    ^bb24:  // pred: ^bb22
      ...
      llvm.br ^bb25(%165 : i32)
    ^bb25(%669: i32):  // 2 preds: ^bb24, ^bb26
      %670 = llvm.icmp "slt" %669, %592 : i32
      llvm.cond_br %670, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation1}
    ^bb26:  // pred: ^bb25
    ...
    ^bb28:  // pred: ^bb14
      ...
      llvm.br ^bb29(%165, %676, %674, %597, %598, %599, %165, %165, %165, %arg0 : i32, i1, i1, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb29(%679: i32, %680: i1, %681: i1, %682: i32, %683: i32, %684: i32, %685: i32, %686: i32, %687: i32, %688: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb68
      %689 = llvm.icmp "slt" %679, %439 : i32
      llvm.cond_br %689, ^bb30, ^bb69
    ^bb30:  // pred: ^bb29
      %690 = llvm.icmp "sgt" %677, %679 : i32
      llvm.cond_br %690, ^bb31, ^bb46
    ^bb31:  // pred: ^bb30
      %691 = llvm.zext %680 : i1 to i32
      %692 = llvm.icmp "eq" %691, %165 : i32
      llvm.cond_br %692, ^bb32, ^bb33
    ^bb32:  // pred: ^bb31
    ...
    ^bb35:  // 2 preds: ^bb33, ^bb34
      ...
      llvm.cond_br %698, ^bb36, ^bb37
    ^bb36:  // pred: ^bb35
      %700 = llvm.xor %684, %164 : i32
      llvm.br ^bb38(%700 : i32)
    ^bb37:  // pred: ^bb35
      llvm.br ^bb38(%684 : i32)
    ^bb38(%701: i32):  // 2 preds: ^bb36, ^bb37
      llvm.br ^bb39
    ^bb39:  // pred: ^bb38
      ...
      llvm.br ^bb40(%165 : i32)
    ^bb40(%736: i32):  // 2 preds: ^bb39, ^bb41
      %737 = llvm.icmp "slt" %736, %729 : i32
      llvm.cond_br %737, ^bb41, ^bb42 {llvm.loop_annotation = #loop_annotation1}
    ^bb41:  // pred: ^bb40
    ...
    ^bb42:  // pred: ^bb40
      ...
      llvm.br ^bb43(%165 : i32)
    ^bb43(%768: i32):  // 2 preds: ^bb42, ^bb44
      %769 = llvm.icmp "slt" %768, %729 : i32
      llvm.cond_br %769, ^bb44, ^bb45 {llvm.loop_annotation = #loop_annotation1}
    ^bb44:  // pred: ^bb43
      ...
      llvm.br ^bb43(%771 : i32)
    ^bb45:  // pred: ^bb43
      llvm.br ^bb47(%697, %699, %701 : i32, i32, i32)
    ^bb46:  // pred: ^bb30
      llvm.br ^bb47(%682, %683, %684 : i32, i32, i32)
    ^bb47(%772: i32, %773: i32, %774: i32):  // 2 preds: ^bb45, ^bb46
      llvm.br ^bb48
    ^bb48:  // pred: ^bb47
      %775 = llvm.zext %681 : i1 to i32
      %776 = llvm.icmp "eq" %775, %165 : i32
      llvm.cond_br %776, ^bb49, ^bb50
    ^bb49:  // pred: ^bb48
    ...
    ^bb50:  // 2 preds: ^bb48, ^bb49
      ...
      llvm.cond_br %780, ^bb51, ^bb52
    ^bb51:  // pred: ^bb50
      %782 = llvm.xor %687, %164 : i32
      llvm.br ^bb53(%782 : i32)
    ^bb52:  // pred: ^bb50
      llvm.br ^bb53(%687 : i32)
    ^bb53(%783: i32):  // 2 preds: ^bb51, ^bb52
      llvm.br ^bb54
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%165, %688 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb55(%784: i32, %785: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb54, ^bb65
      %786 = llvm.icmp "slt" %784, %136 : i32
      llvm.cond_br %786, ^bb56, ^bb66 {loop_annotation = #loop_annotation2}
    ^bb56:  // pred: ^bb55
      ...
      llvm.br ^bb57(%165 : i32)
    ^bb57(%820: i32):  // 2 preds: ^bb56, ^bb64
      %821 = llvm.icmp "slt" %820, %678 : i32
      llvm.cond_br %821, ^bb58, ^bb65 {llvm.loop_annotation = #loop_annotation1}
    ^bb58:  // pred: ^bb57
      llvm.br ^bb59(%165 : i32)
    ^bb59(%822: i32):  // 2 preds: ^bb58, ^bb63
      %823 = llvm.icmp "slt" %822, %678 : i32
      llvm.cond_br %823, ^bb60, ^bb64 {llvm.loop_annotation = #loop_annotation1}
    ^bb60:  // pred: ^bb59
      llvm.br ^bb61(%165 : i32)
    ^bb61(%824: i32):  // 2 preds: ^bb60, ^bb62
      %825 = llvm.icmp "slt" %824, %678 : i32
      llvm.cond_br %825, ^bb62, ^bb63 {llvm.loop_annotation = #loop_annotation1}
    ^bb62:  // pred: ^bb61
    ...
    ^bb68:  // 2 preds: ^bb66, ^bb67
      ...
      llvm.br ^bb29(%840, %837, %839, %772, %773, %774, %779, %781, %783, %785 : i32, i1, i1, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb69:  // pred: ^bb29
      %841 = nvvm.elect.sync -> i1
      llvm.cond_br %841, ^bb70, ^bb71
    ^bb70:  // pred: ^bb69
      nvvm.tcgen05.commit.arrive %201 : !llvm.ptr<3>
      llvm.br ^bb71
    ^bb71:  // 2 preds: ^bb69, ^bb70
      llvm.br ^bb73(%683, %684 : i32, i32)
    ^bb72:  // pred: ^bb12
      llvm.br ^bb73(%165, %164 : i32, i32)
    ^bb73(%842: i32, %843: i32):  // 2 preds: ^bb71, ^bb72
      llvm.br ^bb74
    ^bb74:  // pred: ^bb73
      llvm.cond_br %192, ^bb75, ^bb76
    ^bb75:  // pred: ^bb74
    ...
    ^bb76:  // 2 preds: ^bb74, ^bb75
      ...
      llvm.br ^bb77(%165 : i32)
    ^bb77(%938: i32):  // 2 preds: ^bb76, ^bb78
      %939 = llvm.icmp "slt" %938, %937 : i32
      llvm.cond_br %939, ^bb78, ^bb79 {llvm.loop_annotation = #loop_annotation1}
    ^bb78:  // pred: ^bb77
    ...
    ^bb79:  // pred: ^bb77
      ...
      llvm.br ^bb80(%165 : i32)
    ^bb80(%1464: i32):  // 2 preds: ^bb79, ^bb81
      %1465 = llvm.icmp "slt" %1464, %937 : i32
      llvm.cond_br %1465, ^bb81, ^bb82 {llvm.loop_annotation = #loop_annotation1}
    ^bb81:  // pred: ^bb80
