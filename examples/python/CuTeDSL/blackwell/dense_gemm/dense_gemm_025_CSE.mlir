...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb15:  // pred: ^bb14
      ...
      nvvm.mbarrier.try_wait.parity.shared %201, %199, %21 : !llvm.ptr<3>, i32, i32
    ...
    ^bb33(%228: i32, %229: i1, %230: i1, %231: i32, %232: i32, %233: i32, %234: i32, %235: i32, %236: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb32, ^bb78
      %237 = llvm.icmp "slt" %228, %114 : i32
      llvm.cond_br %237, ^bb34, ^bb79
    ^bb34:  // pred: ^bb33
      %238 = llvm.icmp "sgt" %227, %228 : i32
      llvm.cond_br %238, ^bb35, ^bb54
    ^bb35:  // pred: ^bb34
    ...
    ^bb36:  // pred: ^bb35
      ...
      nvvm.mbarrier.try_wait.parity.shared %241, %233, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb37
    ...
    ^bb49(%259: i32):  // 2 preds: ^bb48, ^bb52
      ...
      llvm.cond_br %260, ^bb50, ^bb53 {llvm.loop_annotation = #loop_annotation1}
    ^bb50:  // pred: ^bb49
    ...
    ^bb53:  // pred: ^bb49
      llvm.br ^bb55(%245, %247, %249 : i32, i32, i32)
    ^bb54:  // pred: ^bb34
      llvm.br ^bb55(%231, %232, %233 : i32, i32, i32)
    ^bb55(%263: i32, %264: i32, %265: i32):  // 2 preds: ^bb53, ^bb54
      llvm.br ^bb56
    ^bb56:  // pred: ^bb55
    ...
    ^bb57:  // pred: ^bb56
      ...
      nvvm.mbarrier.try_wait.parity.shared %268, %235, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb58
    ^bb58:  // 2 preds: ^bb56, ^bb57
      %269 = llvm.add %234, %32 : i32
      %270 = llvm.icmp "eq" %269, %23 : i32
      %271 = llvm.select %270, %16, %269 : i1, i32
      llvm.cond_br %270, ^bb59, ^bb60
    ^bb59:  // pred: ^bb58
      %272 = llvm.xor %235, %32 : i32
      llvm.br ^bb61(%272 : i32)
    ^bb60:  // pred: ^bb58
      llvm.br ^bb61(%235 : i32)
    ^bb61(%273: i32):  // 2 preds: ^bb59, ^bb60
      llvm.br ^bb62
    ^bb62:  // pred: ^bb61
      llvm.br ^bb63(%16, %236 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb63(%274: i32, %275: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb62, ^bb75
      %276 = llvm.icmp "slt" %274, %24 : i32
      llvm.cond_br %276, ^bb64, ^bb76 {loop_annotation = #loop_annotation2}
    ^bb64:  // pred: ^bb63
      ...
      llvm.br ^bb65(%16 : i32)
    ^bb65(%299: i32):  // 2 preds: ^bb64, ^bb74
      %300 = llvm.icmp "slt" %299, %32 : i32
      llvm.cond_br %300, ^bb66, ^bb75 {llvm.loop_annotation = #loop_annotation1}
    ^bb66:  // pred: ^bb65
      llvm.br ^bb67(%16 : i32)
    ^bb67(%301: i32):  // 2 preds: ^bb66, ^bb73
      %302 = llvm.icmp "slt" %301, %32 : i32
      llvm.cond_br %302, ^bb68, ^bb74 {llvm.loop_annotation = #loop_annotation1}
    ^bb68:  // pred: ^bb67
      llvm.br ^bb69(%16 : i32)
    ^bb69(%303: i32):  // 2 preds: ^bb68, ^bb72
      %304 = llvm.icmp "slt" %303, %32 : i32
      llvm.cond_br %304, ^bb70, ^bb73 {llvm.loop_annotation = #loop_annotation1}
    ^bb70:  // pred: ^bb69
      %305 = llvm.inttoptr %189 : i32 to !llvm.ptr<6>
      %306 = nvvm.elect.sync -> i1
      llvm.cond_br %306, ^bb71, ^bb72
    ^bb71:  // pred: ^bb70
    ...
    ^bb79:  // pred: ^bb33
      ...
      llvm.cond_br %319, ^bb80, ^bb81
    ^bb80:  // pred: ^bb79
      nvvm.tcgen05.commit.arrive %59 : !llvm.ptr<3>
      llvm.br ^bb81
    ^bb81:  // 2 preds: ^bb79, ^bb80
      llvm.br ^bb83(%232, %233 : i32, i32)
    ^bb82:  // pred: ^bb12
      llvm.br ^bb83(%16, %32 : i32, i32)
    ^bb83(%320: i32, %321: i32):  // 2 preds: ^bb81, ^bb82
      llvm.br ^bb84
    ^bb84:  // pred: ^bb83
    ...
    ^bb86:  // 2 preds: ^bb84, ^bb85
      ...
      llvm.br ^bb87(%16 : i32)
    ^bb87(%372: i32):  // 2 preds: ^bb86, ^bb88
      %373 = llvm.icmp "slt" %372, %32 : i32
      llvm.cond_br %373, ^bb88, ^bb89 {llvm.loop_annotation = #loop_annotation1}
    ^bb88:  // pred: ^bb87
    ...
    ^bb89:  // pred: ^bb87
      ...
      llvm.br ^bb90(%16 : i32)
    ^bb90(%632: i32):  // 2 preds: ^bb89, ^bb91
      %633 = llvm.icmp "slt" %632, %32 : i32
      llvm.cond_br %633, ^bb91, ^bb92 {llvm.loop_annotation = #loop_annotation1}
    ^bb91:  // pred: ^bb90
    ...
    ^bb95:  // pred: ^bb94
      ...
      llvm.cond_br %765, ^bb96, ^bb97
    ^bb96:  // pred: ^bb95
      %767 = llvm.xor %321, %32 : i32
      llvm.br ^bb98(%767 : i32)
    ^bb97:  // pred: ^bb95
      llvm.br ^bb98(%321 : i32)
    ^bb98(%768: i32):  // 2 preds: ^bb96, ^bb97
      llvm.br ^bb99
    ^bb99:  // pred: ^bb98
      %769 = llvm.add %766, %32 : i32
      %770 = llvm.icmp "eq" %769, %23 : i32
      %771 = llvm.select %770, %16, %769 : i1, i32
      llvm.cond_br %770, ^bb100, ^bb101
    ^bb100:  // pred: ^bb99
      %772 = llvm.xor %768, %32 : i32
      llvm.br ^bb102(%772 : i32)
    ^bb101:  // pred: ^bb99
      llvm.br ^bb102(%768 : i32)
    ^bb102(%773: i32):  // 2 preds: ^bb100, ^bb101
      llvm.br ^bb103
    ^bb103:  // pred: ^bb102
      %774 = llvm.add %771, %32 : i32
      %775 = llvm.icmp "eq" %774, %23 : i32
      %776 = llvm.select %775, %16, %774 : i1, i32
      llvm.cond_br %775, ^bb104, ^bb105
    ^bb104:  // pred: ^bb103
      %777 = llvm.xor %773, %32 : i32
      llvm.br ^bb106(%777 : i32)
    ^bb105:  // pred: ^bb103
      llvm.br ^bb106(%773 : i32)
    ^bb106(%778: i32):  // 2 preds: ^bb104, ^bb105
      llvm.br ^bb107
    ^bb107:  // pred: ^bb106
      %779 = llvm.add %776, %32 : i32
      %780 = llvm.icmp "eq" %779, %23 : i32
      %781 = llvm.select %780, %16, %779 : i1, i32
      llvm.cond_br %780, ^bb108, ^bb109
    ^bb108:  // pred: ^bb107
      %782 = llvm.xor %778, %32 : i32
      llvm.br ^bb110(%782 : i32)
    ^bb109:  // pred: ^bb107
      llvm.br ^bb110(%778 : i32)
    ^bb110(%783: i32):  // 2 preds: ^bb108, ^bb109
      llvm.br ^bb111
    ^bb111:  // pred: ^bb110
      %784 = llvm.add %781, %32 : i32
      %785 = llvm.icmp "eq" %784, %23 : i32
      %786 = llvm.select %785, %16, %784 : i1, i32
      llvm.cond_br %785, ^bb112, ^bb113
    ^bb112:  // pred: ^bb111
      %787 = llvm.xor %783, %32 : i32
      llvm.br ^bb114(%787 : i32)
    ^bb113:  // pred: ^bb111
      llvm.br ^bb114(%783 : i32)
    ^bb114(%788: i32):  // 2 preds: ^bb112, ^bb113
      llvm.br ^bb115
    ^bb115:  // pred: ^bb114
      %789 = llvm.add %786, %32 : i32
      %790 = llvm.icmp "eq" %789, %23 : i32
      %791 = llvm.select %790, %16, %789 : i1, i32
      llvm.cond_br %790, ^bb116, ^bb117
    ^bb116:  // pred: ^bb115
      %792 = llvm.xor %788, %32 : i32
      llvm.br ^bb118(%792 : i32)
    ^bb117:  // pred: ^bb115
      llvm.br ^bb118(%788 : i32)
    ^bb118(%793: i32):  // 2 preds: ^bb116, ^bb117
      llvm.br ^bb119
    ^bb119:  // pred: ^bb118
      %794 = llvm.getelementptr %67[%791] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %794, %793, %21 : !llvm.ptr<3>, i32, i32
      %795 = nvvm.elect.sync -> i1
      llvm.cond_br %795, ^bb120, ^bb121
    ^bb120:  // pred: ^bb119
