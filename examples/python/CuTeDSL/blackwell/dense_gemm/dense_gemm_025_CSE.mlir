...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb14(%197: i32, %198: i32, %199: i32, %200: i32):  // 2 preds: ^bb13, ^bb31
      ...
      llvm.cond_br %201, ^bb15, ^bb32 {loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
      %202 = llvm.getelementptr %68[%199] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %202, %200, %22 : !llvm.ptr<3>, i32, i32
    ...
    ^bb33(%230: i32, %231: i1, %232: i1, %233: i32, %234: i32, %235: i32, %236: i32, %237: i32, %238: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb32, ^bb78
      %239 = llvm.icmp "slt" %230, %115 : i32
      llvm.cond_br %239, ^bb34, ^bb79
    ^bb34:  // pred: ^bb33
      %240 = llvm.icmp "sgt" %229, %230 : i32
      llvm.cond_br %240, ^bb35, ^bb54
    ^bb35:  // pred: ^bb34
    ...
    ^bb36:  // pred: ^bb35
      ...
      nvvm.mbarrier.try_wait.parity.shared %243, %235, %22 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb37
    ...
    ^bb44(%257: i32):  // 2 preds: ^bb43, ^bb47
      ...
      llvm.cond_br %258, ^bb45, ^bb48 {llvm.loop_annotation = #loop_annotation1}
    ^bb45:  // pred: ^bb44
    ...
    ^bb49(%262: i32):  // 2 preds: ^bb48, ^bb52
      ...
      llvm.cond_br %263, ^bb50, ^bb53 {llvm.loop_annotation = #loop_annotation1}
    ^bb50:  // pred: ^bb49
    ...
    ^bb53:  // pred: ^bb49
      llvm.br ^bb55(%247, %249, %251 : i32, i32, i32)
    ^bb54:  // pred: ^bb34
      llvm.br ^bb55(%233, %234, %235 : i32, i32, i32)
    ^bb55(%266: i32, %267: i32, %268: i32):  // 2 preds: ^bb53, ^bb54
      llvm.br ^bb56
    ^bb56:  // pred: ^bb55
      %269 = llvm.zext %232 : i1 to i32
      %270 = llvm.icmp "eq" %269, %17 : i32
      llvm.cond_br %270, ^bb57, ^bb58
    ^bb57:  // pred: ^bb56
      %271 = llvm.getelementptr %12[%236] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %271, %237, %22 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb58
    ^bb58:  // 2 preds: ^bb56, ^bb57
      %272 = llvm.add %236, %33 : i32
      %273 = llvm.icmp "eq" %272, %24 : i32
      %274 = llvm.select %273, %17, %272 : i1, i32
      llvm.cond_br %273, ^bb59, ^bb60
    ^bb59:  // pred: ^bb58
      %275 = llvm.xor %237, %33 : i32
      llvm.br ^bb61(%275 : i32)
    ^bb60:  // pred: ^bb58
      llvm.br ^bb61(%237 : i32)
    ^bb61(%276: i32):  // 2 preds: ^bb59, ^bb60
      llvm.br ^bb62
    ^bb62:  // pred: ^bb61
      llvm.br ^bb63(%17, %238 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb63(%277: i32, %278: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb62, ^bb75
      %279 = llvm.icmp "slt" %277, %25 : i32
      llvm.cond_br %279, ^bb64, ^bb76 {loop_annotation = #loop_annotation2}
    ^bb64:  // pred: ^bb63
      ...
      llvm.br ^bb65(%17 : i32)
    ^bb65(%302: i32):  // 2 preds: ^bb64, ^bb74
      %303 = llvm.icmp "slt" %302, %33 : i32
      llvm.cond_br %303, ^bb66, ^bb75 {llvm.loop_annotation = #loop_annotation1}
    ^bb66:  // pred: ^bb65
      llvm.br ^bb67(%17 : i32)
    ^bb67(%304: i32):  // 2 preds: ^bb66, ^bb73
      %305 = llvm.icmp "slt" %304, %33 : i32
      llvm.cond_br %305, ^bb68, ^bb74 {llvm.loop_annotation = #loop_annotation1}
    ^bb68:  // pred: ^bb67
      llvm.br ^bb69(%17 : i32)
    ^bb69(%306: i32):  // 2 preds: ^bb68, ^bb72
      %307 = llvm.icmp "slt" %306, %33 : i32
      llvm.cond_br %307, ^bb70, ^bb73 {llvm.loop_annotation = #loop_annotation1}
    ^bb70:  // pred: ^bb69
      %308 = llvm.inttoptr %190 : i32 to !llvm.ptr<6>
      %309 = nvvm.elect.sync -> i1
      llvm.cond_br %309, ^bb71, ^bb72
    ^bb71:  // pred: ^bb70
    ...
    ^bb79:  // pred: ^bb33
      ...
      llvm.cond_br %322, ^bb80, ^bb81
    ^bb80:  // pred: ^bb79
      nvvm.tcgen05.commit.arrive %60 : !llvm.ptr<3>
      llvm.br ^bb81
    ^bb81:  // 2 preds: ^bb79, ^bb80
      llvm.br ^bb83(%234, %235 : i32, i32)
    ^bb82:  // pred: ^bb12
      llvm.br ^bb83(%17, %33 : i32, i32)
    ^bb83(%323: i32, %324: i32):  // 2 preds: ^bb81, ^bb82
      llvm.br ^bb84
    ^bb84:  // pred: ^bb83
    ...
    ^bb86:  // 2 preds: ^bb84, ^bb85
      ...
      llvm.br ^bb87(%17 : i32)
    ^bb87(%375: i32):  // 2 preds: ^bb86, ^bb88
      %376 = llvm.icmp "slt" %375, %33 : i32
      llvm.cond_br %376, ^bb88, ^bb89 {llvm.loop_annotation = #loop_annotation1}
    ^bb88:  // pred: ^bb87
    ...
    ^bb89:  // pred: ^bb87
      ...
      llvm.br ^bb90(%17 : i32)
    ^bb90(%635: i32):  // 2 preds: ^bb89, ^bb91
      %636 = llvm.icmp "slt" %635, %33 : i32
      llvm.cond_br %636, ^bb91, ^bb92 {llvm.loop_annotation = #loop_annotation1}
    ^bb91:  // pred: ^bb90
    ...
    ^bb116:  // pred: ^bb115
      ...
      llvm.br ^bb118(%795 : i32)
    ^bb117:  // pred: ^bb115
      llvm.br ^bb118(%791 : i32)
    ^bb118(%796: i32):  // 2 preds: ^bb116, ^bb117
      llvm.br ^bb119
    ^bb119:  // pred: ^bb118
      %797 = llvm.getelementptr %68[%794] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %797, %796, %22 : !llvm.ptr<3>, i32, i32
      %798 = nvvm.elect.sync -> i1
      llvm.cond_br %798, ^bb120, ^bb121
    ^bb120:  // pred: ^bb119
