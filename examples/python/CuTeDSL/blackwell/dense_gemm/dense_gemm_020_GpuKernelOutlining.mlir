...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb22(%641: i32):  // 2 preds: ^bb21, ^bb23
      %642 = llvm.icmp "slt" %641, %592 : i32
      llvm.cond_br %642, ^bb23, ^bb24 {llvm.loop_annotation = #loop_annotation1}
    ^bb23:  // pred: ^bb22
    ...
    ^bb25(%671: i32):  // 2 preds: ^bb24, ^bb26
      %672 = llvm.icmp "slt" %671, %592 : i32
      llvm.cond_br %672, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation1}
    ^bb26:  // pred: ^bb25
    ...
    ^bb28:  // pred: ^bb14
      ...
      llvm.br ^bb29(%165, %678, %676, %597, %598, %599, %165, %165, %165, %arg0 : i32, i1, i1, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb29(%681: i32, %682: i1, %683: i1, %684: i32, %685: i32, %686: i32, %687: i32, %688: i32, %689: i32, %690: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb68
      %691 = llvm.icmp "slt" %681, %439 : i32
      llvm.cond_br %691, ^bb30, ^bb69
    ^bb30:  // pred: ^bb29
      %692 = llvm.icmp "sgt" %679, %681 : i32
      llvm.cond_br %692, ^bb31, ^bb46
    ^bb31:  // pred: ^bb30
      %693 = llvm.zext %682 : i1 to i32
      %694 = llvm.icmp "eq" %693, %165 : i32
      llvm.cond_br %694, ^bb32, ^bb33
    ^bb32:  // pred: ^bb31
    ...
    ^bb35:  // 2 preds: ^bb33, ^bb34
      ...
      llvm.cond_br %700, ^bb36, ^bb37
    ^bb36:  // pred: ^bb35
      %702 = llvm.xor %686, %164 : i32
      llvm.br ^bb38(%702 : i32)
    ^bb37:  // pred: ^bb35
      llvm.br ^bb38(%686 : i32)
    ^bb38(%703: i32):  // 2 preds: ^bb36, ^bb37
      llvm.br ^bb39
    ^bb39:  // pred: ^bb38
    ...
    ^bb40(%739: i32):  // 2 preds: ^bb39, ^bb41
      %740 = llvm.icmp "slt" %739, %731 : i32
      llvm.cond_br %740, ^bb41, ^bb42 {llvm.loop_annotation = #loop_annotation1}
    ^bb41:  // pred: ^bb40
    ...
    ^bb43(%772: i32):  // 2 preds: ^bb42, ^bb44
      %773 = llvm.icmp "slt" %772, %731 : i32
      llvm.cond_br %773, ^bb44, ^bb45 {llvm.loop_annotation = #loop_annotation1}
    ^bb44:  // pred: ^bb43
      ...
      llvm.br ^bb43(%775 : i32)
    ^bb45:  // pred: ^bb43
      llvm.br ^bb47(%699, %701, %703 : i32, i32, i32)
    ^bb46:  // pred: ^bb30
      llvm.br ^bb47(%684, %685, %686 : i32, i32, i32)
    ^bb47(%776: i32, %777: i32, %778: i32):  // 2 preds: ^bb45, ^bb46
      llvm.br ^bb48
    ^bb48:  // pred: ^bb47
      %779 = llvm.zext %683 : i1 to i32
      %780 = llvm.icmp "eq" %779, %165 : i32
      llvm.cond_br %780, ^bb49, ^bb50
    ^bb49:  // pred: ^bb48
    ...
    ^bb50:  // 2 preds: ^bb48, ^bb49
      ...
      llvm.cond_br %784, ^bb51, ^bb52
    ^bb51:  // pred: ^bb50
      %786 = llvm.xor %689, %164 : i32
      llvm.br ^bb53(%786 : i32)
    ^bb52:  // pred: ^bb50
      llvm.br ^bb53(%689 : i32)
    ^bb53(%787: i32):  // 2 preds: ^bb51, ^bb52
      llvm.br ^bb54
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%165, %690 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb55(%788: i32, %789: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb54, ^bb65
      %790 = llvm.icmp "slt" %788, %136 : i32
      llvm.cond_br %790, ^bb56, ^bb66 {loop_annotation = #loop_annotation2}
    ^bb56:  // pred: ^bb55
    ...
    ^bb57(%824: i32):  // 2 preds: ^bb56, ^bb64
      %825 = llvm.icmp "slt" %824, %680 : i32
      llvm.cond_br %825, ^bb58, ^bb65 {llvm.loop_annotation = #loop_annotation1}
    ^bb58:  // pred: ^bb57
      llvm.br ^bb59(%165 : i32)
    ^bb59(%826: i32):  // 2 preds: ^bb58, ^bb63
      %827 = llvm.icmp "slt" %826, %680 : i32
      llvm.cond_br %827, ^bb60, ^bb64 {llvm.loop_annotation = #loop_annotation1}
    ^bb60:  // pred: ^bb59
      llvm.br ^bb61(%165 : i32)
    ^bb61(%828: i32):  // 2 preds: ^bb60, ^bb62
      %829 = llvm.icmp "slt" %828, %680 : i32
      llvm.cond_br %829, ^bb62, ^bb63 {llvm.loop_annotation = #loop_annotation1}
    ^bb62:  // pred: ^bb61
    ...
    ^bb68:  // 2 preds: ^bb66, ^bb67
      ...
      llvm.br ^bb29(%844, %841, %843, %776, %777, %778, %783, %785, %787, %789 : i32, i1, i1, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb69:  // pred: ^bb29
      %845 = nvvm.elect.sync -> i1
      llvm.cond_br %845, ^bb70, ^bb71
    ^bb70:  // pred: ^bb69
      nvvm.tcgen05.commit.arrive %201 : !llvm.ptr<3>
      llvm.br ^bb71
    ^bb71:  // 2 preds: ^bb69, ^bb70
      llvm.br ^bb73(%685, %686 : i32, i32)
    ^bb72:  // pred: ^bb12
      llvm.br ^bb73(%165, %164 : i32, i32)
    ^bb73(%846: i32, %847: i32):  // 2 preds: ^bb71, ^bb72
      llvm.br ^bb74
    ^bb74:  // pred: ^bb73
    ...
    ^bb77(%942: i32):  // 2 preds: ^bb76, ^bb78
      %943 = llvm.icmp "slt" %942, %941 : i32
      llvm.cond_br %943, ^bb78, ^bb79 {llvm.loop_annotation = #loop_annotation1}
    ^bb78:  // pred: ^bb77
    ...
    ^bb80(%1466: i32):  // 2 preds: ^bb79, ^bb81
      %1467 = llvm.icmp "slt" %1466, %941 : i32
      llvm.cond_br %1467, ^bb81, ^bb82 {llvm.loop_annotation = #loop_annotation1}
    ^bb81:  // pred: ^bb80
