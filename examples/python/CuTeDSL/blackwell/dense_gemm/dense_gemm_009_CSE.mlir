...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !mma_tf32_tf32_f32_128x128x8_, %arg5: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>, %arg6: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg7: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>, %arg8: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg9: !memref_gmem_f32_):
      ...
      %467:2 = "scf.if"(%369) ({
        %1183:3 = "scf.for"(%355, %466, %354, %355, %355, %354) ({
        ^bb0(%arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32):
          %1293 = "cute.make_int_tuple"(%arg24) : (i32) -> !cute.int_tuple<"?">
          %1294 = "cute.add_offset"(%379, %1293) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
          %1295 = "builtin.unrealized_conversion_cast"(%1294) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
          "nvvm.mbarrier.try_wait.parity.shared"(%1295, %arg25, %331) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
          %1296 = "nvvm.elect.sync"() : () -> i1
          "scf.if"(%1296) ({
            %1334 = "cute.add_offset"(%378, %1293) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
          ...
          %1297 = "arith.addi"(%arg24, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %1298 = "arith.addi"(%arg23, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %1299 = "arith.cmpi"(%1297, %329) <{predicate = 0 : i64}> : (i32, i32) -> i1
          %1300 = "arith.select"(%1299, %355, %1297) : (i1, i32, i32) -> i32
          %1301 = "scf.if"(%1299) ({
          ...
          %1302 = "cute.make_coord"(%arg22) : (i32) -> !cute.coord<"(_,?)">
          %1303 = "cute.crd2idx"(%1302, %457) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
          %1304 = "cute.add_offset"(%459, %1303) : (!cute.arith_tuple_iter<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
          ...
          %1308 = "cute.crd2idx"(%1307, %328) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),7):((1,0),4096)">) -> !cute.int_tuple<"?{div=4096}">
          %1309 = "cute.add_offset"(%389, %1308) : (!cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=4096}">) -> !cute.ptr<tf32, smem, align<128>, S<3,4,3>>
          %1310 = "cute.add_offset"(%378, %1293) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
          %1311 = "cute.make_int_tuple"(%1306#0, %1306#1, %1306#2) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %1312 = "cute.make_arith_tuple_iter"(%1311) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
          %1313 = "cute_nvgpu.atom.make_exec_tma"(%arg5) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          %1314 = "cute_nvgpu.atom.set_value"(%1313, %1310) <{field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.ptr<i64, smem>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          %1315 = "builtin.unrealized_conversion_cast"(%1310) : (!cute.ptr<i64, smem>) -> !cute.ptr<smem, align<8>>
          %1316 = "cute_nvgpu.atom.get_value"(%1313) <{field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> i64
          %1317 = "cute_nvgpu.get_tma_desc_addr"(%1314) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
          %1318 = "cute.deref_arith_tuple_iter"(%1312) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %1319:3 = "cute.get_scalars"(%1318) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (i32, i32, i32)
          "cute_nvgpu.arch.copy.SM100.tma_load"(%1317, %1309, %1315, %1319#0, %1319#1, %1319#2, %1316) <{mode = #cute_nvgpu.tma_load_mode<tiled>, num_cta = 1 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 3, 0, 0, 1>}> : (!cute.ptr<generic, align<64>>, !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.ptr<smem, align<8>>, i32, i32, i32, i64) -> ()
          %1320 = "cute.crd2idx"(%1302, %463) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
          %1321 = "cute.add_offset"(%465, %1320) : (!cute.arith_tuple_iter<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
          %1322 = "cute.deref_arith_tuple_iter"(%1321) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %1323:3 = "cute.get_leaves"(%1322) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">)
          %1324 = "cute.add_offset"(%390, %1308) : (!cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=4096}">) -> !cute.ptr<tf32, smem, align<128>, S<3,4,3>>
          %1325 = "cute.make_int_tuple"(%1323#0, %1323#1, %1323#2) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %1326 = "cute.make_arith_tuple_iter"(%1325) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
          %1327 = "cute_nvgpu.atom.make_exec_tma"(%arg7) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          %1328 = "cute_nvgpu.atom.set_value"(%1327, %1310) <{field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.ptr<i64, smem>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          %1329 = "cute_nvgpu.atom.get_value"(%1327) <{field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> i64
          %1330 = "cute_nvgpu.get_tma_desc_addr"(%1328) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
          %1331 = "cute.deref_arith_tuple_iter"(%1326) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %1332:3 = "cute.get_scalars"(%1331) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (i32, i32, i32)
          "cute_nvgpu.arch.copy.SM100.tma_load"(%1330, %1324, %1315, %1332#0, %1332#1, %1332#2, %1329) <{mode = #cute_nvgpu.tma_load_mode<tiled>, num_cta = 1 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 3, 0, 0, 1>}> : (!cute.ptr<generic, align<64>>, !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.ptr<smem, align<8>>, i32, i32, i32, i64) -> ()
          "scf.yield"(%1298, %1300, %1301) : (i32, i32, i32) -> ()
        }) {loop_annotation = #loop_annotation} : (i32, i32, i32, i32, i32, i32) -> (i32, i32, i32)
        %1184 = "cute.derefine"(%378) : (!cute.ptr<i64, smem, align<1024>>) -> !cute.ptr<i64, smem>
        %1185 = "builtin.unrealized_conversion_cast"(%1184) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
        %1186 = "nvvm.mbarrier.wait.parity"(%1185, %355) <{kind = #nvvm.mbar_wait<try>, scope = #nvvm.mbar_scope<cta>}> : (!llvm.ptr<3>, i32) -> i1
        %1187 = "cute.make_int_tuple"(%1183#1) : (i32) -> !cute.int_tuple<"?">
        %1188 = "cute.add_offset"(%379, %1187) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
        %1189 = "builtin.unrealized_conversion_cast"(%1188) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
        %1190 = "nvvm.mbarrier.wait.parity"(%1189, %1183#2) <{kind = #nvvm.mbar_wait<try>, scope = #nvvm.mbar_scope<cta>}> : (!llvm.ptr<3>, i32) -> i1
        %1191:9 = "scf.for"(%355, %427, %354, %1190, %1186, %1183#0, %1183#1, %1183#2, %355, %355, %355, %arg4) ({
        ^bb0(%arg10: i32, %arg11: i1, %arg12: i1, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32, %arg19: !mma_tf32_tf32_f32_128x128x8_):
          ...
          %1198 = "arith.cmpi"(%1197, %arg10) <{predicate = 4 : i64}> : (i32, i32) -> i1
          %1199:3 = "scf.if"(%1198) ({
            %1246 = "arith.extui"(%arg11) : (i1) -> i32
            %1247 = "arith.cmpi"(%1246, %355) <{predicate = 0 : i64}> : (i32, i32) -> i1
            "scf.if"(%1247) ({
              %1290 = "cute.make_int_tuple"(%arg14) : (i32) -> !cute.int_tuple<"?">
              %1291 = "cute.add_offset"(%379, %1290) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %1292 = "builtin.unrealized_conversion_cast"(%1291) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
              "nvvm.mbarrier.try_wait.parity.shared"(%1292, %arg15, %331) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
              "scf.yield"() : () -> ()
            }, {
            }) : (i1) -> ()
            %1248 = "nvvm.elect.sync"() : () -> i1
            "scf.if"(%1248) ({
              %1287 = "cute.make_int_tuple"(%arg14) : (i32) -> !cute.int_tuple<"?">
              %1288 = "cute.add_offset"(%378, %1287) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %1289 = "builtin.unrealized_conversion_cast"(%1288) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
              "nvvm.mbarrier.txn"(%1289, %330) <{kind = #nvvm.mbar_txn_kind<arrive_expect_tx>, scope = #nvvm.mbar_scope<cta>, space = #nvvm.mbar_space<cta>}> : (!llvm.ptr<3>, i32) -> ()
              "scf.yield"() : () -> ()
            }, {
            }) : (i1) -> ()
            %1249 = "arith.addi"(%arg14, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %1250 = "arith.addi"(%arg13, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %1251 = "arith.cmpi"(%1249, %329) <{predicate = 0 : i64}> : (i32, i32) -> i1
            %1252 = "arith.select"(%1251, %355, %1249) : (i1, i32, i32) -> i32
            %1253 = "scf.if"(%1251) ({
              %1286 = "arith.xori"(%arg15, %354) : (i32, i32) -> i32
              "scf.yield"(%1286) : (i32) -> ()
            }, {
              "scf.yield"(%arg15) : (i32) -> ()
            }) : (i1) -> i32
            %1254 = "cute.make_coord"(%arg13) : (i32) -> !cute.coord<"(_,?)">
            %1255 = "cute.crd2idx"(%1254, %457) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
            %1256 = "cute.add_offset"(%459, %1255) : (!cute.arith_tuple_iter<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
            ...
            %1259 = "cute.make_coord"(%arg14) : (i32) -> !cute.coord<"(_,?)">
            %1260 = "cute.crd2idx"(%1259, %328) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),7):((1,0),4096)">) -> !cute.int_tuple<"?{div=4096}">
            %1261 = "cute.add_offset"(%389, %1260) : (!cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=4096}">) -> !cute.ptr<tf32, smem, align<128>, S<3,4,3>>
            %1262 = "cute.make_int_tuple"(%arg14) : (i32) -> !cute.int_tuple<"?">
            %1263 = "cute.add_offset"(%378, %1262) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %1264 = "cute.make_int_tuple"(%1258#0, %1258#1, %1258#2) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %1265 = "cute.make_arith_tuple_iter"(%1264) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
            %1266 = "cute_nvgpu.atom.make_exec_tma"(%arg5) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %1267 = "cute_nvgpu.atom.set_value"(%1266, %1263) <{field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.ptr<i64, smem>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %1268 = "builtin.unrealized_conversion_cast"(%1263) : (!cute.ptr<i64, smem>) -> !cute.ptr<smem, align<8>>
            %1269 = "cute_nvgpu.atom.get_value"(%1266) <{field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> i64
            %1270 = "cute_nvgpu.get_tma_desc_addr"(%1267) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
            %1271 = "cute.deref_arith_tuple_iter"(%1265) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %1272:3 = "cute.get_scalars"(%1271) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (i32, i32, i32)
            "cute_nvgpu.arch.copy.SM100.tma_load"(%1270, %1261, %1268, %1272#0, %1272#1, %1272#2, %1269) <{mode = #cute_nvgpu.tma_load_mode<tiled>, num_cta = 1 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 3, 0, 0, 1>}> : (!cute.ptr<generic, align<64>>, !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.ptr<smem, align<8>>, i32, i32, i32, i64) -> ()
            %1273 = "cute.crd2idx"(%1254, %463) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
            %1274 = "cute.add_offset"(%465, %1273) : (!cute.arith_tuple_iter<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
            %1275 = "cute.deref_arith_tuple_iter"(%1274) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %1276:3 = "cute.get_leaves"(%1275) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">)
            %1277 = "cute.add_offset"(%390, %1260) : (!cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=4096}">) -> !cute.ptr<tf32, smem, align<128>, S<3,4,3>>
            %1278 = "cute.make_int_tuple"(%1276#0, %1276#1, %1276#2) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %1279 = "cute.make_arith_tuple_iter"(%1278) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> !cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">
            %1280 = "cute_nvgpu.atom.make_exec_tma"(%arg7) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, tma_format = TF32_RN>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %1281 = "cute_nvgpu.atom.set_value"(%1280, %1263) <{field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.ptr<i64, smem>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %1282 = "cute_nvgpu.atom.get_value"(%1280) <{field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>}> : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> i64
            %1283 = "cute_nvgpu.get_tma_desc_addr"(%1281) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
            %1284 = "cute.deref_arith_tuple_iter"(%1279) : (!cute.arith_tuple_iter<"(?{div=32},?{div=128},?)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %1285:3 = "cute.get_scalars"(%1284) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">) -> (i32, i32, i32)
            "cute_nvgpu.arch.copy.SM100.tma_load"(%1283, %1277, %1268, %1285#0, %1285#1, %1285#2, %1282) <{mode = #cute_nvgpu.tma_load_mode<tiled>, num_cta = 1 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 3, 0, 0, 1>}> : (!cute.ptr<generic, align<64>>, !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, !cute.ptr<smem, align<8>>, i32, i32, i32, i64) -> ()
            "scf.yield"(%1250, %1252, %1253) : (i32, i32, i32) -> ()
          }, {
            "scf.yield"(%arg13, %arg14, %arg15) : (i32, i32, i32) -> ()
          }) : (i1) -> (i32, i32, i32)
          %1200 = "arith.extui"(%arg12) : (i1) -> i32
          %1201 = "arith.cmpi"(%1200, %355) <{predicate = 0 : i64}> : (i32, i32) -> i1
          "scf.if"(%1201) ({
            %1243 = "cute.make_int_tuple"(%arg17) : (i32) -> !cute.int_tuple<"?">
            %1244 = "cute.add_offset"(%378, %1243) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %1245 = "builtin.unrealized_conversion_cast"(%1244) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
            "nvvm.mbarrier.try_wait.parity.shared"(%1245, %arg18, %331) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
            "scf.yield"() : () -> ()
          }, {
          }) : (i1) -> ()
          %1202 = "arith.addi"(%arg17, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %1203 = "arith.addi"(%arg16, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %1204 = "arith.cmpi"(%1202, %329) <{predicate = 0 : i64}> : (i32, i32) -> i1
          %1205 = "arith.select"(%1204, %355, %1202) : (i1, i32, i32) -> i32
          %1206 = "scf.if"(%1204) ({
            %1242 = "arith.xori"(%arg18, %354) : (i32, i32) -> i32
            "scf.yield"(%1242) : (i32) -> ()
          }, {
            "scf.yield"(%arg18) : (i32) -> ()
          }) : (i1) -> i32
          %1207 = "scf.for"(%355, %327, %354, %arg19) ({
          ^bb0(%arg20: i32, %arg21: !mma_tf32_tf32_f32_128x128x8_):
            %1228 = "cute.make_coord"(%arg20, %arg17) : (i32, i32) -> !cute.coord<"(_,_,?,?)">
            %1229 = "cute.crd2idx"(%1228, %326) : (!cute.coord<"(_,_,?,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            %1230 = "cute.add_offset"(%451, %1229) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %1231 = "cute.add_offset"(%452, %1229) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %1232 = "cute_nvgpu.atom.get_value"(%arg21) <{field = #cute_nvgpu.atom_mma_field_sm100<neg_a>}> : (!mma_tf32_tf32_f32_128x128x8_) -> i1
            %1233 = "cute_nvgpu.atom.get_value"(%arg21) <{field = #cute_nvgpu.atom_mma_field_sm100<neg_b>}> : (!mma_tf32_tf32_f32_128x128x8_) -> i1
            %1234 = "cute_nvgpu.atom.get_value"(%arg21) <{field = #cute_nvgpu.atom_mma_field_sm100<accum_c>}> : (!mma_tf32_tf32_f32_128x128x8_) -> i1
            %1235 = "arith.extui"(%1232) : (i1) -> i32
            %1236 = "arith.extui"(%1233) : (i1) -> i32
            %1237 = "arith.shli"(%1235, %324) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %1238 = "arith.shli"(%1236, %323) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
            %1239 = "arith.ori"(%1237, %325) : (i32, i32) -> i32
            %1240 = "arith.ori"(%1239, %1238) : (i32, i32) -> i32
            "cute_nvgpu.arch.mma.SM100.umma"(%1230, %1231, %453, %1240, %1234) <{a_type = tf32, num_cta = 1 : i32, scale = 0 : i32}> : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
            %1241 = "cute_nvgpu.atom.set_value"(%arg21, %332) <{field = #cute_nvgpu.atom_mma_field_sm100<accum_c>}> : (!mma_tf32_tf32_f32_128x128x8_, i1) -> !mma_tf32_tf32_f32_128x128x8_
            "scf.yield"(%1241) : (!mma_tf32_tf32_f32_128x128x8_) -> ()
          ...
          "scf.if"(%1208) ({
            %1225 = "cute.make_int_tuple"(%arg17) : (i32) -> !cute.int_tuple<"?">
            ...
            "nvvm.tcgen05.commit.arrive"(%1227) <{group = #nvvm.tcgen05_group<cta_1>}> : (!llvm.ptr<3>) -> ()
            "scf.yield"() : () -> ()
          }, {
          }) : (i1) -> ()
          %1209 = "arith.addi"(%arg10, %354) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
          %1210 = "arith.cmpi"(%1197, %1209) <{predicate = 4 : i64}> : (i32, i32) -> i1
          %1211 = "scf.if"(%1210) ({
            %1221 = "cute.make_int_tuple"(%1199#1) : (i32) -> !cute.int_tuple<"?">
            %1222 = "cute.add_offset"(%379, %1221) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %1223 = "builtin.unrealized_conversion_cast"(%1222) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
            %1224 = "nvvm.mbarrier.wait.parity"(%1223, %1199#2) <{kind = #nvvm.mbar_wait<try>, scope = #nvvm.mbar_scope<cta>}> : (!llvm.ptr<3>, i32) -> i1
            "scf.yield"(%1224) : (i1) -> ()
          }, {
            "scf.yield"(%arg11) : (i1) -> ()
          }) : (i1) -> i1
          %1212 = "arith.cmpi"(%427, %1209) <{predicate = 4 : i64}> : (i32, i32) -> i1
          %1213 = "arith.extui"(%1212) : (i1) -> i32
          %1214 = "arith.select"(%1212, %354, %1213) : (i1, i32, i32) -> i32
          %1215 = "arith.cmpi"(%1214, %355) <{predicate = 1 : i64}> : (i32, i32) -> i1
          %1216 = "scf.if"(%1215) ({
            %1217 = "cute.make_int_tuple"(%1205) : (i32) -> !cute.int_tuple<"?">
            %1218 = "cute.add_offset"(%378, %1217) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %1219 = "builtin.unrealized_conversion_cast"(%1218) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
            %1220 = "nvvm.mbarrier.wait.parity"(%1219, %1206) <{kind = #nvvm.mbar_wait<try>, scope = #nvvm.mbar_scope<cta>}> : (!llvm.ptr<3>, i32) -> i1
            "scf.yield"(%1220) : (i1) -> ()
          }, {
            "scf.yield"(%arg12) : (i1) -> ()
          }) : (i1) -> i1
          "scf.yield"(%1211, %1216, %1199#0, %1199#1, %1199#2, %1203, %1205, %1206, %1207) : (i1, i1, i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_) -> ()
        ...
        "scf.if"(%1192) ({
          %1193 = "cute.derefine"(%380) : (!cute.ptr<i64, smem, align<16>>) -> !cute.ptr<i64, smem>
          %1194 = "builtin.unrealized_conversion_cast"(%1193) : (!cute.ptr<i64, smem>) -> !llvm.ptr<3>
          "nvvm.tcgen05.commit.arrive"(%1194) <{group = #nvvm.tcgen05_group<cta_1>}> : (!llvm.ptr<3>) -> ()
          "scf.yield"() : () -> ()
        }, {
        }) : (i1) -> ()
        "scf.yield"(%1191#3, %1191#4) : (i32, i32) -> ()
      }, {
