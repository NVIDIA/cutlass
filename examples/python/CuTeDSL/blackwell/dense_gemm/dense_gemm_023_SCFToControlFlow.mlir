...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb37:  // pred: ^bb36
      ...
      "cf.cond_br"(%1082)[^bb38, ^bb39] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb38:  // pred: ^bb37
    ...
    ^bb39:  // 2 preds: ^bb37, ^bb38
      ...
      "cf.cond_br"(%1111)[^bb40, ^bb41] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb40:  // pred: ^bb39
    ...
    ^bb52:  // pred: ^bb51
      ...
      "cf.cond_br"(%1162)[^bb53, ^bb54] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb53:  // pred: ^bb52
