...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb49(%262: i32):  // 2 preds: ^bb48, ^bb52
      ...
      llvm.cond_br %263, ^bb50, ^bb53(%247, %249, %251 : i32, i32, i32) {llvm.loop_annotation = #loop_annotation1}
    ^bb50:  // pred: ^bb49
    ...
    ^bb62(%277: i32, %278: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb61, ^bb74
      ...
      llvm.cond_br %279, ^bb63, ^bb75 {loop_annotation = #loop_annotation2}
    ^bb63:  // pred: ^bb62
    ...
    ^bb64(%302: i32):  // 2 preds: ^bb63, ^bb73
      ...
      llvm.cond_br %303, ^bb65, ^bb74 {llvm.loop_annotation = #loop_annotation1}
    ^bb65:  // pred: ^bb64
      llvm.br ^bb66(%17 : i32)
    ^bb66(%304: i32):  // 2 preds: ^bb65, ^bb72
      %305 = llvm.icmp "slt" %304, %33 : i32
      llvm.cond_br %305, ^bb67, ^bb73 {llvm.loop_annotation = #loop_annotation1}
    ^bb67:  // pred: ^bb66
      llvm.br ^bb68(%17 : i32)
    ^bb68(%306: i32):  // 2 preds: ^bb67, ^bb71
      %307 = llvm.icmp "slt" %306, %33 : i32
      llvm.cond_br %307, ^bb69, ^bb72 {llvm.loop_annotation = #loop_annotation1}
    ^bb69:  // pred: ^bb68
    ...
    ^bb85(%375: i32):  // 2 preds: ^bb84, ^bb86
      ...
      llvm.cond_br %376, ^bb86, ^bb87 {llvm.loop_annotation = #loop_annotation1}
    ^bb86:  // pred: ^bb85
    ...
    ^bb88(%635: i32):  // 2 preds: ^bb87, ^bb89
      ...
      llvm.cond_br %636, ^bb89, ^bb90 {llvm.loop_annotation = #loop_annotation1}
    ^bb89:  // pred: ^bb88
