...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %72 = "nvvm.read.ptx.sreg.tid.x"() : () -> i32
      %73 = "nvvm.read.ptx.sreg.ctaid.x"() : () -> i32
      %74 = "cute.make_coord"(%73) : (i32) -> !cute.coord<"(_,?)">
      %75 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
      %76 = "cute.crd2idx"(%74, %75) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      ...
      %81 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      %82 = "cute.crd2idx"(%80, %81) : (!cute.coord<"(_,?)">, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      %83 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<16>>
      %84 = "cute.add_offset"(%83, %82) : (!cute.ptr<i8, gmem, align<16>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      %85 = "cute.make_view"(%84) : (!cute.ptr<i8, gmem>) -> !memref_gmem_i8_1
      %86 = "cute.make_coord"(%73) : (i32) -> !cute.coord<"(_,?)">
      %87 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %88 = "cute.crd2idx"(%86, %87) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %89 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      %90 = "cute.add_offset"(%89, %88) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.int_tuple<"(?,?{div=1024},?)">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %91 = "cute.make_view"(%90) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">) -> !cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">
      ...
      %96 = "cute.get_iter"(%91) : (!cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %97 = "cute.make_view"(%96) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">) -> !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      ...
      %114 = "cute.crd2idx"(%112, %113) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@1,1@1)">) -> !cute.int_tuple<"(0,?{div=8})">
      %115 = "cute.get_iter"(%97) : (!cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %116 = "cute.add_offset"(%115, %114) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">, !cute.int_tuple<"(0,?{div=8})">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %117 = "cute.make_view"(%116) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">) -> !cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">
      %118 = "cute.static"() : () -> !cute.int_tuple<"(0,0)">
      %119 = "cute.get_iter"(%117) : (!cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %120 = "cute.add_offset"(%119, %118) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">, !cute.int_tuple<"(0,0)">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      ...
      %124:3 = "cute.get_leaves"(%123) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %125 = "cute.make_coord"(%124#0, %124#1, %124#2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
      ...
      "scf.if"(%135) ({
        ...
        %158 = "nvgpu.cvt_fptrunc"(%157) <{packed_kind = #nvgpu.subbytes_packedkind<compact>, rnd = #nvgpu.rnd<rn>}> : (vector<8xf32>) -> vector<8xf4E2M1FN>
        ...
        %161 = "builtin.unrealized_conversion_cast"(%158) : (vector<8xf4E2M1FN>) -> vector<8xi4>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f4E2M1FN):
    %0 = "cute.get_iter"(%arg1) : (!memref_gmem_f4E2M1FN) -> !cute.ptr<f4E2M1FN, gmem, align<16>>
    ...
    %3 = "cute.recast_iter"(%0) : (!cute.ptr<f4E2M1FN, gmem, align<16>>) -> !cute.ptr<i8, gmem, align<16>>
    %4 = "cute.get_layout"(%arg1) : (!memref_gmem_f4E2M1FN) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %5 = "cute.recast_layout"(%4) <{new_type_bits = 8 : i32, old_type_bits = 4 : i32}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %6 = "cute.make_view"(%3, %5) : (!cute.ptr<i8, gmem, align<16>>, !cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !memref_gmem_i8_6
    %7 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %16 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %28 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_6) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %29:5 = "cute.get_scalars"(%28) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    %30 = "arith.constant"() <{value = 1024 : i32}> : () -> i32
    %31 = "arith.ceildivsi"(%29#1, %30) : (i32, i32) -> i32
    %32 = "cute.make_shape"(%29#0, %31, %29#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %33 = "cute.make_stride"(%29#3, %29#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %34 = "cute.make_layout"(%32, %33) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    %35 = "cute.make_view"(%27, %34) : (!cute.ptr<f32, gmem>, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !memref_gmem_f32_
    ...
    %40 = "arith.ceildivsi"(%38#1, %39) : (i32, i32) -> i32
    %41 = "cute.make_shape"(%38#0, %40, %38#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %42 = "cute.static"() : () -> !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
    %43 = "cute.make_layout"(%41, %42) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %44 = "cute.make_view"(%36, %43) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %45 = "cute.get_iter"(%6) : (!memref_gmem_i8_6) -> !cute.ptr<i8, gmem, align<16>>
    %46 = "cute.get_layout"(%6) : (!memref_gmem_i8_6) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %47:5 = "cute.get_scalars"(%46) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    %48 = "arith.constant"() <{value = 512 : i32}> : () -> i32
    %49 = "arith.ceildivsi"(%47#1, %48) : (i32, i32) -> i32
    %50 = "cute.make_shape"(%47#0, %49, %47#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %51 = "cute.make_stride"(%47#3, %47#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %52 = "cute.make_layout"(%50, %51) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,512,1),(?,?,?))">, !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %53 = "cute.make_view"(%45, %52) : (!cute.ptr<i8, gmem, align<16>>, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !memref_gmem_i8_
    %54 = "cute.get_layout"(%35) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    %55 = "cute.size"(%54) <{mode = array<i32: 1>}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %67 = "cuda.launch_ex"(%64, %35, %53, %44, %11, %13, %15) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo110241010i641024i64_tensorptri8gmemalign16o15121010i64512i64_tensor000o1102410110101024112____Float32_Float4E2M1FN_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
