...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %66 = "cute.static"() : () -> !cute.layout<"(128,8):(8@1,1@1)">
      ...
      %72 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
      %73 = "cute.crd2idx"(%71, %72) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      ...
      %77 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      %78 = "cute.crd2idx"(%76, %77) : (!cute.coord<"(_,?)">, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      %79 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<16>>
      %80 = "cute.add_offset"(%79, %78) : (!cute.ptr<i8, gmem, align<16>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      %81 = "cute.make_coord"(%70) : (i32) -> !cute.coord<"(_,?)">
      %82 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %83 = "cute.crd2idx"(%81, %82) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %84 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %93 = "cute.crd2idx"(%92, %66) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@1,1@1)">) -> !cute.int_tuple<"(0,?{div=8})">
      %94 = "cute.add_offset"(%85, %93) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">, !cute.int_tuple<"(0,?{div=8})">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %95 = "cute.deref_arith_tuple_iter"(%94) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %96:3 = "cute.get_leaves"(%95) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %97 = "cute.make_coord"(%96#0, %96#1, %96#2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
      ...
      "scf.if"(%105) ({
        ...
        %149 = "nvgpu.cvt_fptrunc"(%148) <{packed_kind = #nvgpu.subbytes_packedkind<compact>, rnd = #nvgpu.rnd<rn>}> : (vector<8xf32>) -> vector<8xf4E2M1FN>
        %150 = "cute.recast_layout"(%65) <{new_type_bits = 8 : i32, old_type_bits = 4 : i32}> : (!cute.layout<"8:1">) -> !cute.layout<"4:1">
        %151 = "builtin.unrealized_conversion_cast"(%149) : (vector<8xf4E2M1FN>) -> vector<8xi4>
        %152 = "vector.bitcast"(%151) : (vector<8xi4>) -> vector<4xi8>
        "cute.memref.store_vec"(%152, %108) : (vector<4xi8>, !memref_rmem_i8_) -> ()
        %153 = "builtin.unrealized_conversion_cast"(%109) : (!cute.ptr<i8, rmem, align<32>>) -> !llvm.ptr
        %154 = "builtin.unrealized_conversion_cast"(%91) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
        %155 = "llvm.load"(%153) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
        "llvm.store"(%155, %154) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
        %156 = "cute.add_offset"(%109, %64) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<i8, rmem>
        %157 = "cute.add_offset"(%91, %64) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<i8, gmem>
        %158 = "builtin.unrealized_conversion_cast"(%156) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
        %159 = "builtin.unrealized_conversion_cast"(%157) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
        %160 = "llvm.load"(%158) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
        "llvm.store"(%160, %159) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
        %161 = "cute.add_offset"(%109, %63) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<i8, rmem, align<2>>
        %162 = "cute.add_offset"(%91, %63) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<i8, gmem>
        %163 = "builtin.unrealized_conversion_cast"(%161) : (!cute.ptr<i8, rmem, align<2>>) -> !llvm.ptr
        %164 = "builtin.unrealized_conversion_cast"(%162) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
        %165 = "llvm.load"(%163) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
        "llvm.store"(%165, %164) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
        %166 = "cute.add_offset"(%109, %62) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<i8, rmem>
        %167 = "cute.add_offset"(%91, %62) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<i8, gmem>
        %168 = "builtin.unrealized_conversion_cast"(%166) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
        %169 = "builtin.unrealized_conversion_cast"(%167) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
        %170 = "llvm.load"(%168) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
        "llvm.store"(%170, %169) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
        "scf.yield"() : () -> ()
      }, {
      }) : (i1) -> ()
      "cuda.return"() : () -> ()
  ...
  ^bb0(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f4E2M1FN):
    ...
    %23 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_1) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %24 = "cute.get_shape"(%23) : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %33 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_1) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %34:5 = "cute.get_scalars"(%33) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    %35 = "arith.ceildivsi"(%34#1, %6) : (i32, i32) -> i32
    %36 = "cute.make_shape"(%34#0, %35, %34#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %37 = "cute.make_stride"(%34#3, %34#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %38 = "cute.make_layout"(%36, %37) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    %39 = "cute.make_view"(%32, %38) : (!cute.ptr<f32, gmem>, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !memref_gmem_f32_
    %40:3 = "cute.get_scalars"(%31) <{only_dynamic}> : (!cute.layout<"(?,?,?):(1@0,1@1,1@2)">) -> (i32, i32, i32)
    %41 = "arith.ceildivsi"(%40#1, %6) : (i32, i32) -> i32
    %42 = "cute.make_shape"(%40#0, %41, %40#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %43 = "cute.make_layout"(%42, %5) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %44 = "cute.make_view"(%30, %43) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %45:5 = "cute.get_scalars"(%13) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    %46 = "arith.ceildivsi"(%45#1, %4) : (i32, i32) -> i32
    %47 = "cute.make_shape"(%45#0, %46, %45#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %48 = "cute.make_stride"(%45#3, %45#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %49 = "cute.make_layout"(%47, %48) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,512,1),(?,?,?))">, !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %50 = "cute.make_view"(%11, %49) : (!cute.ptr<i8, gmem, align<16>>, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !memref_gmem_i8_
    %51 = "cute.size"(%38) <{mode = array<i32: 1>}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %56 = "cuda.launch_ex"(%55, %39, %50, %44, %18, %20, %22) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo110241010i641024i64_tensorptri8gmemalign16o15121010i64512i64_tensor000o1102410110101024112____Float32_Float4E2M1FN_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
