...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    "cuda.kernel"() <{arg_attrs = [{}, {}, {}, {}, {}, {}, {}, {}], function_type = (!memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, !cute.layout<"(128,8):(8,1)">, !cute.layout<"(128,4):(4,1)">, i32, i32, i32) -> (), sym_name = "kernel_cutlass__convert_kernel_tensorptrf32gmemo110241010i641024i64_tensorptri8gmemalign16o15121010i64512i64_tensor000o1102410110101024112____Float32_Float4E2M1FN_0"}> ({
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg5: !cute.layout<"(128,8):(8,1)">, %arg6: !cute.layout<"(128,4):(4,1)">, %arg7: i32, %arg8: i32, %arg9: i32):
      %96 = "cute.get_iter"(%arg2) : (!memref_gmem_f32_) -> !cute.ptr<f32, gmem>
      %97 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<16>>
      %98 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %102 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<16>>
      %103 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %106 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
      %107 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      %108 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %109 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
      %110 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      %111 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      ...
      %123 = "cute.slice"(%arg4, %122) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, !cute.coord<"(_,?)">) -> !cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">
      %124 = "cute.get_iter"(%123) : (!cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %125 = "cute.deref_arith_tuple_iter"(%124) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %126:3 = "cute.get_leaves"(%125) : (!cute.int_tuple<"(?,?{div=1024},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">)
      %127 = "cute.get_scalars"(%126#0) : (!cute.int_tuple<"?">) -> i32
      %128 = "cute.get_scalars"(%126#1) : (!cute.int_tuple<"?{div=1024}">) -> i32
      %129 = "cute.get_scalars"(%126#2) : (!cute.int_tuple<"?">) -> i32
      %130 = "cute.get_iter"(%123) : (!cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %131 = "cute.deref_arith_tuple_iter"(%130) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %132:3 = "cute.get_leaves"(%131) : (!cute.int_tuple<"(?,?{div=1024},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">)
      %133 = "cute.get_scalars"(%132#0) : (!cute.int_tuple<"?">) -> i32
      %134 = "cute.get_scalars"(%132#1) : (!cute.int_tuple<"?{div=1024}">) -> i32
      ...
      %140 = "cute.composition"(%123, %arg5) : (!cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">, !cute.layout<"(128,8):(8,1)">) -> !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      %141 = "cute.get_iter"(%140) : (!cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">) -> !cute.arith_tuple_iter<"(?,?{div=1024},?)">
      %142 = "cute.deref_arith_tuple_iter"(%141) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %143:3 = "cute.get_leaves"(%142) : (!cute.int_tuple<"(?,?{div=1024},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=1024}">, !cute.int_tuple<"?">)
      %144 = "cute.get_scalars"(%143#0) : (!cute.int_tuple<"?">) -> i32
      %145 = "cute.get_scalars"(%143#1) : (!cute.int_tuple<"?{div=1024}">) -> i32
      ...
      %156 = "cute.slice"(%140, %155) : (!cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">, !cute.coord<"(?,_)">) -> !cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">
      %157 = "cute.get_iter"(%156) : (!cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %158 = "cute.deref_arith_tuple_iter"(%157) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %159:3 = "cute.get_leaves"(%158) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %160 = "cute.get_scalars"(%159#0) : (!cute.int_tuple<"?">) -> i32
      %161 = "cute.get_scalars"(%159#1) : (!cute.int_tuple<"?{div=8}">) -> i32
      %162 = "cute.get_scalars"(%159#2) : (!cute.int_tuple<"?">) -> i32
      %163 = "cute.get_iter"(%156) : (!cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %164 = "cute.deref_arith_tuple_iter"(%163) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %165:3 = "cute.get_leaves"(%164) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %166 = "cute.get_scalars"(%165#0) : (!cute.int_tuple<"?">) -> i32
      %167 = "cute.get_scalars"(%165#1) : (!cute.int_tuple<"?{div=8}">) -> i32
      %168 = "cute.get_scalars"(%165#2) : (!cute.int_tuple<"?">) -> i32
      %169 = "cute.make_coord"() : () -> !cute.coord<"0">
      %170 = "cute.slice"(%156, %169) : (!cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">, !cute.coord<"0">) -> !cute.coord_tensor<"(?,?{div=8},?)", "():()">
      ...
      %173:3 = "cute.get_leaves"(%172) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %174 = "cute.get_scalars"(%173#0) : (!cute.int_tuple<"?">) -> i32
      %175 = "cute.get_scalars"(%173#1) : (!cute.int_tuple<"?{div=8}">) -> i32
      ...
      %179:3 = "cute.get_leaves"(%178) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %180 = "cute.get_scalars"(%179#0) : (!cute.int_tuple<"?">) -> i32
      %181 = "cute.get_scalars"(%179#1) : (!cute.int_tuple<"?{div=8}">) -> i32
      ...
      %185:3 = "cute.get_leaves"(%184) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %186 = "cute.get_scalars"(%185#0) : (!cute.int_tuple<"?">) -> i32
      %187 = "cute.get_scalars"(%185#1) : (!cute.int_tuple<"?{div=8}">) -> i32
      %188 = "cute.get_scalars"(%185#2) : (!cute.int_tuple<"?">) -> i32
      %189 = "cute.make_coord"(%185#0, %185#1, %185#2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
      ...
      "scf.if"(%191) ({
        ...
        %262 = "nvgpu.cvt_fptrunc"(%258) <{packed_kind = #nvgpu.subbytes_packedkind<compact>, rnd = #nvgpu.rnd<rn>}> : (vector<8xf32>) -> vector<8xf4E2M1FN>
        ...
        %268 = "builtin.unrealized_conversion_cast"(%262) : (vector<8xf4E2M1FN>) -> vector<8xi4>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f4E2M1FN):
    ...
    %93 = "cuda.launch_ex"(%90, %61, %73, %65, %8, %9, %19, %21, %23) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo110241010i641024i64_tensorptri8gmemalign16o15121010i64512i64_tensor000o1102410110101024112____Float32_Float4E2M1FN_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, !cute.layout<"(128,8):(8,1)">, !cute.layout<"(128,4):(4,1)">, i32, i32, i32) -> !cuda.result
