...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb12(%672: i32, %673: i32, %674: i32, %675: i1, %676: i32, %677: i32, %678: i32, %679: i32):  // 2 preds: ^bb11, ^bb51
      llvm.cond_br %675, ^bb13(%672, %673, %674, %676, %677, %678, %679 : i32, i32, i32, i32, i32, i32, i32), ^bb52
    ...
    ^bb23(%764: i32, %765: i1, %766: i32, %767: i32, %768: i32):  // 2 preds: ^bb22, ^bb50
      %769 = llvm.icmp "slt" %764, %479 : i32
      llvm.cond_br %769, ^bb24, ^bb51 {loop_annotation = #loop_annotation}
    ^bb24:  // pred: ^bb23
    ...
    ^bb33(%812: i32):  // 2 preds: ^bb32, ^bb34
      %813 = llvm.icmp "slt" %812, %666 : i32
      llvm.cond_br %813, ^bb34, ^bb35 {llvm.loop_annotation = #loop_annotation1}
    ^bb34:  // pred: ^bb33
    ...
    ^bb35:  // pred: ^bb33
      ...
      llvm.br ^bb36(%171 : i32)
    ^bb36(%842: i32):  // 2 preds: ^bb35, ^bb37
      %843 = llvm.icmp "slt" %842, %666 : i32
      llvm.cond_br %843, ^bb37, ^bb38 {llvm.loop_annotation = #loop_annotation1}
    ^bb37:  // pred: ^bb36
    ...
    ^bb39:  // pred: ^bb38
      ...
      llvm.br ^bb40(%171 : i32)
    ^bb40(%866: i32):  // 2 preds: ^bb39, ^bb41
      %867 = llvm.icmp "slt" %866, %666 : i32
      llvm.cond_br %867, ^bb41, ^bb42 {llvm.loop_annotation = #loop_annotation1}
    ^bb41:  // pred: ^bb40
      nvvm.cp.async.bulk.tensor.prefetch %861, box[%863, %864, %865] l2_cache_hint = %862 : !llvm.ptr
      %868 = llvm.add %866, %172 : i32
      llvm.br ^bb40(%868 : i32)
    ^bb42:  // pred: ^bb40
    ...
    ^bb52:  // pred: ^bb12
      ...
      llvm.cond_br %919, ^bb53, ^bb54
    ^bb53:  // pred: ^bb52
      %921 = llvm.xor %677, %172 : i32
      llvm.br ^bb55(%921 : i32)
    ^bb54:  // pred: ^bb52
      llvm.br ^bb55(%677 : i32)
    ^bb55(%922: i32):  // 2 preds: ^bb53, ^bb54
      llvm.br ^bb56
    ^bb56:  // pred: ^bb55
      %923 = llvm.add %920, %172 : i32
      %924 = llvm.icmp "eq" %923, %147 : i32
      %925 = llvm.select %924, %171, %923 : i1, i32
      llvm.cond_br %924, ^bb57, ^bb58
    ^bb57:  // pred: ^bb56
      %926 = llvm.xor %922, %172 : i32
      llvm.br ^bb59(%926 : i32)
    ^bb58:  // pred: ^bb56
      llvm.br ^bb59(%922 : i32)
    ^bb59(%927: i32):  // 2 preds: ^bb57, ^bb58
      llvm.br ^bb60
    ^bb60:  // pred: ^bb59
      %928 = llvm.add %925, %172 : i32
      %929 = llvm.icmp "eq" %928, %147 : i32
      %930 = llvm.select %929, %171, %928 : i1, i32
      llvm.cond_br %929, ^bb61, ^bb62
    ^bb61:  // pred: ^bb60
      %931 = llvm.xor %927, %172 : i32
      llvm.br ^bb63(%931 : i32)
    ^bb62:  // pred: ^bb60
      llvm.br ^bb63(%927 : i32)
    ^bb63(%932: i32):  // 2 preds: ^bb61, ^bb62
      llvm.br ^bb64
    ^bb64:  // pred: ^bb63
      %933 = llvm.add %930, %172 : i32
      %934 = llvm.icmp "eq" %933, %147 : i32
      %935 = llvm.select %934, %171, %933 : i1, i32
      llvm.cond_br %934, ^bb65, ^bb66
    ^bb65:  // pred: ^bb64
      %936 = llvm.xor %932, %172 : i32
      llvm.br ^bb67(%936 : i32)
    ^bb66:  // pred: ^bb64
      llvm.br ^bb67(%932 : i32)
    ^bb67(%937: i32):  // 2 preds: ^bb65, ^bb66
      llvm.br ^bb68
    ^bb68:  // pred: ^bb67
      %938 = llvm.add %935, %172 : i32
      %939 = llvm.icmp "eq" %938, %147 : i32
      %940 = llvm.select %939, %171, %938 : i1, i32
      llvm.cond_br %939, ^bb69, ^bb70
    ^bb69:  // pred: ^bb68
      %941 = llvm.xor %937, %172 : i32
      llvm.br ^bb71(%941 : i32)
    ^bb70:  // pred: ^bb68
      llvm.br ^bb71(%937 : i32)
    ^bb71(%942: i32):  // 2 preds: ^bb69, ^bb70
      llvm.br ^bb72
    ^bb72:  // pred: ^bb71
      %943 = llvm.add %940, %172 : i32
      %944 = llvm.icmp "eq" %943, %147 : i32
      %945 = llvm.select %944, %171, %943 : i1, i32
      llvm.cond_br %944, ^bb73, ^bb74
    ^bb73:  // pred: ^bb72
      %946 = llvm.xor %942, %172 : i32
      llvm.br ^bb75(%946 : i32)
    ^bb74:  // pred: ^bb72
      llvm.br ^bb75(%942 : i32)
    ^bb75(%947: i32):  // 2 preds: ^bb73, ^bb74
      llvm.br ^bb76
    ^bb76:  // pred: ^bb75
    ...
    ^bb80:  // pred: ^bb79
      ...
      llvm.br ^bb81(%972, %171, %171, %arg0, %171, %171, %172, %953, %171 : i1, i32, i32, !llvm.struct<(i1, i1, i1)>, i32, i32, i32, i32, i32)
    ^bb81(%1001: i1, %1002: i32, %1003: i32, %1004: !llvm.struct<(i1, i1, i1)>, %1005: i32, %1006: i32, %1007: i32, %1008: i32, %1009: i32):  // 2 preds: ^bb80, ^bb115
      llvm.cond_br %1001, ^bb82(%1002, %1003, %1004, %1005, %1006, %1007, %1008, %1009 : i32, i32, !llvm.struct<(i1, i1, i1)>, i32, i32, i32, i32, i32), ^bb116
    ^bb82(%1010: i32, %1011: i32, %1012: !llvm.struct<(i1, i1, i1)>, %1013: i32, %1014: i32, %1015: i32, %1016: i32, %1017: i32):  // pred: ^bb81
      ...
      llvm.br ^bb83(%171, %1024, %171, %1010, %1011, %1026 : i32, i1, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb83(%1027: i32, %1028: i1, %1029: i32, %1030: i32, %1031: i32, %1032: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb82, ^bb108
      %1033 = llvm.icmp "slt" %1027, %479 : i32
      llvm.cond_br %1033, ^bb84, ^bb109
    ^bb84:  // pred: ^bb83
      %1034 = llvm.zext %1028 : i1 to i32
      %1035 = llvm.icmp "eq" %1034, %171 : i32
      llvm.cond_br %1035, ^bb85, ^bb86
    ^bb85:  // pred: ^bb84
    ...
    ^bb86:  // 2 preds: ^bb84, ^bb85
      ...
      llvm.cond_br %1039, ^bb87, ^bb88
    ^bb87:  // pred: ^bb86
      %1041 = llvm.xor %1031, %172 : i32
      llvm.br ^bb89(%1041 : i32)
    ^bb88:  // pred: ^bb86
      llvm.br ^bb89(%1031 : i32)
    ^bb89(%1042: i32):  // 2 preds: ^bb87, ^bb88
      llvm.br ^bb90
    ^bb90:  // pred: ^bb89
      llvm.br ^bb91(%171, %1032 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb91(%1043: i32, %1044: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb90, ^bb101
      %1045 = llvm.icmp "slt" %1043, %160 : i32
      llvm.cond_br %1045, ^bb92, ^bb102 {loop_annotation = #loop_annotation2}
    ^bb92:  // pred: ^bb91
      ...
      llvm.br ^bb93(%171 : i32)
    ^bb93(%1079: i32):  // 2 preds: ^bb92, ^bb100
      %1080 = llvm.icmp "slt" %1079, %1000 : i32
      llvm.cond_br %1080, ^bb94, ^bb101 {llvm.loop_annotation = #loop_annotation1}
    ^bb94:  // pred: ^bb93
      llvm.br ^bb95(%171 : i32)
    ^bb95(%1081: i32):  // 2 preds: ^bb94, ^bb99
      %1082 = llvm.icmp "slt" %1081, %1000 : i32
      llvm.cond_br %1082, ^bb96, ^bb100 {llvm.loop_annotation = #loop_annotation1}
    ^bb96:  // pred: ^bb95
      llvm.br ^bb97(%171 : i32)
    ^bb97(%1083: i32):  // 2 preds: ^bb96, ^bb98
      %1084 = llvm.icmp "slt" %1083, %1000 : i32
      llvm.cond_br %1084, ^bb98, ^bb99 {llvm.loop_annotation = #loop_annotation1}
    ^bb98:  // pred: ^bb97
    ...
    ^bb105:  // pred: ^bb104
      ...
      llvm.br ^bb107(%1097 : i1)
    ^bb106:  // pred: ^bb104
      llvm.br ^bb107(%148 : i1)
    ^bb107(%1098: i1):  // 2 preds: ^bb105, ^bb106
      llvm.br ^bb108
    ^bb108:  // pred: ^bb107
      %1099 = llvm.add %1027, %172 : i32
      llvm.br ^bb83(%1099, %1098, %1038, %1040, %1042, %1044 : i32, i1, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb109:  // pred: ^bb83
      %1100 = nvvm.elect.sync -> i1
      llvm.cond_br %1100, ^bb110, ^bb111
    ^bb110:  // pred: ^bb109
    ...
    ^bb111:  // 2 preds: ^bb109, ^bb110
      ...
      llvm.cond_br %1104, ^bb112, ^bb113
    ^bb112:  // pred: ^bb111
      %1106 = llvm.xor %1015, %172 : i32
      llvm.br ^bb114(%1106 : i32)
    ^bb113:  // pred: ^bb111
      llvm.br ^bb114(%1015 : i32)
    ^bb114(%1107: i32):  // 2 preds: ^bb112, ^bb113
      llvm.br ^bb115
    ^bb115:  // pred: ^bb114
      ...
      llvm.br ^bb81(%1110, %1030, %1031, %1032, %1103, %1105, %1107, %1108, %1109 : i1, i32, i32, !llvm.struct<(i1, i1, i1)>, i32, i32, i32, i32, i32)
    ^bb116:  // pred: ^bb81
    ...
    ^bb123:  // 2 preds: ^bb79, ^bb122
      ...
      llvm.cond_br %1137, ^bb124, ^bb146
    ^bb124:  // pred: ^bb123
      llvm.cond_br %238, ^bb125, ^bb126
    ^bb125:  // pred: ^bb124
    ...
    ^bb126:  // 2 preds: ^bb124, ^bb125
      ...
      llvm.br ^bb127(%1251, %1264, %1262, %1225, %171, %171, %171, %1139, %171 : i32, i32, i32, i1, i32, i32, i32, i32, i32)
    ^bb127(%1522: i32, %1523: i32, %1524: i32, %1525: i1, %1526: i32, %1527: i32, %1528: i32, %1529: i32, %1530: i32):  // 2 preds: ^bb126, ^bb140
      llvm.cond_br %1525, ^bb128(%1522, %1523, %1524, %1526, %1527, %1528, %1529, %1530 : i32, i32, i32, i32, i32, i32, i32, i32), ^bb141
    ^bb128(%1531: i32, %1532: i32, %1533: i32, %1534: i32, %1535: i32, %1536: i32, %1537: i32, %1538: i32):  // pred: ^bb127
      ...
      llvm.br ^bb129(%171 : i32)
    ^bb129(%1569: i32):  // 2 preds: ^bb128, ^bb130
      %1570 = llvm.icmp "slt" %1569, %1267 : i32
      llvm.cond_br %1570, ^bb130, ^bb131 {llvm.loop_annotation = #loop_annotation1}
    ^bb130:  // pred: ^bb129
    ...
    ^bb131:  // pred: ^bb129
      ...
      llvm.br ^bb132(%171 : i32)
    ^bb132(%1839: i32):  // 2 preds: ^bb131, ^bb133
      %1840 = llvm.icmp "slt" %1839, %1267 : i32
      llvm.cond_br %1840, ^bb133, ^bb134 {llvm.loop_annotation = #loop_annotation1}
    ^bb133:  // pred: ^bb132
      ...
      llvm.br ^bb132(%1969 : i32)
    ^bb134:  // pred: ^bb132
      %1970 = nvvm.elect.sync -> i1
      llvm.cond_br %1970, ^bb135, ^bb136
    ^bb135:  // pred: ^bb134
    ...
    ^bb136:  // 2 preds: ^bb134, ^bb135
      ...
      llvm.cond_br %1974, ^bb137, ^bb138
    ^bb137:  // pred: ^bb136
      %1976 = llvm.xor %1536, %172 : i32
      llvm.br ^bb139(%1976 : i32)
    ^bb138:  // pred: ^bb136
      llvm.br ^bb139(%1536 : i32)
    ^bb139(%1977: i32):  // 2 preds: ^bb137, ^bb138
      llvm.br ^bb140
    ^bb140:  // pred: ^bb139
      ...
      llvm.br ^bb127(%1994, %2001, %1999, %1980, %1973, %1975, %1977, %1978, %1979 : i32, i32, i32, i1, i32, i32, i32, i32, i32)
    ^bb141:  // pred: ^bb127
      nvvm.barrier id = %11 number_of_threads = %159
      llvm.cond_br %238, ^bb142, ^bb143
    ^bb142:  // pred: ^bb141
      nvvm.tcgen05.relinquish_alloc_permit
      llvm.br ^bb143
    ^bb143:  // 2 preds: ^bb141, ^bb142
      llvm.cond_br %238, ^bb144, ^bb145
    ^bb144:  // pred: ^bb143
