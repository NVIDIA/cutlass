  ...
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass_kernel___main__PersistentDenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB11288128_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: !cute.fast_divmod_divisor<32>, %arg10: !cute.fast_divmod_divisor<32>, %arg11: !cute.fast_divmod_divisor<32>) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 192, 1, 1>} {
      ...
      scf.if %154 {
        ...
        %226 = arith.minsi %174, %c7_i32 : i32
        %iv_67 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
        %227 = cute.inttoptr(%iv_67) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
        %228 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %229 = cute_nvgpu.atom.set_value(%228, %227 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %230 = cute.get_scalars(%137) : !cute.int_tuple<"1">
        %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%229 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
        %231 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
        %232 = cute_nvgpu.atom.get_value(%229 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
        %233 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %234 = cute_nvgpu.atom.set_value(%233, %227 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %TMADescAddr_68 = cute_nvgpu.get_tma_desc_addr(%234 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
        %235 = builtin.unrealized_conversion_cast %TMADescAddr_68 : !cute.ptr<generic, align<64>> to !llvm.ptr
        %236 = cute_nvgpu.atom.get_value(%234 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
        %237 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %238 = cute.get_scalars(%137) : !cute.int_tuple<"1">
        %239 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %sub = cute.tuple_sub(%e0_29, %131) : (!cute.int_tuple<"?">, !cute.int_tuple<"7">) -> !cute.int_tuple<"?">
        %240 = cute.get_scalars(%sub) : !cute.int_tuple<"?">
        %241:7 = scf.while (%arg12 = %221, %arg13 = %222, %arg14 = %223, %arg15 = %190, %arg16 = %c0_i32, %arg17 = %c1_i32, %arg18 = %184, %arg19 = %c0_i32) : (i32, i32, i32, i1, i32, i32, i32, i32) -> (i32, i32, i32, i32, i32, i32, i32) {
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32):
          ...
          %tup_73 = cute.add_offset(%127, %idx_72) : (!cute.int_tuple<"(0,0,0)">, !cute.int_tuple<"(0,?{div=128},?)">) -> !cute.int_tuple<"(0,?{div=128},?)">
          scf.for %arg19 = %c0_i32 to %226 step %c1_i32  : i32 {
            ...
            %298:3 = cute.get_scalars(%tup_84) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            scf.for %arg20 = %c0_i32 to %230 step %c1_i32  : i32 {
              nvvm.cp.async.bulk.tensor.prefetch %231, box[%298#0, %298#1, %298#2] l2_cache_hint = %232 : !llvm.ptr
            ...
            %299:3 = cute.get_scalars(%tup_86) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            scf.for %arg20 = %c0_i32 to %230 step %c1_i32  : i32 {
              nvvm.cp.async.bulk.tensor.prefetch %235, box[%299#0, %299#1, %299#2] l2_cache_hint = %236 : !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
          ...
          %268 = builtin.unrealized_conversion_cast %ptr_75 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          %269 = nvvm.mbarrier.wait.parity %268, %arg16 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
          %270:4 = scf.for %arg19 = %c0_i32 to %174 step %c1_i32 iter_args(%arg20 = %269, %arg21 = %c0_i32, %arg22 = %arg15, %arg23 = %arg16) -> (i1, i32, i32, i32)  : i32 {
            %298 = arith.extui %arg20 : i1 to i32
            ...
            scf.if %299 {
              ...
              %317 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %317, %arg23, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            ...
            scf.if %300 {
              ...
              %317 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %317, %c32768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            ...
            %305 = scf.if %303 -> (i32) {
              %317 = arith.xori %arg23, %c1_i32 : i32
              scf.yield %317 : i32
            } else {
              scf.yield %arg23 : i32
            }
            ...
            %idx_89 = cute.crd2idx(%coord_88, %122) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),7):((1,0),4096)">) -> !cute.int_tuple<"?{div=4096}">
            ...
            %306 = cute_nvgpu.atom.set_value(%237, %ptr_92 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %307 = cute_nvgpu.atom.get_value(%306 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %308 = cute_nvgpu.atom.get_value(%306 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr_94 = cute_nvgpu.get_tma_desc_addr(%306 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
            %309:3 = cute.get_scalars(%int_tuple_93) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            scf.for %arg24 = %c0_i32 to %238 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_94 : !cute.ptr<generic, align<64>>, %ptr_90 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %307 : !cute.ptr<smem, align<8>>, [%309#0, %309#1, %309#2] : i32, i32, i32) cache_policy = %308 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %310 = cute_nvgpu.atom.set_value(%239, %ptr_92 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            ...
            %TMADescAddr_102 = cute_nvgpu.get_tma_desc_addr(%310 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
            %313:3 = cute.get_scalars(%int_tuple_101) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            scf.for %arg24 = %c0_i32 to %238 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_102 : !cute.ptr<generic, align<64>>, %ptr_100 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %311 : !cute.ptr<smem, align<8>>, [%313#0, %313#1, %313#2] : i32, i32, i32) cache_policy = %312 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %314 = arith.cmpi sgt, %240, %arg19 : i32
            scf.if %314 {
              %317 = arith.addi %arg21, %c7_i32 : i32
              %coord_103 = cute.make_coord(%317) : (i32) -> !cute.coord<"(_,?)">
              ...
              %318 = cute.inttoptr(%iv_106) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
              %319 = cute_nvgpu.atom.set_value(%237, %318 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %TMADescAddr_107 = cute_nvgpu.get_tma_desc_addr(%319 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %320 = builtin.unrealized_conversion_cast %TMADescAddr_107 : !cute.ptr<generic, align<64>> to !llvm.ptr
              %321 = cute_nvgpu.atom.get_value(%319 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %322:3 = cute.get_scalars(%tup_105) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              scf.for %arg24 = %c0_i32 to %238 step %c1_i32  : i32 {
                nvvm.cp.async.bulk.tensor.prefetch %320, box[%322#0, %322#1, %322#2] l2_cache_hint = %321 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              ...
              %323 = cute_nvgpu.atom.set_value(%239, %318 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %TMADescAddr_110 = cute_nvgpu.get_tma_desc_addr(%323 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %324 = builtin.unrealized_conversion_cast %TMADescAddr_110 : !cute.ptr<generic, align<64>> to !llvm.ptr
              %325 = cute_nvgpu.atom.get_value(%323 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %326:3 = cute.get_scalars(%tup_109) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              scf.for %arg24 = %c0_i32 to %238 step %c1_i32  : i32 {
                nvvm.cp.async.bulk.tensor.prefetch %324, box[%326#0, %326#1, %326#2] l2_cache_hint = %325 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
            }
            %315 = arith.cmpi sgt, %174, %302 : i32
            %316 = scf.if %315 -> (i1) {
              %int_tuple_103 = cute.make_int_tuple(%304) : (i32) -> !cute.int_tuple<"?">
              %ptr_104 = cute.add_offset(%ptr_4, %int_tuple_103) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %317 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %318 = nvvm.mbarrier.wait.parity %317, %305 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %318 : i1
            } else {
              scf.yield %true : i1
            }
            scf.yield %316, %302, %304, %305 : i1, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          %271 = arith.addi %arg17, %188 : i32
          %272 = arith.addi %arg18, %c1_i32 : i32
          %273 = arith.cmpi sgt, %189, %271 : i32
          %274 = nvvm.mul  hi %271, %multiplier : i32 -> i32
          %275 = arith.subi %271, %274 : i32
          %276 = arith.shrui %275, %192 : i32
          %277 = arith.addi %274, %276 : i32
          %278 = arith.shrui %277, %193 : i32
          %279 = arith.muli %278, %191 : i32
          %280 = arith.subi %271, %279 : i32
          %281 = nvvm.mul  hi %280, %multiplier_52 : i32 -> i32
          %282 = arith.subi %280, %281 : i32
          %283 = arith.shrui %282, %202 : i32
          %284 = arith.addi %281, %283 : i32
          %285 = arith.shrui %284, %203 : i32
          %286 = arith.muli %285, %201 : i32
          %287 = arith.subi %280, %286 : i32
          %288 = nvvm.mul  hi %285, %multiplier_55 : i32 -> i32
          %289 = arith.subi %285, %288 : i32
          %290 = arith.shrui %289, %212 : i32
          %291 = arith.addi %288, %290 : i32
          %292 = arith.shrui %291, %213 : i32
          %293 = arith.muli %292, %211 : i32
          %294 = arith.subi %285, %293 : i32
          %int_tuple_76 = cute.make_int_tuple(%287) : (i32) -> !cute.int_tuple<"?">
          %mul_77 = cute.tuple_mul(%int_tuple_76, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %295 = cute.get_scalars(%mul_77) : !cute.int_tuple<"?">
          %int_tuple_78 = cute.make_int_tuple(%294) : (i32) -> !cute.int_tuple<"?">
          %mul_79 = cute.tuple_mul(%int_tuple_78, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %296 = cute.get_scalars(%mul_79) : !cute.int_tuple<"?">
          %int_tuple_80 = cute.make_int_tuple(%292) : (i32) -> !cute.int_tuple<"?">
          %mul_81 = cute.tuple_mul(%int_tuple_80, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %297 = cute.get_scalars(%mul_81) : !cute.int_tuple<"?">
          scf.yield %295, %296, %297, %273, %270#2, %270#3, %271, %272 : i32, i32, i32, i1, i32, i32, i32, i32
        }
        %242 = arith.addi %241#3, %c1_i32 : i32
        %243 = arith.cmpi eq, %242, %c7_i32 : i32
        %244 = arith.select %243, %c0_i32, %242 : i32
        %245 = scf.if %243 -> (i32) {
          %268 = arith.xori %241#4, %c1_i32 : i32
          scf.yield %268 : i32
        } else {
          scf.yield %241#4 : i32
        }
        ...
        %257 = scf.if %255 -> (i32) {
          %268 = arith.xori %253, %c1_i32 : i32
          scf.yield %268 : i32
        } else {
          scf.yield %253 : i32
        }
        %258 = arith.addi %256, %c1_i32 : i32
        %259 = arith.cmpi eq, %258, %c7_i32 : i32
        %260 = arith.select %259, %c0_i32, %258 : i32
        %261 = scf.if %259 -> (i32) {
          %268 = arith.xori %257, %c1_i32 : i32
          scf.yield %268 : i32
        } else {
          scf.yield %257 : i32
        }
        %262 = arith.addi %260, %c1_i32 : i32
        %263 = arith.cmpi eq, %262, %c7_i32 : i32
        %264 = arith.select %263, %c0_i32, %262 : i32
        %265 = scf.if %263 -> (i32) {
          %268 = arith.xori %261, %c1_i32 : i32
          scf.yield %268 : i32
        } else {
          scf.yield %261 : i32
        }
        %int_tuple_69 = cute.make_int_tuple(%264) : (i32) -> !cute.int_tuple<"?">
        %ptr_70 = cute.add_offset(%ptr_4, %int_tuple_69) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
        %266 = builtin.unrealized_conversion_cast %ptr_70 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.try_wait.parity.shared %266, %265, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        ...
        scf.if %267 {
          ...
          %268 = builtin.unrealized_conversion_cast %ptr_71 : !cute.ptr<i64, smem> to !llvm.ptr<3>
