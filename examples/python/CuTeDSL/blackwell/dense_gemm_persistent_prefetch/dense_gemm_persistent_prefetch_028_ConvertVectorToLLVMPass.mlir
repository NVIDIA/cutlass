...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb19:  // pred: ^bb18
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%690, %686, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb20] : () -> ()
    ...
    ^bb62:  // pred: ^bb61
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%767, %766, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb68:  // pred: ^bb67
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%817, %811, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb71:  // pred: ^bb70
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%828, %823, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb72] : () -> ()
    ...
    ^bb100:  // pred: ^bb99
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%902, %901, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb101] : () -> ()
    ...
    ^bb107:  // pred: ^bb106
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%1140, %1127, %442) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
