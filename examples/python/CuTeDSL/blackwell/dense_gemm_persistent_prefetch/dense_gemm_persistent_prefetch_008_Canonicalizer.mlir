    ...
    cuda.kernel @kernel_cutlass_kernel___main__PersistentDenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB11288128_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: !cute.fast_divmod_divisor<32>, %arg10: !cute.fast_divmod_divisor<32>, %arg11: !cute.fast_divmod_divisor<32>) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 192, 1, 1>} {
      ...
      scf.if %234 {
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32):
          ...
          %307 = arith.minsi %226, %c7_i32 : i32
          scf.for %arg19 = %c0_i32 to %307 step %c1_i32  : i32 {
            %coord_98 = cute.make_coord(%arg19) : (i32) -> !cute.coord<"(_,?)">
            ...
            %iv_101 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
            %348 = cute.inttoptr(%iv_101) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
            %349 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %350 = cute_nvgpu.atom.set_value(%349, %348 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %351 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg20 = %c0_i32 to %351 step %c1_i32  : i32 {
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%350 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %356 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
              %357 = cute_nvgpu.atom.get_value(%350 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %358:3 = cute.get_scalars(%tup_100) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              nvvm.cp.async.bulk.tensor.prefetch %356, box[%358#0, %358#1, %358#2] l2_cache_hint = %357 : !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %coord_102 = cute.make_coord(%arg19) : (i32) -> !cute.coord<"(_,?)">
            %idx_103 = cute.crd2idx(%coord_102, %lay_76) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
            %tup_104 = cute.add_offset(%tup_78, %idx_103) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %iv_105 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
            %352 = cute.inttoptr(%iv_105) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
            %353 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %354 = cute_nvgpu.atom.set_value(%353, %352 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %355 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg20 = %c0_i32 to %355 step %c1_i32  : i32 {
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%354 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %356 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
              %357 = cute_nvgpu.atom.get_value(%354 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %358:3 = cute.get_scalars(%tup_104) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              nvvm.cp.async.bulk.tensor.prefetch %356, box[%358#0, %358#1, %358#2] l2_cache_hint = %357 : !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
          ...
          %308 = builtin.unrealized_conversion_cast %ptr_80 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          %309 = nvvm.mbarrier.wait.parity %308, %arg16 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
          %310:4 = scf.for %arg19 = %c0_i32 to %226 step %c1_i32 iter_args(%arg20 = %309, %arg21 = %c0_i32, %arg22 = %arg15, %arg23 = %arg16) -> (i1, i32, i32, i32)  : i32 {
            %348 = arith.extui %arg20 : i1 to i32
            ...
            scf.if %349 {
              ...
              %367 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %367, %arg23, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            ...
            scf.if %350 {
              ...
              %367 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %367, %c32768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            %351 = arith.addi %arg22, %c1_i32 : i32
            %352 = arith.addi %arg21, %c1_i32 : i32
            %353 = arith.cmpi eq, %351, %c7_i32 : i32
            %354 = arith.select %353, %c0_i32, %351 : i32
            %355 = scf.if %353 -> (i32) {
              %367 = arith.xori %arg23, %c1_i32 : i32
              scf.yield %367 : i32
            } else {
              scf.yield %arg23 : i32
            }
            ...
            %356 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %357 = cute_nvgpu.atom.set_value(%356, %ptr_108 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %358 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg24 = %c0_i32 to %358 step %c1_i32  : i32 {
              %367 = cute_nvgpu.atom.get_value(%357 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %368 = cute_nvgpu.atom.get_value(%357 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%357 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %369:3 = cute.get_scalars(%int_tuple_109) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_106 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %367 : !cute.ptr<smem, align<8>>, [%369#0, %369#1, %369#2] : i32, i32, i32) cache_policy = %368 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %359 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %360 = cute_nvgpu.atom.set_value(%359, %ptr_120 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %361 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg24 = %c0_i32 to %361 step %c1_i32  : i32 {
              %367 = cute_nvgpu.atom.get_value(%360 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %368 = cute_nvgpu.atom.get_value(%360 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%360 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %369:3 = cute.get_scalars(%int_tuple_121) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_118 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %367 : !cute.ptr<smem, align<8>>, [%369#0, %369#1, %369#2] : i32, i32, i32) cache_policy = %368 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %sub = cute.tuple_sub(%e0_29, %131) : (!cute.int_tuple<"?">, !cute.int_tuple<"7">) -> !cute.int_tuple<"?">
            %362 = cute.get_scalars(%sub) : !cute.int_tuple<"?">
            %363 = arith.cmpi sgt, %362, %arg19 : i32
            scf.if %363 {
              %367 = arith.addi %arg21, %c7_i32 : i32
              %coord_122 = cute.make_coord(%367) : (i32) -> !cute.coord<"(_,?)">
              %idx_123 = cute.crd2idx(%coord_122, %lay_73) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
              %tup_124 = cute.add_offset(%tup, %idx_123) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %iv_125 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
              %368 = cute.inttoptr(%iv_125) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
              %369 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %370 = cute_nvgpu.atom.set_value(%369, %368 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %371 = cute.get_scalars(%137) : !cute.int_tuple<"1">
              scf.for %arg24 = %c0_i32 to %371 step %c1_i32  : i32 {
                %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%370 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
                %376 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
                %377 = cute_nvgpu.atom.get_value(%370 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                %378:3 = cute.get_scalars(%tup_124) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
                nvvm.cp.async.bulk.tensor.prefetch %376, box[%378#0, %378#1, %378#2] l2_cache_hint = %377 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %coord_126 = cute.make_coord(%367) : (i32) -> !cute.coord<"(_,?)">
              %idx_127 = cute.crd2idx(%coord_126, %lay_76) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
              %tup_128 = cute.add_offset(%tup_78, %idx_127) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %iv_129 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
              %372 = cute.inttoptr(%iv_129) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
              %373 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %374 = cute_nvgpu.atom.set_value(%373, %372 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              %375 = cute.get_scalars(%137) : !cute.int_tuple<"1">
              scf.for %arg24 = %c0_i32 to %375 step %c1_i32  : i32 {
                %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%374 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
                %376 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
                %377 = cute_nvgpu.atom.get_value(%374 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                %378:3 = cute.get_scalars(%tup_128) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
                nvvm.cp.async.bulk.tensor.prefetch %376, box[%378#0, %378#1, %378#2] l2_cache_hint = %377 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
            }
            %364 = arith.addi %arg21, %c1_i32 : i32
            %365 = arith.cmpi sgt, %226, %364 : i32
            %366 = scf.if %365 -> (i1) {
              %int_tuple_122 = cute.make_int_tuple(%354) : (i32) -> !cute.int_tuple<"?">
              %ptr_123 = cute.add_offset(%ptr_4, %int_tuple_122) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %367 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %368 = nvvm.mbarrier.wait.parity %367, %355 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %368 : i1
            } else {
              scf.yield %true : i1
            }
            scf.yield %366, %352, %354, %355 : i1, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          %311 = arith.addi %arg17, %241 : i32
          %312 = arith.addi %arg18, %c1_i32 : i32
          %sz_81 = cute.size(%lay_71) : (!cute.layout<"(?,?,?):(1,?,?)">) -> !cute.int_tuple<"?">
          %e0_82 = cute.get_leaves(%sz_81) : !cute.int_tuple<"?">
          %313 = cute.get_scalars(%e0_82) : !cute.int_tuple<"?">
          %314 = arith.cmpi sgt, %313, %311 : i32
          %315 = cute.fast_divmod.get_divisor(%arg9) : !cute.fast_divmod_divisor<32>
          %multiplier_83, %shift1_84, %shift2_85 = cute.fast_divmod.get_aux(%arg9) : !cute.fast_divmod_divisor<32> -> (i32, i8)
          %316 = arith.extui %shift1_84 : i8 to i32
          %317 = arith.extui %shift2_85 : i8 to i32
          %318 = nvvm.mul  hi %311, %multiplier_83 : i32 -> i32
          %319 = arith.subi %311, %318 : i32
          %320 = arith.shrui %319, %316 : i32
          %321 = arith.addi %318, %320 : i32
          %322 = arith.shrui %321, %317 : i32
          %323 = arith.muli %322, %315 : i32
          %324 = arith.subi %311, %323 : i32
          %325 = cute.fast_divmod.get_divisor(%arg10) : !cute.fast_divmod_divisor<32>
          %multiplier_86, %shift1_87, %shift2_88 = cute.fast_divmod.get_aux(%arg10) : !cute.fast_divmod_divisor<32> -> (i32, i8)
          %326 = arith.extui %shift1_87 : i8 to i32
          %327 = arith.extui %shift2_88 : i8 to i32
          %328 = nvvm.mul  hi %324, %multiplier_86 : i32 -> i32
          %329 = arith.subi %324, %328 : i32
          %330 = arith.shrui %329, %326 : i32
          %331 = arith.addi %328, %330 : i32
          %332 = arith.shrui %331, %327 : i32
          %333 = arith.muli %332, %325 : i32
          %334 = arith.subi %324, %333 : i32
          %335 = cute.fast_divmod.get_divisor(%arg11) : !cute.fast_divmod_divisor<32>
          %multiplier_89, %shift1_90, %shift2_91 = cute.fast_divmod.get_aux(%arg11) : !cute.fast_divmod_divisor<32> -> (i32, i8)
          %336 = arith.extui %shift1_90 : i8 to i32
          %337 = arith.extui %shift2_91 : i8 to i32
          %338 = nvvm.mul  hi %332, %multiplier_89 : i32 -> i32
          %339 = arith.subi %332, %338 : i32
          %340 = arith.shrui %339, %336 : i32
          %341 = arith.addi %338, %340 : i32
          %342 = arith.shrui %341, %337 : i32
          %343 = arith.muli %342, %335 : i32
          %344 = arith.subi %332, %343 : i32
          %int_tuple_92 = cute.make_int_tuple(%334) : (i32) -> !cute.int_tuple<"?">
          %mul_93 = cute.tuple_mul(%int_tuple_92, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %345 = cute.get_scalars(%mul_93) : !cute.int_tuple<"?">
          %int_tuple_94 = cute.make_int_tuple(%344) : (i32) -> !cute.int_tuple<"?">
          %mul_95 = cute.tuple_mul(%int_tuple_94, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %346 = cute.get_scalars(%mul_95) : !cute.int_tuple<"?">
          %int_tuple_96 = cute.make_int_tuple(%342) : (i32) -> !cute.int_tuple<"?">
          %mul_97 = cute.tuple_mul(%int_tuple_96, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %347 = cute.get_scalars(%mul_97) : !cute.int_tuple<"?">
          scf.yield %345, %346, %347, %314, %310#2, %310#3, %311, %312 : i32, i32, i32, i1, i32, i32, i32, i32
        }
