...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb14(%257: i32):  // 2 preds: ^bb13, ^bb21
      ...
      llvm.cond_br %258, ^bb15, ^bb22 {loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
      %259 = llvm.mul %257, %14 : i32
      llvm.br ^bb16(%16 : i32)
    ^bb16(%260: i32):  // 2 preds: ^bb15, ^bb17
      %261 = llvm.icmp "slt" %260, %36 : i32
      llvm.cond_br %261, ^bb17, ^bb18 {llvm.loop_annotation = #loop_annotation1}
    ^bb17:  // pred: ^bb16
    ...
    ^bb19(%263: i32):  // 2 preds: ^bb18, ^bb20
      ...
      llvm.cond_br %264, ^bb20, ^bb21 {llvm.loop_annotation = #loop_annotation1}
    ^bb20:  // pred: ^bb19
    ...
    ^bb23(%269: i32, %270: i1, %271: i32, %272: i32, %273: i32):  // 2 preds: ^bb22, ^bb54
      ...
      llvm.cond_br %274, ^bb24, ^bb55 {loop_annotation = #loop_annotation}
    ^bb24:  // pred: ^bb23
    ...
    ^bb33(%290: i32):  // 2 preds: ^bb32, ^bb36
      ...
      llvm.cond_br %291, ^bb34, ^bb37 {llvm.loop_annotation = #loop_annotation1}
    ^bb34:  // pred: ^bb33
    ...
    ^bb38(%295: i32):  // 2 preds: ^bb37, ^bb41
      ...
      llvm.cond_br %296, ^bb39, ^bb42 {llvm.loop_annotation = #loop_annotation1}
    ^bb39:  // pred: ^bb38
    ...
    ^bb44(%302: i32):  // 2 preds: ^bb43, ^bb45
      ...
      llvm.cond_br %303, ^bb45, ^bb46 {llvm.loop_annotation = #loop_annotation1}
    ^bb45:  // pred: ^bb44
    ...
    ^bb47(%305: i32):  // 2 preds: ^bb46, ^bb48
      ...
      llvm.cond_br %306, ^bb48, ^bb49 {llvm.loop_annotation = #loop_annotation1}
    ^bb48:  // pred: ^bb47
    ...
    ^bb95(%434: i32, %435: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb94, ^bb107
      ...
      llvm.cond_br %436, ^bb96, ^bb108 {loop_annotation = #loop_annotation2}
    ^bb96:  // pred: ^bb95
    ...
    ^bb97(%459: i32):  // 2 preds: ^bb96, ^bb106
      ...
      llvm.cond_br %460, ^bb98, ^bb107 {llvm.loop_annotation = #loop_annotation1}
    ^bb98:  // pred: ^bb97
      llvm.br ^bb99(%16 : i32)
    ^bb99(%461: i32):  // 2 preds: ^bb98, ^bb105
      %462 = llvm.icmp "slt" %461, %36 : i32
      llvm.cond_br %462, ^bb100, ^bb106 {llvm.loop_annotation = #loop_annotation1}
    ^bb100:  // pred: ^bb99
      llvm.br ^bb101(%16 : i32)
    ^bb101(%463: i32):  // 2 preds: ^bb100, ^bb104
      %464 = llvm.icmp "slt" %463, %36 : i32
      llvm.cond_br %464, ^bb102, ^bb105 {llvm.loop_annotation = #loop_annotation1}
    ^bb102:  // pred: ^bb101
    ...
    ^bb135(%749: i32):  // 2 preds: ^bb134, ^bb136
      ...
      llvm.cond_br %750, ^bb136, ^bb137 {llvm.loop_annotation = #loop_annotation1}
    ^bb136:  // pred: ^bb135
    ...
    ^bb138(%882: i32):  // 2 preds: ^bb137, ^bb139
      ...
      llvm.cond_br %883, ^bb139, ^bb140 {llvm.loop_annotation = #loop_annotation1}
    ^bb139:  // pred: ^bb138
