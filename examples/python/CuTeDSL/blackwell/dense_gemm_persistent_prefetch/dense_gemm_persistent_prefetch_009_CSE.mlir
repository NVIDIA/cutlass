    ...
    cuda.kernel @kernel_cutlass_kernel___main__PersistentDenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB11288128_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: !cute.fast_divmod_divisor<32>, %arg10: !cute.fast_divmod_divisor<32>, %arg11: !cute.fast_divmod_divisor<32>) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 192, 1, 1>} {
      ...
      scf.if %154 {
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32, %arg18: i32):
          ...
          %253 = arith.minsi %174, %c7_i32 : i32
          scf.for %arg19 = %c0_i32 to %253 step %c1_i32  : i32 {
            %coord_80 = cute.make_coord(%arg19) : (i32) -> !cute.coord<"(_,?)">
            ...
            %iv_83 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
            %284 = cute.inttoptr(%iv_83) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
            %285 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %286 = cute_nvgpu.atom.set_value(%285, %284 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %287 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg20 = %c0_i32 to %287 step %c1_i32  : i32 {
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%286 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %290 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
              %291 = cute_nvgpu.atom.get_value(%286 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %292:3 = cute.get_scalars(%tup_82) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              nvvm.cp.async.bulk.tensor.prefetch %290, box[%292#0, %292#1, %292#2] l2_cache_hint = %291 : !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %idx_84 = cute.crd2idx(%coord_80, %lay_69) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
            %tup_85 = cute.add_offset(%tup_71, %idx_84) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %288 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %289 = cute_nvgpu.atom.set_value(%288, %284 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            scf.for %arg20 = %c0_i32 to %287 step %c1_i32  : i32 {
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%289 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %290 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
              %291 = cute_nvgpu.atom.get_value(%289 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %292:3 = cute.get_scalars(%tup_85) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              nvvm.cp.async.bulk.tensor.prefetch %290, box[%292#0, %292#1, %292#2] l2_cache_hint = %291 : !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
          ...
          %254 = builtin.unrealized_conversion_cast %ptr_73 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          %255 = nvvm.mbarrier.wait.parity %254, %arg16 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
          %256:4 = scf.for %arg19 = %c0_i32 to %174 step %c1_i32 iter_args(%arg20 = %255, %arg21 = %c0_i32, %arg22 = %arg15, %arg23 = %arg16) -> (i1, i32, i32, i32)  : i32 {
            %284 = arith.extui %arg20 : i1 to i32
            ...
            scf.if %285 {
              ...
              %301 = builtin.unrealized_conversion_cast %ptr_100 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.try_wait.parity.shared %301, %arg23, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            ...
            %287 = arith.addi %arg22, %c1_i32 : i32
            %288 = arith.addi %arg21, %c1_i32 : i32
            %289 = arith.cmpi eq, %287, %c7_i32 : i32
            %290 = arith.select %289, %c0_i32, %287 : i32
            %291 = scf.if %289 -> (i32) {
              %301 = arith.xori %arg23, %c1_i32 : i32
              scf.yield %301 : i32
            } else {
              scf.yield %arg23 : i32
            }
            ...
            %292 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %293 = cute_nvgpu.atom.set_value(%292, %ptr_90 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %294 = cute.get_scalars(%137) : !cute.int_tuple<"1">
            scf.for %arg24 = %c0_i32 to %294 step %c1_i32  : i32 {
              %301 = cute_nvgpu.atom.get_value(%293 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %302 = cute_nvgpu.atom.get_value(%293 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%293 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %303:3 = cute.get_scalars(%int_tuple_91) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_88 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %301 : !cute.ptr<smem, align<8>>, [%303#0, %303#1, %303#2] : i32, i32, i32) cache_policy = %302 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %295 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            %296 = cute_nvgpu.atom.set_value(%295, %ptr_90 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            scf.for %arg24 = %c0_i32 to %294 step %c1_i32  : i32 {
              %301 = cute_nvgpu.atom.get_value(%296 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %302 = cute_nvgpu.atom.get_value(%296 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%296 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
              %303:3 = cute.get_scalars(%int_tuple_98) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_97 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %301 : !cute.ptr<smem, align<8>>, [%303#0, %303#1, %303#2] : i32, i32, i32) cache_policy = %302 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %sub = cute.tuple_sub(%e0_29, %131) : (!cute.int_tuple<"?">, !cute.int_tuple<"7">) -> !cute.int_tuple<"?">
            %297 = cute.get_scalars(%sub) : !cute.int_tuple<"?">
            %298 = arith.cmpi sgt, %297, %arg19 : i32
            scf.if %298 {
              %301 = arith.addi %arg21, %c7_i32 : i32
              %coord_99 = cute.make_coord(%301) : (i32) -> !cute.coord<"(_,?)">
              %idx_100 = cute.crd2idx(%coord_99, %lay_66) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
              %tup_101 = cute.add_offset(%tup, %idx_100) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %iv_102 = cute.assume(%c0_i64) : (i64) -> !cute.i64<divby 8>
              %302 = cute.inttoptr(%iv_102) : !cute.i64<divby 8> to !cute.ptr<i64, smem>
              %303 = cute_nvgpu.atom.set_value(%292, %302 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              scf.for %arg24 = %c0_i32 to %294 step %c1_i32  : i32 {
                %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%303 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
                %305 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
                %306 = cute_nvgpu.atom.get_value(%303 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                %307:3 = cute.get_scalars(%tup_101) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
                nvvm.cp.async.bulk.tensor.prefetch %305, box[%307#0, %307#1, %307#2] l2_cache_hint = %306 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
              %idx_103 = cute.crd2idx(%coord_99, %lay_69) : (!cute.coord<"(_,?)">, !cute.layout<"(((32,128),1),?):(((1@0,1@1),0),32@0)">) -> !cute.int_tuple<"(?{div=32},0)">
              %tup_104 = cute.add_offset(%tup_71, %idx_103) : (!cute.int_tuple<"(0,?{div=128},?)">, !cute.int_tuple<"(?{div=32},0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %304 = cute_nvgpu.atom.set_value(%295, %302 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
              scf.for %arg24 = %c0_i32 to %294 step %c1_i32  : i32 {
                %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%304 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) -> !cute.ptr<generic, align<64>>
                %305 = builtin.unrealized_conversion_cast %TMADescAddr : !cute.ptr<generic, align<64>> to !llvm.ptr
                %306 = cute_nvgpu.atom.get_value(%304 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                %307:3 = cute.get_scalars(%tup_104) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
                nvvm.cp.async.bulk.tensor.prefetch %305, box[%307#0, %307#1, %307#2] l2_cache_hint = %306 : !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
            }
            %299 = arith.cmpi sgt, %174, %288 : i32
            %300 = scf.if %299 -> (i1) {
              %int_tuple_99 = cute.make_int_tuple(%290) : (i32) -> !cute.int_tuple<"?">
              %ptr_100 = cute.add_offset(%ptr_4, %int_tuple_99) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %301 = builtin.unrealized_conversion_cast %ptr_100 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %302 = nvvm.mbarrier.wait.parity %301, %291 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %302 : i1
            } else {
              scf.yield %true : i1
            }
            scf.yield %300, %288, %290, %291 : i1, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          %257 = arith.addi %arg17, %188 : i32
          %258 = arith.addi %arg18, %c1_i32 : i32
          %259 = arith.cmpi sgt, %189, %257 : i32
          %260 = nvvm.mul  hi %257, %multiplier : i32 -> i32
          %261 = arith.subi %257, %260 : i32
          %262 = arith.shrui %261, %192 : i32
          %263 = arith.addi %260, %262 : i32
          %264 = arith.shrui %263, %193 : i32
          %265 = arith.muli %264, %191 : i32
          %266 = arith.subi %257, %265 : i32
          %267 = nvvm.mul  hi %266, %multiplier_52 : i32 -> i32
          %268 = arith.subi %266, %267 : i32
          %269 = arith.shrui %268, %202 : i32
          %270 = arith.addi %267, %269 : i32
          %271 = arith.shrui %270, %203 : i32
          %272 = arith.muli %271, %201 : i32
          %273 = arith.subi %266, %272 : i32
          %274 = nvvm.mul  hi %271, %multiplier_55 : i32 -> i32
          %275 = arith.subi %271, %274 : i32
          %276 = arith.shrui %275, %212 : i32
          %277 = arith.addi %274, %276 : i32
          %278 = arith.shrui %277, %213 : i32
          %279 = arith.muli %278, %211 : i32
          %280 = arith.subi %271, %279 : i32
          %int_tuple_74 = cute.make_int_tuple(%273) : (i32) -> !cute.int_tuple<"?">
          %mul_75 = cute.tuple_mul(%int_tuple_74, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %281 = cute.get_scalars(%mul_75) : !cute.int_tuple<"?">
          %int_tuple_76 = cute.make_int_tuple(%280) : (i32) -> !cute.int_tuple<"?">
          %mul_77 = cute.tuple_mul(%int_tuple_76, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %282 = cute.get_scalars(%mul_77) : !cute.int_tuple<"?">
          %int_tuple_78 = cute.make_int_tuple(%278) : (i32) -> !cute.int_tuple<"?">
          %mul_79 = cute.tuple_mul(%int_tuple_78, %137) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %283 = cute.get_scalars(%mul_79) : !cute.int_tuple<"?">
          scf.yield %281, %282, %283, %259, %256#2, %256#3, %257, %258 : i32, i32, i32, i1, i32, i32, i32, i32
        }
