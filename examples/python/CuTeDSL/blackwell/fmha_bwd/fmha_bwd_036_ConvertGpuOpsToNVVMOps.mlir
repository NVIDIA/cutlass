"gpu.module"() <{sym_name = "kernels"}> ({
  ...
  ^bb277:  // pred: ^bb276
    ...
    %1011 = "llvm.inline_asm"(%1010) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    %1013 = "llvm.inline_asm"(%1012) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
