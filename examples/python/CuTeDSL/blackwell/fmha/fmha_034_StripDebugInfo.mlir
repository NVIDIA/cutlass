"gpu.module"() <{sym_name = "kernels"}> ({
  ...
  ^bb291:  // pred: ^bb290
    ...
    %1032 = "math.exp2"(%1031) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
    ...
    %1034 = "math.exp2"(%1033) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb300:  // pred: ^bb299
    ...
    %1060 = "math.exp2"(%1059) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb318:  // pred: ^bb317
    ...
    %2110 = "math.exp2"(%2109) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
    ...
    %2112 = "math.exp2"(%2111) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb327:  // pred: ^bb326
    ...
    %2138 = "math.exp2"(%2137) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb358:  // pred: ^bb357
    ...
    %3249 = "math.exp2"(%3248) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb385:  // pred: ^bb384
    ...
    %4325 = "math.exp2"(%4324) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
    ...
    %4327 = "math.exp2"(%4326) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb394:  // pred: ^bb393
    ...
    %4353 = "math.exp2"(%4352) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb418:  // pred: ^bb417
    ...
    %5433 = "math.exp2"(%5432) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
  ...
  ^bb432:  // pred: ^bb431
    ...
    %5486 = "math.exp2"(%5485) <{fastmath = #arith.fastmath<fast>}> : (f32) -> f32
