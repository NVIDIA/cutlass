...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb291:  // pred: ^bb290
      ...
      %1515 = "llvm.inline_asm"(%1514) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb300:  // pred: ^bb299
      ...
      %1543 = "llvm.inline_asm"(%1542) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb318:  // pred: ^bb317
      ...
      %2593 = "llvm.inline_asm"(%2592) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb327:  // pred: ^bb326
      ...
      %2621 = "llvm.inline_asm"(%2620) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb367:  // pred: ^bb366
      ...
      %3758 = "llvm.inline_asm"(%3757) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb385:  // pred: ^bb384
      ...
      %4808 = "llvm.inline_asm"(%4807) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
      ...
      %4810 = "llvm.inline_asm"(%4809) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb394:  // pred: ^bb393
      ...
      %4836 = "llvm.inline_asm"(%4835) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb418:  // pred: ^bb417
      ...
      %5916 = "llvm.inline_asm"(%5915) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    ^bb432:  // pred: ^bb431
      ...
      %5969 = "llvm.inline_asm"(%5968) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
