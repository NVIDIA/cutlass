...
module attributes {gpu.container_module} {
      ...
      scf.if %684 {
        ...
        ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32):
          ...
          scf.for %arg29 = %c0_i32 to %758 step %c1_i32  : i32 {
            ...
            %771 = cute_nvgpu.atom.get_value(%757 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 1024, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,1):(1@0,1@1)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            ...
            %772:2 = cute.get_scalars(%int_tuple_134) : !cute.int_tuple<"(0,?)">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_131 : !cute.ptr<bf16, smem, align<128>>, %770 : !cute.ptr<smem, align<8>>, [%772#0, %772#1] : i32, i32) cache_policy = %771 mode = <tiled> num_cta = 1 : i32
          ...
          %763:8 = scf.for %arg29 = %c0_i32 to %316 step %c1_i32 iter_args(%arg30 = %751, %arg31 = %753, %arg32 = %c0_i32, %arg33 = %arg21, %arg34 = %arg22, %arg35 = %c0_i32, %arg36 = %arg23, %arg37 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32)  : i32 {
            ...
            scf.for %arg38 = %c0_i32 to %775 step %c1_i32  : i32 {
              ...
              %800 = cute_nvgpu.atom.get_value(%774 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 65536, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              ...
              %801:5 = cute.get_scalars(%int_tuple_148) : !cute.int_tuple<"(0,0,?,?,?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_145 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %799 : !cute.ptr<smem, align<8>>, [%801#0, %801#1, %801#2, %801#3, %801#4] : i32, i32, i32, i32, i32) cache_policy = %800 mode = <tiled> num_cta = 1 : i32
              ...
              %802:5 = cute.get_scalars(%tup_175) : !cute.int_tuple<"(64,0,?,?,?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_176 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %799 : !cute.ptr<smem, align<8>>, [%802#0, %802#1, %802#2, %802#3, %802#4] : i32, i32, i32, i32, i32) cache_policy = %800 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            scf.for %arg38 = %c0_i32 to %781 step %c1_i32  : i32 {
              ...
              %800 = cute_nvgpu.atom.get_value(%780 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 2048, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              ...
              %801:4 = cute.get_scalars(%int_tuple_161) : !cute.int_tuple<"(0,?,?,?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_158 : !cute.ptr<bf16, smem, align<256>>, %799 : !cute.ptr<smem, align<8>>, [%801#0, %801#1, %801#2, %801#3] : i32, i32, i32, i32) cache_policy = %800 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            scf.for %arg38 = %c0_i32 to %784 step %c1_i32  : i32 {
              ...
              %800 = cute_nvgpu.atom.get_value(%783 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 4096, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              ...
              %801:4 = cute.get_scalars(%int_tuple_174) : !cute.int_tuple<"(0,?,?,?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_171 : !cute.ptr<f32, smem, align<512>>, %799 : !cute.ptr<smem, align<8>>, [%801#0, %801#1, %801#2, %801#3] : i32, i32, i32, i32) cache_policy = %800 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32):
            ...
            %741:8 = scf.for %arg27 = %c0_i32 to %316 step %c1_i32 iter_args(%arg28 = %738, %arg29 = %740, %arg30 = %c0_i32, %arg31 = %arg21, %arg32 = %arg22, %arg33 = %c0_i32, %arg34 = %arg23, %arg35 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32)  : i32 {
              ...
              scf.for %arg36 = %c0_i32 to %754 step %c1_i32  : i32 {
                ...
                %776 = cute_nvgpu.atom.get_value(%753 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                ...
                %777:5 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(0,0,?,?,?)">
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_109 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %775 : !cute.ptr<smem, align<8>>, [%777#0, %777#1, %777#2, %777#3, %777#4] : i32, i32, i32, i32, i32) cache_policy = %776 mode = <tiled> num_cta = 1 : i32
                ...
                %778:5 = cute.get_scalars(%tup_127) : !cute.int_tuple<"(64,0,?,?,?)">
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_128 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %775 : !cute.ptr<smem, align<8>>, [%778#0, %778#1, %778#2, %778#3, %778#4] : i32, i32, i32, i32, i32) cache_policy = %776 mode = <tiled> num_cta = 1 : i32
              } {llvm.loop_annotation = #loop_annotation}
              ...
              scf.for %arg36 = %c0_i32 to %760 step %c1_i32  : i32 {
                ...
                %776 = cute_nvgpu.atom.get_value(%759 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
                ...
                %777:5 = cute.get_scalars(%int_tuple_126) : !cute.int_tuple<"(0,0,?,?,?)">
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_123 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %775 : !cute.ptr<smem, align<8>>, [%777#0, %777#1, %777#2, %777#3, %777#4] : i32, i32, i32, i32, i32) cache_policy = %776 mode = <tiled> num_cta = 1 : i32
            ...
            scf.if %713 {
              ...
              scf.if %729 {
                ...
                ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32, %arg29: i32, %arg30: i32, %arg31: i32, %arg32: i32):
                  ...
                  cute.memref.store_vec %cst_1, %rmem_101 : !memref_rmem_f32_1
                  ...
                  cute.memref.store_vec %cst_0, %rmem_107 : !memref_rmem_bf16_1
                  ...
                  %800:18 = scf.for %arg33 = %c0_i32 to %316 step %c1_i32 iter_args(%arg34 = %788, %arg35 = %790, %arg36 = %792, %arg37 = %c0_i32, %arg38 = %arg21, %arg39 = %arg22, %arg40 = %c0_i32, %arg41 = %arg23, %arg42 = %arg24, %arg43 = %c0_i32, %arg44 = %arg25, %arg45 = %arg26, %arg46 = %c0_i32, %arg47 = %arg27, %arg48 = %arg28, %arg49 = %c1_i32, %arg50 = %798, %arg51 = %799) -> (i1, i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                    ...
                    %818 = cute.memref.load_vec %rmem : !memref_rmem_bf16_
                    %819 = arith.extf %818 : vector<128xbf16> to vector<128xf32>
                    cute.memref.store_vec %819, %rmem_141 : !memref_rmem_f32_
                    %820 = cute.memref.load_vec %view_92 : !memref_rmem_bf16_
                    %821 = arith.extf %820 : vector<128xbf16> to vector<128xf32>
                    cute.memref.store_vec %821, %rmem_142 : !memref_rmem_f32_
                    %822 = cute.memref.load_vec %view_94 : !memref_rmem_f32_
                    cute.memref.store_vec %822, %rmem_143 : !memref_rmem_f32_
                    ...
                    %2238 = cute.memref.load_vec %rmem_100 : !memref_rmem_f32_1
                    cute.memref.store_vec %2238, %rmem_101 : !memref_rmem_f32_1
                  ...
                  scf.if %801 {
                    ...
                    scf.for %arg33 = %c0_i32 to %809 step %c1_i32  : i32 {
                      ...
                      %810 = cute_nvgpu.atom.get_value(%808 : !cute_nvgpu.atom.tma_store<bf16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,64,1,1):(1@1,1@0,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
                      %811:4 = cute.get_scalars(%int_tuple_130) : !cute.int_tuple<"(0,0,?,?)">
                      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %iter_39 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%811#0, %811#1, %811#2, %811#3] : i32, i32, i32, i32) cache_policy = %810 mode = <tiled>
                      ...
                      %812:4 = cute.get_scalars(%tup_132) : !cute.int_tuple<"(64,0,?,?)">
                      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_131 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%812#0, %812#1, %812#2, %812#3] : i32, i32, i32, i32) cache_policy = %810 mode = <tiled>
                    } {llvm.loop_annotation = #loop_annotation}
                ...
                scf.if %745 {
                  ...
                  ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32):
                    ...
                    %778:11 = scf.for %arg27 = %c0_i32 to %316 step %c1_i32 iter_args(%arg28 = %775, %arg29 = %777, %arg30 = %c0_i32, %arg31 = %arg19, %arg32 = %arg20, %arg33 = %c0_i32, %arg34 = %arg21, %arg35 = %arg22, %arg36 = %c0_i32, %arg37 = %arg23, %arg38 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                      ...
                      %791 = cute.memref.load_vec %rmem_75 : !memref_rmem_f32_2
                      cute.memref.store_vec %791, %rmem_115 : !memref_rmem_f32_2
                      %792 = cute.memref.load_vec %rmem_80 : !memref_rmem_f32_2
                      cute.memref.store_vec %792, %rmem_116 : !memref_rmem_f32_2
                      %793 = cute.memref.load_vec %rmem_86 : !memref_rmem_bf16_2
                      %794 = arith.extf %793 : vector<128xbf16> to vector<128xf32>
                      cute.memref.store_vec %794, %rmem_117 : !memref_rmem_f32_2
                      ...
                      %795 = cute.memref.load_vec %rmem_118 : !memref_rmem_f32_3
                      %796 = arith.truncf %795 : vector<128xf32> to vector<128xbf16>
                      cute.memref.store_vec %796, %rmem_93 : !memref_rmem_bf16_3
                  ...
                  ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32, %arg29: i32, %arg30: i32, %arg31: i32, %arg32: i32):
                    ...
                    %815:16 = scf.for %arg33 = %c0_i32 to %316 step %c1_i32 iter_args(%arg34 = %807, %arg35 = %809, %arg36 = %811, %arg37 = %813, %arg38 = %c0_i32, %arg39 = %arg21, %arg40 = %arg22, %arg41 = %c0_i32, %arg42 = %arg23, %arg43 = %arg24, %arg44 = %c0_i32, %arg45 = %arg25, %arg46 = %arg26, %arg47 = %c0_i32, %arg48 = %arg27, %arg49 = %arg28) -> (i1, i1, i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                      ...
                      scf.for %arg50 = %c0_i32 to %c2_i32 step %c1_i32  : i32 {
                        ...
                        %868 = cute.memref.load_vec %rmem_90 : !memref_rmem_f32_5
                        %869 = arith.truncf %868 : vector<32xf32> to vector<32xbf16>
                        cute.memref.store_vec %869, %rmem_89 : !memref_rmem_bf16_4
                        ...
                        scf.if %872 {
                          ...
                          scf.for %arg51 = %c0_i32 to %874 step %c1_i32  : i32 {
                            ...
                            %875 = cute_nvgpu.atom.get_value(%873 : !cute_nvgpu.atom.tma_store<bf16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
                            %876:5 = cute.get_scalars(%int_tuple_146) : !cute.int_tuple<"(0,?{div=32},?,?,?)">
                            cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_141 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%876#0, %876#1, %876#2, %876#3, %876#4] : i32, i32, i32, i32, i32) cache_policy = %875 mode = <tiled>
                            ...
                            %877:5 = cute.get_scalars(%tup_148) : !cute.int_tuple<"(64,?{div=32},?,?,?)">
                            cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_147 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%877#0, %877#1, %877#2, %877#3, %877#4] : i32, i32, i32, i32, i32) cache_policy = %875 mode = <tiled>
                          } {llvm.loop_annotation = #loop_annotation}
                          nvvm.cp.async.bulk.commit.group
  ...
  func.func @cutlass___call_____main__SSDKernel_object_at__Tensorgmemo64128i64div1281128i64div8192i64div8192_Tensorgmemo1281128i64div128i64div128_Tensorgmemo1281128i64div128i64div128_Tensorgmem(%arg0: !memref_gmem_bf16_, %arg1: !memref_gmem_f32_, %arg2: !memref_gmem_bf16_1, %arg3: !memref_gmem_bf16_2, %arg4: !memref_gmem_bf16_2, %arg5: !memref_gmem_bf16_3, %arg6: !memref_gmem_bf16_4, %arg7: !memref_gmem_bf16_5, %arg8: !cuda.stream) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %869 = cuda.launch_cfg.create<max_attrs = 2 : i32> (blockDim = (%c512_i32, %c1_i32, %c1_i32), dynamicSmemBytes = %c232448_i64, gridDim = (%868, %c1_i32, %c1_i32), stream = %arg8) : i32, i32, i32, i64, i32, i32, i32, !cuda.stream -> !cuda.launch_cfg<max_attrs = 2>
    cuda.launch_cfg.cluster_dim[%869] (%c1_i32, %c1_i32, %c1_i32) : !cuda.launch_cfg<max_attrs = 2>, i32, i32, i32
    %870 = cuda.launch_ex @kernels::@kernel_cutlass_kernel___main__SSDKernel_object_at__CopyAtom_ThrID10_TVLayoutSrc1409601_TVLayoutDst1409601_Valuetypebf16_tensor00000o641281110121314_CopyAtom_ThrID10_TVLayoutSrc1819201_TVL_0<%869> (%131, %view, %237, %view_7, %343, %view_13, %863, %view_43, %760, %view_37, %448, %view_19, %553, %view_25, %654, %view_31, %867, %865, %866) : !cuda.launch_cfg<max_attrs = 2>, (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, bf16, copy_bits = 65536, tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0,0)", "(64,128,?,?,?):(1@1,1@0,1@2,1@3,1@4)">, !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, bf16, copy_bits = 131072, tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0,0)", "(128,128,?,?,?):(1@0,1@1,1@2,1@3,1@4)">, !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, bf16, copy_bits = 131072, tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0,0)", "(128,128,?,?,?):(1@0,1@1,1@2,1@3,1@4)">, !cute_nvgpu.atom.non_exec_tiled_tma_store<bf16, copy_bits = 65536, tma_gbasis = <"(64,64,1,1):(1@1,1@0,1@2,1@3)">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0)", "(64,128,?,?):(1@1,1@0,1@2,1@3)">, !cute_nvgpu.atom.non_exec_tiled_tma_store<bf16, copy_bits = 32768, tma_gbasis = <"(64,32,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0,0)", "(128,64,?,?,?):(1@0,1@1,1@2,1@3,1@4)">, !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, bf16, copy_bits = 2048, tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0,0,0)", "(128,?,?,?):(1@0,1@1,1@2,1@3)">, !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 4096, tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">, internal_val_type = f32>, !cute.coord_tensor<"(0,0,0,0)", "(128,?,?,?):(1@0,1@1,1@2,1@3)">, !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, bf16, copy_bits = 1024, tma_gbasis = <"(64,1):(1@0,1@1)">, internal_val_type = bf16>, !cute.coord_tensor<"(0,0)", "(64,?):(1@0,1@1)">, i32, i32, i32) -> !cuda.result
    %871 = cuda.cast %870 : !cuda.result -> i32
    cuda.return_if_error %871 : i32
    return %c0_i32 : i32
  }
}
