gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb66(%228: i32):  // 2 preds: ^bb65, ^bb69
    ...
    llvm.cond_br %229, ^bb67, ^bb70 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb67:  // pred: ^bb66
  ...
  ^bb75(%237: i32, %238: i1, %239: i1, %240: i32, %241: i32, %242: i32, %243: i32, %244: i32, %245: i32):  // 2 preds: ^bb74, ^bb117
    ...
    llvm.cond_br %246, ^bb76, ^bb118 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb76:  // pred: ^bb75
  ...
  ^bb81(%256: i32):  // 2 preds: ^bb80, ^bb86
    ...
    llvm.cond_br %257, ^bb82, ^bb87 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb82:  // pred: ^bb81
  ...
  ^bb92(%269: i32):  // 2 preds: ^bb91, ^bb95
    ...
    llvm.cond_br %270, ^bb93, ^bb96 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb93:  // pred: ^bb92
  ...
  ^bb97(%274: i32):  // 2 preds: ^bb96, ^bb100
    ...
    llvm.cond_br %275, ^bb98, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb98:  // pred: ^bb97
  ...
  ^bb150(%352: i32, %353: i1, %354: i1, %355: i32, %356: i32, %357: i32, %358: i32, %359: i32, %360: i32):  // 2 preds: ^bb149, ^bb189
    ...
    llvm.cond_br %361, ^bb151, ^bb190 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb151:  // pred: ^bb150
  ...
  ^bb559(%5501: i32):  // 2 preds: ^bb558, ^bb560
    ...
    llvm.cond_br %5502, ^bb560, ^bb561 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb560:  // pred: ^bb559
  ...
  ^bb564(%5521: i32):  // 2 preds: ^bb563, ^bb565
    ...
    llvm.cond_br %5522, ^bb565, ^bb566 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb565:  // pred: ^bb564
  ...
  ^bb573(%5630: i32):  // 2 preds: ^bb572, ^bb574
    ...
    llvm.cond_br %5631, ^bb574, ^bb575 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb574:  // pred: ^bb573
  ...
  ^bb615(%5720: i32):  // 2 preds: ^bb614, ^bb616
    ...
    llvm.cond_br %5721, ^bb616, ^bb617 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb616:  // pred: ^bb615
  ...
  ^bb632(%5783: i32, %5784: i1, %5785: i1, %5786: i32, %5787: i32, %5788: i32, %5789: i32, %5790: i32, %5791: i32, %5792: i32, %5793: i32):  // 2 preds: ^bb631, ^bb685
    ...
    llvm.cond_br %5794, ^bb633, ^bb686 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb633:  // pred: ^bb632
  ...
  ^bb638(%5803: i32):  // 2 preds: ^bb637, ^bb639
    ...
    llvm.cond_br %5804, ^bb639, ^bb640 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb639:  // pred: ^bb638
  ...
  ^bb641(%5830: i32):  // 2 preds: ^bb640, ^bb642
    ...
    llvm.cond_br %5831, ^bb642, ^bb643 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb642:  // pred: ^bb641
  ...
  ^bb644(%5900: i32):  // 2 preds: ^bb643, ^bb645
    ...
    llvm.cond_br %5901, ^bb645, ^bb646 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb645:  // pred: ^bb644
  ...
  ^bb647(%6052: i32):  // 2 preds: ^bb646, ^bb648
    ...
    llvm.cond_br %6053, ^bb648, ^bb649 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb648:  // pred: ^bb647
  ...
  ^bb650(%6125: i32):  // 2 preds: ^bb649, ^bb651
    ...
    llvm.cond_br %6126, ^bb651, ^bb652 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb651:  // pred: ^bb650
  ...
  ^bb653(%6210: i32):  // 2 preds: ^bb652, ^bb656
    ...
    llvm.cond_br %6211, ^bb654, ^bb657 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb654:  // pred: ^bb653
  ...
  ^bb658(%6242: i32):  // 2 preds: ^bb657, ^bb659
    ...
    llvm.cond_br %6243, ^bb659, ^bb660 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb659:  // pred: ^bb658
  ...
  ^bb661(%6359: i32):  // 2 preds: ^bb660, ^bb662
    ...
    llvm.cond_br %6360, ^bb662, ^bb663 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb662:  // pred: ^bb661
  ...
  ^bb707(%6467: i32, %6468: i1, %6469: i1, %6470: i1, %6471: i1, %6472: i32, %6473: i32, %6474: i32, %6475: i32, %6476: i32, %6477: i32, %6478: i32, %6479: i32, %6480: i32, %6481: i32, %6482: i32, %6483: i32):  // 2 preds: ^bb706, ^bb781
    ...
    llvm.cond_br %6484, ^bb708, ^bb782 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb708:  // pred: ^bb707
  ...
  ^bb719(%6502: i32):  // 2 preds: ^bb718, ^bb720
    ...
    llvm.cond_br %6503, ^bb720, ^bb721 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb720:  // pred: ^bb719
  ...
  ^bb722(%6513: i32):  // 2 preds: ^bb721, ^bb723
    ...
    llvm.cond_br %6514, ^bb723, ^bb724 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb723:  // pred: ^bb722
  ...
  ^bb725(%6525: i32):  // 2 preds: ^bb724, ^bb726
    ...
    llvm.cond_br %6526, ^bb726, ^bb727 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb726:  // pred: ^bb725
  ...
  ^bb728(%6567: i32):  // 2 preds: ^bb727, ^bb729
    ...
    llvm.cond_br %6568, ^bb729, ^bb730 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb729:  // pred: ^bb728
  ...
  ^bb731(%6631: i32):  // 2 preds: ^bb730, ^bb732
    ...
    llvm.cond_br %6632, ^bb732, ^bb733 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb732:  // pred: ^bb731
  ...
  ^bb737(%6791: i32):  // 2 preds: ^bb736, ^bb738
    ...
    llvm.cond_br %6792, ^bb738, ^bb739 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb738:  // pred: ^bb737
  ...
  ^bb745(%6826: i32):  // 2 preds: ^bb744, ^bb746
    ...
    llvm.cond_br %6827, ^bb746, ^bb747 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb746:  // pred: ^bb745
