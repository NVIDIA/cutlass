      ...
      scf.if %352 {
        ...
        ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32):
          ...
          %398 = scf.if %373 -> (i1) {
            ...
            %416 = builtin.unrealized_conversion_cast %ptr_129 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %417 = nvvm.mbarrier.wait.parity %416, %arg22 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %417 : i1
          } else {
            scf.yield %true : i1
          }
          %399 = scf.if %373 -> (i1) {
            ...
            %416 = builtin.unrealized_conversion_cast %ptr_129 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %417 = nvvm.mbarrier.wait.parity %416, %arg24 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %417 : i1
          } else {
            scf.yield %true : i1
          }
          ...
          scf.if %401 {
            ...
            %416 = builtin.unrealized_conversion_cast %ptr_128 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %416, %c128_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
          }
          ...
          %404 = cute_nvgpu.atom.get_value(%402 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 1024, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,1):(1@0,1@1)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
          ...
          %405:2 = cute.get_scalars(%int_tuple_127) : !cute.int_tuple<"(0,?)">
          scf.for %arg29 = %c0_i32 to %375 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_125 : !cute.ptr<bf16, smem, align<128>>, %403 : !cute.ptr<smem, align<8>>, [%405#0, %405#1] : i32, i32) cache_policy = %404 mode = <tiled> num_cta = 1 : i32
          } {llvm.loop_annotation = #loop_annotation}
          %406 = arith.addi %arg25, %c1_i32 : i32
          %407 = arith.cmpi eq, %406, %c2_i32 : i32
          %408 = arith.select %407, %c0_i32, %406 : i32
          %409 = scf.if %407 -> (i32) {
            %416 = arith.xori %arg26, %c1_i32 : i32
            scf.yield %416 : i32
          } else {
            scf.yield %arg26 : i32
          }
          %410:8 = scf.for %arg29 = %c0_i32 to %316 step %c1_i32 iter_args(%arg30 = %398, %arg31 = %399, %arg32 = %c0_i32, %arg33 = %arg21, %arg34 = %arg22, %arg35 = %c0_i32, %arg36 = %arg23, %arg37 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32)  : i32 {
            %416 = arith.extui %arg30 : i1 to i32
            ...
            scf.if %417 {
              ...
              %449 = builtin.unrealized_conversion_cast %ptr_166 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            ...
            scf.if %418 {
              ...
              %449 = builtin.unrealized_conversion_cast %ptr_166 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %449, %c16384_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            ...
            %419 = cute_nvgpu.atom.set_value(%376, %ptr_137 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 65536, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">>
            %420 = cute_nvgpu.atom.get_value(%419 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 65536, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %421 = cute_nvgpu.atom.get_value(%419 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 65536, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr_139 = cute_nvgpu.get_tma_desc_addr(%419 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 65536, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,64,1,1,(1)):(1@1,1@0,1@2,1@3,(1@4))">>) -> !cute.ptr<generic, align<64>>
            %422:5 = cute.get_scalars(%int_tuple_138) : !cute.int_tuple<"(0,0,?,?,?)">
            ...
            %423:5 = cute.get_scalars(%tup_140) : !cute.int_tuple<"(64,0,?,?,?)">
            scf.for %arg38 = %c0_i32 to %375 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_139 : !cute.ptr<generic, align<64>>, %ptr_135 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %420 : !cute.ptr<smem, align<8>>, [%422#0, %422#1, %422#2, %422#3, %422#4] : i32, i32, i32, i32, i32) cache_policy = %421 mode = <tiled> num_cta = 1 : i32
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_139 : !cute.ptr<generic, align<64>>, %ptr_141 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %420 : !cute.ptr<smem, align<8>>, [%423#0, %423#1, %423#2, %423#3, %423#4] : i32, i32, i32, i32, i32) cache_policy = %421 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %424 = arith.extui %arg31 : i1 to i32
            ...
            scf.if %426 {
              ...
              %449 = builtin.unrealized_conversion_cast %ptr_166 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %449, %c768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            ...
            %427 = cute_nvgpu.atom.set_value(%377, %ptr_153 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 2048, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>
            %428 = cute_nvgpu.atom.get_value(%427 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 2048, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %429 = cute_nvgpu.atom.get_value(%427 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 2048, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr_155 = cute_nvgpu.get_tma_desc_addr(%427 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 2048, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) -> !cute.ptr<generic, align<64>>
            %430:4 = cute.get_scalars(%int_tuple_154) : !cute.int_tuple<"(0,?,?,?)">
            scf.for %arg38 = %c0_i32 to %375 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_155 : !cute.ptr<generic, align<64>>, %ptr_151 : !cute.ptr<bf16, smem, align<256>>, %428 : !cute.ptr<smem, align<8>>, [%430#0, %430#1, %430#2, %430#3] : i32, i32, i32, i32) cache_policy = %429 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %431 = cute_nvgpu.atom.set_value(%378, %ptr_153 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 4096, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>
            %432 = cute_nvgpu.atom.get_value(%431 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 4096, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %433 = cute_nvgpu.atom.get_value(%431 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 4096, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr_164 = cute_nvgpu.get_tma_desc_addr(%431 : !cute_nvgpu.atom.tma_load<f32, copy_bits = 4096, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(128,1,1,1):(1@0,1@1,1@2,1@3)">>) -> !cute.ptr<generic, align<64>>
            %434:4 = cute.get_scalars(%int_tuple_163) : !cute.int_tuple<"(0,?,?,?)">
            scf.for %arg38 = %c0_i32 to %375 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_164 : !cute.ptr<generic, align<64>>, %ptr_162 : !cute.ptr<f32, smem, align<512>>, %432 : !cute.ptr<smem, align<8>>, [%434#0, %434#1, %434#2, %434#3] : i32, i32, i32, i32) cache_policy = %433 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %435 = arith.addi %arg33, %c1_i32 : i32
            %436 = arith.addi %arg32, %c1_i32 : i32
            %437 = arith.cmpi eq, %435, %c2_i32 : i32
            %438 = arith.select %437, %c0_i32, %435 : i32
            %439 = scf.if %437 -> (i32) {
              %449 = arith.xori %arg34, %c1_i32 : i32
              scf.yield %449 : i32
            } else {
              scf.yield %arg34 : i32
            }
            %440 = arith.addi %arg36, %c1_i32 : i32
            %441 = arith.addi %arg35, %c1_i32 : i32
            %442 = arith.cmpi eq, %440, %c2_i32 : i32
            %443 = arith.select %442, %c0_i32, %440 : i32
            %444 = scf.if %442 -> (i32) {
              %449 = arith.xori %arg37, %c1_i32 : i32
              scf.yield %449 : i32
            } else {
              scf.yield %arg37 : i32
            }
            %445 = arith.cmpi sgt, %316, %436 : i32
            %446 = scf.if %445 -> (i1) {
              %int_tuple_165 = cute.make_int_tuple(%438) : (i32) -> !cute.int_tuple<"?">
              %ptr_166 = cute.add_offset(%ptr_41, %int_tuple_165) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %449 = builtin.unrealized_conversion_cast %ptr_166 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %450 = nvvm.mbarrier.wait.parity %449, %439 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %450 : i1
            } else {
              scf.yield %true : i1
            }
            %447 = arith.cmpi sgt, %316, %441 : i32
            %448 = scf.if %447 -> (i1) {
              %int_tuple_165 = cute.make_int_tuple(%443) : (i32) -> !cute.int_tuple<"?">
              %ptr_166 = cute.add_offset(%ptr_47, %int_tuple_165) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %449 = builtin.unrealized_conversion_cast %ptr_166 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %450 = nvvm.mbarrier.wait.parity %449, %444 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
              scf.yield %450 : i1
            } else {
              scf.yield %true : i1
            }
            scf.yield %446, %448, %436, %438, %439, %441, %443, %444 : i1, i1, i32, i32, i32, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          %411 = arith.addi %arg27, %337 : i32
          %412 = arith.addi %arg28, %c1_i32 : i32
          %413 = arith.cmpi sgt, %338, %411 : i32
          %414 = arith.remsi %411, %arg17 : i32
          %415 = arith.floordivsi %411, %arg17 : i32
          scf.yield %415, %414, %413, %410#3, %410#4, %410#6, %410#7, %408, %409, %411, %412 : i32, i32, i1, i32, i32, i32, i32, i32, i32, i32, i32
        }
          ...
          ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32):
            ...
            %385:8 = scf.for %arg27 = %c0_i32 to %316 step %c1_i32 iter_args(%arg28 = %383, %arg29 = %384, %arg30 = %c0_i32, %arg31 = %arg21, %arg32 = %arg22, %arg33 = %c0_i32, %arg34 = %arg23, %arg35 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32)  : i32 {
              ...
              scf.if %393 {
                ...
                %422 = builtin.unrealized_conversion_cast %ptr_125 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                nvvm.mbarrier.try_wait.parity.shared %422, %arg32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
              }
              ...
              %397 = cute_nvgpu.atom.get_value(%395 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              ...
              %398:5 = cute.get_scalars(%int_tuple_104) : !cute.int_tuple<"(0,0,?,?,?)">
              ...
              %399:5 = cute.get_scalars(%tup_105) : !cute.int_tuple<"(64,0,?,?,?)">
              scf.for %arg36 = %c0_i32 to %368 step %c1_i32  : i32 {
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_101 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %396 : !cute.ptr<smem, align<8>>, [%398#0, %398#1, %398#2, %398#3, %398#4] : i32, i32, i32, i32, i32) cache_policy = %397 mode = <tiled> num_cta = 1 : i32
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_106 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %396 : !cute.ptr<smem, align<8>>, [%399#0, %399#1, %399#2, %399#3, %399#4] : i32, i32, i32, i32, i32) cache_policy = %397 mode = <tiled> num_cta = 1 : i32
              } {llvm.loop_annotation = #loop_annotation}
              %400 = arith.extui %arg29 : i1 to i32
              ...
              scf.if %401 {
                ...
                %422 = builtin.unrealized_conversion_cast %ptr_125 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                nvvm.mbarrier.try_wait.parity.shared %422, %arg35, %c10000000_i32 : !llvm.ptr<3>, i32, i32
              }
              ...
              %403 = cute_nvgpu.atom.set_value(%369, %ptr_119 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>
              %404 = cute_nvgpu.atom.get_value(%403 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %405 = cute_nvgpu.atom.get_value(%403 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
              %TMADescAddr_121 = cute_nvgpu.get_tma_desc_addr(%403 : !cute_nvgpu.atom.tma_load<bf16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) -> !cute.ptr<generic, align<64>>
              %406:5 = cute.get_scalars(%int_tuple_120) : !cute.int_tuple<"(0,0,?,?,?)">
              ...
              %407:5 = cute.get_scalars(%tup_122) : !cute.int_tuple<"(64,0,?,?,?)">
              scf.for %arg36 = %c0_i32 to %368 step %c1_i32  : i32 {
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_121 : !cute.ptr<generic, align<64>>, %ptr_117 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %404 : !cute.ptr<smem, align<8>>, [%406#0, %406#1, %406#2, %406#3, %406#4] : i32, i32, i32, i32, i32) cache_policy = %405 mode = <tiled> num_cta = 1 : i32
                cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_121 : !cute.ptr<generic, align<64>>, %ptr_123 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, %404 : !cute.ptr<smem, align<8>>, [%407#0, %407#1, %407#2, %407#3, %407#4] : i32, i32, i32, i32, i32) cache_policy = %405 mode = <tiled> num_cta = 1 : i32
              } {llvm.loop_annotation = #loop_annotation}
              %408 = arith.addi %arg31, %c1_i32 : i32
              %409 = arith.addi %arg30, %c1_i32 : i32
              %410 = arith.cmpi eq, %408, %c2_i32 : i32
              %411 = arith.select %410, %c0_i32, %408 : i32
              %412 = scf.if %410 -> (i32) {
                %422 = arith.xori %arg32, %c1_i32 : i32
                scf.yield %422 : i32
              } else {
                scf.yield %arg32 : i32
              }
              %413 = arith.addi %arg34, %c1_i32 : i32
              %414 = arith.addi %arg33, %c1_i32 : i32
              %415 = arith.cmpi eq, %413, %c2_i32 : i32
              %416 = arith.select %415, %c0_i32, %413 : i32
              %417 = scf.if %415 -> (i32) {
                %422 = arith.xori %arg35, %c1_i32 : i32
                scf.yield %422 : i32
              } else {
                scf.yield %arg35 : i32
              }
              %418 = arith.cmpi sgt, %316, %409 : i32
              %419 = scf.if %418 -> (i1) {
                %int_tuple_124 = cute.make_int_tuple(%411) : (i32) -> !cute.int_tuple<"?">
                %ptr_125 = cute.add_offset(%ptr_43, %int_tuple_124) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %422 = builtin.unrealized_conversion_cast %ptr_125 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                %423 = nvvm.mbarrier.wait.parity %422, %412 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
                scf.yield %423 : i1
              } else {
                scf.yield %true : i1
              }
              %420 = arith.cmpi sgt, %316, %414 : i32
              %421 = scf.if %420 -> (i1) {
                %int_tuple_124 = cute.make_int_tuple(%416) : (i32) -> !cute.int_tuple<"?">
                %ptr_125 = cute.add_offset(%ptr_45, %int_tuple_124) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %422 = builtin.unrealized_conversion_cast %ptr_125 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                %423 = nvvm.mbarrier.wait.parity %422, %417 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
                scf.yield %423 : i1
              } else {
                scf.yield %true : i1
              }
              scf.yield %419, %421, %409, %411, %412, %414, %416, %417 : i1, i1, i32, i32, i32, i32, i32, i32
            } {loop_annotation = #loop_annotation1}
              ...
              scf.if %370 {
                ...
                ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32, %arg29: i32, %arg30: i32, %arg31: i32, %arg32: i32):
                  ...
                  %424:18 = scf.for %arg33 = %c0_i32 to %316 step %c1_i32 iter_args(%arg34 = %415, %arg35 = %416, %arg36 = %417, %arg37 = %c0_i32, %arg38 = %arg21, %arg39 = %arg22, %arg40 = %c0_i32, %arg41 = %arg23, %arg42 = %arg24, %arg43 = %c0_i32, %arg44 = %arg25, %arg45 = %arg26, %arg46 = %c0_i32, %arg47 = %arg27, %arg48 = %arg28, %arg49 = %c1_i32, %arg50 = %422, %arg51 = %423) -> (i1, i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                    ...
                    %439 = cute.memref.load_vec %rmem : !memref_rmem_bf16_
                    %440 = arith.extf %439 : vector<128xbf16> to vector<128xf32>
                    cute.memref.store_vec %440, %rmem_118 : !memref_rmem_f32_
                    %441 = cute.memref.load_vec %view_78 : !memref_rmem_bf16_
                    %442 = arith.extf %441 : vector<128xbf16> to vector<128xf32>
                    cute.memref.store_vec %442, %rmem_119 : !memref_rmem_f32_
                    %443 = cute.memref.load_vec %view_79 : !memref_rmem_f32_
                    cute.memref.store_vec %443, %rmem_120 : !memref_rmem_f32_
                    ...
                    %1858 = cute.memref.load_vec %rmem_84 : !memref_rmem_f32_1
                    cute.memref.store_vec %1858, %rmem_85 : !memref_rmem_f32_1
                    scf.for %arg52 = %c0_i32 to %409 step %c1_i32  : i32 {
                      %coord_132 = cute.make_coord(%arg52) : (i32) -> !cute.coord<"(_,?)">
                  ...
                  scf.if %411 {
                    ...
                    %432 = cute_nvgpu.atom.get_value(%430 : !cute_nvgpu.atom.tma_store<bf16, copy_bits = 65536, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,64,1,1):(1@1,1@0,1@2,1@3)">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
                    %433:4 = cute.get_scalars(%int_tuple_110) : !cute.int_tuple<"(0,0,?,?)">
                    ...
                    %434:4 = cute.get_scalars(%tup_112) : !cute.int_tuple<"(64,0,?,?)">
                    scf.for %arg33 = %c0_i32 to %431 step %c1_i32  : i32 {
                      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %iter_35 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%433#0, %433#1, %433#2, %433#3] : i32, i32, i32, i32) cache_policy = %432 mode = <tiled>
                      cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_111 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%434#0, %434#1, %434#2, %434#3] : i32, i32, i32, i32) cache_policy = %432 mode = <tiled>
                    } {llvm.loop_annotation = #loop_annotation}
                ...
                scf.if %386 {
                  ...
                  ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32):
                    ...
                    %404:11 = scf.for %arg27 = %c0_i32 to %316 step %c1_i32 iter_args(%arg28 = %402, %arg29 = %403, %arg30 = %c0_i32, %arg31 = %arg19, %arg32 = %arg20, %arg33 = %c0_i32, %arg34 = %arg21, %arg35 = %arg22, %arg36 = %c0_i32, %arg37 = %arg23, %arg38 = %arg24) -> (i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                      ...
                      %444 = cute.memref.load_vec %rmem_70 : !memref_rmem_f32_2
                      cute.memref.store_vec %444, %rmem_127 : !memref_rmem_f32_2
                      %445 = cute.memref.load_vec %rmem_74 : !memref_rmem_f32_2
                      cute.memref.store_vec %445, %rmem_128 : !memref_rmem_f32_2
                      %446 = cute.memref.load_vec %rmem_77 : !memref_rmem_bf16_2
                      %447 = arith.extf %446 : vector<128xbf16> to vector<128xf32>
                      cute.memref.store_vec %447, %rmem_129 : !memref_rmem_f32_2
                      ...
                      %448 = cute.memref.load_vec %rmem_130 : !memref_rmem_f32_3
                      %449 = arith.truncf %448 : vector<128xf32> to vector<128xbf16>
                      cute.memref.store_vec %449, %rmem_82 : !memref_rmem_bf16_3
                  ...
                  ^bb0(%arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32, %arg29: i32, %arg30: i32, %arg31: i32, %arg32: i32):
                    ...
                    %434:16 = scf.for %arg33 = %c0_i32 to %316 step %c1_i32 iter_args(%arg34 = %429, %arg35 = %430, %arg36 = %431, %arg37 = %432, %arg38 = %c0_i32, %arg39 = %arg21, %arg40 = %arg22, %arg41 = %c0_i32, %arg42 = %arg23, %arg43 = %arg24, %arg44 = %c0_i32, %arg45 = %arg25, %arg46 = %arg26, %arg47 = %c0_i32, %arg48 = %arg27, %arg49 = %arg28) -> (i1, i1, i1, i1, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)  : i32 {
                      ...
                      scf.for %arg50 = %c0_i32 to %c2_i32 step %c1_i32  : i32 {
                        ...
                        %485 = cute.memref.load_vec %rmem_81 : !memref_rmem_f32_5
                        %486 = arith.truncf %485 : vector<32xf32> to vector<32xbf16>
                        cute.memref.store_vec %486, %rmem_80 : !memref_rmem_bf16_4
                        ...
                        scf.if %427 {
                          ...
                          %490 = cute_nvgpu.atom.get_value(%488 : !cute_nvgpu.atom.tma_store<bf16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1,1,(1)):(1@0,1@1,1@2,1@3,(1@4))">>) {field = #cute_nvgpu.atom_copy_field_tmastore<cache_policy>} : i64
                          %491:5 = cute.get_scalars(%int_tuple_138) : !cute.int_tuple<"(0,?{div=32},?,?,?)">
                          ...
                          %492:5 = cute.get_scalars(%tup_140) : !cute.int_tuple<"(64,?{div=32},?,?,?)">
                          scf.for %arg51 = %c0_i32 to %489 step %c1_i32  : i32 {
                            cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_133 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%491#0, %491#1, %491#2, %491#3, %491#4] : i32, i32, i32, i32, i32) cache_policy = %490 mode = <tiled>
                            cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_139 : !cute.ptr<bf16, smem, align<1024>, S<3,4,3>>, [%492#0, %492#1, %492#2, %492#3, %492#4] : i32, i32, i32, i32, i32) cache_policy = %490 mode = <tiled>
                          } {llvm.loop_annotation = #loop_annotation}
                          nvvm.cp.async.bulk.commit.group
