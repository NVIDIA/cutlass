    ...
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo11024100div10241_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %29 {
        ...
        scf.for %arg6 = %c0_i32 to %32 step %c1_i32  : i32 {
          %38 = cute.get_scalars(%lay_27) <{only_dynamic}> : !cute.layout<"(8,((1))):(?{i64},((0)))">
          %stride_28 = cute.make_stride(%38) : (i64) -> !cute.stride<"(?{i64})">
          %lay_29 = cute.make_layout(%12, %stride_28) : !cute.layout<"(8):(?{i64})">
          %39 = cute.get_scalars(%lay_29) <{only_dynamic}> : !cute.layout<"(8):(?{i64})">
          %40 = builtin.unrealized_conversion_cast %ptr_13 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %41 = builtin.unrealized_conversion_cast %iter_20 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
          %42 = llvm.load %40 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %42, %41 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %int_tuple = cute.make_int_tuple(%39) : (i64) -> !cute.int_tuple<"?{i64}">
          ...
          %46 = arith.muli %39, %c2_i64 : i64
          %iv_32 = cute.assume(%46) : (i64) -> !cute.i64<divby 2>
          ...
          %47 = builtin.unrealized_conversion_cast %ptr_34 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %48 = builtin.unrealized_conversion_cast %ptr_35 : !cute.ptr<f32, rmem, align<8>> to !llvm.ptr
          %49 = llvm.load %47 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %49, %48 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %50 = arith.muli %39, %c3_i64 : i64
          %iv_36 = cute.assume(%50) : (i64) -> !cute.i64<divby 3>
          ...
          %51 = builtin.unrealized_conversion_cast %ptr_38 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %52 = builtin.unrealized_conversion_cast %ptr_39 : !cute.ptr<f32, rmem> to !llvm.ptr
          %53 = llvm.load %51 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %53, %52 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %54 = arith.muli %39, %c4_i64 : i64
          %iv_40 = cute.assume(%54) : (i64) -> !cute.i64<divby 4>
          ...
          %55 = builtin.unrealized_conversion_cast %ptr_42 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %56 = builtin.unrealized_conversion_cast %ptr_43 : !cute.ptr<f32, rmem, align<16>> to !llvm.ptr
          %57 = llvm.load %55 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %57, %56 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %58 = arith.muli %39, %c5_i64 : i64
          %iv_44 = cute.assume(%58) : (i64) -> !cute.i64<divby 5>
          ...
          %59 = builtin.unrealized_conversion_cast %ptr_46 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %60 = builtin.unrealized_conversion_cast %ptr_47 : !cute.ptr<f32, rmem> to !llvm.ptr
          %61 = llvm.load %59 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %61, %60 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %62 = arith.muli %39, %c6_i64 : i64
          %iv_48 = cute.assume(%62) : (i64) -> !cute.i64<divby 6>
          ...
          %63 = builtin.unrealized_conversion_cast %ptr_50 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %64 = builtin.unrealized_conversion_cast %ptr_51 : !cute.ptr<f32, rmem, align<8>> to !llvm.ptr
          %65 = llvm.load %63 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %65, %64 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %66 = arith.muli %39, %c7_i64 : i64
          %iv_52 = cute.assume(%66) : (i64) -> !cute.i64<divby 7>
          ...
          %67 = builtin.unrealized_conversion_cast %ptr_54 : !cute.ptr<f32, gmem> to !llvm.ptr<1>
          %68 = builtin.unrealized_conversion_cast %ptr_55 : !cute.ptr<f32, rmem> to !llvm.ptr
          %69 = llvm.load %67 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %69, %68 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
        ...
        cute.memref.store_vec %37, %rmem_21, row_major : !memref_rmem_i8_
        scf.for %arg6 = %c0_i32 to %32 step %c1_i32  : i32 {
          %38 = builtin.unrealized_conversion_cast %iter_22 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
          %39 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
          %40 = llvm.load %38 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %40, %39 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_28 = cute.add_offset(%iter_22, %6) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<i8, rmem>
          %ptr_29 = cute.add_offset(%ptr_15, %6) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<i8, gmem>
          %41 = builtin.unrealized_conversion_cast %ptr_28 : !cute.ptr<i8, rmem> to !llvm.ptr
          %42 = builtin.unrealized_conversion_cast %ptr_29 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
          %43 = llvm.load %41 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %43, %42 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_30 = cute.add_offset(%iter_22, %5) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<i8, rmem, align<2>>
          %ptr_31 = cute.add_offset(%ptr_15, %5) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<i8, gmem>
          %44 = builtin.unrealized_conversion_cast %ptr_30 : !cute.ptr<i8, rmem, align<2>> to !llvm.ptr
          %45 = builtin.unrealized_conversion_cast %ptr_31 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
          %46 = llvm.load %44 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %46, %45 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_32 = cute.add_offset(%iter_22, %4) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<i8, rmem>
          %ptr_33 = cute.add_offset(%ptr_15, %4) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<i8, gmem>
          %47 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<i8, rmem> to !llvm.ptr
          %48 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
          %49 = llvm.load %47 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %49, %48 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
