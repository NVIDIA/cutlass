...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_i8_, %arg4: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg5: i32, %arg6: i32, %arg7: i32):
      ...
      %113 = "cute.static"() : () -> !cute.layout<"(128,8):(8@1,1@1)">
      ...
      %119 = "cute.get_layout"(%arg2) : (!memref_gmem_f32_) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
      %120 = "cute.crd2idx"(%118, %119) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      ...
      %123 = "cute.get_layout"(%arg3) : (!memref_gmem_i8_) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      %124 = "cute.crd2idx"(%118, %123) : (!cute.coord<"(_,?)">, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?{i64}">
      %125 = "cute.get_iter"(%arg3) : (!memref_gmem_i8_) -> !cute.ptr<i8, gmem, align<16>>
      %126 = "cute.add_offset"(%125, %124) : (!cute.ptr<i8, gmem, align<16>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      %127 = "cute.get_layout"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %128 = "cute.crd2idx"(%118, %127) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      %129 = "cute.get_iter"(%arg4) : (!cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.arith_tuple_iter<"(0,0,0)">
      ...
      %136 = "cute.crd2idx"(%131, %113) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@1,1@1)">) -> !cute.int_tuple<"(0,?{div=8})">
      %137 = "cute.add_offset"(%130, %136) : (!cute.arith_tuple_iter<"(?,?{div=1024},?)">, !cute.int_tuple<"(0,?{div=8})">) -> !cute.arith_tuple_iter<"(?,?{div=8},?)">
      %138 = "cute.deref_arith_tuple_iter"(%137) : (!cute.arith_tuple_iter<"(?,?{div=8},?)">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %139:3 = "cute.get_leaves"(%138) : (!cute.int_tuple<"(?,?{div=8},?)">) -> (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">)
      %140 = "cute.make_coord"(%139#0, %139#1, %139#2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
    ...
    ^bb1:  // pred: ^bb0
      ...
      %192 = "nvgpu.cvt_fptrunc"(%191) <{packed_kind = #nvgpu.subbytes_packedkind<compact>, rnd = #nvgpu.rnd<rn>}> : (vector<8xf32>) -> vector<8xf4E2M1FN>
      %193 = "cute.recast_layout"(%112) <{new_type_bits = 8 : i32, old_type_bits = 4 : i32}> : (!cute.layout<"8:1">) -> !cute.layout<"4:1">
      %194 = "builtin.unrealized_conversion_cast"(%192) : (vector<8xf4E2M1FN>) -> vector<8xi4>
      %195 = "vector.bitcast"(%194) : (vector<8xi4>) -> vector<4xi8>
      "cute.memref.store_vec"(%195, %151) : (vector<4xi8>, !memref_rmem_i8_) -> ()
      %196 = "builtin.unrealized_conversion_cast"(%152) : (!cute.ptr<i8, rmem, align<32>>) -> !llvm.ptr
      %197 = "builtin.unrealized_conversion_cast"(%135) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %198 = "llvm.load"(%196) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%198, %197) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %199 = "cute.add_offset"(%152, %111) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<i8, rmem>
      %200 = "cute.add_offset"(%135, %111) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<i8, gmem>
      %201 = "builtin.unrealized_conversion_cast"(%199) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
      %202 = "builtin.unrealized_conversion_cast"(%200) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %203 = "llvm.load"(%201) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%203, %202) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %204 = "cute.add_offset"(%152, %110) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<i8, rmem, align<2>>
      %205 = "cute.add_offset"(%135, %110) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<i8, gmem>
      %206 = "builtin.unrealized_conversion_cast"(%204) : (!cute.ptr<i8, rmem, align<2>>) -> !llvm.ptr
      %207 = "builtin.unrealized_conversion_cast"(%205) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %208 = "llvm.load"(%206) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%208, %207) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %209 = "cute.add_offset"(%152, %109) : (!cute.ptr<i8, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<i8, rmem>
      %210 = "cute.add_offset"(%135, %109) : (!cute.ptr<i8, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<i8, gmem>
      %211 = "builtin.unrealized_conversion_cast"(%209) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
      %212 = "builtin.unrealized_conversion_cast"(%210) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %213 = "llvm.load"(%211) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%213, %212) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      "cf.br"()[^bb2] : () -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "cuda.return"() : () -> ()
    }) {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = (!memref_gmem_f32_1, !memref_gmem_f4E2M1FN) -> i32, sym_name = "cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_8"}> ({
  ^bb0(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f4E2M1FN):
    %0 = "arith.constant"() <{value = 1 : i32}> : () -> i32
    %1 = "arith.constant"() <{value = 128 : i32}> : () -> i32
    %2 = "arith.constant"() <{value = 0 : i64}> : () -> i64
    %3 = "arith.constant"() <{value = 0 : i32}> : () -> i32
    %4 = "arith.constant"() <{value = 512 : i32}> : () -> i32
    %5 = "cute.static"() : () -> !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
    %6 = "arith.constant"() <{value = 1024 : i32}> : () -> i32
    %7 = "cute.static"() : () -> !cute.stride<"(1@0,1@1,1@2)">
    %8 = "cute.static"() : () -> !cute.layout<"(128,8):(8,1)">
    %9 = "cute.get_iter"(%arg1) : (!memref_gmem_f4E2M1FN) -> !cute.ptr<f4E2M1FN, gmem, align<16>>
    %10 = "cute.recast_layout"(%8) <{new_type_bits = 8 : i32, old_type_bits = 4 : i32}> : (!cute.layout<"(128,8):(8,1)">) -> !cute.layout<"(128,4):(4,1)">
    %11 = "cute.recast_iter"(%9) : (!cute.ptr<f4E2M1FN, gmem, align<16>>) -> !cute.ptr<i8, gmem, align<16>>
    %12 = "cute.get_layout"(%arg1) : (!memref_gmem_f4E2M1FN) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %13 = "cute.recast_layout"(%12) <{new_type_bits = 8 : i32, old_type_bits = 4 : i32}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %14 = "cute.get_layout"(%arg0) : (!memref_gmem_f32_1) -> !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %15 = "cute.get_shape"(%14) : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %27:5 = "cute.get_scalars"(%14) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    ...
    %33 = "arith.addi"(%32, %27#1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %34 = "arith.divsi"(%33, %6) : (i32, i32) -> i32
    %35 = "arith.addi"(%28, %34) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %36 = "arith.subi"(%29, %27#1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %37 = "arith.divsi"(%36, %6) : (i32, i32) -> i32
    %38 = "arith.subi"(%29, %37) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %39 = "arith.cmpi"(%27#1, %29) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %40 = "arith.cmpi"(%27#1, %29) <{predicate = 4 : i64}> : (i32, i32) -> i1
    ...
    %47 = "cute.make_shape"(%27#0, %46, %27#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %48 = "cute.make_stride"(%27#3, %27#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %49 = "cute.make_layout"(%47, %48) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    %50 = "cute.make_view"(%26, %49) : (!cute.ptr<f32, gmem>, !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !memref_gmem_f32_
    ...
    %57 = "arith.addi"(%56, %51#1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %58 = "arith.divsi"(%57, %6) : (i32, i32) -> i32
    %59 = "arith.addi"(%52, %58) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %60 = "arith.subi"(%53, %51#1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %61 = "arith.divsi"(%60, %6) : (i32, i32) -> i32
    %62 = "arith.subi"(%53, %61) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
    %63 = "arith.cmpi"(%51#1, %53) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %64 = "arith.cmpi"(%51#1, %53) <{predicate = 4 : i64}> : (i32, i32) -> i1
    ...
    %71 = "cute.make_shape"(%51#0, %70, %51#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %72 = "cute.make_layout"(%71, %5) <{operandSegmentSizes = array<i32: 1, 1>}> : (!cute.shape<"((1,1024,1),(?,?,?))">, !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %73 = "cute.make_view"(%24, %72) : (!cute.arith_tuple_iter<"(0,0,0)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %74:5 = "cute.get_scalars"(%13) <{only_dynamic}> : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> (i32, i32, i32, i64, i64)
    ...
    %94 = "cute.make_shape"(%74#0, %93, %74#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %95 = "cute.make_stride"(%74#3, %74#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %97 = "cute.make_view"(%11, %96) : (!cute.ptr<i8, gmem, align<16>>, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !memref_gmem_i8_
    %98 = "cute.size"(%49) <{mode = array<i32: 1>}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %103 = "cuda.launch_ex"(%102, %50, %97, %73, %18, %20, %22) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo110241010i641024i64_tensorptri8gmemalign16o15121010i64512i64_tensor000o1102410110101024112____Float32_Float4E2M1FN_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
