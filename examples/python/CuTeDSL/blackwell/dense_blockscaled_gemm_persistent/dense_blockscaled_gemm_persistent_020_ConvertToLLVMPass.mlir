"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg5: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg6: !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %arg7: i32, %arg8: i32, %arg9: i32):
      ...
      %396 = "llvm.add"(%394, %392) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %397 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32)>
      %398 = "llvm.insertvalue"(%397, %393) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %399 = "llvm.insertvalue"(%398, %396) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
    ...
    ^bb1:  // pred: ^bb0
      ...
      %506 = "llvm.bitcast"(%505) : (vector<8xf32>) -> vector<8xi32>
      %507 = "llvm.mlir.undef"() : () -> vector<1xi32>
      %508 = "llvm.mlir.constant"() <{value = 8 : i32}> : () -> i32
      %509 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %510 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %511 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %512 = "llvm.mlir.constant"() <{value = 6 : i64}> : () -> i64
      %513 = "llvm.extractelement"(%506, %512) : (vector<8xi32>, i64) -> i32
      %514 = "llvm.mlir.constant"() <{value = 7 : i64}> : () -> i64
      %515 = "llvm.extractelement"(%506, %514) : (vector<8xi32>, i64) -> i32
      %516 = "llvm.bitcast"(%513) : (i32) -> f32
      %517 = "llvm.bitcast"(%515) : (i32) -> f32
      %518 = "nvvm.cvt.packfloat.f32"(%517, %516, %509) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e2m1x2>}> : (f32, f32, i32) -> i32
      %519 = "llvm.shl"(%511, %508) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %520 = "llvm.or"(%519, %518) : (i32, i32) -> i32
      %521 = "llvm.mlir.constant"() <{value = 4 : i64}> : () -> i64
      %522 = "llvm.extractelement"(%506, %521) : (vector<8xi32>, i64) -> i32
      %523 = "llvm.mlir.constant"() <{value = 5 : i64}> : () -> i64
      %524 = "llvm.extractelement"(%506, %523) : (vector<8xi32>, i64) -> i32
      %525 = "llvm.bitcast"(%522) : (i32) -> f32
      %526 = "llvm.bitcast"(%524) : (i32) -> f32
      %527 = "nvvm.cvt.packfloat.f32"(%526, %525, %509) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e2m1x2>}> : (f32, f32, i32) -> i32
      %528 = "llvm.shl"(%520, %508) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %529 = "llvm.or"(%528, %527) : (i32, i32) -> i32
      %530 = "llvm.mlir.constant"() <{value = 2 : i64}> : () -> i64
      %531 = "llvm.extractelement"(%506, %530) : (vector<8xi32>, i64) -> i32
      %532 = "llvm.mlir.constant"() <{value = 3 : i64}> : () -> i64
      %533 = "llvm.extractelement"(%506, %532) : (vector<8xi32>, i64) -> i32
      %534 = "llvm.bitcast"(%531) : (i32) -> f32
      %535 = "llvm.bitcast"(%533) : (i32) -> f32
      %536 = "nvvm.cvt.packfloat.f32"(%535, %534, %509) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e2m1x2>}> : (f32, f32, i32) -> i32
      %537 = "llvm.shl"(%529, %508) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %538 = "llvm.or"(%537, %536) : (i32, i32) -> i32
      %539 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %540 = "llvm.extractelement"(%506, %539) : (vector<8xi32>, i64) -> i32
      %541 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
      %542 = "llvm.extractelement"(%506, %541) : (vector<8xi32>, i64) -> i32
      %543 = "llvm.bitcast"(%540) : (i32) -> f32
      %544 = "llvm.bitcast"(%542) : (i32) -> f32
      %545 = "nvvm.cvt.packfloat.f32"(%544, %543, %509) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e2m1x2>}> : (f32, f32, i32) -> i32
      %546 = "llvm.shl"(%538, %508) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %547 = "llvm.or"(%546, %545) : (i32, i32) -> i32
      %548 = "llvm.insertelement"(%507, %547, %510) : (vector<1xi32>, i32, i64) -> vector<1xi32>
      %549 = "llvm.bitcast"(%548) : (vector<1xi32>) -> vector<8xi4>
      %550 = "builtin.unrealized_conversion_cast"(%549) : (vector<8xi4>) -> vector<8xf4E2M1FN>
      %551 = "llvm.mlir.undef"() : () -> !llvm.struct<(struct<()>, struct<()>)>
      %552 = "builtin.unrealized_conversion_cast"(%550) : (vector<8xf4E2M1FN>) -> vector<8xi4>
      %553 = "vector.bitcast"(%552) : (vector<8xi4>) -> vector<4xi8>
      %554 = "vector.shape_cast"(%553) : (vector<4xi8>) -> vector<1x4xi8>
      %555 = "llvm.extractvalue"(%430) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %556 = "vector.extract"(%554) <{static_position = array<i64: 0>}> : (vector<1x4xi8>) -> vector<4xi8>
      %557 = "llvm.getelementptr"(%555) <{elem_type = i8, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%556, %557) <{alignment = 32 : i64, ordering = 0 : i64}> : (vector<4xi8>, !llvm.ptr) -> ()
      %558 = "builtin.unrealized_conversion_cast"(%432) : (!cute.ptr<i8, rmem, align<32>>) -> !llvm.ptr
      %559 = "builtin.unrealized_conversion_cast"(%388) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %560 = "llvm.load"(%558) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%560, %559) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %561 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %562 = "llvm.getelementptr"(%431, %561) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %563 = "builtin.unrealized_conversion_cast"(%562) : (!llvm.ptr) -> !cute.ptr<i8, rmem>
      %564 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %565 = "llvm.getelementptr"(%387, %564) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %566 = "builtin.unrealized_conversion_cast"(%565) : (!llvm.ptr<1>) -> !cute.ptr<i8, gmem>
      %567 = "builtin.unrealized_conversion_cast"(%563) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
      %568 = "builtin.unrealized_conversion_cast"(%566) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %569 = "llvm.load"(%567) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%569, %568) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %570 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %571 = "llvm.getelementptr"(%431, %570) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %572 = "builtin.unrealized_conversion_cast"(%571) : (!llvm.ptr) -> !cute.ptr<i8, rmem, align<2>>
      %573 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %574 = "llvm.getelementptr"(%387, %573) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %575 = "builtin.unrealized_conversion_cast"(%574) : (!llvm.ptr<1>) -> !cute.ptr<i8, gmem>
      %576 = "builtin.unrealized_conversion_cast"(%572) : (!cute.ptr<i8, rmem, align<2>>) -> !llvm.ptr
      %577 = "builtin.unrealized_conversion_cast"(%575) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %578 = "llvm.load"(%576) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%578, %577) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %579 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %580 = "llvm.getelementptr"(%431, %579) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %581 = "builtin.unrealized_conversion_cast"(%580) : (!llvm.ptr) -> !cute.ptr<i8, rmem>
      %582 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %583 = "llvm.getelementptr"(%387, %582) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %584 = "builtin.unrealized_conversion_cast"(%583) : (!llvm.ptr<1>) -> !cute.ptr<i8, gmem>
      %585 = "builtin.unrealized_conversion_cast"(%581) : (!cute.ptr<i8, rmem>) -> !llvm.ptr
      %586 = "builtin.unrealized_conversion_cast"(%584) : (!cute.ptr<i8, gmem>) -> !llvm.ptr<1>
      %587 = "llvm.load"(%585) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%587, %586) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      "llvm.br"()[^bb2] : () -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "llvm.return"() : () -> ()
