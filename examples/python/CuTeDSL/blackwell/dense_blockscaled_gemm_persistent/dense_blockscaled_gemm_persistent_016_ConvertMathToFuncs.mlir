...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb2(%57: i32):  // 2 preds: ^bb1, ^bb3
      %58 = arith.cmpi slt, %57, %32 : i32
      cf.cond_br %58, ^bb3, ^bb4 {llvm.loop_annotation = #loop_annotation}
    ^bb3:  // pred: ^bb2
      %59 = llvm.load %35 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %59, %36 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %60 = llvm.load %37 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %60, %38 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %61 = llvm.load %40 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %61, %41 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %62 = llvm.load %43 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %62, %44 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %63 = llvm.load %46 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %63, %47 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %64 = llvm.load %49 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %64, %50 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %65 = llvm.load %52 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %65, %53 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %66 = llvm.load %55 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
      llvm.store %66, %56 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
      %67 = arith.addi %57, %c1_i32 : i32
      cf.br ^bb2(%67 : i32)
    ^bb4:  // pred: ^bb2
      %68 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
      %69 = nvgpu.cvt_fptrunc %68 : vector<8xf32> to vector<8xf4E2M1FN>
      %70 = cute.recast_layout<8, 4> (%10) : !cute.layout<"8:1"> to !cute.layout<"4:1">
      %71 = builtin.unrealized_conversion_cast %69 : vector<8xf4E2M1FN> to vector<8xi4>
      %72 = vector.bitcast %71 : vector<8xi4> to vector<4xi8>
      cute.memref.store_vec %72, %rmem_21, row_major : !memref_rmem_i8_
      %73 = builtin.unrealized_conversion_cast %iter_22 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
      %74 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %75 = builtin.unrealized_conversion_cast %ptr_56 : !cute.ptr<i8, rmem> to !llvm.ptr
      %76 = builtin.unrealized_conversion_cast %ptr_57 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %78 = builtin.unrealized_conversion_cast %ptr_59 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %79 = builtin.unrealized_conversion_cast %ptr_60 : !cute.ptr<i8, rmem> to !llvm.ptr
      %80 = builtin.unrealized_conversion_cast %ptr_61 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      cf.br ^bb5(%c0_i32 : i32)
    ^bb5(%81: i32):  // 2 preds: ^bb4, ^bb6
      %82 = arith.cmpi slt, %81, %32 : i32
      cf.cond_br %82, ^bb6, ^bb7 {llvm.loop_annotation = #loop_annotation}
    ^bb6:  // pred: ^bb5
      %83 = llvm.load %73 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %83, %74 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %84 = llvm.load %75 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %84, %76 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %85 = llvm.load %77 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %85, %78 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %86 = llvm.load %79 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %86, %80 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %87 = arith.addi %81, %c1_i32 : i32
      cf.br ^bb5(%87 : i32)
    ^bb7:  // pred: ^bb5
      cf.br ^bb8
    ^bb8:  // 2 preds: ^bb0, ^bb7
  ...
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemoi641i64_1_8(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f4E2M1FN) attributes {llvm.emit_c_interface} {
    ...
    %11 = arith.cmpi sgt, %c1024_i32, %c0_i32_6 : i32
    %12 = arith.select %11, %c-1_i32, %c1_i32 : i32
    %13 = arith.addi %12, %10#1 : i32
    %14 = arith.divsi %13, %c1024_i32 : i32
    %15 = arith.addi %c1_i32, %14 : i32
    %16 = arith.subi %c0_i32_6, %10#1 : i32
    %17 = arith.divsi %16, %c1024_i32 : i32
    %18 = arith.subi %c0_i32_6, %17 : i32
    %19 = arith.cmpi slt, %10#1, %c0_i32_6 : i32
    %20 = arith.cmpi sgt, %10#1, %c0_i32_6 : i32
    %21 = arith.cmpi slt, %c1024_i32, %c0_i32_6 : i32
    %22 = arith.cmpi sgt, %c1024_i32, %c0_i32_6 : i32
    %23 = arith.andi %19, %21 : i1
    %24 = arith.andi %20, %22 : i1
    %25 = arith.ori %23, %24 : i1
    %26 = arith.select %25, %15, %18 : i32
    %27 = arith.muli %10#4, %c1024_i64 : i64
    %shape_7 = cute.make_shape(%10#0, %26, %10#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %iv = cute.assume(%27) : (i64) -> !cute.i64<divby 1024>
    ...
    %28:3 = cute.get_scalars(%lay_4) <{only_dynamic}> : !cute.layout<"(?,?,?):(1@0,1@1,1@2)">
    %c1_i32_9 = arith.constant 1 : i32
    %c0_i32_10 = arith.constant 0 : i32
    %c-1_i32_11 = arith.constant -1 : i32
    %29 = arith.cmpi sgt, %c1024_i32, %c0_i32_10 : i32
    %30 = arith.select %29, %c-1_i32_11, %c1_i32_9 : i32
    %31 = arith.addi %30, %28#1 : i32
    %32 = arith.divsi %31, %c1024_i32 : i32
    %33 = arith.addi %c1_i32_9, %32 : i32
    %34 = arith.subi %c0_i32_10, %28#1 : i32
    %35 = arith.divsi %34, %c1024_i32 : i32
    %36 = arith.subi %c0_i32_10, %35 : i32
    %37 = arith.cmpi slt, %28#1, %c0_i32_10 : i32
    %38 = arith.cmpi sgt, %28#1, %c0_i32_10 : i32
    %39 = arith.cmpi slt, %c1024_i32, %c0_i32_10 : i32
    %40 = arith.cmpi sgt, %c1024_i32, %c0_i32_10 : i32
    %41 = arith.andi %37, %39 : i1
    %42 = arith.andi %38, %40 : i1
    %43 = arith.ori %41, %42 : i1
    %44 = arith.select %43, %33, %36 : i32
    %shape_12 = cute.make_shape(%28#0, %44, %28#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %lay_13 = cute.make_layout(%shape_12, %0) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %view_14 = cute.make_view(%2, %lay_13) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %45:5 = cute.get_scalars(%5) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %c1_i32_15 = arith.constant 1 : i32
    %c0_i32_16 = arith.constant 0 : i32
    %c-1_i32_17 = arith.constant -1 : i32
    %46 = arith.cmpi sgt, %c512_i32, %c0_i32_16 : i32
    %47 = arith.select %46, %c-1_i32_17, %c1_i32_15 : i32
    %48 = arith.addi %47, %45#1 : i32
    %49 = arith.divsi %48, %c512_i32 : i32
    %50 = arith.addi %c1_i32_15, %49 : i32
    %51 = arith.subi %c0_i32_16, %45#1 : i32
    %52 = arith.divsi %51, %c512_i32 : i32
    %53 = arith.subi %c0_i32_16, %52 : i32
    %54 = arith.cmpi slt, %45#1, %c0_i32_16 : i32
    %55 = arith.cmpi sgt, %45#1, %c0_i32_16 : i32
    %56 = arith.cmpi slt, %c512_i32, %c0_i32_16 : i32
    %57 = arith.cmpi sgt, %c512_i32, %c0_i32_16 : i32
    %58 = arith.andi %54, %56 : i1
    %59 = arith.andi %55, %57 : i1
    %60 = arith.ori %58, %59 : i1
    %61 = arith.select %60, %50, %53 : i32
    %shape_18 = cute.make_shape(%45#0, %61, %45#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_19 = cute.make_stride(%45#3, %45#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %lay_20 = cute.make_layout(%shape_18, %stride_19) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %view_21 = cute.make_view(%iter_0, %lay_20) : !memref_gmem_i8_
