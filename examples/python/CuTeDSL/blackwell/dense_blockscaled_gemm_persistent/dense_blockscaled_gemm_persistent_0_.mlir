...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo11024100div10241_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: !cute.layout<"(128,8):(8,1)">, %arg4: !cute.layout<"(128,4):(4,1)">, %arg5: i32, %arg6: i32, %arg7: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %e0_13, %e1_14, %e2_15, %e3_16, %e4_17, %e5_18 = cute.get_leaves(%4) : !cute.stride<"((0,?{i64},0),(?{i64},?{i64 div=1024},1))">
      ...
      %7 = cute.get_scalars(%itup_21) : !cute.int_tuple<"?{i64 div=1024}">
      %lay_22 = cute.get_layout(%arg1) : !memref_gmem_i8_
      %8 = cute.get_shape(%lay_22) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
      ...
      %12 = cute.get_stride(%lay_22) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
      %e0_32, %e1_33, %e2_34, %e3_35, %e4_36, %e5_37 = cute.get_leaves(%12) : !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
      ...
      %14 = cute.get_scalars(%itup_39) : !cute.int_tuple<"?{i64}">
      %lay_40 = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %15 = cute.get_shape(%lay_40) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.shape<"((1,1024,1),(?,?,?))">
      %e0_41, %e1_42, %e2_43, %e3_44, %e4_45, %e5_46 = cute.get_leaves(%15) : !cute.shape<"((1,1024,1),(?,?,?))">
      ...
      %19 = cute.get_stride(%lay_40) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
      %e0_50, %e1_51, %e2_52, %e3_53, %e4_54, %e5_55 = cute.get_leaves(%19) : !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
      %20 = cute.get_shape(%arg3) : (!cute.layout<"(128,8):(8,1)">) -> !cute.shape<"(128,8)">
      %e0_56, %e1_57 = cute.get_leaves(%20) : !cute.shape<"(128,8)">
      %21 = cute.get_stride(%arg3) : (!cute.layout<"(128,8):(8,1)">) -> !cute.stride<"(8,1)">
      %e0_58, %e1_59 = cute.get_leaves(%21) : !cute.stride<"(8,1)">
      ...
      %27 = cute.get_scalars(%e1_72) : !cute.int_tuple<"?{div=1024}">
      %28 = cute.get_scalars(%e2_73) : !cute.int_tuple<"?">
      %29 = cute.composition(%slice, %arg3) : (!memref_gmem_f32_1, !cute.layout<"(128,8):(8,1)">) -> !memref_gmem_f32_2
      %iter_74 = cute.get_iter(%29) : !memref_gmem_f32_2
      %30 = cute.composition(%slice_66, %arg4) : (!memref_gmem_i8_1, !cute.layout<"(128,4):(4,1)">) -> !memref_gmem_i8_2
      %iter_75 = cute.get_iter(%30) : !memref_gmem_i8_2
      %31 = cute.composition(%slice_69, %arg3) : (!cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">, !cute.layout<"(128,8):(8,1)">) -> !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      %iter_76 = cute.get_iter(%31) : !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      %e0_77, %e1_78, %e2_79 = cute.get_leaves(%iter_76) : !cute.int_tuple<"(?,?{div=1024},?)">
      %32 = cute.get_scalars(%e0_77) : !cute.int_tuple<"?">
      %33 = cute.get_scalars(%e1_78) : !cute.int_tuple<"?{div=1024}">
      ...
      %slice_84 = cute.slice(%30, %coord_83) : !memref_gmem_i8_2, !cute.coord<"(?,_)">
      %iter_85 = cute.get_iter(%slice_84) : !memref_gmem_i8_3
      %coord_86 = cute.make_coord(%24) : (i32) -> !cute.coord<"(?,_)">
      %slice_87 = cute.slice(%31, %coord_86) : !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">, !cute.coord<"(?,_)">
      ...
      %36 = cute.get_scalars(%e1_90) : !cute.int_tuple<"?{div=8}">
      ...
      %39 = cute.get_scalars(%e1_96) : !cute.int_tuple<"?{div=8}">
      ...
      %42 = cute.get_scalars(%e1_100) : !cute.int_tuple<"?{div=8}">
      ...
      %45 = cute.get_scalars(%e1_104) : !cute.int_tuple<"?{div=8}">
      ...
      %47 = cute.elem_less(%coord_106, %coord_107) : !cute.coord<"(?,?{div=8},?)">, !cute.coord<"(?,?,?)">
      scf.if %47 {
        %48 = cute.get_shape(%arg3) : (!cute.layout<"(128,8):(8,1)">) -> !cute.shape<"(128,8)">
        %e0_108, %e1_109 = cute.get_leaves(%48) : !cute.shape<"(128,8)">
        %49 = cute.get_shape(%arg3) : (!cute.layout<"(128,8):(8,1)">) -> !cute.shape<"(128,8)">
        %e0_110, %e1_111 = cute.get_leaves(%49) : !cute.shape<"(128,8)">
        %50 = cute.get(%arg3) <{mode = [1]}> : !cute.layout<"(128,8):(8,1)"> -> !cute.layout<"8:1">
        ...
        %rmem_118 = cute.memref.alloca(%53) : !memref_rmem_i8_
        ...
        %54 = cute.get_shape(%lay_121) : (!cute.layout<"(8):(?{i64})">) -> !cute.shape<"(8)">
        %e0_122 = cute.get_leaves(%54) : !cute.shape<"(8)">
        %lay_123 = cute.get_layout(%rmem) : !memref_rmem_f32_
        %55 = cute.get_shape(%lay_123) : (!cute.layout<"8:1">) -> !cute.shape<"8">
        %e0_124 = cute.get_leaves(%55) : !cute.shape<"8">
        ...
        %56 = cute.get_shape(%lay_128) : (!cute.layout<"(8,1):(?{i64},0)">) -> !cute.shape<"(8,1)">
        %e0_129, %e1_130 = cute.get_leaves(%56) : !cute.shape<"(8,1)">
        ...
        %57 = cute.get_shape(%lay_139) : (!cute.layout<"(8,1):(1,0)">) -> !cute.shape<"(8,1)">
        %e0_140, %e1_141 = cute.get_leaves(%57) : !cute.shape<"(8,1)">
        ...
        %58 = cute.get_shape(%lay_145) : (!cute.layout<"(8,(1)):(?{i64},(0))">) -> !cute.shape<"(8,(1))">
        %e0_146, %e1_147 = cute.get_leaves(%58) : !cute.shape<"(8,(1))">
        %lay_148 = cute.get_layout(%grouped_142) : !memref_rmem_f32_2
        %59 = cute.get_shape(%lay_148) : (!cute.layout<"(8,(1)):(1,(0))">) -> !cute.shape<"(8,(1))">
        %e0_149, %e1_150 = cute.get_leaves(%59) : !cute.shape<"(8,(1))">
        ...
        %61 = nvgpu.cvt_fptrunc %60 : vector<8xf32> to vector<8xf4E2M1FN>
        %shape_154 = cute.make_shape() : () -> !cute.shape<"8">
        %lay_155 = cute.make_layout(%shape_154) : !cute.layout<"8:1">
        %62 = cute.recast_layout<8, 4> (%lay_155) : !cute.layout<"8:1"> to !cute.layout<"4:1">
        %63 = cute.get_shape(%62) : (!cute.layout<"4:1">) -> !cute.shape<"4">
        %e0_156 = cute.get_leaves(%63) : !cute.shape<"4">
        %64 = builtin.unrealized_conversion_cast %61 : vector<8xf4E2M1FN> to vector<8xi4>
        %65 = vector.bitcast %64 : vector<8xi4> to vector<4xi8>
        %lay_157 = cute.get_layout(%rmem_118) : !memref_rmem_i8_
        %66 = cute.get_shape(%lay_157) : (!cute.layout<"4:1">) -> !cute.shape<"4">
        %e0_158 = cute.get_leaves(%66) : !cute.shape<"4">
        ...
        cute.memref.store_vec %65, %rmem_118, row_major : !memref_rmem_i8_
        ...
        %68 = cute.get_shape(%lay_173) : (!cute.layout<"(4,1):(1,0)">) -> !cute.shape<"(4,1)">
        %e0_174, %e1_175 = cute.get_leaves(%68) : !cute.shape<"(4,1)">
        ...
        %69 = cute.get_shape(%lay_185) : (!cute.layout<"(4,1):(1,0)">) -> !cute.shape<"(4,1)">
        %e0_186, %e1_187 = cute.get_leaves(%69) : !cute.shape<"(4,1)">
        ...
        %70 = cute.get_shape(%lay_191) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_192, %e1_193 = cute.get_leaves(%70) : !cute.shape<"(4,(1))">
        %lay_194 = cute.get_layout(%grouped_188) : !memref_gmem_i8_5
        %71 = cute.get_shape(%lay_194) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_195, %e1_196 = cute.get_leaves(%71) : !cute.shape<"(4,(1))">
