...
module attributes {gpu.container_module} {
  ...
  ^bb20:  // pred: ^bb19
    ...
    gpu.launch_func  @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo11024100div10241_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0 blocks in (%160, %24, %24) threads in (%23, %24, %24)  dynamic_shared_memory_size %21 args(%106 : !memref_gmem_f32_, %156 : !memref_gmem_i8_, %129 : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %70 : i32, %71 : i32, %72 : i32)
    llvm.return
  }
