...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb15:  // pred: ^bb14
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%495, %492, %315) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb29:  // pred: ^bb28
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%522, %515, %315) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb41:  // pred: ^bb40
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%541, %517, %315) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb59:  // 2 preds: ^bb57, ^bb58
      "nvvm.mbarrier.try_wait.parity.shared"(%352, %309, %315) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb86:  // pred: ^bb85
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%1048, %1047, %315) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
