...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb47(%255: i32):  // 2 preds: ^bb46, ^bb50
      ...
      llvm.cond_br %256, ^bb48, ^bb51(%242, %244, %240 : i32, i32, i32) {llvm.loop_annotation = #loop_annotation}
    ^bb48:  // pred: ^bb47
    ...
    ^bb58(%268: i32, %269: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb57, ^bb70
      ...
      llvm.cond_br %270, ^bb59, ^bb71 {loop_annotation = #loop_annotation1}
    ^bb59:  // pred: ^bb58
    ...
    ^bb60(%293: i32):  // 2 preds: ^bb59, ^bb69
      ...
      llvm.cond_br %294, ^bb61, ^bb70 {llvm.loop_annotation = #loop_annotation}
    ^bb61:  // pred: ^bb60
      llvm.br ^bb62(%17 : i32)
    ^bb62(%295: i32):  // 2 preds: ^bb61, ^bb68
      %296 = llvm.icmp "slt" %295, %33 : i32
      llvm.cond_br %296, ^bb63, ^bb69 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%17 : i32)
    ^bb64(%297: i32):  // 2 preds: ^bb63, ^bb67
      %298 = llvm.icmp "slt" %297, %33 : i32
      llvm.cond_br %298, ^bb65, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
    ...
    ^bb81(%362: i32):  // 2 preds: ^bb80, ^bb82
      ...
      llvm.cond_br %363, ^bb82, ^bb83 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
    ...
    ^bb84(%622: i32):  // 2 preds: ^bb83, ^bb85
      ...
      llvm.cond_br %623, ^bb85, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb85:  // pred: ^bb84
