  ...
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel___main__DenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB112881281128_TVLay_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %195:7 = scf.if %194 -> (i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_) {
        ...
        %shape_447 = cute.make_shape() : () -> !cute.shape<"1">
        %lay_448 = cute.make_layout(%shape_447) : !cute.layout<"1:0">
        ...
        %233 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>) -> !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
        %c5_i32 = arith.constant 5 : i32
        %234 = arith.minsi %c5_i32, %163 : i32
        %235:3 = scf.for %arg6 = %c0_i32_443 to %234 step %c1_i32_444 iter_args(%arg7 = %c0_i32_330, %arg8 = %c1_i32_331, %arg9 = %c0_i32_330) -> (i32, i32, i32)  : i32 {
          scf.if %true_445 {
            %int_tuple_484 = cute.make_int_tuple(%arg7) : (i32) -> !cute.int_tuple<"?">
            %ptr_485 = cute.add_offset(%ptr_153, %int_tuple_484) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %243 = builtin.unrealized_conversion_cast %ptr_485 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %c10000000_i32 = arith.constant 10000000 : i32
            nvvm.mbarrier.try_wait.parity.shared %243, %arg8, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          }
          scf.if %true_445 {
            %243 = nvvm.elect.sync -> i1
            scf.if %243 {
              %int_tuple_484 = cute.make_int_tuple(%arg7) : (i32) -> !cute.int_tuple<"?">
              %ptr_485 = cute.add_offset(%iter_151, %int_tuple_484) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %244 = builtin.unrealized_conversion_cast %ptr_485 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %c32768_i32 = arith.constant 32768 : i32
              nvvm.mbarrier.txn %244, %c32768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
          }
          %237 = arith.addi %arg7, %c1_i32_446 : i32
          %238 = arith.addi %arg9, %c1_i32_446 : i32
          %239 = arith.cmpi eq, %237, %c7_i32 : i32
          %240:2 = scf.if %239 -> (i32, i32) {
            %243 = arith.xori %arg8, %c1_i32_446 : i32
            %c0_i32_484 = arith.constant 0 : i32
            scf.yield %c0_i32_484, %243 : i32, i32
          } else {
            scf.yield %237, %arg8 : i32, i32
          }
          %coord_449 = cute.make_coord(%arg9) : (i32) -> !cute.coord<"(_,?)">
          %slice_450 = cute.slice(%slice_319, %coord_449) : !cute.coord_tensor<"(0,?{div=128},?)", "(((32,128),1),?):(((1@0,1@1),0),32@0)">, !cute.coord<"(_,?)">
          %iter_451 = cute.get_iter(%slice_450) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
          %e0_452, %e1_453, %e2_454 = cute.get_leaves(%iter_451) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %coord_455 = cute.make_coord(%arg7) : (i32) -> !cute.coord<"(_,?)">
          %slice_456 = cute.slice(%res_smem_tensor, %coord_455) : !memref_smem_tf32_2, !cute.coord<"(_,?)">
          %iter_457 = cute.get_iter(%slice_456) : !memref_smem_tf32_3
          %int_tuple_458 = cute.make_int_tuple(%arg7) : (i32) -> !cute.int_tuple<"?">
          %ptr_459 = cute.add_offset(%iter_151, %int_tuple_458) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
          %lay_460 = cute.get_layout(%slice_450) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
          %lay_461 = cute.get_layout(%slice_456) : !memref_smem_tf32_3
          %append = cute.append_to_rank<2> (%lay_460, %lay_448) : !cute.layout<"(((32,128),1)):(((1@0,1@1),0))">, !cute.layout<"1:0">
          %int_tuple_462 = cute.make_int_tuple(%e0_452, %e1_453, %e2_454) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %view_463 = cute.make_view(%int_tuple_462, %append) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">
          %grouped_464 = cute.group_modes(%view_463) <1, 2> : (!cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">) -> !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">
          %append_465 = cute.append_to_rank<2> (%lay_461, %lay_448) : !cute.layout<"((4096,1)):((1,0))">, !cute.layout<"1:0">
          %view_466 = cute.make_view(%iter_457, %append_465) : !memref_smem_tf32_4
          %grouped_467 = cute.group_modes(%view_466) <1, 2> : (!memref_smem_tf32_4) -> !memref_smem_tf32_5
          %241 = cute_nvgpu.atom.set_value(%232, %ptr_459 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          cute.copy(%241, %grouped_464, %grouped_467) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">, !memref_smem_tf32_5)
          %slice_468 = cute.slice(%slice_325, %coord_449) : !cute.coord_tensor<"(0,?{div=128},?)", "(((32,128),1),?):(((1@0,1@1),0),32@0)">, !cute.coord<"(_,?)">
          %iter_469 = cute.get_iter(%slice_468) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
          %e0_470, %e1_471, %e2_472 = cute.get_leaves(%iter_469) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %slice_473 = cute.slice(%res_smem_tensor_292, %coord_455) : !memref_smem_tf32_2, !cute.coord<"(_,?)">
          %iter_474 = cute.get_iter(%slice_473) : !memref_smem_tf32_3
          %lay_475 = cute.get_layout(%slice_468) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
          %lay_476 = cute.get_layout(%slice_473) : !memref_smem_tf32_3
          %append_477 = cute.append_to_rank<2> (%lay_475, %lay_448) : !cute.layout<"(((32,128),1)):(((1@0,1@1),0))">, !cute.layout<"1:0">
          %int_tuple_478 = cute.make_int_tuple(%e0_470, %e1_471, %e2_472) : (!cute.int_tuple<"?{div=32}">, !cute.int_tuple<"?{div=128}">, !cute.int_tuple<"?">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
          %view_479 = cute.make_view(%int_tuple_478, %append_477) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">
          %grouped_480 = cute.group_modes(%view_479) <1, 2> : (!cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">) -> !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">
          %append_481 = cute.append_to_rank<2> (%lay_476, %lay_448) : !cute.layout<"((4096,1)):((1,0))">, !cute.layout<"1:0">
          %view_482 = cute.make_view(%iter_474, %append_481) : !memref_smem_tf32_4
          %grouped_483 = cute.group_modes(%view_482) <1, 2> : (!memref_smem_tf32_4) -> !memref_smem_tf32_5
          %242 = cute_nvgpu.atom.set_value(%233, %ptr_459 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
          cute.copy(%242, %grouped_480, %grouped_483) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">, !memref_smem_tf32_5)
          scf.yield %240#0, %240#1, %238 : i32, i32, i32
        }
        %236:7 = scf.for %arg6 = %c0_i32_443 to %163 step %c1_i32_444 iter_args(%arg7 = %235#2, %arg8 = %235#0, %arg9 = %235#1, %arg10 = %c0_i32_330, %arg11 = %c0_i32_330, %arg12 = %c0_i32_330, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_)  : i32 {
          %237 = arith.addi %arg6, %234 : i32
          %238 = arith.cmpi ult, %237, %163 : i32
          %239:3 = scf.if %238 -> (i32, i32, i32) {
            scf.if %true_445 {
              %int_tuple_484 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
              %ptr_485 = cute.add_offset(%ptr_153, %int_tuple_484) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %247 = builtin.unrealized_conversion_cast %ptr_485 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %c10000000_i32 = arith.constant 10000000 : i32
              nvvm.mbarrier.try_wait.parity.shared %247, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            scf.if %true_445 {
              ...
              scf.if %247 {
                %int_tuple_484 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
                %ptr_485 = cute.add_offset(%iter_151, %int_tuple_484) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %248 = builtin.unrealized_conversion_cast %ptr_485 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                %c32768_i32 = arith.constant 32768 : i32
                nvvm.mbarrier.txn %248, %c32768_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
              }
            }
            %241 = arith.addi %arg8, %c1_i32_446 : i32
            %242 = arith.addi %arg7, %c1_i32_446 : i32
            %243 = arith.cmpi eq, %241, %c7_i32 : i32
            %244:2 = scf.if %243 -> (i32, i32) {
              %247 = arith.xori %arg9, %c1_i32_446 : i32
              %c0_i32_484 = arith.constant 0 : i32
              scf.yield %c0_i32_484, %247 : i32, i32
            } else {
              scf.yield %241, %arg9 : i32, i32
            }
            %coord_449 = cute.make_coord(%arg7) : (i32) -> !cute.coord<"(_,?)">
            %slice_450 = cute.slice(%slice_319, %coord_449) : !cute.coord_tensor<"(0,?{div=128},?)", "(((32,128),1),?):(((1@0,1@1),0),32@0)">, !cute.coord<"(_,?)">
            %iter_451 = cute.get_iter(%slice_450) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
            %e0_452, %e1_453, %e2_454 = cute.get_leaves(%iter_451) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %coord_455 = cute.make_coord(%arg8) : (i32) -> !cute.coord<"(_,?)">
            %slice_456 = cute.slice(%res_smem_tensor, %coord_455) : !memref_smem_tf32_2, !cute.coord<"(_,?)">
            %iter_457 = cute.get_iter(%slice_456) : !memref_smem_tf32_3
            %int_tuple_458 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
            %ptr_459 = cute.add_offset(%iter_151, %int_tuple_458) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %lay_460 = cute.get_layout(%slice_450) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
            %lay_461 = cute.get_layout(%slice_456) : !memref_smem_tf32_3
            %append = cute.append_to_rank<2> (%lay_460, %lay_448) : !cute.layout<"(((32,128),1)):(((1@0,1@1),0))">, !cute.layout<"1:0">
            ...
            %view_466 = cute.make_view(%iter_457, %append_465) : !memref_smem_tf32_4
            %grouped_467 = cute.group_modes(%view_466) <1, 2> : (!memref_smem_tf32_4) -> !memref_smem_tf32_5
            %245 = cute_nvgpu.atom.set_value(%232, %ptr_459 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            cute.copy(%245, %grouped_464, %grouped_467) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">, !memref_smem_tf32_5)
            %slice_468 = cute.slice(%slice_325, %coord_449) : !cute.coord_tensor<"(0,?{div=128},?)", "(((32,128),1),?):(((1@0,1@1),0),32@0)">, !cute.coord<"(_,?)">
            %iter_469 = cute.get_iter(%slice_468) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
            %e0_470, %e1_471, %e2_472 = cute.get_leaves(%iter_469) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            %slice_473 = cute.slice(%res_smem_tensor_292, %coord_455) : !memref_smem_tf32_2, !cute.coord<"(_,?)">
            ...
            %view_482 = cute.make_view(%iter_474, %append_481) : !memref_smem_tf32_4
            %grouped_483 = cute.group_modes(%view_482) <1, 2> : (!memref_smem_tf32_4) -> !memref_smem_tf32_5
            %246 = cute_nvgpu.atom.set_value(%233, %ptr_459 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            cute.copy(%246, %grouped_480, %grouped_483) : (!cute_nvgpu.atom.tma_load<tf32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>, !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),(1)):(((1@0,1@1),0),(0))">, !memref_smem_tf32_5)
            scf.yield %244#0, %244#1, %242 : i32, i32, i32
          } else {
            scf.yield %arg8, %arg9, %arg7 : i32, i32, i32
          }
          %240:4 = scf.if %88 -> (i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_) {
            scf.if %true_445 {
              %int_tuple_450 = cute.make_int_tuple(%arg11) : (i32) -> !cute.int_tuple<"?">
              %ptr_451 = cute.add_offset(%iter_151, %int_tuple_450) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %247 = builtin.unrealized_conversion_cast %ptr_451 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              %c10000000_i32 = arith.constant 10000000 : i32
              nvvm.mbarrier.try_wait.parity.shared %247, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            }
            %241 = arith.addi %arg11, %c1_i32_446 : i32
            %242 = arith.addi %arg10, %c1_i32_446 : i32
            %243 = arith.cmpi eq, %241, %c7_i32 : i32
            %244:2 = scf.if %243 -> (i32, i32) {
              %247 = arith.xori %arg12, %c1_i32_446 : i32
              %c0_i32_450 = arith.constant 0 : i32
              scf.yield %c0_i32_450, %247 : i32, i32
            } else {
              scf.yield %241, %arg12 : i32, i32
            }
            %c0_i32_449 = arith.constant 0 : i32
            %c4_i32 = arith.constant 4 : i32
            %245 = scf.for %arg14 = %c0_i32_449 to %c4_i32 step %c1_i32_446 iter_args(%arg15 = %arg13) -> (!mma_tf32_tf32_f32_128x128x8_)  : i32 {
              %coord_450 = cute.make_coord(%arg14, %arg11) : (i32, i32) -> !cute.coord<"(_,_,?,?)">
              %slice_451 = cute.slice(%frg_A, %coord_450) : !cute_nvgpu.smem_desc_view<!cute_nvgpu.smem_desc, "(1,1,4,7):(0,0,2,1024)">, !cute.coord<"(_,_,?,?)">
              %slice_452 = cute.slice(%frg_B, %coord_450) : !cute_nvgpu.smem_desc_view<!cute_nvgpu.smem_desc, "(1,1,4,7):(0,0,2,1024)">, !cute.coord<"(_,_,?,?)">
              cute.gemm(%arg15, %view_316, %slice_451, %slice_452, %view_316) : (!mma_tf32_tf32_f32_128x128x8_, !memref_tmem_f32_1, !cute_nvgpu.smem_desc_view<!cute_nvgpu.smem_desc, "(1,1):(0,0)">, !cute_nvgpu.smem_desc_view<!cute_nvgpu.smem_desc, "(1,1):(0,0)">, !memref_tmem_f32_1)
              %247 = cute_nvgpu.atom.set_value(%arg15, %true_445 : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_tf32_tf32_f32_128x128x8_
              scf.yield %247 : !mma_tf32_tf32_f32_128x128x8_
            } {loop_annotation = #loop_annotation}
            %246 = nvvm.elect.sync -> i1
            scf.if %246 {
              %int_tuple_450 = cute.make_int_tuple(%arg11) : (i32) -> !cute.int_tuple<"?">
              %ptr_451 = cute.add_offset(%ptr_153, %int_tuple_450) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %247 = builtin.unrealized_conversion_cast %ptr_451 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %247 : !llvm.ptr<3>
            }
            scf.yield %242, %244#0, %244#1, %245 : i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_
          } else {
            scf.yield %arg10, %arg11, %arg12, %arg13 : i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_
          }
          scf.yield %239#2, %239#0, %239#1, %240#0, %240#1, %240#2, %240#3 : i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_
        }
        scf.if %88 {
          %237 = nvvm.elect.sync -> i1
          scf.if %237 {
            %c0_i32_449 = arith.constant 0 : i32
            %int_tuple_450 = cute.make_int_tuple(%c0_i32_449) : (i32) -> !cute.int_tuple<"?">
            %ptr_451 = cute.add_offset(%iter_160, %int_tuple_450) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %238 = builtin.unrealized_conversion_cast %ptr_451 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %238 : !llvm.ptr<3>
          }
        } else {
        }
        scf.yield %236#0, %236#1, %236#2, %236#3, %236#4, %236#5, %236#6 : i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_
      } else {
