...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb22(%640: i32):  // 2 preds: ^bb21, ^bb23
      ...
      llvm.cond_br %641, ^bb23, ^bb24 {llvm.loop_annotation = #loop_annotation}
    ^bb23:  // pred: ^bb22
    ...
    ^bb25(%669: i32):  // 2 preds: ^bb24, ^bb26
      ...
      llvm.cond_br %670, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation}
    ^bb26:  // pred: ^bb25
    ...
    ^bb29(%675: i32, %676: i32, %677: i32, %678: i32, %679: i32, %680: i32, %681: i32, %682: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb64
      %683 = llvm.icmp "slt" %675, %439 : i32
      llvm.cond_br %683, ^bb30, ^bb65
    ^bb30:  // pred: ^bb29
      %684 = llvm.add %675, %594 : i32
      %685 = llvm.icmp "ult" %684, %439 : i32
      llvm.cond_br %685, ^bb31, ^bb44
    ^bb31:  // pred: ^bb30
    ...
    ^bb33:  // 2 preds: ^bb31, ^bb32
      ...
      llvm.cond_br %691, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
      %693 = llvm.xor %678, %164 : i32
      llvm.br ^bb36(%693 : i32)
    ^bb35:  // pred: ^bb33
      llvm.br ^bb36(%678 : i32)
    ^bb36(%694: i32):  // 2 preds: ^bb34, ^bb35
      llvm.br ^bb37
    ^bb37:  // pred: ^bb36
    ...
    ^bb38(%726: i32):  // 2 preds: ^bb37, ^bb39
      ...
      llvm.cond_br %727, ^bb39, ^bb40 {llvm.loop_annotation = #loop_annotation}
    ^bb39:  // pred: ^bb38
    ...
    ^bb41(%755: i32):  // 2 preds: ^bb40, ^bb42
      %756 = llvm.icmp "slt" %755, %719 : i32
      llvm.cond_br %756, ^bb42, ^bb43 {llvm.loop_annotation = #loop_annotation}
    ^bb42:  // pred: ^bb41
      ...
      llvm.br ^bb41(%758 : i32)
    ^bb43:  // pred: ^bb41
      llvm.br ^bb45(%692, %694, %690 : i32, i32, i32)
    ^bb44:  // pred: ^bb30
      llvm.br ^bb45(%677, %678, %676 : i32, i32, i32)
    ^bb45(%759: i32, %760: i32, %761: i32):  // 2 preds: ^bb43, ^bb44
      llvm.br ^bb46
    ^bb46:  // pred: ^bb45
      ...
      llvm.cond_br %765, ^bb47, ^bb48
    ^bb47:  // pred: ^bb46
      %767 = llvm.xor %681, %164 : i32
      llvm.br ^bb49(%767 : i32)
    ^bb48:  // pred: ^bb46
      llvm.br ^bb49(%681 : i32)
    ^bb49(%768: i32):  // 2 preds: ^bb47, ^bb48
      llvm.br ^bb50
    ^bb50:  // pred: ^bb49
      llvm.br ^bb51(%165, %682 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb51(%769: i32, %770: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb50, ^bb61
      %771 = llvm.icmp "slt" %769, %136 : i32
      llvm.cond_br %771, ^bb52, ^bb62 {loop_annotation = #loop_annotation1}
    ^bb52:  // pred: ^bb51
    ...
    ^bb53(%805: i32):  // 2 preds: ^bb52, ^bb60
      %806 = llvm.icmp "slt" %805, %674 : i32
      llvm.cond_br %806, ^bb54, ^bb61 {llvm.loop_annotation = #loop_annotation}
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%165 : i32)
    ^bb55(%807: i32):  // 2 preds: ^bb54, ^bb59
      %808 = llvm.icmp "slt" %807, %674 : i32
      llvm.cond_br %808, ^bb56, ^bb60 {llvm.loop_annotation = #loop_annotation}
    ^bb56:  // pred: ^bb55
      llvm.br ^bb57(%165 : i32)
    ^bb57(%809: i32):  // 2 preds: ^bb56, ^bb58
      %810 = llvm.icmp "slt" %809, %674 : i32
      llvm.cond_br %810, ^bb58, ^bb59 {llvm.loop_annotation = #loop_annotation}
    ^bb58:  // pred: ^bb57
    ...
    ^bb64:  // 2 preds: ^bb62, ^bb63
      ...
      llvm.br ^bb29(%821, %761, %759, %760, %764, %766, %768, %770 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb65:  // pred: ^bb29
      %822 = nvvm.elect.sync -> i1
      llvm.cond_br %822, ^bb66, ^bb67
    ^bb66:  // pred: ^bb65
      nvvm.tcgen05.commit.arrive %201 : !llvm.ptr<3>
      llvm.br ^bb67
    ^bb67:  // 2 preds: ^bb65, ^bb66
      llvm.br ^bb69(%677, %678 : i32, i32)
    ^bb68:  // pred: ^bb12
      llvm.br ^bb69(%165, %164 : i32, i32)
    ^bb69(%823: i32, %824: i32):  // 2 preds: ^bb67, ^bb68
      llvm.br ^bb70
    ^bb70:  // pred: ^bb69
    ...
    ^bb73(%919: i32):  // 2 preds: ^bb72, ^bb74
      %920 = llvm.icmp "slt" %919, %918 : i32
      llvm.cond_br %920, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb76(%1445: i32):  // 2 preds: ^bb75, ^bb77
      %1446 = llvm.icmp "slt" %1445, %918 : i32
      llvm.cond_br %1446, ^bb77, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb77:  // pred: ^bb76
