...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb22(%641: i32):  // 2 preds: ^bb21, ^bb23
      ...
      llvm.cond_br %642, ^bb23, ^bb24 {llvm.loop_annotation = #loop_annotation}
    ^bb23:  // pred: ^bb22
    ...
    ^bb25(%671: i32):  // 2 preds: ^bb24, ^bb26
      ...
      llvm.cond_br %672, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation}
    ^bb26:  // pred: ^bb25
    ...
    ^bb28:  // pred: ^bb14
      ...
      llvm.br ^bb29(%165, %599, %597, %598, %165, %165, %165, %arg0 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb29(%677: i32, %678: i32, %679: i32, %680: i32, %681: i32, %682: i32, %683: i32, %684: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb64
      %685 = llvm.icmp "slt" %677, %439 : i32
      llvm.cond_br %685, ^bb30, ^bb65
    ^bb30:  // pred: ^bb29
      %686 = llvm.add %677, %594 : i32
      %687 = llvm.icmp "ult" %686, %439 : i32
      llvm.cond_br %687, ^bb31, ^bb44
    ^bb31:  // pred: ^bb30
    ...
    ^bb33:  // 2 preds: ^bb31, ^bb32
      ...
      llvm.cond_br %693, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
      %695 = llvm.xor %680, %164 : i32
      llvm.br ^bb36(%695 : i32)
    ^bb35:  // pred: ^bb33
      llvm.br ^bb36(%680 : i32)
    ^bb36(%696: i32):  // 2 preds: ^bb34, ^bb35
      llvm.br ^bb37
    ^bb37:  // pred: ^bb36
      ...
      llvm.br ^bb38(%165 : i32)
    ^bb38(%729: i32):  // 2 preds: ^bb37, ^bb39
      %730 = llvm.icmp "slt" %729, %721 : i32
      llvm.cond_br %730, ^bb39, ^bb40 {llvm.loop_annotation = #loop_annotation}
    ^bb39:  // pred: ^bb38
    ...
    ^bb40:  // pred: ^bb38
      ...
      llvm.br ^bb41(%165 : i32)
    ^bb41(%759: i32):  // 2 preds: ^bb40, ^bb42
      %760 = llvm.icmp "slt" %759, %721 : i32
      llvm.cond_br %760, ^bb42, ^bb43 {llvm.loop_annotation = #loop_annotation}
    ^bb42:  // pred: ^bb41
      ...
      llvm.br ^bb41(%762 : i32)
    ^bb43:  // pred: ^bb41
      llvm.br ^bb45(%694, %696, %692 : i32, i32, i32)
    ^bb44:  // pred: ^bb30
      llvm.br ^bb45(%679, %680, %678 : i32, i32, i32)
    ^bb45(%763: i32, %764: i32, %765: i32):  // 2 preds: ^bb43, ^bb44
      llvm.br ^bb46
    ^bb46:  // pred: ^bb45
      ...
      llvm.cond_br %769, ^bb47, ^bb48
    ^bb47:  // pred: ^bb46
      %771 = llvm.xor %683, %164 : i32
      llvm.br ^bb49(%771 : i32)
    ^bb48:  // pred: ^bb46
      llvm.br ^bb49(%683 : i32)
    ^bb49(%772: i32):  // 2 preds: ^bb47, ^bb48
      llvm.br ^bb50
    ^bb50:  // pred: ^bb49
      llvm.br ^bb51(%165, %684 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb51(%773: i32, %774: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb50, ^bb61
      %775 = llvm.icmp "slt" %773, %136 : i32
      llvm.cond_br %775, ^bb52, ^bb62 {loop_annotation = #loop_annotation1}
    ^bb52:  // pred: ^bb51
      ...
      llvm.br ^bb53(%165 : i32)
    ^bb53(%809: i32):  // 2 preds: ^bb52, ^bb60
      %810 = llvm.icmp "slt" %809, %676 : i32
      llvm.cond_br %810, ^bb54, ^bb61 {llvm.loop_annotation = #loop_annotation}
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%165 : i32)
    ^bb55(%811: i32):  // 2 preds: ^bb54, ^bb59
      %812 = llvm.icmp "slt" %811, %676 : i32
      llvm.cond_br %812, ^bb56, ^bb60 {llvm.loop_annotation = #loop_annotation}
    ^bb56:  // pred: ^bb55
      llvm.br ^bb57(%165 : i32)
    ^bb57(%813: i32):  // 2 preds: ^bb56, ^bb58
      %814 = llvm.icmp "slt" %813, %676 : i32
      llvm.cond_br %814, ^bb58, ^bb59 {llvm.loop_annotation = #loop_annotation}
    ^bb58:  // pred: ^bb57
    ...
    ^bb64:  // 2 preds: ^bb62, ^bb63
      ...
      llvm.br ^bb29(%825, %765, %763, %764, %768, %770, %772, %774 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb65:  // pred: ^bb29
      %826 = nvvm.elect.sync -> i1
      llvm.cond_br %826, ^bb66, ^bb67
    ^bb66:  // pred: ^bb65
      nvvm.tcgen05.commit.arrive %201 : !llvm.ptr<3>
      llvm.br ^bb67
    ^bb67:  // 2 preds: ^bb65, ^bb66
      llvm.br ^bb69(%679, %680 : i32, i32)
    ^bb68:  // pred: ^bb12
      llvm.br ^bb69(%165, %164 : i32, i32)
    ^bb69(%827: i32, %828: i32):  // 2 preds: ^bb67, ^bb68
      llvm.br ^bb70
    ^bb70:  // pred: ^bb69
      llvm.cond_br %192, ^bb71, ^bb72
    ^bb71:  // pred: ^bb70
    ...
    ^bb72:  // 2 preds: ^bb70, ^bb71
      ...
      llvm.br ^bb73(%165 : i32)
    ^bb73(%923: i32):  // 2 preds: ^bb72, ^bb74
      %924 = llvm.icmp "slt" %923, %922 : i32
      llvm.cond_br %924, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb75:  // pred: ^bb73
      ...
      llvm.br ^bb76(%165 : i32)
    ^bb76(%1447: i32):  // 2 preds: ^bb75, ^bb77
      %1448 = llvm.icmp "slt" %1447, %922 : i32
      llvm.cond_br %1448, ^bb77, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb77:  // pred: ^bb76
