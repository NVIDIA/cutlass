gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_100a">] {
  ...
  ^bb42(%247: i32):  // 2 preds: ^bb41, ^bb45
    ...
    llvm.cond_br %248, ^bb43, ^bb46 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb43:  // pred: ^bb42
  ...
  ^bb47(%252: i32):  // 2 preds: ^bb46, ^bb50
    ...
    llvm.cond_br %253, ^bb48, ^bb51(%240, %242, %238 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb48:  // pred: ^bb47
  ...
  ^bb58(%265: i32, %266: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb57, ^bb70
    ...
    llvm.cond_br %267, ^bb59, ^bb71 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb59:  // pred: ^bb58
  ...
  ^bb60(%290: i32):  // 2 preds: ^bb59, ^bb69
    ...
    llvm.cond_br %291, ^bb61, ^bb70 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb61:  // pred: ^bb60
    llvm.br ^bb62(%16 : i32)
  ^bb62(%292: i32):  // 2 preds: ^bb61, ^bb68
    %293 = llvm.icmp "slt" %292, %32 : i32
    llvm.cond_br %293, ^bb63, ^bb69 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb63:  // pred: ^bb62
    llvm.br ^bb64(%16 : i32)
  ^bb64(%294: i32):  // 2 preds: ^bb63, ^bb67
    %295 = llvm.icmp "slt" %294, %32 : i32
    llvm.cond_br %295, ^bb65, ^bb68 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb65:  // pred: ^bb64
  ...
  ^bb81(%359: i32):  // 2 preds: ^bb80, ^bb82
    ...
    llvm.cond_br %360, ^bb82, ^bb83 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb82:  // pred: ^bb81
  ...
  ^bb84(%619: i32):  // 2 preds: ^bb83, ^bb85
    ...
    llvm.cond_br %620, ^bb85, ^bb86 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
