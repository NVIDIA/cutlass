gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb42(%252: i32):  // 2 preds: ^bb41, ^bb45
    ...
    llvm.cond_br %253, ^bb43, ^bb46 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb43:  // pred: ^bb42
  ...
  ^bb47(%257: i32):  // 2 preds: ^bb46, ^bb50
    ...
    llvm.cond_br %258, ^bb48, ^bb51(%244, %246, %242 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb48:  // pred: ^bb47
  ...
  ^bb58(%270: i32, %271: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb57, ^bb70
    ...
    llvm.cond_br %272, ^bb59, ^bb71 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb59:  // pred: ^bb58
  ...
  ^bb60(%295: i32):  // 2 preds: ^bb59, ^bb69
    ...
    llvm.cond_br %296, ^bb61, ^bb70 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb61:  // pred: ^bb60
    llvm.br ^bb62(%17 : i32)
  ^bb62(%297: i32):  // 2 preds: ^bb61, ^bb68
    %298 = llvm.icmp "slt" %297, %33 : i32
    llvm.cond_br %298, ^bb63, ^bb69 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb63:  // pred: ^bb62
    llvm.br ^bb64(%17 : i32)
  ^bb64(%299: i32):  // 2 preds: ^bb63, ^bb67
    %300 = llvm.icmp "slt" %299, %33 : i32
    llvm.cond_br %300, ^bb65, ^bb68 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb65:  // pred: ^bb64
  ...
  ^bb81(%364: i32):  // 2 preds: ^bb80, ^bb82
    ...
    llvm.cond_br %365, ^bb82, ^bb83 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb82:  // pred: ^bb81
  ...
  ^bb84(%624: i32):  // 2 preds: ^bb83, ^bb85
    ...
    llvm.cond_br %625, ^bb85, ^bb86 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
