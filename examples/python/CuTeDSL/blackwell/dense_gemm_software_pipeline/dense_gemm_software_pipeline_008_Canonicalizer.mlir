...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel___main__DenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB112881281128_TVLay_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, tf32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %250:2 = scf.if %249 -> (i32, i32) {
        ...
        %300:3 = scf.for %arg6 = %c0_i32 to %299 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          scf.for %arg10 = %c0_i32 to %311 step %c1_i32  : i32 {
            ...
            %315:3 = cute.get_scalars(%int_tuple_85) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_82 : !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, %314 : !cute.ptr<smem, align<8>>, [%315#0, %315#1, %315#2] : i32, i32, i32) mode = <tiled> num_cta = 1 : i32
          ...
          scf.for %arg10 = %c0_i32 to %313 step %c1_i32  : i32 {
            ...
            %315:3 = cute.get_scalars(%int_tuple_93) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_92 : !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, %314 : !cute.ptr<smem, align<8>>, [%315#0, %315#1, %315#2] : i32, i32, i32) mode = <tiled> num_cta = 1 : i32
          } {llvm.loop_annotation = #loop_annotation}
        ...
        %301:7 = scf.for %arg6 = %c0_i32 to %226 step %c1_i32 iter_args(%arg7 = %300#2, %arg8 = %300#0, %arg9 = %300#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_)  : i32 {
          ...
          %305:3 = scf.if %304 -> (i32, i32, i32) {
            ...
            scf.for %arg14 = %c0_i32 to %322 step %c1_i32  : i32 {
              ...
              %326:3 = cute.get_scalars(%int_tuple_87) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_84 : !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, %325 : !cute.ptr<smem, align<8>>, [%326#0, %326#1, %326#2] : i32, i32, i32) mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            scf.for %arg14 = %c0_i32 to %324 step %c1_i32  : i32 {
              ...
              %326:3 = cute.get_scalars(%int_tuple_95) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_94 : !cute.ptr<tf32, smem, align<128>, S<3,4,3>>, %325 : !cute.ptr<smem, align<8>>, [%326#0, %326#1, %326#2] : i32, i32, i32) mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
      ...
      %281 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
      cute.memref.store_vec %281, %rmem_68, row_major : !memref_rmem_f32_
