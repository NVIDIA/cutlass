...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb27(%222: i32):  // 2 preds: ^bb26, ^bb30
      ...
      llvm.cond_br %223, ^bb28, ^bb31 {llvm.loop_annotation = #loop_annotation}
    ^bb28:  // pred: ^bb27
    ...
    ^bb47(%256: i32):  // 2 preds: ^bb46, ^bb50
      ...
      llvm.cond_br %257, ^bb48, ^bb51(%243, %245, %241 : i32, i32, i32) {llvm.loop_annotation = #loop_annotation}
    ^bb48:  // pred: ^bb47
    ...
    ^bb58(%269: i32, %270: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb57, ^bb70
      ...
      llvm.cond_br %271, ^bb59, ^bb71 {loop_annotation = #loop_annotation1}
    ^bb59:  // pred: ^bb58
    ...
    ^bb60(%294: i32):  // 2 preds: ^bb59, ^bb69
      ...
      llvm.cond_br %295, ^bb61, ^bb70 {llvm.loop_annotation = #loop_annotation}
    ^bb61:  // pred: ^bb60
      llvm.br ^bb62(%17 : i32)
    ^bb62(%296: i32):  // 2 preds: ^bb61, ^bb68
      %297 = llvm.icmp "slt" %296, %33 : i32
      llvm.cond_br %297, ^bb63, ^bb69 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%17 : i32)
    ^bb64(%298: i32):  // 2 preds: ^bb63, ^bb67
      %299 = llvm.icmp "slt" %298, %33 : i32
      llvm.cond_br %299, ^bb65, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
    ...
    ^bb81(%363: i32):  // 2 preds: ^bb80, ^bb82
      ...
      llvm.cond_br %364, ^bb82, ^bb83 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
    ...
    ^bb84(%623: i32):  // 2 preds: ^bb83, ^bb85
      ...
      llvm.cond_br %624, ^bb85, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb85:  // pred: ^bb84
