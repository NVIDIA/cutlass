...
module attributes {gpu.container_module} {
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb6(%178: i32):  // 2 preds: ^bb5, ^bb23
      ...
      llvm.cond_br %179, ^bb7, ^bb24 {llvm.loop_annotation = #loop_annotation}
    ^bb7:  // pred: ^bb6
    ...
    ^bb25(%227: i32):  // 2 preds: ^bb24, ^bb26
      ...
      llvm.cond_br %228, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation}
    ^bb26:  // pred: ^bb25
    ...
    ^bb34(%303: i32):  // 2 preds: ^bb33, ^bb35
      ...
      llvm.cond_br %304, ^bb35, ^bb36 {llvm.loop_annotation = #loop_annotation}
    ^bb35:  // pred: ^bb34
    ...
    ^bb38(%322: i32):  // 2 preds: ^bb37, ^bb55
      ...
      llvm.cond_br %323, ^bb39, ^bb56 {llvm.loop_annotation = #loop_annotation}
    ^bb39:  // pred: ^bb38
