    ...
    cuda.kernel @kernel_cutlass_kernel___main__RMSNormKernel_object_at__tensorptrbf16gmemalign16o409640961_tensorptrbf16_gmem_align16_o_40961_tensorptrbf16gmemalign16o409640961__2_4096_0(%arg0: !memref_gmem_bf16_, %arg1: !memref_gmem_bf16_1, %arg2: !memref_gmem_bf16_, %arg3: f32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %93 {
        ...
        scf.for %arg4 = %c0_i32 to %147 step %c1_i32  : i32 {
          ...
          %148 = builtin.unrealized_conversion_cast %ptr_71 : !cute.ptr<i8, rmem> to !llvm.ptr
          %149 = llvm.load %148 : !llvm.ptr -> i8
          %150 = llvm.trunc %149 : i8 to i1
          %iter_72 = cute.recast_iter(%ptr_20) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_73 = cute.recast_iter(%ptr_21) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_73 : !cute.ptr<i128, smem>, %iter_72 : !cute.ptr<i128, gmem>, %150 : i1) {cache_mode = <always>}
          %ptr_74 = cute.add_offset(%ptr_20, %22) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"512">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_75 = cute.add_offset(%ptr_21, %22) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"512">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_76 = cute.add_offset(%ptr_71, %23) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"1">) -> !cute.ptr<i8, rmem>
          %151 = builtin.unrealized_conversion_cast %ptr_76 : !cute.ptr<i8, rmem> to !llvm.ptr
          %152 = llvm.load %151 : !llvm.ptr -> i8
          %153 = llvm.trunc %152 : i8 to i1
          %iter_77 = cute.recast_iter(%ptr_74) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_78 = cute.recast_iter(%ptr_75) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_78 : !cute.ptr<i128, smem>, %iter_77 : !cute.ptr<i128, gmem>, %153 : i1) {cache_mode = <always>}
          %ptr_79 = cute.add_offset(%ptr_20, %21) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"1024">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_80 = cute.add_offset(%ptr_21, %21) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"1024">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_81 = cute.add_offset(%ptr_71, %20) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"2">) -> !cute.ptr<i8, rmem>
          %154 = builtin.unrealized_conversion_cast %ptr_81 : !cute.ptr<i8, rmem> to !llvm.ptr
          %155 = llvm.load %154 : !llvm.ptr -> i8
          %156 = llvm.trunc %155 : i8 to i1
          %iter_82 = cute.recast_iter(%ptr_79) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_83 = cute.recast_iter(%ptr_80) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_83 : !cute.ptr<i128, smem>, %iter_82 : !cute.ptr<i128, gmem>, %156 : i1) {cache_mode = <always>}
          %ptr_84 = cute.add_offset(%ptr_20, %19) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"1536">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_85 = cute.add_offset(%ptr_21, %19) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"1536">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_86 = cute.add_offset(%ptr_71, %18) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"3">) -> !cute.ptr<i8, rmem>
          %157 = builtin.unrealized_conversion_cast %ptr_86 : !cute.ptr<i8, rmem> to !llvm.ptr
          %158 = llvm.load %157 : !llvm.ptr -> i8
          %159 = llvm.trunc %158 : i8 to i1
          %iter_87 = cute.recast_iter(%ptr_84) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_88 = cute.recast_iter(%ptr_85) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_88 : !cute.ptr<i128, smem>, %iter_87 : !cute.ptr<i128, gmem>, %159 : i1) {cache_mode = <always>}
          %ptr_89 = cute.add_offset(%ptr_20, %17) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"2048">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_90 = cute.add_offset(%ptr_21, %17) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"2048">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_91 = cute.add_offset(%ptr_71, %16) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"4">) -> !cute.ptr<i8, rmem>
          %160 = builtin.unrealized_conversion_cast %ptr_91 : !cute.ptr<i8, rmem> to !llvm.ptr
          %161 = llvm.load %160 : !llvm.ptr -> i8
          %162 = llvm.trunc %161 : i8 to i1
          %iter_92 = cute.recast_iter(%ptr_89) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_93 = cute.recast_iter(%ptr_90) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_93 : !cute.ptr<i128, smem>, %iter_92 : !cute.ptr<i128, gmem>, %162 : i1) {cache_mode = <always>}
          %ptr_94 = cute.add_offset(%ptr_20, %15) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"2560">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_95 = cute.add_offset(%ptr_21, %15) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"2560">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_96 = cute.add_offset(%ptr_71, %14) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"5">) -> !cute.ptr<i8, rmem>
          %163 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i8, rmem> to !llvm.ptr
          %164 = llvm.load %163 : !llvm.ptr -> i8
          %165 = llvm.trunc %164 : i8 to i1
          %iter_97 = cute.recast_iter(%ptr_94) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_98 = cute.recast_iter(%ptr_95) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_98 : !cute.ptr<i128, smem>, %iter_97 : !cute.ptr<i128, gmem>, %165 : i1) {cache_mode = <always>}
          %ptr_99 = cute.add_offset(%ptr_20, %13) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"3072">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_100 = cute.add_offset(%ptr_21, %13) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"3072">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_101 = cute.add_offset(%ptr_71, %12) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"6">) -> !cute.ptr<i8, rmem>
          %166 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i8, rmem> to !llvm.ptr
          %167 = llvm.load %166 : !llvm.ptr -> i8
          %168 = llvm.trunc %167 : i8 to i1
          %iter_102 = cute.recast_iter(%ptr_99) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_103 = cute.recast_iter(%ptr_100) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_103 : !cute.ptr<i128, smem>, %iter_102 : !cute.ptr<i128, gmem>, %168 : i1) {cache_mode = <always>}
          %ptr_104 = cute.add_offset(%ptr_20, %11) : (!cute.ptr<bf16, gmem, align<16>>, !cute.int_tuple<"3584">) -> !cute.ptr<bf16, gmem, align<16>>
          %ptr_105 = cute.add_offset(%ptr_21, %11) : (!cute.ptr<bf16, smem, align<16>>, !cute.int_tuple<"3584">) -> !cute.ptr<bf16, smem, align<16>>
          %ptr_106 = cute.add_offset(%ptr_71, %10) : (!cute.ptr<i8, rmem>, !cute.int_tuple<"7">) -> !cute.ptr<i8, rmem>
          %169 = builtin.unrealized_conversion_cast %ptr_106 : !cute.ptr<i8, rmem> to !llvm.ptr
          %170 = llvm.load %169 : !llvm.ptr -> i8
          %171 = llvm.trunc %170 : i8 to i1
          %iter_107 = cute.recast_iter(%ptr_104) : !cute.ptr<bf16, gmem, align<16>> to !cute.ptr<i128, gmem>
          %iter_108 = cute.recast_iter(%ptr_105) : !cute.ptr<bf16, smem, align<16>> to !cute.ptr<i128, smem>
          cute_nvgpu.arch.copy.SM80.cp_async(%iter_108 : !cute.ptr<i128, smem>, %iter_107 : !cute.ptr<i128, gmem>, %171 : i1) {cache_mode = <always>}
