...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %51 {
        ...
        %67 = nvgpu.cvt_fptrunc %66 : vector<8xf32> to vector<8xf4E2M1FN>
        ...
        %70 = builtin.unrealized_conversion_cast %67 : vector<8xf4E2M1FN> to vector<8xi4>
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_8(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f4E2M1FN) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %29:5 = cute.get_scalars(%lay_56) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %c1024_i32 = arith.constant 1024 : i32
    %30 = arith.ceildivsi %29#1, %c1024_i32 : i32
    %shape_57 = cute.make_shape(%29#0, %30, %29#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %stride_58 = cute.make_stride(%29#3, %29#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %lay_59 = cute.make_layout(%shape_57, %stride_58) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    ...
    %32 = arith.ceildivsi %31#1, %c1024_i32_66 : i32
    %shape_67 = cute.make_shape(%31#0, %32, %31#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    ...
    %33:5 = cute.get_scalars(%lay_81) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %c512_i32 = arith.constant 512 : i32
    %34 = arith.ceildivsi %33#1, %c512_i32 : i32
    %shape_82 = cute.make_shape(%33#0, %34, %33#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_83 = cute.make_stride(%33#3, %33#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %sz_89 = cute.size(%lay_88) <{mode = [1]}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %36 = cute.get_shape(%lay_93) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %e0_94, %e1_95, %e2_96, %e3, %e4, %e5 = cute.get_leaves(%36) : !cute.shape<"((1,1024,1),(?,?,?))">
    ...
    %40 = cute.get_stride(%lay_93) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %e0_100, %e1_101, %e2_102, %e3_103, %e4_104, %e5_105 = cute.get_leaves(%40) : !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    ...
    %43 = cute.get_shape(%lay_108) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    ...
    %47 = cute.get_stride(%lay_108) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %e0_118, %e1_119, %e2_120, %e3_121, %e4_122, %e5_123 = cute.get_leaves(%47) : !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %lay_126 = cute.get_layout(%view_70) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %50 = cute.get_shape(%lay_126) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %e0_127, %e1_128, %e2_129, %e3_130, %e4_131, %e5_132 = cute.get_leaves(%50) : !cute.shape<"((1,1024,1),(?,?,?))">
    ...
    %54 = cute.get_stride(%lay_126) : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
    %e0_136, %e1_137, %e2_138, %e3_139, %e4_140, %e5_141 = cute.get_leaves(%54) : !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
    ...
    %62 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0<%61> (%view_60, %view_85, %view_70, %17, %18, %19) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
