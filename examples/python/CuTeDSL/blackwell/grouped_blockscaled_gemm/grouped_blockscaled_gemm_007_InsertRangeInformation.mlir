...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %view_9 = cute.make_view(%tup) : !cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">
      ...
      %iter_14 = cute.get_iter(%view_9) : !cute.coord_tensor<"(?,?{div=1024},?)", "((1,1024,1)):((0,1@1,0))">
      %view_15 = cute.make_view(%iter_14) : !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      ...
      %7 = cute.static : !cute.layout<"(128,8):(8@1,1@1)">
      %idx_29 = cute.crd2idx(%coord_28, %7) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@1,1@1)">) -> !cute.int_tuple<"(0,?{div=8})">
      %iter_30 = cute.get_iter(%view_15) : !cute.coord_tensor<"(?,?{div=1024},?)", "(128,8):(8@1,1@1)">
      %tup_31 = cute.add_offset(%iter_30, %idx_29) : (!cute.int_tuple<"(?,?{div=1024},?)">, !cute.int_tuple<"(0,?{div=8})">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %view_32 = cute.make_view(%tup_31) : !cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">
      %8 = cute.static : !cute.int_tuple<"(0,0)">
      %iter_33 = cute.get_iter(%view_32) : !cute.coord_tensor<"(?,?{div=8},?)", "(8):(1@1)">
      %tup_34 = cute.add_offset(%iter_33, %8) : (!cute.int_tuple<"(?,?{div=8},?)">, !cute.int_tuple<"(0,0)">) -> !cute.int_tuple<"(?,?{div=8},?)">
      ...
      %coord_37 = cute.make_coord(%e0, %e1, %e2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
      ...
      scf.if %16 {
        ...
        %25 = nvgpu.cvt_fptrunc %24 : vector<8xf32> to vector<8xf4E2M1FN>
        %26 = cute.static : !cute.layout<"8:1">
        %27 = cute.recast_layout<8, 4> (%26) : !cute.layout<"8:1"> to !cute.layout<"4:1">
        %28 = builtin.unrealized_conversion_cast %25 : vector<8xf4E2M1FN> to vector<8xi4>
        %29 = vector.bitcast %28 : vector<8xi4> to vector<4xi8>
        cute.memref.store_vec %29, %rmem_40 : !memref_rmem_i8_
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_8(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f4E2M1FN) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %3 = cute.get_shape(%lay_1) : (!cute.layout<"(?,?,?):(?{i64},1,?{i64})">) -> !cute.shape<"(?,?,?)">
    ...
    %9:5 = cute.get_scalars(%lay_7) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %c1024_i32 = arith.constant 1024 : i32
    %10 = arith.ceildivsi %9#1, %c1024_i32 : i32
    %shape_8 = cute.make_shape(%9#0, %10, %9#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %stride = cute.make_stride(%9#3, %9#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    ...
    %13 = arith.ceildivsi %12#1, %c1024_i32_12 : i32
    %shape_13 = cute.make_shape(%12#0, %13, %12#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %14 = cute.static : !cute.stride<"((0,1@1,0),(1@0,1024@1,1@2))">
    %lay_14 = cute.make_layout(%shape_13, %14) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %view_15 = cute.make_view(%11, %lay_14) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %iter_16 = cute.get_iter(%view) : !memref_gmem_i8_6
    %lay_17 = cute.get_layout(%view) : !memref_gmem_i8_6
    %15:5 = cute.get_scalars(%lay_17) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %c512_i32 = arith.constant 512 : i32
    %16 = arith.ceildivsi %15#1, %c512_i32 : i32
    %shape_18 = cute.make_shape(%15#0, %16, %15#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_19 = cute.make_stride(%15#3, %15#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %sz = cute.size(%lay_22) <{mode = [1]}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %c1_i32 = arith.constant 1 : i32
    %20 = cuda.launch_cfg.create<max_attrs = 2 : i32> (blockDim = (%c128_i32, %c1_i32, %c1_i32), dynamicSmemBytes = %19, gridDim = (%17, %c1_i32, %c1_i32), stream = %18) : i32, i32, i32, i64, i32, i32, i32, !cuda.stream -> !cuda.launch_cfg<max_attrs = 2>
    %21 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0<%20> (%view_10, %view_21, %view_15, %4, %5, %6) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
    %22 = cuda.cast %21 : !cuda.result -> i32
    cuda.return_if_error %22 : i32
    %c0_i32_24 = arith.constant 0 : i32
    return %c0_i32_24 : i32
  }
}
