...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_3 = cute.add_offset(%iter_2, %idx_1) : (!cute.ptr<i8, gmem, align<16>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<i8, gmem>
      %lay_4 = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
      %idx_5 = cute.crd2idx(%coord, %lay_4) : (!cute.coord<"(_,?)">, !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">) -> !cute.int_tuple<"(?,?{div=1024},?)">
      ...
      %idx_11 = cute.crd2idx(%coord_6, %8) : (!cute.coord<"(?,_)">, !cute.layout<"(128,8):(8@1,1@1)">) -> !cute.int_tuple<"(0,?{div=8})">
      %tup_12 = cute.add_offset(%tup, %idx_11) : (!cute.int_tuple<"(?,?{div=1024},?)">, !cute.int_tuple<"(0,?{div=8})">) -> !cute.int_tuple<"(?,?{div=8},?)">
      %e0, %e1, %e2 = cute.get_leaves(%tup_12) : !cute.int_tuple<"(?,?{div=8},?)">
      %coord_13 = cute.make_coord(%e0, %e1, %e2) : (!cute.int_tuple<"?">, !cute.int_tuple<"?{div=8}">, !cute.int_tuple<"?">) -> !cute.coord<"(?,?{div=8},?)">
    ...
    ^bb4:  // pred: ^bb2
      ...
      %50 = nvgpu.cvt_fptrunc %49 : vector<8xf32> to vector<8xf4E2M1FN>
      %51 = cute.recast_layout<8, 4> (%7) : !cute.layout<"8:1"> to !cute.layout<"4:1">
      %52 = builtin.unrealized_conversion_cast %50 : vector<8xf4E2M1FN> to vector<8xi4>
      %53 = vector.bitcast %52 : vector<8xi4> to vector<4xi8>
      cute.memref.store_vec %53, %rmem_16 : !memref_rmem_i8_
      %54 = builtin.unrealized_conversion_cast %iter_17 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
      %55 = builtin.unrealized_conversion_cast %ptr_10 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %56 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<i8, rmem> to !llvm.ptr
      %57 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %58 = builtin.unrealized_conversion_cast %ptr_34 : !cute.ptr<i8, rmem, align<2>> to !llvm.ptr
      %59 = builtin.unrealized_conversion_cast %ptr_35 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      ...
      %60 = builtin.unrealized_conversion_cast %ptr_36 : !cute.ptr<i8, rmem> to !llvm.ptr
      %61 = builtin.unrealized_conversion_cast %ptr_37 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
      cf.br ^bb5(%c0_i32 : i32)
    ^bb5(%62: i32):  // 2 preds: ^bb4, ^bb6
      %63 = arith.cmpi slt, %62, %21 : i32
      cf.cond_br %63, ^bb6, ^bb7 {llvm.loop_annotation = #loop_annotation}
    ^bb6:  // pred: ^bb5
      %64 = llvm.load %54 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %64, %55 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %65 = llvm.load %56 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %65, %57 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %66 = llvm.load %58 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %66, %59 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %67 = llvm.load %60 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %67, %61 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %68 = arith.addi %62, %c1_i32 : i32
      cf.br ^bb5(%68 : i32)
    ^bb7:  // pred: ^bb5
      cf.br ^bb8
    ^bb8:  // 2 preds: ^bb0, ^bb7
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_8(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f4E2M1FN) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %10:5 = cute.get_scalars(%lay_1) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %16 = arith.subi %c0_i32_7, %10#1 : i32
    %17 = arith.divsi %16, %c1024_i32 : i32
    %18 = arith.subi %c0_i32_7, %17 : i32
    %19 = arith.cmpi slt, %10#1, %c0_i32_7 : i32
    %20 = arith.cmpi sgt, %10#1, %c0_i32_7 : i32
    ...
    %shape_8 = cute.make_shape(%10#0, %26, %10#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %stride = cute.make_stride(%10#3, %10#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},1024,?{i64}))">
    %lay_9 = cute.make_layout(%shape_8, %stride) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    ...
    %30 = arith.addi %29, %27#1 : i32
    %31 = arith.divsi %30, %c1024_i32 : i32
    %32 = arith.addi %c1_i32_10, %31 : i32
    %33 = arith.subi %c0_i32_11, %27#1 : i32
    %34 = arith.divsi %33, %c1024_i32 : i32
    %35 = arith.subi %c0_i32_11, %34 : i32
    %36 = arith.cmpi slt, %27#1, %c0_i32_11 : i32
    %37 = arith.cmpi sgt, %27#1, %c0_i32_11 : i32
    ...
    %shape_13 = cute.make_shape(%27#0, %43, %27#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    %lay_14 = cute.make_layout(%shape_13, %0) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %view_15 = cute.make_view(%2, %lay_14) : !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">
    %44:5 = cute.get_scalars(%5) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %47 = arith.addi %46, %44#1 : i32
    %48 = arith.divsi %47, %c512_i32 : i32
    %49 = arith.addi %c1_i32_16, %48 : i32
    %50 = arith.subi %c0_i32_17, %44#1 : i32
    %51 = arith.divsi %50, %c512_i32 : i32
    %52 = arith.subi %c0_i32_17, %51 : i32
    %53 = arith.cmpi slt, %44#1, %c0_i32_17 : i32
    %54 = arith.cmpi sgt, %44#1, %c0_i32_17 : i32
    ...
    %shape_19 = cute.make_shape(%44#0, %60, %44#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_20 = cute.make_stride(%44#3, %44#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %lay_21 = cute.make_layout(%shape_19, %stride_20) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %view_22 = cute.make_view(%iter_0, %lay_21) : !memref_gmem_i8_
    %sz = cute.size(%lay_9) <{mode = [1]}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
    ...
    %64 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0<%63> (%view, %view_22, %view_15, %7, %8, %9) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_i8_, !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, i32, i32, i32) -> !cuda.result
