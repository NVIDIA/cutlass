...
module attributes {gpu.container_module} {
    ...
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo1102410101024_tensorptri8gmemalign16o15121010512_tensor000o1102410110101024112____Float32_Float4E2M1FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_i8_, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,1024,1),(?,?,?)):((0,1@1,0),(1@0,1024@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %20 {
        ...
        scf.for %arg6 = %c0_i32 to %21 step %c1_i32  : i32 {
          %51 = llvm.load %22 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %51, %23 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %52 = llvm.load %24 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %52, %25 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %53 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %53, %27 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %54 = llvm.load %28 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %54, %29 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %55 = llvm.load %30 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %55, %31 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %56 = llvm.load %32 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %56, %33 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %57 = llvm.load %34 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %57, %35 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %58 = llvm.load %36 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %58, %37 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %38 = cute.memref.load_vec %rmem : !memref_rmem_f32_
        %39 = nvgpu.cvt_fptrunc %38 : vector<8xf32> to vector<8xf4E2M1FN>
        %40 = cute.recast_layout<8, 4> (%7) : !cute.layout<"8:1"> to !cute.layout<"4:1">
        %41 = builtin.unrealized_conversion_cast %39 : vector<8xf4E2M1FN> to vector<8xi4>
        %42 = vector.bitcast %41 : vector<8xi4> to vector<4xi8>
        cute.memref.store_vec %42, %rmem_16 : !memref_rmem_i8_
        %43 = builtin.unrealized_conversion_cast %iter_17 : !cute.ptr<i8, rmem, align<32>> to !llvm.ptr
        %44 = builtin.unrealized_conversion_cast %ptr_10 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
        ...
        %45 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<i8, rmem> to !llvm.ptr
        %46 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
        ...
        %47 = builtin.unrealized_conversion_cast %ptr_34 : !cute.ptr<i8, rmem, align<2>> to !llvm.ptr
        %48 = builtin.unrealized_conversion_cast %ptr_35 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
        ...
        %49 = builtin.unrealized_conversion_cast %ptr_36 : !cute.ptr<i8, rmem> to !llvm.ptr
        %50 = builtin.unrealized_conversion_cast %ptr_37 : !cute.ptr<i8, gmem> to !llvm.ptr<1>
        scf.for %arg6 = %c0_i32 to %21 step %c1_i32  : i32 {
          %51 = llvm.load %43 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %51, %44 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %52 = llvm.load %45 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %52, %46 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %53 = llvm.load %47 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %53, %48 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %54 = llvm.load %49 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %54, %50 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_8(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f4E2M1FN) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %lay_7 = cute.make_layout(%shape_6, %stride) : !cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">
    ...
    %shape_8 = cute.make_shape(%12#0, %13, %12#2) : (i32, i32, i32) -> !cute.shape<"((1,1024,1),(?,?,?))">
    ...
    %shape_11 = cute.make_shape(%14#0, %15, %14#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_12 = cute.make_stride(%14#3, %14#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %sz = cute.size(%lay_7) <{mode = [1]}> : (!cute.layout<"((1,1024,1),(?,?,?)):((0,1,0),(?{i64},1024,?{i64}))">) -> !cute.int_tuple<"?">
