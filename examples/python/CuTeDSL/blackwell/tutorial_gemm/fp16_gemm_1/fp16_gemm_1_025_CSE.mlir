...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb41(%269: i32, %270: i32, %271: i32, %272: i32, %273: i32, %274: i32, %275: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb40, ^bb118
      %276 = llvm.icmp "slt" %269, %153 : i32
      llvm.cond_br %276, ^bb42, ^bb119
    ^bb42:  // pred: ^bb41
      %277 = llvm.add %269, %233 : i32
      %278 = llvm.icmp "ult" %277, %153 : i32
      llvm.cond_br %278, ^bb43, ^bb62
    ^bb43:  // pred: ^bb42
    ...
    ^bb57(%301: i32):  // 2 preds: ^bb56, ^bb60
      ...
      llvm.cond_br %302, ^bb58, ^bb61 {llvm.loop_annotation = #loop_annotation}
    ^bb58:  // pred: ^bb57
    ...
    ^bb61:  // pred: ^bb57
      llvm.br ^bb63(%285, %287, %283 : i32, i32, i32)
    ^bb62:  // pred: ^bb42
      llvm.br ^bb63(%271, %272, %270 : i32, i32, i32)
    ^bb63(%308: i32, %309: i32, %310: i32):  // 2 preds: ^bb61, ^bb62
      llvm.br ^bb64
    ^bb64:  // pred: ^bb63
      llvm.cond_br %111, ^bb65, ^bb116
    ^bb65:  // pred: ^bb64
      ...
      llvm.cond_br %313, ^bb66, ^bb67
    ^bb66:  // pred: ^bb65
      %315 = llvm.xor %274, %40 : i32
      llvm.br ^bb68(%315 : i32)
    ^bb67:  // pred: ^bb65
      llvm.br ^bb68(%274 : i32)
    ^bb68(%316: i32):  // 2 preds: ^bb66, ^bb67
      llvm.br ^bb69
    ^bb69:  // pred: ^bb68
      ...
      llvm.br ^bb70(%21 : i32)
    ^bb70(%337: i32):  // 2 preds: ^bb69, ^bb79
      %338 = llvm.icmp "slt" %337, %40 : i32
      llvm.cond_br %338, ^bb71, ^bb80 {llvm.loop_annotation = #loop_annotation}
    ^bb71:  // pred: ^bb70
      llvm.br ^bb72(%21 : i32)
    ^bb72(%339: i32):  // 2 preds: ^bb71, ^bb78
      %340 = llvm.icmp "slt" %339, %40 : i32
      llvm.cond_br %340, ^bb73, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb73:  // pred: ^bb72
      llvm.br ^bb74(%21 : i32)
    ^bb74(%341: i32):  // 2 preds: ^bb73, ^bb77
      %342 = llvm.icmp "slt" %341, %40 : i32
      llvm.cond_br %342, ^bb75, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb75:  // pred: ^bb74
      %343 = llvm.inttoptr %216 : i32 to !llvm.ptr<6>
      %344 = nvvm.elect.sync -> i1
      llvm.cond_br %344, ^bb76, ^bb77
    ^bb76:  // pred: ^bb75
    ...
    ^bb77:  // 2 preds: ^bb75, ^bb76
      ...
      llvm.br ^bb74(%345 : i32)
    ^bb78:  // pred: ^bb74
      %346 = llvm.add %339, %40 : i32
      llvm.br ^bb72(%346 : i32)
    ^bb79:  // pred: ^bb72
      %347 = llvm.add %337, %40 : i32
      llvm.br ^bb70(%347 : i32)
    ^bb80:  // pred: ^bb70
      ...
      llvm.br ^bb81(%21 : i32)
    ^bb81(%356: i32):  // 2 preds: ^bb80, ^bb90
      %357 = llvm.icmp "slt" %356, %40 : i32
      llvm.cond_br %357, ^bb82, ^bb91 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
      llvm.br ^bb83(%21 : i32)
    ^bb83(%358: i32):  // 2 preds: ^bb82, ^bb89
      %359 = llvm.icmp "slt" %358, %40 : i32
      llvm.cond_br %359, ^bb84, ^bb90 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
      llvm.br ^bb85(%21 : i32)
    ^bb85(%360: i32):  // 2 preds: ^bb84, ^bb88
      %361 = llvm.icmp "slt" %360, %40 : i32
      llvm.cond_br %361, ^bb86, ^bb89 {llvm.loop_annotation = #loop_annotation}
    ^bb86:  // pred: ^bb85
      %362 = llvm.inttoptr %216 : i32 to !llvm.ptr<6>
      %363 = nvvm.elect.sync -> i1
      llvm.cond_br %363, ^bb87, ^bb88
    ^bb87:  // pred: ^bb86
    ...
    ^bb88:  // 2 preds: ^bb86, ^bb87
      ...
      llvm.br ^bb85(%364 : i32)
    ^bb89:  // pred: ^bb85
      %365 = llvm.add %358, %40 : i32
      llvm.br ^bb83(%365 : i32)
    ^bb90:  // pred: ^bb83
    ...
    ^bb91:  // pred: ^bb81
      ...
      llvm.br ^bb92(%21 : i32)
    ^bb92(%375: i32):  // 2 preds: ^bb91, ^bb101
      %376 = llvm.icmp "slt" %375, %40 : i32
      llvm.cond_br %376, ^bb93, ^bb102 {llvm.loop_annotation = #loop_annotation}
    ^bb93:  // pred: ^bb92
      llvm.br ^bb94(%21 : i32)
    ^bb94(%377: i32):  // 2 preds: ^bb93, ^bb100
      %378 = llvm.icmp "slt" %377, %40 : i32
      llvm.cond_br %378, ^bb95, ^bb101 {llvm.loop_annotation = #loop_annotation}
    ^bb95:  // pred: ^bb94
      llvm.br ^bb96(%21 : i32)
    ^bb96(%379: i32):  // 2 preds: ^bb95, ^bb99
      %380 = llvm.icmp "slt" %379, %40 : i32
      llvm.cond_br %380, ^bb97, ^bb100 {llvm.loop_annotation = #loop_annotation}
    ^bb97:  // pred: ^bb96
      %381 = llvm.inttoptr %216 : i32 to !llvm.ptr<6>
      %382 = nvvm.elect.sync -> i1
      llvm.cond_br %382, ^bb98, ^bb99
    ^bb98:  // pred: ^bb97
    ...
    ^bb99:  // 2 preds: ^bb97, ^bb98
      ...
      llvm.br ^bb96(%383 : i32)
    ^bb100:  // pred: ^bb96
      %384 = llvm.add %377, %40 : i32
      llvm.br ^bb94(%384 : i32)
    ^bb101:  // pred: ^bb94
      %385 = llvm.add %375, %40 : i32
      llvm.br ^bb92(%385 : i32)
    ^bb102:  // pred: ^bb92
    ...
    ^bb103(%394: i32):  // 2 preds: ^bb102, ^bb112
      %395 = llvm.icmp "slt" %394, %40 : i32
      llvm.cond_br %395, ^bb104, ^bb113 {llvm.loop_annotation = #loop_annotation}
    ^bb104:  // pred: ^bb103
      llvm.br ^bb105(%21 : i32)
    ^bb105(%396: i32):  // 2 preds: ^bb104, ^bb111
      %397 = llvm.icmp "slt" %396, %40 : i32
      llvm.cond_br %397, ^bb106, ^bb112 {llvm.loop_annotation = #loop_annotation}
    ^bb106:  // pred: ^bb105
      llvm.br ^bb107(%21 : i32)
    ^bb107(%398: i32):  // 2 preds: ^bb106, ^bb110
      %399 = llvm.icmp "slt" %398, %40 : i32
      llvm.cond_br %399, ^bb108, ^bb111 {llvm.loop_annotation = #loop_annotation}
    ^bb108:  // pred: ^bb107
    ...
    ^bb110:  // 2 preds: ^bb108, ^bb109
      ...
      llvm.br ^bb107(%402 : i32)
    ^bb111:  // pred: ^bb107
      %403 = llvm.add %396, %40 : i32
      llvm.br ^bb105(%403 : i32)
    ^bb112:  // pred: ^bb105
    ...
    ^bb115:  // 2 preds: ^bb113, ^bb114
      llvm.br ^bb117(%314, %316, %405 : i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb116:  // pred: ^bb64
      llvm.br ^bb117(%273, %274, %275 : i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb117(%408: i32, %409: i32, %410: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb115, ^bb116
      llvm.br ^bb118
    ^bb118:  // pred: ^bb117
      %411 = llvm.add %269, %40 : i32
      llvm.br ^bb41(%411, %310, %308, %309, %408, %409, %410 : i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb119:  // pred: ^bb41
      llvm.cond_br %111, ^bb120, ^bb123
    ^bb120:  // pred: ^bb119
      %412 = nvvm.elect.sync -> i1
      llvm.cond_br %412, ^bb121, ^bb122
    ^bb121:  // pred: ^bb120
    ...
    ^bb123:  // 2 preds: ^bb119, ^bb122
      llvm.br ^bb125(%229, %271, %272 : i32, i32, i32)
    ^bb124:  // pred: ^bb16
      llvm.br ^bb125(%40, %21, %40 : i32, i32, i32)
    ^bb125(%413: i32, %414: i32, %415: i32):  // 2 preds: ^bb123, ^bb124
      llvm.br ^bb126
    ^bb126:  // pred: ^bb125
    ...
    ^bb129(%416: i32):  // 2 preds: ^bb128, ^bb136
      %417 = llvm.icmp "slt" %416, %37 : i32
      llvm.cond_br %417, ^bb130, ^bb137
    ^bb130:  // pred: ^bb129
      %418 = llvm.srem %416, %37 : i32
      %419 = llvm.mul %418, %39 : i32
      %420 = llvm.add %219, %419 : i32
      llvm.br ^bb131(%21 : i32)
    ^bb131(%421: i32):  // 2 preds: ^bb130, ^bb132
      %422 = llvm.icmp "slt" %421, %40 : i32
      llvm.cond_br %422, ^bb132, ^bb133 {llvm.loop_annotation = #loop_annotation}
    ^bb132:  // pred: ^bb131
    ...
    ^bb134(%429: i32):  // 2 preds: ^bb133, ^bb135
      %430 = llvm.icmp "slt" %429, %37 : i32
      llvm.cond_br %430, ^bb135, ^bb136 {llvm.loop_annotation = #loop_annotation}
    ^bb135:  // pred: ^bb134
      ...
      llvm.br ^bb134(%435 : i32)
    ^bb136:  // pred: ^bb134
      %436 = llvm.add %416, %40 : i32
      llvm.br ^bb129(%436 : i32)
    ^bb137:  // pred: ^bb129
    ...
    ^bb138:  // pred: ^bb137
      ...
      llvm.cond_br %439, ^bb139, ^bb140
    ^bb139:  // pred: ^bb138
      %441 = llvm.xor %415, %40 : i32
      llvm.br ^bb141(%441 : i32)
    ^bb140:  // pred: ^bb138
      llvm.br ^bb141(%415 : i32)
    ^bb141(%442: i32):  // 2 preds: ^bb139, ^bb140
      llvm.br ^bb142
    ^bb142:  // pred: ^bb141
      %443 = llvm.add %440, %40 : i32
      %444 = llvm.icmp "eq" %443, %30 : i32
      %445 = llvm.select %444, %21, %443 : i1, i32
      llvm.cond_br %444, ^bb143, ^bb144
    ^bb143:  // pred: ^bb142
      %446 = llvm.xor %442, %40 : i32
      llvm.br ^bb145(%446 : i32)
    ^bb144:  // pred: ^bb142
      llvm.br ^bb145(%442 : i32)
    ^bb145(%447: i32):  // 2 preds: ^bb143, ^bb144
      llvm.br ^bb146
    ^bb146:  // pred: ^bb145
      %448 = llvm.add %445, %40 : i32
      %449 = llvm.icmp "eq" %448, %30 : i32
      %450 = llvm.select %449, %21, %448 : i1, i32
      llvm.cond_br %449, ^bb147, ^bb148
    ^bb147:  // pred: ^bb146
      %451 = llvm.xor %447, %40 : i32
      llvm.br ^bb149(%451 : i32)
    ^bb148:  // pred: ^bb146
      llvm.br ^bb149(%447 : i32)
    ^bb149(%452: i32):  // 2 preds: ^bb147, ^bb148
      llvm.br ^bb150
    ^bb150:  // pred: ^bb149
      %453 = llvm.add %450, %40 : i32
      %454 = llvm.icmp "eq" %453, %30 : i32
      %455 = llvm.select %454, %21, %453 : i1, i32
      llvm.cond_br %454, ^bb151, ^bb152
    ^bb151:  // pred: ^bb150
      %456 = llvm.xor %452, %40 : i32
      llvm.br ^bb153(%456 : i32)
    ^bb152:  // pred: ^bb150
      llvm.br ^bb153(%452 : i32)
    ^bb153(%457: i32):  // 2 preds: ^bb151, ^bb152
      llvm.br ^bb154
    ^bb154:  // pred: ^bb153
      %458 = llvm.add %455, %40 : i32
      %459 = llvm.icmp "eq" %458, %30 : i32
      %460 = llvm.select %459, %21, %458 : i1, i32
      llvm.cond_br %459, ^bb155, ^bb156
    ^bb155:  // pred: ^bb154
      %461 = llvm.xor %457, %40 : i32
      llvm.br ^bb157(%461 : i32)
    ^bb156:  // pred: ^bb154
      llvm.br ^bb157(%457 : i32)
    ^bb157(%462: i32):  // 2 preds: ^bb155, ^bb156
      llvm.br ^bb158
    ^bb158:  // pred: ^bb157
      %463 = llvm.add %460, %40 : i32
      %464 = llvm.icmp "eq" %463, %30 : i32
      %465 = llvm.select %464, %21, %463 : i1, i32
      llvm.cond_br %464, ^bb159, ^bb160
    ^bb159:  // pred: ^bb158
      %466 = llvm.xor %462, %40 : i32
      llvm.br ^bb161(%466 : i32)
    ^bb160:  // pred: ^bb158
      llvm.br ^bb161(%462 : i32)
    ^bb161(%467: i32):  // 2 preds: ^bb159, ^bb160
      llvm.br ^bb162
    ^bb162:  // pred: ^bb161
      ...
      llvm.cond_br %111, ^bb163, ^bb166
    ^bb163:  // pred: ^bb162
      %469 = nvvm.elect.sync -> i1
      llvm.cond_br %469, ^bb164, ^bb165
    ^bb164:  // pred: ^bb163
    ...
    ^bb166:  // 2 preds: ^bb162, ^bb165
      llvm.cond_br %111, ^bb167, ^bb170
    ^bb167:  // pred: ^bb166
      %471 = llvm.icmp "eq" %101, %21 : i32
      llvm.cond_br %471, ^bb168, ^bb169
    ^bb168:  // pred: ^bb167
