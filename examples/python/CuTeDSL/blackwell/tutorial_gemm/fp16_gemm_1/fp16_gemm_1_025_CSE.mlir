...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb18:  // pred: ^bb17
      nvvm.mbarrier.try_wait.parity.shared %111, %39, %28 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb19
    ...
    ^bb21:  // pred: ^bb20
      ...
      nvvm.mbarrier.try_wait.parity.shared %238, %235, %28 : !llvm.ptr<3>, i32, i32
    ...
    ^bb41(%267: i32, %268: i32, %269: i32, %270: i32, %271: i32, %272: i32, %273: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb40, ^bb118
      %274 = llvm.icmp "slt" %267, %152 : i32
      llvm.cond_br %274, ^bb42, ^bb119
    ^bb42:  // pred: ^bb41
      %275 = llvm.add %267, %232 : i32
      %276 = llvm.icmp "ult" %275, %152 : i32
      llvm.cond_br %276, ^bb43, ^bb62
    ^bb43:  // pred: ^bb42
      %277 = llvm.getelementptr %92[%269] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %277, %270, %28 : !llvm.ptr<3>, i32, i32
    ...
    ^bb57(%298: i32):  // 2 preds: ^bb56, ^bb60
      ...
      llvm.cond_br %299, ^bb58, ^bb61 {llvm.loop_annotation = #loop_annotation}
    ^bb58:  // pred: ^bb57
    ...
    ^bb61:  // pred: ^bb57
      llvm.br ^bb63(%283, %285, %281 : i32, i32, i32)
    ^bb62:  // pred: ^bb42
      llvm.br ^bb63(%269, %270, %268 : i32, i32, i32)
    ^bb63(%305: i32, %306: i32, %307: i32):  // 2 preds: ^bb61, ^bb62
      llvm.br ^bb64
    ^bb64:  // pred: ^bb63
      llvm.cond_br %110, ^bb65, ^bb116
    ^bb65:  // pred: ^bb64
      %308 = llvm.getelementptr %12[%271] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %308, %272, %28 : !llvm.ptr<3>, i32, i32
      %309 = llvm.add %271, %39 : i32
      %310 = llvm.icmp "eq" %309, %29 : i32
      %311 = llvm.select %310, %20, %309 : i1, i32
      llvm.cond_br %310, ^bb66, ^bb67
    ^bb66:  // pred: ^bb65
      %312 = llvm.xor %272, %39 : i32
      llvm.br ^bb68(%312 : i32)
    ^bb67:  // pred: ^bb65
      llvm.br ^bb68(%272 : i32)
    ^bb68(%313: i32):  // 2 preds: ^bb66, ^bb67
      llvm.br ^bb69
    ^bb69:  // pred: ^bb68
      ...
      llvm.br ^bb70(%20 : i32)
    ^bb70(%334: i32):  // 2 preds: ^bb69, ^bb79
      %335 = llvm.icmp "slt" %334, %39 : i32
      llvm.cond_br %335, ^bb71, ^bb80 {llvm.loop_annotation = #loop_annotation}
    ^bb71:  // pred: ^bb70
      llvm.br ^bb72(%20 : i32)
    ^bb72(%336: i32):  // 2 preds: ^bb71, ^bb78
      %337 = llvm.icmp "slt" %336, %39 : i32
      llvm.cond_br %337, ^bb73, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb73:  // pred: ^bb72
      llvm.br ^bb74(%20 : i32)
    ^bb74(%338: i32):  // 2 preds: ^bb73, ^bb77
      %339 = llvm.icmp "slt" %338, %39 : i32
      llvm.cond_br %339, ^bb75, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb75:  // pred: ^bb74
    ...
    ^bb77:  // 2 preds: ^bb75, ^bb76
      ...
      llvm.br ^bb74(%342 : i32)
    ^bb78:  // pred: ^bb74
      %343 = llvm.add %336, %39 : i32
      llvm.br ^bb72(%343 : i32)
    ^bb79:  // pred: ^bb72
      %344 = llvm.add %334, %39 : i32
      llvm.br ^bb70(%344 : i32)
    ^bb80:  // pred: ^bb70
      ...
      llvm.br ^bb81(%20 : i32)
    ^bb81(%353: i32):  // 2 preds: ^bb80, ^bb90
      %354 = llvm.icmp "slt" %353, %39 : i32
      llvm.cond_br %354, ^bb82, ^bb91 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
      llvm.br ^bb83(%20 : i32)
    ^bb83(%355: i32):  // 2 preds: ^bb82, ^bb89
      %356 = llvm.icmp "slt" %355, %39 : i32
      llvm.cond_br %356, ^bb84, ^bb90 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
      llvm.br ^bb85(%20 : i32)
    ^bb85(%357: i32):  // 2 preds: ^bb84, ^bb88
      %358 = llvm.icmp "slt" %357, %39 : i32
      llvm.cond_br %358, ^bb86, ^bb89 {llvm.loop_annotation = #loop_annotation}
    ^bb86:  // pred: ^bb85
      %359 = llvm.inttoptr %215 : i32 to !llvm.ptr<6>
      %360 = nvvm.elect.sync -> i1
      llvm.cond_br %360, ^bb87, ^bb88
    ^bb87:  // pred: ^bb86
    ...
    ^bb88:  // 2 preds: ^bb86, ^bb87
      ...
      llvm.br ^bb85(%361 : i32)
    ^bb89:  // pred: ^bb85
      %362 = llvm.add %355, %39 : i32
      llvm.br ^bb83(%362 : i32)
    ^bb90:  // pred: ^bb83
    ...
    ^bb91:  // pred: ^bb81
      ...
      llvm.br ^bb92(%20 : i32)
    ^bb92(%372: i32):  // 2 preds: ^bb91, ^bb101
      %373 = llvm.icmp "slt" %372, %39 : i32
      llvm.cond_br %373, ^bb93, ^bb102 {llvm.loop_annotation = #loop_annotation}
    ^bb93:  // pred: ^bb92
      llvm.br ^bb94(%20 : i32)
    ^bb94(%374: i32):  // 2 preds: ^bb93, ^bb100
      %375 = llvm.icmp "slt" %374, %39 : i32
      llvm.cond_br %375, ^bb95, ^bb101 {llvm.loop_annotation = #loop_annotation}
    ^bb95:  // pred: ^bb94
      llvm.br ^bb96(%20 : i32)
    ^bb96(%376: i32):  // 2 preds: ^bb95, ^bb99
      %377 = llvm.icmp "slt" %376, %39 : i32
      llvm.cond_br %377, ^bb97, ^bb100 {llvm.loop_annotation = #loop_annotation}
    ^bb97:  // pred: ^bb96
      %378 = llvm.inttoptr %215 : i32 to !llvm.ptr<6>
      %379 = nvvm.elect.sync -> i1
      llvm.cond_br %379, ^bb98, ^bb99
    ^bb98:  // pred: ^bb97
    ...
    ^bb99:  // 2 preds: ^bb97, ^bb98
      ...
      llvm.br ^bb96(%380 : i32)
    ^bb100:  // pred: ^bb96
      %381 = llvm.add %374, %39 : i32
      llvm.br ^bb94(%381 : i32)
    ^bb101:  // pred: ^bb94
      %382 = llvm.add %372, %39 : i32
      llvm.br ^bb92(%382 : i32)
    ^bb102:  // pred: ^bb92
    ...
    ^bb103(%391: i32):  // 2 preds: ^bb102, ^bb112
      %392 = llvm.icmp "slt" %391, %39 : i32
      llvm.cond_br %392, ^bb104, ^bb113 {llvm.loop_annotation = #loop_annotation}
    ^bb104:  // pred: ^bb103
      llvm.br ^bb105(%20 : i32)
    ^bb105(%393: i32):  // 2 preds: ^bb104, ^bb111
      %394 = llvm.icmp "slt" %393, %39 : i32
      llvm.cond_br %394, ^bb106, ^bb112 {llvm.loop_annotation = #loop_annotation}
    ^bb106:  // pred: ^bb105
      llvm.br ^bb107(%20 : i32)
    ^bb107(%395: i32):  // 2 preds: ^bb106, ^bb110
      %396 = llvm.icmp "slt" %395, %39 : i32
      llvm.cond_br %396, ^bb108, ^bb111 {llvm.loop_annotation = #loop_annotation}
    ^bb108:  // pred: ^bb107
      %397 = llvm.inttoptr %215 : i32 to !llvm.ptr<6>
      %398 = nvvm.elect.sync -> i1
      llvm.cond_br %398, ^bb109, ^bb110
    ^bb109:  // pred: ^bb108
    ...
    ^bb115:  // 2 preds: ^bb113, ^bb114
      llvm.br ^bb117(%311, %313, %402 : i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb116:  // pred: ^bb64
      llvm.br ^bb117(%271, %272, %273 : i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb117(%405: i32, %406: i32, %407: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb115, ^bb116
      llvm.br ^bb118
    ^bb118:  // pred: ^bb117
      %408 = llvm.add %267, %39 : i32
      llvm.br ^bb41(%408, %307, %305, %306, %405, %406, %407 : i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb119:  // pred: ^bb41
      llvm.cond_br %110, ^bb120, ^bb123
    ^bb120:  // pred: ^bb119
      %409 = nvvm.elect.sync -> i1
      llvm.cond_br %409, ^bb121, ^bb122
    ^bb121:  // pred: ^bb120
    ...
    ^bb123:  // 2 preds: ^bb119, ^bb122
      llvm.br ^bb125(%228, %269, %270 : i32, i32, i32)
    ^bb124:  // pred: ^bb16
      llvm.br ^bb125(%39, %20, %39 : i32, i32, i32)
    ^bb125(%410: i32, %411: i32, %412: i32):  // 2 preds: ^bb123, ^bb124
      llvm.br ^bb126
    ^bb126:  // pred: ^bb125
    ...
    ^bb129(%413: i32):  // 2 preds: ^bb128, ^bb136
      %414 = llvm.icmp "slt" %413, %36 : i32
      llvm.cond_br %414, ^bb130, ^bb137
    ^bb130:  // pred: ^bb129
      %415 = llvm.srem %413, %36 : i32
      %416 = llvm.mul %415, %38 : i32
      %417 = llvm.add %218, %416 : i32
      llvm.br ^bb131(%20 : i32)
    ^bb131(%418: i32):  // 2 preds: ^bb130, ^bb132
      %419 = llvm.icmp "slt" %418, %39 : i32
      llvm.cond_br %419, ^bb132, ^bb133 {llvm.loop_annotation = #loop_annotation}
    ^bb132:  // pred: ^bb131
    ...
    ^bb134(%426: i32):  // 2 preds: ^bb133, ^bb135
      %427 = llvm.icmp "slt" %426, %10 : i32
      llvm.cond_br %427, ^bb135, ^bb136 {llvm.loop_annotation = #loop_annotation}
    ^bb135:  // pred: ^bb134
      ...
      llvm.br ^bb134(%432 : i32)
    ^bb136:  // pred: ^bb134
      %433 = llvm.add %413, %39 : i32
      llvm.br ^bb129(%433 : i32)
    ^bb137:  // pred: ^bb129
    ...
    ^bb138:  // pred: ^bb137
      ...
      llvm.cond_br %436, ^bb139, ^bb140
    ^bb139:  // pred: ^bb138
      %438 = llvm.xor %412, %39 : i32
      llvm.br ^bb141(%438 : i32)
    ^bb140:  // pred: ^bb138
      llvm.br ^bb141(%412 : i32)
    ^bb141(%439: i32):  // 2 preds: ^bb139, ^bb140
      llvm.br ^bb142
    ^bb142:  // pred: ^bb141
      %440 = llvm.add %437, %39 : i32
      %441 = llvm.icmp "eq" %440, %29 : i32
      %442 = llvm.select %441, %20, %440 : i1, i32
      llvm.cond_br %441, ^bb143, ^bb144
    ^bb143:  // pred: ^bb142
      %443 = llvm.xor %439, %39 : i32
      llvm.br ^bb145(%443 : i32)
    ^bb144:  // pred: ^bb142
      llvm.br ^bb145(%439 : i32)
    ^bb145(%444: i32):  // 2 preds: ^bb143, ^bb144
      llvm.br ^bb146
    ^bb146:  // pred: ^bb145
      %445 = llvm.add %442, %39 : i32
      %446 = llvm.icmp "eq" %445, %29 : i32
      %447 = llvm.select %446, %20, %445 : i1, i32
      llvm.cond_br %446, ^bb147, ^bb148
    ^bb147:  // pred: ^bb146
      %448 = llvm.xor %444, %39 : i32
      llvm.br ^bb149(%448 : i32)
    ^bb148:  // pred: ^bb146
      llvm.br ^bb149(%444 : i32)
    ^bb149(%449: i32):  // 2 preds: ^bb147, ^bb148
      llvm.br ^bb150
    ^bb150:  // pred: ^bb149
      %450 = llvm.add %447, %39 : i32
      %451 = llvm.icmp "eq" %450, %29 : i32
      %452 = llvm.select %451, %20, %450 : i1, i32
      llvm.cond_br %451, ^bb151, ^bb152
    ^bb151:  // pred: ^bb150
      %453 = llvm.xor %449, %39 : i32
      llvm.br ^bb153(%453 : i32)
    ^bb152:  // pred: ^bb150
      llvm.br ^bb153(%449 : i32)
    ^bb153(%454: i32):  // 2 preds: ^bb151, ^bb152
      llvm.br ^bb154
    ^bb154:  // pred: ^bb153
      %455 = llvm.add %452, %39 : i32
      %456 = llvm.icmp "eq" %455, %29 : i32
      %457 = llvm.select %456, %20, %455 : i1, i32
      llvm.cond_br %456, ^bb155, ^bb156
    ^bb155:  // pred: ^bb154
      %458 = llvm.xor %454, %39 : i32
      llvm.br ^bb157(%458 : i32)
    ^bb156:  // pred: ^bb154
      llvm.br ^bb157(%454 : i32)
    ^bb157(%459: i32):  // 2 preds: ^bb155, ^bb156
      llvm.br ^bb158
    ^bb158:  // pred: ^bb157
      %460 = llvm.add %457, %39 : i32
      %461 = llvm.icmp "eq" %460, %29 : i32
      %462 = llvm.select %461, %20, %460 : i1, i32
      llvm.cond_br %461, ^bb159, ^bb160
    ^bb159:  // pred: ^bb158
      %463 = llvm.xor %459, %39 : i32
      llvm.br ^bb161(%463 : i32)
    ^bb160:  // pred: ^bb158
      llvm.br ^bb161(%459 : i32)
    ^bb161(%464: i32):  // 2 preds: ^bb159, ^bb160
      llvm.br ^bb162
    ^bb162:  // pred: ^bb161
      %465 = llvm.getelementptr %92[%462] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %465, %464, %28 : !llvm.ptr<3>, i32, i32
      llvm.cond_br %110, ^bb163, ^bb166
    ^bb163:  // pred: ^bb162
      %466 = nvvm.elect.sync -> i1
      llvm.cond_br %466, ^bb164, ^bb165
    ^bb164:  // pred: ^bb163
    ...
    ^bb166:  // 2 preds: ^bb162, ^bb165
      llvm.cond_br %110, ^bb167, ^bb170
    ^bb167:  // pred: ^bb166
      %468 = llvm.icmp "eq" %100, %20 : i32
      llvm.cond_br %468, ^bb168, ^bb169
    ^bb168:  // pred: ^bb167
      nvvm.mbarrier.try_wait.parity.shared %111, %410, %28 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb169
