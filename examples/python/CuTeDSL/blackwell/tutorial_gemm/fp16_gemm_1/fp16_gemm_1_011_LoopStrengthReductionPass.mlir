...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK21111000_PermutationMNK____MMAAtom_ThrID21_ShapeMNK25625616_TVLayoutA2128161281256_TVLayoutB2128161281256_TVLayoutC21282561281256_CopyAtom_ThrI_0(%arg0: !mma_f16_f16_f32_256x256x16_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg2: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg4: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg5: !memref_gmem_f16_) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %42 = cute.get_flat_coord(%41, %26) : (i32, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.coord<"(?,0,0,0)">
      %e0, %e1, %e2, %e3 = cute.get_leaves(%42) : !cute.coord<"(?,0,0,0)">
      %itup = cute.to_int_tuple(%e0) : !cute.coord<"?"> to !cute.int_tuple<"?">
      %43 = arith.remsi %39, %c2_i32 : i32
      %44 = arith.floordivsi %39, %c2_i32 : i32
      ...
      %ptr_4 = cute.add_offset(%49, %21) : (!cute.ptr<i8, smem, align<128>>, !cute.int_tuple<"114688">) -> !cute.ptr<i8, smem, align<128>>
      %iter_5 = cute.recast_iter(%49) : !cute.ptr<i8, smem, align<128>> to !cute.ptr<f16, smem, align<128>, S<3,4,3>>
      %iter_6 = cute.recast_iter(%ptr_4) : !cute.ptr<i8, smem, align<128>> to !cute.ptr<f16, smem, align<128>, S<3,4,3>>
      %50 = arith.cmpi eq, %38, %c0_i32 : i32
      scf.if %50 {
      ...
      scf.if %50 {
        %127 = builtin.unrealized_conversion_cast %iter_7 : !cute.ptr<i64, smem, align<1024>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %127, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_95 = cute.add_offset(%iter_7, %20) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"1">) -> !cute.ptr<i64, smem>
        ...
        %ptr_96 = cute.add_offset(%iter_7, %19) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"2">) -> !cute.ptr<i64, smem, align<16>>
        %129 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %129, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_97 = cute.add_offset(%iter_7, %18) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"3">) -> !cute.ptr<i64, smem>
        ...
        %ptr_98 = cute.add_offset(%iter_7, %17) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"4">) -> !cute.ptr<i64, smem, align<32>>
        %131 = builtin.unrealized_conversion_cast %ptr_98 : !cute.ptr<i64, smem, align<32>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %131, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_99 = cute.add_offset(%iter_7, %16) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"5">) -> !cute.ptr<i64, smem>
        %132 = builtin.unrealized_conversion_cast %ptr_99 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %132, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_100 = cute.add_offset(%iter_7, %15) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"6">) -> !cute.ptr<i64, smem, align<16>>
        %133 = builtin.unrealized_conversion_cast %ptr_100 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
      ...
      scf.if %50 {
        %127 = builtin.unrealized_conversion_cast %ptr_8 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %127, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %128 = builtin.unrealized_conversion_cast %dyn_97 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %128, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %129 = builtin.unrealized_conversion_cast %ptr_99 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %129, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %130 = builtin.unrealized_conversion_cast %dyn_102 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %130, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %131 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %131, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %132 = builtin.unrealized_conversion_cast %dyn_107 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %132, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %133 = builtin.unrealized_conversion_cast %ptr_109 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %133, %c1_i32 : !llvm.ptr<3>, i32
      }
      %51 = cute_nvgpu.arch.make_warp_uniform(%41) : i32
      %52 = cute.get_flat_coord(%51, %26) : (i32, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.coord<"(?,0,0,0)">
      %e0_9, %e1_10, %e2_11, %e3_12 = cute.get_leaves(%52) : !cute.coord<"(?,0,0,0)">
      %itup_13 = cute.to_int_tuple(%e0_9) : !cute.coord<"?"> to !cute.int_tuple<"?">
      %53 = cute.get_scalars(%itup_13) : !cute.int_tuple<"?">
      ...
      %54 = cute.get_scalars(%e0_14) : !cute.int_tuple<"?">
      %55 = arith.shli %c1_i32, %54 : i32
      %56 = arith.trunci %55 : i32 to i16
      ...
      %57 = cute.get_scalars(%e0_17) : !cute.int_tuple<"?">
      %58 = arith.shli %c1_i32, %57 : i32
      %59 = arith.trunci %58 : i32 to i16
      %60 = arith.xori %53, %c1_i32 : i32
      %coord_18 = cute.make_coord(%60) : (i32) -> !cute.coord<"(?,0,_,0)">
      ...
      %61 = cute.get_scalars(%e0_20) : !cute.int_tuple<"?">
      %62 = arith.shli %c1_i32, %61 : i32
      %63 = arith.trunci %62 : i32 to i16
      %coord_21 = cute.make_coord(%60) : (i32) -> !cute.coord<"(?,_,0,0)">
      ...
      %64 = cute.get_scalars(%e0_23) : !cute.int_tuple<"?">
      %65 = arith.shli %c1_i32, %64 : i32
      %66 = arith.trunci %65 : i32 to i16
      %67 = arith.ori %56, %59 : i16
      %68 = arith.ori %67, %63 : i16
      %69 = arith.ori %68, %66 : i16
      %70 = arith.cmpi eq, %43, %c0_i32 : i32
      nvvm.fence.mbarrier.init
      nvvm.cluster.arrive.relaxed
      nvvm.cluster.wait
      %iter_24 = cute.recast_iter(%ptr_0) : !cute.ptr<i8, smem, align<16>> to !cute.ptr<i64, smem, align<16>>
      scf.if %50 {
        %127 = builtin.unrealized_conversion_cast %iter_24 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %127, %c1_i32 : !llvm.ptr<3>, i32
      }
      ...
      scf.if %50 {
        ...
        nvvm.mbarrier.init.shared %127, %c256_i32 : !llvm.ptr<3>, i32
      }
      %71 = arith.floordivsi %51, %c2_i32 : i32
      %72 = arith.muli %71, %c2_i32 : i32
      nvvm.fence.mbarrier.init
      nvvm.cluster.arrive.relaxed
      nvvm.cluster.wait
      %coord_26 = cute.make_coord(%44, %40) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %73:2 = cute.get_scalars(%coord_26) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_27 = cute.make_coord(%73#0) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %74:2 = cute.get_scalars(%lay) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %75 = arith.ceildivsi %74#0, %c256_i32 : i32
      %76 = arith.ceildivsi %74#1, %c64_i32 : i32
      %shape = cute.make_shape(%75, %76) : (i32, i32) -> !cute.shape<"((256,64),(?,?))">
      %lay_28 = cute.make_layout(%shape, %13) : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %77:2 = cute.get_scalars(%lay_28) <{only_dynamic}> : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %shape_29 = cute.make_shape(%77#1) : (i32) -> !cute.shape<"(256,64,?)">
      ...
      %coord_32 = cute.make_coord(%73#1) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay_33 = cute.get_layout(%arg4) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %78:2 = cute.get_scalars(%lay_33) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %79 = arith.ceildivsi %78#0, %c256_i32 : i32
      %80 = arith.ceildivsi %78#1, %c64_i32 : i32
      %shape_34 = cute.make_shape(%79, %80) : (i32, i32) -> !cute.shape<"((256,64),(?,?))">
      %lay_35 = cute.make_layout(%shape_34, %13) : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %81:2 = cute.get_scalars(%lay_35) <{only_dynamic}> : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %shape_36 = cute.make_shape(%81#1) : (i32) -> !cute.shape<"(256,64,?)">
      %lay_37 = cute.make_layout(%shape_36, %12) : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %idx_38 = cute.crd2idx(%coord_32, %lay_35) : (!cute.coord<"((_,_),(?,_))">, !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">) -> !cute.int_tuple<"(0,?{div=256})">
      %tup_39 = cute.add_offset(%11, %idx_38) : (!cute.int_tuple<"(0,0)">, !cute.int_tuple<"(0,?{div=256})">) -> !cute.int_tuple<"(0,?{div=256})">
      %coord_40 = cute.make_coord(%73#0, %73#1) : (i32, i32) -> !cute.coord<"((_,_),(?,?))">
      %lay_41 = cute.get_layout(%arg5) : !memref_gmem_f16_
      %82:3 = cute.get_scalars(%lay_41) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(?{i64 div=8192},1)">
      %83 = arith.ceildivsi %82#0, %c256_i32 : i32
      %84 = arith.muli %82#2, %c256_i64 : i64
      %85 = arith.ceildivsi %82#1, %c256_i32 : i32
      %shape_42 = cute.make_shape(%83, %85) : (i32, i32) -> !cute.shape<"((256,256),(?,?))">
      %iv_43 = cute.assume(%82#2) : (i64) -> !cute.i64<divby 8192>
      %iv_44 = cute.assume(%84) : (i64) -> !cute.i64<divby 2097152>
      ...
      %86:4 = cute.get_scalars(%lay_45) <{only_dynamic}> : !cute.layout<"((256,256),(?,?)):((?{i64 div=8192},1),(?{i64 div=2097152},256))">
      %iv_46 = cute.assume(%86#2) : (i64) -> !cute.i64<divby 8192>
      %stride_47 = cute.make_stride(%iv_46) : (!cute.i64<divby 8192>) -> !cute.stride<"(?{i64 div=8192},1)">
      %lay_48 = cute.make_layout(%10, %stride_47) : !cute.layout<"(256,256):(?{i64 div=8192},1)">
      ...
      %coord_52 = cute.make_coord(%43) : (i32) -> !cute.coord<"?">
      %87 = cute.get_scalars(%lay_30) <{only_dynamic}> : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %88 = cute.get_scalars(%coord_52) <{only_dynamic}> : !cute.coord<"?">
      %89 = arith.remsi %88, %c2_i32 : i32
      %90 = arith.remsi %89, %c2_i32 : i32
      %91 = arith.muli %90, %c128_i32 : i32
      %iv_53 = cute.assume(%91) : (i32) -> !cute.i32<divby 128>
      ...
      %shape_55 = cute.make_shape(%87) : (i32) -> !cute.shape<"((128,16),1,4,?)">
      %lay_56 = cute.make_layout(%shape_55, %9) : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %92 = cute.get_scalars(%lay_37) <{only_dynamic}> : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %tup_57 = cute.add_offset(%tup_39, %int_tuple) : (!cute.int_tuple<"(0,?{div=256})">, !cute.int_tuple<"(0,?{div=128})">) -> !cute.int_tuple<"(0,?{div=128})">
      %shape_58 = cute.make_shape(%92) : (i32) -> !cute.shape<"((128,16),1,4,?)">
      %lay_59 = cute.make_layout(%shape_58, %9) : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %93 = cute.get_scalars(%lay_48) <{only_dynamic}> : !cute.layout<"(256,256):(?{i64 div=8192},1)">
      %94 = arith.muli %93, %c128_i64 : i64
      %95 = arith.extsi %90 : i32 to i64
      %96 = arith.muli %95, %94 : i64
      %iv_60 = cute.assume(%96) : (i64) -> !cute.i64<divby 1048576>
      ...
      %iv_63 = cute.assume(%93) : (i64) -> !cute.i64<divby 8192>
      %stride_64 = cute.make_stride(%iv_63) : (!cute.i64<divby 8192>) -> !cute.stride<"((?{i64 div=8192},1),0,0)">
      %lay_65 = cute.make_layout(%8, %stride_64) : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      ...
      %97 = cute.get_scalars(%lay_56) <{only_dynamic}> : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_67 = cute.make_shape(%97) : (i32) -> !cute.shape<"(((128,16),1,4),?)">
      %lay_68 = cute.make_layout(%shape_67, %7) : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %98 = cute.get_scalars(%lay_68) <{only_dynamic}> : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_69 = cute.make_shape(%98) : (i32) -> !cute.shape<"(((64,128),1),?)">
      %lay_70 = cute.make_layout(%shape_69, %6) : !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">
      %99 = cute.get_scalars(%lay_59) <{only_dynamic}> : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_71 = cute.make_shape(%99) : (i32) -> !cute.shape<"(((128,16),1,4),?)">
      %lay_72 = cute.make_layout(%shape_71, %7) : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %100 = cute.get_scalars(%lay_72) <{only_dynamic}> : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_73 = cute.make_shape(%100) : (i32) -> !cute.shape<"(((64,128),1),?)">
      %lay_74 = cute.make_layout(%shape_73, %6) : !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">
      %coord_75 = cute.make_coord(%itup) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,0,_,0)">
      %idx_76 = cute.crd2idx(%coord_75, %26) : (!cute.coord<"(?,0,_,0)">, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.int_tuple<"?">
      %e0_77 = cute.get_leaves(%idx_76) : !cute.int_tuple<"?">
      %101 = cute.get_scalars(%e0_77) : !cute.int_tuple<"?">
      %102 = arith.shli %c1_i32, %101 : i32
      %103 = arith.trunci %102 : i32 to i16
      %coord_78 = cute.make_coord(%itup) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,_,0,0)">
      %idx_79 = cute.crd2idx(%coord_78, %26) : (!cute.coord<"(?,_,0,0)">, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.int_tuple<"?">
      %e0_80 = cute.get_leaves(%idx_79) : !cute.int_tuple<"?">
      %104 = cute.get_scalars(%e0_80) : !cute.int_tuple<"?">
      %105 = arith.shli %c1_i32, %104 : i32
      %106 = arith.trunci %105 : i32 to i16
      scf.if %50 {
        %127 = nvvm.elect.sync -> i1
        scf.if %127 {
          %128 = builtin.unrealized_conversion_cast %iter : !cute.ptr<i64, smem, align<128>> to !llvm.ptr<3>
          nvvm.mbarrier.init.shared %128, %c32_i32 : !llvm.ptr<3>, i32
        }
      }
      nvvm.fence.mbarrier.init
      scf.if %50 {
      ...
      %107 = cute.get_scalars(%lay_65) <{only_dynamic}> : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      %iv_81 = cute.assume(%107) : (i64) -> !cute.i64<divby 8192>
      %stride_82 = cute.make_stride(%iv_81) : (!cute.i64<divby 8192>) -> !cute.stride<"(((?{i64 div=8192},1)),((0,64),0,0))">
      %lay_83 = cute.make_layout(%5, %stride_82) : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %coord_84 = cute.make_coord(%27) : (i32) -> !cute.coord<"?">
      %108 = cute.get_scalars(%coord_84) <{only_dynamic}> : !cute.coord<"?">
      %109 = arith.divsi %108, %c32_i32 : i32
      %110 = arith.muli %109, %c2097152_i32 : i32
      %iv_85 = cute.assume(%110) : (i32) -> !cute.i32<divby 2097152>
      ...
      %111 = cute.get_scalars(%lay_83) <{only_dynamic}> : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %112 = arith.muli %111, %c32_i64 : i64
      %113 = arith.remsi %108, %c32_i32 : i32
      %114 = arith.extsi %113 : i32 to i64
      %115 = arith.muli %114, %111 : i64
      %116 = arith.extsi %109 : i32 to i64
      %117 = arith.muli %116, %112 : i64
      %118 = arith.addi %115, %117 : i64
      %iv_88 = cute.assume(%118) : (i64) -> !cute.i64<divby 8192>
      ...
      %119 = cute.get_scalars(%e0_92) : !cute.int_tuple<"?">
      %120:3 = scf.if %50 -> (i32, i32, i32) {
        %127 = arith.cmpi ne, %43, %c0_i32 : i32
        %128 = arith.extui %127 : i1 to i32
        scf.if %70 {
          %137 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %137, %c1_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        }
        %129 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %130 = cute_nvgpu.atom.set_value(%129, %103 : i16) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %131 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %132 = cute_nvgpu.atom.set_value(%131, %106 : i16) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %133 = arith.minsi %119, %c5_i32 : i32
        %134 = cute.get_scalars(%20) : !cute.int_tuple<"1">
        %135:3 = scf.for %arg6 = %c0_i32 to %133 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          %137 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %137, %arg8, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          scf.if %70 {
          ...
          %139 = arith.addi %arg9, %c1_i32 : i32
          %140 = arith.cmpi eq, %138, %c7_i32 : i32
          ...
          %idx_103 = cute.crd2idx(%coord_102, %4) : (!cute.coord<"(_,?)">, !cute.layout<"((8192,1),7):((1,0),8192)">) -> !cute.int_tuple<"?{div=8192}">
          ...
          %143 = cute_nvgpu.atom.set_value(%130, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
          %144 = cute_nvgpu.atom.get_value(%143 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
          %145 = cute_nvgpu.atom.get_value(%143 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
          %146 = cute_nvgpu.atom.get_value(%143 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
          %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%143 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
          %147:2 = cute.get_scalars(%int_tuple_106) : !cute.int_tuple<"(?{div=64},?{div=128})">
          scf.for %arg10 = %c0_i32 to %134 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_104 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %144 : !cute.ptr<smem, align<8>>, [%147#0, %147#1] : i32, i32) mask = %145 cache_policy = %146 mode = <tiled> num_cta = 2 : i32
          ...
          %148 = cute_nvgpu.atom.set_value(%132, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
          %149 = cute_nvgpu.atom.get_value(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
          %150 = cute_nvgpu.atom.get_value(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
          %151 = cute_nvgpu.atom.get_value(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
          %TMADescAddr_113 = cute_nvgpu.get_tma_desc_addr(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
          %152:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
          scf.for %arg10 = %c0_i32 to %134 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_113 : !cute.ptr<generic, align<64>>, %ptr_111 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %149 : !cute.ptr<smem, align<8>>, [%152#0, %152#1] : i32, i32) mask = %150 cache_policy = %151 mode = <tiled> num_cta = 2 : i32
          } {llvm.loop_annotation = #loop_annotation}
          scf.yield %141, %142, %139 : i32, i32, i32
        }
        %136:7 = scf.for %arg6 = %c0_i32 to %119 step %c1_i32 iter_args(%arg7 = %135#2, %arg8 = %135#0, %arg9 = %135#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_)  : i32 {
          %137 = arith.addi %arg6, %133 : i32
          %138 = arith.cmpi ult, %137, %119 : i32
          %139:3 = scf.if %138 -> (i32, i32, i32) {
            %int_tuple_95 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
            %ptr_96 = cute.add_offset(%ptr_8, %int_tuple_95) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %141 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %141, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            scf.if %70 {
              %158 = nvvm.elect.sync -> i1
              scf.if %158 {
                %ptr_114 = cute.add_offset(%iter_7, %int_tuple_95) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %159 = builtin.unrealized_conversion_cast %ptr_114 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                nvvm.mbarrier.txn %159, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
              }
            }
            %142 = arith.addi %arg8, %c1_i32 : i32
            %143 = arith.addi %arg7, %c1_i32 : i32
            %144 = arith.cmpi eq, %142, %c7_i32 : i32
            ...
            %ptr_105 = cute.add_offset(%iter_7, %int_tuple_95) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %int_tuple_106 = cute.make_int_tuple(%e0_100, %e1_101) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %147 = cute_nvgpu.atom.set_value(%130, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            %148 = cute.get_scalars(%20) : !cute.int_tuple<"1">
            %149 = cute_nvgpu.atom.get_value(%147 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %150 = cute_nvgpu.atom.get_value(%147 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
            %151 = cute_nvgpu.atom.get_value(%147 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%147 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %152:2 = cute.get_scalars(%int_tuple_106) : !cute.int_tuple<"(?{div=64},?{div=128})">
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_104 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %149 : !cute.ptr<smem, align<8>>, [%152#0, %152#1] : i32, i32) mask = %150 cache_policy = %151 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %idx_107 = cute.crd2idx(%coord_97, %lay_74) : (!cute.coord<"(_,?)">, !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">) -> !cute.int_tuple<"(?{div=64},0)">
            %tup_108 = cute.add_offset(%tup_57, %idx_107) : (!cute.int_tuple<"(0,?{div=128})">, !cute.int_tuple<"(?{div=64},0)">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %e0_109, %e1_110 = cute.get_leaves(%tup_108) : !cute.int_tuple<"(?{div=64},?{div=128})">
            %ptr_111 = cute.add_offset(%iter_6, %idx_103) : (!cute.ptr<f16, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=8192}">) -> !cute.ptr<f16, smem, align<128>, S<3,4,3>>
            %int_tuple_112 = cute.make_int_tuple(%e0_109, %e1_110) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %153 = cute_nvgpu.atom.set_value(%132, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            %154 = cute_nvgpu.atom.get_value(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %155 = cute_nvgpu.atom.get_value(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
            %156 = cute_nvgpu.atom.get_value(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr_113 = cute_nvgpu.get_tma_desc_addr(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %157:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_113 : !cute.ptr<generic, align<64>>, %ptr_111 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %154 : !cute.ptr<smem, align<8>>, [%157#0, %157#1] : i32, i32) mask = %155 cache_policy = %156 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            scf.yield %145, %146, %143 : i32, i32, i32
          } else {
            scf.yield %arg8, %arg9, %arg7 : i32, i32, i32
          }
          %140:4 = scf.if %70 -> (i32, i32, i32, !mma_f16_f16_f32_256x256x16_) {
            ...
            %141 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %141, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            %142 = arith.addi %arg11, %c1_i32 : i32
            %143 = arith.addi %arg10, %c1_i32 : i32
            %144 = arith.cmpi eq, %142, %c7_i32 : i32
            %145 = arith.select %144, %c0_i32, %142 : i32
            %146 = scf.if %144 -> (i32) {
              %189 = arith.xori %arg12, %c1_i32 : i32
              scf.yield %189 : i32
            } else {
              scf.yield %arg12 : i32
            }
            %coord_97 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,0,?)">
            %idx_98 = cute.crd2idx(%coord_97, %3) : (!cute.coord<"(_,_,0,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=1024}">
            ...
            %147 = cute.get_scalars(%20) : !cute.int_tuple<"1">
            %148 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %149 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %150 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %151 = arith.extui %148 : i1 to i32
            %152 = arith.extui %149 : i1 to i32
            %153 = arith.shli %151, %c13_i32 : i32
            %154 = arith.shli %152, %c14_i32 : i32
            %155 = arith.ori %153, %c272629776_i32 : i32
            %156 = arith.ori %155, %154 : i32
            scf.for %arg14 = %c0_i32 to %147 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %147 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %147 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_99, %tup_100, %tmem_ptr, %156, %150) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %157 = cute_nvgpu.atom.set_value(%arg13, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_101 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,1,?)">
            %idx_102 = cute.crd2idx(%coord_101, %3) : (!cute.coord<"(_,_,1,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            ...
            %158 = cute_nvgpu.atom.get_value(%157 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %159 = cute_nvgpu.atom.get_value(%157 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %160 = cute_nvgpu.atom.get_value(%157 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %161 = arith.extui %158 : i1 to i32
            %162 = arith.extui %159 : i1 to i32
            %163 = arith.shli %161, %c13_i32 : i32
            %164 = arith.shli %162, %c14_i32 : i32
            %165 = arith.ori %163, %c272629776_i32 : i32
            %166 = arith.ori %165, %164 : i32
            scf.for %arg14 = %c0_i32 to %147 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %147 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %147 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_103, %tup_104, %tmem_ptr, %166, %160) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %167 = cute_nvgpu.atom.set_value(%157, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_105 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,2,?)">
            %idx_106 = cute.crd2idx(%coord_105, %3) : (!cute.coord<"(_,_,2,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=4}">
            ...
            %168 = cute_nvgpu.atom.get_value(%167 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %169 = cute_nvgpu.atom.get_value(%167 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %170 = cute_nvgpu.atom.get_value(%167 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %171 = arith.extui %168 : i1 to i32
            %172 = arith.extui %169 : i1 to i32
            %173 = arith.shli %171, %c13_i32 : i32
            %174 = arith.shli %172, %c14_i32 : i32
            %175 = arith.ori %173, %c272629776_i32 : i32
            %176 = arith.ori %175, %174 : i32
            scf.for %arg14 = %c0_i32 to %147 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %147 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %147 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_107, %tup_108, %tmem_ptr, %176, %170) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %177 = cute_nvgpu.atom.set_value(%167, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_109 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,3,?)">
            %idx_110 = cute.crd2idx(%coord_109, %3) : (!cute.coord<"(_,_,3,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            ...
            %178 = cute_nvgpu.atom.get_value(%177 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %179 = cute_nvgpu.atom.get_value(%177 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %180 = cute_nvgpu.atom.get_value(%177 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %181 = arith.extui %178 : i1 to i32
            %182 = arith.extui %179 : i1 to i32
            %183 = arith.shli %181, %c13_i32 : i32
            %184 = arith.shli %182, %c14_i32 : i32
            %185 = arith.ori %183, %c272629776_i32 : i32
            %186 = arith.ori %185, %184 : i32
            scf.for %arg14 = %c0_i32 to %147 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %147 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %147 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_111, %tup_112, %tmem_ptr, %186, %180) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %187 = cute_nvgpu.atom.set_value(%177, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %188 = nvvm.elect.sync -> i1
            scf.if %188 {
              %ptr_113 = cute.add_offset(%ptr_8, %int_tuple_95) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %189 = builtin.unrealized_conversion_cast %ptr_113 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %189, multicast_mask = %69 {group = #nvvm.tcgen05_group<cta_2>} : !llvm.ptr<3>, i16
            }
            scf.yield %143, %145, %146, %187 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          } else {
            scf.yield %arg10, %arg11, %arg12, %arg13 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          }
          scf.yield %139#2, %139#0, %139#1, %140#0, %140#1, %140#2, %140#3 : i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_
        }
        scf.if %70 {
          %137 = nvvm.elect.sync -> i1
          scf.if %137 {
            %dyn_95 = cute.derefine(%iter_24) : !cute.ptr<i64, smem, align<16>> to !cute.ptr<i64, smem>
            %138 = builtin.unrealized_conversion_cast %dyn_95 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %138, multicast_mask = %c3_i16 {group = #nvvm.tcgen05_group<cta_2>} : !llvm.ptr<3>, i16
          }
        }
        scf.yield %128, %136#1, %136#2 : i32, i32, i32
      } else {
      ...
      %121 = builtin.unrealized_conversion_cast %dyn : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.try_wait.parity.shared %121, %c0_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      %iter_93 = cute.get_iter(%rmem) : !memref_rmem_f32_
      %122 = cute.get_scalars(%20) : !cute.int_tuple<"1">
      %123 = builtin.unrealized_conversion_cast %iter_93 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
      %iter_94 = cute.get_iter(%rmem_91) : !memref_rmem_f16_
      %124 = cute.get_scalars(%17) : !cute.int_tuple<"4">
      scf.for %arg6 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
        %coord_95 = cute.make_coord(%arg6) : (i32) -> !cute.coord<"(_,_,?)">
        %idx_96 = cute.crd2idx(%coord_95, %2) : (!cute.coord<"(_,_,?)">, !cute.layout<"(((64,32),1),1,((1,4),1,1)):(((1,65536),0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        %ptr_97 = cute.add_offset(%ptr_87, %idx_96) : (!cute.ptr<f32, tmem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, tmem, align<16>>
        scf.for %arg7 = %c0_i32 to %122 step %c1_i32  : i32 {
          %129 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_97) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 64 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<64xi32>
          llvm.store %129, %123 : vector<64xi32>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %127 = cute.memref.load_vec %rmem : !memref_rmem_f32_
        %128 = arith.truncf %127 : vector<64xf32> to vector<64xf16>
        cute.memref.store_vec %128, %rmem_91 : !memref_rmem_f16_
        %idx_98 = cute.crd2idx(%coord_95, %1) : (!cute.coord<"(_,_,?)">, !cute.layout<"((64,1),1,((1,4),1,1)):((1,0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        ...
        scf.for %arg7 = %c0_i32 to %124 step %c1_i32  : i32 {
          ...
          %idx_101 = cute.crd2idx(%coord_100, %0) : (!cute.coord<"(_,?)">, !cute.layout<"(16,(4)):(1,(16))">) -> !cute.int_tuple<"?{div=16}">
          ...
          %129 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<f16, rmem, align<32>> to !llvm.ptr
          %130 = builtin.unrealized_conversion_cast %ptr_103 : !cute.ptr<f16, gmem, align<32>> to !llvm.ptr<1>
          %131 = llvm.load %129 {alignment = 32 : i64} : !llvm.ptr -> vector<16xf16>
          llvm.store %131, %130 {alignment = 32 : i64} : vector<16xf16>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      %125 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      %126 = nvvm.mapa.shared.cluster %125, %72 : !llvm.ptr<3>, i32 -> <3>
      nvvm.mbarrier.txn %126, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>, space = #nvvm.mbar_space<cluster>} : !llvm.ptr<3>, i32
      scf.if %50 {
        %127 = arith.addi %120#1, %c1_i32 : i32
        %128 = arith.cmpi eq, %127, %c7_i32 : i32
        %129 = arith.select %128, %c0_i32, %127 : i32
        %130 = scf.if %128 -> (i32) {
          %152 = arith.xori %120#2, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %120#2 : i32
        }
        %131 = arith.addi %129, %c1_i32 : i32
        %132 = arith.cmpi eq, %131, %c7_i32 : i32
        %133 = arith.select %132, %c0_i32, %131 : i32
        %134 = scf.if %132 -> (i32) {
          %152 = arith.xori %130, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %130 : i32
        }
        %135 = arith.addi %133, %c1_i32 : i32
        %136 = arith.cmpi eq, %135, %c7_i32 : i32
        %137 = arith.select %136, %c0_i32, %135 : i32
        %138 = scf.if %136 -> (i32) {
          %152 = arith.xori %134, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %134 : i32
        }
        %139 = arith.addi %137, %c1_i32 : i32
        %140 = arith.cmpi eq, %139, %c7_i32 : i32
        %141 = arith.select %140, %c0_i32, %139 : i32
        %142 = scf.if %140 -> (i32) {
          %152 = arith.xori %138, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %138 : i32
        }
        %143 = arith.addi %141, %c1_i32 : i32
        %144 = arith.cmpi eq, %143, %c7_i32 : i32
        %145 = arith.select %144, %c0_i32, %143 : i32
        %146 = scf.if %144 -> (i32) {
          %152 = arith.xori %142, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %142 : i32
        }
        %147 = arith.addi %145, %c1_i32 : i32
        %148 = arith.cmpi eq, %147, %c7_i32 : i32
        %149 = arith.select %148, %c0_i32, %147 : i32
        %150 = scf.if %148 -> (i32) {
          %152 = arith.xori %146, %c1_i32 : i32
          scf.yield %152 : i32
        } else {
          scf.yield %146 : i32
        }
        %int_tuple_95 = cute.make_int_tuple(%149) : (i32) -> !cute.int_tuple<"?">
        %ptr_96 = cute.add_offset(%ptr_8, %int_tuple_95) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
        %151 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.try_wait.parity.shared %151, %150, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        scf.if %70 {
          ...
          scf.if %152 {
            ...
            %153 = builtin.unrealized_conversion_cast %ptr_97 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %153, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
          }
        }
        scf.if %70 {
          %152 = arith.remsi %51, %c2_i32 : i32
          %153 = arith.cmpi eq, %152, %c0_i32 : i32
          scf.if %153 {
            nvvm.mbarrier.try_wait.parity.shared %125, %120#0, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          }
        }
      }
      nvvm.barrier id = %c1_i32
      scf.if %50 {
        %127 = arith.xori %51, %c1_i32 : i32
        %128 = builtin.unrealized_conversion_cast %iter : !cute.ptr<i64, smem, align<128>> to !llvm.ptr<3>
        %129 = nvvm.mapa.shared.cluster %128, %127 : !llvm.ptr<3>, i32 -> <3>
        nvvm.mbarrier.txn %129, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>, space = #nvvm.mbar_space<cluster>} : !llvm.ptr<3>, i32
