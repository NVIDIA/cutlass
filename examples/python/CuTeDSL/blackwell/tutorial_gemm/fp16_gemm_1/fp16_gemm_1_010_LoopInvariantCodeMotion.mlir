    ...
    func.func public @kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK21111000_PermutationMNK____MMAAtom_ThrID21_ShapeMNK25625616_TVLayoutA2128161281256_TVLayoutB2128161281256_TVLayoutC21282561281256_CopyAtom_ThrI_0(%arg0: !mma_f16_f16_f32_256x256x16_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg2: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg4: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg5: !memref_gmem_f16_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %121:3 = scf.if %51 -> (i32, i32, i32) {
        ...
        %136:3 = scf.for %arg6 = %c0_i32 to %134 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          %143 = scf.if %141 -> (i32) {
            %152 = arith.xori %arg8, %c1_i32 : i32
            scf.yield %152 : i32
          } else {
            scf.yield %arg8 : i32
          }
          ...
          scf.for %arg10 = %c0_i32 to %135 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_104 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %145 : !cute.ptr<smem, align<8>>, [%147#0, %147#1] : i32, i32) mask = %146 mode = <tiled> num_cta = 2 : i32
          ...
          %148 = cute_nvgpu.atom.set_value(%133, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
          ...
          %151:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
          scf.for %arg10 = %c0_i32 to %135 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_113 : !cute.ptr<generic, align<64>>, %ptr_111 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %149 : !cute.ptr<smem, align<8>>, [%151#0, %151#1] : i32, i32) mask = %150 mode = <tiled> num_cta = 2 : i32
          } {llvm.loop_annotation = #loop_annotation}
          scf.yield %142, %143, %140 : i32, i32, i32
        }
        %137:7 = scf.for %arg6 = %c0_i32 to %120 step %c1_i32 iter_args(%arg7 = %136#2, %arg8 = %136#0, %arg9 = %136#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_)  : i32 {
          %138 = arith.addi %arg6, %134 : i32
          %139 = arith.cmpi ult, %138, %120 : i32
          %140:3 = scf.if %139 -> (i32, i32, i32) {
            %int_tuple_95 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
            %ptr_96 = cute.add_offset(%ptr_8, %int_tuple_95) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %142 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %142, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            scf.if %71 {
              %157 = nvvm.elect.sync -> i1
              scf.if %157 {
                %ptr_114 = cute.add_offset(%iter_7, %int_tuple_95) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %158 = builtin.unrealized_conversion_cast %ptr_114 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                nvvm.mbarrier.txn %158, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
              }
            }
            %143 = arith.addi %arg8, %c1_i32 : i32
            %144 = arith.addi %arg7, %c1_i32 : i32
            %145 = arith.cmpi eq, %143, %c7_i32 : i32
            %146 = arith.select %145, %c0_i32, %143 : i32
            %147 = scf.if %145 -> (i32) {
              %157 = arith.xori %arg9, %c1_i32 : i32
              scf.yield %157 : i32
            } else {
              scf.yield %arg9 : i32
            }
            ...
            %ptr_105 = cute.add_offset(%iter_7, %int_tuple_95) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %int_tuple_106 = cute.make_int_tuple(%e0_100, %e1_101) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %148 = cute_nvgpu.atom.set_value(%131, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            %149 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %150 = cute_nvgpu.atom.get_value(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %151 = cute_nvgpu.atom.get_value(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%148 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %152:2 = cute.get_scalars(%int_tuple_106) : !cute.int_tuple<"(?{div=64},?{div=128})">
            scf.for %arg14 = %c0_i32 to %149 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_104 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %150 : !cute.ptr<smem, align<8>>, [%152#0, %152#1] : i32, i32) mask = %151 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %idx_107 = cute.crd2idx(%coord_97, %lay_74) : (!cute.coord<"(_,?)">, !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">) -> !cute.int_tuple<"(?{div=64},0)">
            %tup_108 = cute.add_offset(%tup_57, %idx_107) : (!cute.int_tuple<"(0,?{div=128})">, !cute.int_tuple<"(?{div=64},0)">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %e0_109, %e1_110 = cute.get_leaves(%tup_108) : !cute.int_tuple<"(?{div=64},?{div=128})">
            %ptr_111 = cute.add_offset(%iter_6, %idx_103) : (!cute.ptr<f16, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=8192}">) -> !cute.ptr<f16, smem, align<128>, S<3,4,3>>
            %int_tuple_112 = cute.make_int_tuple(%e0_109, %e1_110) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %153 = cute_nvgpu.atom.set_value(%133, %ptr_105 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            ...
            %156:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
            scf.for %arg14 = %c0_i32 to %149 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_113 : !cute.ptr<generic, align<64>>, %ptr_111 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %154 : !cute.ptr<smem, align<8>>, [%156#0, %156#1] : i32, i32) mask = %155 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            scf.yield %146, %147, %144 : i32, i32, i32
          } else {
            scf.yield %arg8, %arg9, %arg7 : i32, i32, i32
          }
          %141:4 = scf.if %71 -> (i32, i32, i32, !mma_f16_f16_f32_256x256x16_) {
            ...
            %142 = builtin.unrealized_conversion_cast %ptr_96 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %142, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            %143 = arith.addi %arg11, %c1_i32 : i32
            %144 = arith.addi %arg10, %c1_i32 : i32
            %145 = arith.cmpi eq, %143, %c7_i32 : i32
            %146 = arith.select %145, %c0_i32, %143 : i32
            %147 = scf.if %145 -> (i32) {
              %190 = arith.xori %arg12, %c1_i32 : i32
              scf.yield %190 : i32
            } else {
              scf.yield %arg12 : i32
            }
            ...
            %148 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            ...
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %148 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %148 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_99, %tup_100, %tmem_ptr, %157, %151) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %158 = cute_nvgpu.atom.set_value(%arg13, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            ...
            %159 = cute_nvgpu.atom.get_value(%158 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %160 = cute_nvgpu.atom.get_value(%158 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %161 = cute_nvgpu.atom.get_value(%158 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %162 = arith.extui %159 : i1 to i32
            %163 = arith.extui %160 : i1 to i32
            %164 = arith.shli %162, %c13_i32 : i32
            %165 = arith.shli %163, %c14_i32 : i32
            %166 = arith.ori %164, %c272629776_i32 : i32
            %167 = arith.ori %166, %165 : i32
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %148 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %148 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_103, %tup_104, %tmem_ptr, %167, %161) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %168 = cute_nvgpu.atom.set_value(%158, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            ...
            %169 = cute_nvgpu.atom.get_value(%168 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %170 = cute_nvgpu.atom.get_value(%168 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %171 = cute_nvgpu.atom.get_value(%168 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %172 = arith.extui %169 : i1 to i32
            %173 = arith.extui %170 : i1 to i32
            %174 = arith.shli %172, %c13_i32 : i32
            %175 = arith.shli %173, %c14_i32 : i32
            %176 = arith.ori %174, %c272629776_i32 : i32
            %177 = arith.ori %176, %175 : i32
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %148 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %148 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_107, %tup_108, %tmem_ptr, %177, %171) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %178 = cute_nvgpu.atom.set_value(%168, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            ...
            %179 = cute_nvgpu.atom.get_value(%178 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
            %180 = cute_nvgpu.atom.get_value(%178 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
            %181 = cute_nvgpu.atom.get_value(%178 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
            %182 = arith.extui %179 : i1 to i32
            %183 = arith.extui %180 : i1 to i32
            %184 = arith.shli %182, %c13_i32 : i32
            %185 = arith.shli %183, %c14_i32 : i32
            %186 = arith.ori %184, %c272629776_i32 : i32
            %187 = arith.ori %186, %185 : i32
            scf.for %arg14 = %c0_i32 to %148 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %148 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %148 step %c1_i32  : i32 {
                  cute_nvgpu.arch.mma.SM100.umma(%tup_111, %tup_112, %tmem_ptr, %187, %181) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %188 = cute_nvgpu.atom.set_value(%178, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            ...
            scf.if %189 {
              ...
              nvvm.tcgen05.commit.arrive %190, multicast_mask = %70 {group = #nvvm.tcgen05_group<cta_2>} : !llvm.ptr<3>, i16
            }
            scf.yield %144, %146, %147, %188 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          } else {
            scf.yield %arg10, %arg11, %arg12, %arg13 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          }
          scf.yield %140#2, %140#0, %140#1, %141#0, %141#1, %141#2, %141#3 : i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_
        }
        scf.if %71 {
      ...
      %125 = cute.get_scalars(%0) : !cute.int_tuple<"8">
      scf.for %arg6 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
        ...
        %128 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
        %129 = arith.truncf %128 : vector<64xf32> to vector<64xf16>
        cute.memref.store_vec %129, %rmem_91, row_major : !memref_rmem_f16_
        ...
        scf.for %arg7 = %c0_i32 to %125 step %c1_i32  : i32 {
          ...
          %130 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          %131 = builtin.unrealized_conversion_cast %ptr_103 : !cute.ptr<f16, gmem, align<16>> to !llvm.ptr<1>
          %132 = llvm.load %130 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
          llvm.store %132, %131 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
