...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb18:  // pred: ^bb17
      "nvvm.mbarrier.try_wait.parity.shared"(%378, %306, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb19] : () -> ()
    ...
    ^bb21:  // pred: ^bb20
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%506, %503, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb37:  // pred: ^bb36
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%536, %529, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb52:  // pred: ^bb51
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%558, %531, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb77:  // 2 preds: ^bb75, ^bb76
      "nvvm.mbarrier.try_wait.parity.shared"(%343, %287, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb108:  // pred: ^bb107
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%673, %672, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb114:  // pred: ^bb113
      "nvvm.mbarrier.try_wait.parity.shared"(%378, %621, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb115] : () -> ()
    ...
    ^bb118:  // pred: ^bb117
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%344, %287, %295) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
