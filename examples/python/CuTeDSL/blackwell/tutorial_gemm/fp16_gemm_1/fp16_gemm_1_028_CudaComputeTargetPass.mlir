gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb30(%256: i32):  // 2 preds: ^bb29, ^bb33
    ...
    llvm.cond_br %257, ^bb31, ^bb34 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb31:  // pred: ^bb30
  ...
  ^bb35(%264: i32):  // 2 preds: ^bb34, ^bb38
    ...
    llvm.cond_br %265, ^bb36, ^bb39 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb36:  // pred: ^bb35
  ...
  ^bb52(%296: i32):  // 2 preds: ^bb51, ^bb55
    ...
    llvm.cond_br %297, ^bb53, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb53:  // pred: ^bb52
  ...
  ^bb57(%304: i32):  // 2 preds: ^bb56, ^bb60
    ...
    llvm.cond_br %305, ^bb58, ^bb61(%288, %290, %286 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb58:  // pred: ^bb57
  ...
  ^bb69(%340: i32):  // 2 preds: ^bb68, ^bb78
    ...
    llvm.cond_br %341, ^bb70, ^bb79 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb70:  // pred: ^bb69
    llvm.br ^bb71(%21 : i32)
  ^bb71(%342: i32):  // 2 preds: ^bb70, ^bb77
    %343 = llvm.icmp "slt" %342, %40 : i32
    llvm.cond_br %343, ^bb72, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
    llvm.br ^bb73(%21 : i32)
  ^bb73(%344: i32):  // 2 preds: ^bb72, ^bb76
    %345 = llvm.icmp "slt" %344, %40 : i32
    llvm.cond_br %345, ^bb74, ^bb77 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb80(%359: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %360, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%21 : i32)
  ^bb82(%361: i32):  // 2 preds: ^bb81, ^bb88
    %362 = llvm.icmp "slt" %361, %40 : i32
    llvm.cond_br %362, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%21 : i32)
  ^bb84(%363: i32):  // 2 preds: ^bb83, ^bb87
    %364 = llvm.icmp "slt" %363, %40 : i32
    llvm.cond_br %364, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb91(%378: i32):  // 2 preds: ^bb90, ^bb100
    ...
    llvm.cond_br %379, ^bb92, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb92:  // pred: ^bb91
    llvm.br ^bb93(%21 : i32)
  ^bb93(%380: i32):  // 2 preds: ^bb92, ^bb99
    %381 = llvm.icmp "slt" %380, %40 : i32
    llvm.cond_br %381, ^bb94, ^bb100 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb94:  // pred: ^bb93
    llvm.br ^bb95(%21 : i32)
  ^bb95(%382: i32):  // 2 preds: ^bb94, ^bb98
    %383 = llvm.icmp "slt" %382, %40 : i32
    llvm.cond_br %383, ^bb96, ^bb99 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb96:  // pred: ^bb95
  ...
  ^bb102(%397: i32):  // 2 preds: ^bb101, ^bb111
    ...
    llvm.cond_br %398, ^bb103, ^bb112 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb103:  // pred: ^bb102
    llvm.br ^bb104(%21 : i32)
  ^bb104(%399: i32):  // 2 preds: ^bb103, ^bb110
    %400 = llvm.icmp "slt" %399, %40 : i32
    llvm.cond_br %400, ^bb105, ^bb111 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb105:  // pred: ^bb104
    llvm.br ^bb106(%21 : i32)
  ^bb106(%401: i32):  // 2 preds: ^bb105, ^bb109
    %402 = llvm.icmp "slt" %401, %40 : i32
    llvm.cond_br %402, ^bb107, ^bb110 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb107:  // pred: ^bb106
  ...
  ^bb128(%424: i32):  // 2 preds: ^bb127, ^bb129
    ...
    llvm.cond_br %425, ^bb129, ^bb130 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb129:  // pred: ^bb128
  ...
  ^bb131(%432: i32):  // 2 preds: ^bb130, ^bb132
    ...
    llvm.cond_br %433, ^bb132, ^bb133 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb132:  // pred: ^bb131
