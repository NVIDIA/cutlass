gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb18:  // pred: ^bb17
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,n,n" %112, %40, %29 : (!llvm.ptr<3>, i32, i32) -> ()
    llvm.br ^bb19
  ...
  ^bb21:  // pred: ^bb20
    ...
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,r,n" %239, %236, %29 : (!llvm.ptr<3>, i32, i32) -> ()
  ...
  ^bb30(%253: i32):  // 2 preds: ^bb29, ^bb33
    ...
    llvm.cond_br %254, ^bb31, ^bb34 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb31:  // pred: ^bb30
  ...
  ^bb35(%261: i32):  // 2 preds: ^bb34, ^bb38
    ...
    llvm.cond_br %262, ^bb36, ^bb39 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb36:  // pred: ^bb35
  ...
  ^bb43:  // pred: ^bb42
    ...
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,r,n" %279, %272, %29 : (!llvm.ptr<3>, i32, i32) -> ()
  ...
  ^bb52(%293: i32):  // 2 preds: ^bb51, ^bb55
    ...
    llvm.cond_br %294, ^bb53, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb53:  // pred: ^bb52
  ...
  ^bb57(%301: i32):  // 2 preds: ^bb56, ^bb60
    ...
    llvm.cond_br %302, ^bb58, ^bb61(%285, %287, %283 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb58:  // pred: ^bb57
  ...
  ^bb64:  // pred: ^bb63
    ...
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,r,n" %311, %274, %29 : (!llvm.ptr<3>, i32, i32) -> ()
  ...
  ^bb69(%337: i32):  // 2 preds: ^bb68, ^bb78
    ...
    llvm.cond_br %338, ^bb70, ^bb79 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb70:  // pred: ^bb69
    llvm.br ^bb71(%21 : i32)
  ^bb71(%339: i32):  // 2 preds: ^bb70, ^bb77
    %340 = llvm.icmp "slt" %339, %40 : i32
    llvm.cond_br %340, ^bb72, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
    llvm.br ^bb73(%21 : i32)
  ^bb73(%341: i32):  // 2 preds: ^bb72, ^bb76
    %342 = llvm.icmp "slt" %341, %40 : i32
    llvm.cond_br %342, ^bb74, ^bb77 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb80(%356: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %357, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%21 : i32)
  ^bb82(%358: i32):  // 2 preds: ^bb81, ^bb88
    %359 = llvm.icmp "slt" %358, %40 : i32
    llvm.cond_br %359, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%21 : i32)
  ^bb84(%360: i32):  // 2 preds: ^bb83, ^bb87
    %361 = llvm.icmp "slt" %360, %40 : i32
    llvm.cond_br %361, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb91(%375: i32):  // 2 preds: ^bb90, ^bb100
    ...
    llvm.cond_br %376, ^bb92, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb92:  // pred: ^bb91
    llvm.br ^bb93(%21 : i32)
  ^bb93(%377: i32):  // 2 preds: ^bb92, ^bb99
    %378 = llvm.icmp "slt" %377, %40 : i32
    llvm.cond_br %378, ^bb94, ^bb100 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb94:  // pred: ^bb93
    llvm.br ^bb95(%21 : i32)
  ^bb95(%379: i32):  // 2 preds: ^bb94, ^bb98
    %380 = llvm.icmp "slt" %379, %40 : i32
    llvm.cond_br %380, ^bb96, ^bb99 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb96:  // pred: ^bb95
  ...
  ^bb102(%394: i32):  // 2 preds: ^bb101, ^bb111
    ...
    llvm.cond_br %395, ^bb103, ^bb112 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb103:  // pred: ^bb102
    llvm.br ^bb104(%21 : i32)
  ^bb104(%396: i32):  // 2 preds: ^bb103, ^bb110
    %397 = llvm.icmp "slt" %396, %40 : i32
    llvm.cond_br %397, ^bb105, ^bb111 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb105:  // pred: ^bb104
    llvm.br ^bb106(%21 : i32)
  ^bb106(%398: i32):  // 2 preds: ^bb105, ^bb109
    %399 = llvm.icmp "slt" %398, %40 : i32
    llvm.cond_br %399, ^bb107, ^bb110 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb107:  // pred: ^bb106
  ...
  ^bb128(%421: i32):  // 2 preds: ^bb127, ^bb129
    ...
    llvm.cond_br %422, ^bb129, ^bb130 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb129:  // pred: ^bb128
  ...
  ^bb131(%429: i32):  // 2 preds: ^bb130, ^bb132
    ...
    llvm.cond_br %430, ^bb132, ^bb133 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb132:  // pred: ^bb131
  ...
  ^bb159:  // pred: ^bb158
    ...
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,r,n" %468, %467, %29 : (!llvm.ptr<3>, i32, i32) -> ()
  ...
  ^bb165:  // pred: ^bb164
    llvm.inline_asm has_side_effects asm_dialect = att "{\0A\09.reg .pred       P1; \0A\09LAB_WAIT: \0A\09mbarrier.try_wait.parity.shared.b64 P1, [$0], $1, $2; \0A\09@P1 bra.uni DONE; \0A\09bra.uni     LAB_WAIT; \0A\09DONE: \0A\09}", "r,r,n" %112, %413, %29 : (!llvm.ptr<3>, i32, i32) -> ()
    llvm.br ^bb166
