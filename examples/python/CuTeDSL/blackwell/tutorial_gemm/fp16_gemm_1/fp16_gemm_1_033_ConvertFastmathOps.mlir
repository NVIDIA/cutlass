gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_100a">] {
  ...
  ^bb30(%251: i32):  // 2 preds: ^bb29, ^bb33
    ...
    llvm.cond_br %252, ^bb31, ^bb34 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb31:  // pred: ^bb30
  ...
  ^bb35(%259: i32):  // 2 preds: ^bb34, ^bb38
    ...
    llvm.cond_br %260, ^bb36, ^bb39 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb36:  // pred: ^bb35
  ...
  ^bb52(%290: i32):  // 2 preds: ^bb51, ^bb55
    ...
    llvm.cond_br %291, ^bb53, ^bb56 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb53:  // pred: ^bb52
  ...
  ^bb57(%298: i32):  // 2 preds: ^bb56, ^bb60
    ...
    llvm.cond_br %299, ^bb58, ^bb61(%283, %285, %281 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb58:  // pred: ^bb57
  ...
  ^bb69(%334: i32):  // 2 preds: ^bb68, ^bb78
    ...
    llvm.cond_br %335, ^bb70, ^bb79 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb70:  // pred: ^bb69
    llvm.br ^bb71(%20 : i32)
  ^bb71(%336: i32):  // 2 preds: ^bb70, ^bb77
    %337 = llvm.icmp "slt" %336, %39 : i32
    llvm.cond_br %337, ^bb72, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
    llvm.br ^bb73(%20 : i32)
  ^bb73(%338: i32):  // 2 preds: ^bb72, ^bb76
    %339 = llvm.icmp "slt" %338, %39 : i32
    llvm.cond_br %339, ^bb74, ^bb77 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb80(%353: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %354, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%20 : i32)
  ^bb82(%355: i32):  // 2 preds: ^bb81, ^bb88
    %356 = llvm.icmp "slt" %355, %39 : i32
    llvm.cond_br %356, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%20 : i32)
  ^bb84(%357: i32):  // 2 preds: ^bb83, ^bb87
    %358 = llvm.icmp "slt" %357, %39 : i32
    llvm.cond_br %358, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb91(%372: i32):  // 2 preds: ^bb90, ^bb100
    ...
    llvm.cond_br %373, ^bb92, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb92:  // pred: ^bb91
    llvm.br ^bb93(%20 : i32)
  ^bb93(%374: i32):  // 2 preds: ^bb92, ^bb99
    %375 = llvm.icmp "slt" %374, %39 : i32
    llvm.cond_br %375, ^bb94, ^bb100 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb94:  // pred: ^bb93
    llvm.br ^bb95(%20 : i32)
  ^bb95(%376: i32):  // 2 preds: ^bb94, ^bb98
    %377 = llvm.icmp "slt" %376, %39 : i32
    llvm.cond_br %377, ^bb96, ^bb99 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb96:  // pred: ^bb95
  ...
  ^bb102(%391: i32):  // 2 preds: ^bb101, ^bb111
    ...
    llvm.cond_br %392, ^bb103, ^bb112 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb103:  // pred: ^bb102
    llvm.br ^bb104(%20 : i32)
  ^bb104(%393: i32):  // 2 preds: ^bb103, ^bb110
    %394 = llvm.icmp "slt" %393, %39 : i32
    llvm.cond_br %394, ^bb105, ^bb111 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb105:  // pred: ^bb104
    llvm.br ^bb106(%20 : i32)
  ^bb106(%395: i32):  // 2 preds: ^bb105, ^bb109
    %396 = llvm.icmp "slt" %395, %39 : i32
    llvm.cond_br %396, ^bb107, ^bb110 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb107:  // pred: ^bb106
  ...
  ^bb128(%418: i32):  // 2 preds: ^bb127, ^bb129
    ...
    llvm.cond_br %419, ^bb129, ^bb130 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb129:  // pred: ^bb128
  ...
  ^bb131(%426: i32):  // 2 preds: ^bb130, ^bb132
    ...
    llvm.cond_br %427, ^bb132, ^bb133 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb132:  // pred: ^bb131
