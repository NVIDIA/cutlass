...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK21111000_PermutationMNK____MMAAtom_ThrID21_ShapeMNK25625616_TVLayoutA2128161281256_TVLayoutB2128161281256_TVLayoutC21282561281256_CopyAtom_ThrI_0(%arg0: !mma_f16_f16_f32_256x256x16_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg2: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg4: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg5: !memref_gmem_f16_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %44 = cute.get_flat_coord(%43, %27) : (i32, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.coord<"(?,0,0,0)">
      ...
      %ptr_4 = cute.add_offset(%51, %22) : (!cute.ptr<i8, smem, align<128>>, !cute.int_tuple<"114688">) -> !cute.ptr<i8, smem, align<128>>
      ...
      %54 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %55 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %56 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %57 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      %58 = arith.muli %54, %56 : i32
      %59 = arith.addi %53, %58 : i32
      %60 = arith.muli %55, %56 : i32
      %61 = arith.muli %60, %57 : i32
      %62 = arith.addi %59, %61 : i32
      %63 = arith.floordivsi %62, %c32_i32 : i32
      %64 = cute_nvgpu.arch.make_warp_uniform(%63) : i32
      %65 = arith.cmpi eq, %64, %c0_i32 : i32
      scf.if %65 {
        %249 = builtin.unrealized_conversion_cast %iter_7 : !cute.ptr<i64, smem, align<1024>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %249, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_100 = cute.add_offset(%iter_7, %21) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"1">) -> !cute.ptr<i64, smem>
        %250 = builtin.unrealized_conversion_cast %ptr_100 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %250, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_101 = cute.add_offset(%iter_7, %20) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"2">) -> !cute.ptr<i64, smem, align<16>>
        %251 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %251, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_102 = cute.add_offset(%iter_7, %19) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"3">) -> !cute.ptr<i64, smem>
        %252 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %252, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_103 = cute.add_offset(%iter_7, %18) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"4">) -> !cute.ptr<i64, smem, align<32>>
        %253 = builtin.unrealized_conversion_cast %ptr_103 : !cute.ptr<i64, smem, align<32>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %253, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_104 = cute.add_offset(%iter_7, %17) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"5">) -> !cute.ptr<i64, smem>
        %254 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %254, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_105 = cute.add_offset(%iter_7, %16) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"6">) -> !cute.ptr<i64, smem, align<16>>
        %255 = builtin.unrealized_conversion_cast %ptr_105 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
      ...
      scf.if %78 {
        %249 = builtin.unrealized_conversion_cast %ptr_8 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %249, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %250 = builtin.unrealized_conversion_cast %dyn_102 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %250, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %251 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %251, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %252 = builtin.unrealized_conversion_cast %dyn_107 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %252, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %254 = builtin.unrealized_conversion_cast %dyn_112 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %254, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %255 = builtin.unrealized_conversion_cast %ptr_114 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %255, %c1_i32 : !llvm.ptr<3>, i32
      }
      %79 = nvvm.read.ptx.sreg.cluster.ctarank : i32
      %80 = cute_nvgpu.arch.make_warp_uniform(%79) : i32
      %81 = cute.get_flat_coord(%80, %27) : (i32, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.coord<"(?,0,0,0)">
      %e0_9, %e1_10, %e2_11, %e3_12 = cute.get_leaves(%81) : !cute.coord<"(?,0,0,0)">
      %itup_13 = cute.to_int_tuple(%e0_9) : !cute.coord<"?"> to !cute.int_tuple<"?">
      %82 = cute.get_scalars(%itup_13) : !cute.int_tuple<"?">
      ...
      %83 = cute.get_scalars(%e0_14) : !cute.int_tuple<"?">
      %84 = arith.shli %c1_i32, %83 : i32
      %85 = arith.trunci %84 : i32 to i16
      ...
      %86 = cute.get_scalars(%e0_17) : !cute.int_tuple<"?">
      %87 = arith.shli %c1_i32, %86 : i32
      %88 = arith.trunci %87 : i32 to i16
      %89 = arith.xori %82, %c1_i32 : i32
      %coord_18 = cute.make_coord(%89) : (i32) -> !cute.coord<"(?,0,_,0)">
      ...
      %90 = cute.get_scalars(%e0_20) : !cute.int_tuple<"?">
      %91 = arith.shli %c1_i32, %90 : i32
      %92 = arith.trunci %91 : i32 to i16
      %coord_21 = cute.make_coord(%89) : (i32) -> !cute.coord<"(?,_,0,0)">
      ...
      %93 = cute.get_scalars(%e0_23) : !cute.int_tuple<"?">
      %94 = arith.shli %c1_i32, %93 : i32
      %95 = arith.trunci %94 : i32 to i16
      %96 = arith.ori %85, %88 : i16
      %97 = arith.ori %96, %92 : i16
      %98 = arith.ori %97, %95 : i16
      %99 = nvvm.read.ptx.sreg.ctaid.x range <i32, 0, 2147483647> : i32
      ...
      %102 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %103 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %104 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %105 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %106 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      scf.if %114 {
        %249 = builtin.unrealized_conversion_cast %iter_24 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %249, %c1_i32 : !llvm.ptr<3>, i32
      }
      %ptr_25 = cute.add_offset(%iter_24, %21) : (!cute.ptr<i64, smem, align<16>>, !cute.int_tuple<"1">) -> !cute.ptr<i64, smem>
      %115 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %116 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %117 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %118 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %119 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      scf.if %127 {
        %249 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %249, %c256_i32 : !llvm.ptr<3>, i32
      }
      %128 = nvvm.read.ptx.sreg.cluster.ctarank : i32
      %129 = cute_nvgpu.arch.make_warp_uniform(%128) : i32
      %130 = arith.floordivsi %129, %c2_i32 : i32
      %131 = arith.muli %130, %c2_i32 : i32
      nvvm.fence.mbarrier.init
      nvvm.cluster.arrive
      nvvm.cluster.wait
      %coord_26 = cute.make_coord(%46, %42) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %132:2 = cute.get_scalars(%coord_26) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_27 = cute.make_coord(%132#0) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %133:2 = cute.get_scalars(%lay) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %134 = arith.ceildivsi %133#0, %c256_i32 : i32
      %135 = arith.ceildivsi %133#1, %c64_i32 : i32
      %shape = cute.make_shape(%134, %135) : (i32, i32) -> !cute.shape<"((256,64),(?,?))">
      %lay_28 = cute.make_layout(%shape, %14) : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %136:2 = cute.get_scalars(%lay_28) <{only_dynamic}> : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %shape_29 = cute.make_shape(%136#1) : (i32) -> !cute.shape<"(256,64,?)">
      ...
      %coord_32 = cute.make_coord(%46, %42) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %137:2 = cute.get_scalars(%coord_32) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_33 = cute.make_coord(%137#1) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay_34 = cute.get_layout(%arg4) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %138:2 = cute.get_scalars(%lay_34) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %139 = arith.ceildivsi %138#0, %c256_i32 : i32
      %140 = arith.ceildivsi %138#1, %c64_i32 : i32
      %shape_35 = cute.make_shape(%139, %140) : (i32, i32) -> !cute.shape<"((256,64),(?,?))">
      %lay_36 = cute.make_layout(%shape_35, %14) : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %141:2 = cute.get_scalars(%lay_36) <{only_dynamic}> : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %shape_37 = cute.make_shape(%141#1) : (i32) -> !cute.shape<"(256,64,?)">
      %lay_38 = cute.make_layout(%shape_37, %13) : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %idx_39 = cute.crd2idx(%coord_33, %lay_36) : (!cute.coord<"((_,_),(?,_))">, !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">) -> !cute.int_tuple<"(0,?{div=256})">
      %tup_40 = cute.add_offset(%12, %idx_39) : (!cute.int_tuple<"(0,0)">, !cute.int_tuple<"(0,?{div=256})">) -> !cute.int_tuple<"(0,?{div=256})">
      %coord_41 = cute.make_coord(%46, %42) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %142:2 = cute.get_scalars(%coord_41) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_42 = cute.make_coord(%142#0, %142#1) : (i32, i32) -> !cute.coord<"((_,_),(?,?))">
      %lay_43 = cute.get_layout(%arg5) : !memref_gmem_f16_
      %143:3 = cute.get_scalars(%lay_43) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(?{i64 div=8192},1)">
      %144 = arith.ceildivsi %143#0, %c256_i32 : i32
      %145 = arith.muli %143#2, %c256_i64 : i64
      %146 = arith.ceildivsi %143#1, %c256_i32 : i32
      %shape_44 = cute.make_shape(%144, %146) : (i32, i32) -> !cute.shape<"((256,256),(?,?))">
      %iv_45 = cute.assume(%143#2) : (i64) -> !cute.i64<divby 8192>
      %iv_46 = cute.assume(%145) : (i64) -> !cute.i64<divby 2097152>
      ...
      %147:4 = cute.get_scalars(%lay_47) <{only_dynamic}> : !cute.layout<"((256,256),(?,?)):((?{i64 div=8192},1),(?{i64 div=2097152},256))">
      %iv_48 = cute.assume(%147#2) : (i64) -> !cute.i64<divby 8192>
      %stride_49 = cute.make_stride(%iv_48) : (!cute.i64<divby 8192>) -> !cute.stride<"(?{i64 div=8192},1)">
      %lay_50 = cute.make_layout(%11, %stride_49) : !cute.layout<"(256,256):(?{i64 div=8192},1)">
      ...
      %coord_54 = cute.make_coord(%45) : (i32) -> !cute.coord<"?">
      %148 = cute.get_scalars(%lay_30) <{only_dynamic}> : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %149 = cute.get_scalars(%coord_54) <{only_dynamic}> : !cute.coord<"?">
      %150 = arith.remsi %149, %c2_i32 : i32
      %151 = arith.remsi %150, %c2_i32 : i32
      %152 = arith.muli %151, %c128_i32 : i32
      %iv_55 = cute.assume(%152) : (i32) -> !cute.i32<divby 128>
      ...
      %shape_57 = cute.make_shape(%148) : (i32) -> !cute.shape<"((128,16),1,4,?)">
      %lay_58 = cute.make_layout(%shape_57, %10) : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %coord_59 = cute.make_coord(%45) : (i32) -> !cute.coord<"?">
      %153 = cute.get_scalars(%lay_38) <{only_dynamic}> : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %154 = cute.get_scalars(%coord_59) <{only_dynamic}> : !cute.coord<"?">
      %155 = arith.remsi %154, %c2_i32 : i32
      %156 = arith.remsi %155, %c2_i32 : i32
      %157 = arith.muli %156, %c128_i32 : i32
      %iv_60 = cute.assume(%157) : (i32) -> !cute.i32<divby 128>
      ...
      %shape_63 = cute.make_shape(%153) : (i32) -> !cute.shape<"((128,16),1,4,?)">
      %lay_64 = cute.make_layout(%shape_63, %10) : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %coord_65 = cute.make_coord(%45) : (i32) -> !cute.coord<"?">
      %158 = cute.get_scalars(%lay_50) <{only_dynamic}> : !cute.layout<"(256,256):(?{i64 div=8192},1)">
      %159 = cute.get_scalars(%coord_65) <{only_dynamic}> : !cute.coord<"?">
      %160 = arith.muli %158, %c128_i64 : i64
      %161 = arith.remsi %159, %c2_i32 : i32
      %162 = arith.remsi %161, %c2_i32 : i32
      %163 = arith.extsi %162 : i32 to i64
      %164 = arith.muli %163, %160 : i64
      %iv_66 = cute.assume(%164) : (i64) -> !cute.i64<divby 1048576>
      ...
      %iv_69 = cute.assume(%158) : (i64) -> !cute.i64<divby 8192>
      %stride_70 = cute.make_stride(%iv_69) : (!cute.i64<divby 8192>) -> !cute.stride<"((?{i64 div=8192},1),0,0)">
      %lay_71 = cute.make_layout(%9, %stride_70) : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      ...
      %165 = cute.get_scalars(%lay_58) <{only_dynamic}> : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_73 = cute.make_shape(%165) : (i32) -> !cute.shape<"(((128,16),1,4),?)">
      %lay_74 = cute.make_layout(%shape_73, %8) : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %166 = cute.get_scalars(%lay_74) <{only_dynamic}> : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_75 = cute.make_shape(%166) : (i32) -> !cute.shape<"(((64,128),1),?)">
      %lay_76 = cute.make_layout(%shape_75, %7) : !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">
      %167 = cute.get_scalars(%lay_64) <{only_dynamic}> : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_77 = cute.make_shape(%167) : (i32) -> !cute.shape<"(((128,16),1,4),?)">
      %lay_78 = cute.make_layout(%shape_77, %8) : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %168 = cute.get_scalars(%lay_78) <{only_dynamic}> : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_79 = cute.make_shape(%168) : (i32) -> !cute.shape<"(((64,128),1),?)">
      %lay_80 = cute.make_layout(%shape_79, %7) : !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">
      %coord_81 = cute.make_coord(%itup) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,0,_,0)">
      %idx_82 = cute.crd2idx(%coord_81, %27) : (!cute.coord<"(?,0,_,0)">, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.int_tuple<"?">
      %e0_83 = cute.get_leaves(%idx_82) : !cute.int_tuple<"?">
      %169 = cute.get_scalars(%e0_83) : !cute.int_tuple<"?">
      %170 = arith.shli %c1_i32, %169 : i32
      %171 = arith.trunci %170 : i32 to i16
      %coord_84 = cute.make_coord(%itup) : (!cute.int_tuple<"?">) -> !cute.coord<"(?,_,0,0)">
      %idx_85 = cute.crd2idx(%coord_84, %27) : (!cute.coord<"(?,_,0,0)">, !cute.layout<"((2),1,1,1):((1),0,0,0)">) -> !cute.int_tuple<"?">
      %e0_86 = cute.get_leaves(%idx_85) : !cute.int_tuple<"?">
      %172 = cute.get_scalars(%e0_86) : !cute.int_tuple<"?">
      %173 = arith.shli %c1_i32, %172 : i32
      %174 = arith.trunci %173 : i32 to i16
      ...
      scf.if %187 {
        ...
        scf.if %249 {
          %250 = builtin.unrealized_conversion_cast %iter : !cute.ptr<i64, smem, align<128>> to !llvm.ptr<3>
          nvvm.mbarrier.init.shared %250, %c32_i32 : !llvm.ptr<3>, i32
        }
      }
      nvvm.fence.mbarrier.init
      %188 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %189 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %190 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %191 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %192 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      %201 = cute.get_scalars(%lay_71) <{only_dynamic}> : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      %iv_87 = cute.assume(%201) : (i64) -> !cute.i64<divby 8192>
      %stride_88 = cute.make_stride(%iv_87) : (!cute.i64<divby 8192>) -> !cute.stride<"(((?{i64 div=8192},1)),((0,64),0,0))">
      %lay_89 = cute.make_layout(%6, %stride_88) : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %coord_90 = cute.make_coord(%28) : (i32) -> !cute.coord<"?">
      %202 = cute.get_scalars(%coord_90) <{only_dynamic}> : !cute.coord<"?">
      %203 = arith.divsi %202, %c32_i32 : i32
      %204 = arith.muli %203, %c2097152_i32 : i32
      %iv_91 = cute.assume(%204) : (i32) -> !cute.i32<divby 2097152>
      ...
      %coord_94 = cute.make_coord(%28) : (i32) -> !cute.coord<"?">
      %205 = cute.get_scalars(%lay_89) <{only_dynamic}> : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %206 = cute.get_scalars(%coord_94) <{only_dynamic}> : !cute.coord<"?">
      %207 = arith.muli %205, %c32_i64 : i64
      %208 = arith.divsi %206, %c32_i32 : i32
      %209 = arith.remsi %206, %c32_i32 : i32
      %210 = arith.extsi %209 : i32 to i64
      %211 = arith.muli %210, %205 : i64
      %212 = arith.extsi %208 : i32 to i64
      %213 = arith.muli %212, %207 : i64
      %214 = arith.addi %211, %213 : i64
      %iv_95 = cute.assume(%214) : (i64) -> !cute.i64<divby 8192>
      ...
      %215 = arith.cmpi eq, %45, %c0_i32 : i32
      %sz = cute.size(%lay_30) <{mode = [2]}> : (!cute.layout<"(256,64,?):(1@1,1@0,64@0)">) -> !cute.int_tuple<"?">
      %e0_99 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
      %216 = cute.get_scalars(%e0_99) : !cute.int_tuple<"?">
      %217 = arith.cmpi eq, %40, %c0_i32 : i32
      %218:3 = scf.if %217 -> (i32, i32, i32) {
        %249 = arith.cmpi ne, %45, %c0_i32 : i32
        %250 = arith.extui %249 : i1 to i32
        scf.if %215 {
          %258 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %258, %c1_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        }
        %251 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %252 = cute_nvgpu.atom.set_value(%251, %171 : i16) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %253 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %254 = cute_nvgpu.atom.set_value(%253, %174 : i16) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
        %255 = arith.minsi %216, %c5_i32 : i32
        %256:3 = scf.for %arg6 = %c0_i32 to %255 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          %258 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          ...
          scf.if %101 {
            ...
            scf.if %268 {
              ...
              %269 = builtin.unrealized_conversion_cast %ptr_121 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %269, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
          }
          %259 = arith.addi %arg7, %c1_i32 : i32
          %260 = arith.addi %arg9, %c1_i32 : i32
          %261 = arith.cmpi eq, %259, %c7_i32 : i32
          %262 = arith.select %261, %c0_i32, %259 : i32
          %263 = scf.if %261 -> (i32) {
            %268 = arith.xori %arg8, %c1_i32 : i32
            scf.yield %268 : i32
          } else {
            scf.yield %arg8 : i32
          }
          ...
          %idx_108 = cute.crd2idx(%coord_107, %5) : (!cute.coord<"(_,?)">, !cute.layout<"((8192,1),7):((1,0),8192)">) -> !cute.int_tuple<"?{div=8192}">
          ...
          %264 = cute_nvgpu.atom.set_value(%252, %ptr_111 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
          %265 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg10 = %c0_i32 to %265 step %c1_i32  : i32 {
            %268 = cute_nvgpu.atom.get_value(%264 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %269 = cute_nvgpu.atom.get_value(%264 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%264 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %270:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_109 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %268 : !cute.ptr<smem, align<8>>, [%270#0, %270#1] : i32, i32) mask = %269 mode = <tiled> num_cta = 2 : i32
          ...
          %idx_117 = cute.crd2idx(%coord_107, %5) : (!cute.coord<"(_,?)">, !cute.layout<"((8192,1),7):((1,0),8192)">) -> !cute.int_tuple<"?{div=8192}">
          ...
          %266 = cute_nvgpu.atom.set_value(%254, %ptr_111 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
          %267 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg10 = %c0_i32 to %267 step %c1_i32  : i32 {
            %268 = cute_nvgpu.atom.get_value(%266 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %269 = cute_nvgpu.atom.get_value(%266 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%266 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %270:2 = cute.get_scalars(%int_tuple_119) : !cute.int_tuple<"(?{div=64},?{div=128})">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_118 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %268 : !cute.ptr<smem, align<8>>, [%270#0, %270#1] : i32, i32) mask = %269 mode = <tiled> num_cta = 2 : i32
          } {llvm.loop_annotation = #loop_annotation}
          scf.yield %262, %263, %260 : i32, i32, i32
        }
        %257:7 = scf.for %arg6 = %c0_i32 to %216 step %c1_i32 iter_args(%arg7 = %256#2, %arg8 = %256#0, %arg9 = %256#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_)  : i32 {
          %258 = arith.addi %arg6, %255 : i32
          %259 = arith.cmpi ult, %258, %216 : i32
          %260:3 = scf.if %259 -> (i32, i32, i32) {
            %int_tuple_100 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
            %ptr_101 = cute.add_offset(%ptr_8, %int_tuple_100) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %262 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %262, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            scf.if %101 {
              %272 = nvvm.elect.sync -> i1
              scf.if %272 {
                %int_tuple_120 = cute.make_int_tuple(%arg8) : (i32) -> !cute.int_tuple<"?">
                %ptr_121 = cute.add_offset(%iter_7, %int_tuple_120) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
                %273 = builtin.unrealized_conversion_cast %ptr_121 : !cute.ptr<i64, smem> to !llvm.ptr<3>
                nvvm.mbarrier.txn %273, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
              }
            }
            %263 = arith.addi %arg8, %c1_i32 : i32
            %264 = arith.addi %arg7, %c1_i32 : i32
            %265 = arith.cmpi eq, %263, %c7_i32 : i32
            %266 = arith.select %265, %c0_i32, %263 : i32
            %267 = scf.if %265 -> (i32) {
              %272 = arith.xori %arg9, %c1_i32 : i32
              scf.yield %272 : i32
            } else {
              scf.yield %arg9 : i32
            }
            ...
            %ptr_111 = cute.add_offset(%iter_7, %int_tuple_110) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %int_tuple_112 = cute.make_int_tuple(%e0_105, %e1_106) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %268 = cute_nvgpu.atom.set_value(%252, %ptr_111 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            %269 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %269 step %c1_i32  : i32 {
              %272 = cute_nvgpu.atom.get_value(%268 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %273 = cute_nvgpu.atom.get_value(%268 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%268 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
              %274:2 = cute.get_scalars(%int_tuple_112) : !cute.int_tuple<"(?{div=64},?{div=128})">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_109 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %272 : !cute.ptr<smem, align<8>>, [%274#0, %274#1] : i32, i32) mask = %273 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            %idx_113 = cute.crd2idx(%coord_102, %lay_80) : (!cute.coord<"(_,?)">, !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">) -> !cute.int_tuple<"(?{div=64},0)">
            %tup_114 = cute.add_offset(%tup_62, %idx_113) : (!cute.int_tuple<"(0,?{div=128})">, !cute.int_tuple<"(?{div=64},0)">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %e0_115, %e1_116 = cute.get_leaves(%tup_114) : !cute.int_tuple<"(?{div=64},?{div=128})">
            ...
            %ptr_118 = cute.add_offset(%iter_6, %idx_117) : (!cute.ptr<f16, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"?{div=8192}">) -> !cute.ptr<f16, smem, align<128>, S<3,4,3>>
            %int_tuple_119 = cute.make_int_tuple(%e0_115, %e1_116) : (!cute.int_tuple<"?{div=64}">, !cute.int_tuple<"?{div=128}">) -> !cute.int_tuple<"(?{div=64},?{div=128})">
            %270 = cute_nvgpu.atom.set_value(%254, %ptr_111 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>
            %271 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %271 step %c1_i32  : i32 {
              %272 = cute_nvgpu.atom.get_value(%270 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %273 = cute_nvgpu.atom.get_value(%270 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<mcast_mask>} : i16
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%270 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 2, g_stride = <"()"> mcast = true tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
              %274:2 = cute.get_scalars(%int_tuple_119) : !cute.int_tuple<"(?{div=64},?{div=128})">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_118 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %272 : !cute.ptr<smem, align<8>>, [%274#0, %274#1] : i32, i32) mask = %273 mode = <tiled> num_cta = 2 : i32
            } {llvm.loop_annotation = #loop_annotation}
            scf.yield %266, %267, %264 : i32, i32, i32
          } else {
            scf.yield %arg8, %arg9, %arg7 : i32, i32, i32
          }
          %261:4 = scf.if %215 -> (i32, i32, i32, !mma_f16_f16_f32_256x256x16_) {
            ...
            %262 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %262, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            %263 = arith.addi %arg11, %c1_i32 : i32
            %264 = arith.addi %arg10, %c1_i32 : i32
            %265 = arith.cmpi eq, %263, %c7_i32 : i32
            %266 = arith.select %265, %c0_i32, %263 : i32
            %267 = scf.if %265 -> (i32) {
              %285 = arith.xori %arg12, %c1_i32 : i32
              scf.yield %285 : i32
            } else {
              scf.yield %arg12 : i32
            }
            %coord_102 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,0,?)">
            %idx_103 = cute.crd2idx(%coord_102, %4) : (!cute.coord<"(_,_,0,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %tup_104 = cute.add_offset(%ummaSmemDesc, %idx_103) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=1024}">) -> !cute_nvgpu.smem_desc
            %idx_105 = cute.crd2idx(%coord_102, %4) : (!cute.coord<"(_,_,0,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=1024}">
            %tup_106 = cute.add_offset(%ummaSmemDesc_72, %idx_105) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=1024}">) -> !cute_nvgpu.smem_desc
            %268 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %269 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %270 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %268 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %269 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %270 step %c1_i32  : i32 {
                  %285 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                  %286 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                  %287 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                  ...
                  cute_nvgpu.arch.mma.SM100.umma(%tup_104, %tup_106, %tmem_ptr, %293, %287) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %271 = cute_nvgpu.atom.set_value(%arg13, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_107 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,1,?)">
            %idx_108 = cute.crd2idx(%coord_107, %4) : (!cute.coord<"(_,_,1,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            %tup_109 = cute.add_offset(%ummaSmemDesc, %idx_108) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %idx_110 = cute.crd2idx(%coord_107, %4) : (!cute.coord<"(_,_,1,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            %tup_111 = cute.add_offset(%ummaSmemDesc_72, %idx_110) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %272 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %273 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %274 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %272 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %273 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %274 step %c1_i32  : i32 {
                  %285 = cute_nvgpu.atom.get_value(%271 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                  %286 = cute_nvgpu.atom.get_value(%271 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                  %287 = cute_nvgpu.atom.get_value(%271 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                  %288 = arith.extui %285 : i1 to i32
                  %289 = arith.extui %286 : i1 to i32
                  %290 = arith.shli %288, %c13_i32 : i32
                  %291 = arith.shli %289, %c14_i32 : i32
                  %292 = arith.ori %290, %c272629776_i32 : i32
                  %293 = arith.ori %292, %291 : i32
                  cute_nvgpu.arch.mma.SM100.umma(%tup_109, %tup_111, %tmem_ptr, %293, %287) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %275 = cute_nvgpu.atom.set_value(%271, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_112 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,2,?)">
            %idx_113 = cute.crd2idx(%coord_112, %4) : (!cute.coord<"(_,_,2,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=4}">
            %tup_114 = cute.add_offset(%ummaSmemDesc, %idx_113) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=4}">) -> !cute_nvgpu.smem_desc
            %idx_115 = cute.crd2idx(%coord_112, %4) : (!cute.coord<"(_,_,2,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=4}">
            %tup_116 = cute.add_offset(%ummaSmemDesc_72, %idx_115) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=4}">) -> !cute_nvgpu.smem_desc
            %276 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %277 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %278 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %276 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %277 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %278 step %c1_i32  : i32 {
                  %285 = cute_nvgpu.atom.get_value(%275 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                  %286 = cute_nvgpu.atom.get_value(%275 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                  %287 = cute_nvgpu.atom.get_value(%275 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                  %288 = arith.extui %285 : i1 to i32
                  %289 = arith.extui %286 : i1 to i32
                  %290 = arith.shli %288, %c13_i32 : i32
                  %291 = arith.shli %289, %c14_i32 : i32
                  %292 = arith.ori %290, %c272629776_i32 : i32
                  %293 = arith.ori %292, %291 : i32
                  cute_nvgpu.arch.mma.SM100.umma(%tup_114, %tup_116, %tmem_ptr, %293, %287) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %279 = cute_nvgpu.atom.set_value(%275, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            %coord_117 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,3,?)">
            %idx_118 = cute.crd2idx(%coord_117, %4) : (!cute.coord<"(_,_,3,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            %tup_119 = cute.add_offset(%ummaSmemDesc, %idx_118) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %idx_120 = cute.crd2idx(%coord_117, %4) : (!cute.coord<"(_,_,3,?)">, !cute.layout<"(1,1,4,7):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
            %tup_121 = cute.add_offset(%ummaSmemDesc_72, %idx_120) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
            %280 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %281 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %282 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %280 step %c1_i32  : i32 {
              scf.for %arg15 = %c0_i32 to %281 step %c1_i32  : i32 {
                scf.for %arg16 = %c0_i32 to %282 step %c1_i32  : i32 {
                  %285 = cute_nvgpu.atom.get_value(%279 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                  %286 = cute_nvgpu.atom.get_value(%279 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                  %287 = cute_nvgpu.atom.get_value(%279 : !mma_f16_f16_f32_256x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                  %288 = arith.extui %285 : i1 to i32
                  %289 = arith.extui %286 : i1 to i32
                  %290 = arith.shli %288, %c13_i32 : i32
                  %291 = arith.shli %289, %c14_i32 : i32
                  %292 = arith.ori %290, %c272629776_i32 : i32
                  %293 = arith.ori %292, %291 : i32
                  cute_nvgpu.arch.mma.SM100.umma(%tup_119, %tup_121, %tmem_ptr, %293, %287) {num_cta = 2 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            %283 = cute_nvgpu.atom.set_value(%279, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_256x256x16_
            ...
            scf.if %284 {
              ...
              %285 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.tcgen05.commit.arrive %285, multicast_mask = %98 {group = #nvvm.tcgen05_group<cta_2>} : !llvm.ptr<3>, i16
            }
            scf.yield %264, %266, %267, %283 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          } else {
            scf.yield %arg10, %arg11, %arg12, %arg13 : i32, i32, i32, !mma_f16_f16_f32_256x256x16_
          }
          scf.yield %260#2, %260#0, %260#1, %261#0, %261#1, %261#2, %261#3 : i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_256x256x16_
        }
        scf.if %215 {
          %258 = nvvm.elect.sync -> i1
          scf.if %258 {
            %dyn_100 = cute.derefine(%iter_24) : !cute.ptr<i64, smem, align<16>> to !cute.ptr<i64, smem>
            %259 = builtin.unrealized_conversion_cast %dyn_100 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %259, multicast_mask = %c3_i16 {group = #nvvm.tcgen05_group<cta_2>} : !llvm.ptr<3>, i16
          }
        }
        scf.yield %250, %257#1, %257#2 : i32, i32, i32
      } else {
        scf.yield %c1_i32, %c0_i32, %c1_i32 : i32, i32, i32
      }
      %219 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %220 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %221 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %222 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %223 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      %229 = arith.floordivsi %228, %c32_i32 : i32
      ...
      %232 = builtin.unrealized_conversion_cast %dyn : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.try_wait.parity.shared %232, %c0_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      scf.for %arg6 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
        ...
        %idx_102 = cute.crd2idx(%coord_101, %3) : (!cute.coord<"(_,_,?)">, !cute.layout<"(((64,32),1),1,((1,4),1,1)):(((1,65536),0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        %ptr_103 = cute.add_offset(%ptr_93, %idx_102) : (!cute.ptr<f32, tmem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, tmem, align<16>>
        %249 = cute.get_scalars(%21) : !cute.int_tuple<"1">
        scf.for %arg7 = %c0_i32 to %249 step %c1_i32  : i32 {
          %253 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_103) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 64 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<64xi32>
          %254 = builtin.unrealized_conversion_cast %iter_100 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
          llvm.store %253, %254 : vector<64xi32>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %250 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
        %251 = arith.truncf %250 : vector<64xf32> to vector<64xf16>
        cute.memref.store_vec %251, %rmem_98, row_major : !memref_rmem_f16_
        %coord_104 = cute.make_coord(%arg6) : (i32) -> !cute.coord<"(_,_,?)">
        %idx_105 = cute.crd2idx(%coord_104, %2) : (!cute.coord<"(_,_,?)">, !cute.layout<"((64,1),1,((1,4),1,1)):((1,0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        ...
        %252 = cute.get_scalars(%0) : !cute.int_tuple<"8">
        scf.for %arg7 = %c0_i32 to %252 step %c1_i32  : i32 {
          %coord_108 = cute.make_coord(%arg7) : (i32) -> !cute.coord<"(_,?)">
          %idx_109 = cute.crd2idx(%coord_108, %1) : (!cute.coord<"(_,?)">, !cute.layout<"(8,(8)):(1,(8))">) -> !cute.int_tuple<"?{div=8}">
          %ptr_110 = cute.add_offset(%iter_107, %idx_109) : (!cute.ptr<f16, rmem, align<32>>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f16, rmem, align<16>>
          %idx_111 = cute.crd2idx(%coord_108, %1) : (!cute.coord<"(_,?)">, !cute.layout<"(8,(8)):(1,(8))">) -> !cute.int_tuple<"?{div=8}">
          %ptr_112 = cute.add_offset(%ptr_106, %idx_111) : (!cute.ptr<f16, gmem, align<32>>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f16, gmem, align<16>>
          %253 = builtin.unrealized_conversion_cast %ptr_110 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          %254 = builtin.unrealized_conversion_cast %ptr_112 : !cute.ptr<f16, gmem, align<16>> to !llvm.ptr<1>
          %255 = llvm.load %253 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
          llvm.store %255, %254 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      %233 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      %234 = nvvm.mapa.shared.cluster %233, %131 : !llvm.ptr<3>, i32 -> <3>
      nvvm.mbarrier.txn %234, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>, space = #nvvm.mbar_space<cluster>} : !llvm.ptr<3>, i32
      %235 = arith.cmpi eq, %40, %c0_i32 : i32
      scf.if %235 {
        %249 = arith.addi %218#1, %c1_i32 : i32
        %250 = arith.cmpi eq, %249, %c7_i32 : i32
        %251 = arith.select %250, %c0_i32, %249 : i32
        %252 = scf.if %250 -> (i32) {
          %274 = arith.xori %218#2, %c1_i32 : i32
          scf.yield %274 : i32
        } else {
          scf.yield %218#2 : i32
        }
        ...
        %272 = scf.if %270 -> (i32) {
          %274 = arith.xori %268, %c1_i32 : i32
          scf.yield %274 : i32
        } else {
          scf.yield %268 : i32
        }
        %int_tuple_100 = cute.make_int_tuple(%271) : (i32) -> !cute.int_tuple<"?">
        %ptr_101 = cute.add_offset(%ptr_8, %int_tuple_100) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
        %273 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.try_wait.parity.shared %273, %272, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        scf.if %101 {
          %274 = nvvm.elect.sync -> i1
          scf.if %274 {
            %int_tuple_102 = cute.make_int_tuple(%271) : (i32) -> !cute.int_tuple<"?">
            %ptr_103 = cute.add_offset(%iter_7, %int_tuple_102) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %275 = builtin.unrealized_conversion_cast %ptr_103 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %275, %c65536_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
          }
        }
        scf.if %215 {
          %274 = nvvm.read.ptx.sreg.cluster.ctarank : i32
          %275 = cute_nvgpu.arch.make_warp_uniform(%274) : i32
          %276 = arith.remsi %275, %c2_i32 : i32
          %277 = arith.cmpi eq, %276, %c0_i32 : i32
          scf.if %277 {
            %278 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %278, %218#0, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          }
        }
      }
      nvvm.barrier id = %c1_i32
      %236 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %237 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %238 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %239 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %240 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      scf.if %248 {
        %249 = nvvm.read.ptx.sreg.cluster.ctarank : i32
        %250 = cute_nvgpu.arch.make_warp_uniform(%249) : i32
        %251 = arith.xori %250, %c1_i32 : i32
        %252 = builtin.unrealized_conversion_cast %iter : !cute.ptr<i64, smem, align<128>> to !llvm.ptr<3>
        %253 = nvvm.mapa.shared.cluster %252, %251 : !llvm.ptr<3>, i32 -> <3>
        nvvm.mbarrier.txn %253, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>, space = #nvvm.mbar_space<cluster>} : !llvm.ptr<3>, i32
        %254 = builtin.unrealized_conversion_cast %iter : !cute.ptr<i64, smem, align<128>> to !llvm.ptr<3>
        nvvm.mbarrier.try_wait.parity.shared %254, %c0_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
  ...
  func.func @cutlass_host_function_Tensorgmemodiv8192i64div81921_Tensorgmemodiv8192i64div81921_Tensorgmemodiv8192i64div81921(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f16_, %arg2: !memref_gmem_f16_) attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @kernels::@kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK21111000_PermutationMNK____MMAAtom_ThrID21_ShapeMNK25625616_TVLayoutA2128161281256_TVLayoutB2128161281256_TVLayoutC21282561281256_CopyAtom_ThrI_0 clusters in (%c2, %c1, %c1) blocks in (%221, %222, %c1) threads in (%c128, %c1, %c1)  dynamic_shared_memory_size %c229632_i32 args(%10 : !mma_f16_f16_f32_256x256x16_, %111 : !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %view : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %213 : !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_100_2sm_multicast, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %view_8 : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg2 : !memref_gmem_f16_) {use_pdl = false}
    return
  }
}
