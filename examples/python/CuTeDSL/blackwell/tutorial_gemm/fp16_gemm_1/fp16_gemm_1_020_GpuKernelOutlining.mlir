...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb20(%502: i32, %503: i32, %504: i32, %505: i32):  // 2 preds: ^bb19, ^bb35
      %506 = llvm.icmp "slt" %502, %500 : i32
      llvm.cond_br %506, ^bb21, ^bb36
    ^bb21:  // pred: ^bb20
    ...
    ^bb32:  // pred: ^bb30
      ...
      llvm.br ^bb33(%49 : i32)
    ^bb33(%571: i32):  // 2 preds: ^bb32, ^bb34
      %572 = llvm.icmp "slt" %571, %501 : i32
      llvm.cond_br %572, ^bb34, ^bb35 {llvm.loop_annotation = #loop_annotation}
    ^bb34:  // pred: ^bb33
      ...
      llvm.br ^bb33(%578 : i32)
    ^bb35:  // pred: ^bb33
      %579 = llvm.add %502, %52 : i32
      llvm.br ^bb20(%579, %513, %515, %511 : i32, i32, i32, i32)
    ^bb36:  // pred: ^bb20
      llvm.br ^bb37(%49, %505, %503, %504, %49, %49, %49, %arg0 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb37(%580: i32, %581: i32, %582: i32, %583: i32, %584: i32, %585: i32, %586: i32, %587: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb36, ^bb102
      %588 = llvm.icmp "slt" %580, %488 : i32
      llvm.cond_br %588, ^bb38, ^bb103
    ^bb38:  // pred: ^bb37
      %589 = llvm.add %580, %500 : i32
      %590 = llvm.icmp "ult" %589, %488 : i32
      llvm.cond_br %590, ^bb39, ^bb54
    ^bb39:  // pred: ^bb38
      ...
      llvm.cond_br %189, ^bb40, ^bb43
    ^bb40:  // pred: ^bb39
      %592 = nvvm.elect.sync -> i1
      llvm.cond_br %592, ^bb41, ^bb42
    ^bb41:  // pred: ^bb40
    ...
    ^bb43:  // 2 preds: ^bb39, ^bb42
      ...
      llvm.cond_br %596, ^bb44, ^bb45
    ^bb44:  // pred: ^bb43
      %598 = llvm.xor %583, %52 : i32
      llvm.br ^bb46(%598 : i32)
    ^bb45:  // pred: ^bb43
      llvm.br ^bb46(%583 : i32)
    ^bb46(%599: i32):  // 2 preds: ^bb44, ^bb45
      llvm.br ^bb47
    ^bb47:  // pred: ^bb46
      ...
      llvm.br ^bb48(%49 : i32)
    ^bb48(%627: i32):  // 2 preds: ^bb47, ^bb49
      %628 = llvm.icmp "slt" %627, %619 : i32
      llvm.cond_br %628, ^bb49, ^bb50 {llvm.loop_annotation = #loop_annotation}
    ^bb49:  // pred: ^bb48
    ...
    ^bb50:  // pred: ^bb48
      ...
      llvm.br ^bb51(%49 : i32)
    ^bb51(%656: i32):  // 2 preds: ^bb50, ^bb52
      %657 = llvm.icmp "slt" %656, %619 : i32
      llvm.cond_br %657, ^bb52, ^bb53 {llvm.loop_annotation = #loop_annotation}
    ^bb52:  // pred: ^bb51
      ...
      llvm.br ^bb51(%663 : i32)
    ^bb53:  // pred: ^bb51
      llvm.br ^bb55(%597, %599, %595 : i32, i32, i32)
    ^bb54:  // pred: ^bb38
      llvm.br ^bb55(%582, %583, %581 : i32, i32, i32)
    ^bb55(%664: i32, %665: i32, %666: i32):  // 2 preds: ^bb53, ^bb54
      llvm.br ^bb56
    ^bb56:  // pred: ^bb55
      llvm.cond_br %189, ^bb57, ^bb100
    ^bb57:  // pred: ^bb56
      ...
      llvm.cond_br %670, ^bb58, ^bb59
    ^bb58:  // pred: ^bb57
      %672 = llvm.xor %586, %52 : i32
      llvm.br ^bb60(%672 : i32)
    ^bb59:  // pred: ^bb57
      llvm.br ^bb60(%586 : i32)
    ^bb60(%673: i32):  // 2 preds: ^bb58, ^bb59
      llvm.br ^bb61
    ^bb61:  // pred: ^bb60
      ...
      llvm.br ^bb62(%49 : i32)
    ^bb62(%700: i32):  // 2 preds: ^bb61, ^bb69
      %701 = llvm.icmp "slt" %700, %690 : i32
      llvm.cond_br %701, ^bb63, ^bb70 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%49 : i32)
    ^bb64(%702: i32):  // 2 preds: ^bb63, ^bb68
      %703 = llvm.icmp "slt" %702, %690 : i32
      llvm.cond_br %703, ^bb65, ^bb69 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
      llvm.br ^bb66(%49 : i32)
    ^bb66(%704: i32):  // 2 preds: ^bb65, ^bb67
      %705 = llvm.icmp "slt" %704, %690 : i32
      llvm.cond_br %705, ^bb67, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb67:  // pred: ^bb66
      ...
      llvm.br ^bb66(%709 : i32)
    ^bb68:  // pred: ^bb66
      %710 = llvm.add %702, %52 : i32
      llvm.br ^bb64(%710 : i32)
    ^bb69:  // pred: ^bb64
      %711 = llvm.add %700, %52 : i32
      llvm.br ^bb62(%711 : i32)
    ^bb70:  // pred: ^bb62
      ...
      llvm.br ^bb71(%49 : i32)
    ^bb71(%740: i32):  // 2 preds: ^bb70, ^bb78
      %741 = llvm.icmp "slt" %740, %690 : i32
      llvm.cond_br %741, ^bb72, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
      llvm.br ^bb73(%49 : i32)
    ^bb73(%742: i32):  // 2 preds: ^bb72, ^bb77
      %743 = llvm.icmp "slt" %742, %690 : i32
      llvm.cond_br %743, ^bb74, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
      llvm.br ^bb75(%49 : i32)
    ^bb75(%744: i32):  // 2 preds: ^bb74, ^bb76
      %745 = llvm.icmp "slt" %744, %690 : i32
      llvm.cond_br %745, ^bb76, ^bb77 {llvm.loop_annotation = #loop_annotation}
    ^bb76:  // pred: ^bb75
      ...
      llvm.br ^bb75(%749 : i32)
    ^bb77:  // pred: ^bb75
      %750 = llvm.add %742, %52 : i32
      llvm.br ^bb73(%750 : i32)
    ^bb78:  // pred: ^bb73
      %751 = llvm.add %740, %52 : i32
      llvm.br ^bb71(%751 : i32)
    ^bb79:  // pred: ^bb71
      ...
      llvm.br ^bb80(%49 : i32)
    ^bb80(%780: i32):  // 2 preds: ^bb79, ^bb87
      %781 = llvm.icmp "slt" %780, %690 : i32
      llvm.cond_br %781, ^bb81, ^bb88 {llvm.loop_annotation = #loop_annotation}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%49 : i32)
    ^bb82(%782: i32):  // 2 preds: ^bb81, ^bb86
      %783 = llvm.icmp "slt" %782, %690 : i32
      llvm.cond_br %783, ^bb83, ^bb87 {llvm.loop_annotation = #loop_annotation}
    ^bb83:  // pred: ^bb82
      llvm.br ^bb84(%49 : i32)
    ^bb84(%784: i32):  // 2 preds: ^bb83, ^bb85
      %785 = llvm.icmp "slt" %784, %690 : i32
      llvm.cond_br %785, ^bb85, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb85:  // pred: ^bb84
    ...
    ^bb86:  // pred: ^bb84
      ...
      llvm.br ^bb82(%790 : i32)
    ^bb87:  // pred: ^bb82
      %791 = llvm.add %780, %52 : i32
      llvm.br ^bb80(%791 : i32)
    ^bb88:  // pred: ^bb80
      ...
      llvm.br ^bb89(%49 : i32)
    ^bb89(%820: i32):  // 2 preds: ^bb88, ^bb96
      %821 = llvm.icmp "slt" %820, %690 : i32
      llvm.cond_br %821, ^bb90, ^bb97 {llvm.loop_annotation = #loop_annotation}
    ^bb90:  // pred: ^bb89
      llvm.br ^bb91(%49 : i32)
    ^bb91(%822: i32):  // 2 preds: ^bb90, ^bb95
      %823 = llvm.icmp "slt" %822, %690 : i32
      llvm.cond_br %823, ^bb92, ^bb96 {llvm.loop_annotation = #loop_annotation}
    ^bb92:  // pred: ^bb91
      llvm.br ^bb93(%49 : i32)
    ^bb93(%824: i32):  // 2 preds: ^bb92, ^bb94
      %825 = llvm.icmp "slt" %824, %690 : i32
      llvm.cond_br %825, ^bb94, ^bb95 {llvm.loop_annotation = #loop_annotation}
    ^bb94:  // pred: ^bb93
    ...
    ^bb99:  // 2 preds: ^bb97, ^bb98
      llvm.br ^bb101(%669, %671, %673, %832 : i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb100:  // pred: ^bb56
      llvm.br ^bb101(%584, %585, %586, %587 : i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb101(%835: i32, %836: i32, %837: i32, %838: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb99, ^bb100
      llvm.br ^bb102
    ^bb102:  // pred: ^bb101
      %839 = llvm.add %580, %52 : i32
      llvm.br ^bb37(%839, %666, %664, %665, %835, %836, %837, %838 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb103:  // pred: ^bb37
      llvm.cond_br %189, ^bb104, ^bb107
    ^bb104:  // pred: ^bb103
      %840 = nvvm.elect.sync -> i1
      llvm.cond_br %840, ^bb105, ^bb106
    ^bb105:  // pred: ^bb104
    ...
    ^bb107:  // 2 preds: ^bb103, ^bb106
      llvm.br ^bb109(%490, %582, %583 : i32, i32, i32)
    ^bb108:  // pred: ^bb16
      llvm.br ^bb109(%52, %49, %52 : i32, i32, i32)
    ^bb109(%841: i32, %842: i32, %843: i32):  // 2 preds: ^bb107, ^bb108
      llvm.br ^bb110
    ^bb110:  // pred: ^bb109
      llvm.cond_br %125, ^bb111, ^bb112
    ^bb111:  // pred: ^bb110
    ...
    ^bb112:  // 2 preds: ^bb110, ^bb111
      ...
      llvm.br ^bb113(%49 : i32)
    ^bb113(%848: i32):  // 2 preds: ^bb112, ^bb120
      %849 = llvm.icmp "slt" %848, %14 : i32
      llvm.cond_br %849, ^bb114, ^bb121
    ^bb114:  // pred: ^bb113
      ...
      llvm.br ^bb115(%49 : i32)
    ^bb115(%859: i32):  // 2 preds: ^bb114, ^bb116
      %860 = llvm.icmp "slt" %859, %845 : i32
      llvm.cond_br %860, ^bb116, ^bb117 {llvm.loop_annotation = #loop_annotation}
    ^bb116:  // pred: ^bb115
    ...
    ^bb117:  // pred: ^bb115
      ...
      llvm.br ^bb118(%49 : i32)
    ^bb118(%885: i32):  // 2 preds: ^bb117, ^bb119
      %886 = llvm.icmp "slt" %885, %847 : i32
      llvm.cond_br %886, ^bb119, ^bb120 {llvm.loop_annotation = #loop_annotation}
    ^bb119:  // pred: ^bb118
      ...
      llvm.br ^bb118(%894 : i32)
    ^bb120:  // pred: ^bb118
      %895 = llvm.add %848, %52 : i32
      llvm.br ^bb113(%895 : i32)
    ^bb121:  // pred: ^bb113
    ...
    ^bb146:  // pred: ^bb145
      ...
      llvm.cond_br %189, ^bb147, ^bb150
    ^bb147:  // pred: ^bb146
      %928 = nvvm.elect.sync -> i1
      llvm.cond_br %928, ^bb148, ^bb149
    ^bb148:  // pred: ^bb147
    ...
    ^bb150:  // 2 preds: ^bb146, ^bb149
      llvm.cond_br %189, ^bb151, ^bb154
    ^bb151:  // pred: ^bb150
      %930 = llvm.srem %161, %58 : i32
      %931 = llvm.icmp "eq" %930, %49 : i32
      llvm.cond_br %931, ^bb152, ^bb153
    ^bb152:  // pred: ^bb151
