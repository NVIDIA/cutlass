...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb20(%503: i32, %504: i32, %505: i32, %506: i32):  // 2 preds: ^bb19, ^bb35
      %507 = llvm.icmp "slt" %503, %501 : i32
      llvm.cond_br %507, ^bb21, ^bb36
    ^bb21:  // pred: ^bb20
    ...
    ^bb29:  // pred: ^bb28
      ...
      llvm.br ^bb30(%50 : i32)
    ^bb30(%542: i32):  // 2 preds: ^bb29, ^bb31
      %543 = llvm.icmp "slt" %542, %502 : i32
      llvm.cond_br %543, ^bb31, ^bb32 {llvm.loop_annotation = #loop_annotation}
    ^bb31:  // pred: ^bb30
    ...
    ^bb32:  // pred: ^bb30
      ...
      llvm.br ^bb33(%50 : i32)
    ^bb33(%570: i32):  // 2 preds: ^bb32, ^bb34
      %571 = llvm.icmp "slt" %570, %502 : i32
      llvm.cond_br %571, ^bb34, ^bb35 {llvm.loop_annotation = #loop_annotation}
    ^bb34:  // pred: ^bb33
      ...
      llvm.br ^bb33(%577 : i32)
    ^bb35:  // pred: ^bb33
      %578 = llvm.add %503, %53 : i32
      llvm.br ^bb20(%578, %514, %516, %512 : i32, i32, i32, i32)
    ^bb36:  // pred: ^bb20
      llvm.br ^bb37(%50, %506, %504, %505, %50, %50, %50, %arg0 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb37(%579: i32, %580: i32, %581: i32, %582: i32, %583: i32, %584: i32, %585: i32, %586: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb36, ^bb102
      %587 = llvm.icmp "slt" %579, %489 : i32
      llvm.cond_br %587, ^bb38, ^bb103
    ^bb38:  // pred: ^bb37
      %588 = llvm.add %579, %501 : i32
      %589 = llvm.icmp "ult" %588, %489 : i32
      llvm.cond_br %589, ^bb39, ^bb54
    ^bb39:  // pred: ^bb38
      ...
      llvm.cond_br %190, ^bb40, ^bb43
    ^bb40:  // pred: ^bb39
      %591 = nvvm.elect.sync -> i1
      llvm.cond_br %591, ^bb41, ^bb42
    ^bb41:  // pred: ^bb40
    ...
    ^bb43:  // 2 preds: ^bb39, ^bb42
      ...
      llvm.cond_br %595, ^bb44, ^bb45
    ^bb44:  // pred: ^bb43
      %597 = llvm.xor %582, %53 : i32
      llvm.br ^bb46(%597 : i32)
    ^bb45:  // pred: ^bb43
      llvm.br ^bb46(%582 : i32)
    ^bb46(%598: i32):  // 2 preds: ^bb44, ^bb45
      llvm.br ^bb47
    ^bb47:  // pred: ^bb46
      ...
      llvm.br ^bb48(%50 : i32)
    ^bb48(%625: i32):  // 2 preds: ^bb47, ^bb49
      %626 = llvm.icmp "slt" %625, %618 : i32
      llvm.cond_br %626, ^bb49, ^bb50 {llvm.loop_annotation = #loop_annotation}
    ^bb49:  // pred: ^bb48
    ...
    ^bb50:  // pred: ^bb48
      ...
      llvm.br ^bb51(%50 : i32)
    ^bb51(%653: i32):  // 2 preds: ^bb50, ^bb52
      %654 = llvm.icmp "slt" %653, %618 : i32
      llvm.cond_br %654, ^bb52, ^bb53 {llvm.loop_annotation = #loop_annotation}
    ^bb52:  // pred: ^bb51
      ...
      llvm.br ^bb51(%660 : i32)
    ^bb53:  // pred: ^bb51
      llvm.br ^bb55(%596, %598, %594 : i32, i32, i32)
    ^bb54:  // pred: ^bb38
      llvm.br ^bb55(%581, %582, %580 : i32, i32, i32)
    ^bb55(%661: i32, %662: i32, %663: i32):  // 2 preds: ^bb53, ^bb54
      llvm.br ^bb56
    ^bb56:  // pred: ^bb55
      llvm.cond_br %190, ^bb57, ^bb100
    ^bb57:  // pred: ^bb56
      ...
      llvm.cond_br %667, ^bb58, ^bb59
    ^bb58:  // pred: ^bb57
      %669 = llvm.xor %585, %53 : i32
      llvm.br ^bb60(%669 : i32)
    ^bb59:  // pred: ^bb57
      llvm.br ^bb60(%585 : i32)
    ^bb60(%670: i32):  // 2 preds: ^bb58, ^bb59
      llvm.br ^bb61
    ^bb61:  // pred: ^bb60
      ...
      llvm.br ^bb62(%50 : i32)
    ^bb62(%697: i32):  // 2 preds: ^bb61, ^bb69
      %698 = llvm.icmp "slt" %697, %687 : i32
      llvm.cond_br %698, ^bb63, ^bb70 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%50 : i32)
    ^bb64(%699: i32):  // 2 preds: ^bb63, ^bb68
      %700 = llvm.icmp "slt" %699, %687 : i32
      llvm.cond_br %700, ^bb65, ^bb69 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
      llvm.br ^bb66(%50 : i32)
    ^bb66(%701: i32):  // 2 preds: ^bb65, ^bb67
      %702 = llvm.icmp "slt" %701, %687 : i32
      llvm.cond_br %702, ^bb67, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb67:  // pred: ^bb66
      ...
      llvm.br ^bb66(%706 : i32)
    ^bb68:  // pred: ^bb66
      %707 = llvm.add %699, %53 : i32
      llvm.br ^bb64(%707 : i32)
    ^bb69:  // pred: ^bb64
      %708 = llvm.add %697, %53 : i32
      llvm.br ^bb62(%708 : i32)
    ^bb70:  // pred: ^bb62
      ...
      llvm.br ^bb71(%50 : i32)
    ^bb71(%737: i32):  // 2 preds: ^bb70, ^bb78
      %738 = llvm.icmp "slt" %737, %687 : i32
      llvm.cond_br %738, ^bb72, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
      llvm.br ^bb73(%50 : i32)
    ^bb73(%739: i32):  // 2 preds: ^bb72, ^bb77
      %740 = llvm.icmp "slt" %739, %687 : i32
      llvm.cond_br %740, ^bb74, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
      llvm.br ^bb75(%50 : i32)
    ^bb75(%741: i32):  // 2 preds: ^bb74, ^bb76
      %742 = llvm.icmp "slt" %741, %687 : i32
      llvm.cond_br %742, ^bb76, ^bb77 {llvm.loop_annotation = #loop_annotation}
    ^bb76:  // pred: ^bb75
      ...
      llvm.br ^bb75(%746 : i32)
    ^bb77:  // pred: ^bb75
      %747 = llvm.add %739, %53 : i32
      llvm.br ^bb73(%747 : i32)
    ^bb78:  // pred: ^bb73
      %748 = llvm.add %737, %53 : i32
      llvm.br ^bb71(%748 : i32)
    ^bb79:  // pred: ^bb71
      ...
      llvm.br ^bb80(%50 : i32)
    ^bb80(%777: i32):  // 2 preds: ^bb79, ^bb87
      %778 = llvm.icmp "slt" %777, %687 : i32
      llvm.cond_br %778, ^bb81, ^bb88 {llvm.loop_annotation = #loop_annotation}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%50 : i32)
    ^bb82(%779: i32):  // 2 preds: ^bb81, ^bb86
      %780 = llvm.icmp "slt" %779, %687 : i32
      llvm.cond_br %780, ^bb83, ^bb87 {llvm.loop_annotation = #loop_annotation}
    ^bb83:  // pred: ^bb82
      llvm.br ^bb84(%50 : i32)
    ^bb84(%781: i32):  // 2 preds: ^bb83, ^bb85
      %782 = llvm.icmp "slt" %781, %687 : i32
      llvm.cond_br %782, ^bb85, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb85:  // pred: ^bb84
      ...
      llvm.br ^bb84(%786 : i32)
    ^bb86:  // pred: ^bb84
      %787 = llvm.add %779, %53 : i32
      llvm.br ^bb82(%787 : i32)
    ^bb87:  // pred: ^bb82
      %788 = llvm.add %777, %53 : i32
      llvm.br ^bb80(%788 : i32)
    ^bb88:  // pred: ^bb80
      ...
      llvm.br ^bb89(%50 : i32)
    ^bb89(%817: i32):  // 2 preds: ^bb88, ^bb96
      %818 = llvm.icmp "slt" %817, %687 : i32
      llvm.cond_br %818, ^bb90, ^bb97 {llvm.loop_annotation = #loop_annotation}
    ^bb90:  // pred: ^bb89
      llvm.br ^bb91(%50 : i32)
    ^bb91(%819: i32):  // 2 preds: ^bb90, ^bb95
      %820 = llvm.icmp "slt" %819, %687 : i32
      llvm.cond_br %820, ^bb92, ^bb96 {llvm.loop_annotation = #loop_annotation}
    ^bb92:  // pred: ^bb91
      llvm.br ^bb93(%50 : i32)
    ^bb93(%821: i32):  // 2 preds: ^bb92, ^bb94
      %822 = llvm.icmp "slt" %821, %687 : i32
      llvm.cond_br %822, ^bb94, ^bb95 {llvm.loop_annotation = #loop_annotation}
    ^bb94:  // pred: ^bb93
    ...
    ^bb99:  // 2 preds: ^bb97, ^bb98
      llvm.br ^bb101(%666, %668, %670, %829 : i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb100:  // pred: ^bb56
      llvm.br ^bb101(%583, %584, %585, %586 : i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb101(%832: i32, %833: i32, %834: i32, %835: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb99, ^bb100
      llvm.br ^bb102
    ^bb102:  // pred: ^bb101
      %836 = llvm.add %579, %53 : i32
      llvm.br ^bb37(%836, %663, %661, %662, %832, %833, %834, %835 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb103:  // pred: ^bb37
      llvm.cond_br %190, ^bb104, ^bb107
    ^bb104:  // pred: ^bb103
      %837 = nvvm.elect.sync -> i1
      llvm.cond_br %837, ^bb105, ^bb106
    ^bb105:  // pred: ^bb104
    ...
    ^bb107:  // 2 preds: ^bb103, ^bb106
      llvm.br ^bb109(%491, %581, %582 : i32, i32, i32)
    ^bb108:  // pred: ^bb16
      llvm.br ^bb109(%53, %50, %53 : i32, i32, i32)
    ^bb109(%838: i32, %839: i32, %840: i32):  // 2 preds: ^bb107, ^bb108
      llvm.br ^bb110
    ^bb110:  // pred: ^bb109
      llvm.cond_br %126, ^bb111, ^bb112
    ^bb111:  // pred: ^bb110
    ...
    ^bb112:  // 2 preds: ^bb110, ^bb111
      ...
      llvm.br ^bb113(%50 : i32)
    ^bb113(%845: i32):  // 2 preds: ^bb112, ^bb120
      %846 = llvm.icmp "slt" %845, %15 : i32
      llvm.cond_br %846, ^bb114, ^bb121
    ^bb114:  // pred: ^bb113
      ...
      llvm.br ^bb115(%50 : i32)
    ^bb115(%856: i32):  // 2 preds: ^bb114, ^bb116
      %857 = llvm.icmp "slt" %856, %842 : i32
      llvm.cond_br %857, ^bb116, ^bb117 {llvm.loop_annotation = #loop_annotation}
    ^bb116:  // pred: ^bb115
    ...
    ^bb117:  // pred: ^bb115
      ...
      llvm.br ^bb118(%50 : i32)
    ^bb118(%884: i32):  // 2 preds: ^bb117, ^bb119
      %885 = llvm.icmp "slt" %884, %844 : i32
      llvm.cond_br %885, ^bb119, ^bb120 {llvm.loop_annotation = #loop_annotation}
    ^bb119:  // pred: ^bb118
      ...
      llvm.br ^bb118(%893 : i32)
    ^bb120:  // pred: ^bb118
      %894 = llvm.add %845, %53 : i32
      llvm.br ^bb113(%894 : i32)
    ^bb121:  // pred: ^bb113
    ...
    ^bb142:  // pred: ^bb141
      ...
      llvm.cond_br %922, ^bb143, ^bb144
    ^bb143:  // pred: ^bb142
      %924 = llvm.xor %920, %53 : i32
      llvm.br ^bb145(%924 : i32)
    ^bb144:  // pred: ^bb142
      llvm.br ^bb145(%920 : i32)
    ^bb145(%925: i32):  // 2 preds: ^bb143, ^bb144
      llvm.br ^bb146
    ^bb146:  // pred: ^bb145
      ...
      llvm.cond_br %190, ^bb147, ^bb150
    ^bb147:  // pred: ^bb146
      %927 = nvvm.elect.sync -> i1
      llvm.cond_br %927, ^bb148, ^bb149
    ^bb148:  // pred: ^bb147
    ...
    ^bb150:  // 2 preds: ^bb146, ^bb149
      llvm.cond_br %190, ^bb151, ^bb154
    ^bb151:  // pred: ^bb150
      %929 = llvm.srem %162, %59 : i32
      %930 = llvm.icmp "eq" %929, %50 : i32
      llvm.cond_br %930, ^bb152, ^bb153
    ^bb152:  // pred: ^bb151
