...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb13:  // pred: ^bb12
      "nvvm.mbarrier.try_wait.parity.shared"(%317, %276, %267) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb15:  // pred: ^bb14
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%422, %419, %267) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb29:  // pred: ^bb28
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%450, %443, %267) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb41:  // pred: ^bb40
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%470, %445, %267) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb61:  // 2 preds: ^bb59, ^bb60
      "nvvm.mbarrier.try_wait.parity.shared"(%301, %260, %267) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
