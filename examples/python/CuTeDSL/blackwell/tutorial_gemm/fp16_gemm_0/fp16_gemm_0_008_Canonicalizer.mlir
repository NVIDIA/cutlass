...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK12825616_TVLayoutA1128161281128_TVLayoutB1256162561256_TVLayoutC11282561281128_CopyAtom_ThrI_0(%arg0: !mma_f16_f16_f32_128x256x16_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg2: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 262144, tma_gbasis = <"(64,256):(1@1,1@0)">, internal_val_type = f16>, %arg4: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg5: !memref_gmem_f16_) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_2 = cute.add_offset(%45, %22) : (!cute.ptr<i8, smem, align<128>>, !cute.int_tuple<"65536">) -> !cute.ptr<i8, smem, align<128>>
      ...
      %65 = arith.muli %61, %63 : i32
      %66 = arith.addi %60, %65 : i32
      %67 = arith.muli %62, %63 : i32
      %68 = arith.muli %67, %64 : i32
      %69 = arith.addi %66, %68 : i32
      %70 = arith.floordivsi %69, %c32_i32 : i32
      %71 = cute_nvgpu.arch.make_warp_uniform(%70) : i32
      %72 = arith.cmpi eq, %71, %c0_i32 : i32
      scf.if %72 {
        %179 = builtin.unrealized_conversion_cast %iter_5 : !cute.ptr<i64, smem, align<1024>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %179, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_62 = cute.add_offset(%iter_5, %21) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"1">) -> !cute.ptr<i64, smem>
        %180 = builtin.unrealized_conversion_cast %ptr_62 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %180, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_63 = cute.add_offset(%iter_5, %20) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"2">) -> !cute.ptr<i64, smem, align<16>>
        %181 = builtin.unrealized_conversion_cast %ptr_63 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %181, %c1_i32 : !llvm.ptr<3>, i32
        %ptr_64 = cute.add_offset(%iter_5, %19) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"3">) -> !cute.ptr<i64, smem>
        %182 = builtin.unrealized_conversion_cast %ptr_64 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %182, %c1_i32 : !llvm.ptr<3>, i32
      }
      ...
      scf.if %85 {
        %179 = builtin.unrealized_conversion_cast %ptr_6 : !cute.ptr<i64, smem, align<32>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %179, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %180 = builtin.unrealized_conversion_cast %ptr_63 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %180, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %181 = builtin.unrealized_conversion_cast %ptr_65 : !cute.ptr<i64, smem, align<16>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %181, %c1_i32 : !llvm.ptr<3>, i32
        ...
        %182 = builtin.unrealized_conversion_cast %ptr_67 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %182, %c1_i32 : !llvm.ptr<3>, i32
      }
      ...
      scf.if %98 {
        %179 = builtin.unrealized_conversion_cast %iter_7 : !cute.ptr<i64, smem, align<64>> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %179, %c1_i32 : !llvm.ptr<3>, i32
      }
      ...
      scf.if %111 {
        %179 = builtin.unrealized_conversion_cast %ptr_8 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.init.shared %179, %c128_i32 : !llvm.ptr<3>, i32
      }
      nvvm.fence.mbarrier.init
      nvvm.barrier
      %coord = cute.make_coord(%39, %40) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %112:2 = cute.get_scalars(%coord) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_9 = cute.make_coord(%112#0) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay = cute.get_layout(%arg2) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %113:2 = cute.get_scalars(%lay) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %114 = arith.ceildivsi %113#0, %c128_i32 : i32
      %115 = arith.ceildivsi %113#1, %c64_i32 : i32
      %shape = cute.make_shape(%114, %115) : (i32, i32) -> !cute.shape<"((128,64),(?,?))">
      %lay_10 = cute.make_layout(%shape, %17) : !cute.layout<"((128,64),(?,?)):((1@1,1@0),(128@1,64@0))">
      %116:2 = cute.get_scalars(%lay_10) <{only_dynamic}> : !cute.layout<"((128,64),(?,?)):((1@1,1@0),(128@1,64@0))">
      %shape_11 = cute.make_shape(%116#1) : (i32) -> !cute.shape<"(128,64,?)">
      ...
      %coord_13 = cute.make_coord(%39, %40) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %117:2 = cute.get_scalars(%coord_13) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_14 = cute.make_coord(%117#1) : (i32) -> !cute.coord<"((_,_),(?,_))">
      %lay_15 = cute.get_layout(%arg4) : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">
      %118:2 = cute.get_scalars(%lay_15) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(1@1,1@0)">
      %119 = arith.ceildivsi %118#0, %c256_i32 : i32
      %120 = arith.ceildivsi %118#1, %c64_i32 : i32
      %shape_16 = cute.make_shape(%119, %120) : (i32, i32) -> !cute.shape<"((256,64),(?,?))">
      %lay_17 = cute.make_layout(%shape_16, %14) : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %121:2 = cute.get_scalars(%lay_17) <{only_dynamic}> : !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">
      %shape_18 = cute.make_shape(%121#1) : (i32) -> !cute.shape<"(256,64,?)">
      %lay_19 = cute.make_layout(%shape_18, %16) : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %idx_20 = cute.crd2idx(%coord_14, %lay_17) : (!cute.coord<"((_,_),(?,_))">, !cute.layout<"((256,64),(?,?)):((1@1,1@0),(256@1,64@0))">) -> !cute.int_tuple<"(0,?{div=256})">
      %tup_21 = cute.add_offset(%15, %idx_20) : (!cute.int_tuple<"(0,0)">, !cute.int_tuple<"(0,?{div=256})">) -> !cute.int_tuple<"(0,?{div=256})">
      %coord_22 = cute.make_coord(%39, %40) : (i32, i32) -> !cute.coord<"(?,?,_)">
      %122:2 = cute.get_scalars(%coord_22) <{only_dynamic}> : !cute.coord<"(?,?,_)">
      %coord_23 = cute.make_coord(%122#0, %122#1) : (i32, i32) -> !cute.coord<"((_,_),(?,?))">
      %lay_24 = cute.get_layout(%arg5) : !memref_gmem_f16_
      %123:3 = cute.get_scalars(%lay_24) <{only_dynamic}> : !cute.layout<"(?,?{div=8192}):(?{i64 div=8192},1)">
      %124 = arith.ceildivsi %123#0, %c128_i32 : i32
      %125 = arith.muli %123#2, %c128_i64 : i64
      %126 = arith.ceildivsi %123#1, %c256_i32 : i32
      %shape_25 = cute.make_shape(%124, %126) : (i32, i32) -> !cute.shape<"((128,256),(?,?))">
      %iv_26 = cute.assume(%123#2) : (i64) -> !cute.i64<divby 8192>
      %iv_27 = cute.assume(%125) : (i64) -> !cute.i64<divby 1048576>
      ...
      %127:4 = cute.get_scalars(%lay_28) <{only_dynamic}> : !cute.layout<"((128,256),(?,?)):((?{i64 div=8192},1),(?{i64 div=1048576},256))">
      %iv_29 = cute.assume(%127#2) : (i64) -> !cute.i64<divby 8192>
      %stride_30 = cute.make_stride(%iv_29) : (!cute.i64<divby 8192>) -> !cute.stride<"(?{i64 div=8192},1)">
      %lay_31 = cute.make_layout(%13, %stride_30) : !cute.layout<"(128,256):(?{i64 div=8192},1)">
      ...
      %128 = cute.get_scalars(%lay_12) <{only_dynamic}> : !cute.layout<"(128,64,?):(1@1,1@0,64@0)">
      %shape_35 = cute.make_shape(%128) : (i32) -> !cute.shape<"((128,16),1,4,?)">
      %lay_36 = cute.make_layout(%shape_35, %12) : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %129 = cute.get_scalars(%lay_19) <{only_dynamic}> : !cute.layout<"(256,64,?):(1@1,1@0,64@0)">
      %shape_37 = cute.make_shape(%129) : (i32) -> !cute.shape<"((256,16),1,4,?)">
      %lay_38 = cute.make_layout(%shape_37, %12) : !cute.layout<"((256,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %130 = cute.get_scalars(%lay_31) <{only_dynamic}> : !cute.layout<"(128,256):(?{i64 div=8192},1)">
      %iv_39 = cute.assume(%130) : (i64) -> !cute.i64<divby 8192>
      %stride_40 = cute.make_stride(%iv_39) : (!cute.i64<divby 8192>) -> !cute.stride<"((?{i64 div=8192},1),0,0)">
      %lay_41 = cute.make_layout(%11, %stride_40) : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      ...
      %131 = cute.get_scalars(%lay_36) <{only_dynamic}> : !cute.layout<"((128,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_43 = cute.make_shape(%131) : (i32) -> !cute.shape<"(((128,16),1,4),?)">
      %lay_44 = cute.make_layout(%shape_43, %10) : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %132 = cute.get_scalars(%lay_44) <{only_dynamic}> : !cute.layout<"(((128,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_45 = cute.make_shape(%132) : (i32) -> !cute.shape<"(((64,128),1),?)">
      %lay_46 = cute.make_layout(%shape_45, %9) : !cute.layout<"(((64,128),1),?):(((1@0,1@1),0),64@0)">
      %133 = cute.get_scalars(%lay_38) <{only_dynamic}> : !cute.layout<"((256,16),1,4,?):((1@1,1@0),0,16@0,64@0)">
      %shape_47 = cute.make_shape(%133) : (i32) -> !cute.shape<"(((256,16),1,4),?)">
      %lay_48 = cute.make_layout(%shape_47, %10) : !cute.layout<"(((256,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %134 = cute.get_scalars(%lay_48) <{only_dynamic}> : !cute.layout<"(((256,16),1,4),?):(((1@1,1@0),0,16@0),64@0)">
      %shape_49 = cute.make_shape(%134) : (i32) -> !cute.shape<"(((64,256),1),?)">
      %lay_50 = cute.make_layout(%shape_49, %9) : !cute.layout<"(((64,256),1),?):(((1@0,1@1),0),64@0)">
      nvvm.barrier id = %c1_i32 number_of_threads = %c128_i32
      %tmem_ptr = cute_nvgpu.arch.sm100.retrieve_tmem_ptr(%iter) : !cute.ptr<i32, smem, align<16>> -> !cute.ptr<f32, tmem, align<16>>
      %135 = cute.get_scalars(%lay_41) <{only_dynamic}> : !cute.layout<"((128,256),1,1):((?{i64 div=8192},1),0,0)">
      %iv_51 = cute.assume(%135) : (i64) -> !cute.i64<divby 8192>
      %stride_52 = cute.make_stride(%iv_51) : (!cute.i64<divby 8192>) -> !cute.stride<"(((?{i64 div=8192},1)),((0,64),0,0))">
      %lay_53 = cute.make_layout(%8, %stride_52) : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %coord_54 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %136 = cute.get_scalars(%coord_54) <{only_dynamic}> : !cute.coord<"?">
      %137 = arith.divsi %136, %c32_i32 : i32
      %138 = arith.muli %137, %c2097152_i32 : i32
      %iv_55 = cute.assume(%138) : (i32) -> !cute.i32<divby 2097152>
      ...
      %coord_57 = cute.make_coord(%26) : (i32) -> !cute.coord<"?">
      %139 = cute.get_scalars(%lay_53) <{only_dynamic}> : !cute.layout<"(((128,64)),((1,4),1,1)):(((?{i64 div=8192},1)),((0,64),0,0))">
      %140 = cute.get_scalars(%coord_57) <{only_dynamic}> : !cute.coord<"?">
      %141 = arith.muli %139, %c32_i64 : i64
      %142 = arith.divsi %140, %c32_i32 : i32
      %143 = arith.remsi %140, %c32_i32 : i32
      %144 = arith.extsi %143 : i32 to i64
      %145 = arith.muli %144, %139 : i64
      %146 = arith.extsi %142 : i32 to i64
      %147 = arith.muli %146, %141 : i64
      %148 = arith.addi %145, %147 : i64
      %iv_58 = cute.assume(%148) : (i64) -> !cute.i64<divby 8192>
      ...
      %149 = cute.get_scalars(%e0) : !cute.int_tuple<"?">
      %150 = arith.cmpi eq, %38, %c0_i32 : i32
      scf.if %150 {
        %179 = builtin.unrealized_conversion_cast %ptr_8 : !cute.ptr<i64, smem> to !llvm.ptr<3>
        nvvm.mbarrier.try_wait.parity.shared %179, %c1_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
        %180 = cute_nvgpu.atom.make_exec_tma(%arg1) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>
        %181 = cute_nvgpu.atom.make_exec_tma(%arg3) : (!cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 262144, tma_gbasis = <"(64,256):(1@1,1@0)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>
        %182 = arith.minsi %149, %c2_i32 : i32
        %183:3 = scf.for %arg6 = %c0_i32 to %182 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          %186 = builtin.unrealized_conversion_cast %ptr_63 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %186, %arg8, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          ...
          scf.if %187 {
            ...
            %197 = builtin.unrealized_conversion_cast %ptr_82 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %197, %c49152_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
          }
          %188 = arith.addi %arg7, %c1_i32 : i32
          %189 = arith.addi %arg9, %c1_i32 : i32
          %190 = arith.cmpi eq, %188, %c4_i32 : i32
          %191 = arith.select %190, %c0_i32, %188 : i32
          %192 = scf.if %190 -> (i32) {
            %197 = arith.xori %arg8, %c1_i32 : i32
            scf.yield %197 : i32
          } else {
            scf.yield %arg8 : i32
          }
          ...
          %idx_69 = cute.crd2idx(%coord_68, %7) : (!cute.coord<"(_,?)">, !cute.layout<"((8192,1),4):((1,0),8192)">) -> !cute.int_tuple<"?{div=8192}">
          ...
          %193 = cute_nvgpu.atom.set_value(%180, %ptr_72 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>
          %194 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg10 = %c0_i32 to %194 step %c1_i32  : i32 {
            %197 = cute_nvgpu.atom.get_value(%193 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%193 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %198:2 = cute.get_scalars(%int_tuple_73) : !cute.int_tuple<"(?{div=64},?{div=128})">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_70 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %197 : !cute.ptr<smem, align<8>>, [%198#0, %198#1] : i32, i32) mode = <tiled> num_cta = 1 : i32
          ...
          %idx_78 = cute.crd2idx(%coord_68, %6) : (!cute.coord<"(_,?)">, !cute.layout<"((16384,1),4):((1,0),16384)">) -> !cute.int_tuple<"?{div=16384}">
          ...
          %195 = cute_nvgpu.atom.set_value(%181, %ptr_72 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>
          %196 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg10 = %c0_i32 to %196 step %c1_i32  : i32 {
            %197 = cute_nvgpu.atom.get_value(%195 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%195 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %198:2 = cute.get_scalars(%int_tuple_80) : !cute.int_tuple<"(?{div=64},?{div=256})">
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_79 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %197 : !cute.ptr<smem, align<8>>, [%198#0, %198#1] : i32, i32) mode = <tiled> num_cta = 1 : i32
          } {llvm.loop_annotation = #loop_annotation}
          scf.yield %191, %192, %189 : i32, i32, i32
        }
        %184:7 = scf.for %arg6 = %c0_i32 to %149 step %c1_i32 iter_args(%arg7 = %183#2, %arg8 = %183#0, %arg9 = %183#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %arg0) -> (i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_128x256x16_)  : i32 {
          %186 = arith.addi %arg6, %182 : i32
          %187 = arith.cmpi ult, %186, %149 : i32
          %188:3 = scf.if %187 -> (i32, i32, i32) {
            ...
            %212 = builtin.unrealized_conversion_cast %ptr_85 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %212, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            ...
            scf.if %213 {
              ...
              %223 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %223, %c49152_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            %214 = arith.addi %arg8, %c1_i32 : i32
            %215 = arith.addi %arg7, %c1_i32 : i32
            %216 = arith.cmpi eq, %214, %c4_i32 : i32
            %217 = arith.select %216, %c0_i32, %214 : i32
            %218 = scf.if %216 -> (i32) {
              %223 = arith.xori %arg9, %c1_i32 : i32
              scf.yield %223 : i32
            } else {
              scf.yield %arg9 : i32
            }
            ...
            %idx_91 = cute.crd2idx(%coord_90, %7) : (!cute.coord<"(_,?)">, !cute.layout<"((8192,1),4):((1,0),8192)">) -> !cute.int_tuple<"?{div=8192}">
            ...
            %219 = cute_nvgpu.atom.set_value(%180, %ptr_94 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>
            %220 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %220 step %c1_i32  : i32 {
              %223 = cute_nvgpu.atom.get_value(%219 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%219 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
              %224:2 = cute.get_scalars(%int_tuple_95) : !cute.int_tuple<"(?{div=64},?{div=128})">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_92 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %223 : !cute.ptr<smem, align<8>>, [%224#0, %224#1] : i32, i32) mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %idx_100 = cute.crd2idx(%coord_90, %6) : (!cute.coord<"(_,?)">, !cute.layout<"((16384,1),4):((1,0),16384)">) -> !cute.int_tuple<"?{div=16384}">
            ...
            %221 = cute_nvgpu.atom.set_value(%181, %ptr_94 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>
            %222 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            scf.for %arg14 = %c0_i32 to %222 step %c1_i32  : i32 {
              %223 = cute_nvgpu.atom.get_value(%221 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
              %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%221 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
              %224:2 = cute.get_scalars(%int_tuple_102) : !cute.int_tuple<"(?{div=64},?{div=256})">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_101 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %223 : !cute.ptr<smem, align<8>>, [%224#0, %224#1] : i32, i32) mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            scf.yield %217, %218, %215 : i32, i32, i32
          } else {
          ...
          %189 = builtin.unrealized_conversion_cast %ptr_63 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %189, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          %190 = arith.addi %arg11, %c1_i32 : i32
          %191 = arith.addi %arg10, %c1_i32 : i32
          %192 = arith.cmpi eq, %190, %c4_i32 : i32
          %193 = arith.select %192, %c0_i32, %190 : i32
          %194 = scf.if %192 -> (i32) {
            %212 = arith.xori %arg12, %c1_i32 : i32
            scf.yield %212 : i32
          } else {
            scf.yield %arg12 : i32
          }
          %coord_64 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,0,?)">
          %idx_65 = cute.crd2idx(%coord_64, %5) : (!cute.coord<"(_,_,0,?)">, !cute.layout<"(1,1,4,4):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=1024}">
          %tup_66 = cute.add_offset(%ummaSmemDesc, %idx_65) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=1024}">) -> !cute_nvgpu.smem_desc
          %idx_67 = cute.crd2idx(%coord_64, %4) : (!cute.coord<"(_,_,0,?)">, !cute.layout<"(1,1,4,4):(0,0,2,2048)">) -> !cute.int_tuple<"?{div=2048}">
          %tup_68 = cute.add_offset(%ummaSmemDesc_42, %idx_67) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2048}">) -> !cute_nvgpu.smem_desc
          %195 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %196 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %197 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg14 = %c0_i32 to %195 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %196 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %197 step %c1_i32  : i32 {
                %212 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                %213 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                %214 = cute_nvgpu.atom.get_value(%arg13 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                %215 = arith.extui %212 : i1 to i32
                %216 = arith.extui %213 : i1 to i32
                %217 = arith.shli %215, %c13_i32 : i32
                %218 = arith.shli %216, %c14_i32 : i32
                %219 = arith.ori %217, %c138412048_i32 : i32
                %220 = arith.ori %219, %218 : i32
                cute_nvgpu.arch.mma.SM100.umma(%tup_66, %tup_68, %tmem_ptr, %220, %214) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %198 = cute_nvgpu.atom.set_value(%arg13, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          %coord_69 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,1,?)">
          %idx_70 = cute.crd2idx(%coord_69, %5) : (!cute.coord<"(_,_,1,?)">, !cute.layout<"(1,1,4,4):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
          %tup_71 = cute.add_offset(%ummaSmemDesc, %idx_70) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
          %idx_72 = cute.crd2idx(%coord_69, %4) : (!cute.coord<"(_,_,1,?)">, !cute.layout<"(1,1,4,4):(0,0,2,2048)">) -> !cute.int_tuple<"?{div=2}">
          %tup_73 = cute.add_offset(%ummaSmemDesc_42, %idx_72) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
          %199 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %200 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %201 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg14 = %c0_i32 to %199 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %200 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %201 step %c1_i32  : i32 {
                %212 = cute_nvgpu.atom.get_value(%198 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                %213 = cute_nvgpu.atom.get_value(%198 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                %214 = cute_nvgpu.atom.get_value(%198 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                %215 = arith.extui %212 : i1 to i32
                %216 = arith.extui %213 : i1 to i32
                %217 = arith.shli %215, %c13_i32 : i32
                %218 = arith.shli %216, %c14_i32 : i32
                %219 = arith.ori %217, %c138412048_i32 : i32
                %220 = arith.ori %219, %218 : i32
                cute_nvgpu.arch.mma.SM100.umma(%tup_71, %tup_73, %tmem_ptr, %220, %214) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %202 = cute_nvgpu.atom.set_value(%198, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          %coord_74 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,2,?)">
          %idx_75 = cute.crd2idx(%coord_74, %5) : (!cute.coord<"(_,_,2,?)">, !cute.layout<"(1,1,4,4):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=4}">
          %tup_76 = cute.add_offset(%ummaSmemDesc, %idx_75) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=4}">) -> !cute_nvgpu.smem_desc
          %idx_77 = cute.crd2idx(%coord_74, %4) : (!cute.coord<"(_,_,2,?)">, !cute.layout<"(1,1,4,4):(0,0,2,2048)">) -> !cute.int_tuple<"?{div=4}">
          %tup_78 = cute.add_offset(%ummaSmemDesc_42, %idx_77) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=4}">) -> !cute_nvgpu.smem_desc
          %203 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %204 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %205 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg14 = %c0_i32 to %203 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %204 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %205 step %c1_i32  : i32 {
                %212 = cute_nvgpu.atom.get_value(%202 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                %213 = cute_nvgpu.atom.get_value(%202 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                %214 = cute_nvgpu.atom.get_value(%202 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                %215 = arith.extui %212 : i1 to i32
                %216 = arith.extui %213 : i1 to i32
                %217 = arith.shli %215, %c13_i32 : i32
                %218 = arith.shli %216, %c14_i32 : i32
                %219 = arith.ori %217, %c138412048_i32 : i32
                %220 = arith.ori %219, %218 : i32
                cute_nvgpu.arch.mma.SM100.umma(%tup_76, %tup_78, %tmem_ptr, %220, %214) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %206 = cute_nvgpu.atom.set_value(%202, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          %coord_79 = cute.make_coord(%arg11) : (i32) -> !cute.coord<"(_,_,3,?)">
          %idx_80 = cute.crd2idx(%coord_79, %5) : (!cute.coord<"(_,_,3,?)">, !cute.layout<"(1,1,4,4):(0,0,2,1024)">) -> !cute.int_tuple<"?{div=2}">
          %tup_81 = cute.add_offset(%ummaSmemDesc, %idx_80) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
          %idx_82 = cute.crd2idx(%coord_79, %4) : (!cute.coord<"(_,_,3,?)">, !cute.layout<"(1,1,4,4):(0,0,2,2048)">) -> !cute.int_tuple<"?{div=2}">
          %tup_83 = cute.add_offset(%ummaSmemDesc_42, %idx_82) : (!cute_nvgpu.smem_desc, !cute.int_tuple<"?{div=2}">) -> !cute_nvgpu.smem_desc
          %207 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %208 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          %209 = cute.get_scalars(%21) : !cute.int_tuple<"1">
          scf.for %arg14 = %c0_i32 to %207 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %208 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %209 step %c1_i32  : i32 {
                %212 = cute_nvgpu.atom.get_value(%206 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
                %213 = cute_nvgpu.atom.get_value(%206 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
                %214 = cute_nvgpu.atom.get_value(%206 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
                %215 = arith.extui %212 : i1 to i32
                %216 = arith.extui %213 : i1 to i32
                %217 = arith.shli %215, %c13_i32 : i32
                %218 = arith.shli %216, %c14_i32 : i32
                %219 = arith.ori %217, %c138412048_i32 : i32
                %220 = arith.ori %219, %218 : i32
                cute_nvgpu.arch.mma.SM100.umma(%tup_81, %tup_83, %tmem_ptr, %220, %214) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %210 = cute_nvgpu.atom.set_value(%206, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          %211 = nvvm.elect.sync -> i1
          scf.if %211 {
            %int_tuple_84 = cute.make_int_tuple(%arg11) : (i32) -> !cute.int_tuple<"?">
            %ptr_85 = cute.add_offset(%ptr_6, %int_tuple_84) : (!cute.ptr<i64, smem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %212 = builtin.unrealized_conversion_cast %ptr_85 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %212 : !llvm.ptr<3>
          }
          scf.yield %188#2, %188#0, %188#1, %191, %193, %194, %210 : i32, i32, i32, i32, i32, i32, !mma_f16_f16_f32_128x256x16_
        }
        %185 = nvvm.elect.sync -> i1
        scf.if %185 {
          %dyn_62 = cute.derefine(%iter_7) : !cute.ptr<i64, smem, align<64>> to !cute.ptr<i64, smem>
          %186 = builtin.unrealized_conversion_cast %dyn_62 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.tcgen05.commit.arrive %186 : !llvm.ptr<3>
        }
      }
      %151 = nvvm.read.ptx.sreg.tid.x range <i32, 0, 1024> : i32
      %152 = nvvm.read.ptx.sreg.tid.y range <i32, 0, 1024> : i32
      %153 = nvvm.read.ptx.sreg.tid.z range <i32, 0, 64> : i32
      %154 = nvvm.read.ptx.sreg.ntid.x range <i32, 1, 1024> : i32
      %155 = nvvm.read.ptx.sreg.ntid.y range <i32, 1, 1024> : i32
      ...
      nvvm.mbarrier.try_wait.parity.shared %164, %c0_i32, %c10000000_i32 : !llvm.ptr<3>, i32, i32
      scf.for %arg6 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
        ...
        %idx_64 = cute.crd2idx(%coord_63, %3) : (!cute.coord<"(_,_,?)">, !cute.layout<"(((64,32),1),1,((1,4),1,1)):(((1,65536),0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        %ptr_65 = cute.add_offset(%ptr_56, %idx_64) : (!cute.ptr<f32, tmem, align<16>>, !cute.int_tuple<"?{div=64}">) -> !cute.ptr<f32, tmem, align<16>>
        %179 = cute.get_scalars(%21) : !cute.int_tuple<"1">
        scf.for %arg7 = %c0_i32 to %179 step %c1_i32  : i32 {
          %183 = "cute_nvgpu.arch.copy.SM100.tmem_load"(%ptr_65) <{num_b = 32 : i32, num_dp = 32 : i32, num_rep = 64 : i32}> : (!cute.ptr<f32, tmem, align<16>>) -> vector<64xi32>
          %184 = builtin.unrealized_conversion_cast %iter_62 : !cute.ptr<f32, rmem, align<32>> to !llvm.ptr
          llvm.store %183, %184 : vector<64xi32>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %180 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
        %181 = arith.truncf %180 : vector<64xf32> to vector<64xf16>
        cute.memref.store_vec %181, %rmem_61, row_major : !memref_rmem_f16_
        %coord_66 = cute.make_coord(%arg6) : (i32) -> !cute.coord<"(_,_,?)">
        %idx_67 = cute.crd2idx(%coord_66, %2) : (!cute.coord<"(_,_,?)">, !cute.layout<"((64,1),1,((1,4),1,1)):((1,0),0,((0,64),0,0))">) -> !cute.int_tuple<"?{div=64}">
        ...
        %182 = cute.get_scalars(%0) : !cute.int_tuple<"8">
        scf.for %arg7 = %c0_i32 to %182 step %c1_i32  : i32 {
          %coord_70 = cute.make_coord(%arg7) : (i32) -> !cute.coord<"(_,?)">
          %idx_71 = cute.crd2idx(%coord_70, %1) : (!cute.coord<"(_,?)">, !cute.layout<"(8,(8)):(1,(8))">) -> !cute.int_tuple<"?{div=8}">
          %ptr_72 = cute.add_offset(%iter_69, %idx_71) : (!cute.ptr<f16, rmem, align<32>>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f16, rmem, align<16>>
          %idx_73 = cute.crd2idx(%coord_70, %1) : (!cute.coord<"(_,?)">, !cute.layout<"(8,(8)):(1,(8))">) -> !cute.int_tuple<"?{div=8}">
          %ptr_74 = cute.add_offset(%ptr_68, %idx_73) : (!cute.ptr<f16, gmem, align<32>>, !cute.int_tuple<"?{div=8}">) -> !cute.ptr<f16, gmem, align<16>>
          %183 = builtin.unrealized_conversion_cast %ptr_72 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
          %184 = builtin.unrealized_conversion_cast %ptr_74 : !cute.ptr<f16, gmem, align<16>> to !llvm.ptr<1>
          %185 = llvm.load %183 {alignment = 16 : i64} : !llvm.ptr -> vector<8xf16>
          llvm.store %185, %184 {alignment = 16 : i64} : vector<8xf16>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      %165 = builtin.unrealized_conversion_cast %ptr_8 : !cute.ptr<i64, smem> to !llvm.ptr<3>
      nvvm.mbarrier.txn %165, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
  ...
  func.func @cutlass_host_function_Tensorgmemodiv8192i64div81921_Tensorgmemodiv8192i64div81921_Tensorgmemodiv8192i64div81921(%arg0: !memref_gmem_f16_, %arg1: !memref_gmem_f16_, %arg2: !memref_gmem_f16_) attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @kernels::@kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK12825616_TVLayoutA1128161281128_TVLayoutB1256162561256_TVLayoutC11282561281128_CopyAtom_ThrI_0 blocks in (%220, %221, %c1) threads in (%c128, %c1, %c1)  dynamic_shared_memory_size %c196736_i32 args(%9 : !mma_f16_f16_f32_128x256x16_, %110 : !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %view : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %212 : !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 262144, tma_gbasis = <"(64,256):(1@1,1@0)">, internal_val_type = f16>, %view_8 : !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg2 : !memref_gmem_f16_) {use_pdl = false}
    return
  }
}
