gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_100a">] {
  ...
  ^bb22(%194: i32):  // 2 preds: ^bb21, ^bb25
    ...
    llvm.cond_br %195, ^bb23, ^bb26 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb23:  // pred: ^bb22
  ...
  ^bb27(%200: i32):  // 2 preds: ^bb26, ^bb30
    ...
    llvm.cond_br %201, ^bb28, ^bb31 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb28:  // pred: ^bb27
  ...
  ^bb42(%228: i32):  // 2 preds: ^bb41, ^bb45
    ...
    llvm.cond_br %229, ^bb43, ^bb46 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb43:  // pred: ^bb42
  ...
  ^bb47(%234: i32):  // 2 preds: ^bb46, ^bb50
    ...
    llvm.cond_br %235, ^bb48, ^bb51(%221, %223, %219 : i32, i32, i32) {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb48:  // pred: ^bb47
  ...
  ^bb58(%268: i32):  // 2 preds: ^bb57, ^bb67
    ...
    llvm.cond_br %269, ^bb59, ^bb68 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb59:  // pred: ^bb58
    llvm.br ^bb60(%20 : i32)
  ^bb60(%270: i32):  // 2 preds: ^bb59, ^bb66
    %271 = llvm.icmp "slt" %270, %36 : i32
    llvm.cond_br %271, ^bb61, ^bb67 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb61:  // pred: ^bb60
    llvm.br ^bb62(%20 : i32)
  ^bb62(%272: i32):  // 2 preds: ^bb61, ^bb65
    %273 = llvm.icmp "slt" %272, %36 : i32
    llvm.cond_br %273, ^bb63, ^bb66 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb63:  // pred: ^bb62
  ...
  ^bb69(%288: i32):  // 2 preds: ^bb68, ^bb78
    ...
    llvm.cond_br %289, ^bb70, ^bb79 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb70:  // pred: ^bb69
    llvm.br ^bb71(%20 : i32)
  ^bb71(%290: i32):  // 2 preds: ^bb70, ^bb77
    %291 = llvm.icmp "slt" %290, %36 : i32
    llvm.cond_br %291, ^bb72, ^bb78 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb72:  // pred: ^bb71
    llvm.br ^bb73(%20 : i32)
  ^bb73(%292: i32):  // 2 preds: ^bb72, ^bb76
    %293 = llvm.icmp "slt" %292, %36 : i32
    llvm.cond_br %293, ^bb74, ^bb77 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb74:  // pred: ^bb73
  ...
  ^bb80(%308: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %309, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%20 : i32)
  ^bb82(%310: i32):  // 2 preds: ^bb81, ^bb88
    %311 = llvm.icmp "slt" %310, %36 : i32
    llvm.cond_br %311, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%20 : i32)
  ^bb84(%312: i32):  // 2 preds: ^bb83, ^bb87
    %313 = llvm.icmp "slt" %312, %36 : i32
    llvm.cond_br %313, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb91(%328: i32):  // 2 preds: ^bb90, ^bb100
    ...
    llvm.cond_br %329, ^bb92, ^bb101 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb92:  // pred: ^bb91
    llvm.br ^bb93(%20 : i32)
  ^bb93(%330: i32):  // 2 preds: ^bb92, ^bb99
    %331 = llvm.icmp "slt" %330, %36 : i32
    llvm.cond_br %331, ^bb94, ^bb100 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb94:  // pred: ^bb93
    llvm.br ^bb95(%20 : i32)
  ^bb95(%332: i32):  // 2 preds: ^bb94, ^bb98
    %333 = llvm.icmp "slt" %332, %36 : i32
    llvm.cond_br %333, ^bb96, ^bb99 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb96:  // pred: ^bb95
  ...
  ^bb112(%349: i32):  // 2 preds: ^bb111, ^bb113
    ...
    llvm.cond_br %350, ^bb113, ^bb114 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb113:  // pred: ^bb112
  ...
  ^bb115(%357: i32):  // 2 preds: ^bb114, ^bb116
    ...
    llvm.cond_br %358, ^bb116, ^bb117 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb116:  // pred: ^bb115
