...
module attributes {gpu.container_module} {
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb27(%204: i32):  // 2 preds: ^bb26, ^bb30
      ...
      llvm.cond_br %205, ^bb28, ^bb31 {llvm.loop_annotation = #loop_annotation}
    ^bb28:  // pred: ^bb27
    ...
    ^bb47(%239: i32):  // 2 preds: ^bb46, ^bb50
      ...
      llvm.cond_br %240, ^bb48, ^bb51(%225, %227, %223 : i32, i32, i32) {llvm.loop_annotation = #loop_annotation}
    ^bb48:  // pred: ^bb47
    ...
    ^bb58(%273: i32):  // 2 preds: ^bb57, ^bb67
      ...
      llvm.cond_br %274, ^bb59, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb59:  // pred: ^bb58
      llvm.br ^bb60(%21 : i32)
    ^bb60(%275: i32):  // 2 preds: ^bb59, ^bb66
      %276 = llvm.icmp "slt" %275, %37 : i32
      llvm.cond_br %276, ^bb61, ^bb67 {llvm.loop_annotation = #loop_annotation}
    ^bb61:  // pred: ^bb60
      llvm.br ^bb62(%21 : i32)
    ^bb62(%277: i32):  // 2 preds: ^bb61, ^bb65
      %278 = llvm.icmp "slt" %277, %37 : i32
      llvm.cond_br %278, ^bb63, ^bb66 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
    ...
    ^bb69(%293: i32):  // 2 preds: ^bb68, ^bb78
      ...
      llvm.cond_br %294, ^bb70, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb70:  // pred: ^bb69
      llvm.br ^bb71(%21 : i32)
    ^bb71(%295: i32):  // 2 preds: ^bb70, ^bb77
      %296 = llvm.icmp "slt" %295, %37 : i32
      llvm.cond_br %296, ^bb72, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
      llvm.br ^bb73(%21 : i32)
    ^bb73(%297: i32):  // 2 preds: ^bb72, ^bb76
      %298 = llvm.icmp "slt" %297, %37 : i32
      llvm.cond_br %298, ^bb74, ^bb77 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
    ...
    ^bb80(%313: i32):  // 2 preds: ^bb79, ^bb89
      ...
      llvm.cond_br %314, ^bb81, ^bb90 {llvm.loop_annotation = #loop_annotation}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%21 : i32)
    ^bb82(%315: i32):  // 2 preds: ^bb81, ^bb88
      %316 = llvm.icmp "slt" %315, %37 : i32
      llvm.cond_br %316, ^bb83, ^bb89 {llvm.loop_annotation = #loop_annotation}
    ^bb83:  // pred: ^bb82
      llvm.br ^bb84(%21 : i32)
    ^bb84(%317: i32):  // 2 preds: ^bb83, ^bb87
      %318 = llvm.icmp "slt" %317, %37 : i32
      llvm.cond_br %318, ^bb85, ^bb88 {llvm.loop_annotation = #loop_annotation}
    ^bb85:  // pred: ^bb84
    ...
    ^bb91(%333: i32):  // 2 preds: ^bb90, ^bb100
      ...
      llvm.cond_br %334, ^bb92, ^bb101 {llvm.loop_annotation = #loop_annotation}
    ^bb92:  // pred: ^bb91
      llvm.br ^bb93(%21 : i32)
    ^bb93(%335: i32):  // 2 preds: ^bb92, ^bb99
      %336 = llvm.icmp "slt" %335, %37 : i32
      llvm.cond_br %336, ^bb94, ^bb100 {llvm.loop_annotation = #loop_annotation}
    ^bb94:  // pred: ^bb93
      llvm.br ^bb95(%21 : i32)
    ^bb95(%337: i32):  // 2 preds: ^bb94, ^bb98
      %338 = llvm.icmp "slt" %337, %37 : i32
      llvm.cond_br %338, ^bb96, ^bb99 {llvm.loop_annotation = #loop_annotation}
    ^bb96:  // pred: ^bb95
    ...
    ^bb112(%354: i32):  // 2 preds: ^bb111, ^bb113
      ...
      llvm.cond_br %355, ^bb113, ^bb114 {llvm.loop_annotation = #loop_annotation}
    ^bb113:  // pred: ^bb112
    ...
    ^bb115(%362: i32):  // 2 preds: ^bb114, ^bb116
      ...
      llvm.cond_br %363, ^bb116, ^bb117 {llvm.loop_annotation = #loop_annotation}
    ^bb116:  // pred: ^bb115
