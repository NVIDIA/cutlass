...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb15:  // pred: ^bb14
      ...
      nvvm.mbarrier.try_wait.parity.shared %181, %178, %27 : !llvm.ptr<3>, i32, i32
    ...
    ^bb33(%205: i32, %206: i32, %207: i32, %208: i32, %209: i32, %210: i32, %211: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb32, ^bb104
      %212 = llvm.icmp "slt" %205, %109 : i32
      llvm.cond_br %212, ^bb34, ^bb105
    ^bb34:  // pred: ^bb33
      %213 = llvm.add %205, %175 : i32
      %214 = llvm.icmp "ult" %213, %109 : i32
      llvm.cond_br %214, ^bb35, ^bb52
    ^bb35:  // pred: ^bb34
      %215 = llvm.getelementptr %73[%207] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %215, %208, %27 : !llvm.ptr<3>, i32, i32
    ...
    ^bb47(%234: i32):  // 2 preds: ^bb46, ^bb50
      ...
      llvm.cond_br %235, ^bb48, ^bb51 {llvm.loop_annotation = #loop_annotation}
    ^bb48:  // pred: ^bb47
    ...
    ^bb51:  // pred: ^bb47
      llvm.br ^bb53(%221, %223, %219 : i32, i32, i32)
    ^bb52:  // pred: ^bb34
      llvm.br ^bb53(%207, %208, %206 : i32, i32, i32)
    ^bb53(%238: i32, %239: i32, %240: i32):  // 2 preds: ^bb51, ^bb52
      llvm.br ^bb54
    ^bb54:  // pred: ^bb53
      %241 = llvm.getelementptr %13[%209] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.try_wait.parity.shared %241, %210, %27 : !llvm.ptr<3>, i32, i32
      %242 = llvm.add %209, %36 : i32
      %243 = llvm.icmp "eq" %242, %28 : i32
      %244 = llvm.select %243, %20, %242 : i1, i32
      llvm.cond_br %243, ^bb55, ^bb56
    ^bb55:  // pred: ^bb54
      %245 = llvm.xor %210, %36 : i32
      llvm.br ^bb57(%245 : i32)
    ^bb56:  // pred: ^bb54
      llvm.br ^bb57(%210 : i32)
    ^bb57(%246: i32):  // 2 preds: ^bb55, ^bb56
      llvm.br ^bb58
    ^bb58:  // pred: ^bb57
      ...
      llvm.br ^bb59(%20 : i32)
    ^bb59(%268: i32):  // 2 preds: ^bb58, ^bb68
      %269 = llvm.icmp "slt" %268, %36 : i32
      llvm.cond_br %269, ^bb60, ^bb69 {llvm.loop_annotation = #loop_annotation}
    ^bb60:  // pred: ^bb59
      llvm.br ^bb61(%20 : i32)
    ^bb61(%270: i32):  // 2 preds: ^bb60, ^bb67
      %271 = llvm.icmp "slt" %270, %36 : i32
      llvm.cond_br %271, ^bb62, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb62:  // pred: ^bb61
      llvm.br ^bb63(%20 : i32)
    ^bb63(%272: i32):  // 2 preds: ^bb62, ^bb66
      %273 = llvm.icmp "slt" %272, %36 : i32
      llvm.cond_br %273, ^bb64, ^bb67 {llvm.loop_annotation = #loop_annotation}
    ^bb64:  // pred: ^bb63
      %274 = llvm.inttoptr %160 : i32 to !llvm.ptr<6>
      %275 = nvvm.elect.sync -> i1
      llvm.cond_br %275, ^bb65, ^bb66
    ^bb65:  // pred: ^bb64
    ...
    ^bb66:  // 2 preds: ^bb64, ^bb65
      ...
      llvm.br ^bb63(%276 : i32)
    ^bb67:  // pred: ^bb63
      %277 = llvm.add %270, %36 : i32
      llvm.br ^bb61(%277 : i32)
    ^bb68:  // pred: ^bb61
      %278 = llvm.add %268, %36 : i32
      llvm.br ^bb59(%278 : i32)
    ^bb69:  // pred: ^bb59
      ...
      llvm.br ^bb70(%20 : i32)
    ^bb70(%288: i32):  // 2 preds: ^bb69, ^bb79
      %289 = llvm.icmp "slt" %288, %36 : i32
      llvm.cond_br %289, ^bb71, ^bb80 {llvm.loop_annotation = #loop_annotation}
    ^bb71:  // pred: ^bb70
      llvm.br ^bb72(%20 : i32)
    ^bb72(%290: i32):  // 2 preds: ^bb71, ^bb78
      %291 = llvm.icmp "slt" %290, %36 : i32
      llvm.cond_br %291, ^bb73, ^bb79 {llvm.loop_annotation = #loop_annotation}
    ^bb73:  // pred: ^bb72
      llvm.br ^bb74(%20 : i32)
    ^bb74(%292: i32):  // 2 preds: ^bb73, ^bb77
      %293 = llvm.icmp "slt" %292, %36 : i32
      llvm.cond_br %293, ^bb75, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb75:  // pred: ^bb74
      %294 = llvm.inttoptr %160 : i32 to !llvm.ptr<6>
      %295 = nvvm.elect.sync -> i1
      llvm.cond_br %295, ^bb76, ^bb77
    ^bb76:  // pred: ^bb75
    ...
    ^bb77:  // 2 preds: ^bb75, ^bb76
      ...
      llvm.br ^bb74(%296 : i32)
    ^bb78:  // pred: ^bb74
      %297 = llvm.add %290, %36 : i32
      llvm.br ^bb72(%297 : i32)
    ^bb79:  // pred: ^bb72
    ...
    ^bb80:  // pred: ^bb70
      ...
      llvm.br ^bb81(%20 : i32)
    ^bb81(%308: i32):  // 2 preds: ^bb80, ^bb90
      %309 = llvm.icmp "slt" %308, %36 : i32
      llvm.cond_br %309, ^bb82, ^bb91 {llvm.loop_annotation = #loop_annotation}
    ^bb82:  // pred: ^bb81
      llvm.br ^bb83(%20 : i32)
    ^bb83(%310: i32):  // 2 preds: ^bb82, ^bb89
      %311 = llvm.icmp "slt" %310, %36 : i32
      llvm.cond_br %311, ^bb84, ^bb90 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
      llvm.br ^bb85(%20 : i32)
    ^bb85(%312: i32):  // 2 preds: ^bb84, ^bb88
      %313 = llvm.icmp "slt" %312, %36 : i32
      llvm.cond_br %313, ^bb86, ^bb89 {llvm.loop_annotation = #loop_annotation}
    ^bb86:  // pred: ^bb85
      %314 = llvm.inttoptr %160 : i32 to !llvm.ptr<6>
      %315 = nvvm.elect.sync -> i1
      llvm.cond_br %315, ^bb87, ^bb88
    ^bb87:  // pred: ^bb86
    ...
    ^bb88:  // 2 preds: ^bb86, ^bb87
      ...
      llvm.br ^bb85(%316 : i32)
    ^bb89:  // pred: ^bb85
      %317 = llvm.add %310, %36 : i32
      llvm.br ^bb83(%317 : i32)
    ^bb90:  // pred: ^bb83
      %318 = llvm.add %308, %36 : i32
      llvm.br ^bb81(%318 : i32)
    ^bb91:  // pred: ^bb81
      ...
      llvm.br ^bb92(%20 : i32)
    ^bb92(%328: i32):  // 2 preds: ^bb91, ^bb101
      %329 = llvm.icmp "slt" %328, %36 : i32
      llvm.cond_br %329, ^bb93, ^bb102 {llvm.loop_annotation = #loop_annotation}
    ^bb93:  // pred: ^bb92
      llvm.br ^bb94(%20 : i32)
    ^bb94(%330: i32):  // 2 preds: ^bb93, ^bb100
      %331 = llvm.icmp "slt" %330, %36 : i32
      llvm.cond_br %331, ^bb95, ^bb101 {llvm.loop_annotation = #loop_annotation}
    ^bb95:  // pred: ^bb94
      llvm.br ^bb96(%20 : i32)
    ^bb96(%332: i32):  // 2 preds: ^bb95, ^bb99
      %333 = llvm.icmp "slt" %332, %36 : i32
      llvm.cond_br %333, ^bb97, ^bb100 {llvm.loop_annotation = #loop_annotation}
    ^bb97:  // pred: ^bb96
      %334 = llvm.inttoptr %160 : i32 to !llvm.ptr<6>
      %335 = nvvm.elect.sync -> i1
      llvm.cond_br %335, ^bb98, ^bb99
    ^bb98:  // pred: ^bb97
    ...
    ^bb111(%344: i32):  // 2 preds: ^bb110, ^bb118
      %345 = llvm.icmp "slt" %344, %28 : i32
      llvm.cond_br %345, ^bb112, ^bb119
    ^bb112:  // pred: ^bb111
      %346 = llvm.srem %344, %28 : i32
      %347 = llvm.mul %346, %35 : i32
      %348 = llvm.add %163, %347 : i32
      llvm.br ^bb113(%20 : i32)
    ^bb113(%349: i32):  // 2 preds: ^bb112, ^bb114
      %350 = llvm.icmp "slt" %349, %36 : i32
      llvm.cond_br %350, ^bb114, ^bb115 {llvm.loop_annotation = #loop_annotation}
    ^bb114:  // pred: ^bb113
    ...
    ^bb116(%357: i32):  // 2 preds: ^bb115, ^bb117
      %358 = llvm.icmp "slt" %357, %0 : i32
      llvm.cond_br %358, ^bb117, ^bb118 {llvm.loop_annotation = #loop_annotation}
    ^bb117:  // pred: ^bb116
      ...
      llvm.br ^bb116(%363 : i32)
    ^bb118:  // pred: ^bb116
      %364 = llvm.add %344, %36 : i32
      llvm.br ^bb111(%364 : i32)
    ^bb119:  // pred: ^bb111
