...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass_kernel_TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK12825616_TVLayoutA1128161281128_TVLayoutB1256162561256_TVLayoutC11282561281128_CopyAtom_ThrI_0(%arg0: !mma_f16_f16_f32_128x256x16_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 131072, tma_gbasis = <"(64,128):(1@1,1@0)">, internal_val_type = f16>, %arg2: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f16, copy_bits = 262144, tma_gbasis = <"(64,256):(1@1,1@0)">, internal_val_type = f16>, %arg4: !cute.coord_tensor<"(0,0)", "(?,?{div=8192}):(1@1,1@0)">, %arg5: !memref_gmem_f16_) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %45 {
        ...
        %90:3 = scf.for %arg6 = %c0_i32 to %88 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c0_i32) -> (i32, i32, i32)  : i32 {
          ...
          scf.if %95 {
            ...
            %109 = builtin.unrealized_conversion_cast %ptr_80 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %109, %c49152_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
          }
          ...
          %100 = scf.if %98 -> (i32) {
            %109 = arith.xori %arg8, %c1_i32 : i32
            scf.yield %109 : i32
          } else {
            scf.yield %arg8 : i32
          }
          ...
          %103 = cute_nvgpu.atom.get_value(%101 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
          ...
          scf.for %arg10 = %c0_i32 to %89 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_69 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %102 : !cute.ptr<smem, align<8>>, [%104#0, %104#1] : i32, i32) cache_policy = %103 mode = <tiled> num_cta = 1 : i32
          ...
          %105 = cute_nvgpu.atom.set_value(%87, %ptr_70 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>
          ...
          %107 = cute_nvgpu.atom.get_value(%105 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
          ...
          %108:2 = cute.get_scalars(%int_tuple_78) : !cute.int_tuple<"(?{div=64},?{div=256})">
          scf.for %arg10 = %c0_i32 to %89 step %c1_i32  : i32 {
            cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_79 : !cute.ptr<generic, align<64>>, %ptr_77 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %106 : !cute.ptr<smem, align<8>>, [%108#0, %108#1] : i32, i32) cache_policy = %107 mode = <tiled> num_cta = 1 : i32
          } {llvm.loop_annotation = #loop_annotation}
          scf.yield %99, %100, %97 : i32, i32, i32
        }
        %91 = cute.get_scalars(%21) : !cute.int_tuple<"1">
        %92:7 = scf.for %arg6 = %c0_i32 to %79 step %c1_i32 iter_args(%arg7 = %90#2, %arg8 = %90#0, %arg9 = %90#1, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %0) -> (i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)  : i32 {
          %94 = builtin.unrealized_conversion_cast %arg13 : !llvm.struct<(i1, i1, i1)> to !mma_f16_f16_f32_128x256x16_
          %95 = arith.addi %arg6, %88 : i32
          %96 = arith.cmpi ult, %95, %79 : i32
          %97:3 = scf.if %96 -> (i32, i32, i32) {
            ...
            %146 = builtin.unrealized_conversion_cast %ptr_84 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %146, %arg9, %c10000000_i32 : !llvm.ptr<3>, i32, i32
            ...
            scf.if %147 {
              ...
              %162 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %162, %c49152_i32 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
            }
            %148 = arith.addi %arg8, %c1_i32 : i32
            %149 = arith.addi %arg7, %c1_i32 : i32
            %150 = arith.cmpi eq, %148, %c4_i32 : i32
            %151 = arith.select %150, %c0_i32, %148 : i32
            %152 = scf.if %150 -> (i32) {
              %162 = arith.xori %arg9, %c1_i32 : i32
              scf.yield %162 : i32
            } else {
              scf.yield %arg9 : i32
            }
            ...
            %153 = cute_nvgpu.atom.set_value(%86, %ptr_92 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>
            %154 = cute.get_scalars(%21) : !cute.int_tuple<"1">
            %155 = cute_nvgpu.atom.get_value(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute.ptr<smem, align<8>>
            %156 = cute_nvgpu.atom.get_value(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%153 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,128):(1@1,1@0)">>) -> !cute.ptr<generic, align<64>>
            %157:2 = cute.get_scalars(%int_tuple_93) : !cute.int_tuple<"(?{div=64},?{div=128})">
            scf.for %arg14 = %c0_i32 to %154 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_91 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %155 : !cute.ptr<smem, align<8>>, [%157#0, %157#1] : i32, i32) cache_policy = %156 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            ...
            %158 = cute_nvgpu.atom.set_value(%87, %ptr_92 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>
            ...
            %160 = cute_nvgpu.atom.get_value(%158 : !cute_nvgpu.atom.tma_load<f16, copy_bits = 262144, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(64,256):(1@1,1@0)">>) {field = #cute_nvgpu.atom_copy_field_tmaload<cache_policy>} : i64
            ...
            %161:2 = cute.get_scalars(%int_tuple_100) : !cute.int_tuple<"(?{div=64},?{div=256})">
            scf.for %arg14 = %c0_i32 to %154 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr_101 : !cute.ptr<generic, align<64>>, %ptr_99 : !cute.ptr<f16, smem, align<128>, S<3,4,3>>, %159 : !cute.ptr<smem, align<8>>, [%161#0, %161#1] : i32, i32) cache_policy = %160 mode = <tiled> num_cta = 1 : i32
            } {llvm.loop_annotation = #loop_annotation}
            scf.yield %151, %152, %149 : i32, i32, i32
          } else {
          ...
          %98 = builtin.unrealized_conversion_cast %ptr_62 : !cute.ptr<i64, smem> to !llvm.ptr<3>
          nvvm.mbarrier.try_wait.parity.shared %98, %arg12, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          %99 = arith.addi %arg11, %c1_i32 : i32
          %100 = arith.addi %arg10, %c1_i32 : i32
          %101 = arith.cmpi eq, %99, %c4_i32 : i32
          %102 = arith.select %101, %c0_i32, %99 : i32
          %103 = scf.if %101 -> (i32) {
            %146 = arith.xori %arg12, %c1_i32 : i32
            scf.yield %146 : i32
          } else {
            scf.yield %arg12 : i32
          }
          ...
          %104 = cute_nvgpu.atom.get_value(%94 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
          %105 = cute_nvgpu.atom.get_value(%94 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
          %106 = cute_nvgpu.atom.get_value(%94 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
          ...
          scf.for %arg14 = %c0_i32 to %91 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %91 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %91 step %c1_i32  : i32 {
                cute_nvgpu.arch.mma.SM100.umma(%tup_65, %tup_67, %tmem_ptr, %112, %106) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %113 = cute_nvgpu.atom.set_value(%94, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          ...
          %114 = cute_nvgpu.atom.get_value(%113 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
          %115 = cute_nvgpu.atom.get_value(%113 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
          %116 = cute_nvgpu.atom.get_value(%113 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
          %117 = arith.extui %114 : i1 to i32
          %118 = arith.extui %115 : i1 to i32
          %119 = arith.shli %117, %c13_i32 : i32
          %120 = arith.shli %118, %c14_i32 : i32
          %121 = arith.ori %119, %c138412048_i32 : i32
          %122 = arith.ori %121, %120 : i32
          scf.for %arg14 = %c0_i32 to %91 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %91 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %91 step %c1_i32  : i32 {
                cute_nvgpu.arch.mma.SM100.umma(%tup_70, %tup_72, %tmem_ptr, %122, %116) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %123 = cute_nvgpu.atom.set_value(%113, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          ...
          %124 = cute_nvgpu.atom.get_value(%123 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
          %125 = cute_nvgpu.atom.get_value(%123 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
          %126 = cute_nvgpu.atom.get_value(%123 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
          %127 = arith.extui %124 : i1 to i32
          %128 = arith.extui %125 : i1 to i32
          %129 = arith.shli %127, %c13_i32 : i32
          %130 = arith.shli %128, %c14_i32 : i32
          %131 = arith.ori %129, %c138412048_i32 : i32
          %132 = arith.ori %131, %130 : i32
          scf.for %arg14 = %c0_i32 to %91 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %91 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %91 step %c1_i32  : i32 {
                cute_nvgpu.arch.mma.SM100.umma(%tup_75, %tup_77, %tmem_ptr, %132, %126) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %133 = cute_nvgpu.atom.set_value(%123, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          ...
          %134 = cute_nvgpu.atom.get_value(%133 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_a>} : i1
          %135 = cute_nvgpu.atom.get_value(%133 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<neg_b>} : i1
          %136 = cute_nvgpu.atom.get_value(%133 : !mma_f16_f16_f32_128x256x16_) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : i1
          %137 = arith.extui %134 : i1 to i32
          %138 = arith.extui %135 : i1 to i32
          %139 = arith.shli %137, %c13_i32 : i32
          %140 = arith.shli %138, %c14_i32 : i32
          %141 = arith.ori %139, %c138412048_i32 : i32
          %142 = arith.ori %141, %140 : i32
          scf.for %arg14 = %c0_i32 to %91 step %c1_i32  : i32 {
            scf.for %arg15 = %c0_i32 to %91 step %c1_i32  : i32 {
              scf.for %arg16 = %c0_i32 to %91 step %c1_i32  : i32 {
                cute_nvgpu.arch.mma.SM100.umma(%tup_80, %tup_82, %tmem_ptr, %142, %136) {num_cta = 1 : i32, scale = 0 : i32, a_type = f16} : (!cute_nvgpu.smem_desc, !cute_nvgpu.smem_desc, !cute.ptr<f32, tmem, align<16>>, i32, i1) -> ()
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          %143 = cute_nvgpu.atom.set_value(%133, %true : i1) {field = #cute_nvgpu.atom_mma_field_sm100<accum_c>} : !mma_f16_f16_f32_128x256x16_
          %144 = builtin.unrealized_conversion_cast %143 : !mma_f16_f16_f32_128x256x16_ to !llvm.struct<(i1, i1, i1)>
          ...
          scf.if %145 {
            ...
            %146 = builtin.unrealized_conversion_cast %ptr_83 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.tcgen05.commit.arrive %146 : !llvm.ptr<3>
          }
          scf.yield %97#2, %97#0, %97#1, %100, %102, %103, %144 : i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>
        }
      ...
      %83 = cute.get_scalars(%18) : !cute.int_tuple<"4">
      scf.for %arg6 = %c0_i32 to %c4_i32 step %c1_i32  : i32 {
        ...
        %85 = cute.memref.load_vec %rmem : !memref_rmem_f32_
        %86 = arith.truncf %85 : vector<64xf32> to vector<64xf16>
        cute.memref.store_vec %86, %rmem_58 : !memref_rmem_f16_
        ...
        scf.for %arg7 = %c0_i32 to %83 step %c1_i32  : i32 {
          ...
          %idx_67 = cute.crd2idx(%coord_66, %1) : (!cute.coord<"(_,?)">, !cute.layout<"(16,(4)):(1,(16))">) -> !cute.int_tuple<"?{div=16}">
          ...
          %87 = builtin.unrealized_conversion_cast %ptr_68 : !cute.ptr<f16, rmem, align<32>> to !llvm.ptr
          %88 = builtin.unrealized_conversion_cast %ptr_69 : !cute.ptr<f16, gmem, align<32>> to !llvm.ptr<1>
          %89 = llvm.load %87 {alignment = 32 : i64} : !llvm.ptr -> vector<16xf16>
          llvm.store %89, %88 {alignment = 32 : i64} : vector<16xf16>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
