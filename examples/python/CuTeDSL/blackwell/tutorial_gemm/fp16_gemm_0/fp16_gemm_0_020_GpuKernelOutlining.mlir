...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb14(%394: i32, %395: i32, %396: i32, %397: i32):  // 2 preds: ^bb13, ^bb27
      %398 = llvm.icmp "slt" %394, %392 : i32
      llvm.cond_br %398, ^bb15, ^bb28
    ^bb15:  // pred: ^bb14
    ...
    ^bb25(%459: i32):  // 2 preds: ^bb24, ^bb26
      ...
      llvm.cond_br %460, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation}
    ^bb26:  // pred: ^bb25
      ...
      llvm.br ^bb25(%462 : i32)
    ^bb27:  // pred: ^bb25
      %463 = llvm.add %394, %50 : i32
      llvm.br ^bb14(%463, %405, %407, %403 : i32, i32, i32, i32)
    ^bb28:  // pred: ^bb14
      %464 = llvm.mlir.constant(1 : i32) : i32
      llvm.br ^bb29(%47, %397, %395, %396, %47, %47, %47, %arg0 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb29(%465: i32, %466: i32, %467: i32, %468: i32, %469: i32, %470: i32, %471: i32, %472: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb88
      %473 = llvm.icmp "slt" %465, %384 : i32
      llvm.cond_br %473, ^bb30, ^bb89
    ^bb30:  // pred: ^bb29
      %474 = llvm.add %465, %392 : i32
      %475 = llvm.icmp "ult" %474, %384 : i32
      llvm.cond_br %475, ^bb31, ^bb44
    ^bb31:  // pred: ^bb30
    ...
    ^bb33:  // 2 preds: ^bb31, ^bb32
      ...
      llvm.cond_br %481, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
      %483 = llvm.xor %468, %50 : i32
      llvm.br ^bb36(%483 : i32)
    ^bb35:  // pred: ^bb33
      llvm.br ^bb36(%468 : i32)
    ^bb36(%484: i32):  // 2 preds: ^bb34, ^bb35
      llvm.br ^bb37
    ^bb37:  // pred: ^bb36
      ...
      llvm.br ^bb38(%47 : i32)
    ^bb38(%510: i32):  // 2 preds: ^bb37, ^bb39
      %511 = llvm.icmp "slt" %510, %504 : i32
      llvm.cond_br %511, ^bb39, ^bb40 {llvm.loop_annotation = #loop_annotation}
    ^bb39:  // pred: ^bb38
    ...
    ^bb40:  // pred: ^bb38
      ...
      llvm.br ^bb41(%47 : i32)
    ^bb41(%537: i32):  // 2 preds: ^bb40, ^bb42
      %538 = llvm.icmp "slt" %537, %504 : i32
      llvm.cond_br %538, ^bb42, ^bb43 {llvm.loop_annotation = #loop_annotation}
    ^bb42:  // pred: ^bb41
      ...
      llvm.br ^bb41(%540 : i32)
    ^bb43:  // pred: ^bb41
      llvm.br ^bb45(%482, %484, %480 : i32, i32, i32)
    ^bb44:  // pred: ^bb30
      llvm.br ^bb45(%467, %468, %466 : i32, i32, i32)
    ^bb45(%541: i32, %542: i32, %543: i32):  // 2 preds: ^bb43, ^bb44
      llvm.br ^bb46
    ^bb46:  // pred: ^bb45
      ...
      llvm.cond_br %547, ^bb47, ^bb48
    ^bb47:  // pred: ^bb46
      %549 = llvm.xor %471, %50 : i32
      llvm.br ^bb49(%549 : i32)
    ^bb48:  // pred: ^bb46
      llvm.br ^bb49(%471 : i32)
    ^bb49(%550: i32):  // 2 preds: ^bb47, ^bb48
      llvm.br ^bb50
    ^bb50:  // pred: ^bb49
      ...
      llvm.br ^bb51(%47 : i32)
    ^bb51(%580: i32):  // 2 preds: ^bb50, ^bb58
      %581 = llvm.icmp "slt" %580, %464 : i32
      llvm.cond_br %581, ^bb52, ^bb59 {llvm.loop_annotation = #loop_annotation}
    ^bb52:  // pred: ^bb51
      llvm.br ^bb53(%47 : i32)
    ^bb53(%582: i32):  // 2 preds: ^bb52, ^bb57
      %583 = llvm.icmp "slt" %582, %464 : i32
      llvm.cond_br %583, ^bb54, ^bb58 {llvm.loop_annotation = #loop_annotation}
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%47 : i32)
    ^bb55(%584: i32):  // 2 preds: ^bb54, ^bb56
      %585 = llvm.icmp "slt" %584, %464 : i32
      llvm.cond_br %585, ^bb56, ^bb57 {llvm.loop_annotation = #loop_annotation}
    ^bb56:  // pred: ^bb55
      ...
      llvm.br ^bb55(%589 : i32)
    ^bb57:  // pred: ^bb55
      %590 = llvm.add %582, %50 : i32
      llvm.br ^bb53(%590 : i32)
    ^bb58:  // pred: ^bb53
      %591 = llvm.add %580, %50 : i32
      llvm.br ^bb51(%591 : i32)
    ^bb59:  // pred: ^bb51
      ...
      llvm.br ^bb60(%47 : i32)
    ^bb60(%626: i32):  // 2 preds: ^bb59, ^bb67
      %627 = llvm.icmp "slt" %626, %464 : i32
      llvm.cond_br %627, ^bb61, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb61:  // pred: ^bb60
      llvm.br ^bb62(%47 : i32)
    ^bb62(%628: i32):  // 2 preds: ^bb61, ^bb66
      %629 = llvm.icmp "slt" %628, %464 : i32
      llvm.cond_br %629, ^bb63, ^bb67 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%47 : i32)
    ^bb64(%630: i32):  // 2 preds: ^bb63, ^bb65
      %631 = llvm.icmp "slt" %630, %464 : i32
      llvm.cond_br %631, ^bb65, ^bb66 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
      ...
      llvm.br ^bb64(%635 : i32)
    ^bb66:  // pred: ^bb64
      %636 = llvm.add %628, %50 : i32
      llvm.br ^bb62(%636 : i32)
    ^bb67:  // pred: ^bb62
    ...
    ^bb68:  // pred: ^bb60
      ...
      llvm.br ^bb69(%47 : i32)
    ^bb69(%672: i32):  // 2 preds: ^bb68, ^bb76
      %673 = llvm.icmp "slt" %672, %464 : i32
      llvm.cond_br %673, ^bb70, ^bb77 {llvm.loop_annotation = #loop_annotation}
    ^bb70:  // pred: ^bb69
      llvm.br ^bb71(%47 : i32)
    ^bb71(%674: i32):  // 2 preds: ^bb70, ^bb75
      %675 = llvm.icmp "slt" %674, %464 : i32
      llvm.cond_br %675, ^bb72, ^bb76 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
      llvm.br ^bb73(%47 : i32)
    ^bb73(%676: i32):  // 2 preds: ^bb72, ^bb74
      %677 = llvm.icmp "slt" %676, %464 : i32
      llvm.cond_br %677, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
      ...
      llvm.br ^bb73(%681 : i32)
    ^bb75:  // pred: ^bb73
      %682 = llvm.add %674, %50 : i32
      llvm.br ^bb71(%682 : i32)
    ^bb76:  // pred: ^bb71
      %683 = llvm.add %672, %50 : i32
      llvm.br ^bb69(%683 : i32)
    ^bb77:  // pred: ^bb69
      ...
      llvm.br ^bb78(%47 : i32)
    ^bb78(%718: i32):  // 2 preds: ^bb77, ^bb85
      %719 = llvm.icmp "slt" %718, %464 : i32
      llvm.cond_br %719, ^bb79, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb79:  // pred: ^bb78
      llvm.br ^bb80(%47 : i32)
    ^bb80(%720: i32):  // 2 preds: ^bb79, ^bb84
      %721 = llvm.icmp "slt" %720, %464 : i32
      llvm.cond_br %721, ^bb81, ^bb85 {llvm.loop_annotation = #loop_annotation}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%47 : i32)
    ^bb82(%722: i32):  // 2 preds: ^bb81, ^bb83
      %723 = llvm.icmp "slt" %722, %464 : i32
      llvm.cond_br %723, ^bb83, ^bb84 {llvm.loop_annotation = #loop_annotation}
    ^bb83:  // pred: ^bb82
    ...
    ^bb88:  // 2 preds: ^bb86, ^bb87
      ...
      llvm.br ^bb29(%733, %543, %541, %542, %546, %548, %550, %730 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb89:  // pred: ^bb29
      %734 = nvvm.elect.sync -> i1
      llvm.cond_br %734, ^bb90, ^bb91
    ^bb90:  // pred: ^bb89
    ...
    ^bb94:  // 2 preds: ^bb92, ^bb93
      ...
      llvm.br ^bb95(%47 : i32)
    ^bb95(%739: i32):  // 2 preds: ^bb94, ^bb102
      %740 = llvm.icmp "slt" %739, %24 : i32
      llvm.cond_br %740, ^bb96, ^bb103
    ^bb96:  // pred: ^bb95
      ...
      llvm.br ^bb97(%47 : i32)
    ^bb97(%750: i32):  // 2 preds: ^bb96, ^bb98
      %751 = llvm.icmp "slt" %750, %736 : i32
      llvm.cond_br %751, ^bb98, ^bb99 {llvm.loop_annotation = #loop_annotation}
    ^bb98:  // pred: ^bb97
    ...
    ^bb99:  // pred: ^bb97
      ...
      llvm.br ^bb100(%47 : i32)
    ^bb100(%778: i32):  // 2 preds: ^bb99, ^bb101
      %779 = llvm.icmp "slt" %778, %738 : i32
      llvm.cond_br %779, ^bb101, ^bb102 {llvm.loop_annotation = #loop_annotation}
    ^bb101:  // pred: ^bb100
