...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb14(%393: i32, %394: i32, %395: i32, %396: i32):  // 2 preds: ^bb13, ^bb27
      %397 = llvm.icmp "slt" %393, %391 : i32
      llvm.cond_br %397, ^bb15, ^bb28
    ^bb15:  // pred: ^bb14
    ...
    ^bb21:  // pred: ^bb20
      ...
      llvm.br ^bb22(%46 : i32)
    ^bb22(%432: i32):  // 2 preds: ^bb21, ^bb23
      %433 = llvm.icmp "slt" %432, %392 : i32
      llvm.cond_br %433, ^bb23, ^bb24 {llvm.loop_annotation = #loop_annotation}
    ^bb23:  // pred: ^bb22
    ...
    ^bb24:  // pred: ^bb22
      ...
      llvm.br ^bb25(%46 : i32)
    ^bb25(%460: i32):  // 2 preds: ^bb24, ^bb26
      %461 = llvm.icmp "slt" %460, %392 : i32
      llvm.cond_br %461, ^bb26, ^bb27 {llvm.loop_annotation = #loop_annotation}
    ^bb26:  // pred: ^bb25
      ...
      llvm.br ^bb25(%463 : i32)
    ^bb27:  // pred: ^bb25
      %464 = llvm.add %393, %49 : i32
      llvm.br ^bb14(%464, %404, %406, %402 : i32, i32, i32, i32)
    ^bb28:  // pred: ^bb14
      %465 = llvm.mlir.constant(1 : i32) : i32
      llvm.br ^bb29(%46, %396, %394, %395, %46, %46, %46, %arg0 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb29(%466: i32, %467: i32, %468: i32, %469: i32, %470: i32, %471: i32, %472: i32, %473: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb28, ^bb88
      %474 = llvm.icmp "slt" %466, %383 : i32
      llvm.cond_br %474, ^bb30, ^bb89
    ^bb30:  // pred: ^bb29
      %475 = llvm.add %466, %391 : i32
      %476 = llvm.icmp "ult" %475, %383 : i32
      llvm.cond_br %476, ^bb31, ^bb44
    ^bb31:  // pred: ^bb30
    ...
    ^bb33:  // 2 preds: ^bb31, ^bb32
      ...
      llvm.cond_br %482, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
      %484 = llvm.xor %469, %49 : i32
      llvm.br ^bb36(%484 : i32)
    ^bb35:  // pred: ^bb33
      llvm.br ^bb36(%469 : i32)
    ^bb36(%485: i32):  // 2 preds: ^bb34, ^bb35
      llvm.br ^bb37
    ^bb37:  // pred: ^bb36
      ...
      llvm.br ^bb38(%46 : i32)
    ^bb38(%512: i32):  // 2 preds: ^bb37, ^bb39
      %513 = llvm.icmp "slt" %512, %505 : i32
      llvm.cond_br %513, ^bb39, ^bb40 {llvm.loop_annotation = #loop_annotation}
    ^bb39:  // pred: ^bb38
    ...
    ^bb40:  // pred: ^bb38
      ...
      llvm.br ^bb41(%46 : i32)
    ^bb41(%540: i32):  // 2 preds: ^bb40, ^bb42
      %541 = llvm.icmp "slt" %540, %505 : i32
      llvm.cond_br %541, ^bb42, ^bb43 {llvm.loop_annotation = #loop_annotation}
    ^bb42:  // pred: ^bb41
      ...
      llvm.br ^bb41(%543 : i32)
    ^bb43:  // pred: ^bb41
      llvm.br ^bb45(%483, %485, %481 : i32, i32, i32)
    ^bb44:  // pred: ^bb30
      llvm.br ^bb45(%468, %469, %467 : i32, i32, i32)
    ^bb45(%544: i32, %545: i32, %546: i32):  // 2 preds: ^bb43, ^bb44
      llvm.br ^bb46
    ^bb46:  // pred: ^bb45
      ...
      llvm.cond_br %550, ^bb47, ^bb48
    ^bb47:  // pred: ^bb46
      %552 = llvm.xor %472, %49 : i32
      llvm.br ^bb49(%552 : i32)
    ^bb48:  // pred: ^bb46
      llvm.br ^bb49(%472 : i32)
    ^bb49(%553: i32):  // 2 preds: ^bb47, ^bb48
      llvm.br ^bb50
    ^bb50:  // pred: ^bb49
      ...
      llvm.br ^bb51(%46 : i32)
    ^bb51(%583: i32):  // 2 preds: ^bb50, ^bb58
      %584 = llvm.icmp "slt" %583, %465 : i32
      llvm.cond_br %584, ^bb52, ^bb59 {llvm.loop_annotation = #loop_annotation}
    ^bb52:  // pred: ^bb51
      llvm.br ^bb53(%46 : i32)
    ^bb53(%585: i32):  // 2 preds: ^bb52, ^bb57
      %586 = llvm.icmp "slt" %585, %465 : i32
      llvm.cond_br %586, ^bb54, ^bb58 {llvm.loop_annotation = #loop_annotation}
    ^bb54:  // pred: ^bb53
      llvm.br ^bb55(%46 : i32)
    ^bb55(%587: i32):  // 2 preds: ^bb54, ^bb56
      %588 = llvm.icmp "slt" %587, %465 : i32
      llvm.cond_br %588, ^bb56, ^bb57 {llvm.loop_annotation = #loop_annotation}
    ^bb56:  // pred: ^bb55
      ...
      llvm.br ^bb55(%592 : i32)
    ^bb57:  // pred: ^bb55
      %593 = llvm.add %585, %49 : i32
      llvm.br ^bb53(%593 : i32)
    ^bb58:  // pred: ^bb53
      %594 = llvm.add %583, %49 : i32
      llvm.br ^bb51(%594 : i32)
    ^bb59:  // pred: ^bb51
      ...
      llvm.br ^bb60(%46 : i32)
    ^bb60(%629: i32):  // 2 preds: ^bb59, ^bb67
      %630 = llvm.icmp "slt" %629, %465 : i32
      llvm.cond_br %630, ^bb61, ^bb68 {llvm.loop_annotation = #loop_annotation}
    ^bb61:  // pred: ^bb60
      llvm.br ^bb62(%46 : i32)
    ^bb62(%631: i32):  // 2 preds: ^bb61, ^bb66
      %632 = llvm.icmp "slt" %631, %465 : i32
      llvm.cond_br %632, ^bb63, ^bb67 {llvm.loop_annotation = #loop_annotation}
    ^bb63:  // pred: ^bb62
      llvm.br ^bb64(%46 : i32)
    ^bb64(%633: i32):  // 2 preds: ^bb63, ^bb65
      %634 = llvm.icmp "slt" %633, %465 : i32
      llvm.cond_br %634, ^bb65, ^bb66 {llvm.loop_annotation = #loop_annotation}
    ^bb65:  // pred: ^bb64
      ...
      llvm.br ^bb64(%638 : i32)
    ^bb66:  // pred: ^bb64
      %639 = llvm.add %631, %49 : i32
      llvm.br ^bb62(%639 : i32)
    ^bb67:  // pred: ^bb62
      %640 = llvm.add %629, %49 : i32
      llvm.br ^bb60(%640 : i32)
    ^bb68:  // pred: ^bb60
      ...
      llvm.br ^bb69(%46 : i32)
    ^bb69(%675: i32):  // 2 preds: ^bb68, ^bb76
      %676 = llvm.icmp "slt" %675, %465 : i32
      llvm.cond_br %676, ^bb70, ^bb77 {llvm.loop_annotation = #loop_annotation}
    ^bb70:  // pred: ^bb69
      llvm.br ^bb71(%46 : i32)
    ^bb71(%677: i32):  // 2 preds: ^bb70, ^bb75
      %678 = llvm.icmp "slt" %677, %465 : i32
      llvm.cond_br %678, ^bb72, ^bb76 {llvm.loop_annotation = #loop_annotation}
    ^bb72:  // pred: ^bb71
      llvm.br ^bb73(%46 : i32)
    ^bb73(%679: i32):  // 2 preds: ^bb72, ^bb74
      %680 = llvm.icmp "slt" %679, %465 : i32
      llvm.cond_br %680, ^bb74, ^bb75 {llvm.loop_annotation = #loop_annotation}
    ^bb74:  // pred: ^bb73
      ...
      llvm.br ^bb73(%684 : i32)
    ^bb75:  // pred: ^bb73
      %685 = llvm.add %677, %49 : i32
      llvm.br ^bb71(%685 : i32)
    ^bb76:  // pred: ^bb71
      %686 = llvm.add %675, %49 : i32
      llvm.br ^bb69(%686 : i32)
    ^bb77:  // pred: ^bb69
      ...
      llvm.br ^bb78(%46 : i32)
    ^bb78(%721: i32):  // 2 preds: ^bb77, ^bb85
      %722 = llvm.icmp "slt" %721, %465 : i32
      llvm.cond_br %722, ^bb79, ^bb86 {llvm.loop_annotation = #loop_annotation}
    ^bb79:  // pred: ^bb78
      llvm.br ^bb80(%46 : i32)
    ^bb80(%723: i32):  // 2 preds: ^bb79, ^bb84
      %724 = llvm.icmp "slt" %723, %465 : i32
      llvm.cond_br %724, ^bb81, ^bb85 {llvm.loop_annotation = #loop_annotation}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%46 : i32)
    ^bb82(%725: i32):  // 2 preds: ^bb81, ^bb83
      %726 = llvm.icmp "slt" %725, %465 : i32
      llvm.cond_br %726, ^bb83, ^bb84 {llvm.loop_annotation = #loop_annotation}
    ^bb83:  // pred: ^bb82
    ...
    ^bb88:  // 2 preds: ^bb86, ^bb87
      ...
      llvm.br ^bb29(%736, %546, %544, %545, %549, %551, %553, %733 : i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb89:  // pred: ^bb29
      %737 = nvvm.elect.sync -> i1
      llvm.cond_br %737, ^bb90, ^bb91
    ^bb90:  // pred: ^bb89
    ...
    ^bb94:  // 2 preds: ^bb92, ^bb93
      ...
      llvm.br ^bb95(%46 : i32)
    ^bb95(%742: i32):  // 2 preds: ^bb94, ^bb102
      %743 = llvm.icmp "slt" %742, %23 : i32
      llvm.cond_br %743, ^bb96, ^bb103
    ^bb96:  // pred: ^bb95
      ...
      llvm.br ^bb97(%46 : i32)
    ^bb97(%753: i32):  // 2 preds: ^bb96, ^bb98
      %754 = llvm.icmp "slt" %753, %739 : i32
      llvm.cond_br %754, ^bb98, ^bb99 {llvm.loop_annotation = #loop_annotation}
    ^bb98:  // pred: ^bb97
    ...
    ^bb100(%779: i32):  // 2 preds: ^bb99, ^bb101
      %780 = llvm.icmp "slt" %779, %741 : i32
      llvm.cond_br %780, ^bb101, ^bb102 {llvm.loop_annotation = #loop_annotation}
    ^bb101:  // pred: ^bb100
