...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb12:  // 2 preds: ^bb10, ^bb11
      ...
      "llvm.cond_br"(%389)[^bb13, ^bb44] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb13:  // pred: ^bb12
    ...
    ^bb14(%683: i32, %684: i32, %685: i32, %686: i32):  // 2 preds: ^bb13, ^bb21
      %687 = "llvm.icmp"(%683, %680) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%687)[^bb15, ^bb22] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb15:  // pred: ^bb14
    ...
    ^bb22:  // pred: ^bb14
      "llvm.br"(%338, %686, %684, %685, %338, %338, %338, %arg6)[^bb23] : (i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>) -> ()
    ^bb23(%745: i32, %746: i32, %747: i32, %748: i32, %749: i32, %750: i32, %751: i32, %752: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb22, ^bb40
      %753 = "llvm.icmp"(%745, %672) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%753)[^bb24, ^bb41] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb24:  // pred: ^bb23
      %754 = "llvm.add"(%745, %680) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %755 = "llvm.icmp"(%754, %672) <{predicate = 6 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%755)[^bb25, ^bb32] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb25:  // pred: ^bb24
      ...
      "llvm.cond_br"(%757)[^bb26, ^bb27] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb26:  // pred: ^bb25
    ...
    ^bb27:  // 2 preds: ^bb25, ^bb26
      ...
      "llvm.cond_br"(%761)[^bb28, ^bb29] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb28:  // pred: ^bb27
      %763 = "llvm.xor"(%748, %341) : (i32, i32) -> i32
      "llvm.br"(%763)[^bb30] : (i32) -> ()
    ^bb29:  // pred: ^bb27
      "llvm.br"(%748)[^bb30] : (i32) -> ()
    ^bb30(%764: i32):  // 2 preds: ^bb28, ^bb29
      "llvm.br"()[^bb31] : () -> ()
    ^bb31:  // pred: ^bb30
      ...
      "llvm.br"(%762, %764, %760)[^bb33] : (i32, i32, i32) -> ()
    ^bb32:  // pred: ^bb24
      "llvm.br"(%747, %748, %746)[^bb33] : (i32, i32, i32) -> ()
    ^bb33(%814: i32, %815: i32, %816: i32):  // 2 preds: ^bb31, ^bb32
      "llvm.br"()[^bb34] : () -> ()
    ^bb34:  // pred: ^bb33
      ...
      "llvm.cond_br"(%820)[^bb35, ^bb36] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb35:  // pred: ^bb34
      %822 = "llvm.xor"(%751, %341) : (i32, i32) -> i32
      "llvm.br"(%822)[^bb37] : (i32) -> ()
    ^bb36:  // pred: ^bb34
      "llvm.br"(%751)[^bb37] : (i32) -> ()
    ^bb37(%823: i32):  // 2 preds: ^bb35, ^bb36
      "llvm.br"()[^bb38] : () -> ()
    ^bb38:  // pred: ^bb37
      ...
      "llvm.cond_br"(%941)[^bb39, ^bb40] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb39:  // pred: ^bb38
    ...
    ^bb40:  // 2 preds: ^bb38, ^bb39
      ...
      "llvm.br"(%943, %816, %814, %815, %819, %821, %823, %940)[^bb23] : (i32, i32, i32, i32, i32, i32, i32, !llvm.struct<(i1, i1, i1)>) -> ()
    ^bb41:  // pred: ^bb23
      %944 = "nvvm.elect.sync"() : () -> i1
      "llvm.cond_br"(%944)[^bb42, ^bb43] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb42:  // pred: ^bb41
    ...
    ^bb44:  // 2 preds: ^bb12, ^bb43
      "llvm.cond_br"(%389)[^bb45, ^bb46] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb45:  // pred: ^bb44
    ...
    ^bb46:  // 2 preds: ^bb44, ^bb45
      ...
      "llvm.br"(%338)[^bb47] : (i32) -> ()
    ^bb47(%947: i32):  // 2 preds: ^bb46, ^bb51
      %948 = "llvm.icmp"(%947, %316) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%948)[^bb48, ^bb52] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb48:  // pred: ^bb47
      ...
      "llvm.br"(%338)[^bb49] : (i32) -> ()
    ^bb49(%981: i32):  // 2 preds: ^bb48, ^bb50
      %982 = "llvm.icmp"(%981, %316) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%982)[^bb50, ^bb51] <{operandSegmentSizes = array<i32: 1, 0, 0>}> {llvm.loop_annotation = #loop_annotation} : (i1) -> ()
    ^bb50:  // pred: ^bb49
    ...
    ^bb52:  // pred: ^bb47
      ...
      "llvm.cond_br"(%389)[^bb53, ^bb54] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb53:  // pred: ^bb52
