...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb12(%651: i32, %652: i32, %653: i32, %654: i1, %655: i32, %656: i32, %657: i32, %658: i32):  // 2 preds: ^bb11, ^bb38
      llvm.cond_br %654, ^bb13(%651, %652, %653, %655, %656, %657, %658 : i32, i32, i32, i32, i32, i32, i32), ^bb39
    ...
    ^bb14(%708: i32, %709: i1, %710: i32, %711: i32, %712: i32):  // 2 preds: ^bb13, ^bb37
      %713 = llvm.icmp "slt" %708, %478 : i32
      llvm.cond_br %713, ^bb15, ^bb38 {loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
    ...
    ^bb24(%756: i32):  // 2 preds: ^bb23, ^bb27
      %757 = llvm.icmp "slt" %756, %647 : i32
      llvm.cond_br %757, ^bb25, ^bb28 {llvm.loop_annotation = #loop_annotation1}
    ^bb25:  // pred: ^bb24
      %758 = nvvm.elect.sync -> i1
      llvm.cond_br %758, ^bb26, ^bb27
    ^bb26:  // pred: ^bb25
    ...
    ^bb28:  // pred: ^bb24
      ...
      llvm.br ^bb29(%170 : i32)
    ^bb29(%786: i32):  // 2 preds: ^bb28, ^bb32
      %787 = llvm.icmp "slt" %786, %647 : i32
      llvm.cond_br %787, ^bb30, ^bb33 {llvm.loop_annotation = #loop_annotation1}
    ^bb30:  // pred: ^bb29
      %788 = nvvm.elect.sync -> i1
      llvm.cond_br %788, ^bb31, ^bb32
    ^bb31:  // pred: ^bb30
    ...
    ^bb32:  // 2 preds: ^bb30, ^bb31
      ...
      llvm.br ^bb29(%789 : i32)
    ^bb33:  // pred: ^bb29
      %790 = llvm.icmp "sgt" %478, %720 : i32
      llvm.cond_br %790, ^bb34, ^bb35
    ^bb34:  // pred: ^bb33
    ...
    ^bb40:  // pred: ^bb39
      ...
      llvm.br ^bb42(%822 : i32)
    ^bb41:  // pred: ^bb39
      llvm.br ^bb42(%656 : i32)
    ^bb42(%823: i32):  // 2 preds: ^bb40, ^bb41
      llvm.br ^bb43
    ^bb43:  // pred: ^bb42
    ...
    ^bb44:  // pred: ^bb43
      ...
      llvm.br ^bb46(%827 : i32)
    ^bb45:  // pred: ^bb43
      llvm.br ^bb46(%823 : i32)
    ^bb46(%828: i32):  // 2 preds: ^bb44, ^bb45
      llvm.br ^bb47
    ^bb47:  // pred: ^bb46
    ...
    ^bb49:  // pred: ^bb47
      llvm.br ^bb50(%828 : i32)
    ^bb50(%833: i32):  // 2 preds: ^bb48, ^bb49
      llvm.br ^bb51
    ^bb51:  // pred: ^bb50
    ...
    ^bb53:  // pred: ^bb51
      llvm.br ^bb54(%833 : i32)
    ^bb54(%838: i32):  // 2 preds: ^bb52, ^bb53
      llvm.br ^bb55
    ^bb55:  // pred: ^bb54
    ...
    ^bb57:  // pred: ^bb55
      llvm.br ^bb58(%838 : i32)
    ^bb58(%843: i32):  // 2 preds: ^bb56, ^bb57
      llvm.br ^bb59
    ^bb59:  // pred: ^bb58
    ...
    ^bb61:  // pred: ^bb59
      llvm.br ^bb62(%843 : i32)
    ^bb62(%848: i32):  // 2 preds: ^bb60, ^bb61
      llvm.br ^bb63
    ^bb63:  // pred: ^bb62
    ...
    ^bb67:  // pred: ^bb66
      ...
      llvm.br ^bb68(%873, %170, %170, %arg0, %170, %170, %171, %854, %170 : i1, i32, i32, !llvm.struct<(i1, i1, i1)>, i32, i32, i32, i32, i32)
    ...
    ^bb74:  // pred: ^bb73
      ...
      llvm.br ^bb76(%942 : i32)
    ^bb75:  // pred: ^bb73
      llvm.br ^bb76(%932 : i32)
    ^bb76(%943: i32):  // 2 preds: ^bb74, ^bb75
      llvm.br ^bb77
    ^bb77:  // pred: ^bb76
      llvm.br ^bb78(%170, %933 : i32, !llvm.struct<(i1, i1, i1)>)
    ^bb78(%944: i32, %945: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb77, ^bb90
      %946 = llvm.icmp "slt" %944, %159 : i32
      llvm.cond_br %946, ^bb79, ^bb91 {loop_annotation = #loop_annotation2}
    ^bb79:  // pred: ^bb78
    ...
    ^bb80(%980: i32):  // 2 preds: ^bb79, ^bb89
      %981 = llvm.icmp "slt" %980, %901 : i32
      llvm.cond_br %981, ^bb81, ^bb90 {llvm.loop_annotation = #loop_annotation1}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%170 : i32)
    ^bb82(%982: i32):  // 2 preds: ^bb81, ^bb88
      %983 = llvm.icmp "slt" %982, %901 : i32
      llvm.cond_br %983, ^bb83, ^bb89 {llvm.loop_annotation = #loop_annotation1}
    ^bb83:  // pred: ^bb82
      llvm.br ^bb84(%170 : i32)
    ^bb84(%984: i32):  // 2 preds: ^bb83, ^bb87
      %985 = llvm.icmp "slt" %984, %901 : i32
      llvm.cond_br %985, ^bb85, ^bb88 {llvm.loop_annotation = #loop_annotation1}
    ^bb85:  // pred: ^bb84
      %986 = llvm.mlir.constant(dense<0> : vector<4xi32>) : vector<4xi32>
      %987 = llvm.inttoptr %923 : i32 to !llvm.ptr<6>
      %988 = nvvm.elect.sync -> i1
      llvm.cond_br %988, ^bb86, ^bb87
    ^bb86:  // pred: ^bb85
    ...
    ^bb87:  // 2 preds: ^bb85, ^bb86
      ...
      llvm.br ^bb84(%989 : i32)
    ^bb88:  // pred: ^bb84
      %990 = llvm.add %982, %171 : i32
      llvm.br ^bb82(%990 : i32)
    ^bb89:  // pred: ^bb82
    ...
    ^bb97:  // pred: ^bb96
      ...
      llvm.br ^bb70(%1000, %999, %939, %941, %943, %945 : i32, i1, i32, i32, i32, !llvm.struct<(i1, i1, i1)>)
    ^bb98:  // pred: ^bb70
      %1001 = nvvm.elect.sync -> i1
      llvm.cond_br %1001, ^bb99, ^bb100
    ^bb99:  // pred: ^bb98
    ...
    ^bb101:  // pred: ^bb100
      ...
      llvm.br ^bb103(%1007 : i32)
    ^bb102:  // pred: ^bb100
      llvm.br ^bb103(%916 : i32)
    ^bb103(%1008: i32):  // 2 preds: ^bb101, ^bb102
      llvm.br ^bb104
    ^bb104:  // pred: ^bb103
      ...
      llvm.br ^bb68(%1011, %931, %932, %933, %1004, %1006, %1008, %1009, %1010 : i1, i32, i32, !llvm.struct<(i1, i1, i1)>, i32, i32, i32, i32, i32)
    ^bb105:  // pred: ^bb68
    ...
    ^bb107:  // pred: ^bb106
      ...
      llvm.br ^bb109(%1035 : i32)
    ^bb108:  // pred: ^bb106
      llvm.br ^bb109(%908 : i32)
    ^bb109(%1036: i32):  // 2 preds: ^bb107, ^bb108
      llvm.br ^bb110
    ^bb110:  // pred: ^bb109
    ...
    ^bb112:  // 2 preds: ^bb66, ^bb111
      ...
      llvm.cond_br %1038, ^bb113, ^bb135
    ^bb113:  // pred: ^bb112
      llvm.cond_br %237, ^bb114, ^bb115
    ^bb114:  // pred: ^bb113
    ...
    ^bb115:  // 2 preds: ^bb113, ^bb114
      ...
      llvm.br ^bb116(%1152, %1165, %1163, %1126, %170, %170, %170, %1040, %170 : i32, i32, i32, i1, i32, i32, i32, i32, i32)
    ^bb116(%1423: i32, %1424: i32, %1425: i32, %1426: i1, %1427: i32, %1428: i32, %1429: i32, %1430: i32, %1431: i32):  // 2 preds: ^bb115, ^bb129
      llvm.cond_br %1426, ^bb117(%1423, %1424, %1425, %1427, %1428, %1429, %1430, %1431 : i32, i32, i32, i32, i32, i32, i32, i32), ^bb130
    ^bb117(%1432: i32, %1433: i32, %1434: i32, %1435: i32, %1436: i32, %1437: i32, %1438: i32, %1439: i32):  // pred: ^bb116
    ...
    ^bb118(%1470: i32):  // 2 preds: ^bb117, ^bb119
      ...
      llvm.cond_br %1471, ^bb119, ^bb120 {llvm.loop_annotation = #loop_annotation1}
    ^bb119:  // pred: ^bb118
    ...
    ^bb120:  // pred: ^bb118
      ...
      llvm.br ^bb121(%170 : i32)
    ^bb121(%1740: i32):  // 2 preds: ^bb120, ^bb122
      %1741 = llvm.icmp "slt" %1740, %1168 : i32
      llvm.cond_br %1741, ^bb122, ^bb123 {llvm.loop_annotation = #loop_annotation1}
    ^bb122:  // pred: ^bb121
      ...
      llvm.br ^bb121(%1870 : i32)
    ^bb123:  // pred: ^bb121
      %1871 = nvvm.elect.sync -> i1
      llvm.cond_br %1871, ^bb124, ^bb125
    ^bb124:  // pred: ^bb123
    ...
    ^bb126:  // pred: ^bb125
      ...
      llvm.br ^bb128(%1877 : i32)
    ^bb127:  // pred: ^bb125
      llvm.br ^bb128(%1437 : i32)
    ^bb128(%1878: i32):  // 2 preds: ^bb126, ^bb127
      llvm.br ^bb129
    ^bb129:  // pred: ^bb128
