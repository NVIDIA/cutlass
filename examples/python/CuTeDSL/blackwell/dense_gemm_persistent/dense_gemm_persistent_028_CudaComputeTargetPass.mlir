gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb14(%256: i32, %257: i1, %258: i32, %259: i32, %260: i32):  // 2 preds: ^bb13, ^bb37
    ...
    llvm.cond_br %261, ^bb15, ^bb38 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb15:  // pred: ^bb14
  ...
  ^bb24(%278: i32):  // 2 preds: ^bb23, ^bb27
    ...
    llvm.cond_br %279, ^bb25, ^bb28 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb25:  // pred: ^bb24
  ...
  ^bb29(%283: i32):  // 2 preds: ^bb28, ^bb32
    ...
    llvm.cond_br %284, ^bb30, ^bb33 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb30:  // pred: ^bb29
  ...
  ^bb78(%413: i32, %414: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb77, ^bb90
    ...
    llvm.cond_br %415, ^bb79, ^bb91 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb79:  // pred: ^bb78
  ...
  ^bb80(%438: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %439, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%16 : i32)
  ^bb82(%440: i32):  // 2 preds: ^bb81, ^bb88
    %441 = llvm.icmp "slt" %440, %36 : i32
    llvm.cond_br %441, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%16 : i32)
  ^bb84(%442: i32):  // 2 preds: ^bb83, ^bb87
    %443 = llvm.icmp "slt" %442, %36 : i32
    llvm.cond_br %443, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb118(%728: i32):  // 2 preds: ^bb117, ^bb119
    ...
    llvm.cond_br %729, ^bb119, ^bb120 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb119:  // pred: ^bb118
  ...
  ^bb121(%861: i32):  // 2 preds: ^bb120, ^bb122
    ...
    llvm.cond_br %862, ^bb122, ^bb123 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb122:  // pred: ^bb121
