gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb14(%255: i32, %256: i1, %257: i32, %258: i32, %259: i32):  // 2 preds: ^bb13, ^bb37
    ...
    llvm.cond_br %260, ^bb15, ^bb38 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb15:  // pred: ^bb14
  ...
  ^bb24(%277: i32):  // 2 preds: ^bb23, ^bb27
    ...
    llvm.cond_br %278, ^bb25, ^bb28 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb25:  // pred: ^bb24
  ...
  ^bb29(%282: i32):  // 2 preds: ^bb28, ^bb32
    ...
    llvm.cond_br %283, ^bb30, ^bb33 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb30:  // pred: ^bb29
  ...
  ^bb78(%412: i32, %413: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb77, ^bb90
    ...
    llvm.cond_br %414, ^bb79, ^bb91 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb79:  // pred: ^bb78
  ...
  ^bb80(%437: i32):  // 2 preds: ^bb79, ^bb89
    ...
    llvm.cond_br %438, ^bb81, ^bb90 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb81:  // pred: ^bb80
    llvm.br ^bb82(%16 : i32)
  ^bb82(%439: i32):  // 2 preds: ^bb81, ^bb88
    %440 = llvm.icmp "slt" %439, %36 : i32
    llvm.cond_br %440, ^bb83, ^bb89 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb83:  // pred: ^bb82
    llvm.br ^bb84(%16 : i32)
  ^bb84(%441: i32):  // 2 preds: ^bb83, ^bb87
    %442 = llvm.icmp "slt" %441, %36 : i32
    llvm.cond_br %442, ^bb85, ^bb88 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb85:  // pred: ^bb84
  ...
  ^bb118(%727: i32):  // 2 preds: ^bb117, ^bb119
    ...
    llvm.cond_br %728, ^bb119, ^bb120 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb119:  // pred: ^bb118
  ...
  ^bb121(%860: i32):  // 2 preds: ^bb120, ^bb122
    ...
    llvm.cond_br %861, ^bb122, ^bb123 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb122:  // pred: ^bb121
