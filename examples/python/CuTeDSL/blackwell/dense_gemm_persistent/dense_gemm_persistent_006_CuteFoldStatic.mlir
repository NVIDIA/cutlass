  ...
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass_kernel___main__PersistentDenseGemmKernel_object_at__TiledMMA_ThrLayoutVMNK11110000_PermutationMNK____MMAAtom_ThrID10_ShapeMNK1281288_TVLayoutA112881281128_TVLayoutB11288128_0(%arg0: !mma_tf32_tf32_f32_128x128x8_, %arg1: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg2: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg3: !cute_nvgpu.atom.non_exec_tiled_tma_load<sm_90, f32, copy_bits = 131072, tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">, internal_val_type = tf32>, %arg4: !cute.coord_tensor<"(0,0,0)", "(?,?,?):(1@1,1@0,1@2)">, %arg5: !memref_gmem_f32_, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: !cute.fast_divmod_divisor<32>, %arg10: !cute.fast_divmod_divisor<32>, %arg11: !cute.fast_divmod_divisor<32>) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 192, 1, 1>} {
      ...
      %185:3 = scf.if %184 -> (i32, i32, i32) {
        %190 = nvvm.read.ptx.sreg.ctaid.x : i32
        %191 = nvvm.read.ptx.sreg.ctaid.y : i32
        %192 = nvvm.read.ptx.sreg.ctaid.z : i32
        %193 = nvvm.read.ptx.sreg.nctaid.x : i32
        %194 = nvvm.read.ptx.sreg.nctaid.y : i32
        %195 = nvvm.read.ptx.sreg.nctaid.z : i32
        ...
        ^bb0(%arg12: i32, %arg13: i32, %arg14: i32, %arg15: i1, %arg16: i32, %arg17: i32, %arg18: i32, %arg19: i32, %arg20: i32, %arg21: i32, %arg22: i32, %arg23: i32, %arg24: i32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: !cute.fast_divmod_divisor<32>, %arg29: !cute.fast_divmod_divisor<32>, %arg30: !cute.fast_divmod_divisor<32>):
          ...
          %358:4 = scf.for %arg31 = %c0_i32_169 to %164 step %c1_i32_170 iter_args(%arg32 = %357, %arg33 = %c0_i32_169, %arg34 = %arg17, %arg35 = %arg18) -> (i1, i32, i32, i32)  : i32 {
            %400 = arith.extui %arg32 : i1 to i32
            %c0_i32_194 = arith.constant 0 : i32
            %401 = arith.cmpi eq, %400, %c0_i32_194 : i32
            scf.if %401 {
              ...
              %425 = builtin.unrealized_conversion_cast %ptr_257 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            ...
            scf.if %true_195 {
              ...
              scf.if %425 {
                ...
                %426 = builtin.unrealized_conversion_cast %ptr_257 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            ...
            %402 = arith.addi %arg34, %c1_i32_196 : i32
            %403 = arith.addi %arg33, %c1_i32_196 : i32
            %c7_i32_197 = arith.constant 7 : i32
            %404 = arith.cmpi eq, %402, %c7_i32_197 : i32
            %405:2 = scf.if %404 -> (i32, i32) {
              %c1_i32_256 = arith.constant 1 : i32
              %425 = arith.xori %arg35, %c1_i32_256 : i32
              %c0_i32_257 = arith.constant 0 : i32
              scf.yield %c0_i32_257, %425 : i32, i32
            } else {
            ...
            %idx_209 = cute.crd2idx(%coord_208, %406) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),7):((1,0),4096)">) -> !cute.int_tuple<"?{div=4096}">
            ...
            %view_217 = cute.make_view(%int_tuple_216, %407) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">
            ...
            %view_220 = cute.make_view(%iter_213, %408) : !memref_smem_f32_4
            ...
            %410 = cute_nvgpu.atom.set_value(%409, %ptr_215 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            ...
            scf.for %arg36 = %c0_i32_225 to %413 step %c1_i32_226  : i32 {
              %425 = cute.static : !cute.layout<"(((32,128),1)):(((1@0,1@1),0))">
              %426 = cute.static : !cute.int_tuple<"(0,0)">
              %tup_256 = cute.add_offset(%iter_223, %426) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">, !cute.int_tuple<"(0,0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %view_257 = cute.make_view(%tup_256, %425) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
              %427 = cute.static : !cute.layout<"((4096,1)):((1,0))">
              %428 = cute.static : !cute.int_tuple<"0">
              %ptr_258 = cute.add_offset(%iter_224, %428) : (!cute.ptr<f32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"0">) -> !cute.ptr<f32, smem, align<128>, S<3,4,3>>
              %view_259 = cute.make_view(%ptr_258, %427) : !memref_smem_f32_3
              ...
              %431:3 = cute.get_scalars(%iter_260) : !cute.int_tuple<"(?{div=32},?{div=128},?)">
              cute_nvgpu.arch.copy.SM100.tma_load(%TMADescAddr : !cute.ptr<generic, align<64>>, %iter_261 : !cute.ptr<f32, smem, align<128>, S<3,4,3>>, %429 : !cute.ptr<smem, align<8>>, [%431#0, %431#1, %431#2] : i32, i32, i32) cache_policy = %430 mode = <tiled> num_cta = 1 : i32
            ...
            %idx_238 = cute.crd2idx(%coord_237, %414) : (!cute.coord<"(_,?)">, !cute.layout<"((4096,1),7):((1,0),4096)">) -> !cute.int_tuple<"?{div=4096}">
            ...
            %view_246 = cute.make_view(%int_tuple_245, %415) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1),1):(((1@0,1@1),0),0)">
            ...
            %view_249 = cute.make_view(%iter_242, %416) : !memref_smem_f32_4
            ...
            %418 = cute_nvgpu.atom.set_value(%417, %ptr_244 : !cute.ptr<i64, smem>) {field = #cute_nvgpu.atom_copy_field_tmaload<tma_bar>} : !cute_nvgpu.atom.tma_load<f32, copy_bits = 131072, mode = tiled, num_cta = 1, g_stride = <"()"> tma_gbasis = <"(32,128,1):(1@1,1@0,1@2)">>
            ...
            scf.for %arg36 = %c0_i32_254 to %421 step %c1_i32_255  : i32 {
              %425 = cute.static : !cute.layout<"(((32,128),1)):(((1@0,1@1),0))">
              %426 = cute.static : !cute.int_tuple<"(0,0)">
              %tup_256 = cute.add_offset(%iter_252, %426) : (!cute.int_tuple<"(?{div=32},?{div=128},?)">, !cute.int_tuple<"(0,0)">) -> !cute.int_tuple<"(?{div=32},?{div=128},?)">
              %view_257 = cute.make_view(%tup_256, %425) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
              %427 = cute.static : !cute.layout<"((4096,1)):((1,0))">
              %428 = cute.static : !cute.int_tuple<"0">
              %ptr_258 = cute.add_offset(%iter_253, %428) : (!cute.ptr<f32, smem, align<128>, S<3,4,3>>, !cute.int_tuple<"0">) -> !cute.ptr<f32, smem, align<128>, S<3,4,3>>
              %view_259 = cute.make_view(%ptr_258, %427) : !memref_smem_f32_3
              %iter_260 = cute.get_iter(%view_257) : !cute.coord_tensor<"(?{div=32},?{div=128},?)", "(((32,128),1)):(((1@0,1@1),0))">
              %iter_261 = cute.get_iter(%view_259) : !memref_smem_f32_3
            ...
            %422 = arith.addi %arg33, %c1_i32_196 : i32
            %423 = arith.cmpi sgt, %164, %422 : i32
            %424:4 = scf.if %423 -> (i1, i32, i32, i32) {
              %int_tuple_256 = cute.make_int_tuple(%405#0) : (i32) -> !cute.int_tuple<"?">
              %ptr_257 = cute.add_offset(%ptr_13, %int_tuple_256) : (!cute.ptr<i64, smem>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
              %425 = builtin.unrealized_conversion_cast %ptr_257 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              ...
              scf.yield %true_195, %403, %405#0, %405#1 : i1, i32, i32, i32
            }
          ...
          %362 = cute.get_scalars(%e0_172) : !cute.int_tuple<"?">
          ...
          %367 = nvvm.mul  hi %360, %multiplier_173 : i32 -> i32
          ...
          %375 = arith.extui %shift1_177 : i8 to i32
          %376 = arith.extui %shift2_178 : i8 to i32
          %377 = nvvm.mul  hi %373, %multiplier_176 : i32 -> i32
          ...
          %385 = arith.extui %shift1_180 : i8 to i32
          %386 = arith.extui %shift2_181 : i8 to i32
          %387 = nvvm.mul  hi %381, %multiplier_179 : i32 -> i32
          ...
          %int_tuple_182 = cute.make_int_tuple(%383) : (i32) -> !cute.int_tuple<"?">
          %mul_183 = cute.tuple_mul(%int_tuple_182, %394) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          ...
          %395 = cute.get_scalars(%tup_185) : !cute.int_tuple<"?">
          %396 = cute.static : !cute.int_tuple<"1">
          %int_tuple_186 = cute.make_int_tuple(%393) : (i32) -> !cute.int_tuple<"?">
          %mul_187 = cute.tuple_mul(%int_tuple_186, %396) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          ...
          %397 = cute.get_scalars(%tup_189) : !cute.int_tuple<"?">
          %398 = cute.static : !cute.int_tuple<"1">
          %int_tuple_190 = cute.make_int_tuple(%391) : (i32) -> !cute.int_tuple<"?">
          %mul_191 = cute.tuple_mul(%int_tuple_190, %398) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          ...
          %399 = cute.get_scalars(%tup_193) : !cute.int_tuple<"?">
      ...
      %187:5 = scf.if %186 -> (!cute.ptr<i32, smem, align<8>>, i32, i32, i32, !mma_tf32_tf32_f32_128x128x8_) {
        ...
        %191 = nvvm.read.ptx.sreg.ctaid.x : i32
        %192 = nvvm.read.ptx.sreg.ctaid.y : i32
        %193 = nvvm.read.ptx.sreg.ctaid.z : i32
        %194 = nvvm.read.ptx.sreg.nctaid.x : i32
        %195 = nvvm.read.ptx.sreg.nctaid.y : i32
        %196 = nvvm.read.ptx.sreg.nctaid.z : i32
