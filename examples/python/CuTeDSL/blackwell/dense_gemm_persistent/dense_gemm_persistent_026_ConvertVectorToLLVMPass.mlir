...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb14(%254: i32, %255: i1, %256: i32, %257: i32, %258: i32):  // 2 preds: ^bb13, ^bb37
      ...
      llvm.cond_br %259, ^bb15, ^bb38 {loop_annotation = #loop_annotation}
    ^bb15:  // pred: ^bb14
    ...
    ^bb16:  // pred: ^bb15
      ...
      nvvm.mbarrier.try_wait.parity.shared %262, %258, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb17
    ...
    ^bb24(%276: i32):  // 2 preds: ^bb23, ^bb27
      ...
      llvm.cond_br %277, ^bb25, ^bb28 {llvm.loop_annotation = #loop_annotation1}
    ^bb25:  // pred: ^bb24
    ...
    ^bb29(%281: i32):  // 2 preds: ^bb28, ^bb32
      ...
      llvm.cond_br %282, ^bb30, ^bb33 {llvm.loop_annotation = #loop_annotation1}
    ^bb30:  // pred: ^bb29
    ...
    ^bb63:  // pred: ^bb62
      ...
      nvvm.mbarrier.try_wait.parity.shared %343, %342, %21 : !llvm.ptr<3>, i32, i32
    ...
    ^bb69:  // pred: ^bb68
      ...
      nvvm.mbarrier.try_wait.parity.shared %393, %387, %21 : !llvm.ptr<3>, i32, i32
    ...
    ^bb72:  // pred: ^bb71
      ...
      nvvm.mbarrier.try_wait.parity.shared %404, %399, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb73
    ...
    ^bb78(%411: i32, %412: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb77, ^bb90
      ...
      llvm.cond_br %413, ^bb79, ^bb91 {loop_annotation = #loop_annotation2}
    ^bb79:  // pred: ^bb78
    ...
    ^bb80(%436: i32):  // 2 preds: ^bb79, ^bb89
      ...
      llvm.cond_br %437, ^bb81, ^bb90 {llvm.loop_annotation = #loop_annotation1}
    ^bb81:  // pred: ^bb80
      llvm.br ^bb82(%16 : i32)
    ^bb82(%438: i32):  // 2 preds: ^bb81, ^bb88
      %439 = llvm.icmp "slt" %438, %36 : i32
      llvm.cond_br %439, ^bb83, ^bb89 {llvm.loop_annotation = #loop_annotation1}
    ^bb83:  // pred: ^bb82
      llvm.br ^bb84(%16 : i32)
    ^bb84(%440: i32):  // 2 preds: ^bb83, ^bb87
      %441 = llvm.icmp "slt" %440, %36 : i32
      llvm.cond_br %441, ^bb85, ^bb88 {llvm.loop_annotation = #loop_annotation1}
    ^bb85:  // pred: ^bb84
    ...
    ^bb110:  // pred: ^bb109
      ...
      nvvm.mbarrier.try_wait.parity.shared %487, %486, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb111
    ...
    ^bb117:  // pred: ^bb116
      ...
      nvvm.mbarrier.try_wait.parity.shared %725, %712, %21 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb118(%16 : i32)
    ^bb118(%726: i32):  // 2 preds: ^bb117, ^bb119
      %727 = llvm.icmp "slt" %726, %36 : i32
      llvm.cond_br %727, ^bb119, ^bb120 {llvm.loop_annotation = #loop_annotation1}
    ^bb119:  // pred: ^bb118
    ...
    ^bb121(%859: i32):  // 2 preds: ^bb120, ^bb122
      ...
      llvm.cond_br %860, ^bb122, ^bb123 {llvm.loop_annotation = #loop_annotation1}
    ^bb122:  // pred: ^bb121
