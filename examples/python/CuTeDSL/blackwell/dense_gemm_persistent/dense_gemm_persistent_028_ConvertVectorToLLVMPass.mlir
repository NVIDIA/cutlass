...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb16:  // pred: ^bb15
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%683, %679, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb17] : () -> ()
    ...
    ^bb57:  // pred: ^bb56
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%757, %756, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb63:  // pred: ^bb62
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%807, %801, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
    ...
    ^bb66:  // pred: ^bb65
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%818, %813, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb67] : () -> ()
    ...
    ^bb95:  // pred: ^bb94
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%892, %891, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
      "llvm.br"()[^bb96] : () -> ()
    ...
    ^bb102:  // pred: ^bb101
      ...
      "nvvm.mbarrier.try_wait.parity.shared"(%1130, %1117, %440) <{useIntrinsic = false}> : (!llvm.ptr<3>, i32, i32) -> ()
