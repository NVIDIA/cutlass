...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb10:  // 2 preds: ^bb8, ^bb9
      ...
      %102 = llvm.select %21, %12, %36 : i1, i32
      ...
      %126 = llvm.select %21, %12, %36 : i1, i32
    ...
    ^bb16:  // pred: ^bb15
      ...
      nvvm.mbarrier.try_wait.parity.shared %271, %267, %20 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb17
    ...
    ^bb18:  // pred: ^bb17
      ...
      nvvm.mbarrier.txn %273, %22 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
      llvm.br ^bb19
    ^bb19:  // 2 preds: ^bb17, ^bb18
      %274 = llvm.add %266, %36 : i32
      %275 = llvm.add %265, %36 : i32
      %276 = llvm.icmp "eq" %274, %23 : i32
    ...
    ^bb23:  // pred: ^bb22
      ...
      %282 = llvm.getelementptr %83[%281] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, f32
    ...
    ^bb28:  // pred: ^bb24
      ...
      %290 = llvm.getelementptr %84[%281] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, f32
    ...
    ^bb63:  // pred: ^bb62
      ...
      nvvm.mbarrier.try_wait.parity.shared %354, %353, %20 : !llvm.ptr<3>, i32, i32
      %355 = nvvm.elect.sync -> i1
      llvm.cond_br %355, ^bb64, ^bb65
    ^bb64:  // pred: ^bb63
      %356 = llvm.getelementptr %10[%351] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i64
      nvvm.mbarrier.txn %356, %22 {kind = #nvvm.mbar_txn_kind<arrive_expect_tx>} : !llvm.ptr<3>, i32
      llvm.br ^bb65
    ...
    ^bb69(%400: i32, %401: i32, %402: !llvm.struct<(i1, i1, i1)>, %403: i32, %404: i32, %405: i32):  // pred: ^bb68
      ...
      nvvm.mbarrier.try_wait.parity.shared %410, %404, %20 : !llvm.ptr<3>, i32, i32
      %411 = llvm.insertvalue %26, %402[0] : !llvm.struct<(i1, i1, i1)> 
    ...
    ^bb72:  // pred: ^bb71
      ...
      nvvm.mbarrier.try_wait.parity.shared %421, %416, %20 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb73
    ^bb73:  // 2 preds: ^bb71, ^bb72
      %422 = llvm.add %415, %36 : i32
      %423 = llvm.add %414, %36 : i32
      %424 = llvm.icmp "eq" %422, %23 : i32
    ...
    ^bb90:  // pred: ^bb80
      %464 = llvm.insertvalue %21, %429[0] : !llvm.struct<(i1, i1, i1)> 
    ...
    ^bb110:  // pred: ^bb109
      ...
      nvvm.mbarrier.try_wait.parity.shared %504, %503, %20 : !llvm.ptr<3>, i32, i32
      llvm.br ^bb111
    ...
    ^bb117(%731: i32, %732: i32, %733: i32, %734: i32, %735: i32, %736: i32):  // pred: ^bb116
      ...
      nvvm.mbarrier.try_wait.parity.shared %748, %735, %20 : !llvm.ptr<3>, i32, i32
