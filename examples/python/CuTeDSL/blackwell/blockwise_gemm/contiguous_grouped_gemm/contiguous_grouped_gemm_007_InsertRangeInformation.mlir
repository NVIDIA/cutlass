...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_5 = cute.add_offset(%iter_4, %idx_3) : (!cute.ptr<f8E4M3FN, gmem, align<16>>, !cute.int_tuple<"?{i64}">) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      %ptr_32 = cute.add_offset(%iter_31, %idx_30) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      scf.if %22 {
        ...
        scf.for %arg6 = %c0_i32_73 to %40 step %c1_i32_74  : i32 {
          ...
          %ptr_77 = cute.add_offset(%iter_72, %44) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"0">) -> !cute.ptr<f8E4M3FN, gmem>
          ...
          %46 = builtin.unrealized_conversion_cast %iter_80 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          ...
          %ptr_81 = cute.add_offset(%iter_79, %48) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, rmem>
          %49 = cute.static : !cute.int_tuple<"1">
          %ptr_82 = cute.add_offset(%iter_80, %49) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, gmem>
          %50 = builtin.unrealized_conversion_cast %ptr_81 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %51 = builtin.unrealized_conversion_cast %ptr_82 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %52 = llvm.load %50 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %52, %51 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %53 = cute.static : !cute.int_tuple<"2">
          %ptr_83 = cute.add_offset(%iter_79, %53) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
          %54 = cute.static : !cute.int_tuple<"2">
          %ptr_84 = cute.add_offset(%iter_80, %54) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, gmem>
          %55 = builtin.unrealized_conversion_cast %ptr_83 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
          %56 = builtin.unrealized_conversion_cast %ptr_84 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %57 = llvm.load %55 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %57, %56 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %58 = cute.static : !cute.int_tuple<"3">
          %ptr_85 = cute.add_offset(%iter_79, %58) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, rmem>
          %59 = cute.static : !cute.int_tuple<"3">
          %ptr_86 = cute.add_offset(%iter_80, %59) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, gmem>
          %60 = builtin.unrealized_conversion_cast %ptr_85 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %61 = builtin.unrealized_conversion_cast %ptr_86 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %62 = llvm.load %60 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %62, %61 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
  ...
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6) attributes {llvm.emit_c_interface} {
    ...
    %13:5 = cute.get_scalars(%lay_13) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %stride_16 = cute.make_stride(%13#3, %13#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %lay_17 = cute.make_layout(%shape_15, %stride_16) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %view_18 = cute.make_view(%iter_12, %lay_17) : !memref_gmem_f8E4M3FN
    %lay_19 = cute.get_layout(%view_6) : !memref_gmem_f32_
    %sz = cute.size(%lay_19) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,?{i64},0),(?{i64},?{i64 div=512},1))">) -> !cute.int_tuple<"?">
    %e0_20 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
    %15 = cute.get_scalars(%e0_20) : !cute.int_tuple<"?">
    %16 = arith.index_cast %15 : i32 to index
    %c1 = arith.constant 1 : index
    %c128 = arith.constant 128 : index
    %c0_i32 = arith.constant 0 : i32
    gpu.launch_func  @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0 blocks in (%16, %c1, %c1) threads in (%c128, %c1, %c1)  dynamic_shared_memory_size %c0_i32 args(%view_6 : !memref_gmem_f32_, %view_18 : !memref_gmem_f8E4M3FN, %view_11 : !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %1 : i32, %2 : i32, %3 : i32) {use_pdl = false}
    return
  }
}
