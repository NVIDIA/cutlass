...
"builtin.module"() ({
  "gpu.module"() <{sym_name = "kernels"}> ({
    "cuda.kernel"() <{arg_attrs = [{}, {}, {}, {}, {}, {}, {}, {}], function_type = (!memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, !cute.layout<"(128,4):(4,1)">, !cute.layout<"(128,4):(4,1)">, i32, i32, i32) -> (), sym_name = "kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010i64512i64_tensorptrf8E4M3FNgmemalign16o15121010i64512i64_tensor000o15121011010512112____Float32_Float8E4M3FN_0"}> ({
    ^bb0(%arg2: !memref_gmem_f32_, %arg3: !memref_gmem_f8E4M3FN, %arg4: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg5: !cute.layout<"(128,4):(4,1)">, %arg6: !cute.layout<"(128,4):(4,1)">, %arg7: i32, %arg8: i32, %arg9: i32):
      ...
      %101 = "cute.get_layout"(%arg3) : (!memref_gmem_f8E4M3FN) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      ...
      %104 = "cute.get_layout"(%arg3) : (!memref_gmem_f8E4M3FN) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
      ...
      %114 = "cute.get_iter"(%113) : (!memref_gmem_f8E4M3FN1) -> !cute.ptr<f8E4M3FN, gmem>
      %115 = "cute.get_iter"(%113) : (!memref_gmem_f8E4M3FN1) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      %133 = "cute.get_iter"(%132) : (!memref_gmem_f8E4M3FN2) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      %147 = "cute.get_iter"(%146) : (!memref_gmem_f8E4M3FN3) -> !cute.ptr<f8E4M3FN, gmem>
      %148 = "cute.get_iter"(%146) : (!memref_gmem_f8E4M3FN3) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      "scf.if"(%185) ({
        ...
        %295 = "cute.make_view"(%148, %294) : (!cute.ptr<f8E4M3FN, gmem>, !cute.layout<"(4,1):(1,0)">) -> !memref_gmem_f8E4M3FN4
        %296 = "cute.get_iter"(%295) : (!memref_gmem_f8E4M3FN4) -> !cute.ptr<f8E4M3FN, gmem>
        ...
        %304 = "cute.get_iter"(%303) : (!memref_gmem_f8E4M3FN5) -> !cute.ptr<f8E4M3FN, gmem>
        %305 = "cute.get_iter"(%303) : (!memref_gmem_f8E4M3FN5) -> !cute.ptr<f8E4M3FN, gmem>
  ...
  ^bb0(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6):
    ...
    %76 = "cute.get_layout"(%67) : (!memref_gmem_f8E4M3FN) -> !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    ...
    %87 = "cuda.launch_ex"(%84, %55, %67, %59, %8, %8, %13, %15, %17) <{assume_kernel_attr = #cuda.assume_kernel_attr<true>, callee = @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010i64512i64_tensorptrf8E4M3FNgmemalign16o15121010i64512i64_tensor000o15121011010512112____Float32_Float8E4M3FN_0}> : (!cuda.launch_cfg<max_attrs = 3>, !memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, !cute.layout<"(128,4):(4,1)">, !cute.layout<"(128,4):(4,1)">, i32, i32, i32) -> !cuda.result
