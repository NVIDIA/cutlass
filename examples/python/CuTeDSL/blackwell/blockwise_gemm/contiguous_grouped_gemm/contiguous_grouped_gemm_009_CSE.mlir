    ...
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %24 {
        ...
        scf.for %arg6 = %c0_i32 to %27 step %c1_i32  : i32 {
          ...
          %31 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %32 = llvm.load %30 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %32, %31 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_28 = cute.add_offset(%iter_22, %2) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, rmem>
          %ptr_29 = cute.add_offset(%ptr_15, %2) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, gmem>
          %33 = builtin.unrealized_conversion_cast %ptr_28 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %34 = builtin.unrealized_conversion_cast %ptr_29 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %35 = llvm.load %33 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %35, %34 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_30 = cute.add_offset(%iter_22, %1) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
          %ptr_31 = cute.add_offset(%ptr_15, %1) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, gmem>
          %36 = builtin.unrealized_conversion_cast %ptr_30 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
          %37 = builtin.unrealized_conversion_cast %ptr_31 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %38 = llvm.load %36 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %38, %37 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_32 = cute.add_offset(%iter_22, %0) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, rmem>
          %ptr_33 = cute.add_offset(%ptr_15, %0) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, gmem>
          %39 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %40 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
