    ...
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %14 {
        ...
        scf.for %arg6 = %c0_i32 to %15 step %c1_i32  : i32 {
          %34 = llvm.load %16 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %34, %17 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %35 = llvm.load %18 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %35, %19 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %36 = llvm.load %20 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %36, %21 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %37 = llvm.load %22 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %37, %23 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
        ...
        %27 = builtin.unrealized_conversion_cast %ptr_9 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        ...
        %28 = builtin.unrealized_conversion_cast %ptr_23 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
        %29 = builtin.unrealized_conversion_cast %ptr_24 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        ...
        %30 = builtin.unrealized_conversion_cast %ptr_25 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
        %31 = builtin.unrealized_conversion_cast %ptr_26 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        ...
        %32 = builtin.unrealized_conversion_cast %ptr_27 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
        %33 = builtin.unrealized_conversion_cast %ptr_28 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        scf.for %arg6 = %c0_i32 to %15 step %c1_i32  : i32 {
          %34 = llvm.load %26 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %34, %27 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %35 = llvm.load %28 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %35, %29 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %36 = llvm.load %30 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %36, %31 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %37 = llvm.load %32 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %37, %33 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
