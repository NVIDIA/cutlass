...
module attributes {gpu.container_module} {
  ...
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f8E4M3FN1) attributes {llvm.emit_c_interface} {
    ...
    %42:5 = cute.get_scalars(%lay_13) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %stride_18 = cute.make_stride(%42#3, %42#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %lay_19 = cute.make_layout(%shape_17, %stride_18) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
