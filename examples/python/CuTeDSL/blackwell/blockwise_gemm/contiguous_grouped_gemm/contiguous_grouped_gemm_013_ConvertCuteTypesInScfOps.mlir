...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_15 = cute.add_offset(%ptr_4, %idx_14) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      scf.if %24 {
        ...
        scf.for %arg6 = %c0_i32 to %27 step %c1_i32  : i32 {
          %50 = llvm.load %30 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %50, %31 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %51 = llvm.load %32 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %51, %33 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %52 = llvm.load %35 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %52, %36 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %53 = llvm.load %38 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %53, %39 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
        } {llvm.loop_annotation = #loop_annotation}
        %40 = cute.memref.load_vec %rmem, row_major : !memref_rmem_f32_
        %41 = nvgpu.cvt_fptrunc %40 : vector<4xf32> to vector<4xf8E4M3FN>
        cute.memref.store_vec %41, %rmem_21, row_major : !memref_rmem_f8E4M3FN
        %42 = builtin.unrealized_conversion_cast %iter_22 : !cute.ptr<f8E4M3FN, rmem, align<32>> to !llvm.ptr
        %43 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        %ptr_40 = cute.add_offset(%iter_22, %2) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, rmem>
        %ptr_41 = cute.add_offset(%ptr_15, %2) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, gmem>
        %44 = builtin.unrealized_conversion_cast %ptr_40 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
        %45 = builtin.unrealized_conversion_cast %ptr_41 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        %ptr_42 = cute.add_offset(%iter_22, %1) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
        %ptr_43 = cute.add_offset(%ptr_15, %1) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, gmem>
        %46 = builtin.unrealized_conversion_cast %ptr_42 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
        %47 = builtin.unrealized_conversion_cast %ptr_43 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        %ptr_44 = cute.add_offset(%iter_22, %0) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, rmem>
        %ptr_45 = cute.add_offset(%ptr_15, %0) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, gmem>
        %48 = builtin.unrealized_conversion_cast %ptr_44 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
        %49 = builtin.unrealized_conversion_cast %ptr_45 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
        scf.for %arg6 = %c0_i32 to %27 step %c1_i32  : i32 {
          %50 = llvm.load %42 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %50, %43 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %51 = llvm.load %44 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %51, %45 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %52 = llvm.load %46 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %52, %47 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %53 = llvm.load %48 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %53, %49 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
  }
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f8E4M3FN1) attributes {llvm.emit_c_interface} {
    %c0_i32 = arith.constant 0 : i32
    ...
    %12:5 = cute.get_scalars(%lay_9) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %13 = arith.ceildivsi %12#1, %c512_i32 : i32
    %shape_10 = cute.make_shape(%12#0, %13, %12#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_11 = cute.make_stride(%12#3, %12#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %lay_12 = cute.make_layout(%shape_10, %stride_11) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">
    %view_13 = cute.make_view(%iter_8, %lay_12) : !memref_gmem_f8E4M3FN
    %sz = cute.size(%lay_4) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,?{i64},0),(?{i64},?{i64 div=512},1))">) -> !cute.int_tuple<"?">
    %e0_14 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
    %14 = cute.get_scalars(%e0_14) : !cute.int_tuple<"?">
    %15 = arith.index_cast %14 : i32 to index
    gpu.launch_func  @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0 blocks in (%15, %c1, %c1) threads in (%c128, %c1, %c1)  dynamic_shared_memory_size %c0_i32 args(%view : !memref_gmem_f32_, %view_13 : !memref_gmem_f8E4M3FN, %view_7 : !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %4 : i32, %5 : i32, %6 : i32) {use_pdl = false}
    return
  }
}
