...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_18 = cute.add_offset(%ptr_5, %idx_17) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      scf.if %24 {
        ...
        scf.for %arg6 = %c0_i32 to %30 step %c1_i32  : i32 {
          ...
          %32 = builtin.unrealized_conversion_cast %ptr_18 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %33 = llvm.load %31 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %33, %32 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_32 = cute.add_offset(%iter_26, %2) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, rmem>
          %ptr_33 = cute.add_offset(%ptr_18, %2) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, gmem>
          %34 = builtin.unrealized_conversion_cast %ptr_32 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %35 = builtin.unrealized_conversion_cast %ptr_33 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %36 = llvm.load %34 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %36, %35 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_34 = cute.add_offset(%iter_26, %1) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
          %ptr_35 = cute.add_offset(%ptr_18, %1) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, gmem>
          %37 = builtin.unrealized_conversion_cast %ptr_34 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
          %38 = builtin.unrealized_conversion_cast %ptr_35 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %39 = llvm.load %37 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %39, %38 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %ptr_36 = cute.add_offset(%iter_26, %0) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, rmem>
          %ptr_37 = cute.add_offset(%ptr_18, %0) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, gmem>
          %40 = builtin.unrealized_conversion_cast %ptr_36 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %41 = builtin.unrealized_conversion_cast %ptr_37 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
  ...
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f8E4M3FN1) attributes {llvm.emit_c_interface} {
    ...
    %12:5 = cute.get_scalars(%lay_10) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    %13 = arith.ceildivsi %12#1, %c512_i32 : i32
    %shape_11 = cute.make_shape(%12#0, %13, %12#2) : (i32, i32, i32) -> !cute.shape<"((1,512,1),(?,?,?))">
    %stride_12 = cute.make_stride(%12#3, %12#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
