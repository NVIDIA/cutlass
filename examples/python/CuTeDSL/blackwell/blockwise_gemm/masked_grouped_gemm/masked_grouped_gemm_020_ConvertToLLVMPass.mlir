"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg5: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg6: !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %arg7: i32, %arg8: i32, %arg9: i32):
      ...
      %308 = "builtin.unrealized_conversion_cast"(%307) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %309 = "llvm.getelementptr"(%278, %306) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %310 = "builtin.unrealized_conversion_cast"(%309) : (!llvm.ptr<1>) -> !cute.ptr<f8E4M3FN, gmem>
      %311 = "llvm.extractvalue"(%229) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %312 = "llvm.extractvalue"(%229) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %313 = "llvm.mlir.constant"() <{value = 4 : i32}> : () -> i32
      %314 = "llvm.mul"(%231, %313) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %315 = "llvm.extractvalue"(%302) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %316 = "llvm.extractvalue"(%302) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %317 = "llvm.extractvalue"(%302) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %318 = "llvm.add"(%316, %314) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %319 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32)>
      %320 = "llvm.insertvalue"(%319, %315) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %321 = "llvm.insertvalue"(%320, %318) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %322 = "llvm.insertvalue"(%321, %317) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      ...
      %331 = "llvm.insertvalue"(%330, %arg7) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %332 = "llvm.insertvalue"(%331, %arg8) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %333 = "llvm.insertvalue"(%332, %arg9) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %334 = "llvm.extractvalue"(%329) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %335 = "llvm.extractvalue"(%329) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %336 = "llvm.extractvalue"(%329) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %337 = "llvm.extractvalue"(%333) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %338 = "llvm.extractvalue"(%333) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %339 = "llvm.extractvalue"(%333) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %340 = "llvm.icmp"(%334, %337) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %341 = "llvm.icmp"(%335, %338) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %342 = "llvm.and"(%340, %341) : (i1, i1) -> i1
      %343 = "llvm.icmp"(%336, %339) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %344 = "llvm.and"(%342, %343) : (i1, i1) -> i1
      "llvm.cond_br"(%344)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb1:  // pred: ^bb0
      %345 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %346 = "llvm.insertvalue"(%345, %225) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %347 = "llvm.insertvalue"(%346, %222) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %348 = "llvm.extractvalue"(%347) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %349 = "builtin.unrealized_conversion_cast"(%348) : (!llvm.ptr) -> !cute.ptr<f32, rmem, align<32>>
      %350 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %351 = "llvm.insertvalue"(%350, %221) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %352 = "llvm.insertvalue"(%351, %218) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %353 = "llvm.extractvalue"(%352) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %354 = "builtin.unrealized_conversion_cast"(%353) : (!llvm.ptr) -> !cute.ptr<f8E4M3FN, rmem, align<32>>
      %355 = "builtin.unrealized_conversion_cast"(%308) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
      %356 = "builtin.unrealized_conversion_cast"(%349) : (!cute.ptr<f32, rmem, align<32>>) -> !llvm.ptr
      ...
      %359 = "llvm.getelementptr"(%307, %358) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %360 = "builtin.unrealized_conversion_cast"(%359) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %361 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %362 = "llvm.getelementptr"(%348, %361) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %363 = "builtin.unrealized_conversion_cast"(%362) : (!llvm.ptr) -> !cute.ptr<f32, rmem>
      %364 = "builtin.unrealized_conversion_cast"(%360) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
      ...
      %368 = "llvm.getelementptr"(%307, %367) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %369 = "builtin.unrealized_conversion_cast"(%368) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %370 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %371 = "llvm.getelementptr"(%348, %370) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %372 = "builtin.unrealized_conversion_cast"(%371) : (!llvm.ptr) -> !cute.ptr<f32, rmem, align<8>>
      %373 = "builtin.unrealized_conversion_cast"(%369) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
      %374 = "builtin.unrealized_conversion_cast"(%372) : (!cute.ptr<f32, rmem, align<8>>) -> !llvm.ptr
      ...
      %377 = "llvm.getelementptr"(%307, %376) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %378 = "builtin.unrealized_conversion_cast"(%377) : (!llvm.ptr<1>) -> !cute.ptr<f32, gmem>
      %379 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %380 = "llvm.getelementptr"(%348, %379) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %381 = "builtin.unrealized_conversion_cast"(%380) : (!llvm.ptr) -> !cute.ptr<f32, rmem>
      %382 = "builtin.unrealized_conversion_cast"(%378) : (!cute.ptr<f32, gmem>) -> !llvm.ptr<1>
      %383 = "builtin.unrealized_conversion_cast"(%381) : (!cute.ptr<f32, rmem>) -> !llvm.ptr
      ...
      %385 = "llvm.mlir.poison"() : () -> !llvm.array<1 x vector<4xf32>>
      %386 = "builtin.unrealized_conversion_cast"(%385) : (!llvm.array<1 x vector<4xf32>>) -> vector<1x4xf32>
      %387 = "llvm.extractvalue"(%347) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %388 = "llvm.getelementptr"(%387) <{elem_type = f32, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      %389 = "llvm.load"(%388) <{alignment = 32 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<4xf32>
      %390 = "vector.insert"(%389, %386) <{static_position = array<i64: 0>}> : (vector<4xf32>, vector<1x4xf32>) -> vector<1x4xf32>
      %391 = "vector.shape_cast"(%390) : (vector<1x4xf32>) -> vector<4xf32>
      %392 = "llvm.bitcast"(%391) : (vector<4xf32>) -> vector<4xi32>
      %393 = "llvm.mlir.undef"() : () -> vector<1xi32>
      %394 = "llvm.mlir.constant"() <{value = 16 : i32}> : () -> i32
      %395 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %396 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %397 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %398 = "llvm.mlir.constant"() <{value = 2 : i64}> : () -> i64
      %399 = "llvm.extractelement"(%392, %398) : (vector<4xi32>, i64) -> i32
      %400 = "llvm.mlir.constant"() <{value = 3 : i64}> : () -> i64
      %401 = "llvm.extractelement"(%392, %400) : (vector<4xi32>, i64) -> i32
      %402 = "llvm.bitcast"(%399) : (i32) -> f32
      %403 = "llvm.bitcast"(%401) : (i32) -> f32
      %404 = "nvvm.cvt.packfloat.f32"(%403, %402, %395) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e4m3x2>}> : (f32, f32, i32) -> i32
      %405 = "llvm.shl"(%397, %394) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %406 = "llvm.or"(%405, %404) : (i32, i32) -> i32
      %407 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %408 = "llvm.extractelement"(%392, %407) : (vector<4xi32>, i64) -> i32
      %409 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
      %410 = "llvm.extractelement"(%392, %409) : (vector<4xi32>, i64) -> i32
      %411 = "llvm.bitcast"(%408) : (i32) -> f32
      %412 = "llvm.bitcast"(%410) : (i32) -> f32
      %413 = "nvvm.cvt.packfloat.f32"(%412, %411, %395) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e4m3x2>}> : (f32, f32, i32) -> i32
      %414 = "llvm.shl"(%406, %394) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %415 = "llvm.or"(%414, %413) : (i32, i32) -> i32
      %416 = "llvm.insertelement"(%393, %415, %396) : (vector<1xi32>, i32, i64) -> vector<1xi32>
      %417 = "llvm.bitcast"(%416) : (vector<1xi32>) -> vector<4xi8>
      %418 = "vector.shape_cast"(%417) : (vector<4xi8>) -> vector<1x4xi8>
      %419 = "llvm.extractvalue"(%352) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %420 = "vector.extract"(%418) <{static_position = array<i64: 0>}> : (vector<1x4xi8>) -> vector<4xi8>
      %421 = "llvm.getelementptr"(%419) <{elem_type = i8, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%420, %421) <{alignment = 32 : i64, ordering = 0 : i64}> : (vector<4xi8>, !llvm.ptr) -> ()
      %422 = "builtin.unrealized_conversion_cast"(%354) : (!cute.ptr<f8E4M3FN, rmem, align<32>>) -> !llvm.ptr
      %423 = "builtin.unrealized_conversion_cast"(%310) : (!cute.ptr<f8E4M3FN, gmem>) -> !llvm.ptr<1>
      %424 = "llvm.load"(%422) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%424, %423) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %425 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %426 = "llvm.getelementptr"(%353, %425) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %427 = "builtin.unrealized_conversion_cast"(%426) : (!llvm.ptr) -> !cute.ptr<f8E4M3FN, rmem>
      %428 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %429 = "llvm.getelementptr"(%309, %428) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %430 = "builtin.unrealized_conversion_cast"(%429) : (!llvm.ptr<1>) -> !cute.ptr<f8E4M3FN, gmem>
      %431 = "builtin.unrealized_conversion_cast"(%427) : (!cute.ptr<f8E4M3FN, rmem>) -> !llvm.ptr
      %432 = "builtin.unrealized_conversion_cast"(%430) : (!cute.ptr<f8E4M3FN, gmem>) -> !llvm.ptr<1>
      %433 = "llvm.load"(%431) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%433, %432) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %434 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %435 = "llvm.getelementptr"(%353, %434) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %436 = "builtin.unrealized_conversion_cast"(%435) : (!llvm.ptr) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
      %437 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %438 = "llvm.getelementptr"(%309, %437) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %439 = "builtin.unrealized_conversion_cast"(%438) : (!llvm.ptr<1>) -> !cute.ptr<f8E4M3FN, gmem>
      %440 = "builtin.unrealized_conversion_cast"(%436) : (!cute.ptr<f8E4M3FN, rmem, align<2>>) -> !llvm.ptr
      %441 = "builtin.unrealized_conversion_cast"(%439) : (!cute.ptr<f8E4M3FN, gmem>) -> !llvm.ptr<1>
      %442 = "llvm.load"(%440) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%442, %441) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      %443 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %444 = "llvm.getelementptr"(%353, %443) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %445 = "builtin.unrealized_conversion_cast"(%444) : (!llvm.ptr) -> !cute.ptr<f8E4M3FN, rmem>
      %446 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %447 = "llvm.getelementptr"(%309, %446) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %448 = "builtin.unrealized_conversion_cast"(%447) : (!llvm.ptr<1>) -> !cute.ptr<f8E4M3FN, gmem>
      %449 = "builtin.unrealized_conversion_cast"(%445) : (!cute.ptr<f8E4M3FN, rmem>) -> !llvm.ptr
      %450 = "builtin.unrealized_conversion_cast"(%448) : (!cute.ptr<f8E4M3FN, gmem>) -> !llvm.ptr<1>
      %451 = "llvm.load"(%449) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
      "llvm.store"(%451, %450) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
      "llvm.br"()[^bb2] : () -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "llvm.return"() : () -> ()
