...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb4:  // pred: ^bb2
      ...
      %50 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
      ...
      %51 = builtin.unrealized_conversion_cast %ptr_40 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
      %52 = builtin.unrealized_conversion_cast %ptr_41 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
      ...
      %53 = builtin.unrealized_conversion_cast %ptr_42 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
      %54 = builtin.unrealized_conversion_cast %ptr_43 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
      ...
      %55 = builtin.unrealized_conversion_cast %ptr_44 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
      %56 = builtin.unrealized_conversion_cast %ptr_45 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
      cf.br ^bb5(%c0_i32 : i32)
    ^bb5(%57: i32):  // 2 preds: ^bb4, ^bb6
      %58 = arith.cmpi slt, %57, %27 : i32
      cf.cond_br %58, ^bb6, ^bb7 {llvm.loop_annotation = #loop_annotation}
    ^bb6:  // pred: ^bb5
      %59 = llvm.load %49 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %59, %50 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %60 = llvm.load %51 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %60, %52 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %61 = llvm.load %53 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %61, %54 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %62 = llvm.load %55 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
      llvm.store %62, %56 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
      %63 = arith.addi %57, %c1_i32 : i32
      cf.br ^bb5(%63 : i32)
    ^bb7:  // pred: ^bb5
      cf.br ^bb8
    ^bb8:  // 2 preds: ^bb0, ^bb7
