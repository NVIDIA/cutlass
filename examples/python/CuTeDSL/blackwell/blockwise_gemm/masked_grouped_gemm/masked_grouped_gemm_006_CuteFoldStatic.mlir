...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_25 = cute.add_offset(%iter_24, %idx_23) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem>
      ...
      scf.if %16 {
        ...
        scf.for %arg6 = %c0_i32_58 to %30 step %c1_i32_59  : i32 {
          ...
          %33 = cute.static : !cute.layout<"(4):(1)">
          %34 = cute.static : !cute.int_tuple<"0">
          %ptr_62 = cute.add_offset(%iter_57, %34) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"0">) -> !cute.ptr<f8E4M3FN, gmem>
          ...
          %36 = builtin.unrealized_conversion_cast %iter_65 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %37 = llvm.load %35 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %37, %36 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %38 = cute.static : !cute.int_tuple<"1">
          %ptr_66 = cute.add_offset(%iter_64, %38) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, rmem>
          %39 = cute.static : !cute.int_tuple<"1">
          %ptr_67 = cute.add_offset(%iter_65, %39) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"1">) -> !cute.ptr<f8E4M3FN, gmem>
          %40 = builtin.unrealized_conversion_cast %ptr_66 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %41 = builtin.unrealized_conversion_cast %ptr_67 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %42 = llvm.load %40 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %42, %41 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %43 = cute.static : !cute.int_tuple<"2">
          %ptr_68 = cute.add_offset(%iter_64, %43) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, rmem, align<2>>
          %44 = cute.static : !cute.int_tuple<"2">
          %ptr_69 = cute.add_offset(%iter_65, %44) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"2">) -> !cute.ptr<f8E4M3FN, gmem>
          %45 = builtin.unrealized_conversion_cast %ptr_68 : !cute.ptr<f8E4M3FN, rmem, align<2>> to !llvm.ptr
          %46 = builtin.unrealized_conversion_cast %ptr_69 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
          %47 = llvm.load %45 {alignment = 1 : i64} : !llvm.ptr -> vector<1xi8>
          llvm.store %47, %46 {alignment = 1 : i64} : vector<1xi8>, !llvm.ptr<1>
          %48 = cute.static : !cute.int_tuple<"3">
          %ptr_70 = cute.add_offset(%iter_64, %48) : (!cute.ptr<f8E4M3FN, rmem, align<32>>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, rmem>
          %49 = cute.static : !cute.int_tuple<"3">
          %ptr_71 = cute.add_offset(%iter_65, %49) : (!cute.ptr<f8E4M3FN, gmem>, !cute.int_tuple<"3">) -> !cute.ptr<f8E4M3FN, gmem>
          %50 = builtin.unrealized_conversion_cast %ptr_70 : !cute.ptr<f8E4M3FN, rmem> to !llvm.ptr
          %51 = builtin.unrealized_conversion_cast %ptr_71 : !cute.ptr<f8E4M3FN, gmem> to !llvm.ptr<1>
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %12:5 = cute.get_scalars(%lay_13) <{only_dynamic}> : !cute.layout<"(?,?,?):(?{i64},1,?{i64})">
    ...
    %stride_16 = cute.make_stride(%12#3, %12#4) : (i64, i64) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %sz = cute.size(%lay_19) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?">
    %e0_20 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
    %14 = cute.get_scalars(%e0_20) : !cute.int_tuple<"?">
    %c0_i32 = arith.constant 0 : i32
    ...
    %18 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0<%17> (%view_6, %view_18, %view_11, %1, %2, %3) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, i32, i32, i32) -> !cuda.result
    %19 = cuda.cast %18 : !cuda.result -> i32
    cuda.return_if_error %19 : i32
    %c0_i32_21 = arith.constant 0 : i32
    return %c0_i32_21 : i32
  }
}
