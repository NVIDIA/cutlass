...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %28 = cute.get_scalars(%e1_73) : !cute.int_tuple<"?{div=512}">
      ...
      %31 = cute.get_scalars(%e1_77) : !cute.int_tuple<"?{div=512}">
      %32 = cute.get_scalars(%e2_78) : !cute.int_tuple<"?">
      %33 = cute.composition(%slice, %0) : (!memref_gmem_f32_1, !cute.layout<"(128,4):(4,1)">) -> !memref_gmem_f32_2
      %iter_79 = cute.get_iter(%33) : !memref_gmem_f32_2
      %34 = cute.composition(%slice_66, %1) : (!memref_gmem_f8E4M3FN1, !cute.layout<"(128,4):(4,1)">) -> !memref_gmem_f8E4M3FN2
      %iter_80 = cute.get_iter(%34) : !memref_gmem_f8E4M3FN2
      %35 = cute.composition(%slice_70, %0) : (!cute.coord_tensor<"(?,?{div=512},?)", "((1,512,1)):((0,1@1,0))">, !cute.layout<"(128,4):(4,1)">) -> !cute.coord_tensor<"(?,?{div=512},?)", "(128,4):(4@1,1@1)">
      %iter_81 = cute.get_iter(%35) : !cute.coord_tensor<"(?,?{div=512},?)", "(128,4):(4@1,1@1)">
      %e0_82, %e1_83, %e2_84 = cute.get_leaves(%iter_81) : !cute.int_tuple<"(?,?{div=512},?)">
      %36 = cute.get_scalars(%e0_82) : !cute.int_tuple<"?">
      %37 = cute.get_scalars(%e1_83) : !cute.int_tuple<"?{div=512}">
      ...
      %slice_90 = cute.slice(%34, %coord_89) : !memref_gmem_f8E4M3FN2, !cute.coord<"(?,_)">
      ...
      %slice_94 = cute.slice(%35, %coord_93) : !cute.coord_tensor<"(?,?{div=512},?)", "(128,4):(4@1,1@1)">, !cute.coord<"(?,_)">
      ...
      %40 = cute.get_scalars(%e1_97) : !cute.int_tuple<"?{div=4}">
      ...
      %43 = cute.get_scalars(%e1_101) : !cute.int_tuple<"?{div=4}">
      ...
      %46 = cute.get_scalars(%e1_107) : !cute.int_tuple<"?{div=4}">
      ...
      %49 = cute.get_scalars(%e1_111) : !cute.int_tuple<"?{div=4}">
      ...
      %52 = cute.get_scalars(%e1_115) : !cute.int_tuple<"?{div=4}">
      ...
      %54 = cute.elem_less(%coord_117, %coord_118) : !cute.coord<"(?,?{div=4},?)">, !cute.coord<"(?,?,?)">
      scf.if %54 {
        %55 = cute.get_shape(%0) : (!cute.layout<"(128,4):(4,1)">) -> !cute.shape<"(128,4)">
        %e0_119, %e1_120 = cute.get_leaves(%55) : !cute.shape<"(128,4)">
        %56 = cute.get_shape(%0) : (!cute.layout<"(128,4):(4,1)">) -> !cute.shape<"(128,4)">
        %e0_121, %e1_122 = cute.get_leaves(%56) : !cute.shape<"(128,4)">
        %57 = cute.get(%0) <{mode = [1]}> : !cute.layout<"(128,4):(4,1)"> -> !cute.layout<"4:1">
        ...
        %rmem_129 = cute.memref.alloca(%60) : !memref_rmem_f8E4M3FN
        ...
        %61 = cute.get_shape(%lay_132) : (!cute.layout<"(4):(1)">) -> !cute.shape<"(4)">
        %e0_133 = cute.get_leaves(%61) : !cute.shape<"(4)">
        %lay_134 = cute.get_layout(%rmem) : !memref_rmem_f32_
        %62 = cute.get_shape(%lay_134) : (!cute.layout<"4:1">) -> !cute.shape<"4">
        %e0_135 = cute.get_leaves(%62) : !cute.shape<"4">
        ...
        %63 = cute.get_shape(%lay_139) : (!cute.layout<"(4,1):(1,0)">) -> !cute.shape<"(4,1)">
        %e0_140, %e1_141 = cute.get_leaves(%63) : !cute.shape<"(4,1)">
        ...
        %64 = cute.get_shape(%lay_150) : (!cute.layout<"(4,1):(1,0)">) -> !cute.shape<"(4,1)">
        %e0_151, %e1_152 = cute.get_leaves(%64) : !cute.shape<"(4,1)">
        ...
        %65 = cute.get_shape(%lay_156) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_157, %e1_158 = cute.get_leaves(%65) : !cute.shape<"(4,(1))">
        %lay_159 = cute.get_layout(%grouped_153) : !memref_rmem_f32_2
        %66 = cute.get_shape(%lay_159) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_160, %e1_161 = cute.get_leaves(%66) : !cute.shape<"(4,(1))">
        ...
        %68 = nvgpu.cvt_fptrunc %67 : vector<4xf32> to vector<4xf8E4M3FN>
        ...
        cute.memref.store_vec %68, %rmem_129 : !memref_rmem_f8E4M3FN
        %atom_172 = cute.make_atom() : () -> !cute_nvgpu.atom.universal_copy<f8E4M3FN>
        %lay_173 = cute.get_layout(%slice_90) : !memref_gmem_f8E4M3FN3
        %70 = cute.get_shape(%lay_173) : (!cute.layout<"(4):(1)">) -> !cute.shape<"(4)">
        %e0_174 = cute.get_leaves(%70) : !cute.shape<"(4)">
        ...
        %71 = cute.get_shape(%lay_181) : (!cute.layout<"(4,1):(1,0)">) -> !cute.shape<"(4,1)">
        %e0_182, %e1_183 = cute.get_leaves(%71) : !cute.shape<"(4,1)">
        ...
        %73 = cute.get_shape(%lay_199) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_200, %e1_201 = cute.get_leaves(%73) : !cute.shape<"(4,(1))">
        %lay_202 = cute.get_layout(%grouped_196) : !memref_gmem_f8E4M3FN5
        %74 = cute.get_shape(%lay_202) : (!cute.layout<"(4,(1)):(1,(0))">) -> !cute.shape<"(4,(1))">
        %e0_203, %e1_204 = cute.get_leaves(%74) : !cute.shape<"(4,(1))">
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemoi641i64_1_4(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %35 = cute.get_shape(%lay_87) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    ...
    %39 = cute.get_stride(%lay_87) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %e0_97, %e1_98, %e2_99, %e3_100, %e4_101, %e5_102 = cute.get_leaves(%39) : !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %54 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010512_tensor000o15121011010512112____Float32_Float8E4M3FN_0<%53> (%div, %div_65, %div_55, %15, %16, %17) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, i32, i32, i32) -> !cuda.result
