"gpu.module"() <{sym_name = "kernels"}> ({
  ...
  ^bb499:  // pred: ^bb497
    ...
    %1644 = "llvm.inline_asm"(%1643) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
  ...
  ^bb510:  // pred: ^bb509
    ...
    %2689 = "llvm.inline_asm"(%2688) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
    ...
    %2691 = "llvm.inline_asm"(%2690) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
  ...
  ^bb518:  // pred: ^bb516
    ...
    %3731 = "llvm.inline_asm"(%3730) <{asm_dialect = 0 : i64, asm_string = "ex2.approx.ftz.f32 $0, $1;", constraints = "=f,f"}> : (f32) -> f32
