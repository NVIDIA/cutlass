...
module attributes {gpu.container_module} {
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb6(%124: i32):  // 2 preds: ^bb5, ^bb39
      ...
      llvm.cond_br %125, ^bb7, ^bb40 {llvm.loop_annotation = #loop_annotation}
    ^bb7:  // pred: ^bb6
    ...
    ^bb44(%225: i32):  // 2 preds: ^bb43, ^bb77
      ...
      llvm.cond_br %226, ^bb45, ^bb78 {llvm.loop_annotation = #loop_annotation}
    ^bb45:  // pred: ^bb44
    ...
    ^bb83(%330: i32):  // 2 preds: ^bb82, ^bb116
      ...
      llvm.cond_br %331, ^bb84, ^bb117 {llvm.loop_annotation = #loop_annotation}
    ^bb84:  // pred: ^bb83
  ...
  llvm.func @cutlass_elementwise_add_Tensorgmem_o_i641_Tensorgmem_o_i641_Tensorgmem_o_i641_CUstream_False_False(%arg0: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg1: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg2: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, i64)>)>, %arg3: !llvm.ptr) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %170 = llvm.alloca %10 x !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)> : (i32) -> !llvm.ptr
    %171 = llvm.alloca %10 x !llvm.array<2 x struct<(i32, array<4 x i8>, array<64 x i8>)>> : (i32) -> !llvm.ptr
    %172 = llvm.getelementptr %170[0, 4] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %171, %172 : !llvm.ptr, !llvm.ptr
    %173 = llvm.getelementptr %170[0, 1, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %13, %173 : i32, !llvm.ptr
    %174 = llvm.getelementptr %170[0, 1, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %10, %174 : i32, !llvm.ptr
    %175 = llvm.getelementptr %170[0, 1, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %10, %175 : i32, !llvm.ptr
    %176 = llvm.getelementptr %170[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %9, %176 : i64, !llvm.ptr
    %177 = llvm.getelementptr %170[0, 0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %169, %177 : i32, !llvm.ptr
    %178 = llvm.getelementptr %170[0, 0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %10, %178 : i32, !llvm.ptr
    %179 = llvm.getelementptr %170[0, 0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %10, %179 : i32, !llvm.ptr
    %180 = llvm.getelementptr %170[0, 5] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %11, %180 : i32, !llvm.ptr
    %181 = llvm.getelementptr %170[0, 3] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(array<3 x i32>, array<3 x i32>, i64, ptr, ptr, i32)>
    llvm.store %arg3, %181 : !llvm.ptr, !llvm.ptr
    %182 = llvm.alloca %10 x !llvm.array<1 x ptr> : (i32) -> !llvm.ptr
    %183 = llvm.getelementptr %182[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1 x ptr>
    llvm.store %170, %183 : !llvm.ptr, !llvm.ptr
    %184 = builtin.unrealized_conversion_cast %182 : !llvm.ptr to !cuda.launch_cfg<max_attrs = 2>
    %185 = cuda.launch_ex @kernels::@kernel_cutlass_elementwise_add_kernel_tensorptrf32gmemo161281i64div16128_tensorptrf32gmemo161281i64div16128_tensorptrf32gmemo161281i64div16128_tensor00o1612810111601281___False_0<%184> (%54, %92, %130, %168, %132, %133) : !cuda.launch_cfg<max_attrs = 2>, (!llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, struct<(i64, i64)>)>)>, !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, struct<(i64, i64)>)>)>, !llvm.struct<(ptr<1>, struct<(struct<(i32, i32)>, struct<(i64, i64)>)>)>, !llvm.struct<(struct<()>, struct<(struct<(i32, i32)>, struct<()>)>)>, i32, i32) -> !cuda.result
    %186 = builtin.unrealized_conversion_cast %185 : !cuda.result to i32
