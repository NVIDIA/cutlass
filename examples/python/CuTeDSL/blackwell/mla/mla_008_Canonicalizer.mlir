...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_13 = cute.add_offset(%ptr_4, %idx_12) : (!cute.ptr<f8E4M3FN, gmem, align<16>>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem, align<4>>
      ...
      scf.if %14 {
        ...
        scf.for %arg6 = %c0_i32 to %18 step %c1_i32  : i32 {
          ...
          %20 = builtin.unrealized_conversion_cast %ptr_13 : !cute.ptr<f8E4M3FN, gmem, align<4>> to !llvm.ptr<1>
          %21 = llvm.load %19 {alignment = 4 : i64} : !llvm.ptr -> vector<4xi8>
          llvm.store %21, %20 {alignment = 4 : i64} : vector<4xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemodiv16div161div16_1_4(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f8E4M3FN1) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %11:5 = cute.get_scalars(%lay_10) <{only_dynamic}> : !cute.layout<"(?,?{div=16},?):(?{div=16},1,?{div=16})">
    ...
    %iv_12 = cute.assume(%11#4) : (i32) -> !cute.i32<divby 16>
    %stride_13 = cute.make_stride(%iv, %iv_12) : (!cute.i32<divby 16>, !cute.i32<divby 16>) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %lay_14 = cute.make_layout(%shape_11, %stride_13) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">
    %view_15 = cute.make_view(%iter_9, %lay_14) : !memref_gmem_f8E4M3FN
    %sz = cute.size(%lay_5) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?">
    %e0_16 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
    %13 = cute.get_scalars(%e0_16) : !cute.int_tuple<"?">
