...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    cuda.kernel @kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cu_attrs = {max_dynamic_shared_size_bytes = #cuda.dev_max_shared_memory_optin, non_portable_cluster_size_allowed = 1 : i32}, cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %9 = cute.get_shape(%lay_21) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
      ...
      %13 = cute.get_stride(%lay_21) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
      %e0_31, %e1_32, %e2_33, %e3_34, %e4_35, %e5_36 = cute.get_leaves(%13) : !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
      %itup_37 = cute.to_int_tuple(%e3_34) : !cute.stride<"?{div=16}"> to !cute.int_tuple<"?{div=16}">
      %14 = cute.get_scalars(%itup_37) : !cute.int_tuple<"?{div=16}">
      ...
      %idx_69 = cute.crd2idx(%coord_67, %lay_68) : (!cute.coord<"(_,?)">, !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.int_tuple<"?{div=16}">
      %iter_70 = cute.get_iter(%arg1) : !memref_gmem_f8E4M3FN
      %ptr_71 = cute.add_offset(%iter_70, %idx_69) : (!cute.ptr<f8E4M3FN, gmem, align<16>>, !cute.int_tuple<"?{div=16}">) -> !cute.ptr<f8E4M3FN, gmem, align<16>>
      ...
      %ptr_112 = cute.add_offset(%iter_111, %idx_110) : (!cute.ptr<f8E4M3FN, gmem, align<16>>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem, align<4>>
      ...
      scf.if %58 {
        ...
        scf.for %arg6 = %c0_i32_270 to %80 step %c1_i32_271  : i32 {
          ...
          %ptr_279 = cute.add_offset(%iter_262, %idx_278) : (!cute.ptr<f8E4M3FN, gmem, align<4>>, !cute.int_tuple<"0">) -> !cute.ptr<f8E4M3FN, gmem, align<4>>
          ...
          %84 = builtin.unrealized_conversion_cast %iter_282 : !cute.ptr<f8E4M3FN, gmem, align<4>> to !llvm.ptr<1>
          %85 = llvm.load %83 {alignment = 4 : i64} : !llvm.ptr -> vector<4xi8>
          llvm.store %85, %84 {alignment = 4 : i64} : vector<4xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemodiv16div161div16_1_4(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %30:5 = cute.get_scalars(%lay_80) <{only_dynamic}> : !cute.layout<"(?,?{div=16},?):(?{div=16},1,?{div=16})">
    ...
    %iv = cute.assume(%30#3) : (i32) -> !cute.i32<divby 16>
    %iv_83 = cute.assume(%30#4) : (i32) -> !cute.i32<divby 16>
    %stride_84 = cute.make_stride(%iv, %iv_83) : (!cute.i32<divby 16>, !cute.i32<divby 16>) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %lay_85 = cute.make_layout(%shape_82, %stride_84) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">
    %view_86 = cute.make_view(%iter_79, %lay_85) : !memref_gmem_f8E4M3FN
    %iter_87 = cute.get_iter(%view_86) : !memref_gmem_f8E4M3FN
    %iter_88 = cute.get_iter(%view_86) : !memref_gmem_f8E4M3FN
    %lay_89 = cute.get_layout(%view_59) : !memref_gmem_f32_
    %sz_90 = cute.size(%lay_89) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?">
    %e0_91 = cute.get_leaves(%sz_90) : !cute.int_tuple<"?">
    %32 = cute.get_scalars(%e0_91) : !cute.int_tuple<"?">
    %sz_92 = cute.size(%lay_22) <{mode = [0]}> : (!cute.layout<"(128,4):(4,1)">) -> !cute.int_tuple<"128">
    %e0_93 = cute.get_leaves(%sz_92) : !cute.int_tuple<"128">
    %lay_94 = cute.get_layout(%view_59) : !memref_gmem_f32_
    %33 = cute.get_shape(%lay_94) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_95, %e1_96, %e2_97, %e3, %e4, %e5 = cute.get_leaves(%33) : !cute.shape<"((1,512,1),(?,?,?))">
    %itup_98 = cute.to_int_tuple(%e3) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %34 = cute.get_scalars(%itup_98) : !cute.int_tuple<"?">
    %itup_99 = cute.to_int_tuple(%e4) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %35 = cute.get_scalars(%itup_99) : !cute.int_tuple<"?">
    %itup_100 = cute.to_int_tuple(%e5) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %36 = cute.get_scalars(%itup_100) : !cute.int_tuple<"?">
    %37 = cute.get_stride(%lay_94) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    %e0_101, %e1_102, %e2_103, %e3_104, %e4_105, %e5_106 = cute.get_leaves(%37) : !cute.stride<"((0,1,0),(?{i64},512,?{i64}))">
    ...
    %lay_109 = cute.get_layout(%view_86) : !memref_gmem_f8E4M3FN
    %40 = cute.get_shape(%lay_109) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_110, %e1_111, %e2_112, %e3_113, %e4_114, %e5_115 = cute.get_leaves(%40) : !cute.shape<"((1,512,1),(?,?,?))">
    %itup_116 = cute.to_int_tuple(%e3_113) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %41 = cute.get_scalars(%itup_116) : !cute.int_tuple<"?">
    %itup_117 = cute.to_int_tuple(%e4_114) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %42 = cute.get_scalars(%itup_117) : !cute.int_tuple<"?">
    %itup_118 = cute.to_int_tuple(%e5_115) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %43 = cute.get_scalars(%itup_118) : !cute.int_tuple<"?">
    %44 = cute.get_stride(%lay_109) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %e0_119, %e1_120, %e2_121, %e3_122, %e4_123, %e5_124 = cute.get_leaves(%44) : !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %itup_125 = cute.to_int_tuple(%e3_122) : !cute.stride<"?{div=16}"> to !cute.int_tuple<"?{div=16}">
    %45 = cute.get_scalars(%itup_125) : !cute.int_tuple<"?{div=16}">
    %itup_126 = cute.to_int_tuple(%e5_124) : !cute.stride<"?{div=16}"> to !cute.int_tuple<"?{div=16}">
    %46 = cute.get_scalars(%itup_126) : !cute.int_tuple<"?{div=16}">
    %lay_127 = cute.get_layout(%view_69) : !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">
    %47 = cute.get_shape(%lay_127) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_128, %e1_129, %e2_130, %e3_131, %e4_132, %e5_133 = cute.get_leaves(%47) : !cute.shape<"((1,512,1),(?,?,?))">
    %itup_134 = cute.to_int_tuple(%e3_131) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %48 = cute.get_scalars(%itup_134) : !cute.int_tuple<"?">
    ...
    %51 = cute.get_stride(%lay_127) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">) -> !cute.stride<"((0,1@1,0),(1@0,512@1,1@2))">
    %e0_137, %e1_138, %e2_139, %e3_140, %e4_141, %e5_142 = cute.get_leaves(%51) : !cute.stride<"((0,1@1,0),(1@0,512@1,1@2))">
    %52 = cute.get_shape(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.shape<"(128,4)">
    %e0_143, %e1_144 = cute.get_leaves(%52) : !cute.shape<"(128,4)">
    %53 = cute.get_stride(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.stride<"(4,1)">
    %e0_145, %e1_146 = cute.get_leaves(%53) : !cute.stride<"(4,1)">
    %54 = cute.get_shape(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.shape<"(128,4)">
    %e0_147, %e1_148 = cute.get_leaves(%54) : !cute.shape<"(128,4)">
    %55 = cute.get_stride(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.stride<"(4,1)">
    %e0_149, %e1_150 = cute.get_leaves(%55) : !cute.stride<"(4,1)">
    %c0_i32 = arith.constant 0 : i32
    ...
    %59 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0<%58> (%view_59, %view_86, %view_69, %15, %16, %17) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, i32, i32, i32) -> !cuda.result
    %60 = cuda.cast %59 : !cuda.result -> i32
    cuda.return_if_error %60 : i32
    %c0_i32_151 = arith.constant 0 : i32
    return %c0_i32_151 : i32
  }
}
