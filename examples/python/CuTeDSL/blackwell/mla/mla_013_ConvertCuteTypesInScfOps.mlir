    ...
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      scf.if %24 {
        ...
        scf.for %arg6 = %c0_i32 to %27 step %c1_i32  : i32 {
          ...
          %46 = llvm.load %35 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %46, %36 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
          %47 = llvm.load %38 {alignment = 4 : i64} : !llvm.ptr<1> -> vector<1xf32>
          llvm.store %47, %39 {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr
        ...
        %43 = builtin.unrealized_conversion_cast %ptr_15 : !cute.ptr<f8E4M3FN, gmem, align<4>> to !llvm.ptr<1>
        scf.for %arg6 = %c0_i32 to %27 step %c1_i32  : i32 {
          %44 = llvm.load %42 {alignment = 4 : i64} : !llvm.ptr -> vector<4xi8>
          llvm.store %44, %43 {alignment = 4 : i64} : vector<4xi8>, !llvm.ptr<1>
        } {llvm.loop_annotation = #loop_annotation}
      }
      return
    }
