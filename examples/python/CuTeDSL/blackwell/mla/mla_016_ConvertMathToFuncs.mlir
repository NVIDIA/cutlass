...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^bb4:  // pred: ^bb2
      ...
      %34 = builtin.unrealized_conversion_cast %ptr_9 : !cute.ptr<f8E4M3FN, gmem, align<4>> to !llvm.ptr<1>
      cf.br ^bb5(%c0_i32 : i32)
    ^bb5(%35: i32):  // 2 preds: ^bb4, ^bb6
      %36 = arith.cmpi slt, %35, %15 : i32
      cf.cond_br %36, ^bb6, ^bb7 {llvm.loop_annotation = #loop_annotation}
    ^bb6:  // pred: ^bb5
      %37 = llvm.load %33 {alignment = 4 : i64} : !llvm.ptr -> vector<4xi8>
      llvm.store %37, %34 {alignment = 4 : i64} : vector<4xi8>, !llvm.ptr<1>
      %38 = arith.addi %35, %c1_i32 : i32
      cf.br ^bb5(%38 : i32)
    ^bb7:  // pred: ^bb5
      cf.br ^bb8
    ^bb8:  // 2 preds: ^bb0, ^bb7
  ...
  func.func @cutlass__convert_Tensorgmemoi641i64_Tensorgmemodiv16div161div16_1_4(%arg0: !memref_gmem_f32_1, %arg1: !memref_gmem_f8E4M3FN1) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %41:5 = cute.get_scalars(%lay_14) <{only_dynamic}> : !cute.layout<"(?,?{div=16},?):(?{div=16},1,?{div=16})">
    ...
    %iv = cute.assume(%41#3) : (i32) -> !cute.i32<divby 16>
    %iv_19 = cute.assume(%41#4) : (i32) -> !cute.i32<divby 16>
    %stride_20 = cute.make_stride(%iv, %iv_19) : (!cute.i32<divby 16>, !cute.i32<divby 16>) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %lay_21 = cute.make_layout(%shape_18, %stride_20) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">
    %view_22 = cute.make_view(%iter_13, %lay_21) : !memref_gmem_f8E4M3FN
    %sz = cute.size(%lay_6) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{i64},512,?{i64}))">) -> !cute.int_tuple<"?">
    %e0_23 = cute.get_leaves(%sz) : !cute.int_tuple<"?">
    %58 = cute.get_scalars(%e0_23) : !cute.int_tuple<"?">
    ...
    %61 = cuda.launch_ex @kernels::@kernel_cutlass__convert_kernel_tensorptrf32gmemo15121010512_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0<%60> (%view, %view_22, %view_12, %4, %5, %6) : !cuda.launch_cfg<max_attrs = 2>, (!memref_gmem_f32_, !memref_gmem_f8E4M3FN, !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, i32, i32, i32) -> !cuda.result
