...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    func.func public @kernel_cutlass__convert_kernel_tensorptrf32gmemo1512100div5121_tensorptrf8E4M3FNgmemalign16o15121010div16512div16_tensor000o15121011010512112____Float32_Float8E4M3FN_0(%arg0: !memref_gmem_f32_, %arg1: !memref_gmem_f8E4M3FN, %arg2: !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">, %arg3: i32, %arg4: i32, %arg5: i32) attributes {cute.kernel, gpu.kernel, nvvm.reqntid = array<i32: 128, 1, 1>} {
      ...
      %ptr_109 = cute.add_offset(%iter_108, %idx_107) : (!cute.ptr<f8E4M3FN, gmem, align<16>>, !cute.int_tuple<"?{div=4}">) -> !cute.ptr<f8E4M3FN, gmem, align<4>>
      ...
      scf.if %48 {
        ...
        scf.for %arg6 = %c0_i32_267 to %74 step %c1_i32_268  : i32 {
          ...
          %ptr_276 = cute.add_offset(%iter_259, %idx_275) : (!cute.ptr<f8E4M3FN, gmem, align<4>>, !cute.int_tuple<"0">) -> !cute.ptr<f8E4M3FN, gmem, align<4>>
  ...
  func.func @cutlass__convert_Tensorgmemoi64i641_Tensorgmemodiv16div161div16_1_4(%arg0: !memref_gmem_f32_6, %arg1: !memref_gmem_f8E4M3FN6) attributes {llvm.emit_c_interface} {
    ...
    %32:5 = cute.get_scalars(%lay_77) <{only_dynamic}> : !cute.layout<"(?,?{div=16},?):(?{div=16},1,?{div=16})">
    ...
    %iv_80 = cute.assume(%32#3) : (i32) -> !cute.i32<divby 16>
    %iv_81 = cute.assume(%32#4) : (i32) -> !cute.i32<divby 16>
    %stride_82 = cute.make_stride(%iv_80, %iv_81) : (!cute.i32<divby 16>, !cute.i32<divby 16>) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %lay_83 = cute.make_layout(%shape_79, %stride_82) : !cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">
    %view_84 = cute.make_view(%iter_76, %lay_83) : !memref_gmem_f8E4M3FN
    %iter_85 = cute.get_iter(%view_84) : !memref_gmem_f8E4M3FN
    %iter_86 = cute.get_iter(%view_84) : !memref_gmem_f8E4M3FN
    %lay_87 = cute.get_layout(%view) : !memref_gmem_f32_
    %sz_88 = cute.size(%lay_87) <{mode = [1]}> : (!cute.layout<"((1,512,1),(?,?,?)):((0,?{i64},0),(?{i64},?{i64 div=512},1))">) -> !cute.int_tuple<"?">
    %e0_89 = cute.get_leaves(%sz_88) : !cute.int_tuple<"?">
    %34 = cute.get_scalars(%e0_89) : !cute.int_tuple<"?">
    %sz_90 = cute.size(%lay_22) <{mode = [0]}> : (!cute.layout<"(128,4):(4,1)">) -> !cute.int_tuple<"128">
    %e0_91 = cute.get_leaves(%sz_90) : !cute.int_tuple<"128">
    %lay_92 = cute.get_layout(%view) : !memref_gmem_f32_
    %35 = cute.get_shape(%lay_92) : (!cute.layout<"((1,512,1),(?,?,?)):((0,?{i64},0),(?{i64},?{i64 div=512},1))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_93, %e1_94, %e2_95, %e3, %e4, %e5 = cute.get_leaves(%35) : !cute.shape<"((1,512,1),(?,?,?))">
    %itup_96 = cute.to_int_tuple(%e3) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %36 = cute.get_scalars(%itup_96) : !cute.int_tuple<"?">
    %itup_97 = cute.to_int_tuple(%e4) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %37 = cute.get_scalars(%itup_97) : !cute.int_tuple<"?">
    %itup_98 = cute.to_int_tuple(%e5) : !cute.shape<"?"> to !cute.int_tuple<"?">
    %38 = cute.get_scalars(%itup_98) : !cute.int_tuple<"?">
    %39 = cute.get_stride(%lay_92) : (!cute.layout<"((1,512,1),(?,?,?)):((0,?{i64},0),(?{i64},?{i64 div=512},1))">) -> !cute.stride<"((0,?{i64},0),(?{i64},?{i64 div=512},1))">
    %e0_99, %e1_100, %e2_101, %e3_102, %e4_103, %e5_104 = cute.get_leaves(%39) : !cute.stride<"((0,?{i64},0),(?{i64},?{i64 div=512},1))">
    %itup_105 = cute.to_int_tuple(%e1_100) : !cute.stride<"?{i64}"> to !cute.int_tuple<"?{i64}">
    %40 = cute.get_scalars(%itup_105) : !cute.int_tuple<"?{i64}">
    %itup_106 = cute.to_int_tuple(%e3_102) : !cute.stride<"?{i64}"> to !cute.int_tuple<"?{i64}">
    %41 = cute.get_scalars(%itup_106) : !cute.int_tuple<"?{i64}">
    %itup_107 = cute.to_int_tuple(%e4_103) : !cute.stride<"?{i64 div=512}"> to !cute.int_tuple<"?{i64 div=512}">
    %42 = cute.get_scalars(%itup_107) : !cute.int_tuple<"?{i64 div=512}">
    %lay_108 = cute.get_layout(%view_84) : !memref_gmem_f8E4M3FN
    %43 = cute.get_shape(%lay_108) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_109, %e1_110, %e2_111, %e3_112, %e4_113, %e5_114 = cute.get_leaves(%43) : !cute.shape<"((1,512,1),(?,?,?))">
    ...
    %47 = cute.get_stride(%lay_108) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1,0),(?{div=16},512,?{div=16}))">) -> !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %e0_118, %e1_119, %e2_120, %e3_121, %e4_122, %e5_123 = cute.get_leaves(%47) : !cute.stride<"((0,1,0),(?{div=16},512,?{div=16}))">
    %itup_124 = cute.to_int_tuple(%e3_121) : !cute.stride<"?{div=16}"> to !cute.int_tuple<"?{div=16}">
    %48 = cute.get_scalars(%itup_124) : !cute.int_tuple<"?{div=16}">
    %itup_125 = cute.to_int_tuple(%e5_123) : !cute.stride<"?{div=16}"> to !cute.int_tuple<"?{div=16}">
    %49 = cute.get_scalars(%itup_125) : !cute.int_tuple<"?{div=16}">
    %lay_126 = cute.get_layout(%view_66) : !cute.coord_tensor<"(0,0,0)", "((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">
    %50 = cute.get_shape(%lay_126) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">) -> !cute.shape<"((1,512,1),(?,?,?))">
    %e0_127, %e1_128, %e2_129, %e3_130, %e4_131, %e5_132 = cute.get_leaves(%50) : !cute.shape<"((1,512,1),(?,?,?))">
    ...
    %54 = cute.get_stride(%lay_126) : (!cute.layout<"((1,512,1),(?,?,?)):((0,1@1,0),(1@0,512@1,1@2))">) -> !cute.stride<"((0,1@1,0),(1@0,512@1,1@2))">
    %e0_136, %e1_137, %e2_138, %e3_139, %e4_140, %e5_141 = cute.get_leaves(%54) : !cute.stride<"((0,1@1,0),(1@0,512@1,1@2))">
    %55 = cute.get_shape(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.shape<"(128,4)">
    %e0_142, %e1_143 = cute.get_leaves(%55) : !cute.shape<"(128,4)">
    %56 = cute.get_stride(%lay_22) : (!cute.layout<"(128,4):(4,1)">) -> !cute.stride<"(4,1)">
    %e0_144, %e1_145 = cute.get_leaves(%56) : !cute.stride<"(4,1)">
