"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb0(%arg4: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i64, i64)>)>)>, %arg5: !llvm.struct<(ptr<1>, struct<(struct<(i32, i32, i32)>, struct<(i32, i32)>)>)>, %arg6: !llvm.struct<(struct<()>, struct<(struct<(i32, i32, i32)>, struct<()>)>)>, %arg7: i32, %arg8: i32, %arg9: i32):
      ...
      %305 = "llvm.getelementptr"(%275, %303) <{elem_type = i8, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %306 = "llvm.extractvalue"(%229) <{position = array<i64: 0>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %307 = "llvm.extractvalue"(%229) <{position = array<i64: 1>}> : (!llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<()>
      %308 = "llvm.mlir.constant"() <{value = 4 : i32}> : () -> i32
      %309 = "llvm.mul"(%231, %308) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %310 = "llvm.extractvalue"(%299) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %311 = "llvm.extractvalue"(%299) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %312 = "llvm.extractvalue"(%299) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %313 = "llvm.add"(%311, %309) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %314 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32)>
      %315 = "llvm.insertvalue"(%314, %310) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %316 = "llvm.insertvalue"(%315, %313) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %317 = "llvm.insertvalue"(%316, %312) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %318 = "llvm.extractvalue"(%317) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %319 = "llvm.extractvalue"(%317) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %320 = "llvm.extractvalue"(%317) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %321 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32)>
      %322 = "llvm.insertvalue"(%321, %318) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %323 = "llvm.insertvalue"(%322, %319) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %324 = "llvm.insertvalue"(%323, %320) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %325 = "llvm.mlir.undef"() : () -> !llvm.struct<(i32, i32, i32)>
      %326 = "llvm.insertvalue"(%325, %arg7) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %327 = "llvm.insertvalue"(%326, %arg8) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %328 = "llvm.insertvalue"(%327, %arg9) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>, i32) -> !llvm.struct<(i32, i32, i32)>
      %329 = "llvm.extractvalue"(%324) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %330 = "llvm.extractvalue"(%324) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %331 = "llvm.extractvalue"(%324) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %332 = "llvm.extractvalue"(%328) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %333 = "llvm.extractvalue"(%328) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %334 = "llvm.extractvalue"(%328) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32)>) -> i32
      %335 = "llvm.icmp"(%329, %332) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %336 = "llvm.icmp"(%330, %333) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %337 = "llvm.and"(%335, %336) : (i1, i1) -> i1
      %338 = "llvm.icmp"(%331, %334) <{predicate = 2 : i64}> : (i32, i32) -> i1
      %339 = "llvm.and"(%337, %338) : (i1, i1) -> i1
      "llvm.cond_br"(%339)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb1:  // pred: ^bb0
      %340 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %341 = "llvm.insertvalue"(%340, %225) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %342 = "llvm.insertvalue"(%341, %222) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %343 = "llvm.extractvalue"(%342) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %344 = "llvm.mlir.undef"() : () -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %345 = "llvm.insertvalue"(%344, %221) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.ptr) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %346 = "llvm.insertvalue"(%345, %218) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(struct<()>, struct<()>)>) -> !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>
      %347 = "llvm.extractvalue"(%346) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %348 = "llvm.load"(%304) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf32>
      "llvm.store"(%348, %343) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<1xf32>, !llvm.ptr) -> ()
      %349 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %350 = "llvm.getelementptr"(%304, %349) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %351 = "llvm.mlir.constant"() <{value = 1 : i32}> : () -> i32
      %352 = "llvm.getelementptr"(%343, %351) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %353 = "llvm.load"(%350) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf32>
      "llvm.store"(%353, %352) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<1xf32>, !llvm.ptr) -> ()
      %354 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %355 = "llvm.getelementptr"(%304, %354) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %356 = "llvm.mlir.constant"() <{value = 2 : i32}> : () -> i32
      %357 = "llvm.getelementptr"(%343, %356) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %358 = "llvm.load"(%355) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf32>
      "llvm.store"(%358, %357) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<1xf32>, !llvm.ptr) -> ()
      %359 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %360 = "llvm.getelementptr"(%304, %359) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>
      %361 = "llvm.mlir.constant"() <{value = 3 : i32}> : () -> i32
      %362 = "llvm.getelementptr"(%343, %361) <{elem_type = f32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i32) -> !llvm.ptr
      %363 = "llvm.load"(%360) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr<1>) -> vector<1xf32>
      "llvm.store"(%363, %362) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<1xf32>, !llvm.ptr) -> ()
      %364 = "llvm.mlir.poison"() : () -> !llvm.array<1 x vector<4xf32>>
      %365 = "builtin.unrealized_conversion_cast"(%364) : (!llvm.array<1 x vector<4xf32>>) -> vector<1x4xf32>
      %366 = "llvm.extractvalue"(%342) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %367 = "llvm.getelementptr"(%366) <{elem_type = f32, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      %368 = "llvm.load"(%367) <{alignment = 32 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<4xf32>
      %369 = "vector.insert"(%368, %365) <{static_position = array<i64: 0>}> : (vector<4xf32>, vector<1x4xf32>) -> vector<1x4xf32>
      %370 = "vector.shape_cast"(%369) : (vector<1x4xf32>) -> vector<4xf32>
      %371 = "llvm.bitcast"(%370) : (vector<4xf32>) -> vector<4xi32>
      %372 = "llvm.mlir.undef"() : () -> vector<1xi32>
      %373 = "llvm.mlir.constant"() <{value = 16 : i32}> : () -> i32
      %374 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %375 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %376 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
      %377 = "llvm.mlir.constant"() <{value = 2 : i64}> : () -> i64
      %378 = "llvm.extractelement"(%371, %377) : (vector<4xi32>, i64) -> i32
      %379 = "llvm.mlir.constant"() <{value = 3 : i64}> : () -> i64
      %380 = "llvm.extractelement"(%371, %379) : (vector<4xi32>, i64) -> i32
      %381 = "llvm.bitcast"(%378) : (i32) -> f32
      %382 = "llvm.bitcast"(%380) : (i32) -> f32
      %383 = "nvvm.cvt.packfloat.f32"(%382, %381, %374) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e4m3x2>}> : (f32, f32, i32) -> i32
      %384 = "llvm.shl"(%376, %373) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %385 = "llvm.or"(%384, %383) : (i32, i32) -> i32
      %386 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
      %387 = "llvm.extractelement"(%371, %386) : (vector<4xi32>, i64) -> i32
      %388 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
      %389 = "llvm.extractelement"(%371, %388) : (vector<4xi32>, i64) -> i32
      %390 = "llvm.bitcast"(%387) : (i32) -> f32
      %391 = "llvm.bitcast"(%389) : (i32) -> f32
      %392 = "nvvm.cvt.packfloat.f32"(%391, %390, %374) <{extractHi = false, relu = false, rnd = #nvvm.rnd<rn>, sat = #nvvm.sat<satfinite>, to = #nvvm.packfloat_type<e4m3x2>}> : (f32, f32, i32) -> i32
      %393 = "llvm.shl"(%385, %373) <{overflowFlags = #llvm.overflow<none>}> : (i32, i32) -> i32
      %394 = "llvm.or"(%393, %392) : (i32, i32) -> i32
      %395 = "llvm.insertelement"(%372, %394, %375) : (vector<1xi32>, i32, i64) -> vector<1xi32>
      %396 = "llvm.bitcast"(%395) : (vector<1xi32>) -> vector<4xi8>
      %397 = "vector.shape_cast"(%396) : (vector<4xi8>) -> vector<1x4xi8>
      %398 = "llvm.extractvalue"(%346) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) -> !llvm.ptr
      %399 = "vector.extract"(%397) <{static_position = array<i64: 0>}> : (vector<1x4xi8>) -> vector<4xi8>
      %400 = "llvm.getelementptr"(%398) <{elem_type = i8, rawConstantIndices = array<i32: 0>}> : (!llvm.ptr) -> !llvm.ptr
      "llvm.store"(%399, %400) <{alignment = 32 : i64, ordering = 0 : i64}> : (vector<4xi8>, !llvm.ptr) -> ()
      %401 = "llvm.load"(%347) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<4xi8>
      "llvm.store"(%401, %305) <{alignment = 4 : i64, ordering = 0 : i64}> : (vector<4xi8>, !llvm.ptr<1>) -> ()
      "llvm.br"()[^bb2] : () -> ()
    ^bb2:  // 2 preds: ^bb0, ^bb1
      "llvm.return"() : () -> ()
