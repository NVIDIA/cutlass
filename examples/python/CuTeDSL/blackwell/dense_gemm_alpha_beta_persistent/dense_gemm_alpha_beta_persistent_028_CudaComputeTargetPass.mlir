gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
  ...
  ^bb128(%569: i32):  // 2 preds: ^bb127, ^bb129
    ...
    llvm.cond_br %570, ^bb129, ^bb130 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb129:  // pred: ^bb128
  ...
  ^bb131(%580: i32):  // 2 preds: ^bb130, ^bb132
    ...
    llvm.cond_br %581, ^bb132, ^bb133 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb132:  // pred: ^bb131
  ...
  ^bb140(%605: i32):  // 2 preds: ^bb139, ^bb141
    ...
    llvm.cond_br %606, ^bb141, ^bb142 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb141:  // pred: ^bb140
  ...
  ^bb144(%616: i32):  // 2 preds: ^bb143, ^bb145
    ...
    llvm.cond_br %617, ^bb145, ^bb146 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb145:  // pred: ^bb144
  ...
  ^bb168(%724: i32):  // 2 preds: ^bb167, ^bb171
    ...
    llvm.cond_br %725, ^bb169, ^bb172 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb169:  // pred: ^bb168
