gpu.module @kernels [#nvvm.target<O = 3, chip = "sm_100a">] {
  ...
  ^bb30(%179: i32, %180: i1, %181: i32, %182: i32, %183: i32):  // 2 preds: ^bb29, ^bb53
    ...
    llvm.cond_br %184, ^bb31, ^bb54 {loop_annotation = #llvm.loop_annotation<unroll = <disable = true, count = 1 : i32>>}
  ^bb31:  // pred: ^bb30
  ...
  ^bb36(%194: i32):  // 2 preds: ^bb35, ^bb39
    ...
    llvm.cond_br %195, ^bb37, ^bb40 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb37:  // pred: ^bb36
  ...
  ^bb41(%199: i32):  // 2 preds: ^bb40, ^bb44
    ...
    llvm.cond_br %200, ^bb42, ^bb45 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb42:  // pred: ^bb41
  ...
  ^bb98(%289: i32, %290: !llvm.struct<(i1, i1, i1)>):  // 2 preds: ^bb97, ^bb110
    ...
    llvm.cond_br %291, ^bb99, ^bb111 {loop_annotation = #llvm.loop_annotation<unroll = <full = true>>}
  ^bb99:  // pred: ^bb98
  ...
  ^bb100(%314: i32):  // 2 preds: ^bb99, ^bb109
    ...
    llvm.cond_br %315, ^bb101, ^bb110 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb101:  // pred: ^bb100
    llvm.br ^bb102(%19 : i32)
  ^bb102(%316: i32):  // 2 preds: ^bb101, ^bb108
    %317 = llvm.icmp "slt" %316, %40 : i32
    llvm.cond_br %317, ^bb103, ^bb109 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb103:  // pred: ^bb102
    llvm.br ^bb104(%19 : i32)
  ^bb104(%318: i32):  // 2 preds: ^bb103, ^bb107
    %319 = llvm.icmp "slt" %318, %40 : i32
    llvm.cond_br %319, ^bb105, ^bb108 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb105:  // pred: ^bb104
  ...
  ^bb152(%469: i32):  // 2 preds: ^bb151, ^bb153
    ...
    llvm.cond_br %470, ^bb153, ^bb154 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb153:  // pred: ^bb152
  ...
  ^bb155(%480: i32):  // 2 preds: ^bb154, ^bb156
    ...
    llvm.cond_br %481, ^bb156, ^bb157 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb156:  // pred: ^bb155
  ...
  ^bb164(%505: i32):  // 2 preds: ^bb163, ^bb165
    ...
    llvm.cond_br %506, ^bb165, ^bb166 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb165:  // pred: ^bb164
  ...
  ^bb168(%515: i32):  // 2 preds: ^bb167, ^bb169
    ...
    llvm.cond_br %516, ^bb169, ^bb170 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb169:  // pred: ^bb168
  ...
  ^bb208(%582: i32):  // 2 preds: ^bb207, ^bb211
    ...
    llvm.cond_br %583, ^bb209, ^bb212 {llvm.loop_annotation = #llvm.loop_annotation<unroll = <disable = false, full = true>>}
  ^bb209:  // pred: ^bb208
