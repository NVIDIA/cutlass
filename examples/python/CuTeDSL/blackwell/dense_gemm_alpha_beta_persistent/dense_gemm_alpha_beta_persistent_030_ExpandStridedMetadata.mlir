...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels attributes {compute_targets = [#cuda.compute_target<sass, conditional, [sm_100]>]} {
    ...
    ^bb128(%565: i32):  // 2 preds: ^bb127, ^bb129
      ...
      llvm.cond_br %566, ^bb129, ^bb130 {llvm.loop_annotation = #loop_annotation1}
    ^bb129:  // pred: ^bb128
    ...
    ^bb131(%576: i32):  // 2 preds: ^bb130, ^bb132
      ...
      llvm.cond_br %577, ^bb132, ^bb133 {llvm.loop_annotation = #loop_annotation1}
    ^bb132:  // pred: ^bb131
    ...
    ^bb140(%601: i32):  // 2 preds: ^bb139, ^bb141
      ...
      llvm.cond_br %602, ^bb141, ^bb142 {llvm.loop_annotation = #loop_annotation1}
    ^bb141:  // pred: ^bb140
    ...
    ^bb144(%612: i32):  // 2 preds: ^bb143, ^bb145
      ...
      llvm.cond_br %613, ^bb145, ^bb146 {llvm.loop_annotation = #loop_annotation1}
    ^bb145:  // pred: ^bb144
    ...
    ^bb168(%720: i32):  // 2 preds: ^bb167, ^bb171
      ...
      llvm.cond_br %721, ^bb169, ^bb172 {llvm.loop_annotation = #loop_annotation1}
    ^bb169:  // pred: ^bb168
