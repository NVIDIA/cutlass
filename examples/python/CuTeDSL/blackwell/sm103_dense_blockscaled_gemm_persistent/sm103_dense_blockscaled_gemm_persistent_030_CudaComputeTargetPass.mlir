"gpu.module"() <{sym_name = "kernels"}> ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %131 = "llvm.bitcast"(%130) : (vector<1xi32>) -> vector<8xi4>
    %132 = "llvm.bitcast"(%131) : (vector<8xi4>) -> vector<4xi8>
    "llvm.store"(%132, %14) <{alignment = 32 : i64, ordering = 0 : i64}> : (vector<4xi8>, !llvm.ptr) -> ()
    %133 = "llvm.load"(%14) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
    "llvm.store"(%133, %72) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
    %134 = "llvm.getelementptr"(%14) <{elem_type = i8, rawConstantIndices = array<i32: 1>}> : (!llvm.ptr) -> !llvm.ptr
    %135 = "llvm.getelementptr"(%72) <{elem_type = i8, rawConstantIndices = array<i32: 1>}> : (!llvm.ptr<1>) -> !llvm.ptr<1>
    ...
    %137 = "llvm.getelementptr"(%14) <{elem_type = i8, rawConstantIndices = array<i32: 2>}> : (!llvm.ptr) -> !llvm.ptr
    %138 = "llvm.getelementptr"(%72) <{elem_type = i8, rawConstantIndices = array<i32: 2>}> : (!llvm.ptr<1>) -> !llvm.ptr<1>
    %139 = "llvm.load"(%137) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
    "llvm.store"(%139, %138) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
    %140 = "llvm.getelementptr"(%14) <{elem_type = i8, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr) -> !llvm.ptr
    %141 = "llvm.getelementptr"(%72) <{elem_type = i8, rawConstantIndices = array<i32: 3>}> : (!llvm.ptr<1>) -> !llvm.ptr<1>
    %142 = "llvm.load"(%140) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> vector<1xi8>
    "llvm.store"(%142, %141) <{alignment = 1 : i64, ordering = 0 : i64}> : (vector<1xi8>, !llvm.ptr<1>) -> ()
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    "llvm.return"() : () -> ()
