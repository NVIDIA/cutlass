...
module attributes {gpu.container_module} {
  ...
  func.func @cutlass_print_tensor_Tensorgenerico3441(%arg0: !memref_generic_f32_) attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg1 = %c0 to %28 step %c1 {
      %33 = arith.subi %28, %c1 : index
      %34 = arith.cmpi ne, %arg1, %33 : index
      %35 = arith.cmpi ne, %arg1, %c0 : index
      scf.if %35 {
        %40 = llvm.getelementptr %12[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<8 x i8>
        %41 = llvm.call @printf(%40) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
      }
      %36 = llvm.getelementptr %11[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x i8>
      %37 = llvm.call @printf(%36) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
      scf.for %arg2 = %c0 to %26 step %c1 {
        %40 = arith.cmpi sgt, %arg2, %c2 : index
        %41 = arith.subi %26, %c3 : index
        %42 = arith.cmpi slt, %arg2, %41 : index
        ...
        scf.if %43 {
          ...
          scf.if %44 {
            %51 = llvm.getelementptr %9[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<9 x i8>
          ...
          scf.for %arg3 = %c0 to %27 step %c1 {
            %51 = arith.cmpi sgt, %arg3, %c2 : index
            %52 = arith.subi %27, %c3 : index
            %53 = arith.cmpi slt, %arg3, %52 : index
            %54 = arith.andi %51, %53 : i1
            scf.if %54 {
          ...
          %49 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x i8>
          %50 = llvm.call @printf(%49) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
          scf.if %46 {
            %51 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x i8>
            %52 = llvm.call @printf(%51) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
          }
        }
      }
      %38 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x i8>
      %39 = llvm.call @printf(%38) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
      scf.if %34 {
        %40 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<4 x i8>
        %41 = llvm.call @printf(%40) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
      }
    }
    %31 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x i8>
