module attributes {gpu.container_module} {
  ...
  llvm.func @cutlass_print_tensor_Tensorgenerico3441(%arg0: !llvm.struct<(ptr, struct<(struct<()>, struct<()>)>)>) attributes {llvm.emit_c_interface} {
    ...
    llvm.br ^bb1(%21 : i64)
  ^bb1(%36: i64):  // 2 preds: ^bb0, ^bb29
    %37 = llvm.icmp "slt" %36, %29 : i64
    llvm.cond_br %37, ^bb2, ^bb30
  ^bb2:  // pred: ^bb1
  ...
  ^bb4:  // 2 preds: ^bb2, ^bb3
    ...
    llvm.br ^bb5(%21 : i64)
  ^bb5(%43: i64):  // 2 preds: ^bb4, ^bb26
    %44 = llvm.icmp "slt" %43, %27 : i64
    llvm.cond_br %44, ^bb6, ^bb27
  ^bb6:  // pred: ^bb5
  ...
  ^bb12:  // 2 preds: ^bb10, ^bb11
    ...
    llvm.br ^bb13(%21 : i64)
  ^bb13(%59: i64):  // 2 preds: ^bb12, ^bb22
    %60 = llvm.icmp "slt" %59, %28 : i64
    llvm.cond_br %60, ^bb14, ^bb23
  ^bb14:  // pred: ^bb13
