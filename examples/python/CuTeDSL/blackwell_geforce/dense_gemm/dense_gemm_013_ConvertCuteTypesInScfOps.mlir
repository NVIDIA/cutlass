      ...
      scf.if %112 {
        ...
        ^bb0(%arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32):
          ...
          %169 = scf.if %140 -> (i1) {
            ...
            %226 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %227 = nvvm.mbarrier.wait.parity %226, %arg13 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            scf.yield %227 : i1
          } else {
            scf.yield %true : i1
          }
          ...
          scf.if %171 {
            ...
            %ptr_101 = cute.add_offset(%iter, %int_tuple_100) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %226 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.try_wait.parity.shared %226, %arg13, %c10000000_i32 : !llvm.ptr<3>, i32, i32
          }
          ...
          %172 = builtin.unrealized_conversion_cast %view_75 : !memref_smem_f16_ to !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>
          ...
          %173 = builtin.unrealized_conversion_cast %view_77 : !memref_smem_f16_ to !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>
          scf.for %arg16 = %c0_i32 to %141 step %c1_i32  : i32 {
            ...
            %226 = cute_nvgpu.arch.copy.ldsm %ptr_105{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
            %227 = vector.extractelement %226[%48 : i32] : vector<4xi32>
            %228 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
            llvm.store %227, %228 : i32, !llvm.ptr
            %229 = vector.extractelement %226[%47 : i32] : vector<4xi32>
            %ptr_106 = cute.add_offset(%ptr_104, %60) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
            %230 = builtin.unrealized_conversion_cast %ptr_106 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
            llvm.store %229, %230 : i32, !llvm.ptr
            %231 = vector.extractelement %226[%46 : i32] : vector<4xi32>
            %ptr_107 = cute.add_offset(%ptr_104, %58) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
            %232 = builtin.unrealized_conversion_cast %ptr_107 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
            llvm.store %231, %232 : i32, !llvm.ptr
            %233 = vector.extractelement %226[%45 : i32] : vector<4xi32>
            %ptr_108 = cute.add_offset(%ptr_104, %44) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
            %234 = builtin.unrealized_conversion_cast %ptr_108 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
          ...
          scf.for %arg16 = %c0_i32 to %141 step %c1_i32  : i32 {
            ...
            %226 = cute_nvgpu.arch.copy.ldsm %ptr_105{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
            %227 = vector.extractelement %226[%48 : i32] : vector<4xi32>
            %228 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
            llvm.store %227, %228 : i32, !llvm.ptr
            %229 = vector.extractelement %226[%47 : i32] : vector<4xi32>
          ...
          %174:5 = scf.for %arg16 = %c0_i32 to %142 step %c1_i32 iter_args(%arg17 = %172, %arg18 = %173, %arg19 = %c0_i32, %arg20 = %arg12, %arg21 = %arg13) -> (!llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, i32, i32, i32)  : i32 {
            %226 = builtin.unrealized_conversion_cast %arg18 : !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)> to !memref_smem_f16_
            %227 = builtin.unrealized_conversion_cast %arg17 : !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)> to !memref_smem_f16_
            %iter_100 = cute.get_iter(%227) : !memref_smem_f16_
            ...
            scf.for %arg22 = %c0_i32 to %141 step %c1_i32  : i32 {
              ...
              %239 = cute_nvgpu.arch.copy.ldsm %swizzled{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
              %240 = vector.extractelement %239[%48 : i32] : vector<4xi32>
              %241 = builtin.unrealized_conversion_cast %ptr_120 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              llvm.store %240, %241 : i32, !llvm.ptr
              %242 = vector.extractelement %239[%47 : i32] : vector<4xi32>
              %ptr_121 = cute.add_offset(%ptr_120, %60) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
              %243 = builtin.unrealized_conversion_cast %ptr_121 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %242, %243 : i32, !llvm.ptr
              %244 = vector.extractelement %239[%46 : i32] : vector<4xi32>
              %ptr_122 = cute.add_offset(%ptr_120, %58) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
              %245 = builtin.unrealized_conversion_cast %ptr_122 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %244, %245 : i32, !llvm.ptr
              %246 = vector.extractelement %239[%45 : i32] : vector<4xi32>
              %ptr_123 = cute.add_offset(%ptr_120, %44) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
              %247 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %246, %247 : i32, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            %iter_102 = cute.get_iter(%226) : !memref_smem_f16_
            ...
            scf.for %arg22 = %c0_i32 to %141 step %c1_i32  : i32 {
              ...
              %239 = cute_nvgpu.arch.copy.ldsm %swizzled{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
              %240 = vector.extractelement %239[%48 : i32] : vector<4xi32>
              %241 = builtin.unrealized_conversion_cast %ptr_120 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %240, %241 : i32, !llvm.ptr
              %242 = vector.extractelement %239[%47 : i32] : vector<4xi32>
            ...
            scf.for %arg22 = %c0_i32 to %143 step %c1_i32  : i32 {
              scf.for %arg23 = %c0_i32 to %141 step %c1_i32  : i32 {
                ...
                %239 = builtin.unrealized_conversion_cast %ptr_118 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
                %240 = llvm.getelementptr %239[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %241 = llvm.getelementptr %239[2] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %242 = llvm.getelementptr %239[3] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                scf.for %arg24 = %c0_i32 to %144 step %c1_i32  : i32 {
                  ...
                  %243 = llvm.load %239 : !llvm.ptr -> vector<2xf16>
                  %244 = llvm.load %240 : !llvm.ptr -> vector<2xf16>
                  %245 = llvm.load %241 : !llvm.ptr -> vector<2xf16>
                  %246 = llvm.load %242 : !llvm.ptr -> vector<2xf16>
                  %247 = builtin.unrealized_conversion_cast %ptr_122 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
                  %248 = llvm.load %247 : !llvm.ptr -> vector<2xf16>
                  %249 = llvm.getelementptr %247[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                  %250 = llvm.load %249 : !llvm.ptr -> vector<2xf16>
                  %251 = builtin.unrealized_conversion_cast %ptr_124 : !cute.ptr<f32, rmem, align<16>> to !llvm.ptr
                  %252 = llvm.load %251 : !llvm.ptr -> f32
                  %253 = llvm.getelementptr %251[1] : (!llvm.ptr) -> !llvm.ptr, f32
                  %254 = llvm.load %253 : !llvm.ptr -> f32
                  %255 = llvm.getelementptr %251[2] : (!llvm.ptr) -> !llvm.ptr, f32
                  %256 = llvm.load %255 : !llvm.ptr -> f32
                  %257 = llvm.getelementptr %251[3] : (!llvm.ptr) -> !llvm.ptr, f32
                  %258 = llvm.load %257 : !llvm.ptr -> f32
                  %259:4 = cute_nvgpu.arch.mma.SM80 A[%243, %244, %245, %246]  B[%248, %250]  C[%252, %254, %256, %258] < {a_type = f16, b_type = f16, shape_MNK = #cute.shape<"(16,8,16)">}> : (vector<2xf16>, vector<2xf16>, f32) -> (f32, f32, f32, f32)
                  llvm.store %259#0, %251 : f32, !llvm.ptr
                  llvm.store %259#1, %253 : f32, !llvm.ptr
                  llvm.store %259#2, %255 : f32, !llvm.ptr
                  llvm.store %259#3, %257 : f32, !llvm.ptr
                } {llvm.loop_annotation = #loop_annotation}
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
            ...
            scf.if %83 {
              ...
              %239 = builtin.unrealized_conversion_cast %ptr_117 : !cute.ptr<i64, smem> to !llvm.ptr<3>
              nvvm.mbarrier.txn %239, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
            }
            %228 = arith.addi %arg20, %c1_i32 : i32
            %229 = arith.addi %arg19, %c1_i32 : i32
            %230 = arith.cmpi eq, %228, %c4_i32 : i32
            %231 = arith.select %230, %c0_i32, %228 : i32
            %232 = scf.if %230 -> (i32) {
              %239 = arith.xori %arg21, %c1_i32 : i32
              scf.yield %239 : i32
            } else {
              scf.yield %arg21 : i32
            }
            %int_tuple_108 = cute.make_int_tuple(%231) : (i32) -> !cute.int_tuple<"?">
            %ptr_109 = cute.add_offset(%iter, %int_tuple_108) : (!cute.ptr<i64, smem, align<1024>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %233 = builtin.unrealized_conversion_cast %ptr_109 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            %234 = nvvm.mbarrier.wait.parity %233, %232 {kind = #nvvm.mbar_wait<try>} : !llvm.ptr<3>, i32 -> i1
            %coord_110 = cute.make_coord(%231) : (i32) -> !cute.coord<"(_,_,_,?)">
            ...
            %235 = builtin.unrealized_conversion_cast %view_113 : !memref_smem_f16_ to !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>
            ...
            %236 = builtin.unrealized_conversion_cast %view_115 : !memref_smem_f16_ to !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>
            %237 = arith.extui %234 : i1 to i32
            ...
            scf.for %arg22 = %c0_i32 to %141 step %c1_i32  : i32 {
              ...
              %239 = cute_nvgpu.arch.copy.ldsm %ptr_121{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
              %240 = vector.extractelement %239[%48 : i32] : vector<4xi32>
              %241 = builtin.unrealized_conversion_cast %ptr_120 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              llvm.store %240, %241 : i32, !llvm.ptr
              %242 = vector.extractelement %239[%47 : i32] : vector<4xi32>
              %ptr_122 = cute.add_offset(%ptr_120, %60) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
              %243 = builtin.unrealized_conversion_cast %ptr_122 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %242, %243 : i32, !llvm.ptr
              %244 = vector.extractelement %239[%46 : i32] : vector<4xi32>
              %ptr_123 = cute.add_offset(%ptr_120, %58) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
              %245 = builtin.unrealized_conversion_cast %ptr_123 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
              llvm.store %244, %245 : i32, !llvm.ptr
              %246 = vector.extractelement %239[%45 : i32] : vector<4xi32>
              %ptr_124 = cute.add_offset(%ptr_120, %44) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
              %247 = builtin.unrealized_conversion_cast %ptr_124 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
              llvm.store %246, %247 : i32, !llvm.ptr
            } {llvm.loop_annotation = #loop_annotation}
            scf.for %arg22 = %c0_i32 to %141 step %c1_i32  : i32 {
              %coord_116 = cute.make_coord(%arg22) : (i32) -> !cute.coord<"(_,?)">
            ...
            scf.yield %235, %236, %229, %231, %232 : !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)>, i32, i32, i32
          } {loop_annotation = #loop_annotation1}
          %175 = builtin.unrealized_conversion_cast %174#1 : !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)> to !memref_smem_f16_
          %176 = builtin.unrealized_conversion_cast %174#0 : !llvm.struct<(ptr<3>, struct<(struct<()>, struct<()>)>)> to !memref_smem_f16_
          %iter_78 = cute.get_iter(%176) : !memref_smem_f16_
          ...
          scf.for %arg16 = %c0_i32 to %141 step %c1_i32  : i32 {
            ...
            %swizzled = cute.apply_swizzle(%ptr_102) : !cute.ptr<f16, smem, align<16>, S<3,4,3>>
            %226 = cute_nvgpu.arch.copy.ldsm %swizzled{matrix_shape = <"(8,8)">, sz_pattern = <u16>, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>> -> vector<4xi32>
            %227 = vector.extractelement %226[%48 : i32] : vector<4xi32>
            %228 = builtin.unrealized_conversion_cast %ptr_104 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
            llvm.store %227, %228 : i32, !llvm.ptr
            %229 = vector.extractelement %226[%47 : i32] : vector<4xi32>
            %ptr_105 = cute.add_offset(%ptr_104, %60) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"2">) -> !cute.ptr<f16, rmem, align<4>>
            %230 = builtin.unrealized_conversion_cast %ptr_105 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
            llvm.store %229, %230 : i32, !llvm.ptr
            %231 = vector.extractelement %226[%46 : i32] : vector<4xi32>
            %ptr_106 = cute.add_offset(%ptr_104, %58) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"4">) -> !cute.ptr<f16, rmem, align<8>>
            %232 = builtin.unrealized_conversion_cast %ptr_106 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
            llvm.store %231, %232 : i32, !llvm.ptr
            %233 = vector.extractelement %226[%45 : i32] : vector<4xi32>
            %ptr_107 = cute.add_offset(%ptr_104, %44) : (!cute.ptr<f16, rmem, align<16>>, !cute.int_tuple<"6">) -> !cute.ptr<f16, rmem, align<4>>
            %234 = builtin.unrealized_conversion_cast %ptr_107 : !cute.ptr<f16, rmem, align<4>> to !llvm.ptr
            llvm.store %233, %234 : i32, !llvm.ptr
          } {llvm.loop_annotation = #loop_annotation}
          %iter_80 = cute.get_iter(%175) : !memref_smem_f16_
          ...
          scf.for %arg16 = %c0_i32 to %145 step %c1_i32  : i32 {
            scf.for %arg17 = %c0_i32 to %141 step %c1_i32  : i32 {
              ...
              %226 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
              %227 = llvm.getelementptr %226[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
              %228 = llvm.getelementptr %226[2] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
              %229 = llvm.getelementptr %226[3] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
              scf.for %arg18 = %c0_i32 to %146 step %c1_i32  : i32 {
                ...
                %230 = llvm.load %226 : !llvm.ptr -> vector<2xf16>
                %231 = llvm.load %227 : !llvm.ptr -> vector<2xf16>
                %232 = llvm.load %228 : !llvm.ptr -> vector<2xf16>
                %233 = llvm.load %229 : !llvm.ptr -> vector<2xf16>
                %234 = builtin.unrealized_conversion_cast %ptr_106 : !cute.ptr<f16, rmem, align<8>> to !llvm.ptr
                %235 = llvm.load %234 : !llvm.ptr -> vector<2xf16>
                %236 = llvm.getelementptr %234[1] : (!llvm.ptr) -> !llvm.ptr, vector<2xf16>
                %237 = llvm.load %236 : !llvm.ptr -> vector<2xf16>
                %238 = builtin.unrealized_conversion_cast %ptr_108 : !cute.ptr<f32, rmem, align<16>> to !llvm.ptr
                %239 = llvm.load %238 : !llvm.ptr -> f32
                %240 = llvm.getelementptr %238[1] : (!llvm.ptr) -> !llvm.ptr, f32
                %241 = llvm.load %240 : !llvm.ptr -> f32
                %242 = llvm.getelementptr %238[2] : (!llvm.ptr) -> !llvm.ptr, f32
                %243 = llvm.load %242 : !llvm.ptr -> f32
                %244 = llvm.getelementptr %238[3] : (!llvm.ptr) -> !llvm.ptr, f32
                %245 = llvm.load %244 : !llvm.ptr -> f32
                %246:4 = cute_nvgpu.arch.mma.SM80 A[%230, %231, %232, %233]  B[%235, %237]  C[%239, %241, %243, %245] < {a_type = f16, b_type = f16, shape_MNK = #cute.shape<"(16,8,16)">}> : (vector<2xf16>, vector<2xf16>, f32) -> (f32, f32, f32, f32)
                llvm.store %246#0, %238 : f32, !llvm.ptr
                llvm.store %246#1, %240 : f32, !llvm.ptr
                llvm.store %246#2, %242 : f32, !llvm.ptr
                llvm.store %246#3, %244 : f32, !llvm.ptr
              } {llvm.loop_annotation = #loop_annotation}
            } {llvm.loop_annotation = #loop_annotation}
          } {llvm.loop_annotation = #loop_annotation}
          ...
          scf.if %83 {
            %int_tuple_100 = cute.make_int_tuple(%174#3) : (i32) -> !cute.int_tuple<"?">
            %ptr_101 = cute.add_offset(%ptr_3, %int_tuple_100) : (!cute.ptr<i64, smem, align<32>>, !cute.int_tuple<"?">) -> !cute.ptr<i64, smem>
            %226 = builtin.unrealized_conversion_cast %ptr_101 : !cute.ptr<i64, smem> to !llvm.ptr<3>
            nvvm.mbarrier.txn %226, %c1_i32 {kind = #nvvm.mbar_txn_kind<arrive>} : !llvm.ptr<3>, i32
          }
          %177 = arith.addi %174#3, %c1_i32 : i32
          %178 = arith.cmpi eq, %177, %c4_i32 : i32
          %179 = arith.select %178, %c0_i32, %177 : i32
          %180 = scf.if %178 -> (i32) {
            %226 = arith.xori %174#4, %c1_i32 : i32
            scf.yield %226 : i32
          } else {
            scf.yield %174#4 : i32
          }
          ...
          %181 = cute.make_tiled_copy(%atom_66) : !copy_stsm_4_
          %182 = cute.make_tiled_copy(%atom_66) : !copy_stsm_4_1
          %rmem_86 = cute.memref.alloca() : !memref_rmem_f32_2
          %183 = cute.memref.load(%view, %36) : (!memref_rmem_f32_1, !cute.coord<"0">) -> f32
          cute.memref.store(%rmem_86, %36, %183) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
          %184 = cute.memref.load(%view, %35) : (!memref_rmem_f32_1, !cute.coord<"1">) -> f32
          cute.memref.store(%rmem_86, %35, %184) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
          %185 = cute.memref.load(%view, %34) : (!memref_rmem_f32_1, !cute.coord<"2">) -> f32
          cute.memref.store(%rmem_86, %34, %185) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
          %186 = cute.memref.load(%view, %33) : (!memref_rmem_f32_1, !cute.coord<"3">) -> f32
          cute.memref.store(%rmem_86, %33, %186) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
          %187 = cute.memref.load(%view, %32) : (!memref_rmem_f32_1, !cute.coord<"4">) -> f32
          cute.memref.store(%rmem_86, %32, %187) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
          %188 = cute.memref.load(%view, %31) : (!memref_rmem_f32_1, !cute.coord<"5">) -> f32
          cute.memref.store(%rmem_86, %31, %188) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
          %189 = cute.memref.load(%view, %30) : (!memref_rmem_f32_1, !cute.coord<"6">) -> f32
          cute.memref.store(%rmem_86, %30, %189) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
          %190 = cute.memref.load(%view, %29) : (!memref_rmem_f32_1, !cute.coord<"7">) -> f32
          cute.memref.store(%rmem_86, %29, %190) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
          %191 = cute.memref.load(%view, %28) : (!memref_rmem_f32_1, !cute.coord<"8">) -> f32
          cute.memref.store(%rmem_86, %28, %191) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
          %192 = cute.memref.load(%view, %27) : (!memref_rmem_f32_1, !cute.coord<"9">) -> f32
          cute.memref.store(%rmem_86, %27, %192) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
          %193 = cute.memref.load(%view, %26) : (!memref_rmem_f32_1, !cute.coord<"10">) -> f32
          cute.memref.store(%rmem_86, %26, %193) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
          %194 = cute.memref.load(%view, %25) : (!memref_rmem_f32_1, !cute.coord<"11">) -> f32
          cute.memref.store(%rmem_86, %25, %194) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
          %195 = cute.memref.load(%view, %24) : (!memref_rmem_f32_1, !cute.coord<"12">) -> f32
          cute.memref.store(%rmem_86, %24, %195) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
          %196 = cute.memref.load(%view, %23) : (!memref_rmem_f32_1, !cute.coord<"13">) -> f32
          cute.memref.store(%rmem_86, %23, %196) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
          %197 = cute.memref.load(%view, %22) : (!memref_rmem_f32_1, !cute.coord<"14">) -> f32
          cute.memref.store(%rmem_86, %22, %197) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
          %198 = cute.memref.load(%view, %21) : (!memref_rmem_f32_1, !cute.coord<"15">) -> f32
          cute.memref.store(%rmem_86, %21, %198) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
          %rmem_87 = cute.memref.alloca() : !memref_rmem_f16_2
          %iter_88 = cute.get_iter(%rmem_87) : !memref_rmem_f16_2
          %199 = cute.memref.load_vec %rmem_86, row_major : !memref_rmem_f32_2
          %200 = arith.truncf %199 : vector<16xf32> to vector<16xf16>
          cute.memref.store_vec %200, %rmem_87, row_major : !memref_rmem_f16_2
          scf.for %arg16 = %c0_i32 to %141 step %c1_i32  : i32 {
            %coord_100 = cute.make_coord(%arg16) : (i32) -> !cute.coord<"(_,?)">
            ...
            %226 = builtin.unrealized_conversion_cast %ptr_102 : !cute.ptr<f16, rmem, align<16>> to !llvm.ptr
            %227 = llvm.load %226 : !llvm.ptr -> vector<4xi32>
            %swizzled = cute.apply_swizzle(%ptr_104) : !cute.ptr<f16, smem, align<16>, S<3,4,3>>
            cute_nvgpu.arch.copy.stsm(%swizzled, %227) {matrix_shape = <"(8,8)">, num_matrices = 4 : i32, transpose} : <f16, smem, align<16>, S<3,4,3>>, vector<4xi32>
          } {llvm.loop_annotation = #loop_annotation}
          ...
          scf.if %78 {
            ...
            %226 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">>
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%226 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">>) -> !cute.ptr<generic, align<64>>
            %227:3 = cute.get_scalars(%int_tuple_103) : !cute.int_tuple<"(?{div=64},?{div=64},?)">
            scf.for %arg16 = %c0_i32 to %145 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %iter_6 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, [%227#0, %227#1, %227#2] : i32, i32, i32) mode = <tiled>
            } {llvm.loop_annotation = #loop_annotation}
            nvvm.cp.async.bulk.commit.group
            nvvm.cp.async.bulk.wait_group 7 {read}
          }
          %201 = cute.memref.load(%view, %18) : (!memref_rmem_f32_1, !cute.coord<"16">) -> f32
          cute.memref.store(%rmem_86, %36, %201) : (!memref_rmem_f32_2, !cute.coord<"0">, f32) -> ()
          %202 = cute.memref.load(%view, %17) : (!memref_rmem_f32_1, !cute.coord<"17">) -> f32
          cute.memref.store(%rmem_86, %35, %202) : (!memref_rmem_f32_2, !cute.coord<"1">, f32) -> ()
          %203 = cute.memref.load(%view, %16) : (!memref_rmem_f32_1, !cute.coord<"18">) -> f32
          cute.memref.store(%rmem_86, %34, %203) : (!memref_rmem_f32_2, !cute.coord<"2">, f32) -> ()
          %204 = cute.memref.load(%view, %15) : (!memref_rmem_f32_1, !cute.coord<"19">) -> f32
          cute.memref.store(%rmem_86, %33, %204) : (!memref_rmem_f32_2, !cute.coord<"3">, f32) -> ()
          %205 = cute.memref.load(%view, %14) : (!memref_rmem_f32_1, !cute.coord<"20">) -> f32
          cute.memref.store(%rmem_86, %32, %205) : (!memref_rmem_f32_2, !cute.coord<"4">, f32) -> ()
          %206 = cute.memref.load(%view, %13) : (!memref_rmem_f32_1, !cute.coord<"21">) -> f32
          cute.memref.store(%rmem_86, %31, %206) : (!memref_rmem_f32_2, !cute.coord<"5">, f32) -> ()
          %207 = cute.memref.load(%view, %12) : (!memref_rmem_f32_1, !cute.coord<"22">) -> f32
          cute.memref.store(%rmem_86, %30, %207) : (!memref_rmem_f32_2, !cute.coord<"6">, f32) -> ()
          %208 = cute.memref.load(%view, %11) : (!memref_rmem_f32_1, !cute.coord<"23">) -> f32
          cute.memref.store(%rmem_86, %29, %208) : (!memref_rmem_f32_2, !cute.coord<"7">, f32) -> ()
          %209 = cute.memref.load(%view, %10) : (!memref_rmem_f32_1, !cute.coord<"24">) -> f32
          cute.memref.store(%rmem_86, %28, %209) : (!memref_rmem_f32_2, !cute.coord<"8">, f32) -> ()
          %210 = cute.memref.load(%view, %9) : (!memref_rmem_f32_1, !cute.coord<"25">) -> f32
          cute.memref.store(%rmem_86, %27, %210) : (!memref_rmem_f32_2, !cute.coord<"9">, f32) -> ()
          %211 = cute.memref.load(%view, %8) : (!memref_rmem_f32_1, !cute.coord<"26">) -> f32
          cute.memref.store(%rmem_86, %26, %211) : (!memref_rmem_f32_2, !cute.coord<"10">, f32) -> ()
          %212 = cute.memref.load(%view, %7) : (!memref_rmem_f32_1, !cute.coord<"27">) -> f32
          cute.memref.store(%rmem_86, %25, %212) : (!memref_rmem_f32_2, !cute.coord<"11">, f32) -> ()
          %213 = cute.memref.load(%view, %6) : (!memref_rmem_f32_1, !cute.coord<"28">) -> f32
          cute.memref.store(%rmem_86, %24, %213) : (!memref_rmem_f32_2, !cute.coord<"12">, f32) -> ()
          %214 = cute.memref.load(%view, %5) : (!memref_rmem_f32_1, !cute.coord<"29">) -> f32
          cute.memref.store(%rmem_86, %23, %214) : (!memref_rmem_f32_2, !cute.coord<"13">, f32) -> ()
          %215 = cute.memref.load(%view, %4) : (!memref_rmem_f32_1, !cute.coord<"30">) -> f32
          cute.memref.store(%rmem_86, %22, %215) : (!memref_rmem_f32_2, !cute.coord<"14">, f32) -> ()
          %216 = cute.memref.load(%view, %3) : (!memref_rmem_f32_1, !cute.coord<"31">) -> f32
          cute.memref.store(%rmem_86, %21, %216) : (!memref_rmem_f32_2, !cute.coord<"15">, f32) -> ()
          %rmem_89 = cute.memref.alloca() : !memref_rmem_f16_2
          %iter_90 = cute.get_iter(%rmem_89) : !memref_rmem_f16_2
          %217 = cute.memref.load_vec %rmem_86, row_major : !memref_rmem_f32_2
          %218 = arith.truncf %217 : vector<16xf32> to vector<16xf16>
          cute.memref.store_vec %218, %rmem_89, row_major : !memref_rmem_f16_2
          scf.for %arg16 = %c0_i32 to %141 step %c1_i32  : i32 {
            %coord_100 = cute.make_coord(%arg16) : (i32) -> !cute.coord<"(_,?)">
            %idx_101 = cute.crd2idx(%coord_100, %20) : (!cute.coord<"(_,?)">, !cute.layout<"(((2,2,2),1),((2,1))):(((1,2,4),0),((8,0)))">) -> !cute.int_tuple<"?{div=8}">
          ...
          scf.if %78 {
            ...
            %226 = cute_nvgpu.atom.make_exec_tma(%arg4) : (!cute_nvgpu.atom.non_exec_tiled_tma_store<f16, copy_bits = 32768, tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">, internal_val_type = f16>) -> !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">>
            %TMADescAddr = cute_nvgpu.get_tma_desc_addr(%226 : !cute_nvgpu.atom.tma_store<f16, copy_bits = 32768, mode = tiled, g_stride = <"()"> tma_gbasis = <"(64,32,1):(1@0,1@1,1@2)">>) -> !cute.ptr<generic, align<64>>
            %227:3 = cute.get_scalars(%int_tuple_105) : !cute.int_tuple<"(?{div=64},?{div=32},?)">
            scf.for %arg16 = %c0_i32 to %145 step %c1_i32  : i32 {
              cute_nvgpu.arch.copy.SM100.tma_store(%TMADescAddr : !cute.ptr<generic, align<64>>, %ptr_100 : !cute.ptr<f16, smem, align<1024>, S<3,4,3>>, [%227#0, %227#1, %227#2] : i32, i32, i32) mode = <tiled>
            } {llvm.loop_annotation = #loop_annotation}
            nvvm.cp.async.bulk.commit.group
            nvvm.cp.async.bulk.wait_group 7 {read}
          }
          %219 = arith.addi %arg14, %105 : i32
          %220 = arith.addi %arg15, %c1_i32 : i32
          %221 = arith.cmpi sgt, %106, %219 : i32
          %222 = cute.get_hier_coord(%219, %lay) : (i32, !cute.layout<"(?,?,?):(1,?,?)">) -> !cute.coord<"(?,?,?)">
          %e0_91, %e1_92, %e2_93 = cute.get_leaves(%222) : !cute.coord<"(?,?,?)">
          ...
          %223 = cute.get_scalars(%mul_97) : !cute.int_tuple<"?">
          %mul_98 = cute.tuple_mul(%itup_95, %61) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %224 = cute.get_scalars(%mul_98) : !cute.int_tuple<"?">
          %mul_99 = cute.tuple_mul(%itup_96, %61) : (!cute.int_tuple<"?">, !cute.int_tuple<"1">) -> !cute.int_tuple<"?">
          %225 = cute.get_scalars(%mul_99) : !cute.int_tuple<"?">
          nvvm.cp.async.bulk.wait_group 0 {read}
          scf.yield %223, %224, %225, %221, %179, %180, %219, %220 : i32, i32, i32, i1, i32, i32, i32, i32
        }
      } else {
