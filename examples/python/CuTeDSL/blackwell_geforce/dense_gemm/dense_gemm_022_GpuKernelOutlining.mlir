...
"builtin.module"() ({
  ...
  "gpu.module"() <{sym_name = "kernels"}> ({
    ...
    ^bb140:  // pred: ^bb6
      ...
      "llvm.cond_br"(%3059)[^bb141, ^bb168] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb141:  // pred: ^bb140
    ...
    ^bb142(%3080: i32, %3081: i32, %3082: i32, %3083: i1, %3084: i32, %3085: i32, %3086: i32, %3087: i32):  // 2 preds: ^bb141, ^bb152
      "llvm.cond_br"(%3083, %3080, %3081, %3082, %3084, %3085, %3086, %3087)[^bb143, ^bb153] <{operandSegmentSizes = array<i32: 1, 7, 0>}> : (i1, i32, i32, i32, i32, i32, i32, i32) -> ()
    ...
    ^bb144(%3135: i32, %3136: i32, %3137: i32, %3138: i32):  // 2 preds: ^bb143, ^bb151
      %3139 = "llvm.icmp"(%3135, %1000) <{predicate = 2 : i64}> : (i32, i32) -> i1
      "llvm.cond_br"(%3139)[^bb145, ^bb152] <{loop_annotation = #loop_annotation1, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb145:  // pred: ^bb144
    ...
    ^bb147:  // 2 preds: ^bb145, ^bb146
      ...
      "llvm.cond_br"(%3200)[^bb148, ^bb149] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb148:  // pred: ^bb147
      %3202 = "llvm.xor"(%3138, %677) : (i32, i32) -> i32
      "llvm.br"(%3202)[^bb150] : (i32) -> ()
    ^bb149:  // pred: ^bb147
      "llvm.br"(%3138)[^bb150] : (i32) -> ()
    ^bb150(%3203: i32):  // 2 preds: ^bb148, ^bb149
      "llvm.br"()[^bb151] : () -> ()
    ^bb151:  // pred: ^bb150
    ...
    ^bb153:  // pred: ^bb142
      ...
      "llvm.cond_br"(%3230)[^bb154, ^bb155] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb154:  // pred: ^bb153
      %3232 = "llvm.xor"(%3085, %677) : (i32, i32) -> i32
      "llvm.br"(%3232)[^bb156] : (i32) -> ()
    ^bb155:  // pred: ^bb153
      "llvm.br"(%3085)[^bb156] : (i32) -> ()
    ^bb156(%3233: i32):  // 2 preds: ^bb154, ^bb155
      "llvm.br"()[^bb157] : () -> ()
    ^bb157:  // pred: ^bb156
      ...
      "llvm.cond_br"(%3235)[^bb158, ^bb159] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb158:  // pred: ^bb157
      %3237 = "llvm.xor"(%3233, %677) : (i32, i32) -> i32
      "llvm.br"(%3237)[^bb160] : (i32) -> ()
    ^bb159:  // pred: ^bb157
      "llvm.br"(%3233)[^bb160] : (i32) -> ()
    ^bb160(%3238: i32):  // 2 preds: ^bb158, ^bb159
      "llvm.br"()[^bb161] : () -> ()
    ^bb161:  // pred: ^bb160
      ...
      "llvm.cond_br"(%3240)[^bb162, ^bb163] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb162:  // pred: ^bb161
      %3242 = "llvm.xor"(%3238, %677) : (i32, i32) -> i32
      "llvm.br"(%3242)[^bb164] : (i32) -> ()
    ^bb163:  // pred: ^bb161
      "llvm.br"(%3238)[^bb164] : (i32) -> ()
    ^bb164(%3243: i32):  // 2 preds: ^bb162, ^bb163
      "llvm.br"()[^bb165] : () -> ()
    ^bb165:  // pred: ^bb164
      ...
      "llvm.cond_br"(%3245)[^bb166, ^bb167] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
    ^bb166:  // pred: ^bb165
