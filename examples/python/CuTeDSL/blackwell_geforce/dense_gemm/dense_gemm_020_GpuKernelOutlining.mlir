...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    ^bb172(%2613: i32, %2614: i32, %2615: i32, %2616: i1, %2617: i32, %2618: i32, %2619: i32, %2620: i32):  // 2 preds: ^bb171, ^bb188
      llvm.cond_br %2616, ^bb173(%2613, %2614, %2615, %2617, %2618, %2619, %2620 : i32, i32, i32, i32, i32, i32, i32), ^bb189
    ...
    ^bb174(%2668: i32, %2669: i32, %2670: i32, %2671: i32):  // 2 preds: ^bb173, ^bb187
      %2672 = llvm.icmp "slt" %2668, %420 : i32
      llvm.cond_br %2672, ^bb175, ^bb188 {loop_annotation = #loop_annotation1}
    ^bb175:  // pred: ^bb174
    ...
    ^bb178(%2721: i32):  // 2 preds: ^bb177, ^bb179
      %2722 = llvm.icmp "slt" %2721, %2609 : i32
      llvm.cond_br %2722, ^bb179, ^bb180 {llvm.loop_annotation = #loop_annotation}
    ^bb179:  // pred: ^bb178
    ...
    ^bb181(%2737: i32):  // 2 preds: ^bb180, ^bb182
      %2738 = llvm.icmp "slt" %2737, %2609 : i32
      llvm.cond_br %2738, ^bb182, ^bb183 {llvm.loop_annotation = #loop_annotation}
    ^bb182:  // pred: ^bb181
    ...
    ^bb189:  // pred: ^bb172
      ...
      llvm.cond_br %2773, ^bb190, ^bb191
    ^bb190:  // pred: ^bb189
      %2775 = llvm.xor %2618, %99 : i32
      llvm.br ^bb192(%2775 : i32)
    ^bb191:  // pred: ^bb189
      llvm.br ^bb192(%2618 : i32)
    ^bb192(%2776: i32):  // 2 preds: ^bb190, ^bb191
      llvm.br ^bb193
    ^bb193:  // pred: ^bb192
      %2777 = llvm.add %2774, %99 : i32
      %2778 = llvm.icmp "eq" %2777, %94 : i32
      %2779 = llvm.select %2778, %103, %2777 : i1, i32
      llvm.cond_br %2778, ^bb194, ^bb195
    ^bb194:  // pred: ^bb193
      %2780 = llvm.xor %2776, %99 : i32
      llvm.br ^bb196(%2780 : i32)
    ^bb195:  // pred: ^bb193
      llvm.br ^bb196(%2776 : i32)
    ^bb196(%2781: i32):  // 2 preds: ^bb194, ^bb195
      llvm.br ^bb197
    ^bb197:  // pred: ^bb196
      %2782 = llvm.add %2779, %99 : i32
      %2783 = llvm.icmp "eq" %2782, %94 : i32
      %2784 = llvm.select %2783, %103, %2782 : i1, i32
      llvm.cond_br %2783, ^bb198, ^bb199
    ^bb198:  // pred: ^bb197
      %2785 = llvm.xor %2781, %99 : i32
      llvm.br ^bb200(%2785 : i32)
    ^bb199:  // pred: ^bb197
      llvm.br ^bb200(%2781 : i32)
    ^bb200(%2786: i32):  // 2 preds: ^bb198, ^bb199
      llvm.br ^bb201
    ^bb201:  // pred: ^bb200
