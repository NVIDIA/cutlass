...
class BaseOp(CopyOp):
    """
    Base class for warp-level matrix copy operations.

    Provides shared validation and string formatting for warp load/store ops.
    """
...
class LdMatrix8x8x16bTrait(Trait):
    """Trait generated by ``LdMatrix8x8x16bOp``."""
...
class LdMatrix8x16x8bTrait(Trait):
    """Trait generated by ``LdMatrix8x16x8bOp``."""
...
class LdMatrix16x8x8bTrait(Trait):
    """Trait generated by ``LdMatrix16x8x8bOp``."""
...
class LdMatrix16x16x8bTrait(Trait):
    """Trait generated by ``LdMatrix16x16x8bOp``."""
...
class StMatrix8x8x16bTrait(Trait):
    """Trait generated by ``StMatrix8x8x16bOp``."""
...
class StMatrix16x8x8bTrait(Trait):
    """Trait generated by ``StMatrix16x8x8bOp``."""
