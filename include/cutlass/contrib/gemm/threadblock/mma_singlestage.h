...
class MmaSingleStage : public cutlass::contrib::gemm::threadblock::MmaBase<Shape_, Policy_, 1> {
 public:
  ///< Base class
  using Base = cutlass::contrib::gemm::threadblock::MmaBase<Shape_, Policy_, 1>;
 ...
 public:
  ...
  void operator()(int gemm_k_iterations,  ///< number of iterations of the mainloop
                  ...
                  PrologueOpA prologue_op_A,
                  PrologueOpB prologue_op_B,
    ...
    for (; gemm_k_iterations > 0; --gemm_k_iterations) {
      ...
      for (int warp_mma_k = 0; warp_mma_k < Base::kWarpGemmIterations; ++warp_mma_k) {
        ...
        warp_frag_A =
            prologue_op_A.template operator()<WarpLoadIteratorA>(warp_frag_A, prologue_frag_A);
        warp_frag_B =
            prologue_op_B.template operator()<WarpLoadIteratorB>(warp_frag_B, prologue_frag_B);
