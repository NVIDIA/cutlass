  ...
  struct Params {
    ...
    void update(Arguments const& args, void* workspace = nullptr) {
      problem_visitor = typename ProblemVisitor::Params(
          args.problem_size_op, args.batch_count_op, args.problem_count);
      threadblock_count = args.threadblock_count;
      prologue_op_A = args.prologue_op_A;
      prologue_op_B = args.prologue_op_B;
      output_op = args.output_op;
 ...
 public:
  ...
  void operator()(Params const& params, SharedStorage& shared_storage) {
    ...
    while (problem_visitor.next_tile()) {
      ...
      typename Mma::IteratorA iterator_A(LayoutA(params_A.ldm),
                                         params_A.ptr,
      ...
      typename Mma::IteratorB iterator_B(LayoutB(params_B.ldm),
                                         params_B.ptr,
